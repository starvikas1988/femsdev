...
// $config['smtp_pass'] = 'Omind#1q2w'; // change it to yours

$config['smtp_user'] = 'noreply.mwp@fusionbposervices.com'; // change it to yours
$config['smtp_pass'] = 'Fusion@2022'; // change it to yours

$config['smtp_crypto'] = 'tls';
$config['mailtype'] = 'html';
$config['charset'] = 'iso-8859-1';
$config['wordwrap'] = TRUE;
$config['useragent'] = 'MWP-DEV';
