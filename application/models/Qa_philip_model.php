...
//////////////////////////	
	...
	function mba_voice_data($data){
		$this->db->insert_batch('qa_mba_voice_feedback', $data);
	}

	function qa_k2_claims_data($data){
		$this->db->insert_batch('qa_k2_claims_feedback', $data);
	}

	function qa_clio_data($data){
		$this->db->insert_batch('qa_clio_feedback', $data);
	}

	function qa_rpm_form_data($data){
		$this->db->insert_batch('qa_rpm', $data);
	}

	function qa_virtuox_data($data){
		$this->db->insert_batch('qa_virtuox_feedback', $data);
	}

	function qa_keeper_data($data){
		$this->db->insert_batch('qa_keeper_feedback', $data);
	}

	function qa_alpha_data($data){
		$this->db->insert_batch('qa_alpha_feedback', $data);
	}

	function qa_hcco_data($data){
		$this->db->insert_batch('qa_hcco_feedback', $data);
	}

	function qa_hcco_flex_data($data){
		$this->db->insert_batch('qa_hcco_flex_feedback', $data);
	}

	function qa_hcci_data($data){
		$this->db->insert_batch('qa_hcci_feedback', $data);
	}

	function qa_hcci_cx_data($data){
		$this->db->insert_batch('qa_hcci_feedback_new', $data);
	}
}
?>	