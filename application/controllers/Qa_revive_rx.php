	...
	public function create_qa_revive_rx_CSV($rr,$campaign)
	{
		...
		if($campaign == 'revive_rx')
		{
			...
			$header = array("Auditor Name", "Audit Date","L1 Supervisor:" ,"Agent", "Fusion ID","Call Id","Call Duration","Contact Number","Audit Type","VOC","Call Type","Audit Link","Audit Start Date Time", "Audit End Date Time", "Interval(in sec)","Possible Score","Earned Score","Overall Score",
				...
				"Remarks1",
				"Soft skills:Did we use polite vocabulary (Thank you and apologies)",
				"Remarks2",
				"Soft skills:Did not overtalk the customer",
				"Remarks3",
				...
				"Remarks10",
				"Compliance:Agent asked for clarifying and probing questions",
				"Remarks11",
				"Compliance:Followed proper hold and transfer procedures",
				"Remarks12",
				"Compliance:Left appropiate notes in the account",
				"Remarks13",
				"Compliance:Update the system acordingly (TEXT messages assessment allergies future tasks pay simple payment)",
				"Remarks14",
				"Compliance:Confirmed the total amount asked for authorization to process the payment and fill.",
				"Remarks15",
				"Compliance:Left voicemail and sent TEXT message (unable to contact patient).",
				"Remarks16",
				"Compliance:Did we ask If additional assitance was needed.",
				"Remarks17",
				"Compliance:Closed the call positively.",
				"Remarks18",
				"Business Critical-Fatal:Properly authenticates (Complete shipping address and DOB)",
				"Remarks19",
