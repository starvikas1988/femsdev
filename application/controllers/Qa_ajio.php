...
/*------------------------------ Report Part ---------------------------*/
	...
	public function create_qa_ajio_CSV($rr,$campaign)
	{
		...
		if($campaign=="inbound"){
			...
			$header = array("Auditor Name", "Auditor Department", "Auditor Role", "Audit Date", "Agent", "MWP ID", "L1 Super", "Call Date/Time", "Type of Audit", "Call ID", "Audit Type", "Auditor Type", "VOC", "Overall Score", "Earned Score", "Possible Score", "Fatal Count", "Pre Fatal Score", "Audit Start Date Time", "Audit End Date Time", "Interval(In Second)",
