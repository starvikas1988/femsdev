	...
	public function index()
	{
		if(check_logged_in()){
			...
			$sqlPhilipines = "SELECT def.table_name,s.office_id,c.id as clientId,def.process_id,c.fullname as clientName,p.name as processName
                                ...
                                where c.is_active=1 and def.client_id not in (0) and s.office_id in ('CEB','MAN') and c.id not in('4','90','291','312','324','339','342','345','352','355','357') group by def.process_id order by c.fullname";				 
