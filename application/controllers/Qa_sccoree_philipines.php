...
class Qa_sccoree_philipines extends CI_Controller {
	...
	public function index()
	{
		if(check_logged_in()){
			...
			$data["content_template"] 	= "qa_score_philipines/Qa_sccoree_philipines.php";
			...
			//{
				foreach($resPhilipines as $key=> $rowPhilipines)
				{
