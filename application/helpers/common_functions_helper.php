...
////////////////////
	...
	function get_username()
	{
    	global $CI;
    	$rr = $CI->session->userdata('logged_in');
		if(check_logged_in()) return ucwords($rr["name"]);
	}
	...
	function get_user_country(){
    	...
    	$qSQL= "SELECT ol.location AS 'Country'
				...
				WHERE ol.abbr IN (SELECT s.office_id
				  				  FROM signin s
				  				  WHERE s.fusion_id IN ('".$fusion_id."'))";
	...
	*/
	...
	function is_pms_permssion() {
       $ses_fusion_id = get_user_fusion_id();
        $access_ids = array("FKOL014560","FKOL016266","FKOL010158","FKOL007108","FKOL010321", "FKOL000003", "FKOL015832","FKOL010535","FKOL016146","FKOL012410");
        $ret = false;
		...
		if (get_dept_folder() == "hr" && isIndiaLocation()) {
			$ret = true;
		}
    ...
    function is_user_assignd_employee_count($user_id = '', $role = '', $dept = '') {
		...
		if ($role != "agent") {
			...
			$query = $CI->db->query($qSql);
			$res = $query->row_array();
			if ($res["value"] > 0 && isIndiaLocation())
				$ret = true;
	...
	function is_access_search_employee(){
		...
		$access_ids=" #FELS004207#FKOL015829#";
		$ret=false;
	...
	function is_access_jurys_inn_modules(){
		...
		*/
		...
		$access_ids=" #FCEB003302#FCEB004265#FCEB004128#FCEB000584#FCEB000766#FCEB005191#FALB000001#FCEB000791#FCEB000965#FCEB004238#FCEB004354#FCEB004355#FCEB003423#FCEB004639#FCEB004889#FCEB004189#FCEB005474#FCEB000385#FCEB004922#FCEB004739#FCEB000722#FCEB000340#FCEB000386#";
		$ret=false;
	...
	function is_access_phs_modules(){
		...
		$access_ids="##FCEB005078#FKOL006355#FMAN000131#FCEB003516#FCEB004981#FMAN001069#FCEB000739#FCEB004317#";
		$ret=false;
	...
	function is_access_clio_modules(){
		...
		$access_ids="##FCEB000757#FCEB000688#FCEB004264#FCEB004126#FCEB003880#FCEB006520#";
		$ret=false;
	...
	function isAccessAvonReports(){
		...
		$access_ids=" #FALB000267#FKOL001961#FKOL007078#FKOL002542#FKOL007301#FKOL007614#FKOL007196#FKOL003098#FKOL015417#FKOL010038#";
		$ret=true;
	...
	function is_access_clinic_portal(){
		...
		*/
		$ses_fusion_id=get_user_fusion_id();
		$client_id=get_client_ids();
		$access_ids=" #FKOL001961#FCEB003836#FCEB000089#FCEB004453#FMAN000456#FCEB000093#";
		$ret=false;
...
//////////FNF /
	...
	function isAccessFNFHr(){
		...
		*/
		...
		$ses_fusion_id=get_user_fusion_id();
		$access_ids=" #FJAM005935#FELS004207#FELS00017#FKOL000003#FKOL003187#FKOL010158#FKOL012897#FNOI000565#";
	...
	function isAccessFNFITSecurity(){
		...
		$ses_fusion_id=get_user_fusion_id();
		$access_ids=" #FKOL001786#FKOL004016#FNOI000140#FJMP000071#FKOL001919#FKOL001917#";
	...
	function isAccessFNFPayroll(){
		...
		*/
		...
		$ses_fusion_id=get_user_fusion_id();
		$access_ids=" #FKOL001766#FKOL001709#FKOL004086#FKOL006124#FKOL007911#FKOL008639#FKOL008807#FCHA000264#FCHA000262#FKOL011173#FKOL007860#FKOL005386#FKOL007211#FCHA000326#FCHA000279#FCHA000280#FCHA000327#FCHA003519#FCHA000278#FCHA000283#FKOL014701#";
	...
	function isAccessFNFAccounts(){
		...
		*/
		...
		$ses_fusion_id=get_user_fusion_id();
		$access_ids=" #FKOL001725#FKOL005795#FKOL001730#FKOL012213#FJAM004503#FNOI000140#FKOL010888#FKOL008638#FCHA003550#FCHA003562#FCHA002016#FKOL014024#FKOL014734#FKOL014689#FKOL015102#FKOL015113#FKOL015404#FHWH009981#FKOL001919#FKOL001917#";
...
///////////////	
	...
	function is_access_master_entry(){
		...
		$ses_fusion_id=get_user_fusion_id();
		$access_ids="-#FKOL006359#FALB000189#FCEB000582#FKOL001916#FKOL001899#FMON002590#FJAM006076#FJAM005935#FJAM005464#FELS004207#FHIG000314#FKOL007108#FKOL012897#";
...
function is_access_announcment(){
	...
	*/
	...
	function is_update_profile($pfid){
		...
		$ses_omuid_id=get_user_omuid();
		$ses_fusion_id=get_user_fusion_id();
		$access_ids=" ##FCAS000953#FJAM002325#FCEB000748#FJAM004503#FMAN000342#FBLR000327#FMAN000343#FCEB000236#FCEB000492#FKOL001854#FKOL002245#FKOL004812#FKOL007562#FCEB000746#FKOL001901#FCHA000571#FCHA003182#FCHA002098#FKOL001900#";
...
/////////////	
	...
	function is_access_itdeclaration_dump()
	{
		$ret=false;
		$ses_fusion_id=get_user_fusion_id();
		$access_ids="-##FKOL000007#FKOL001730#FKOL012619#FKOL015826#FKOL015826#";
	...
	function specific_location_leave_approve(){
		...
		//FKOL004086 - mangal
		//FKOL006124 - (Debraj Banerjee 
		$access_ids="-##FKOL004086#FKOL006124#FKOL008639#FKOL007911#FKOL008807#FKOL011173#FKOL007860#FKOL005386#FKOL007211#FCHA000264#FCHA000326#FCHA000279#FCHA000280#FCHA000262#FCHA000327#FCHA003519#FCHA000278#FCHA000283#FKOL014701#FJAM005935#FJAM005877#FJAM006076#FALB000189#";
		if(strpos($access_ids,"#".$ses_fusion_id."#") == false) $ret=false;
		else $ret=true;
	...
	function is_access_zendesk_crm(){
		...
		$access_ids=" #FJAM005935#FJAM005935#FKOL000007#FKOL006487#FKOL015327#";
...
function it_assets_office_email_ids($user_id=null)
{
	...
	function isAccessNaps(){
		...
		$access_ids=" #FKOL008643#FKOL008803#FKOL001854#FKOL002245#FKOL004812#FCHA000327#FCHA000283#FCHA000268#FCHA000328#FCHA000272#FCHA003529#FCHA000326#FKOL001900#FKOL007078#FKOL010158#FKOL005837#";
	...
	function isAccessAssetManagement(){
		...
		*/
		...
		$access_ids=" #FKOL002504#FKOL005575#FKOL008262#FKOL008451#FKOL010158#FKOL005837#FKOL011477#FKOL012213#FJAM004503#FKOL012897#FNOI000565#FKOL010888#FKOL008638#FCHA003550#FCHA003562#FCHA002016#FKOL014024#FKOL014734#FKOL014689#FKOL015102#FKOL015113#FKOL015404#FHWH009981#FKOL015827#FKOL016690#";
...
function is_access_Cns_modules(){
	...
	$access_ids=""; $access_ids="#FKOL001725#FKOL007187#FKOL001732#FELS003317#FKOL001730#FKOL012895#FKOL001731#FKOL008610#FKOL012753#FKOL001961#FKOL001736#FKOL011684#FKOL008375#FKOL001736#FKOL001917#FKOL000003#FCHA000283#FKOL001709#FKOL012895#FKOL001766#FKOL015828#FALT002231#";
	$ret=false;
...
function isAccessFNFprocurement() {
    ...
    $ses_fusion_id = get_user_fusion_id();
    $access_ids = " #FKOL002504#FKOL001803#FKOL001780#FKOL001782#FKOL005575#FKOL001774#FKOL001790#FKOL005557#FKOL002505#FKOL001777#FKOL002501#FKOL001779#FKOL007297#FKOL007405#FKOL007232#FKOL007508#FKOL008233#FKOL006963#FCHE000112#FKOL001788#FKOL008638#FKOL008600#FKOL009320#FKOL008262#FKOL008451#FKOL008627#FKOL012213#FJAM004503#FDUR000125#FCHE000367#FKOL006366#FKOC000138#FMUM000048#FNOI000140#FJMP000071#FKOL011103#FKOL011751#FKOL001917#FKOL001919#FKOL011103#FKOL008610#FKOL001919#FKOL001917#FKOL016690#FKOL016690#";
...
function is_access_Call_modules(){
	...
	$access_ids=""; $access_ids="##FKOL007187#FKOL012753#FKOL011883#FMUM007616#FMUM007619#FMUM007630#FMUM007571#FMUM007577#FMUM007584#FMUM006346#FMUM007509#FMUM007516#FMUM007526#FMUM006114#FMUM006153#FMUM007529#FMUM007641#FMUM007649#";
	$ret=false;
