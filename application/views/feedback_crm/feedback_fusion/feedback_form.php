		...
		<div class="survey-main">
	     ...
	     <?php if(!empty($type) && $type == 'done'){ ?>
				...
				<div class="white-main">
					...
					<div class="survey-content">
						<div class="body-widget">
							  ...
							  <p style="text-align:center" ><br/><button onclick="javascript:window.close()" class="button-survey" type="button">&#8592 Feedback Received</button></p>
						</div>
					</div>
				</div>
			</div>
		  ...
		  <?php } else { ?>
			...
			<input type="hidden" value="<?php echo $crmID; ?>" name="crm_id">
			<input type="hidden" value="<?php echo $emailID; ?>" name="email_id">
								...
								<table class="table table-striped">
									...
									<?php foreach($values as $key=>$token){ ?>
									  <tr>
										...
										<?php foreach($optionsF as $keyop=>$tokenOP){ ?>
										<td>
											<label class="radio-inline"><input type="radio" value="<?php echo $keyop; ?>" name="<?php echo $key; ?>" required><?php //echo $tokenOP; ?></label>
										</td>
										<?php } ?>
									  </tr>
									<?php } ?>
				...
				<div class="white-main">					
					<div class="survey-content">
						...
						<div class="common-top">
							<div class="radio">
								<label>
									<input type="radio" value="1" name="fusion_services" required>
									An exceptional value, worth more than we expected
								</label>
							</div>
							<div class="radio">
								<label>
									<input type="radio" value="2" name="fusion_services" required>
									A good value, worth about what we expected
								</label>
							</div>
							<div class="radio">
								<label>
									<input type="radio" value="3" name="fusion_services" required>
									A poor value, worth less than what we expected
								</label>
							</div>
							<div class="radio">
								<label>
									<input type="radio" value="4" name="fusion_services" required>
									Undecided
								</label>
							</div>
						</div>
			...
			<div class="common-repeat">
				<div class="white-main">					
					<div class="survey-content">
						...
						<div class="common-top">
							<textarea class="form-control" id="customer_comments" name="customer_comments" required></textarea>
						</div>
					</div>
				</div>
			</div>
