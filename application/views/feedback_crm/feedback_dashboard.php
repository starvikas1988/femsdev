...
<div class="widget-body">
  <div class="row">
  <div class="col-md-6">
  <h4 style="padding-left:10px"><i class="fa fa-bar-chart"></i> <?php echo fdcrm_title(); ?></h4>
  </div>
  <div class="col-md-6">
...
<div class="panel panel-default">
  <div class="panel-heading"><b><?php echo fdcrm_title('1'); ?> Analytics - <i class="fa fa-calendar"></i> <?php echo $from_date != $to_date ? date('d M', strtotime($from_date)) ." - " .date('d M Y', strtotime($to_date)) : date('d M Y', strtotime($from_date)); ?></b></div>
  <div class="panel-body">	
	<div class="row">
...
<div class="panel panel-default">
  <div class="panel-heading"><b><?php echo fdcrm_title('1'); ?> - Daywise Analytics - <i class="fa fa-calendar"></i> <?php echo date('F Y', strtotime($currYear ."-".$currMonth."-01")); ?></b></div>
  <div class="panel-body">	
	<div class="row">	
