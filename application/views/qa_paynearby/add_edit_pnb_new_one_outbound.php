					 	...
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>Call Duration:</td>
										<td><input type="text" readonly class="form-control" id="call_duration" name="data[call_duration]" value="<?php echo $pnboutbound_new['call_duration'] ?>" required></td>
										<td>Incoming No.:</td>
							...
							<table class="table table-striped skt-table">
								...
								<tr>
									...
									<td>
										<select class="form-control pnb_ob_point pnb_ob_fatal" name="data[actioning_in_system]" required>
											...
											<option pnb_ob_val=0 pnb_ob_max=8 value="Fatal" <?php if($pnboutbound_new['actioning_in_system']=="Fatal") echo "selected"; ?>>Fatal</option>
										</select>
									</td>
								...
								<tr>
									...
									<td><input type="text" name="data[remark18]" value="<?php echo $pnboutbound_new['remark18']?>" class="form-control"/></td>
								</tr>
								
								<tr>
									<td>Call Summary:</td>
									<td colspan="6"><textarea class="form-control" name="data[call_summary]"><?php echo $pnboutbound_new['call_summary'] ?></textarea></td>
									</tr>
								
								<tr>
									<td>Feedback:</td>
									<td colspan="6"><textarea class="form-control" name="data[feedback]"><?php echo $pnboutbound_new['feedback'] ?></textarea></td>
								</tr>
								<tr>
									...
									<?php if($pnboutbound_id!=0){ ?>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Feedback Acceptance:</td><td colspan=6><?php echo $pnboutbound_new['agnt_fd_acpt'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weightbold">Agent Review:</td><td colspan=6><?php echo $pnboutbound_new['agent_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td><td colspan=6><?php echo $pnboutbound_new['mgnt_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td><td colspan=6><?php echo $pnboutbound_new['client_rvw_note'] ?></td></tr>
