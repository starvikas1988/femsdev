								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td>Phone Number:</td>
											<td><input type="text" class="form-control" name="data[phone]" value="<?php echo $qa_acg_curd['phone'] ?>" required></td>
										...
										<tr>
											...
											<td><input type="text" readonly id="acg_overall_score" name="data[overall_score]" class="form-control avonFatal" style="font-weight:bold" value="<?php echo $qa_acg_curd['overall_score'] ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point compliance" name="data[opening_call]" required>
													...
													<option acg_val=4 <?php echo $qa_acg_curd['opening_call'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option acg_val=0 <?php echo $qa_acg_curd['opening_call'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option acg_val=0 <?php echo $qa_acg_curd['opening_call'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point compliance" name="data[brand_name]" required>
													...
													<option acg_val=4 <?php echo $qa_acg_curd['brand_name'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option acg_val=0 <?php echo $qa_acg_curd['brand_name'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option acg_val=0 <?php echo $qa_acg_curd['brand_name'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[recorded_line]" required>
													
													<option acg_val=5 <?= $qa_acg_curd["recorded_line"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["recorded_line"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["recorded_line"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[rate_of_speech]" required>
													...
													<option acg_val=4 <?php echo $qa_acg_curd['rate_of_speech'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option acg_val=0 <?php echo $qa_acg_curd['rate_of_speech'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option acg_val=0 <?php echo $qa_acg_curd['rate_of_speech'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[overlapped_customer]" required>
													...
													<option acg_val=4 <?php echo $qa_acg_curd['overlapped_customer'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option acg_val=0 <?php echo $qa_acg_curd['overlapped_customer'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option acg_val=0 <?php echo $qa_acg_curd['overlapped_customer'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[energrtic]" required>
													...
													<option acg_val=4 <?= $qa_acg_curd["energrtic"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["energrtic"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point customer" name="data[call_on_hold]" required>
													...
													<option acg_val=3 <?= $qa_acg_curd["call_on_hold"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["call_on_hold"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["call_on_hold"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point customer" name="data[call_on_hold_reason]" required>
													...
													<option acg_val=3 <?= $qa_acg_curd["call_on_hold_reason"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["call_on_hold_reason"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["call_on_hold_reason"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[call_on_hold_resume]" required>
													...
													<option acg_val=3 <?= $qa_acg_curd["call_on_hold_resume"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["call_on_hold_resume"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["call_on_hold_resume"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[customer_query]" required>
													...
													<option acg_val=4 <?= $qa_acg_curd["customer_query"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["customer_query"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["customer_query"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[pause_recording_ssn]" required>
												
													<option acg_val=5 <?= $qa_acg_curd["pause_recording_ssn"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["pause_recording_ssn"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["pause_recording_ssn"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[convert_call_sales]" required>
													...
													<option acg_val=3 <?= $qa_acg_curd["convert_call_sales"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["convert_call_sales"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["convert_call_sales"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[pricing_tenurity]" required>
													...
													<option acg_val=3 <?= $qa_acg_curd["pricing_tenurity"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["pricing_tenurity"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["pricing_tenurity"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[right_plan_suggestion]" required>
													...
													<option acg_val=3 <?= $qa_acg_curd["right_plan_suggestion"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["right_plan_suggestion"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["right_plan_suggestion"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[plan_cover]" required>
													<option acg_val=3 <?= $qa_acg_curd["plan_cover"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["plan_cover"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["plan_cover"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[least_one_digital_option]" required>
													<option acg_val=4 <?= $qa_acg_curd["least_one_digital_option"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["least_one_digital_option"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["least_one_digital_option"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[email_order_summary]" required>
													<option acg_val=4 <?= $qa_acg_curd["email_order_summary"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["email_order_summary"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["email_order_summary"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[auto_IVR_reviewing]" required>
													<option acg_val=4 <?= $qa_acg_curd["auto_IVR_reviewing"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["auto_IVR_reviewing"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["auto_IVR_reviewing"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[press_one_approval]" required>
													<option acg_val=4 <?= $qa_acg_curd["press_one_approval"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["press_one_approval"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["press_one_approval"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[staying_online]" required>
													<option acg_val=4 <?= $qa_acg_curd["staying_online"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["staying_online"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["staying_online"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[asking_questions]" required>
													<option acg_val=4 <?= $qa_acg_curd["asking_questions"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["asking_questions"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["asking_questions"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[accurately_answer]" required>
													<option acg_val=4 <?= $qa_acg_curd["accurately_answer"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["accurately_answer"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["accurately_answer"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[technical_issue]" required>
													<option acg_val=4 <?= $qa_acg_curd["technical_issue"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["technical_issue"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["technical_issue"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[customers_behalf_IVR]" required>
													<option acg_val=4 <?= $qa_acg_curd["customers_behalf_IVR"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["customers_behalf_IVR"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["customers_behalf_IVR"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control acg_point acg_fatal" name="data[disclosure_verbatim]" required>
													<option acg_val=4 <?= $qa_acg_curd["disclosure_verbatim"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["disclosure_verbatim"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["disclosure_verbatim"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[summrized_the_order]" required>
													<option acg_val=2 <?= $qa_acg_curd["summrized_the_order"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["summrized_the_order"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["summrized_the_order"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control acg_point" name="data[closed_call_properly]" required>
													<option acg_val=3 <?= $qa_acg_curd["closed_call_properly"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option acg_val=0 <?= $qa_acg_curd["closed_call_properly"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option acg_val=0 <?= $qa_acg_curd["closed_call_properly"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
