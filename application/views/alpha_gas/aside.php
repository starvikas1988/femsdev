	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>alphagas/dashboard" class="menu-link">
				...
				<li class="menu-item open">
					...
					<a href="" class="menu-link submenu-toggle">
						...
						<span class="menu-text foldable">Alpha Gas</span>
					...
					<ul class="submenu" style="display:block">
						...
						<li>
							<a  href="<?php echo base_url()?>alphagas/newCustomer">
						...
						<?php } ?>
						<li>
							<a  href="<?php echo base_url()?>alphagas/customerSearch">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
						...
						<li>
							<a  href="<?php echo base_url()?>alphagas/customerList">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>alphagas/customerReport" class="menu-link">
