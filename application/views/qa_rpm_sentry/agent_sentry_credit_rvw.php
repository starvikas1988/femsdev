							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" class="form-control" id="call_date" onkeydown="return false;" name="call_date" value="<?php echo $clDate_val; ?>" disabled></td>
									</tr>
									<tr>
										...
										<input type="text" class="form-control" id="tl_names"  value="<?php echo $sentry_credit_data['tl_name']; ?>" readonly>
												<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $sentry_credit_data['tl_id'] ?>" disabled>
										</td>
									</tr>
									<tr>
										<td>Collector:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" name="data[collector]" value="<?php echo $sentry_credit_data['collector'] ?>" disabled></td>
										<td>Call Duration:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="call_duration" onkeydown="return false;" name="data[call_duration]" value="<?php echo $sentry_credit_data['call_duration'] ?>" disabled></td>
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control" id="sci" name="data[sci]" value="<?php echo $sentry_credit_data['sci'] ?>" disabled>
										</td>
										<td>Client:<span style="font-size:24px;color:red">*</span></td>
										<td>
											<input type="text" class="form-control" id="client" name="data[client]" value="<?php echo $sentry_credit_data['client'] ?>" disabled>
										</td>
										<td>Site/Location:<span style="font-size:24px;color:red">*</span></td>
										<td>
											<select class="form-control" name="data[site]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td><input type="text" class="form-control" name="data[call_id]" value="<?php echo $sentry_credit_data['call_id'] ?>" disabled></td>
									...
									<tr class="eml" style="height:25px; font-weight:bold">
										...
										<tr>
											<td class="eml1" rowspan=7>Opening</td>
												...
												<td>5.26</td>
												<td>
													<select class="form-control sentry_credit_point" id="sentry_Fatal1" name="data[begin_call_recording]" disabled>
												...
												<td colspan=2><input type="text" name="data[cmt1]" class="form-control" value="<?php echo $sentry_credit_data['cmt1'] ?>" disabled></td>
										</tr>
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal2" name="data[verify_speacking]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt2]" class="form-control" value="<?php echo $sentry_credit_data['cmt2'] ?>" disabled></td>
										</tr>
										...
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[email_requested]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt3]" class="form-control" value="<?php echo $sentry_credit_data['cmt3'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2 class="text-danger">Did collector Identify themselves by name prior to attempting to collect a debt?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal3" name="data[identify_themselves]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt4]" class="form-control" value="<?php echo $sentry_credit_data['cmt4'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2 class="text-danger">Did collector Identify collection agency by name prior to attempting to collect a debt?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal4" name="data[identify_collection_agency]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt5]" class="form-control" value="<?php echo $sentry_credit_data['cmt5'] ?>" disabled></td>
										</tr>
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal5" name="data[give_Mini_Miranda]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt6]" class="form-control" value="<?php echo $sentry_credit_data['cmt6'] ?>" disabled></td>
										</tr>
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal6" name="data[identify_original_creditor]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt7]" class="form-control" value="<?php echo $sentry_credit_data['cmt7'] ?>" disabled></td>
										</tr>
									...
									<tr>
										<td class="eml" rowspan=12>Call Progression</td>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[avoid_communicating_false]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt8]" class="form-control" value="<?php echo $sentry_credit_data['cmt8'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>Did the collector avoid abusive, rude or unprofessional behavior? (UDAAP)</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[avoid_unprofessional_behavior]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt9]" class="form-control" value="<?php echo $sentry_credit_data['cmt9'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>Did collector obtain reason for delinquency?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[reason_for_delinquency]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt10]" class="form-control" value="<?php echo $sentry_credit_data['cmt10'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>Did collector follow negotiation hierarchy?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[follow_negotiation_hierarchy]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt11]" class="form-control" value="<?php echo $sentry_credit_data['cmt11'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>Did the collector properly handle any dispute or complaint? (FDCPA)</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[handle_dispute]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt12]" class="form-control" value="<?php echo $sentry_credit_data['cmt12'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>Did collector offer appropriate resolutions based on information available?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[offer_appropriate_resolutions]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt13]" class="form-control" value="<?php echo $sentry_credit_data['cmt13'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2 class="text-danger">For accounts that resulted in a payment, did collector follow the appropriate script for the payment type, with the disabled disclosures for Debit Card, Credit Cards, Check by Phone and Post Dates?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal7" name="data[follow_appropriate_script]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt14]" class="form-control" value="<?php echo $sentry_credit_data['cmt14'] ?>" disabled></td>
										</tr>
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="sentry_Fatal8" name="data[checking_account]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt15]" class="form-control" value="<?php echo $sentry_credit_data['cmt15'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>If agency system notes have been reviewed, did collector correctly and accurately update the system notes?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[update_system_notes]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt16]" class="form-control" value="<?php echo $sentry_credit_data['cmt16'] ?>" disabled></td>
										</tr>
										<tr>
											<td colspan=2>Did the collector properly complete any promise tab disabled?</td>
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[complete_promise_tab]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt17]" class="form-control" value="<?php echo $sentry_credit_data['cmt17'] ?>" disabled></td>
										</tr>
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[OOS_disclosures]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt18]" class="form-control" value="<?php echo $sentry_credit_data['cmt18'] ?>" disabled></td>
										</tr>
										<tr>
											...
											<td>5.26</td>
											<td>
												<select class="form-control sentry_credit_point" id="" name="data[complete_file_upkeep_work]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt19]" class="form-control" value="<?php echo $sentry_credit_data['cmt19'] ?>" disabled></td>
										</tr>
										<tr>
											<td>VT Comment:</td>
								...
								<?php if($sentry_credit_data['attach_file']!=''){ ?>
											...
											<?php $attach_file = explode(",",$sentry_credit_data['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_sentry/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_sentry/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $sentry_credit_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $sentry_credit_data['client_rvw_note'] ?></td>
									</tr>

									<tr><td colspan="10" style="background-color:#C5C8C8"></td></tr>
									
									 <form id="form_agent_user" method="POST" action="">
										<input type="hidden" name="sentry_credit_id" class="form-control" value="<?php echo $sentry_credit_id; ?>">
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $sentry_credit_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $sentry_credit_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $sentry_credit_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($sentry_credit_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($sentry_credit_data['agent_rvw_note']==''){ ?>
