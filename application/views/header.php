...
<head>
    ...
    <?php if($url_data == 'mwpuat'){?>
        <link href="<?php echo base_url() ?>assets_home_v3/css/style_uat.css" rel="stylesheet">
     <?php } else {?>
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="javascript:void(0)">
                <?php /*?><?php if (get_user_company_id() == 3) { ?>
                    <img src="<?php echo base_url() ?>/assets_home_v3/brand_logo/omind_logo.svg" class="logo" alt="">
                <?php } else { ?>
                    <img src="<?php echo base_url() ?>/assets_home_v3/brand_logo/fusion_logo.svg" class="logo" alt="">
                <?php } ?><?php */?>
                <?=get_logo()?>
            </a>
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                ...
                <div class="dropdown">
                        <button type="button" class="btn btn-primary dropdown-toggle lang_btn transparent_background" data-bs-toggle="dropdown">
                            <img src="<?php echo base_url() 
                                        ?>assets_home_v3/images/language.svg" alt=""> <span id="lang_disp">English</span>
                        </button>
                    ...
                    <a href="<?php echo base_url() ?>femschat" class="hover_efect" target="_blank">
                        <img src="<?php echo base_url() ?>assets_home_v3/images/chat_message.svg" alt="">
                    </a>
                    <div class="dropdown log_out">
                        ...
                        <ul class="dropdown-menu">
							...
							<?php if(get_def_homepage() == "homev2"){ ?>
								<li><a class="dropdown-item" href="<?php echo base_url(); ?>/home/set_def_home_page/homev3"><img src="<?php echo base_url() ?>assets_home_v3/images/my_profile.svg" class="menu_icon_log" alt="">New Home</a></li>
							<?php }else{ ?>
																
								<li><a class="dropdown-item" href="<?php echo base_url(); ?>/home/set_def_home_page/homev2"><i class="fa fa-home menu_icon_log" aria-hidden="true"></i>Old Home</a></li>
                    ...
                    <a href="#" class="hover_efect" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight">
                        <img src="<?php echo base_url() ?>assets_home_v3/images/help.png" alt="">
                    </a>
                </div>
            </div>
        </div>
