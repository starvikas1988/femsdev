			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<form id="form_new_user" method="GET" action="<?php echo base_url('qa_apphelp/qa_feedback'); ?>">
							<div class="row">
								<div class="col-sm-3">
				...
				<div class="col-sm-12">
					<div class="card">
						<div class="card-body new-table">
							...
							$adt_id=0; ?>
								<div class="col-sm-6">
									<a class="btn btn-success" href="<?php echo base_url(); ?>qa_apphelp/add_edit_audit/<?php echo $adt_id ?>"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Add Audit</a>&nbsp;&nbsp;&nbsp;
									<!--<button class="btn btn-info dataAnalytics"><i class="fa fa-database" aria-hidden="true"></i>&nbsp;Data Analytics:</button>-->
								</div>
							<?php } ?>
							</div>
							<table class="table table-striped " id="datatablesSimple">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php $adt_id=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_apphelp/add_edit_audit/<?php echo $adt_id ?>"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Edit/Review</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
