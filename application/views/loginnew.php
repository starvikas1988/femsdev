...
<?php
	...
	if($brand=="3") $logoUrl = base_url()."assets_home_v3/brand_logo/omind_logo.svg?".time();
	else $logoUrl = base_url()."assets_home_v3/brand_logo/fusion_logo.svg?".time();
...
var logoUrl = "<?php echo base_url() ?>/assets_home_v3/brand_logo/fusion_logo.svg?<?php echo time() ?>";
if(brand=="3") logoUrl = "<?php echo base_url() ?>/assets_home_v3/brand_logo/omind_logo.svg?<?php echo time() ?>";
