  ...
  <section class="app-content">
    <div class="white_widget padding_3">
      <div class="avail_widget_br">
        <h2 class="avail_title_heading">Employee ID Card</h2>
      </div>
      <hr class="sepration_border" />
      <div class="body_widget">
        <h5 class="avail_title_heading">
            ...
            <div class="row">
              <?php if (!empty($agent_details['id'])) { ?>
                ...
                <div class="col-md-4" id="croppie-container">
                  ...
                  <div class="file_upload_style top_1 form-group">
                    <input type="file" class="form-control" accept=".png,.jpg,.jpeg" id="croppie-input">
                  </div>
                  <?php if (is_ppbl_check() != '1') { ?>
                    <button class="btn btn_padding filter_btn_blue croppie-upload">Upload Image</button>
                  <?php } ?>
          ...
          <div class="panel-body">
            <div class="row">
              ...
              <div class="col-md-4 generateCard" <?php if (empty($id_card)) { ?>style="display:none" <?php } ?>>
                <a href="<?php echo base_url() . "employee_id/generateCard/download/" . $agent_details['fusion_id']; ?>" class="btn btn_padding filter_btn">Download ID Card</a>
              </div>
