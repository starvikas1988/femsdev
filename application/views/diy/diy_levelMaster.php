	...
	<section class="app-content">
			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title" style="display:inline-block; line-height:30px">Level Master</h4>                        
                        <?php if(get_login_type() == "client" && get_role()=='client'){ ?>
                        <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#myModal">Add Level</button>
                        <?php } ?>
                    </header>
        ...
        <div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Level List</h4>
					</header>
					<hr class="widget-separator"/>
					<div class="widget-body clearfix">
						<div class="row">
                            ...
                            <thead>
                                <tr class="text-center bg-primary">
                                    ...
                                    <th style="border-bottom-width: 0px; border: 1px solid #ddd;" class="text-center">Level Name</th>
                            ...
                            <?php 
							$sl=0;
                            foreach($levelMaster as $key=>$course): 
								$sl++;
							?>
                                <tr>
                                    ...
                                    <?php }*/ ?>     
                                        ...
                                        <?php
                                            ...
                                            //echo "";
                                        ?>
                                        <a href="delete_level?id=<?php echo $id;?>" class='btn btn-danger' onclick="return confirm('Are you sure, you want to delete it?')"><i class='fa fa-trash-o' aria-hidden='true'></i></a>                                   
                                    </td>									
                                </tr>
                            <?php endforeach; ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="padding:3px 0px;">
                        <div class="form-group">
                            <label class="col-md-4" style="line-height:37px;">level Name</label>
                            <div class="col-md-8">
...
<div id="myCourseModal" class="modal fade" role="dialog" style="font-size:90%; ">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="<?php echo base_url('diy/add_level'); ?>">
                <div class="modal-header" style="padding:8px 15px;">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
