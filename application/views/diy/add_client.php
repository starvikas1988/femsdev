				...
				<div class="widget">
					...
					<div class="widget-body clearfix">
						...
						<form class="myform" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="blood_group">Role</label>
											<select class="form-control" id="role" name="role" required>
												...
												<option value="<?php echo $token->name;?>" <?php if($token->name=='Teacher'){echo "selected=default";}?>><?php echo $token->name; ?></option>
												<?php } ?>
											</select>
									</div>
								</div> 
							...
							<?php if(!empty($c_data['dob'])){
								$dob = date('m/d/Y', strtotime($c_data['dob']));
							}else{
								$dob ="";
							}
							?>
							<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="dob" value="<?php echo $dob; ?>" name="dob" autocomplete="off" readonly >
									</div>								
								</div>
							...
							?>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-control" name="diy_country" id="country_id" <?php echo $req; ?>>
											...
											<?php 
											$selected ="";
											if($cnt->id == $c_data['country_id']){
												$selected = "selected";
											}?>
												<option value="<?php echo $cnt->id ?>" <?php echo $selected;?>><?php echo $cnt->name ?></option>
											<?php endforeach; ?>							
										</select>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="countryCode" value="<?php echo $country_code->phonecode;?>" readonly>
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label for="phone">Mobile No:</label>
										<input type="number" pattern="[1-9]{1}[0-9]{9}" class="form-control" id="mobile" placeholder="Mobile No" name="diy_mobile" value='<?php echo $c_data['mobile'];?>' min="10" <?php echo $req; ?>>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="form-control" name="TimeZone" id="TimeZone" <?php echo $req; ?>>
												...
												<?php 
												$selected = "";
												if($client['GMT_offset'] == $c_data['TimeZone']){
													$selected = "selected";
												}?>
												<option value="<?php echo $client['GMT_offset']."#".$client['id'] ?>" <?php echo $selected;?>><?php echo $client['gmtCountryName'] ?></option>
											<?php endforeach; ?>
