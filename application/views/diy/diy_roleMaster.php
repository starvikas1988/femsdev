			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Role List						
						<?php if(get_login_type() == "client" && get_role()=='client'){ ?>
                        <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#myModal">Add Role</button>
                        <?php } ?>
						...
						<div class="row">
                            ...
                            <thead>
                                <tr class="text-center bg-primary">
                                    ...
                                    <th style="border-bottom-width: 0px; border: 1px solid #ddd;" class="text-center">Role Name</th>
                                    <th style="border-bottom-width: 0px; border: 1px solid #ddd;" class="text-center">Role Description</th>
                                ...
                                <tr>
                                    ...
                                    <?php }*/ ?>
                                        ...
                                        <?php
                                            ...
                                            ?>   
                                            <a href="delete_role?id=<?php echo $id;?>" class="btn btn-danger" onclick="return confirm('Are you sure, you want to delete it?')"><i class='fa fa-trash-o' aria-hidden='true'></i></a>;
...
<div id="myModal" class="modal fade" role="dialog" style="font-size:90%; ">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="<?php echo base_url('diy/add_role'); ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="padding:3px 0px;">
                        <div class="form-group">
                            <label class="col-md-4" style="line-height:37px;">Role Name</label>
                            <div class="col-md-8">
					...
					<div class="row" style="padding:3px 0px;">
                        <div class="form-group">
                            <label class="col-md-4" style="line-height:37px;">Role Description</label>
                            <div class="col-md-8">
