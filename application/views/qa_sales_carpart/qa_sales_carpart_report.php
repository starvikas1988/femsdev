		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">Sales Carpart Inbound</h4></header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('qa_sales_carpart/qa_sales_carpart_report'); ?>">	
						...
						<div class="row">
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>qa_sales_carpart/qa_sales_carpart_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
