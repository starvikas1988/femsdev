								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="form-control"id="" name="campaign" required>
											...
											<option <?php echo $campaign=='sales'?"selected":""; ?> value="sales">SALES</option>
											<option <?php echo $campaign=='service'?"selected":""; ?> value="service">SERVICE</option>
											<option <?php echo $campaign=='inbound'?"selected":""; ?> value="inbound">INBOUND</option>
											<option <?php echo $campaign=='inbound2'?"selected":""; ?> value="inbound2">INBOUND Version 2</option>
										</select>
									</div>
								</div>
								...
								<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<?php $adid=$row['id']; ?>
													<a class="btn btn-success agentFeedback" href="<?php echo base_url(); ?>qa_sales_carpart/process/agnt_feedback/<?php echo $adid ?>/<?php echo $campaign ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">View/Review</a>
											</td>
										</tr>
										<?php endforeach; ?>
									</tbody>
