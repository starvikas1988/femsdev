...
<head>
	...
	.second_box {
		...
		overflow: visible;
		background: #FFF;
		-webkit-box-shadow: 0 6px 22px 0 rgb(0 0 0 / 35%);
		box-shadow: 0 6px 22px 0 rgb(0 0 0 / 35%);
		display: -webkit-box;
		display: -ms-flexbox;
		display: inline-block;
		display: -webkit-box;
				  ...
				  <!--<div class="second_box">
					<div class="msg_box">
						<div class="body-widget">
							...
							<p>This is to keep you posted that MWP will be down from <br /><span><strong>
...
29TH AUGUST 2022, 10AM IST [29TH AUGUST 2022, 00:30PM EST]</strong></span><br />due to server migration.Your inconvenience is highly regretted.</p>
					...
					<div class="footer-widget text-center">
				  		<span>&copy; <?php /*?><?php echo date("Y");?><?php */?> Omind Technologies</span>
				 	</div>			
				  </div>-->
			<!--start message area html elements here 12.08.2022-->  
