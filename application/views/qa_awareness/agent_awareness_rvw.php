							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="10" id="theader" style="font-size:30px">Awareness CHAT QA FORM</td>
										<?php
										if($pre_booking_id==0){
									...
									<tr style="height:45px">
										...
										<td class="eml2" colspan=6>Remarks</td>
										</tr>
									...
									<tr>
										...
										<td>											
											<select class="form-control affinity_point business" name="data[Category5]" disabled>
												<option selected value=''>Select</option>
										...
										<td colspan=4><input type="text" class="form-control" name="data[cmt5]" value="<?php echo $awareness['cmt5'] ?>"disabled></td>
									</tr>
