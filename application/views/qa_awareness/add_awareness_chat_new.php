							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="12" id="theader" style="font-size:30px">Awareness- CHAT QA FORM</td>
										<?php
										if($pre_booking_id==0){
									...
									<tr>
										...
										<td colspan="2">Case/Ticket #:</td>
										<td colspan="4"><input type="text" class="form-control" id="caseTicket" name="data[caseTicket]" value="<?php echo $awareness['caseTicket'] ?>" required></td>
									</tr>
									<tr>
										...
										<td colspan="2" style="font-weight:bold" colspan="1">Cust Rate:</td>
										<td colspan="4">
									...
									<tr>
										<td rowspan=2 class="1">BUSINESS CRITICAL</td>
									...
									<tr>
										<td class="" colspan=4>Did the agent create a case and document properly. Agent put appropriate tagging to every interaction.</td>

										<td>											
											<select class="form-control affinity_point business" name="data[Category5]" required>
												<option affinity_val=5  <?php echo $awareness['Category5']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option affinity_val=5  <?php echo $awareness['Category5']=='No'?"selected":""; ?> value="No">No</option>
												
												<option affinity_val=0  <?php echo $awareness['Category5']=='NA'?"selected":""; ?> value="NA">NA</option>
											</select>
										</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt5]" value="<?php echo $awareness['cmt5'] ?>"></td>
									</tr>
									
									
									<tr>
										<td rowspan=4 class="1">CUSTOMER CRITICAL</td>

										<td class="" colspan=4>The agent greet and identified themselves to the customer.</td>

										<td>											
											<select class="form-control affinity_point customer" name="data[Category6]" required>
												<option affinity_val=2  <?php echo $awareness['Category6']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option affinity_val=2  <?php echo $awareness['Category6']=='No'?"selected":""; ?> value="No">No</option>
								   ...
								   <tr>
										<td class="" colspan=4>The agent showed politeness, courtesy, and professionalism throughout interaction. Showed empathy as appropriate.</td>
									...
									<tr>
										<td class="" colspan=4>The agent must thank the customer for contacting at the end of every chat session.</td>

										<td>											
											<select class="form-control affinity_point customer" name="data[Category9]" required>
												<option affinity_val=2  <?php echo $awareness['Category9']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option affinity_val=2  <?php echo $awareness['Category9']=='No'?"selected":""; ?> value="No">No</option>
									...
									<?php if($pre_booking_id==0){ ?>
									<tr>
										<td colspan=2>Upload Image Files (jpg,jpeg,png)</td>
										<td colspan=4><input type="file" multiple class="form-control imageFile" id="attach_img_file" name="attach_img_file[]"></td>
									</tr>
									<?php }else{ ?>
									<tr>	
										<td colspan=2>Upload Files(jpg,jpeg,png)</td>
										<?php if($awareness['attach_img_file']!=''){ ?>
											<td colspan=6>
												<?php $attach_img_file = explode(",",$awareness['attach_img_file']);
												 foreach($attach_img_file as $mp){ ?>
													<button class="btn btn-info"><a href="<?php echo base_url(); ?>qa_files/awareness/<?php echo $mp; ?>"><?php echo $mp; ?></a></button>
												 <?php } ?>
											</td>
										<?php }else{
