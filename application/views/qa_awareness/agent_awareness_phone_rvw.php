							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="10" id="theader" style="font-size:30px">Awareness Phone QA FORM</td>
										<?php
										if($pre_booking_id==0){
								   ...
								   <tr>
									...
									<tr>
										...
										<td>											
											<select class="form-control affinity_point customer" name="data[Category11]" disabled>
												<option selected value=''>Select</option>
										...
										<td colspan=4><input type="text" class="form-control" name="data[cmt11]" value="<?php echo $awareness['cmt11'] ?>"disabled></td>
									</tr>
									...
									<tr>
										...
										<td>											
											<select class="form-control affinity_point customer" name="data[Category12]" disabled>
												<option selected value=''>Select</option>
										...
										<td colspan=4><input type="text" class="form-control" name="data[cmt12]" value="<?php echo $awareness['cmt12'] ?>"disabled></td>
									</tr>
