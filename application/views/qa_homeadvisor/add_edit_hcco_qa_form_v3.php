								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" id="original_sr_id" name="data[original_sr_id]"  value="<?php echo $hcco_v3_data['original_sr_id']; ?>" class="form-control" required>
											</td>
											<td>New SR (if applicable):<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" id="new_sr_id" name="data[new_sr_id]"  value="<?php echo $hcco_v3_data['new_sr_id']; ?>" class="form-control" required>
											</td>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point business" name="data[introduction_purpose]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[verify_person_speaking]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[incorrect_branding]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[no_branding]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[purpose_of_call]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point business" name="data[follow_up]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[probe_open_ended_questions]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[review_description]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[offer_review]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point compliance" name="data[marketplace_Pre_Submit_Guidelines]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[incorrect_CTT]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[verify_zipp_code]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[pros_presented_name]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[detailed_description]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[pre_OL_possibilty_veribiage]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[pre_submit_expecatations]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point compliance" name="data[marketplace_Post_Submit_Guidelines]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[incorrect_information]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[proper_expectations]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[post_OL_possibilty_veribiage]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[transfer_not_offered]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point compliance" name="data[pre_Priced_Presentation]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[pre_priced_eligible]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[pre_priced_presented_incorrectly]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point compliance" name="data[pre_Priced_Situational_Policy]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[accurate_information]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[legal_language_script]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[overpromised]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[no_coupon_offered]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[coupon_offered_not_needed]" required>
									...
									<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control hcco_v3_point customer" name="data[educate]" required>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control" name="data[scope_of_services]" required>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control" name="data[educate_cross_sell]" required>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control" name="data[mention_Agni_App]" required>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control" name="data[inaccurate_information]" required>
									...
									<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control hcco_v3_point business" name="data[cross_sell]" required>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control" name="data[cross_sell_openended_question]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point customer" name="data[tone]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[tone_not_professional]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[actively_listen_customer]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[inappropriate_rapport]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[show_empathy]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[used_internal_jargon]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point business" name="data[disposition_tagging]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[disposition_SRs]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[incorrect_disposition]" required>
									...
									<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[missing_summary_notes]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[missing_customer_name]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control hcco_v3_point customer" name="data[correct_action]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[take_correct_action]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[do_what_customer_told]" required>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control" name="data[address_customer_concern]" required>
									...
									<tr>
											...
											<td rowspan=10></td>
											<td>
												<input type="text" class="form-control1" id="hcco_Fail1" name="data[critical_Fail_Behaviors]" value="<?php echo $hcco_v3_data['critical_Fail_Behaviors']; ?>" readonly>

												<!-- <select class="form-control hcco_v3_point fatal_point"  readonly id="hcco_Fail1" onkeydown="return false;" name="data[critical_Fail_Behaviors]">
									    ...
									    <tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail2" name="data[recorded_line]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail3" name="data[leading_customer]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail4" name="data[Submitting_SR]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail5" name="data[credit_Card_information]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail6" name="data[adding_DNC]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail7" name="data[no_Disposition]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail8" name="data[offered_pre_priced]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail9" name="data[presented_SR]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control hcco_v3_point fatal_point" id="hcco_Fail10" name="data[flagrantly_inappropriate_response]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[stella_phishing]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[avoiding_Stella_Survey]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[attempted_Cross_Sell]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[AHT_agent]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[AHT_customer]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[AHT_process]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[AHT_technology]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[Conversion_agent]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[Conversion_customer]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[Conversion_process]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[Conversion_technology]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[SR_agent]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[SR_customer]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[SR_process]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[SR_technology]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[CSAT_agent]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[CSAT_customer]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[CSAT_process]" required>
										...
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control" name="data[CSAT_technology]" required>
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<tr>
											<td>Call Summary:</td>
											<td colspan=2><textarea class="form-control" name="data[call_summary]"><?php echo $hcco_v3_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" name="data[feedback]"><?php echo $hcco_v3_data['feedback'] ?></textarea></td>
										</tr>
										<tr>
										...
										<?php if ($hcco_qav3_id != 0) { ?>
											<tr>
												...
												<td colspan=4><?php echo $hcco_v3_data['agnt_fd_acpt'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td>
												<td colspan=4><?php echo $hcco_v3_data['agent_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td>
												<td colspan=4><?php echo $hcco_v3_data['mgnt_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td>
												<td colspan=4><?php echo $hcco_v3_data['client_rvw_note'] ?></td>
											</tr>
