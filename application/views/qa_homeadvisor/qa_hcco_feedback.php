						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_homeadvisor/qa_hcco_feedback'); ?>">
							<div class="row">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success blains-effect" a href="<?php echo base_url()?>Qa_homeadvisor/qa_hcco_feedback" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<h4 class="widget-title">
									<div class="row">
								<div class="col-sm-12">
									<div class="pull-left">HCCO QA FORM Version-3</div>
									</div>
									...
									<div class="pull-right">
										...
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_homeadvisor/add_edit_hcco_qa_form_v3/<?php echo $hcco_qav3_id ?>">Add Feedback</a>
									</div>	
									<?php } ?>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<h4 class="widget-title">
									<div class="row">
								<div class="col-sm-12">
									<div class="pull-left"> HCCO VERSION-2</div>
									</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client" || is_quality_access_trainer()==true){ 
										$hcco_v2_id=0;
									?>
									<div class="pull-right">
										...
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_homeadvisor/add_edit_hcco_v2/<?php echo $hcco_v2_id ?>">Add Feedback</a>
									</div>	
									<?php } ?>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									foreach($qa_hcco_v2_data as $row): ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php echo $row['auditor_name']; ?></td>
										<td><?php echo $row['audit_date']; ?></td>
										...
										<td><?php echo $row['agent_rvw_date']; ?></td>
										<td><?php echo $row['mgnt_rvw_name']; ?></td>
										<!-- <td><?php echo $row['mgnt_rvw_by']; ?></td> -->
										<td><?php echo $row['mgnt_rvw_date']; ?></td>
										<td>
											<?php $hcco_v2_id=$row['id']; ?>
											
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_homeadvisor/add_edit_hcco_v2/<?php echo $hcco_v2_id ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<h4 class="widget-title">
									<div class="row">
								<div class="col-sm-12">
									<div class="pull-left">HCCO SR COMPLIANCE</div>
									</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client" || is_quality_access_trainer()==true){ 
										$hcco_sr_id=0;
									?>
									<div class="pull-right">
										...
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_homeadvisor/add_edit_hcco_sr/<?php echo $hcco_sr_id ?>">Add Feedback</a>
									</div>	
									<?php } ?>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_homeadvisor/add_edit_hcco_sr/<?php echo $hcco_sr_id ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
					...
					<div class="row">
						<div class="col-md-12">
								...
								<h4 class="widget-title">
									<div class="row">
								<div class="col-sm-12">
									<div class="pull-left">HCCO SR COMPLIANCE Version-2</div>
									</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client" || is_quality_access_trainer()==true){ 
										$hcco_srv2_id=0;
									?>
									<div class="pull-right">
										...
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_homeadvisor/add_edit_hcco_sr_v2/<?php echo $hcco_srv2_id ?>">Add Feedback</a>
									</div>	
									<?php } ?>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									foreach($hcco_sr_v2_data as $row): ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php echo $row['auditor_name']; ?></td>
										<td><?php echo $row['audit_date']; ?></td>
										...
										<td><?php echo $row['mgnt_rvw_date']; ?></td>
										<td>
											<?php $hcco_srv2_id=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_homeadvisor/add_edit_hcco_sr_v2/<?php echo $hcco_srv2_id ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
