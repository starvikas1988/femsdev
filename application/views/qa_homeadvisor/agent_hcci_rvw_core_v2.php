									...
									<tbody>
										...
										<tr>
											...
											<td colspan=2>
											    ...
											    <select class="form-control" name="data[cmt1]" disabled>
													<option value="">-Select-</option>
													<option value="Did not understand the issue(s)" <?= ($agnt_feedback['cmt1']=="Did not understand the issue(s)")?"selected":"" ?>>Did not understand the issue(s)</option>
													<option value="Did not probe to identify customer issue(s)" <?= ($agnt_feedback['cmt1']=="Did not probe to identify customer issue(s)")?"selected":"" ?>>Did not probe to identify customer issue(s)</option>
													<option value="Did not ask the right kind of follow up question" <?= ($agnt_feedback['cmt1']=="Did not ask the right kind of follow up question")?"selected":"" ?>>Did not ask the right kind of follow up question</option>
												</select>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt2]" disabled>
													<option value="">-Select-</option>
													<option value="Did not resolve one or more issues" <?= ($agnt_feedback['cmt2']=="Did not resolve one or more issues")?"selected":"" ?>>Did not resolve one or more issues</option>
													<option value="Did not proactively offer help when it was warranted" <?= ($agnt_feedback['cmt2']=="Did not proactively offer help when it was warranted")?"selected":"" ?>>Did not proactively offer help when it was warranted</option>
													<option value="Information given to user was inaccurate" <?= ($agnt_feedback['cmt2']=="Information given to user was inaccurate")?"selected":"" ?>>Information given to user was inaccurate</option>
												</select>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt3]" disabled>
													<option value="">-Select-</option>
													<option value="Did not request accepted point(s) of verification" <?= ($agnt_feedback['cmt3']=="Did not request accepted point(s) of verification")?"selected":"" ?>>Did not request accepted point(s) of verification</option>
													<option value="Points of verification provided by user did not match account details, but agent proceeded" <?= ($agnt_feedback['cmt3']=="Points of verification provided by user did not match account details, but agent proceeded")?"selected":"" ?>>Points of verification provided by user did not match account details, but agent proceeded</option>
												</select>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt4]" disabled>
													<option value="">-Select-</option>
													<option value="Did not follow the workflow correctly" <?= ($agnt_feedback['cmt4']=="Did not follow the workflow correctly")?"selected":"" ?>>Did not follow the workflow correctly</option>
													<option value="Followed incorrect workflow" <?= ($agnt_feedback['cmt4']=="Followed incorrect workflow")?"selected":"" ?>>Followed incorrect workflow</option>
													<option value="Did not adhere to policy" <?= ($agnt_feedback['cmt4']=="Did not adhere to policy")?"selected":"" ?>>Did not adhere to policy</option>
													<option value="Misunderstood how to address the issue(s)" <?= ($agnt_feedback['cmt4']=="Misunderstood how to address the issue(s)")?"selected":"" ?>>Misunderstood how to address the issue(s)</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt5]" disabled>
													<option value="">-Select-</option>
													<option value="Did not empathize when empathy was needed" <?= ($agnt_feedback['cmt5']=="Did not empathize when empathy was needed")?"selected":"" ?>>Did not empathize when empathy was needed</option>
													<option value="Over-apologized" <?= ($agnt_feedback['cmt5']=="Over-apologized")?"selected":"" ?>>Over-apologized</option>
													<option value="Did not introduce themselves to the user" <?= ($agnt_feedback['cmt5']=="Did not introduce themselves to the user")?"selected":"" ?>>Did not introduce themselves to the user</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt6]" disabled>
													<option value="">-Select-</option>
													<option value="Did not communicate steps taken to the user" <?= ($agnt_feedback['cmt6']=="Did not communicate steps taken to the user")?"selected":"" ?>>Did not communicate steps taken to the user</option>
													<option value="Agent was not in control of the call" <?= ($agnt_feedback['cmt6']=="Agent was not in control of the call")?"selected":"" ?>>Agent was not in control of the call</option>
													<option value="Gave inaccurate information to the user" <?= ($agnt_feedback['cmt6']=="Gave inaccurate information to the user")?"selected":"" ?>>Gave inaccurate information to the user</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt7]" disabled>
													<option value="">-Select-</option>
													<option value="Long silences were present during the interaction" <?= ($agnt_feedback['cmt7']=="Long silences were present during the interaction")?"selected":"" ?>>Long silences were present during the interaction</option>
													<option value="Agent did not allow user to finish their thoughts before responding" <?= ($agnt_feedback['cmt7']=="Agent did not allow user to finish their thoughts before responding")?"selected":"" ?>>Agent did not allow user to finish their thoughts before responding</option>
													<option value="Agent's tone was not consistent throughout conversation" <?= ($agnt_feedback['cmt7']=="Agent's tone was not consistent throughout conversation")?"selected":"" ?>>Agent's tone was not consistent throughout conversation</option>
													<option value="Pace of speech made the agent difficult to follow" <?= ($agnt_feedback['cmt7']=="Pace of speech made the agent difficult to follow")?"selected":"" ?>>Pace of speech made the agent difficult to follow</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt8]" disabled>
													<option value="">-Select-</option>
													<option value="Agent did not request permission to place user on hold" <?= ($agnt_feedback['cmt8']=="Agent did not request permission to place user on hold")?"selected":"" ?>>Agent did not request permission to place user on hold</option>
													<option value="Agent did not convey a hold duration to the customer" <?= ($agnt_feedback['cmt8']=="Agent did not convey a hold duration to the customer")?"selected":"" ?>>Agent did not convey a hold duration to the customer</option>
													<option value="Agent did not check in with the user to update estimated time" <?= ($agnt_feedback['cmt8']=="Agent did not check in with the user to update estimated time")?"selected":"" ?>>Agent did not check in with the user to update estimated time</option>
													<option value="Hold was inappropriate or unnecessary" <?= ($agnt_feedback['cmt8']=="Hold was inappropriate or unnecessary")?"selected":"" ?>>Hold was inappropriate or unnecessary</option>
													<option value="Agent placed the user on 'Mute' rather than using the hold button" <?= ($agnt_feedback['cmt8']=="Agent placed the user on 'Mute' rather than using the hold button")?"selected":"" ?>>Agent placed the user on 'Mute' rather than using the hold button</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt9]" disabled>
													<option value="">-Select-</option>
													<option value="Missing date" <?= ($agnt_feedback['cmt9']=="Missing date")?"selected":"" ?>>Missing date</option>
													<option value="Missing agent name" <?= ($agnt_feedback['cmt9']=="Missing agent name")?"selected":"" ?>>Missing agent name</option>
													<option value="Missing or incomplete note of action taken" <?= ($agnt_feedback['cmt9']=="Missing or incomplete note of action taken")?"selected":"" ?>>Missing or incomplete note of action taken</option>
													<option value="Incorrect Dash note format used" <?= ($agnt_feedback['cmt9']=="Incorrect Dash note format used")?"selected":"" ?>>Incorrect Dash note format used</option>
													<option value="Incomplete relevant information in notes" <?= ($agnt_feedback['cmt9']=="Incomplete relevant information in notes")?"selected":"" ?>>Incomplete relevant information in notes</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt10]" disabled>
													<option value="">-Select-</option>
													<option value="Disposition was not updated correctly with new reply" <?= ($agnt_feedback['cmt10']=="Disposition was not updated correctly with new reply")?"selected":"" ?>>Disposition was not updated correctly with new reply</option>
													<option value="Incorrect disposition chosen" <?= ($agnt_feedback['cmt10']=="Incorrect disposition chosen")?"selected":"" ?>>Incorrect disposition chosen</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" name="data[cmt11]" disabled>
													<option value="">-Select-</option>
													<option value="The Agent did NOT perform Lead Audit Interview in BETTI." <?= ($agnt_feedback['cmt11']=="The Agent did NOT perform Lead Audit Interview in BETTI.")?"selected":"" ?>>The Agent did NOT perform Lead Audit Interview in BETTI.</option>
													<option value="The Agent did NOT perform the Audit on the CORRECT SR in BETTI." <?= ($agnt_feedback['cmt11']=="The Agent did NOT perform the Audit on the CORRECT SR in BETTI.")?"selected":"" ?>>The Agent did NOT perform the Audit on the CORRECT SR in BETTI.</option>
													<option value="Performed Lead Audit Interview in BETTI, did NOT Select Customer Serious" <?= ($agnt_feedback['cmt11']=="Performed Lead Audit Interview in BETTI, did NOT Select Customer Serious")?"selected":"" ?>>Performed Lead Audit Interview in BETTI, did NOT Select Customer Serious</option>
												</select>
												<!-- <input type="text" name="data[cmt1]" class="form-control" value="<?php //echo $agnt_feedback['cmt1'] ?>"> -->
											</td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
							...
							<div class="table-responsive top-space">
								<table class="table table-striped skt-table" width="100%">
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<td>Earned Point:</td><td ><input type="text" readonly class="form-control" id="compliance_earned_score" name="data[compliance_earned_score]" value="<?php echo $agnt_feedback['compliance_earned_score'] ?>"></td>
									</tr>
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<td>Possible Point:</td><td ><input type="text" readonly class="form-control" id="compliance_possible_score" name="data[compliance_possible_score]" value="<?php echo $agnt_feedback['compliance_possible_score'] ?>"></td>
									</tr>
									<tr style="font-weight:bold; background-color:#D7BDE2">
