						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="6" id="theader" style="font-size:40px">HCCI [CORE V2]</td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control avon_point compliance" name="data[brand]" required>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point compliance" name="data[sla]" required>
													...
													<option hcci_val=1 <?php echo $avon_data['sla'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option hcci_val=0 <?php echo $avon_data['sla'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option hcci_val=0 <?php echo $avon_data['sla'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point compliance" name="data[suggested_closing_spiel]" required>
													...
													<option hcci_val=1 <?= $avon_data["suggested_closing_spiel"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["suggested_closing_spiel"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["suggested_closing_spiel"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point compliance" name="data[additional_assistance]" required>
													...
													<option hcci_val=1 <?php echo $avon_data['additional_assistance'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option hcci_val=0 <?php echo $avon_data['additional_assistance'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option hcci_val=0 <?php echo $avon_data['additional_assistance'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point compliance" name="data[spiel_adherance]" required>
													...
													<option hcci_val=1 <?php echo $avon_data['spiel_adherance'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
													<option hcci_val=0 <?php echo $avon_data['spiel_adherance'] == "Fail" ? "selected" : ""; ?> value="Fail">Fail</option>
													<option hcci_val=0 <?php echo $avon_data['spiel_adherance'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point compliance" name="data[use_proper_script]" required>
													...
													<option hcci_val=2 <?= $avon_data["use_proper_script"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["use_proper_script"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["use_proper_script"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[acknowledge_issue]" required>
													...
													<option hcci_val=1 <?= $avon_data["acknowledge_issue"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["acknowledge_issue"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["acknowledge_issue"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[empathy_statement]" required>
													...
													<option hcci_val=1 <?= $avon_data["empathy_statement"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["empathy_statement"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["empathy_statement"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[provide_assurance]" required>
													...
													<option hcci_val=1 <?= $avon_data["provide_assurance"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["provide_assurance"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["provide_assurance"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[information_shared]" required>
													...
													<option hcci_val=1 <?= $avon_data["information_shared"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["information_shared"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["information_shared"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[probing_question]" required>
													...
													<option hcci_val=1 <?= $avon_data["probing_question"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["probing_question"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["probing_question"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[call_back]" required>
													...
													<option hcci_val=1 <?= $avon_data["call_back"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["call_back"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["call_back"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[active_listening]" required>
													...
													<option hcci_val=1 <?= $avon_data["active_listening"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["active_listening"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["active_listening"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[interruption]" required>
													...
													<option hcci_val=1 <?= $avon_data["interruption"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["interruption"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["interruption"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[dead_air]" required>
													<option hcci_val=1 <?= $avon_data["dead_air"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["dead_air"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["dead_air"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[grammar_usage]" required>
													<option hcci_val=1 <?= $avon_data["grammar_usage"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["grammar_usage"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["grammar_usage"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[professionalism]" required>
													<option hcci_val=1 <?= $avon_data["professionalism"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["professionalism"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["professionalism"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[interact_with_intention]" required>
													<option hcci_val=1 <?= $avon_data["interact_with_intention"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["interact_with_intention"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["interact_with_intention"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[strong_ownership]" required>
													<option hcci_val=1 <?= $avon_data["strong_ownership"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["strong_ownership"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["strong_ownership"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[enthusiasm]" required>
													<option hcci_val=1 <?= $avon_data["enthusiasm"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["enthusiasm"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["enthusiasm"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point customer" name="data[tailored_contact]" required>
													<option hcci_val=1 <?= $avon_data["tailored_contact"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["tailored_contact"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["tailored_contact"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point business" name="data[avon_security]" required>
													<option hcci_val=4 <?= $avon_data["avon_security"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["avon_security"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["avon_security"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point business" name="data[send_right_approver]" required>
													<option hcci_val=1 <?= $avon_data["send_right_approver"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["send_right_approver"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["send_right_approver"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point business" name="data[efficiency_of_action]" required>
													<option hcci_val=1 <?= $avon_data["efficiency_of_action"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["efficiency_of_action"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["efficiency_of_action"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point business" name="data[documentation]" required>
													<option hcci_val=1 <?= $avon_data["documentation"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["documentation"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["documentation"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control avon_point business" name="data[proper_disposition_tagging]" required>
													<option hcci_val=4 <?= $avon_data["proper_disposition_tagging"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["proper_disposition_tagging"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["proper_disposition_tagging"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr class="fatal">
											...
											<td>
												<select class="form-control avon_point avon_fatal" name="data[resolved_the_concerns]" required>
													<option hcci_val=0 <?= $avon_data["resolved_the_concerns"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["resolved_the_concerns"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["resolved_the_concerns"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
										...
										<tr class="fatal">
											...
											<td>
												<select class="form-control avon_point avon_fatal" name="data[first_response]" required>
													<option hcci_val=0 <?= $avon_data["first_response"] == "Pass" ? "selected" : "" ?> value="Pass">Pass</option>
													<option hcci_val=0 <?= $avon_data["first_response"] == "Fail" ? "selected" : "" ?> value="Fail">Fail</option>
													<option hcci_val=0 <?= $avon_data["first_response"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
												</select>
											</td>
