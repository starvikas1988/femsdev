								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" id="week_no" name="data[week_no]"  value="<?php echo $hcco_sr_v3_data['week_no']; ?>" class="form-control" disabled>
											</td>
											<td>SR/Contact ID:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" id="consumer_no" name="data[SR_contact_id]"  onkeyup="checkDecConsumer(this);" value="<?php echo $hcco_sr_v3_data['SR_contact_id']; ?>" class="form-control" disabled>
										...
										<tr>
											...
											<td>
												<select class="form-control" id="KPI" name="data[KPI]" disabled>
													<option value="">-Select-</option>
											...
											<td>
												<select class="form-control" id="first_SR_XR" name="data[first_SR_XR]" disabled>
										...
										<tr>
											...
											<td>
												<select class="form-control" name="data[credit_applied_SR]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt1]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt1'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Was there a complete detailed description?</td>
											<td>
												<select class="form-control" name="data[complete_detailed_description]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt2]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt2'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Was the phone number, address, first and last name, and email correct? (NO DUMMY EMAIL)</td>
											<td>
												<select class="form-control" name="data[address_email_correct]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt3]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt3'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Did we submit the correct and appropriate CTT? </td>
											<td>
												<select class="form-control" name="data[correct_CTT]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt4]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt4'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Did we follow all appropriate SR Guidelines? (no duplicate requests, was the XS appropriate) </td>
											<td>
												<select class="form-control" name="data[SR_guidelines]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt5]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt5'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Was there more than one request submitted for the original project?</td>
											<td>
												<select class="form-control" name="data[original_project]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt6]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt6'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>If you answered No to any of these questions, please describe what you observed</td>
											<td>
											</td>
											<td colspan=2><input type="text" name="data[cmt7]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt7'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Possible Knowledged Gap</td>
											<td>
												<select class="form-control" name="data[knowledged_gap]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt8]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt8'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>Possible Fraud / Manipulation</td>
											<td>
												<select class="form-control" name="data[fraud_manipulation]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt9]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt9'] ?>"></td>
										</tr>
										<tr>
											<td colspan=4>COACHED</td>
											<td>
												<select class="form-control" name="data[coached]" disabled>
											...
											<td colspan=2><input type="text" name="data[cmt10]" class="form-control" disabled value="<?php echo $hcco_sr_v3_data['cmt10'] ?>"></td>
										</tr>
										<tr>
											<td>Call Summary:</td>
											<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $hcco_sr_v3_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $hcco_sr_v3_data['feedback'] ?></textarea></td>
										</tr>
											<?php if($hcco_sr_v3_data['attach_file']!=''){ ?>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $hcco_sr_v3_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $hcco_sr_v3_data['client_rvw_note'] ?></td>
									</tr>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $hcco_sr_v3_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $hcco_sr_v3_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=4><textarea class="form-control" name="note" required><?php echo $hcco_sr_v3_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($hcco_sr_v3_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($hcco_sr_v3_data['agent_rvw_note']==''){ ?>
