...
<head>
    ...
    <link rel="stylesheet" href="<?php  echo base_url() ?>assets/aifi/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/bootstrap-multiselect.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/custom.css">
	<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/metisMenu.css">
    <link rel="preconnect" href="https://fonts.gstatic.com/">
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@100;300;400;500;700;900&amp;display=swap" rel="stylesheet">
	<!--start data table css here-->
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/dataTables.bootstrap4.min.css"/>
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/aifi/css/buttons.bootstrap4.min.css"/>
	<!--end data table css here-->

	<!--start search bar css here-->
	<link rel="stylesheet" href="<?php  echo base_url() ?>assets/aifi/css/bootstrap-select.css">
	<!--end search bar css here-->
...
<div id="page-container">
    <div class="header-area">
        <div class="header-area-left">
            <a href="#">
                <img src="<?php echo base_url() ?>assets/aifi/images/logo1.png" class="logo" alt="">
            </a>
        </div>
		<!--start mobile logo -->
		<div class="mobile-logo-new">
			<a href="#" class="logo">
                <img src="<?php echo base_url() ?>assets/aifi/images/side-logo1.png" class="logo" alt="">
            </a>
		</div>
		<!--end mobile logo -->
                    ...
                    <li class="user-dropdown">
                        <div class="dropdown">
                            <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?php echo base_url()?>assets/aifi/images/user.jpg" alt="" class="img-fluid">
                            </button>
                            <div class="dropdown-menu dropdown_user" aria-labelledby="dropdownMenuButton" >
                                <div class="dropdown-header d-flex flex-column align-items-center">
                                    <div class="user_img mb-3">
                                        <img src="<?php echo base_url()?>assets/aifi/images/user.jpg" alt="User Image">
                                    </div>
 ...
 <?php $this->load->view('aifi/aside'); ?>
<div id='main_page_content'>
		<?php $this->load->view('aifi/'.$content_template); ?>
	</div>
<footer>
...
<script src="<?php echo base_url() ?>assets/aifi/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/popper.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/bootstrap.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/bootstrap-multiselect.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/metisMenu.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/jquery.slimscroll.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/main.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/chart.js"></script>

<!--
<script src="<?php echo base_url() ?>assets/aifi/js/dataTables.bootstrap4.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/js/jquery.dataTables.min.js"></script>
-->

<!--start data table-->
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/jquery.dataTables.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/dataTables.bootstrap4.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/dataTables.buttons.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/buttons.bootstrap4.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/jszip.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/vfs_fonts.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/buttons.html5.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/buttons.print.min.js"></script>
<script src="<?php echo base_url() ?>assets/aifi/data-table/js/buttons.colVis.min.js"></script>
<!--end data table-->
<!-- <script>
...
<script>
	$('#break_check_button_ld').change(function(){
		...
		if($(this).prop("checked")==true){
			...
			.then((willDelete) => {
			if(willDelete){
				$.post("<?php echo base_url();?>aifi/break_on_ld",function(data){
					//window.location.href = "<?php echo base_url().get_role_dir();?>/dashboard";
					window.location.href = "<?php echo base_url();?>aifi";
				});
				...
				$.post("<?php echo base_url();?>aifi/break_off_ld",function(data){
					if(data==1){
	...
	$('#break_check_button').change(function(){
		if($(this).prop("checked")==true){
			...
			if(willDelete){
				...
				$.post("<?php echo base_url();?>aifi/break_on",function(data){
					window.location.href = "<?php echo base_url();?>aifi";
				});
				...
				$.post("<?php echo base_url();?>aifi/break_off",function(data){
					if(data==1){
						$(this).prop("checked",false);
						window.location.href = "<?php echo base_url();?>aifi";
					}else{
		...
		if($(this).prop("checked")==true){
			...
			if(willDelete){
				...
				$.post("<?php echo base_url();?>aifi/break_on_coaching",function(data){
					window.location.href = "<?php echo base_url();?>aifi";
				});
				...
				$.post("<?php echo base_url();?>aifi/break_off_coaching",function(data){
					if(data==1){
						$(this).prop("checked",false);
						window.location.href = "<?php echo base_url();?>aifi";
					}else{
...
<!--start search bar js here-->
<script src="<?php echo base_url() ?>assets/aifi/js/bootstrap-select.js"></script>
<!--end search bar js here-->
