							...
							<div class="row" id="formInfoJurysInn" style="display:none">
								...
								<div class="col-sm-4" >
									<div class="form-group">
										...
										<select class="selectpicker" name="source" value="" data-hide-disabled="true" data-live-search="true">
										<?php  
										echo "<option value=''>-- Select Source</option>";
										$fixed_string="Vanila_Nano_00";
										for($i=1;$i<10;$i++){
											?>
											<option value="<?php echo $fixed_string.$i; ?>"><?php echo $fixed_string.$i; ?></option>
											<?php	
										}  
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" class="form-control character-only" id="" name="reason_for_leaving" required >
