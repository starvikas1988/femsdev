...
<div class="main-content page-content">
        <div class="main-content-inner">
                ...
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="d-flex align-items-center dashboard-header flex-wrap mb-3 mb-sm-0">
                            <h5 class="mr-4 mb-0 font-weight-bold">Planogram Mistake Tracker</h5>                           
                        </div>  
			...
			<form id="jurryInnForm" action="<?php echo base_url(); ?>aifi/submit_new_transaction_for_planogram" method="POST" autocomplete="off">
					...
					<div class="white-dash">
						<div class="filter-widget form-widget">
							<div class="row" id="formInfoJurysInn" style="display:none">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<label>Type of Planogram mistake :<span style="color:red;">*</span></label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		<div class="body-widget">
			<b>Do you want to start Planogram Mistake Tracker Form ?</b>
		</div>	
      </div>	  
      <div class="modal-footer">
	    <button type="button" style="
    background-color: green;" btype="start" onclick="callActionButtonplanogram('start')" class="hold-btn new-hold-btn">Yes</button>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
	    <button type="button" btype="hold" onclick="callActionButtonplanogram('hold')" class="hold-btn">Yes, Hold</button>
        <button type="button" class="cancel-btn" data-dismiss="modal">No</button>
      </div>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
	...
	<div class="modal-header">
      ...
      <div class="modal-footer">
	    <button type="button" btype="unhold" onclick="callActionButtonplanogram('unhold')"  class="hold-btn">Yes, Unhold</button>
        <button type="button" class="cancel-btn" data-dismiss="modal">No</button>
      </div>
    </div>
  </div>
