				...
				<div class="white-dash">
					<div class="filter-widget">
						<form  method="GET" action="" autocomplete="off">
										...
										<?php 
											...
											for($i=1;$i<10;$i++){
												...
												//  if($source== $fixed_string.$i )
												 if(in_array($fixed_string.$i,$source))	
												 { $selection = "selected"; }
												?>
							...
							<div class="col-sm-2">
								<div class="form-group">
									<button class="submit-btn search_btn" type="submit" style="width: 100px !important;" name="view_report" value="View"><i class="fa fa-paper-plane" aria-hidden="true"></i>Search</button>
								</div>
							</div>
							<div class="col-sm-1">
								<div class="form-group">
									<a class="btn btn-warning" style="margin: 22px;width: 100px;margin-left: -48px;"  href="<?php echo base_url('aifi')?>/report_for_tech"  ><i class="fa fa-paper-plane" aria-hidden="true"></i>Reset</a>
								</div>
							</div>
							</div>
						</form>
