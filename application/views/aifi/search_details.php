							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<select id="transaction_types" class="form-control multi_select" name="transaction_types[]" autocomplete="off" placeholder="Transaction Type" required multiple>
											<?php
								...
								<div class="col-sm-3">
									<div class="form-group">
										<button class="submit-btn search_btn" type="submit" name="search" value="View"><i class="fa fa-paper-plane" aria-hidden="true"></i>Search</button>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<!-- <td><?php //echo $token['trans_ticket_id']; 
														?></td> -->
											<!-- <td><?php //echo $token['trans_flight_id']; 
														?></td> -->
											<!-- <td><b><?php //echo date('d M, Y', strtotime($token['trans_flight_date'])); 
														?></b></td> -->
											...
											<td><?php if ($token['is_resolved'] == 1) { ?>
													<a href="<?php echo base_url('aifi/view_transaction/' . $token['trans_unique_id']); ?>" class="edit-btn"><i class="fa fa-eye" aria-hidden="true"></i></a>
											</td>

										<?php } else { ?>
											<a href="<?php echo base_url('aifi/update_transaction/' . $token['trans_unique_id']); ?>" class="edit-btn"><i class="fa fa-edit"></i></a></td>
										<?php } ?>
