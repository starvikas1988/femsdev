						...
						<form  method="GET" action="" autocomplete="off">
							...
							<div class="col-sm-3">
								<div class="form-group">
									...
									<input type="Text" class="form-control character_numeric_dash_only" name="unique_id" max="<?php echo $date ; ?>"  value="<?php echo ($unique_id!='')?$unique_id:'';?>" autocomplete="off">
								</div>
							</div>
							<div class="col-sm-3">
								<div class="form-group">
							...
							<div class="col-sm-2">
								<div class="form-group">
									<button class="submit-btn search_btn" id="search_condition_validate" style="width: 100px !important;" type="submit" name="view_report" value="View"><i class="fa fa-paper-plane" aria-hidden="true"></i>Search</button>
								</div>
							</div>
							<div class="col-sm-1">
								<div class="form-group">
									<a class="btn btn-warning" style="margin: 22px;width: 100px;margin-left: -48px;"  href="<?php echo base_url('aifi')?>/report_for_planogram"  ><i class="fa fa-paper-plane" aria-hidden="true"></i>Reset</a>
								</div>
							</div>
							</div>
						</form>
		...
		<div class="common-top">
			<div class="middle-content">
				<?php if(!empty($crm_list)){ ?>
					<a class="btn btn-success" href="<?php echo str_replace('report_for_planogram?', 'download_report_for_planogram?', $_SERVER['REQUEST_URI']); ?>">Download Report</a>
				<?php } ?>
