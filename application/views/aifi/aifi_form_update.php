...
<div class="main-content page-content">
        <div class="main-content-inner">
			...
			<form id="jurryInnForm" action="<?php echo base_url(); ?>aifi/submit_update_transaction" method="POST" autocomplete="off">
							...
							<div class="row" id="formInfoJurysInn" >
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="completed_cases" id="completed_cases" placeholder="" value="<?php echo $crm_details['completed_cases']; ?>"  >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										<label>Reason For Leaving</label>
										<input type="text" class="form-control" name="reason_for_leaving"  value="<?php echo $crm_details['reason_for_leaving']; ?>" >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										<label>Hat Link</label>
										<input type="text" class="form-control" name="hat_link"  value="<?php echo $crm_details['hat_link']; ?>"  >
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<select class="form-control" name="source"  >
											...
											for($i=1;$i<10;$i++){
												$selection = "";
												if($crm_details['source'] == $fixed_string.$i ){ $selection = "selected"; }
												?>
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<?php 
											...
											//echo $crm_details['trans_type_name'];die;
							
											foreach($transaction_type as $token){
												

											$selection = "";
											if($crm_details['trans_type_name'] == $token['id'] ){ $selection = "selected"; }
						...
						<div class="table-white">
							<table id="example" class="table common-data table-striped table-bordered">
								...
								<tr>
									...
									<td><?php echo $token['completed_cases']; ?></td>
									<td><?php echo $token['reason_for_leaving']; ?></td>
									<td><?php echo $token['hat_link']; ?></td>
