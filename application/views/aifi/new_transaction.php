		...
		<!-- <div class="row mb-4">
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between flex-wrap">
						...
						<div id="infoMessage">hii<?php //echo $message;
													?></div>                      
                    </div>
                </div>
            </div> -->
		<form id="jurryInnForm" action="<?php echo base_url(); ?>aifi/submit_new_transaction" method="POST" autocomplete="off">
							...
							<div class="row" id="formInfoJurysInn" style="display:none">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<select class="selectpicker" name="source" value="" data-hide-disabled="true" data-live-search="true" required>
											<?php
											echo "<option value=''>-- Select Stores</option>";
											foreach ($stores_details as $token) {
												$selection = "";
												if ($userSelected == $token['id']) {
													$selection = "selected";
												}
											?>
								...
								<div class="col-sm-3">
									<div class="form-group">
										<label>Completed Cases <span style="color:red;">*</span></label>
										<input type="text" class="form-control number-only-no-minus-also" id="" name="completed_cases" required>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										<label>Reason For Leaving <span style="color:red;">*</span></label>
										<input type="text" class="form-control character-as-well-as-number-only" id="" name="reason_for_leaving" required>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="body-widget">
						<b>Do you want to start Productivity Tracker ?</b>
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" style="
    background-color: green;" btype="start" onclick="callActionButton('start')" class="hold-btn new-hold-btn">Yes</button>
