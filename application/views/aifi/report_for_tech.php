				...
				<div class="white-dash">
					<div class="filter-widget">
						<form  method="GET" action="" autocomplete="off">
							...
							<div class="col-sm-2">
								<div class="form-group">
									<button class="submit-btn search_btn" type="submit"id="search_condition_validate" style="width: 100px !important;" name="view_report" value="View"><i class="fa fa-paper-plane" aria-hidden="true"></i>Search</button>
								</div>
							</div>
							<div class="col-sm-1">
								<div class="form-group">
