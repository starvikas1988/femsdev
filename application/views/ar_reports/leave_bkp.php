...
<h4 class="widget-title">Leave Reporting</h4>
</header>
...
<div class="col-md-7" id="agent_div" <?php echo $aHide;?>>
	<div class="form-group">
...
<div class="col-md-1">
	<div class="form-group">
	<br>
	<input type="submit" style='margin-top:2px;' class="btn btn-primary btn-md" id='showReports' name='showReports' value="Dwonload">
	</div>
</div>
