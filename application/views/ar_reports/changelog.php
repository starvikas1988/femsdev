		...
		<div class="row">
			<div class="col-md-12">
				<div class="white_widget padding_3">
					<h2 class="avail_title_heading">Changelog</h2>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" class="form-control due_date-cal" id="start_date" value='<?php if (isset($start_date)) echo $start_date; ?>' name="start_date" required autocomplete="off">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									<label for="end_date">End Date</label>
									<input type="text" class="form-control due_date-cal" id="end_date" value='<?php if (isset($start_date)) echo $end_date; ?>' name="end_date" required autocomplete="off">
								</div>
							</div>
							<div class="col-md-3">
