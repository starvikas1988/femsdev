...
<div class="row">
	...
	<div class="col-md-3">
		...
		<input type="text" class="form-control" id="start_date" value='' name="start_date" required autocomplete="off">
		</div>
	</div>
	...
	<div class="col-md-3">
		...
		<input type="text" class="form-control" id="end_date" value='' name="end_date" required autocomplete="off">
		</div>
	</div>
...
<div class="col-md-2">
	<div class="form-group">
	<br>
	<input type="submit" style='margin-top:3px;' class="btn btn-primary btn-md btn-up1" id='exportReports' name='exportReports' value="Export As Excel">
	</div>
</div>
