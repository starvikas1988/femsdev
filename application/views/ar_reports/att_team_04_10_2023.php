						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group margin_all">
									...
									<input type="text" class="form-control due_date-cal" id="start_date" onselect="check_date();" value='' name="start_date" required autocomplete="off" readonly="readonly">
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group margin_all">
									<label for="end_date">End Date</label>
									<input type="text" class="form-control due_date-cal" id="end_date" value='' name="end_date" required autocomplete="off" readonly="readonly">
								</div>
							</div>
							<div class="col-md-3">
