		...
		<div class="row">
			<div class="col-md-12">
				<div class="white_widget padding_3">
					<h2 class="avail_title_heading">Attendance</h2>
					<h2 class="avail_title_heading"><?php echo $error ?></h2>
		...
		*/
							...
							<div class="col-md-2">
								<div class="form-group margin_all">
									...
									<input type="submit" class="btn btn_padding filter_btn save_common_btn btn-md btn-up1" id='exportReports' name='exportReports' value="Export to Excel">
								</div>
							</div>
						</div><!-- .row -->
						</form>
