			...
			<form id="msform" method="post" enctype="multipart/form-data">
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['photo'] ?>" name="photo" class="form-control" placeholder="" id="photofile" required="" accept=".pdf,image/*">
							</td>
					  	</tr>
					  	<tr>
					  		<td>
					  	...
					  	<tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_adhar_back'] ?>" name="adhar_back" class="form-control" placeholder="" id="adharfileback" required accept=".pdf,image/*">
							</td>
						  ...
						  <tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_pan'] ?>" name="pan" class="form-control" placeholder="" id="panfile" required accept=".pdf,image/*">
								<input type="hidden" name="c_id" class="c_id" value="<?php echo $c_id;?>" >
							</td>
						  </tr>
						  
						  
						  <?php //echo'<pre>';print_r($get_edu);?>
						  ...
						  <tr>
						  	<td align="text-center">
								Last Qualification: 
						  		<select class="form-control required" id="last_qualification" name="last_qualification" required >
						  	...
						  	<td>Passing Year: 
						  		<input type="text" value="" name="passing_year" class="form-control" placeholder="Passing Year" id="passing_year"  required>
						  	</td>
						  	<td>
								Marks/Grade/CGPA/Result: 
						  		<input type="text" value="" name="percentage" class="form-control" placeholder="Marks/Grade/CGPA/Result" id="percentage"  required>
						  	</td>
						  </tr>	
						  <tr>
							<td>
								<label class="pan">Education Doc</label>
							...
							<td>
								<input type="file" value="<?=(!empty($get_edu))?$get_edu[0]['education_doc']:''; ?>" name="edu[]" class="form-control" placeholder="" id="education_doc" required accept=".doc,.docx,.pdf,image/*" >
					...
					<!-- bank -->
						  ...
						  <tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_signature'] ?>" name="attachment_signature" class="form-control" placeholder="" id="attachment_signature" required accept=".pdf,image/*" >
				...
				<br>
				  ...
				  <div class="saq" style=" box-shadow: 0 2px 2px 0 rgba(0, 0, 0, 0.2), 0 3px 8px 0 rgba(0, 0, 0, 0.19); padding:.5rem;">
					<h5>Enter Your Covid Vaccination Information</h5>
					...
					<h5>Enter Your Bank Information</h5>
						...
						<div>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_bank'] ?>" name="bank" class="form-control" placeholder="" id="bankfile" accept=".pdf,image/*">
						...
						<div class="bank_information" style="display:flex; padding: .21rem; margin: 2rem 0; flex-wrap:wrap;">
							...
							<div class="label"><select name="acc_type" class="saq_input" ><option value="Savings">Saving</option><option value="Checking">Checking</option></select></div>
							</div>
							...
							<div class="label"><input type="text"  value="<?= isset($get_person[0]['ifsc_code']) ? $get_person[0]['ifsc_code'] : '' ?>" name="ifsc_code" id="ifsc_code" class="saq_input"  placeholder="IFSC CODE"/></div>
							</div>
						</div>
						</div>
					<br>
