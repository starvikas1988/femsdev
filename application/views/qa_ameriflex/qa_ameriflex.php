					...
					<div class="row">
						<div class="col-md-12">
							<header class="widget-header">
								...
								<div class="col-sm-12">
									<div class="form-group pull-right" > <a href="<?php echo base_url();?>Qa_philipines_raw/sample_ameriflex_download" class="btn btn-success" title="Download Sample ameriflex Excel" download="Sample ameriflex Excel.xlsx" style="margin-right:5px;">Sample Excel</a>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_ameriflex/add_edit_ameriflex/<?php echo $gds_id ?>">Add Audit</a>
								</div>
								</div>
									<?php } ?>
