		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">Ameriflex</h4></header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('qa_ameriflex/qa_ameriflex_report'); ?>">	
						...
						<div class="row">
							<div class="col-md-1">
								<div class="form-group" style='margin-top:10px'>
									<button class="btn btn-primary esal-effect" a href="<?php echo base_url()?>qa_ameriflex/qa_ameriflex_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
							...
							<?php if($download_link!=""){ ?>
								<div class="col-md-1">
									<div class="form-group" style='margin-top:15px'>
										<a href='<?php echo $download_link; ?>' <span style="padding:10px;" class="label label-success">Export Report</span></a>	
									</div>
								</div>
							<?php } ?>
