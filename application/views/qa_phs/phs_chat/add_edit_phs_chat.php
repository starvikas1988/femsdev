							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" readonly id="phs_chatemail_v_possible" name="data[possible_score]" class="form-control" style="font-weight:bold" value="<?php echo $phs_chat['possible_score'] ?>"></td>
										<td style="font-weight:bold; font-size:16px">Earned Score:</td>
										<td><input type="text" readonly id="phs_chatemail_v_earned" name="data[earned_score]" class="form-control" style="font-weight:bold" value="<?php echo $phs_chat['earned_score'] ?>"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Overall Score:</td>
										<td><input type="text" readonly id="phs_chatemail_v_overall" name="data[overall_score]" class="form-control" style="font-weight:bold" value="<?php echo $phs_chat['overall_score'] ?>"></td>
									</tr>
