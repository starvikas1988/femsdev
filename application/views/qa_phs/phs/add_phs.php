					...
					<div class="widget-body">
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF"><td colspan="9" id="theader" style="font-size:30px">Premier Health Solutions [CALL]</td></tr>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control"  name="data[channel]" required></td>
									</tr>
									<tr>
									...
									<tr>										
										...
										<td colspan="2"><input type="text" class="form-control"  name="data[file_number]" required></td>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control"  name="data[member_id]" required></td>
									...
									<!---------->
									<tr>
									<td class="eml" colspan=4> <?php echo "Hello".$num++ .". ".$scoreParametername[$parameter_column_name++] ?> </td>
										<td>											
											<select class="form-control comp_score" name="data[<?=$columname[$score_column_name++]?>]" required>
												<?php
												$score=$val++;
								   ...
								   <tr>
									...
									<tr>
								   		<td rowspan=6 class="eml1">Customer Critical </td>
