							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" class="form-control" value="<?php echo mysql2mmddyy($phs_voice_v2['audit_date']); ?>" disabled></td>
										<td>Call Date:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="2"><input type="text" class="form-control" value="<?php echo mysql2mmddyy($phs_voice_v2['call_date']); ?>" disabled></td>
									</tr>
									<tr>
										<td>Agent:<span style="font-size:24px;color:red">*</span></td>
										<td>
											<select class="form-control" disabled>
												<option><?php echo $phs_voice_v2['fname']." ".$phs_voice_v2['lname'] ?></option>
											</select>
										</td>
										<td>Fusion ID:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" value="<?php echo $phs_voice_v2['fusion_id'] ?>" disabled></td>
										<td>L1 Supervisor:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="2">
											<select class="form-control" disabled>
												<option><?php echo $phs_voice_v2['tl_name'] ?></option>	
											</select>
										</td>
									</tr>
									<tr>
										<td>Channel:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" value="<?php echo $phs_voice_v2['channel'] ?>" disabled></td>
										<td>File Number:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" value="<?php echo $phs_voice_v2['file_no'] ?>" disabled></td>
										<td>Time stamp/ Link:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="2"><input type="text" class="form-control" value="<?php echo $phs_voice_v2['link'] ?>" disabled></td>
									</tr>
									<tr>
										<td>ACPT:<span style="font-size:24px;color:red">*</span></td>
										<td><select class="form-control" disabled><option><?php echo $phs_voice_v2['acpt'] ?></option></select></td>
										<td>ZTP:<span style="font-size:24px;color:red">*</span></td>
										<td><select class="form-control" disabled><option><?php echo $phs_voice_v2['ztp'] ?></option></select></td>
										<td>Member ID:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="2"><input type="text" class="form-control" value="<?php echo $phs_voice_v2['member_id'] ?>" disabled></td>
									</tr>
									<tr>
										<td>Call Type:<span style="font-size:24px;color:red">*</span></td>
										<td>
											<select class="form-control" name="data[call_type]" disabled>
											<option><?php echo $phs_voice_v2['call_type'] ?></option>
											</select>
										</td>
										<td>Caller Type:<span style="font-size:24px;color:red">*</span></td>
										<td><select class="form-control" disabled><option><?php echo $phs_voice_v2['caller_type'] ?></option></select></td>
										<td>PHS Product/Agency:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="2"><select class="form-control" disabled><option><?php echo $phs_voice_v2['product_agency'] ?></option></select></td>
									</tr>
									<tr>
										<td>Audit Type:<span style="font-size:24px;color:red">*</span></td>
										<td><select class="form-control" disabled><option><?php echo $phs_voice_v2['audit_type'] ?></option></select></td>
										<td>VOC:<span style="font-size:24px;color:red">*</span></td>
										<td><select class="form-control" disabled><option><?php echo $phs_voice_v2['voc'] ?></option></select></td>
										<td>Language:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="2"><select class="form-control" disabled><option><?php echo $phs_voice_v2['language'] ?></option></select></td>
									</tr>
									<tr>
										...
										<td><input type="text" readonly id="phs_chatemail_earned" name="data[earned_score]" class="form-control" style="font-weight:bold" value="<?php echo $phs_voice_v2['earned_score'] ?>"></td>
									...
									<tr>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt1]" value="<?php echo $phs_voice_v2['cmt1'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">2</td>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt2]" value="<?php echo $phs_voice_v2['cmt2'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">3</td>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt3]" value="<?php echo $phs_voice_v2['cmt3'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">4</td>
										...
										<td>
											<select class="form-control chatemail_pnt" id ="ajioAF4" name="data[accurate_information]" disabled>
												<option value="">-Select-</option>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt4]" value="<?php echo $phs_voice_v2['cmt4'] ?>" disabled></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class="form-control chatemail_pnt" name="data[appropriate_greeting]" disabled>
												<option value="">-Select-</option>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt5]" value="<?php echo $phs_voice_v2['cmt5'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">6</td>
										<td class="eml1" colspan=2 style="color:red">Provider Call - Ask for the PROVIDER's name and the name of the facility</td>
										<td>
											<select class="form-control chatemail_pnt" name="data[provider_call]" id ="ajioAF5" disabled>
												<option value="">-Select-</option>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt6]" value="<?php echo $phs_voice_v2['cmt6'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">7</td>
										<td class="eml1" colspan=2 style="color:red">Obtain call back number</td>
										<td>
											<select class="form-control chatemail_pnt" name="data[call_back_number]" id ="ajioAF6" disabled>
												<option value="">-Select-</option>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt7]" value="<?php echo $phs_voice_v2['cmt7'] ?>" disabled></td>
									</tr>
									...
									<tr>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt8]" value="<?php echo $phs_voice_v2['cmt8'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">9</td>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt9]" value="<?php echo $phs_voice_v2['cmt9'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">10</td>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt10]" value="<?php echo $phs_voice_v2['cmt10'] ?>" disabled></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class="form-control chatemail_pnt" name="data[active_listening]" disabled>
												<option value="">-Select-</option>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt11]" value="<?php echo $phs_voice_v2['cmt11'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">12</td>
										<td class="eml1" colspan=2>Did the CSR prevent unexplained dead air</td>
										<td>
											<select class="form-control chatemail_pnt" name="data[dead_air]" disabled>
												<option value="">-Select-</option>
										...
										<td>L</td>
										<td>2</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt12]" value="<?php echo $phs_voice_v2['cmt12'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">13</td>
										<td class="eml1" colspan=2>Good Hold/Transfer Etiquette</td>
										<td>
											<select class="form-control chatemail_pnt" name="data[transfer_etiquette]" disabled>
												<option value="">-Select-</option>
										...
										<td>L</td>
										<td>2</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt13]" value="<?php echo $phs_voice_v2['cmt13'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">14</td>
										<td class="eml1" colspan=2>Demonstrate control of call</td>
										<td>
											<select class="form-control chatemail_pnt" name="data[control_of_call]" disabled>
												<option value="">-Select-</option>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt14]" value="<?php echo $phs_voice_v2['cmt14'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">15</td>
										<td class="eml1" colspan=2>Did the CSR allow the member/provider/caller to speak without interrupting</td>
										<td>
											<select class="form-control chatemail_pnt business" name="data[speak_without_interrupting]" disabled>
												<option value="">-Select-</option>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt15]" value="<?php echo $phs_voice_v2['cmt15'] ?>" disabled></td>
									</tr>
									...
									<tr>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt16]" value="<?php echo $phs_voice_v2['cmt16'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">17</td>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt17]" value="<?php echo $phs_voice_v2['cmt17'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">18</td>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt18]" value="<?php echo $phs_voice_v2['cmt18'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">19</td>
										<td class="eml1" colspan=2>Was the reason for the call addressed fully according to policy?</td>
										<td>
											<select class="form-control chatemail_pnt" name="data[reason_for_call]" disabled>
												<option value="">-Select-</option>
										...
										<td>H</td>
										<td>10</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt19]" value="<?php echo $phs_voice_v2['cmt19'] ?>" disabled></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class="form-control chatemail_pnt" name="data[call_recap]" disabled>
												<option value="">-Select-</option>
										...
										<td>L</td>
										<td>2</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt20]" value="<?php echo $phs_voice_v2['cmt20'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">21</td>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt21]" value="<?php echo $phs_voice_v2['cmt21'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">22</td>
										...
										<td>M</td>
										<td>6</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt22]" value="<?php echo $phs_voice_v2['cmt22'] ?>" disabled></td>
									</tr>
									<tr>
										<td class="prm1">23</td>
										...
										<td>L</td>
										<td>2</td>
										<td colspan=2><input type="text" class="form-control" name="data[cmt23]" value="<?php echo $phs_voice_v2['cmt23'] ?>" disabled></td>
									</tr>
									<tr>
										<td>Call Summary:</td>
										<td colspan="2"><textarea class="form-control" disabled   name="data[call_summary]"><?php echo $phs_voice_v2['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan="3"><textarea class="form-control" disabled   name="data[feedback]"><?php echo $phs_voice_v2['feedback'] ?></textarea></td>
									</tr>
									
								<?php if($phs_voice_v2['attach_file']!=''){ ?>
									...
									<tr><td colspan="2" style="font-size:16px">Manager Review:</td> <td colspan="5" style="text-align:left"><?php echo $phs_voice_v2['mgnt_rvw_note'] ?></td></tr>
									<tr><td colspan="2" style="font-size:16px">Client Review:</td> <td colspan="5" style="text-align:left"><?php echo $phs_voice_v2['client_rvw_note'] ?></td></tr>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" id="" name="agnt_fd_acpt" required>
													<option value="">--Select--</option>
													<option <?php echo $phs_voice_v2['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $phs_voice_v2['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=5><textarea class="form-control" name="note" required><?php echo $phs_voice_v2['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($phs_voice_v2['entry_date'],72) == true){ ?>
											<tr>
												<?php if($phs_voice_v2['agent_rvw_note']==''){ ?>
