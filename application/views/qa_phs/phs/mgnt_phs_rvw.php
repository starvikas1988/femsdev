							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="9" id="theader" style="font-size:30px">Premier Health Solutions [CALL]</td>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control"  name="data[channel]" value="<?php echo $$dataDetails['channel'] ?>" required></td>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control"  name="data[file_number]" value="<?php echo $$dataDetails['file_number'] ?>" required></td>
									...
									<tr>
										...
										<td colspan="2">
											<select class="form-control" id="caller_type" name="data[caller_type]" required>
									...
									<tr>
										<td colspan="1">ZTP:</td>
										<td colspan="2">
											<select class="form-control ztp" id="ztp" name="data[ztp]" required>
												<?php												
												...
												<option <?=($$dataDetails['ztp']==$value)?'selected':'';?> value="<?=$value?>" ><?=$value?></option>
												<?php } ?>
											</select>
										</td>
										<td style="font-weight:bold" colspan="1">Member Id:</td>
										<td colspan="2"><input type="text" class="form-control"  name="data[member_id]" value="<?php echo $$dataDetails['member_id'] ?>" required></td>
										<td colspan="1">Language:</td>
										<td colspan="2">
											<select class="form-control" name="data[language]" required>
												<option value="">-Select-</option>
												<option value="<?php echo $$dataDetails['language'] ?>"><?php echo $$dataDetails['language'] ?></option>
									...
									<tr>
										...
										<td>											
											<select class="form-control comp_score" name="data[<?=$columname[$score_column_name++]?>]" required>
												<?php
									...
									<tr>
										...
										<td class="eml" colspan=4><?php echo $num++ .". ".$scoreParametername[$parameter_column_name++] ?></td>
										<td>
											<select class="form-control busi_score"  name="data[<?=$columname[$score_column_name++]?>]" required>
												<?php
												$x=$score_column_name_db_tbl++;
												$score=$val++;
												 foreach ($scoreCard as $key => $value) {
								   ...
								   <tr>
									...
									<tr>
										...
										<td class="eml" colspan=4><?php echo $num++ .". ".$scoreParametername[$parameter_column_name++] ?></td>
										<td>
											<select class="form-control cust_score" name="data[<?=$columname[$score_column_name++]?>]" required>
												<?php
												$x=$score_column_name_db_tbl++;
												$score=$val++;
												 foreach ($scoreCard as $key => $value) {
