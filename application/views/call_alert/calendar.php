		...
		<header class="widget-header">
			...
			<form method="GET">
				<div class="row techer_selection_row">
					...
					<div class="col-md-2">	
					<button class="btn btn-danger1 new-btn" type="submit">View</button>
					</div>
				</div>
			</form>		
		</header>
...
?>
 ...
 $('#myViewcalendar').fullCalendar({
  ...
  eventClick: function(event) {
		...
		Call_alert_date=event.call_alert_date;
		contact_no=event.client_contact;
		supervisor_notification_time=event.super_notify_time;
		...
		$.ajax({
			url: "<?php echo base_url('Call_alert/calendar_setinfo_details'); ?>",
			type: "GET",
			data: { cl_location : cl_location,cl_gmt : cl_gmt, cl_type : 'edit' , location : cl_location,cl_date : cl_date,type :type,emails:emails,notification_days:notification_days,Comment:comments,Call_alert_date:Call_alert_date,id:id,emails1:emails1,notification_days1:notification_days1,Comment:comments,notification_time:notification_time,supervisor_notification_time:supervisor_notification_time,duration:duration,contact_no:contact_no,duration_type:duration_type},
			dataType: "text",
  ...
  dayClick: function(date, jsEvent, view) {
		...
		$.ajax({
			url: "<?php echo base_url('Call_alert/calendar_setinfo_details'); ?>",
			type: "GET",
			data: { cl_location : cl_location, cl_date : cl_date, cl_gmt : cl_gmt, cl_type : 'new', location : cl_location,type :type,emails:emails,notification_days:notification_days,Comment:comments,Call_alert_date:cl_date,id:id,emails1:emails1,notification_days1:notification_days1,notification_time:notification_time,supervisor_notification_time:supervisor_notification_time,duration:duration,duration_type:duration_type},
			dataType: "text",
			success : function(jsonData){
				$("#sktPleaseWait").modal('hide');
				$('#availabilitySlotModal .modal-body').html(jsonData);
