            ...
            <div class="widget-body">
                ...
                <table id="example" class="table table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th>Supervisor's Notification Date Time</th>
                            <th>Created By</th>
                            <th>Created On</th>
                           <th>Completed By</th>
                           <th>Completed On</th>
                        ...
                        <tr>
                            ...
                            <td><?php echo $rows['notification_days'].' '.$rows['notification_time'];?></td>
                            <td><?php echo $rows['emails1'];?></td>
                            <td><?php echo $rows['notification_days1'].' '.$rows['supervisor_notification_time'];?></td>
                            ...
                            <td><?php echo ($rows['approve_status']=='A')?$rows['closer_name']:'';?></td>
                           <td><?php echo ($rows['approve_status']=='A')?$rows['closed_no']:'';?></td>
