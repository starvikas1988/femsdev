                         ...
                         <thead>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button data-toggle="modal" data-target="#modalEditCnsLocation" onclick="get_Call_alert_location_data('<?php echo $row['id']; ?>','<?php echo $row['fusion_id']; ?>','<?php echo $row['location']; ?>')" type="button" class="btn btn-xs btn-primary edit-btn" title="Edit Location"><i class="fa fa-edit"></i></button>
                                            <button onclick="delete_Call_alert_location_access(<?php echo $row['id']; ?>)" type="button" class="btn btn-xs btn-danger edit-btn" title="Delete"><i class="fa fa-trash"></i></button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
    ...
    <div class="modal-dialog">        
        <div class="modal-content">
            ...
            <div class="modal-body filter-widget">
                <form method="post" action="<?php echo base_url()?>Call_alert/add_location_access">
...
<div class="modal fade" id="modalEditCnsLocation" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">        
        <div class="modal-content">
            ...
            <div class="modal-body filter-widget">
                <form method="post" action="<?php echo base_url()?>Call_alert/edit_location_access">
...
function get_Call_alert_location_data(id,fusion_id,location){
        $('#edit_id').val(id);
       ...
       /* var str_array_skills = location.split(',');
        ...
        $.ajax({
                type:'GET',
                url:'<?php echo base_url();?>/Call_alert/get_edit_location',
