        ...
        <div class="slotFormGroup" >
            ...
            <form method="POST" action="<?php echo base_url('Call_alert/calendar_availability_data_'.$cl_type); ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="case"> Customer Cantact Number</label>
                            <input type="number" class="form-control " autocomplete="off" value="<?php echo $contact_no; ?>" maxlength="10" name="contact_no" required> 
                        </div>
                    </div>
                </div>
                        <div class="row">
