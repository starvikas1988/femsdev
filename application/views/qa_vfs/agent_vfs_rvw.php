							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<?php if($campaign=='chat'){ ?>
										...
										<tr>
											<td rowspan=8 style="background-color:#BFC9CA"><b>2. Technical aspects</b></td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control vfsVal" id="" name="accurate_information" disabled>
													...
													<option vfs_val=0 <?php echo $agent_vfs['accurate_information']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=3>d. Understand the issue of the applicant</td>
											<td>4</td>
											<td>
												<select class="form-control vfsVal" id="" name="understand_issue" disabled>
													<option vfs_val=4 <?php echo $agent_vfs['understand_issue']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=4 <?php echo $agent_vfs['understand_issue']=='No'?"selected":""; ?> value="No">No</option>
										...
										<tr>
											<td colspan=3>f.Paraphrasing</td>
											<td>5</td>
											<td>
										...
										<tr>
											<td colspan=3>g. Used all the available resources for providing resolution</td>
											<td>5</td>
											<td>
										...
										<tr>
											<td colspan=3>h. Appropriate Probing</td>
											<td>5</td>
											<td>
										...
										<tr>
											...
											<td colspan=3>a. Was Hold Required</td>
											<td>2</td>
											<td>
									...
									<?php }else if($campaign=='call'){ ?>
										...
										<tr>
											<td rowspan=1 style="background-color:#BFC9CA"><b>1. Opening</b></td>
											<td colspan=3>a. Appropriate greeting - as per script & Clear and Crisp opening</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="appropiate_greeting" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['appropiate_greeting']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['appropiate_greeting']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['appropiate_greeting']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										...
										<tr>
											<td rowspan=6 style="background-color:#BFC9CA"><b>2. Communication</b></td>
											<td colspan=3>a. Voice modulation (Maintained proper tone, pitch, & volume throughout the call) & Appropriate pace & clarity of speech</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="voice_modulation" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['voice_modulation']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['voice_modulation']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['voice_modulation']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=3>b. Empathy on call & Personalization / Power words</td>
											<td>5</td>
											<td>
										...
										<tr>
											<td colspan=3>c. Adjusted to customer language & Courteous & Professional</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="adjust_customer_language" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['adjust_customer_language']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['adjust_customer_language']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['adjust_customer_language']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=3>d. No jargons - simple words used & Avoid fumbling & fillers</td>
											<td>5</td>
											<td>
										...
										<tr>
											<td colspan=3>e. Active listening / Attentiveness & Paraphrasing & Acknowledgment</td>
											<td>5</td>
											<td>
										...
										<tr>
											<td colspan=3>f. Grammatically correct sentences & Comprehension</td>
											<td>5</td>
											<td>
										...
										<tr>
											<td rowspan=6 style="background-color:#BFC9CA"><b>3. Technical aspects</b></td>
										...
										<tr>
											<td colspan=3>b. Took ownership to resolve customer's concern</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="ownership_resolve" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['ownership_resolve']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['ownership_resolve']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['ownership_resolve']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=3>c. Escalate the issue wherever required</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="escalate_issue" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['escalate_issue']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['escalate_issue']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['escalate_issue']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=3>d. Call control</td>
											<td>5</td>
											<td>
											...
											<tr>
											<td colspan=3>e. Query resolved on call - FTR</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="query_resolved" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['query_resolved']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['query_resolved']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['query_resolved']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
											<tr>
											<td colspan=3>f. Step by step procuedure to resolve the QRC(Query/Request/Complaint)</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="procuedure_request" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['procuedure_request']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['procuedure_request']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['procuedure_request']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control vfsVal" id="" name="offers_VAS" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['offers_VAS']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['offers_VAS']=='No'?"selected":""; ?> value="No">No</option>
										...
										<tr>
											...
											<td>
												<select class="form-control vfsVal" id="" name="awareness_created" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['awareness_created']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['awareness_created']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['awareness_created']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										...
										<tr>
											<td rowspan=1 style="background-color:#BFC9CA"><b>6. Hold Protocol</b></td>
											<td colspan=3>a. Hold Guidelines followed</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="hold_required" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['hold_required']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['hold_required']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['hold_required']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										...
										<tr>
											<td rowspan=2 style="background-color:#BFC9CA"><b>7. Call Closing</b></td>
											<td colspan=3>a. Further assistance & Adherence to call closing script</td>
											<td>5</td>
											<td>
												<select class="form-control vfsVal" id="" name="further_assistance" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['further_assistance']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['further_assistance']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['further_assistance']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
									...
									<?php }else if($campaign=='email'){ ?>
										...
										<tr>
											<td colspan=3>c. Simple & definite statements</td>
											<td>2</td>
											<td>
										...
										<tr>
											<td rowspan=7 style="background-color:#BFC9CA"><b>2. Accuracy / follow up</b></td>
										...
										<tr>
											...
											<td>
												<select class="form-control vfsVal" id="" name="FCR_achieved" disabled>
													<option vfs_val=4 <?php echo $agent_vfs['FCR_achieved']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=4 <?php echo $agent_vfs['FCR_achieved']=='No'?"selected":""; ?> value="No">No</option>
													<option vfs_val=0 <?php echo $agent_vfs['FCR_achieved']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
												</select>
											</td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control vfsVal" id="" name="complete_information" disabled>
													<option vfs_val=5 <?php echo $agent_vfs['complete_information']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
													<option vfs_val=5 <?php echo $agent_vfs['complete_information']=='No'?"selected":""; ?> value="No">No</option>
										...
										<tr>
											<td colspan=3>g. Standardized subject line on trail mails</td>
											<td>2</td>
											<td>
