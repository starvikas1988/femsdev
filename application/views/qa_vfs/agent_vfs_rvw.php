							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<?php }else if($campaign=='call'){ ?>
										...
										<tr>
											<td colspan=3>c. Escalate the issue wherever disabled</td>
											<td>5</td>
											<td>
										...
										<!-- <tr>
										<td></td>
										<td colspan=3 style="background-color:#D98880">e. Absence of disposition</td>
										<td></td>
										<td>
											<select class="form-control vfsVal fatal_epi" id="callAutof5" name="absence_disposition" disabled>
												<option vfs_val=0 <?php echo $agent_vfs['absence_disposition']=='No'?"selected":""; ?> value="No">No</option>
												<option vfs_val=0 <?php echo $agent_vfs['absence_disposition']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
											</select>
										</td>
										</tr> -->
										<tr>
									   <td rowspan=6 style="background-color:#BFC9CA"><b>9.First Time Resolution (FTR)</b></td>
										<td colspan=3>a. Disposition</td>
										<td></td>
										<td>
									...
									<tr>
										...
										<td colspan=3>b. Communication mode through which customer contacted previously</td>
										<td></td>
										<td>
									...
									<tr>
										...
										<td colspan=3>c. Description of Disposition selected</td>
										<td></td>
										<td>
									...
									<tr>
										...
										<td colspan=3>d. Was this the first time customer called us ?</td>
										<td></td>
										<td>
									...
									<tr>
										...
										<td colspan=3>e. Did the customer call us more than once but less than 3 times ?</td>
										<td></td>
										<td>
									...
									<tr>
										...
										<td colspan=3>f. Did the customer call us more than 3 times ?</td>
										<td></td>
										<td>
