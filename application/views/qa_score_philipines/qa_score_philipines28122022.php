		                    ...
		                    <table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" width="100%" cellspacing="0">
								...
								<tbody style="text-align: center;">
									...
									if($resultData){
										...
										$business_cnt = 0;
										$compliance_cnt = 0;
										foreach($resultData as $key=> $ad){

											if($ad['clientName']!=''){
												//echo $resultData[$key+1]['office_abbr'];
												?>
										<tr>
											<td><?php echo $i++; ?></td>
											<td><?php echo $ad['clientName']; ?></td>
											<td><?php 
											if($ad['processName']!='' && $ad['processName']!='Premier Health Solutions'){
												echo $ad['processName']; 
											}
											else{
												echo $resultData[$key+1]['table_name'];
											}
											?>
											</td>
											<td><?php echo $ad['qa_location']; ?></td>
											<td><?php echo $resultData[$key+1]['office_abbr']; ?></td>
