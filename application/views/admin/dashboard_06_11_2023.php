	...
	<section class="app-content">
		...
		<div class="row">
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>wfm/dashboard/1?<?php echo $qStrParam; ?>">
			...
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>wfm/dashboard/2?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
			...
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>wfm/dashboard/3?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
			...
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>wfm/dashboard/4?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
			...
			?>
				<div class="<?php echo $colClass; ?>">
					<a href="<?php echo base_url() ?>wfm/dashboard/6?<?php echo $qStrParam; ?>">
						<div class="white_widget stats-widget">
							<div class="padding_3 clearfix">
								<div class="pull-left">
			...
			?>
				<div class="<?php echo $colClass; ?>">
					<a href="<?php echo base_url() ?>wfm/dashboard/7?<?php echo $qStrParam; ?>">
						<div class="white_widget stats-widget">
							<div class="padding_3 clearfix">
								<div class="pull-left">
