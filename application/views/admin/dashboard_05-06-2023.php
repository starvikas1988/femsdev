...
.dt-buttons {
	...
	.table-responsive::-webkit-scrollbar { height: 5px; background-color: #ddd; } .table-responsive::-webkit-scrollbar-track { -webkit-box-shadow: inset 0 0 0px rgba(0, 0, 0, 0); } .table-responsive::-webkit-scrollbar-thumb { height: 5px; background-color: #9a8b8b; } .table-responsive::-webkit-scrollbar-thumb:hover { background-color: #9a8b8b; } .table-responsive::-webkit-scrollbar:vertical { display: none; }
	/*end 24-05-2023 */	
	
	/*start custom multislect css*/
	...
	.filter-widget .btn-group-vertical>.btn, .btn-group>.btn {
		height: 35px!important;
	}
	.filter-widget .form-control {
		height: 35px!important;
	}	
	.filter-widget ::-webkit-scrollbar { width:5px;height: 5px; background-color: #ddd; } .filter-widget ::-webkit-scrollbar-track { -webkit-box-shadow: inset 0 0 0px rgba(0, 0, 0, 0); } .filter-widget ::-webkit-scrollbar-thumb {width:5px; height: 5px; background-color: darkgrey; } .filter-widget ::-webkit-scrollbar-thumb:hover { background-color: #9a8b8b; } 
	...
	<?php echo form_open('',array('method' => 'get')) ?>
		...
		<div class="col-md-3">
			<div class="form-group">
				...
				<select class="form-control" name="sub_dept_id[]" id="sub_dept_id" multiple>
					<option value='ALL'>ALL</option>
					<?php foreach($sub_department_list as $sub_dept): ?>
						<?php
						$sCss="";
						// if($sub_dept['id']==$sdValue) $sCss="selected";
						if(in_array($sub_dept['id'], $sdValue))$sCss="selected";
						?>
		...
		<div class="col-md-2">
			<div class="form-group">
			<br>
			<input type="submit" class="filter_btn btn btn-primary btn-md" style='margin-top:4px;' id='showReports' name='showReports' value="Show">
			</div>
		</div>
		...
		if($total_ncns_req>0 || $total_term_sub>0){
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<a  href="<?php echo base_url()?>admin/dashboard/5?<?php echo $qStrParam; ?>">
				<div class="widget stats-widget">
					<div class="widget-body clearfix">
						<div class="pull-left">
							<h3 class="widget-title text-danger"><span class="counter" data-plugin="counterUp"><?php echo $total_ncns_req ?></h3>
						</div>
						<span class="pull-right big-icon watermark"><i class="fa fa-users"></i></span>
					</div>
					<footer class="widget-footer bg-danger">
						<small>NCNS Termination</small>
					</footer>
				</div>
				</a>
	...
	<div class="row">
		...
		<div class="col-md-12">
				<div class="widget">
					...
					<div class="col-md-4">
					<header class="widget-header">
					<h4 class="widget-title" id='filter_data'>
						<?php
						$ofValue="";
						if($oValue!="ALL"){
							$ofValue=$oValue;
									...
									<tr>
										...
										<?php 
											...
											if($filter_id==6){
												...
												echo "<td width='150px' style='display:inline-block' >";
												...
												if(is_access_complete_kterm()){ 
													...
													echo "<button uid='$user_id' lwd='$lwd' type='button' tremarks='".base64_encode($comments)."' class='completeKnownTerm btn btn-info btn-xs'>Complete Term</button> &nbsp; ";
...
<script>
	$(document).ready(function() {
		var title= $('#filter_data').html();
		var latlong = title.substring(1, title.indexOf('('));
    ...
    table.buttons().container()
        .appendTo( '#default-datatable_wrapper .col-sm-6:eq(0)' );
} );
