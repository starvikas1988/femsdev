	...
	<section class="app-content">
		<div class="white_widget padding_3">
			...
			<div class="body_widget clearfix">
				...
				<div class="row flex_wrap">
					<?php
					//if(get_dept_folder()=="rta" || get_dept_folder()=="wfm" || get_dept_folder()=="hr"){
					?>
					<div class="col-md-3 form-group">
						<div class="filter-widget">
							<label for="dept_id">Department</label>
							<select class="form-control" name="dept_id[]" id="dept_id" multiple>
								<?php
								$sCss = "";
								if (in_array("ALL", $dValue)) $sCss = "selected";
								echo "<option value='ALL' $sCss >All</option>";
								?>
								<?php foreach ($department_list as $dept) : ?>
									<?php
									$sCss = "";
									if ($dept['id'] == $dValue) $sCss = "selected";
									if (in_array($dept['id'], $dValue)) $sCss = "selected";
									?>
					...
					<div class="col-md-3 form-group">
						<div class="filter-widget">
							...
							<select class="form-control" name="client_id[]" id="fclient_id" multiple>
								<?php
								$sCss = "";
								if (in_array("ALL", $cValue)) $sCss = "selected";
								echo "<option value='ALL' $sCss >All</option>";
								?>
								<?php foreach ($client_list as $client) : ?>
									...
									if (in_array($client->id, $cValue)) $sCss = "selected";
									?>
					...
					?>
					<div class="col-md-3 form-group">
						<div class="filter-widget" id="foffice_div" <?php echo $oHid; ?>>
							<label for="office_id">Location</label>
							<select class="form-control" name="office_id[]" id="foffice_id" multiple>
								<?php
								if (get_global_access() == 1) {
									$sCss = "";
									if (in_array("ALL", $oValue)) $sCss = "selected";
									echo "<option value='ALL' $sCss >All</option>";
								}
								?>
					...
					<div class="col-md-3 form-group margin_all">
						<div class="filter-widget">
							<label for="process_id">Process</label>
							<select class="form-control" name="process_id[]" id="fprocess_id" multiple>
								<?php
								$sCss = "";
								if (in_array("ALL", $pValue)) $sCss = "selected";
								echo "<option value='ALL' $sCss >All</option>";
								?>
								<?php foreach ($process_list as $process) : ?>
									...
									if (in_array($process->id, $pValue)) $sCss = "selected";
									?>
					...
					<div class="col-md-3 form-group margin_all" id="">
						<div class="filter-widget">
							<label for="role">Reporting Head</label>
							<select class="form-control" name="assigned_to[]" id="assigned_to" multiple>
								<?php
								$sCss = "";
								if (in_array("ALL", $aValue)) $sCss = "selected";
								echo "<option value='ALL' $sCss >All</option>";
								?>
								<?php foreach ($tl_list as $tl) :
									$sCss = "";
									// if($tl->id==$aValue) $sCss="selected";
									if (in_array($tl->id, $aValue)) $sCss = "selected";
								?>
					...
					<div class="col-md-3">
						<div class="form-group margin_all">
							<label class="visiblity_hidden d_block">Show</label>
							<input type="submit" class="btn btn_padding filter_btn_blue save_common_btn btn-md" id='showReports' name='showReports' value="Show">
						</div>
					</div>
				</div>
				</form>
		...
		<div class="row">
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>admin/dashboard/1?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
								<h3 class="widget-title"><span class="counter" data-plugin="counterUp"><?php echo $total_agent; ?></h3>
							</div>
							<span class="pull-right big-icon watermark"><img src="<?php echo base_url(); ?>assets_home_v3/images/total_users.svg" alt=""></span>
						</div>
						<footer class="widget-footer common_bg_new">
							Total Users
						</footer>
					</div><!-- .widget -->
				</a>
			...
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>admin/dashboard/2?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
								<h3 class="widget-title"><span class="counter" data-plugin="counterUp"><?php echo $total_online ?></h3>
							</div>
							<span class="pull-right big-icon watermark"><img src="<?php echo base_url(); ?>assets_home_v3/images/users_online.svg" alt=""></span>
						</div>
						<footer class="widget-footer common_bg_new">
							Total Users Online
						</footer>
			...
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>admin/dashboard/3?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
								<h3 class="widget-title"><span class="counter" data-plugin="counterUp"><?php echo $total_offline ?></h3>
							</div>
							<span class="pull-right big-icon watermark"><img src="<?php echo base_url(); ?>assets_home_v3/images/users_offline.svg" alt=""></span>
						</div>
						<footer class="widget-footer common_bg_new">
							Total Users Offline
						</footer>
			...
			<div class="<?php echo $colClass; ?>">
				<a href="<?php echo base_url() ?>admin/dashboard/4?<?php echo $qStrParam; ?>">
					<div class="white_widget stats-widget">
						<div class="padding_3 clearfix">
							<div class="pull-left">
								<h3 class="widget-title"><span class="counter" data-plugin="counterUp"><?php echo $total_leave ?></h3>
							</div>
							<span class="pull-right big-icon watermark"><img src="<?php echo base_url(); ?>assets_home_v3/images/users_on_leave.svg" alt=""></span>
						</div>
						<footer class="widget-footer common_bg_new">
							Users On Leave
						</footer>
			...
			?>
				<div class="<?php echo $colClass; ?>">
					<a href="<?php echo base_url() ?>admin/dashboard/6?<?php echo $qStrParam; ?>">
						<div class="white_widget stats-widget">
							<div class="padding_3 clearfix">
								<div class="pull-left">
									<h3 class="widget-title"><span class="counter" data-plugin="counterUp"><?php echo $total_term_sub ?></h3>
								</div>
								<span class="pull-right big-icon watermark"><img src="<?php echo base_url(); ?>assets_home_v3/images/users_quaue.svg" alt=""></span>
							</div>
							<footer class="widget-footer common_bg_new">
								Term Queue
							</footer>
			...
			?>
				<div class="<?php echo $colClass; ?>">
					<a href="<?php echo base_url() ?>admin/dashboard/7?<?php echo $qStrParam; ?>">
						<div class="white_widget stats-widget">
							<div class="padding_3 clearfix">
								<div class="pull-left">
									<h3 class="widget-title"><span class="counter" data-plugin="counterUp"><?php echo @$total_suspended ?></h3>
								</div>
								<span class="pull-right big-icon watermark"><img src="<?php echo base_url(); ?>assets_home_v3/images/suspension.svg" alt=""></span>
							</div>
							<footer class="widget-footer common_bg_new">
								Suspension
							</footer>
		...
		<div class="white_widget padding_3">
			...
			<div class="body_widget">
				<div class="common_table_widget report_hirarchy_new leave_table table_export">
					<table id="default-datatable" data-plugin="DataTable" class="table table-bordered table-striped" cellspacing="0" width="100%">
						<thead>
							<tr>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<!-- <td><?php //echo $user['site_name']; 
												?></td> -->
									<td><?php echo $user['role_name']; ?></td>
									<td><?php echo $user['master_org_grade']; ?></td>
									...
									if ($filter_id == 6) {
										...
										if (is_access_complete_kterm()) {
											echo "<button uid='$user_id' lwd='$lwd' type='button' tremarks='" . base64_encode($comments) . "' class='completeKnownTerm btn btn-xs' title='Complete Term'><img src='" . base_url() . "assets_home_v3/images/complete_user.svg' alt=''></button> ";
											echo "<button title='Cancel Termination' uid='$user_id' type='button' class='cancelTermination btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/terminate_user.svg' alt=''></button>";
										} else
											echo "Pending HR Confirmation";
										echo "</td>";
									} else if ($filter_id == 7) {
										...
										echo '<td width="120px" style="display:inline-block">';
										echo "<button uid='$user_id' fromdt='" . $user['from_date'] . "' todt='" . $user['to_date'] . "' title='Revoke Suspension' type='button' class='cancelSuspension btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/revoke_sitting.svg' alt=''></button>";
										echo "<a target='_blank' title='View Profile' href='" . base_url() . "profile/$ufusion_id'><button title='View Profile' fid='$ufusion_id' type='button' class='btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/view_profile.svg' alt=''></button></a>";
										if ($action_status == "P")
											echo "<button title='Disable For NCNS Term Request' type='button' class='btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/disable_rejoin.svg' alt=''></button>";
										else
											echo "<button title='Terminate' type='button' uid='$user_id' class='termsUserOth btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/terminate_user.svg' alt=''></button>";
										echo '</td>';
									} else if ($filter_id == 5) {
										...
										echo "<td width='120px;'>";
										if (is_access_complete_kterm()) {
											if ($is_update == "N") echo "<button uid='$pre_user_id' preRowId='$pre_row_id' type='button' class='ncnsFinalTermsReq btn btn-xs' title='Complete Term Request'><img src='" . base_url() . "assets_home_v3/images/complete_user.svg' alt=''></button>";
											else if (CurrMySqlDate() >= $user['term_time']) {
												echo "<button title='Terminate' type='button' trm_tm='$term_time' uid='$pre_user_id' class='termsUser btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/terminate_user.svg' alt=''></button>";
											}
											echo "<button title='Reject Term Request' type='button' uid='$pre_user_id' preRowId='$pre_row_id' class='rejectPreTermsReq btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/cancel_big.svg' alt=''></button>";
										}
										echo "</td>";
									} else {
										...
										if ($disposition_id == 1) $bclass = "";
										else if ($disposition_id == 2) $bclass = "";
										else if ($disposition_id == 3) $bclass = "";
										else if ($disposition_id == 4) $bclass = "";
										else $bclass = "";
										$tLtime = "";
										if (isset($user['tLtime'])) $tLtime = $user['tLtime'];
										if ($filter_id == 2 || $filter_id == 3) {
											$_loggedHour = $user['loggedHour'];
											if ($_is_logged_in == 1) echo '<td>' . $_loggedHour . ' Hrs.</td>';
											else if ($tLtime != "") echo '<td>' . $tLtime . ' Hrs.</td>';
											else echo '<td>-</td>';
										}
										if ($filter_id != 2) {
											if ($_is_logged_in == 1) echo '<td>-</td>';
											else if ($_is_logged_in != 1 && $tLtime != "") echo '<td>P</td>';
											else {
												if ($filter_id == 4)
													echo '<td><span class=" ' . $bclass . '">' . $disp_name . ' (' . $user['start_date'] . '-' . $user['end_date'] . ') </span></td>';
												else
													echo '<td><span class=" ' . $bclass . '">' . $disp_name . '</span></td>';
											}
										}
										echo '<td width="120px" style="display:inline-block">';
										...
										if ($disposition_id == 1 && $tLtime == "" && $filter_id != 7) {
											if ($action_status == "P")
												...
												echo "<button uid='$user_id' cid = '$client_id' disp_id='$disposition_id' type='button' class='editDisposition btn btn-xs' title='Edit Status'><img src='" . base_url() . "assets_home_v3/images/edit_icon.svg' alt=''></button>";
										}
										//	if($_is_logged_in!=1){
										$ufusion_id = $user['fusion_id'];
										echo "<a target='_blank' title='View Profile' href='" . base_url() . "profile/$ufusion_id'><button title='View Profile' fid='$ufusion_id' type='button' class='btn btn-xs'><img src='" . base_url() . "assets_home_v3/images/view_profile.svg' alt=''></button></a>";
				...
				<form class="frmPreTermReq" onsubmit="return false" method='POST'>
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control required due_date-cal" id="next_shift_time" placeholder="Enter Next Shift Time" name="next_shift_time" required>
						</div>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control required due_date-cal" id="terms_time" placeholder="Enter Termination Date" name="terms_time" required>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='updatePreTermReq' class="btn btn_padding filter_btn_blue save_common_btn">Save Changes</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog small_modal_new">
			<div class="modal-content">
				<form class="frmRejPreTermReq" onsubmit="return false" method='POST'>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='updateRejPreTermReq' class="btn btn_padding filter_btn_blue save_common_btn">Save Changes</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="frmTermsUser" onsubmit="return false" method='POST'>
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" class="form-control due_date-cal" id="terms_date" placeholder="Enter Termination Date" name="terms_date" required>
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" class="form-control due_date-cal" placeholder="Enter Ticket Date" id="ticket_date" name="ticket_date" required>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='terminateUser' class="btn btn_padding filter_btn_blue save_common_btn">Terminate User</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog small_modal_new">
			<div class="modal-content">
				<form class="frmTermsUserOth" onsubmit="return false" method='POST'>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control due_date-cal" placeholder="Last Working Date" value='' id="lwd_oth" name="lwd" required>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="terms_date">Termination Date</label>
									<input type="text" class="form-control due_date-cal" placeholder="Enter Termination Date" value='<?php echo CurrDateTimeMDY() ?>' id="terms_date_oth" name="terms_date" required>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label for="role">Termination Type</label>
							...
							<div class="col-sm-6">
								<div class="form-group">
									<label for="role">Sub Termination Type</label>
							...
							<div class="col-sm-12">
								<div class="form-group" id="resign_comment">
									<label for="role">Resign Reason</label>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='terminateUserOth' class="btn btn_padding filter_btn_blue save_common_btn">Terminate User</button>
					</div>
				</form>
			</div>
		</div>
				...
				<form class="editDisp" onsubmit="return false" method='POST'>
					...
					<div class="modal-body">
						...
						<div class="form-group" id='div_kterms_date' style="display:none;">
							...
							<input type="text" class="form-control due_date-cal" id="kterms_date" placeholder="Enter Termination Date" name="kterms_date" readonly required>
						</div>
						<div class="form-group" id='div_start_date'>
							<label id='lbl_start_date' for="name">Date (mm/dd/yyyy)</label>
							<input type="text" class="form-control due_date-cal" id="start_date" value='' name="start_date" required>
						</div>
						<div class="form-group" id='div_end_date'>
							<label id='lbl_end_date' for="name">End Date (mm/dd/yyyy)</label>
							<input type="text" class="form-control due_date-cal" id="end_date" value='' name="end_date">
						</div>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='updateDisp' class="btn btn_padding filter_btn_blue save_common_btn">Save Changes</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									<label for="lwd">Last Working Date</label>
									<input type="text" class="form-control due_date-cal" placeholder="Last Working Date" value='' id="ut_lwd" name="lwd" required>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<input type="text" class="form-control due_date-cal" placeholder="Enter Ticket Date" id="ut_ticket_date" name="ut_ticket_date">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									<label for="comments">Comments</label>
									<textarea rows="4" class="form-control" placeholder="Enter Comments" id="t_comments" name="t_comments"></textarea>
								</div>
							</div>
						</div>
						<!--
				...
				-->
					...
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='updateTerminateUser' class="btn btn_padding filter_btn_blue save_common_btn">Terminate User</button>
					</div>
				</form>
			</div>
		</div>
				...
				<form class="frmSuspensionReq" onsubmit="return false" method='POST'>
					...
					<div class="modal-body">
						...
						<div class="form-group" id='div_ret_date'>
							...
							<input type="text" class="form-control due_date-cal" id="final_return_date" value='' name="final_return_date">
						</div>
						<div class="form-group">
							<label for="name">Remarks</label>
							<input type="text" class="form-control required due_date-cal" id="update_comments" placeholder="Enter Remarks" name="update_comments" required>
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='btnCancelSuspension' class="btn btn_padding filter_btn_blue save_common_btn">Cancel Suspension</button>
					</div>
				</form>
			</div>
		</div>
		...
		<div class="modal-dialog small_modal_new">
			<div class="modal-content">
				<form class="frmCancelTermination" onsubmit="return false" method='POST'>
					...
					<div class="modal-footer">
						<button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
						<button type="submit" id='btnCancelTermination' class="btn btn_padding filter_btn_blue save_common_btn">Save Changes</button>
					</div>
				</form>
			</div>
		</div>
