...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>covid_case/submit_personal_information" method="POST" autocomplete="off">
...
<div class="panel panel-default">
 ...
 <div class="panel panel-default">
  ...
  <div class="panel-body"> 
	...
	<a href="<?php echo base_url()."covid_case/form/" .$crmdetails['crm_id'] ."/administrative/"; ?>" class="btn btn-primary pull-right">Skip & Next</a>
	<?php } ?>
