...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>covid_case/submit_risk_response" method="POST" autocomplete="off">
...
<div class="panel panel-default">
  ...
  <a href="<?php echo base_url()."covid_case/form/" .$crmdetails['crm_id'] ."/exposure/"; ?>" class="pull-right btn btn primary"><i class="fa fa-arrow-left"></i> Back to Exposure Timeline</a>
  </div>
  <div class="panel-body">
 ...
 <div class="panel panel-default">
  ...
  <div class="panel-body"> 
	...
	<a href="<?php echo base_url()."covid_case/form/" .$crmdetails['crm_id'] ."/aftercase/"; ?>" class="btn btn-primary pull-right">Skip & Next</a>
	<?php } ?>
