			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header">
								<h4 class="widget-title"> Search Wireless DNA </h4>
							</header>
						</div>	
					...
					<div class="widget-body">
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_wireless_dna'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success blains-effect" href="<?php echo base_url()?>Qa_wireless_dna" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">Wireless DNA</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client"){ 
									$ajio_id=0; ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_wireless_dna/add_edit_wireless_dna/<?php echo $ajio_id ?>">Add Audit</a>
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1; 
										...
										foreach($qa_wireless_dna as $row):
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php 
										...
										<td>
											<?php $mpid=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_wireless_dna/add_edit_wireless_dna/<?php echo $mpid ?>" style="margin-left:5px; font-size:10px;">Edit/Review Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
