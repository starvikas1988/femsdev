								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<option value="<?php echo $qa_wireless_dna_curd['agent_id'] ?>"><?php echo $qa_wireless_dna_curd['fname']." ".$qa_wireless_dna_curd['lname'] ?></option>
											...
											<td colspan="2">
												<input type="text" class="form-control" id="tl_name"  value="<?php echo $qa_wireless_dna_curd['tl_name'] ?>" readonly>
											<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $qa_wireless_dna_curd['tl_id'] ?>" required>
											</td>
										</tr>
										<tr>
											<td>Call ID:<span style="font-size:24px;color:red">*</span></td>
											<td><input type="text" class="form-control" name="data[call_id]" autocomplete="off" value="<?php echo $qa_wireless_dna_curd['call_id'] ?>"  required></td>
											...
											<td>
												<select class="form-control" id="voc" name="data[voc]" required>
													...
													<option value="">-Select-</option>
													<option value="1"  <?= ($qa_wireless_dna_curd['voc']=="1")?"selected":"" ?>>1</option>
													<option value="2"  <?= ($qa_wireless_dna_curd['voc']=="2")?"selected":"" ?>>2</option>
													<option value="3"  <?= ($qa_wireless_dna_curd['voc']=="3")?"selected":"" ?>>3</option>
													<option value="4"  <?= ($qa_wireless_dna_curd['voc']=="4")?"selected":"" ?>>4</option>
													<option value="5"  <?= ($qa_wireless_dna_curd['voc']=="5")?"selected":"" ?>>5</option>
													<option value="6"  <?= ($qa_wireless_dna_curd['voc']=="6")?"selected":"" ?>>6</option>
													<option value="7"  <?= ($qa_wireless_dna_curd['voc']=="7")?"selected":"" ?>>7</option>
													<option value="8"  <?= ($qa_wireless_dna_curd['voc']=="8")?"selected":"" ?>>8</option>
													<option value="9"  <?= ($qa_wireless_dna_curd['voc']=="9")?"selected":"" ?>>9</option>
													<option value="10"  <?= ($qa_wireless_dna_curd['voc']=="10")?"selected":"" ?>>10</option>
												</select>
											</td>
											...
											<td colspan="2">
												<select class="form-control" id="audit_type" name="data[audit_type]" required>
                                                    <option value="">-Select-</option>
                                                    <option value="CQ Audit" <?= ($qa_wireless_dna_curd['audit_type']=="CQ Audit")?"selected":"" ?>>CQ Audit</option>
                                                    <option value="BQ Audit" <?= ($qa_wireless_dna_curd['audit_type']=="BQ Audit")?"selected":"" ?>>BQ Audit</option>
                                                    <option value="Calibration" <?= ($qa_wireless_dna_curd['audit_type']=="Calibration")?"selected":"" ?>>Calibration</option>
                                                    <option value="Pre-Certificate Mock Call" <?= ($qa_wireless_dna_curd['audit_type']=="Pre-Certificate Mock Call")?"selected":"" ?>>Pre-Certificate Mock Call</option>
                                                    <option value="Certification Audit" <?= ($qa_wireless_dna_curd['audit_type']=="Certification Audit")?"selected":"" ?>>Certification Audit</option>
                                                    <option value="WoW Call"  <?= ($qa_wireless_dna_curd['audit_type']=="WoW Call")?"selected":"" ?>>WoW Call</option>
                                                    <option value="Operation Audit"  <?= ($qa_wireless_dna_curd['audit_type']=="Operation Audit")?"selected":"" ?>>Operation Audit</option>
                                                    <option value="Trainer Audit"  <?= ($qa_wireless_dna_curd['audit_type']=="Trainer Audit")?"selected":"" ?>>Trainer Audit</option>
                                                    <option value="Hygiene Audit"  <?= ($qa_wireless_dna_curd['audit_type']=="Hygiene Audit")?"selected":"" ?>>Hygiene Audit</option>
										...
										<td class="auType_epi">
											<select class="form-control" id="auditor_type" name="data[auditor_type]">
                                                    <option value="">Select</option>
                                                    <option value="Master" <?= ($qa_wireless_dna_curd['auditor_type']=="Master")?"selected":"" ?>>Master</option>
                                                    <option value="Regular" <?= ($qa_wireless_dna_curd['auditor_type']=="Regular")?"selected":"" ?>>Regular</option>
                                                </select>
										</td>
										</tr>
									...
									<tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[used_suggested_opening_spiel_reason]" value="<?php echo $qa_wireless_dna_curd['used_suggested_opening_spiel_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<!--td><input type="text" class="form-control" name="data[obtained_customer_consent_comment]"  value="<?php //echo $qa_wireless_dna_curd['obtained_customer_consent_comment'];
																																					?>"></td--->
											<td><input type="text" class="form-control" name="data[obtained_customer_consent_reason]" value="<?php echo $qa_wireless_dna_curd['obtained_customer_consent_reason'] ?>"></td>
										</tr>
										...
										<tr>
											...
											<!--td><input type="text" class="form-control" name="data[active_listening_or_reading_comment]"  value="<?php //echo $qa_wireless_dna_curd['active_listening_or_reading_comment'];
																																					?>"></td-->
											<td><input type="text" class="form-control" name="data[active_listening_or_reading_reason]" value="<?php echo $qa_wireless_dna_curd['active_listening_or_reading_reason'] ?>"></td>
										...
										<tr>
											...
											<!--td><input type="text" class="form-control" name="data[proper_hold_procedure_comment]"  value="<?php //echo $qa_wireless_dna_curd['proper_hold_procedure_comment'];
																																				?>"></td-->
											<td><input type="text" class="form-control" name="data[proper_hold_procedure_reason]" value="<?php echo $qa_wireless_dna_curd['proper_hold_procedure_reason'] ?>"></td>
										</tr>
										<tr>
											<!--end-->
											...
											<!--td><input type="text" class="form-control" name="data[dead_air_comment]"  value="<?php // echo $qa_wireless_dna_curd['dead_air_comment'];
																																	?>"></td-->
											<td><input type="text" class="form-control" name="data[dead_air_reason]" value="<?php echo $qa_wireless_dna_curd['dead_air_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<!--td><input type="text" class="form-control" name="data[interruption_comment]"  value="<?php //echo $qa_wireless_dna_curd['interruption_comment'];
																																		?>"></td-->
											<td><input type="text" class="form-control" name="data[interruption_reason]" value="<?php echo $qa_wireless_dna_curd['interruption_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<!--td><input type="text" class="form-control" name="data[customer_experience_comment]" value="<?php //echo $qa_wireless_dna_curd['customer_experience_comment'];
																																			?>"></td-->
											<td><input type="text" class="form-control" name="data[customer_experience_reason]" value="<?php echo $qa_wireless_dna_curd['customer_experience_reason'] ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[complete_accurate_information_reason]" value="<?php echo $qa_wireless_dna_curd['complete_accurate_information_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<!--td><input type="text" class="form-control" name="data[probing_question_comment]" value="<?php // echo $qa_wireless_dna_curd['probing_question_comment'];
																																		?>"></td-->
											<td><input type="text" class="form-control" name="data[probing_question_reason]" value="<?php echo $qa_wireless_dna_curd['probing_question_reason'] ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[complete_accurate_notes_reason]" value="<?php echo $qa_wireless_dna_curd['complete_accurate_notes_reason'] ?>"></td>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[use_proper_disposition_tagging_reason]" value="<?php echo $qa_wireless_dna_curd['use_proper_disposition_tagging_reason'] ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[additional_assistance_reason]" value="<?php echo $qa_wireless_dna_curd['additional_assistance_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<td><input type="text" class="form-control" name="data[used_Suggested_Closing_Spiel_reason]" value="<?php echo $qa_wireless_dna_curd['used_Suggested_Closing_Spiel_reason'] ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[rudeness_reason]" value="<?php echo $qa_wireless_dna_curd['rudeness_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<td><input type="text" class="form-control" name="data[call_aviodance_reason]" value="<?php echo $qa_wireless_dna_curd['call_aviodance_reason'] ?>"></td>
										</tr>
										<tr>
										...
										<td><input type="text" class="form-control" name="data[improper_won_tagging_reason]" value="<?php echo $qa_wireless_dna_curd['improper_won_tagging_reason'] ?>"></td>
										</tr>
										<tr>
											...
											<td><input type="text" class="form-control" name="data[infosec_violation_reason]" value="<?php echo $qa_wireless_dna_curd['infosec_violation_reason'] ?>"></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan=2><textarea class="form-control" name="data[call_summary]"><?php echo $qa_wireless_dna_curd['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan="4"><textarea class="form-control" name="data[feedback]"><?php  echo $qa_wireless_dna_curd['feedback'] ?></textarea></td>
										</tr>
										<tr>
