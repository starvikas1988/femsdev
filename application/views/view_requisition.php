			...
			<div class="col-md-12">
				<div class="widget">
					...
					?>
						...
						<?php if(is_approve_requisition()==true ){ ?>
					...
					if( is_access_dfr_module()==1 || get_dept_folder()=="hr" || $is_global_access==1){
						...
						if($required_pos > $filled_pos){
							...
							if(is_block_add_candidate_requisition($requisition_id)==false){
								...
								echo "<button title='' type='button' class='btn btn-primary sendBasicLink' r_id='$r_id' requisition_id='$requisition_id' style='font-size:10px'>Send Link to Candidate </button>&nbsp;";
								
								echo "<button title='' type='button' class='btn btn-primary addCandidate' r_id='$r_id' requisition_id='$requisition_id' style='font-size:10px'>Add Candidate</button>";
