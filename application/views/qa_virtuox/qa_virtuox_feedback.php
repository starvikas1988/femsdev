						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">Qa VIRTUOX Audit</div>
									...
									<div class="form-group">
										...
										<?php $stratAuditTimes=date('Y-m-d H:i:s'); ?>
											<?= form_open( base_url('Qa_philipines_raw/import_virtuox_excel_data'),array('method'=>'post','enctype'=>'multipart/form-data'));?>
								...
								<div class="col-sm-12">
									<div class="form-group pull-right" > <a href="<?php echo base_url();?>Qa_philipines_raw/sample_virtuox_download" class="btn btn-success" title="Download Sample virtuox Excel" download="Sample virtuox Excel.xlsx" style="margin-right:5px;">Sample Excel</a>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_<?php echo $page ?>/process/add/<?php echo $stratEmailAuditTime; ?>/<?php echo $page ?>">Add Feedback</a>
								</div>
								</div>
									<?php } ?>
