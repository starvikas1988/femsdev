	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				...
				<?php if(get_role_dir() !='agent'||(get_dept_folder() == 'hr' && is_hr_permission_id_card() == true)){?>
				...
				<?php if(get_role_dir() !='agent' || get_user_fusion_id() == "FKOL010931"){ ?>
				<li class="menu-item">
					<a href="<?php echo base_url('employee_id_card/id_card_reissue')?>" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
						<span class="">Re-issue ID Card</span>
					</a>
				</li>
				<?php 
				}
				...
				<li class="menu-item">
					<a href="<?php echo base_url('employee_id_card/not_applied')?>" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
						<span class="">Non applied candidate</span>
					</a>
				</li>
				<?php } ?>
