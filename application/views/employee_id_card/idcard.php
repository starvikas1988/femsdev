...
<!-- <div class="panel panel-default skipIDCard" <?php /*?><?php if($is_idcard !='Yes' ){echo 'style="display:none"';} ?><?php */?>>
	  <div class="panel-body">	  
		<form method="POST" action="<?php /*?><?php echo base_url('employee_id_card/reapply_id_card'); ?><?php */?>">
		<div class="row">
			<div class="col-md-12">
			<input type="hidden" name="agent_id" value="<?php /*?><?php echo get_user_id(); ?><?php */?>">
