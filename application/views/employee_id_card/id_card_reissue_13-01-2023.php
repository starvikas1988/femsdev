	...
	<section class="app-content">
		...
		<div class="widget">
			...
			<div class="widget-body ">
				...
				<form method="GET" action="<?php echo base_url('employee_id_card/reissue_id_card'); ?>">
					<div class="row">
					<div class="col-md-4">
...
<script>
	...
	$.ajax({
		...
		success: function(result){
			//alert(result);
			if(result==1){
				alert('User Already Resigned Cannot Re-issued ID Card');
				$("#submit").attr("disabled", true);
			}
			else if(result==2){
				alert('User Already Terminated Cannot Re-issued ID Card.');
				$("#submit").attr("disabled", true);
			}
			else if(result==3){
				alert('User Already in Pre Term Cannot Re-issued ID Card.');
				$("#submit").attr("disabled", true);
			}
			else if(result==4){
				alert('User  data Already in Resign  and termination  Cannot Re-issued ID Card ');
				$("#submit").attr("disabled", true);
			}
			else if(result==5){
				alert('User  data Already in Termination  and Pre Termination  Cannot Re-issued ID Card ');
				$("#submit").attr("disabled", true);
			}
			else if(result==6){
				alert('User  data Already in Resign  and Pre Termination  Cannot Re-issued ID Card ');
				$("#submit").attr("disabled", true);
			}				
			else{
