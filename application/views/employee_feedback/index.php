			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						...
						<h2 class="widget-title">Anonymous Survey</h2>
					...
					<div class="widget-body clearfix">
						<div class="row">
							<div class="col-md-6">
								...
								<h2><?php echo $assigned_to_name; ?></h2>
								<hr class="widget-separator">
				...
				<div class="col-md-6">
					<div class="widget">
						...
						<div class="widget-body clearfix">
							...
							<textarea class="form-control" minlength='10' style="margin: 20px 0px;" name="leadership_comment" required></textarea>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="widget">
						...
						<div class="widget-body clearfix">
							...
							<textarea class="form-control" minlength='10' style="margin: 20px 0px;" name="work_knowledge_comment" required></textarea>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6">
					<div class="widget">
						...
						<div class="widget-body clearfix">
							...
							<textarea class="form-control" minlength='10' style="margin: 20px 0px;" name="decision_making_comment" required></textarea>
						</div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="widget">
						...
						<div class="widget-body clearfix">
							...
							<textarea class="form-control" minlength='10' style="margin: 20px 0px;" name="communication_comment" required></textarea>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-12">
					<div class="widget">
						...
						<div class="widget-body clearfix">
							...
							<textarea class="form-control" minlength='10' style="margin: 20px 0px;" name="crisis_comment" required></textarea>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="widget">
						...
						<div class="widget-body clearfix">
							<div class="row">
								...
								<div class="col-md-6">
									<b>COMMENTS</b>
									<textarea class="form-control" minlength='10' style="margin: 20px 0px;" name="other_comments" required></textarea>
