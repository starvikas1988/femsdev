								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $monitoring_tech_v1['tl_id'] ?>" disabled>
										</td>
									</tr>
									<tr>
										<td>Order Number:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" name="data[order_number]" value="<?php echo $monitoring_tech_v1['order_number'] ?>" disabled ></td>
										<td>Customer Name:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" name="data[customer_name]" value="<?php echo $monitoring_tech_v1['customer_name'] ?>" disabled ></td>
									...
									<tr>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[Q2_checks]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>10</td>
										<td><input type="text" class="form-control" disabled name="data[cmt1]" value="<?php echo $monitoring_tech_v1['cmt1'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>2. Templates</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[templates]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>2</td>
										<td><input type="text" class="form-control" disabled name="data[cmt2]" value="<?php echo $monitoring_tech_v1['cmt2'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[hours_battery_per]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt3]" value="<?php echo $monitoring_tech_v1['cmt3'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>4. Camera</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[camera]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt4]" value="<?php echo $monitoring_tech_v1['cmt4'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>5. Disconnects</td>
...
Night Shift: The agent highlights the unit numbers cell blue, and documents the time and the Field Tech scheduled to disconnect the patient.</td>
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[disconnects]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>2</td>
										<td><input type="text" class="form-control" disabled name="data[cmt5]" value="<?php echo $monitoring_tech_v1['cmt5'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>6. Call Logs</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[call_logs]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt6]" value="<?php echo $monitoring_tech_v1['cmt6'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[tv_console_notes]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt7]" value="<?php echo $monitoring_tech_v1['cmt7'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[master_setup_list]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt8]" value="<?php echo $monitoring_tech_v1['cmt8'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[MSL_information]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt9]" value="<?php echo $monitoring_tech_v1['cmt9'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[patient_information]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt10]" value="<?php echo $monitoring_tech_v1['cmt10'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[phone_numbers]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt11]" value="<?php echo $monitoring_tech_v1['cmt11'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>12. Start Time</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[start_time]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt12]" value="<?php echo $monitoring_tech_v1['cmt12'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[number_of_cameras]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt13]" value="<?php echo $monitoring_tech_v1['cmt13'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>14. Time Zone</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[time_zone]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt14]" value="<?php echo $monitoring_tech_v1['cmt14'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>15. WIP</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[wip]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt15]" value="<?php echo $monitoring_tech_v1['cmt15'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>16. Time Syncs </td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[time_syncs]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt16]" value="<?php echo $monitoring_tech_v1['cmt16'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>17. Data Card</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[data_card]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt17]" value="<?php echo $monitoring_tech_v1['cmt17'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>18. AV Log</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[av_log]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt18]" value="<?php echo $monitoring_tech_v1['cmt18'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[response_time_FTS]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt19]" value="<?php echo $monitoring_tech_v1['cmt19'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[response_time_RTS]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt20]" value="<?php echo $monitoring_tech_v1['cmt20'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>21. On-Turns</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[on_turns]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt21]" value="<?php echo $monitoring_tech_v1['cmt21'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[courtesy_calls]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>10</td>
										<td><input type="text" class="form-control" disabled name="data[cmt22]" value="<?php echo $monitoring_tech_v1['cmt22'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="call_video_fatal" name="data[call_video_fatal]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>10</td>
										<td><input type="text" class="form-control" disabled name="data[cmt23]" value="<?php echo $monitoring_tech_v1['cmt23'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="call_OOR_fatal" name="data[call_OOR_fatal]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>10</td>
										<td><input type="text" class="form-control" disabled name="data[cmt24]" value="<?php echo $monitoring_tech_v1['cmt24'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[self_disconnects]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>3</td>
										<td><input type="text" class="form-control" disabled name="data[cmt25]" value="<?php echo $monitoring_tech_v1['cmt25'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#F6DDCC">Business Critical</td>
										<td>26. Escalation</td>
										...
										<td>
											<select  class="form-control stratus_point business stratusAuto" id="" name="data[escalation]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>10</td>
										<td><input type="text" class="form-control" disabled name="data[cmt26]" value="<?php echo $monitoring_tech_v1['cmt26'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<select  class="form-control stratus_point compliance stratusAuto" id="" name="data[mantains_privacy]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>10</td>
										<td><input type="text" class="form-control" disabled name="data[cmt27]" value="<?php echo $monitoring_tech_v1['cmt27'] ?>"></td>
									</tr>
									<tr>
										...
										<td>
											<select  class="form-control stratus_point customer stratusAuto" id="" name="data[handle_patient]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt28]" value="<?php echo $monitoring_tech_v1['cmt28'] ?>"></td>
									</tr>
									<tr>
										<td style="color:#0000FF">Customer Critical</td>
										...
										<td>
											<select  class="form-control stratus_point customer stratusAuto" id="" name="data[dignity_of_patient]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt29]" value="<?php echo $monitoring_tech_v1['cmt29'] ?>"></td>
									</tr>
									<tr>
										<td style="color:#0000FF">Customer Critical</td>
										...
										<td>
											<select  class="form-control stratus_point customer stratusAuto" id="" name="data[agent_initiative]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt30]" value="<?php echo $monitoring_tech_v1['cmt30'] ?>"></td>
									</tr>
									<tr>
										<td style="color:#0000FF">Customer Critical</td>
										...
										<td>
											<select  class="form-control stratus_point customer stratusAuto" id="" name="data[treat_patient_as_adults]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt31]" value="<?php echo $monitoring_tech_v1['cmt31'] ?>"></td>
									</tr>
									<tr>
										<td style="color:#0000FF">Customer Critical</td>
										...
										<td>
											<select  class="form-control stratus_point customer stratusAuto" id="" name="data[active_listening]" disabled>
												<!-- <option value="">-Select-</option> -->
										...
										<td>5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt32]" value="<?php echo $monitoring_tech_v1['cmt32'] ?>"></td>
									</tr>
									...
									<tr>
										...
										<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $monitoring_tech_v1['call_summary'] ?></textarea></td>
										<td style="background-color:#5058e6;color: white;">Feedback:</td>
										<td colspan=2><textarea class="form-control" disabled name="data[feedback]"><?php echo $monitoring_tech_v1['feedback'] ?></textarea></td>
									</tr>
									<?php if($monitoring_tech_v1['attach_file']!=''){ ?>
									...
									<tr><td style="font-size:16px;background-color:#5058e6;color:white;">Manager Review:</td> <td colspan="5" style="text-align:left"><?php echo $monitoring_tech_v1['mgnt_rvw_note'] ?></td></tr>
									<tr><td style="font-size:16px;background-color:#5058e6;color:white;">Client Review:</td> <td colspan="5" style="text-align:left"><?php echo $monitoring_tech_v1['client_rvw_note'] ?></td></tr>
										...
										<tr>
											...
											<td colspan=2>
												<select class="form-control" id="" name="agnt_fd_acpt" required>
													<option value="">--Select--</option>
													<option <?php echo $monitoring_tech_v1['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $monitoring_tech_v1['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											...
											<td colspan=4><textarea class="form-control" name="note" required><?php echo $monitoring_tech_v1['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($monitoring_tech_v1['entry_date'],72) == true){ ?>
											<tr>
												<?php if($monitoring_tech_v1['agent_rvw_note']==''){ ?>
