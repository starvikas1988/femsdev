							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td style="width:250px"><input type="text" class="form-control" id="call_date" name="call_date" value="<?php echo $clDate_val; ?>" disabled></td>
										<td style="width:150px">Call Duration:</td>
										<td style="width:250px"><input type="text" class="form-control" id="call_duration" name="data[call_duration]" value="<?php echo $od_business['call_duration'] ?>" disabled ></td>
									...
									<tr>
										...
										<td>Review Date:</td>
										<td style="width:200px"><input type="text" class="form-control" id="review_date" name="review_date" value="<?php echo $clreview_date; ?>" disabled></td>
									</tr>
									<tr>
									<td>Reviewed By:</td>
										<td><input type="text" class="form-control" name="data[reviewed]" value="<?php echo $od_business['reviewed'] ?>" disabled ></td>
										<td>Customer Id:</td>
										<td><input type="text" class="form-control" name="data[customer_id]" value="<?php echo $od_business['customer_id'] ?>" disabled ></td>
										<td>Session ID:</td>
										<td>
											<input type="text" class="form-control" name="data[session_id]" value="<?php echo $od_business['session_id'] ?>" disabled > 
										</td>	
										<td>LOB:</td>
									<td>
									...
									<td style="background-color:#A9DFBF">Customer Critical</td>
										...
										<td>
											<select class="form-control od_business_point customer" name="data[acknowledge_the_caller]" disabled>
									...
									<td style="background-color:#A9DFBF">Customer Critical</td>
										...
										<td>
											<select class="form-control od_business_point customer" name="data[appropriate_empathy]" disabled>
									...
									<td style="background-color:#A9DFBF">Customer Critical</td>
										...
										<td>
											<select class="form-control od_business_point customer" name="data[understood_CSR]" disabled>
									...
									<td style="background-color:#FADBD8">Business Critical</td>
										...
										<td>
											<select class="form-control od_business_point business" name="data[CCP_recognized]" disabled>
												<!-- id="voice_FA" -->
									...
									<td style="background-color:#F9E79F">Compliance Critical</td>
										...
										<td>
											<select class="form-control od_business_point compliance" name="data[verify_place_order]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control od_business_point business" name="data[control_call]" disabled>
									...
									<td style="background-color:#F9E79F">Compliance Critical</td>
										...
										<td>
											<select class="form-control od_business_point compliance" name="data[CCP_noted]" disabled>
									...
									<td style="background-color:#A9DFBF">Customer Critical</td>
										...
										<td>
											<select class="form-control od_business_point customer" id="" name="data[CCP_listened]" disabled>
									...
									<td style="background-color:#F9E79F">Compliance Critical</td>
										...
										<td>
											<select class="form-control od_business_point compliance" name="data[verified_information]" disabled>
									...
									<td style="background-color:#FADBD8">Business Critical</td>
										...
										<td>
											<select class="form-control od_business_point business" name="data[summarize_resolutions]" disabled>
									...
									<td style="background-color:#FADBD8">Business Critical</td>
										...
										<td>
											<select class="form-control od_business_point business" name="data[CCP_microconversion]" disabled>
									...
									<td style="background-color:#FADBD8">Business Critical</td>
										...
										<td>
											<select class="form-control od_business_point business" name="data[offer_accepted]" disabled>
									...
									<?php if($od_business['attach_file']!=''){ ?>
											...
											<?php $attach_file = explode(",",$od_business['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_od/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_od/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
										...
										<tr>
											...
											<td colspan="8">
												<select class="form-control" id="" name="agnt_fd_acpt" required>
													<option value="">--Select--</option>
													<option <?php echo $od_business['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $od_business['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan="2"  style="font-size:16px">Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan="8"><textarea class="form-control" name="note" required><?php echo $od_business['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($od_business['entry_date'],72) == true){ ?>
											<tr>
												<?php if($od_business['agent_rvw_note']==''){ ?>
