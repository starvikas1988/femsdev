							...
							<tr>
								...
								<td width="260px">
									<?php	
										...
										$params="#".$cd['fname']."#".$cd['lname']."#".$cd['hiring_source']."#".$cd['d_o_b']."#".$cd['email']."#".$cd['phone']."#".$cd['last_qualification']."#".$cd['skill_set']."#".$cd['total_work_exp']."#".$cd['country']."#".$cd['state']."#".$cd['city']."#".$cd['postcode']."#".$cd['address']."#".$cd['summary']."#".$cd['attachment']."#".$cd['gender']."#".$cd['ref_name']."#".$interview_site;
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="text" id="lname" name="lname" class="form-control" value="" placeholder="Enter Last name" required>
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" id="dob" name="dob" class="form-control" value="" placeholder="Enter DOB" autocomplete="off" required>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" id="postcode" name="postcode" class="form-control" value="" placeholder="Enter Postcode" >
					</div>
				</div>
			</div>
			<div class="row">
