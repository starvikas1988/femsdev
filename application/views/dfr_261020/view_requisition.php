		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					...
					<?php foreach($view_reuisition as $row): ?>
						...
						<tbody>
							...
							<tr>
								...
								<?php	
									...
									$params=$cd['requisition_id']."#".$cd['fname']."#".$cd['lname']."#".$cd['hiring_source']."#".$dob."#".$cd['email']."#".$cd['phone']."#".$cd['last_qualification']."#".$cd['skill_set']."#".$cd['total_work_exp']."#".$cd['country']."#".$cd['state']."#".$cd['city']."#".$cd['postcode']."#".$cd['address']."#".$cd['summary']."#".$cd['attachment']."#".$cd['gender']."#".$cd['ref_name'];
											...
											if($c_status=='P' || $c_status=='IP'){
												...
												//echo $candidate_total_schedule($cd['can_id'])['sch_value'];
													//foreach (candidate_total_schedule($cd['can_id']) as $row){
														//$sch_value=$row['sch_value'];	//echo $sch_value;
							...
							/////////Approve Requisition & Fusion Employee/////	
										...
										echo "<span class='label label-info' style='font-size:12px; display:inline-block;'>Empolyee</span>";
											...
											if( (get_dept_folder()=="hr" || get_global_access()== 1) && $gross_pay>0 ){
								...
								if(is_block_add_candidate_requisition($requisition_id)==false){
									...
									echo "&nbsp;<a class='btn btn-success btn-xs viewOfferLetter' href='".base_url().'dfr/resend_basic_link?r_id='.$r_id.'&c_id='.$c_id. "' title='Click to resend apply link'><i class='fa fa-envelope' aria-hidden='true'></i></a>";
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="form-check form-check-inline">
						<input type="checkbox" class="form-check-input" id="referal" name="hiring_source" value="Existing Emplyee" required>
...
<div class="modal fade" id="finalSelectionModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog" style="width:1000px;">
	...
	<form class="frmfinalSelection" action="<?php echo base_url(); ?>dfr/candidate_select_employee" onsubmit="return finalselection()" data-toggle="validator" method='POST'>
					...
					<div class="form-group">
						...
						<?php
							if($dfr_location == 'ELS'){
								...
								echo "<input type='text' class='form-control' id='father_husband_name' name='father_husband_name' required>";
							}
						?>
					</div>	
				</div>
					...
					<div class="form-group">
						...
						<?php
							if($dfr_location == 'ELS'){
								...
								echo "<label for='pan_no'>Pan Number</label>";
							}
						?>
