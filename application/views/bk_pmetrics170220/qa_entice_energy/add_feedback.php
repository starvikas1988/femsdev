							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan=8 id="theader" style="font-size:30px">Entice Energy Scorecard</td>
									</tr>
									<tr>
										<td>Name of Call Listener:</td>
										<td colspan=2><input type="text" class="form-control" value="<?php echo get_username(); ?>" disabled></td>
										<td>Audit Date:</td>
										<td colspan=2><input type="text" class="form-control" id="audit_date" name="audit_date" value="<?php echo CurrDateMDY(); ?>" disabled></td>
										<td>Call Date:</td>
									...
									<tr>
										<td>Customer Name:</td>
										<td colspan=2><input type="text" class="form-control" id="" name="customer_name" required></td>
										<td>Week ending Date:</td>
										<td><input type="text" class="form-control" id="week_end_date" name="week_end_date" required></td>
										<td>Type Of Call:</td>
										<td colspan=2>
									...
									<tr>
										...
										<td colspan=2><input type="text" class="form-control" id="customer_phone" name="customer_phone" onkeyup="checkDec(this);" required></td>
									</tr>
									<tr>
										<td>Audit Type:</td>
										<td colspan=2>
									...
									<tr>
										...
										<td><input type="text" readonly id="ee_earned_score" name="earned_score" class="form-control" style="font-weight:bold"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Possible Score:</td>
										<td><input type="text" readonly id="ee_possible_score" name="possible_score" class="form-control" style="font-weight:bold"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Overall Score:</td>
										<td><input type="text" readonly id="ee_overall_score" name="overall_score" class="form-control" style="font-weight:bold"></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class="form-control ee_points" id="" name="agentstatesname" required>
												<option value="">-Select-</option>
												<option ee_val=4 value="Yes">Yes</option>
												<option ee_val=4 value="No">No</option>
												<option ee_val=0 value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ee_points" id="" name="customertakepartinWHD" required>
												<option value="">-Select-</option>
												<option ee_val=3 value="Yes">Yes</option>
												<option ee_val=3 value="No">No</option>
												<option ee_val=0 value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ee_points" id="" name="dailystandingcharges_C3a" required>
												<option value="">-Select-</option>
												<option ee_val=1.5 value="Yes">Yes</option>
												<option ee_val=1.5 value="No">No</option>
												<option ee_val=0 value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ee_points" id="" name="verifycustomerbankaccount" required>
												<option value="">-Select-</option>
												<option ee_val=2 value="Yes">Yes</option>
												<option ee_val=2 value="No">No</option>
												<option ee_val=0 value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ee_points" id="" name="potentialVulnerability_G1a" required>
												<option value="">-Select-</option>
												<option ee_val=1 value="Yes">Yes</option>
												<option ee_val=1 value="No">No</option>
												<option ee_val=0 value="N/A">N/A</option>
											</select>
										</td>
										<td colspan=3></td>
									...
									<tr>
										<td>Call Summary:</td>
										<td colspan=3><textarea class="form-control" id="call_summary" name="call_summary"></textarea></td>
										<td>Feedback:</td>
										<td colspan=3><textarea class="form-control" id="feedback" name="feedback"></textarea></td>
									</tr>
									<tr>
