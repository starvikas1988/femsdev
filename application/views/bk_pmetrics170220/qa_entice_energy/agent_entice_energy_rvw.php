					...
					<div class="widget-body">
						<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF"><td colspan=8 id="theader" style="font-size:30px">Entice Energy Score Card</td></tr>
									...
									<tr>
										...
										<td>Call Date:</td>
										<td><input type="text" class="form-control" id="call_date" name="call_date" value="<?php echo mysql2mmddyy($enticeEnergy['call_date']); ?>" disabled></td>
									</tr>
									<tr>
										<td>Agent:</td>
										<td colspan=3>
										...
										<!--<td>Fusion ID:</td>
										<td><input type="text" disabled class="form-control" id="fusion_id" name="" value="<?php //echo $enticeEnergy['fusion_id'] ?>"></td> -->
										<td>L1 Supervisor:</td>
										<td colspan=3>
									...
									<tr>
										<td>Customer Name:</td>
										<td colspan=2><input type="text" class="form-control" id="" name="customer_name" value="<?php echo $enticeEnergy['customer_name'] ?>" disabled></td>
										<td>Week ending Date:</td>
										<td><input type="text" class="form-control" id="week_end_date" name="week_end_date" value="<?php echo mysql2mmddyy($enticeEnergy['week_end_date']) ?>" disabled></td>
										<td>Type Of Call:</td>
										<td colspan=2>
											<select class="form-control" id="" name="call_type" disabled>
									...
									<tr>
										...
										<td colspan=2><input type="text" class="form-control" id="customer_phone" name="customer_phone" onkeyup="checkDec(this);" value="<?php echo $enticeEnergy['customer_phone'] ?>" disabled></td>
									</tr>
									<tr>
										<td>Audit Type:</td>
										<td colspan=2>
									...
									<tr>
										...
										<td><input type="text" disabled id="ee_earned_score" name="earned_score" class="form-control" style="font-weight:bold" value="<?php echo $enticeEnergy['earned_score'] ?>"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Possible Score:</td>
										<td><input type="text" disabled id="ee_possible_score" name="possible_score" class="form-control" style="font-weight:bold" value="<?php echo $enticeEnergy['possible_score'] ?>"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Overall Score:</td>
										<td><input type="text" disabled id="ee_overall_score" name="overall_score" class="form-control" style="font-weight:bold" value="<?php echo $enticeEnergy['overall_score'] ?>"></td>
									</tr>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control ee_points" id="" name="agentstatesname" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control ee_points" id="" name="cofirmspeakingtoDMC" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control ee_points" id="" name="goldenaccountdetails" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control ee_points" id="" name="customerprovide1stline" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="customertakepartinWHD" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="confirmsigleduelFuel" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="tariffprobed3times" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="askedsufficientquestion" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="customerhaveSmartmeter" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="economy7checked" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="agentgavebesttariff" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="agentgavefuturespend" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td rowspan=2>3</td>
										<td>
											<select class="form-control ee_points" id="" name="dailystandingcharges_C3a" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										<td>
											<select class="form-control ee_points" id="" name="VATstatement_C3b" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td rowspan=2>3</td>
										<td>
											<select class="form-control ee_points" id="" name="cancelletionfees_C4a" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										<td>
											<select class="form-control ee_points" id="" name="SPcancelletionfees_C4b" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control ee_points" id="" name="verifycustomerbankaccount" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="reconfirmaccountnumber" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="receiveconfirmpayment" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control ee_points" id="" name="directdebitmandate" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="correctT&Cneed" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="agentreadcontactnumber" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control ee_points" id="" name="signupScriptingread" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control ee_points" id="" name="honestwithcustomer" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td rowspan=2>2</td>
										<td>
											<select class="form-control ee_points" id="" name="potentialVulnerability_G1a" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										<td>
											<select class="form-control ee_points" id="" name="priorityVulnerability_G1b" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control ee_points" id="" name="takeappropriateaction" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										<td>Call Summary:</td>
										<td colspan=3><textarea class="form-control" disabled><?php echo $enticeEnergy['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan=3><textarea class="form-control" disabled><?php echo $enticeEnergy['feedback'] ?></textarea></td>
									</tr>
									...
									<tr>
										...
										<td colspan=6><textarea class="form-control" name="note" required><?php echo $enticeEnergy['agent_rvw_note'] ?></textarea></td>
									</tr>
										
									<?php if(is_access_qa_agent_module()==true){
									if(is_available_qa_feedback($enticeEnergy['entry_date'],72) == true){ ?>
										<tr>
											<?php if($enticeEnergy['agent_rvw_date']==''){ ?>
