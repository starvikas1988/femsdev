	...
	<?php echo form_open('',array('method' => 'get')) ?>
		...
		<div class='col-md-2' >
			<div class="form-group" id="week_range_container">
				...
				<label for="sch_range">Start Date</label>
		...
		<div class='col-md-2' >
			<div class="form-group" id="week_range_container">
				...
				<label for="sch_range">End Date</label>
		...
		<div class='col-md-2' id="agent_container" >
			<div class="form-group">
				...
				<input type="text" class="form-control" id="agent_fusion_id" name="agent_fusion_id" required>
			</div>
		<!-- .form-group -->
		</div>
		<?php
...
//echo date('H:i', $time)
			...
			//else if($kpi_type == 9 ) $kpiDispVal = sprintf("%1.2f",round(($kpi_value * 24 )));
									...
									<?php
										...
										{	echo '<tr>';
											...
											foreach($overall_summary[$mpid] as $key=>$value)
											{
												...
												if($hide_col[trim($kpi_info[1])]['tl_view'] == 1)
												{
