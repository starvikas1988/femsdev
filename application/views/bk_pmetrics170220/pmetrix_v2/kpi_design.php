		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					...
					<hr class="widget-separator"/>
					<div style='float:right; margin-top:-35px;' class="col-md-1">
...
<div class="modal fade" id="modalAddDesign" tabindex="-1" role="dialog" aria-labelledby="addAddDesign" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		...
		<form class="frmAddDesign" action="<?php echo base_url(); ?>pmetrix_v2/addDesign" data-toggle="validator" method='POST'>
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-group">
						...
						<select class="form-control" name="client_id" id="aclient_id" >
							...
							<?php foreach($client_list_all as $client): ?>
								<?php
								$sCss="";
								if($client['id']==$cValue) $sCss="selected";
								?>
				...
				<div class="row " id='kpi_divs'>
					...
					<div class="col-md-12">
						...
						<div class="col-md-1">
							<label for="management_view">Currency</label>
						</div>
						<div class="col-md-1">
							<label for="weightage">Weightage (%)</label>
						</div>
						<div class="col-md-1">
							<label for="weightage_comp">Comparison (%)</label>
						</div>
						<div class="col-md-1">
							<label for="agent_view">Agent View</label>
						</div>
						<div class="col-md-1">
							<label for="tl_view">TL View</label>
						</div>
						<div class="col-md-1">
							<label for="management_view">Management View</label>
						</div>
						<div class="col-md-1">
					...
					<div class="col-md-12 kpi_input_row">
						...
						<div class="col-md-1">
							<input type="number" min="0" step="1" pattern="\d+" value="20" class="form-control" placeholder="Integer" name="weightage[]">
						</div>
						
						<div class="col-md-1">
							<select class="form-control" name="weightage_comp[]"><option value="1" selected="">MAX</option><option value="0">MIN</option></select>
						</div>
						<div class="col-md-1">
								
								<select class="form-control" name="agent_view[]"><option value="1">Yes</option><option value="0" selected>No</option></select>
								
						</div>
						<div class="col-md-1">
								
								<select class="form-control" name="tl_view[]"><option value="1">Yes</option><option value="0" selected>No</option></select>
								
						</div>
						<div class="col-md-1">
								
								<select class="form-control" name="management_view[]"><option value="1">Yes</option><option value="0" selected>No</option></select>
...
<div class="modal fade" id="modalUpdateDesign" tabindex="-1" role="dialog" aria-labelledby="updateDesign" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
		...
		<form class="frmUpdateDesign" action="<?php echo base_url(); ?>pmetrix_v2/updateDesign" data-toggle="validator" method='POST'>
