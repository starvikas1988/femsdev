...
<aside id="app-aside" class="app-aside left light">
	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			...
			<!--			
			<li class="menu-item">
				<a href="<?php echo base_url()?>pmetrix_v2" class="menu-link">
			...
			<?php //if( get_role_dir() == "super" || get_global_access()=='1' || is_access_ba_design() == true ) { ?>
			
				<li class="menu-item">
					<a href="<?php echo base_url()?>pmetrix_v2/design" class="menu-link">
			...
			<?php if( is_access_ba_upload() == true ) { ?>
			
				<li class="menu-item">
					<a href="<?php echo base_url()?>pmetrix_v2/uploadMetrix" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-accounts-outline zmdi-hc-lg"></i></span>
			...
			<?php } ?>
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>pmetrix_v2/upload_target" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-accounts-outline zmdi-hc-lg"></i></span>
						<span class="">Upload Target</span>
					</a>
				</li>
				<li class="menu-item">
					<a href="<?php echo base_url()?>pmetrix_v2/upload_grade" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-accounts-outline zmdi-hc-lg"></i></span>
						<span class="">Upload Grade</span>
					</a>
				</li>
