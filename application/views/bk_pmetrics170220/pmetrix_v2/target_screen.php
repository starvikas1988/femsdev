			...
			<form id="add_target_form" method='POST'>
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4 form-group">
							<label>Tenure Bucket</label>
							<select name="tenure_bucket" class="form-control" id="tenure_bucket" required>
								<option value="">--Select Bucket--</option>
								<option value="0-30">0 to 30 Days</option>
								<option value="31-60">31 to 60 Days</option>
								<option value="61-90">61 to 90 Days</option>
								<option value="91-180">91 to 180 Days</option>
								<option value="181-999999">Morethan 180 Days</option>
							</select>
						</div>
					</div>
					<div class="row">
