							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="9" id="theader" style="font-size:30px">Agent NORDNET Rvw<!-- <img src="<?php echo base_url(); ?>main_img/hra.png"> --></td>
									...
									<tr style="height:45px">
										...
										?>
									<tr>
										<td rowspan=6 class="eml1">1. EVALUATION DE L'ACCUEIL, DU CLIMAT DE L'APPEL ET DE LA PRISE DE CONGE</td>
									...
									<tr>
										<td rowspan=4 class="eml1">EVALUATION DE LA REPONSE FOURNIE</td>									
										<td class="eml" colspan=6><?php echo $scoreParametername[$parameter_column_name++] ?></td>
										<td>
											<select class="form-control points_epi"  name="data[<?=$columname[$score_column_name++]?>]" disabled>
												<?php
								   ...
								   <tr>
										<td rowspan=1 class="eml1">ATTITUDE ' TOUS VENDEURS'</td>									
										<td class="eml" colspan=6><?php echo $scoreParametername[$parameter_column_name++] ?></td>
										<td>
											<select class="form-control points_epi"  name="data[<?=$columname[$score_column_name++]?>]" disabled>
												<?php
