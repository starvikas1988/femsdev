...
<div class="widget">
<header class="widget-header">
<h4 class="widget-title">Non Compliance Apps <a class="btn btn-warning btn-sm" data-toggle="modal" data-target="#uapp"><i class="fa fa-plus"></i> Add New</a></h4>
</header>
<hr class="widget-separator"/>
...
<div class="modal" id="uapp" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
	...
	<form method="POST">
      <div class="modal-header">
        <h5 class="modal-title"><b>Non Compliance App</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
