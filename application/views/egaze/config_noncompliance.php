...
<h4 class="widget-title">New Non Compliance App</h4>
</header>
...
<form id="addConfigEgaze" method="POST" action="<?php echo base_url('egaze/submitConfig'); ?>">
					...
					<div class="form-group">
						...
						<input type="hidden" class="form-control" name="app_type" id="app_type" value="noncompliance">
					</div>
					</div>
					</div>
...
<div class="widget">
<header class="widget-header">
<h4 class="widget-title">Non Compliance Apps</h4>
</header>
<hr class="widget-separator"/>
