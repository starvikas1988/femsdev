						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_'.$page); ?>">
							<div class="row">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url('Qa_'.$page);?>" type="submit" id='btnView' name='btnView' value="View" style="padding: 10px;">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="row">
										<div class="col-sm-12">
									<div class="pull-left">Qa KEEPER Audit</div>
									</div>
								...
								<div class="col-sm-8">
									<div class="form-group">
										...
										<?php $stratAuditTimes=date('Y-m-d H:i:s'); ?>
											<?= form_open( base_url('Qa_philipines_raw/import_keeper_excel_data'),array('method'=>'post','enctype'=>'multipart/form-data'));?>
								...
								<div class="col-sm-4">
									<div class="form-group pull-right"  style="margin-top: 10px"> <a href="<?php echo base_url();?>Qa_philipines_raw/sample_keeper_download" class="btn btn-success" title="Download Sample keeper Excel" download="Sample keeper Excel.xlsx" style="margin-right:5px;">Sample Excel</a>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_<?php echo $page ?>/process/add/<?php echo $stratEmailAuditTime; ?>/<?php echo $page ?>">Add Feedback</a>
								</div>
								</div>
									<?php } ?>
								...
								<tbody>
									...
									<tr>
											...
											<?php
											 ...
											 <?php foreach($attach_file as $af){ ?>
												<audio controls='' style="width:120px; height:25px; background-color:#607F93"> 
												  <source src="<?php echo base_url(); ?>qa_files/qa_<?php echo $page ?>/<?php echo $page ?>/<?php echo $af; ?>" type="audio/ogg">
												  <source src="<?php echo base_url(); ?>qa_files/qa_<?php echo $page ?>/<?php echo $page ?>/<?php echo $af; ?>" type="audio/mpeg">
												</audio>
											 <?php } ?>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_<?php echo $page ?>/process/mgnt_rvw/<?php echo $rpid; ?>/<?=$page?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
										</td>
									</tr>
									<?php endforeach; 
								// }
