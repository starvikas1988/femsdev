...
<?php if(get_login_type() != "client" && empty($disable_ameyo_chat)){ ?>
	...
	var campaignId = '11';
	var nodeflowId = '<?php echo (!empty(get_user_office_id()) && get_user_office_id() == 'ALT') ? '20' : '5'; ?>';
		...
		<ul id="top-nav" class="pull-right">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu animated flipInY">
					...
					<?php }else{ ?>
						<li><a href="<?php echo base_url().get_role_dir(); ?>/changePasswd"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>Change Password</a></li>
					<?php } ?>
					
					<li><a id="btnLogoutModel" style= 'cursor:pointer;'><i class="zmdi m-r-md zmdi-hc-lg zmdi-sign-in"></i>Logout</a></li>
					
					<!-- <li><a href="<?php //echo base_url();?>logout"><i class="zmdi m-r-md zmdi-hc-lg zmdi-sign-in"></i>Logout</a></li> -->
...
<?php if(get_login_type() != "client"){ ?>
	...
	<div>
		<ul id="top-nav" class="pull-right">
			...
			<li class="nav-item dropdown">
				...
				<a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-hc-2x zmdi-apps"></i></a>
				
				<div class="dropdown-menu animated flipInY" style="padding-bottom:2px;">
										
					<?php include_once "femsappslink.php" ?>
	...
	<div>
		<ul id="top-nav" class="pull-right">
			<li class="nav-item dropdown">
				<a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-hc-2x zmdi-alert-triangle"></i></a>
				
				<ul id='global_notify_div' class="dropdown-menu animated flipInY">
					
					<!--
					<li><a href="<?php //echo base_url().get_role_dir(); ?>/changePasswd"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>ddddddd Password</a></li>
					<li><a href="<?php //echo base_url();?>logout"><i class="zmdi m-r-md zmdi-hc-lg zmdi-sign-in"></i>Lofffffgout</a></li>
					-->
					<?php
	...
	<?php if(get_login_type()!="client" && isDisableFemsChat()==false){ ?>
	<div>
		<ul id="top-nav" class="pull-right">
						
			<li class="nav-item dropdown">
				<a href="<?php echo base_url();?>femschat" target="_blank" style='margin-top:4px;' class="dropdown-toggle" role="button" aria-haspopup="false" aria-expanded="false"><i class="zmdi zmdi-hc-2x zmdi-comments"></i></a> 
			</li>
	...
	<div>
		<ul id="top-nav" class="pull-right">
			<li class="nav-item dropdown">
					...
					<div class="flag" style="disply:block;z-index:9999; margin-top:18px;">
