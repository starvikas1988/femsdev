...
<?php if ($craftjack_inbound_outbound_id != 0) {
							...
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td colspan="2">
												...
												<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $craftjack_inbound_outbound_data['tl_id'] ?>" required>
											</td>
											<td>Type of Call:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<select class="form-control" id="type_of_call" name="data[call_type]" required>
										...
										<tr>
											...
											<td colspan="2">
												<input type="text" class="form-control" name="data[no_of_SR]" value="<?php echo $craftjack_inbound_outbound_data['no_of_SR'] ?>" required>
											</td>
											<td>SR/Link:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[sr_link]" value="<?php echo $craftjack_inbound_outbound_data['sr_link'] ?>" required>
											</td>
											<td>Customer Name:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[customer_name]" value="<?php echo $craftjack_inbound_outbound_data['customer_name'] ?>" required>
											</td>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="" name="data[intro_mentioned_customer_name]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="" name="data[intro_agent_mentioned_name]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob business business_ib business_ob" id="" name="data[intro_confirmed_requested_job]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="" name="data[intro_opened_call_properly]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob business business_ib business_ob" id="" name="data[follow_up_brief_description]" required>
									...
									<tr>
										...
										<td class="ib_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib  compliance compliance_ib" id="ib_show1" name="data[follow_up_questions_panel_ib]" required>
									...
									<tr>
										...
										<td class="ib_show">5</td>
										<td class="ib_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib compliance compliance_ib" id="ib_show2" name="data[follow_up_access_correct_panel_ib]" required>
									...
									<tr>
										...
										<td class="ob_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ob business business_ob" id="ob_show1" name="data[follow_up_probe_job_done_ob]" required>
									...
									<tr>
										...
										<td class="ob_show">5</td>
										<td class="ob_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ob business business_ob" id="ob_show2" name="data[follow_up_job_done_by_suggested_company_ob]" required>
									...
									<tr>
										...
										<td class="ob_show">5</td>
										<td class="ob_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ob business business_ob" id="ob_show3" name="data[follow_up_probe_experience_ob]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob customer customer_ib customer_ob" id="" name="data[communication_active_listening]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob customer customer_ib customer_ob" id="" name="data[communication_call_etiquette]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob customer customer_ib customer_ob" id="" name="data[communication_dead_air]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob customer customer_ib customer_ob" id="" name="data[communication_interrupted_customer]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob customer customer_ib customer_ob" id="" name="data[communication_ownership_call]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob customer customer_ib customer_ob" id="" name="data[communication_rate_of_speech]" required>
									...
									<tr>
										...
										<td class="ob_show">5</td>
										<td class="ob_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ob compliance compliance_ob" id="ob_show4" name="data[sr_send_details_ob]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob business business_ib business_ob" id="" name="data[sr_correct_project_request]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="" name="data[sr_gather_contact_details]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob business business_ib business_ob" id="" name="data[sr_general_contracter]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="" name="data[sr_verified_auth_project]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob business business_ib business_ob" id="" name="data[closing_closure_greeting]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="ib_ob_Fail1" name="data[critical_valid_SR]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="ib_ob_Fail2" name="data[critical_correct_CTT]" required>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ib craftjack_IB_OB_point_ob compliance compliance_ib compliance_ob" id="ib_ob_Fail3" name="data[critical_contact_verbatim]" required>
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<tr>
											...
											<?php if ($craftjack_inbound_outbound_id == 0) { ?>
												...
												<?php } else {
												if ($craftjack_inbound_outbound_data['attach_file'] != '') { ?>
													<td colspan=6>
										...
										<?php if ($craftjack_inbound_outbound_id != 0) { ?>
											<tr>
												...
												<td colspan=6><?php echo $craftjack_inbound_outbound_data['agnt_fd_acpt'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td>
												<td colspan=6><?php echo $craftjack_inbound_outbound_data['agent_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td>
												<td colspan=6><?php echo $craftjack_inbound_outbound_data['mgnt_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td>
												<td colspan=6><?php echo $craftjack_inbound_outbound_data['client_rvw_note'] ?></td>
											</tr>
