						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">Craftjack Inbound / Outbound</div>
									<?php if(is_access_qa_module()==true){ ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_craftjack/add_edit_craftjack_inbound_outbound/0">Add Feedback</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									foreach($craftjack_inbound_outbound_data as $row): ?>
									<tr>
										<td><?php echo $i++; ?></td>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_craftjack/add_edit_craftjack_inbound_outbound/<?php echo $cjid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit/Review</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
