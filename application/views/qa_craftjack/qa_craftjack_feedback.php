					...
					<div class="row">
						<div class="col-md-12">
							<header class="widget-header">
								...
								<div class="col-sm-12">
									<div class="form-group pull-right" > <a href="<?php echo base_url();?>Qa_philipines_raw/sample_craftjack_cebu_download" class="btn btn-success" title="Download Sample craftjack_cebu Excel" download="Sample craftjack_cebu Excel.xlsx" style="margin-right:5px;">Sample Excel</a>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_craftjack/add_edit_craftjack_cebu/0">Add Feedback</a>
								</div>
								</div>	
									<?php } ?>
