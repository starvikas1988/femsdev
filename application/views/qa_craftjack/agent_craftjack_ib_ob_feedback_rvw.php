							...
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt1]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt1'] ?>"></td>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt2]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt2'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt3]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt3'] ?>"></td>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt4]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt4'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt5]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt5'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>
									<tr>
										...
										<td class="ib_show" colspan=2><input type="text" disabled name="data[cmt6]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt6'] ?>"></td>
									...
									<tr>
										...
										<td class="ib_show" colspan=2><input type="text" disabled name="data[cmt7]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt7'] ?>"></td>
										<td class="ib_show" style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
										...
										<td class="ob_show" colspan=2><input type="text" disabled name="data[cmt8]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt8'] ?>"></td>
									...
									<tr>
										...
										<td class="ob_show" colspan=2><input type="text" disabled name="data[cmt9]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt9'] ?>"></td>
										<td class="ob_show" style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>
									<tr>
										<td class="ob_show">OB</td>
										...
										<td class="ob_show" colspan=2><input type="text" disabled name="data[cmt10]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt10'] ?>"></td>
										<td class="ob_show" style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>	
									<tr>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt11]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt11'] ?>"></td>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt12]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt12'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt13]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt13'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt14]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt14'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt15]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt15'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt16]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt16'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt17]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt17'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="ob_show" colspan=2><input type="text" disabled name="data[cmt18]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt18'] ?>"></td>
									...
									<tr>
										...
										<td colspan=2><input type="text" disabled name="data[cmt19]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt19'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt20]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt20'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" disabled name="data[cmt21]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['cmt21'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" name="data[cmt22]" class="form-control" disabled value="<?php echo $craftjack_inbound_outbound_data['cmt22'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan=2><input type="text" name="data[cmt23]" class="form-control" disabled value="<?php echo $craftjack_inbound_outbound_data['cmt23'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan=2><input type="text" name="data[cmt24]" class="form-control" disabled value="<?php echo $craftjack_inbound_outbound_data['cmt24'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" name="data[cmt25]" class="form-control" disabled value="<?php echo $craftjack_inbound_outbound_data['cmt25'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td colspan=2><input type="text" name="data[cmt26]" class="form-control" disabled value="<?php echo $craftjack_inbound_outbound_data['cmt26'] ?>"></td>
										<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
										<td class="ob_show">OB</td>
										...
										<td class="ob_show">
											<select class="form-control craftjack_inbound_outbound_point craftjack_IB_OB_point_ob compliance compliance_ob" id="ib_ob_Fail4" name="data[critical_recorded_line]" disabled>
										...
										<td class="ob_show" colspan=2><input type="text" name="data[cmt27]" class="form-control" disabled value="<?php echo $craftjack_inbound_outbound_data['cmt27'] ?>"></td>
										<td class="ob_show" style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>Agent</td>
										<td>
											<select class="form-control" id="" name="data[aht_related_agent]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt4]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt4'] ?>"></td>
									...
									<tr>
										...
										<td>Customer</td>
										<td>
											<select class="form-control" id="" name="data[aht_related_customer]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt5]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt5'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>AHT Related Spot Check</td>
										<td>Process</td>
										<td>
											<select class="form-control" id="" name="data[aht_related_process]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt6]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt6'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>AHT Related Spot Check</td>
										<td>Technology</td>
										<td>
											<select class="form-control" id="" name="data[aht_related_technology]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt7]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt7'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td>Agent</td>
										<td>
											<select class="form-control" id="" name="data[conversion_related_agent]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt8]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt8'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>Conversion Related Spot Check</td>
										<td>Customer</td>
										<td>
											<select class="form-control" id="" name="data[conversion_related_customer]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt9]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt9'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>Conversion Related Spot Check</td>
										<td>Process</td>
										<td>
											<select class="form-control" id="" name="data[conversion_related_process]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt10]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt10'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>Conversion Related Spot Check</td>
										<td>Technology</td>
										<td>
											<select class="form-control" id="" name="data[conversion_related_technology]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt11]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt11'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										...
										<td>Agent</td>
										<td>
											<select class="form-control" id="" name="data[sr_related_agent]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt12]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt12'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>SR/HR Related Spot Check</td>
										<td>Customer</td>
										<td>
											<select class="form-control" id="" name="data[sr_related_customer]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt13]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt13'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>SR/HR Related Spot Check</td>
										<td>Process</td>
										<td>
											<select class="form-control" id="" name="data[sr_related_process]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt14]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt14'] ?>"></td>
									</tr>
									<tr>
										<td>IB/OB</td>
										<td colspan=2>SR/HR Related Spot Check</td>
										<td>Technology</td>
										<td>
											<select class="form-control" id="" name="data[sr_related_technology]" disabled>
										...
										<td colspan=3><input type="text" disabled name="data[acpt_cmt15]" class="form-control" value="<?php echo $craftjack_inbound_outbound_data['acpt_cmt15'] ?>"></td>
									</tr>
									<!-- Add ACPT -->
										<?php //$adtsht='';
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<tr>
											<td>Call Summary:</td>
											<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $craftjack_inbound_outbound_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $craftjack_inbound_outbound_data['feedback'] ?></textarea></td>
										</tr>
