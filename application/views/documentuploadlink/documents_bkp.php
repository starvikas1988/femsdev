				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
					  	...
					  	<?php if($user_office_id == "MAN" || $user_office_id == "CEB" || $user_office_id == "ELS" || isIndiaLocation($user_office_id)==true){ ?>
					  	<tr>
					  		<td>
					...
					<?php if($user_office_id == "MAN" || $user_office_id == "CEB" || $user_office_id == "JAM" || $user_office_id == "ELS"){ ?>
					<tr>
							<td>
				 ...
				 <?php if(!empty($get_edu)) { ?>
				  ...
				  <table class="table table-bordered">
							  ...
							  <?php foreach ($get_edu as $key => $value): ?>
							  	...
							  	<td>
							  		<input type="hidden" name="" id="edudoc" value="<?php echo $value['education_doc'];?>" >
			...
			<table class="table table-bordered">
							  ...
							  <?php foreach ($get_exp as $key => $value): ?>
							  		<tr>
									  	...
									  	<td>
									  		<input type="hidden" id="expdoc" class="company_name" value="<?php echo $value['experience_doc']; ?>" >
									  		<?php
