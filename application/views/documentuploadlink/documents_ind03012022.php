...
<div class="container">
    ...
    display: block;padding:4px;" type="text" value="" name="passing_year" class="form-control" placeholder="Passing Year" id="passing_year"  required>
						  	</td>
						  	<td>
								Marks/Grade/CGPA/Result: 
						  		<input style="margin: auto;
    display: block;padding:4px;" type="text" value="" name="percentage" class="form-control" placeholder="Marks/Grade/CGPA/Result" id="percentage"  required>
						  	</td>
						  </tr>	
						  <tr>
							<td>
					  ...
					  <tr>
							<td>
								<label class="sig">Signature</label>
