                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php
                                                if (!empty($get_person[0]['photo'])) {
                                                    $directory_check = "photo";
                                                    $file_url = base_url() . "/uploads/photo/" . $get_person[0]['photo'];
                                                    ...
                                                    <a href="<?php echo base_url() . "uploads/photo/" . $get_person[0]['photo'] ?>" target="_blank">
                                                        <img width="85" style="height:80px!important;" src="<?php echo base_url() . $icon_url; ?>"/>  <?php echo $get_person[0]['photo']; ?> </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($get_person[0]['attachment_adhar'])) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($get_person[0]['attachment_adhar_back'])) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                if (!empty($get_person[0]['attachment_pan'])) {
                                                    $directory_check = "pan";
                                                    $file_url = base_url() . "/uploads/pan/" . $get_person[0]['attachment_pan'];
                                                    ...
                                                    <a href="<?php echo base_url() . "uploads/pan/" . $get_person[0]['attachment_pan'] ?>" target="_blank">
                                                        <img width="85" style="height:80px!important;" src="<?php echo base_url() . $icon_url; ?>"/>  <?php echo $get_person[0]['attachment_pan']; ?> </a>
                                            ...
                                            <td>
                                                <input type="file" value="<?= $get_person[0]['attachment_pan'] ?>" name="pan" class="form-control1" placeholder="" id="panfile" accept=".pdf,image/*" required="required">
                                            </td>
                                        </tr>
                                        <?php if (in_array($naps_frm, $stipend_array) && isIndiaLocation($user_office_id) == true) { ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <?php
                                                    if (!empty($get_person[0]['attachment_naps_frm'])) {
                                                        $directory_check = "naps_frm";
                                                        $file_url = base_url() . "/uploads/naps_frm/" . $get_person[0]['attachment_naps_frm'];
                                                ...
                                                <td>
                                                    <input type="file" value="<?= $get_person[0]['attachment_naps_frm'] ?>" name="naps_frm" class="form-control1" placeholder="" id="naps_frm" accept=".pdf,image/*" required="required">
                                                </td>
                                            </tr>
                                            <?php
                                        }
...
//   echo'<pre>';print_r($get_edu);
                                        ...
                                        <?php
                                        //echo $onboarding_type;
                                        if ($onboarding_type == "NAPS" || $onboarding_type == 'NATS') {
                                            // echo $onboarding_type;
                                            //if(!empty($get_edu)){
                                            ?>
                                            <tr>
                                ...
                                <div id="bank_info" style="display:none">
                                    <div class="bank_information" style="display:flex; padding: .21rem; margin: 2rem 0; flex-wrap:wrap;">
                                        ...
                                        <div class="b_i" style="width:50%; margin-top: .5rem;">
                                            <div class="label"><label>Account Number</label><sup style="color:red;">*</sup></div>
        ...
        <script>
                                                               ...
                                                               $(document).ready(function () {
                                                                   ...
                                                                   var phfile = $("#panfile").attr('value');
                                                                   if (phfile !== "") {
                                                                       $("#panfile").removeAttr('required');
                                                                   }
