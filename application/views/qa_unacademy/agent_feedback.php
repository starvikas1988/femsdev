			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						...
						<div class="card-body">
							<form id="form_new_user" method="GET" action="<?php echo base_url('qa_unacademy/agent_unacademy_feedback'); ?>">
							<div class="row">
								<div class="col-sm-3">
					...
					<div class="card">
						<div class="card-body new-table">
							<div class="row col-sm-6">
								<h4 class="widget-title">Unacademy Activation</h4>
								<button class="btn btn-success"><i class="fa fa-calculator" aria-hidden="true"></i>&nbsp;Total Audits: <b><?php echo $tot_act_feedback ?></b></button>
								<button class="btn btn-warning"><i class="fa fa-comments" aria-hidden="true"></i>&nbsp;Review Pending: <b><?php echo $yet_act_rvw ?></b></button>
							</div>
							<table class="table table-striped " id="datatablesSimple">
								...
								<tbody>
									<?php $i=1;
										foreach($unacademy_activation_data as $row){
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php
										...
										<td>
											<?php $adt_id=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_unacademy/agent_unacademy_activation_rvw/<?php echo $adt_id ?>"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Review</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card">
						<div class="card-body new-table">
							<div class="row col-sm-6">
								<h4 class="widget-title">Unacademy [Version-II]</h4>
							...
							<table class="table table-striped " id="datatablesSimple">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php $adt_id=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_unacademy/agent_unacademy_rvw/<?php echo $adt_id ?>"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;Review</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
