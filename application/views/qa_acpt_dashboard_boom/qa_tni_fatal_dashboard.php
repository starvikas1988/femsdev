			...
			<div class="col-md-12">
				<div class="widget row">
					<div class="widget-body table-responsive">
					  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_tni_dashboard_boomsourcing/'); ?>/tni_fatal_dashboard">
						<div class="row">
							<div class="col-md-2">
								...
								<div class="form-group">
									...
									<select class="form-control" id="office_id" name="office_id[]" multiple="multiple">
										...
										if(is_array($office_id)){
											if(in_array('ALL',$office_id)) $sel='selected';
										}
										?>
										<option value="ALL" <?php echo $sel;?>>ALL</option>
										<?php foreach($location_list as $lc){
											$sel="";
											//if($lc['abbr']==$office_id) $sel='selected';
											if(is_array($office_id)){
												if(in_array($lc['abbr'],$office_id)) $sel='selected';
											}
										?>
					  ...
					  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_tni_dashboard_boomsourcing/download_TNI_fatal'); ?>">
					  <div class="row">
						  ...
						  <!--<div class="col-md-2 text-right" style="margin-top:20px">
								<button type="button" class="btn btn-success waves-effect" style="width:150px" data-toggle="modal" data-target="#myModal">Send Email</button>
						  </div>-->
					  </div>
					  </form>
					  <?php }?>
...
<!--- Email popup modal -->
 <?php if(!empty($tot_param)){ ?>
<form id="email_form" method="GET" action="<?php echo base_url('Qa_tni_dashboard_boomsourcing/download_TNI_fatal'); ?>">
					...
					<div class="modal-body">
					  <div class="col-md-8" style="margin-top:20px">
					   ...
					   <div class="filter-widget">
						...
						<input type="email" class="form-control" id="Email" name="send_email" required>
						</div>
					</div>
		            <div class="modal-footer">
		              <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
		              <button type="submit" id='btnEmail' name='btnEmail' value="Email" class=" btn btn-danger">Send</button>
		            </div>
		      </div>
