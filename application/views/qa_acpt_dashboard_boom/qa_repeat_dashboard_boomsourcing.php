			...
			<div class="col-md-12">
				<div class="widget row">
					<div class="widget-body table-responsive">
					  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_repeat_dashboard_boomsourcing'); ?>">
						<div class="row">
							<div class="col-md-2">
					  ...
					  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_repeat_dashboard_boomsourcing/download_repeat_rep'); ?>">
					  <div class="row">
						...
						<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" width="100%" cellspacing="0">
							...
							<tbody style="text-align: center;">
								...
								<tr>
									...
									<td><?php 
										if($ta[$prm] >1){
											echo "<span style='color:#FF0000;font-weight:bold'>".$ta[$prm]."</span>"; 
										}
										else{
											echo $ta[$prm]; 
										}
...
<!--- Email popup modal -->
 <?php if(!empty($tot_param)){ ?>
<form id="email_form" method="GET" action="<?php echo base_url('Qa_repeat_dashboard_boomsourcing/download_repeat_rep'); ?>">
