							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<select class="form-control" name="data[type_of_audit]" required>
												<?php 
												if($ajio_email_v2['type_of_audit']!=''){
													?>
									...
									<tr>
										...
										<td colspan="6">
											<select class="form-control" id="tagging_evaluator" name="data[tagging_evaluator]" required>
												<?php 
												if($ajio_email_v2['tagging_evaluator']!=''){
													?>
													<option value="<?php echo $ajio_email_v2['tagging_evaluator'] ?>"><?php echo $ajio_email_v2['tagging_evaluator'] ?></option>
													<?php
												}
												?>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="appropriate_acknowledgements" name="data[appropriate_acknowledgements]" required>
												<option ajio_val=10 ajio_max=10 <?php echo $ajio_email_v2['appropriate_acknowledgements'] == "Yes"?"selected":"";?> value="Yes">Yes</option>
												<option ajio_val=0 ajio_max=10 <?php echo $ajio_email_v2['appropriate_acknowledgements'] == "No"?"selected":"";?> value="No">No</option>
											</select>
										</td>
										<td>10</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason1]"><?php //echo $ajio_email_v2['l1_reason1'] ?></textarea> -->
											<select class="form-control" id="appropriate" name="data[l1_reason1]" required>
												<?php 
												if($ajio_email_v2['l1_reason1']!=''){
													?>
													<option value="<?php echo $ajio_email_v2['l1_reason1'] ?>"><?php echo $ajio_email_v2['l1_reason1'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason1'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="font_size_formatting" name="data[font_size_formatting]" required>
												<option ajio_val=5 ajio_max=5 <?php echo $ajio_email_v2['font_size_formatting'] == "Yes"?"selected":"";?> value="Yes">Yes</option>
												<option ajio_val=0 ajio_max=5 <?php echo $ajio_email_v2['font_size_formatting'] == "No"?"selected":"";?> value="No">No</option>
											</select>
										</td>
										<td>5</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason2]"><?php echo $ajio_email_v2['l1_reason2'] ?></textarea> -->
											<select class="form-control" id="font_size" name="data[l1_reason2]" required>
												<?php 
												if($ajio_email_v2['l1_reason2']!=''){
													?>
													<option value="<?php echo $ajio_email_v2['l1_reason2'] ?>"><?php echo $ajio_email_v2['l1_reason2'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason2'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="email_response" name="data[email_response]" required>
										...
										<td>5</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason3]"><?php //echo $ajio_email_v2['l1_reason3'] ?></textarea> -->
											<select class="form-control" id="email_res" name="data[l1_reason3]" required>
												<?php 
												if($ajio_email_v2['l1_reason3']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason3'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason3'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>	
										</td>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason4]"><?php //echo $ajio_email_v2['l1_reason4'] ?></textarea> -->
											<select class="form-control" id="ajioAFone" name="data[l1_reason4]" required>
												<?php 
												if($ajio_email_v2['l1_reason4']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason4'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason4'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>	
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="written_communication" name="data[written_communication]" required>
												<option ajio_val=10 ajio_max=10 <?php echo $ajio_email_v2['written_communication'] == "Yes"?"selected":"";?> value="Yes">Yes</option>
												<option ajio_val=0 ajio_max=10 <?php echo $ajio_email_v2['written_communication'] == "No"?"selected":"";?> value="No">No</option>
											</select>
										</td>
										<td>10</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason5]"><?php //echo $ajio_email_v2['l1_reason5'] ?></textarea> -->
											<select class="form-control" id="written_comm" name="data[l1_reason5]" required>
												<?php 
												if($ajio_email_v2['l1_reason5']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason5'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason5'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>	
									...
									<tr>
										...
										<td>10</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason6]"><?php //echo $ajio_email_v2['l1_reason6'] ?></textarea> -->
											<select class="form-control" id="relevant_previous" name="data[l1_reason6]" required>
												<?php 
												if($ajio_email_v2['l1_reason6']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason6'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason6'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>	
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="handle_objections" name="data[handle_objections]" required>
												...
												<option ajio_val=0 ajio_max=10 <?php echo $ajio_email_v2['handle_objections'] == "No"?"selected":"";?> value="No">No</option>
											</select>
										</td>
										<td>10</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason7]"><?php //echo $ajio_email_v2['l1_reason7'] ?></textarea> -->
											<select class="form-control" id="handle_obj" name="data[l1_reason7]" required>
												<?php 
												if($ajio_email_v2['l1_reason7']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason7'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason7'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="all_relevant_articles" name="data[all_relevant_articles]" required>
										...
										<td>5</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason8]"><?php //echo $ajio_email_v2['l1_reason8'] ?></textarea> -->
											<select class="form-control" id="all_relevant" name="data[l1_reason8]" required>
												<?php 
												if($ajio_email_v2['l1_reason8']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason8'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason8'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="applications_portals" name="data[applications_portals]" required>
												<option ajio_val=5 ajio_max=5 <?php echo $ajio_email_v2['applications_portals'] == "Yes"?"selected":"";?> value="Yes">Yes</option>
												<option ajio_val=0 ajio_max=5 <?php echo $ajio_email_v2['applications_portals'] == "No"?"selected":"";?> value="No">No</option>
											</select>
										</td>
										<td>5</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason9]"><?php //echo $ajio_email_v2['l1_reason9'] ?></textarea> -->
											<select class="form-control" id="applications_por" name="data[l1_reason9]" required>
												<?php 
												if($ajio_email_v2['l1_reason9']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason9'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason9'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											...
											<select class="form-control" id="email_interact" name="data[l1_reason10]" required>
												<?php 
												if($ajio_email_v2['l1_reason10']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason10'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason10'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control ajio" id="outcall_call_back" name="data[outcall_call_back]" required>
										...
										<td>5</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason11]"><?php //echo $ajio_email_v2['l1_reason11'] ?></textarea> -->
											<select class="form-control" id="outcall_call" name="data[l1_reason11]" required>
												<?php 
												if($ajio_email_v2['l1_reason11']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason11'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason11'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason10]"><?php //echo $ajio_email_v2['l1_reason10'] ?></textarea> -->
											<select class="form-control" id="ensure_issue_resol" name="data[l1_reason12]" required>
												<?php 
												if($ajio_email_v2['l1_reason12']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason12'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason12'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											...
											<select class="form-control" id="avoid_repeat" name="data[l1_reason13]" required>
												<?php 
												if($ajio_email_v2['l1_reason13']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason13'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason13'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason14]"><?php //echo $ajio_email_v2['l1_reason14'] ?></textarea> -->
										<select class="form-control" id="tagging_guide" name="data[l1_reason14]" required>
											<?php 
												if($ajio_email_v2['l1_reason14']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['l1_reason14'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason14'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>0</td>
										<td>
											<select class="form-control" id="ztp_guide" name="data[l1_reason15]" required>
												<?php 
												if($ajio_email_v2['l1_reason15']!=''){
													?>
													<option value="<?php echo $ajio_email_v2['l1_reason15'] ?>"><?php echo $ajio_email_v2['l1_reason15'] ?></option>
													<?php
												}
												?>
												<option  <?php echo $ajio_email_v2['l1_reason15'] == "N/A"?"selected":"";?> value="N/A">N/A</option>
											</select>	
										</td>
									...
									<?php if($ajio_id!=0){ ?>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Feedback Acceptance:</td><td colspan=5><?php echo $ajio_email_v2['agnt_fd_acpt'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td><td colspan=5><?php echo $ajio_email_v2['agent_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td><td colspan=5><?php echo $ajio_email_v2['mgnt_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td><td colspan=5><?php echo $ajio_email_v2['client_rvw_note'] ?></td></tr>
