									...
									<tr>
										...
										<td>
											<select class="form-control ajio fatal" id="ajioAF6" name="data[tagging_guidelines]" required>
												...
												<option ajio_val=0 ajio_max=5 <?php echo $ajio_email_v2['tagging_guidelines'] == "Documented on incorrect account"?"selected":"";?> value="Documented on incorrect account">Documented on incorrect account</option>
