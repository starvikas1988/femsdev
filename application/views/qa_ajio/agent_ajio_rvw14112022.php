					...
					<div class="widget-body">
						<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF"><td colspan="6" id="theader" style="font-size:30px">AJIO <?php
								if($campaign == 'email_v2'){
								  ...
								  ?></td></tr>
									...
									<tr><td style="font-size:16px">Manager Review:</td> <td colspan="5" style="text-align:left"><?php echo $ajio['mgnt_rvw_note'] ?></td></tr>
									<tr><td style="font-size:16px">Client Review:</td> <td colspan="5" style="text-align:left"><?php echo $ajio['client_rvw_note'] ?></td></tr>
									...
									<form id="form_agent_user" method="POST" action="">
									 <input type="hidden" name="pnid" class="form-control" value="<?php echo $pnid; ?>">
										...
										<tr>
											...
											<td colspan=4><textarea class="form-control" name="note" required><?php echo $ajio['agent_rvw_note'] ?></textarea></td>
										</tr>
