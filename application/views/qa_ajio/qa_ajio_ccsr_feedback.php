			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('qa_ajio/ajio_ccsr'); ?>">
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success blains-effect" a href="<?php echo base_url()?>qa_ajio/ajio_ccsr" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">AJIO [CCSR Voice]</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client"){ 
									$ajio_id=0; ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_ajio/add_edit_ajio_ccsr_voice/<?php echo $ajio_id ?>">Add Audit</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1; 
										foreach($ajio_ccsr_voice as $row):
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php 
										...
										<td>
											<?php $mpid=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_ajio/add_edit_ajio_ccsr_voice/<?php echo $mpid ?>" style="margin-left:5px; font-size:10px;">Edit/Review Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
				...
				<div class="widget">
					<div class="row">
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">AJIO [CCSR Non-Voice]</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client"){ 
									$ajio_id=0; ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>qa_ajio/add_edit_ajio_ccsr_nonvoice/<?php echo $ajio_id ?>">Add Audit</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1; 
										foreach($ajio_ccsr_nonvoice as $row):
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php 
										...
										<td>
											<?php $mpid=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_ajio/add_edit_ajio_ccsr_nonvoice/<?php echo $mpid ?>" style="margin-left:5px; font-size:10px;">Edit/Review Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
