							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control" onkeydown="return false;" id="call_date_time" name="call_date" value="<?php echo $clDate_val; ?>" required></td>
									</tr>
									<tr>
										...
										<td colspan="6">
											<select class="form-control" id="tagging_evaluator" name="data[tagging_evaluator]" required>
												...
												if($ajio_email_v2['tagging_evaluator']!=''){
													?>
													<option value="<?php //echo $ajio_email_v2['audit_type'] ?>"><?php echo $ajio_email_v2['tagging_evaluator'] ?></option>
													<?php
												}
												?>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>0</td>
										<td>
											<!-- <textarea class="form-control" name="data[l1_reason15]"><?php //echo $ajio_email_v2['l1_reason15'] ?></textarea> -->
