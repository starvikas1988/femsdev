							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label>From Date (MM/DD/YYYY)</label><span style="font-size:24px;color:red"></span>
										<input type="text" id="from_date_agent"  name="from_date" onchange="agent_date_validation(this.value,'S')" onkeydown="return false;" value="<?php $date= mysql2mmddyy($from_date); echo str_replace('-', '/', $date); ?>" class="form-control">
										<span class="start_date_error" style="color:red"></span>
									</div>
								</div>  
								<div class="col-md-3"> 
									<div class="form-group">
										<label>To Date (MM/DD/YYYY)</label><span style="font-size:24px;color:red"></span>
										<input type="text" id="to_date_agent" name="to_date" onchange="agent_date_validation(this.value,'E')"  onkeydown="return false;" value="<?php $date= mysql2mmddyy($to_date); echo str_replace('-', '/', $date); ?>" class="form-control">
										<span class="end_date_error" style="color:red"></span>
									</div> 
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Select Campaign</label><span style="font-size:24px;color:red">*</span>
