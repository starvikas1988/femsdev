			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_ajio/ajio_social_media'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success blains-effect" href="<?php echo base_url()?>Qa_ajio/ajio_social_media" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">Social Media-Quality Form</div>
									<?php if(is_access_qa_module()==true){ ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_ajio/add_edit_ajio_social_media/0">Add Feedback</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									foreach($ajio_social_media_data as $row): ?>
									<tr>
										<td><?php echo $i++; ?></td>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_ajio/add_edit_ajio_social_media/<?php echo $cjid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit/Review</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
