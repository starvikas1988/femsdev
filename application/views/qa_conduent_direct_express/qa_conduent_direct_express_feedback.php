			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_conduent_direct_express'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success blains-effect" href="<?php echo base_url()?>Qa_conduent_direct_express" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
							...
							<header class="widget-header">
								<h4 class="widget-title">
									...
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_conduent_direct_express/add_edit_conduent_direct_express/0">Add Feedback</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_conduent_direct_express/add_edit_conduent_direct_express/<?php echo $cjid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit/Review</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
