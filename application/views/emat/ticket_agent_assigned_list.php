					...
					<div class="email-white">
						...
						<div class="accordian-widget ticketListWidget">
							...
							foreach($messageList as $token){ 
									...
									$ageing_ticket = (e_aging_ticket($token['date_added'])>86400)?$token['date_added']:e_display_aging_time(e_aging_ticket($token['date_added']));
									...
									<table class="table table-bordered table-striped">
										<tbody>
										  <tr>
											...
											<td  style="width:<?php echo $_t4; ?>%;font-size:12px"><span class="red"><?php echo $ageing_ticket; ?></span></td>
