...
<section class="app-content">
	...
	<div class="widget headBar">
		<header class="widget-header">
		<h4 class="widget-title"><i class="fa fa-bar-chart"></i> Agent Overview</h4>
		</header>
	</div>
	</div>
	...
	<div class="widget headBar">
		<header class="widget-header">
		<h4 class="widget-title"><i class="fa fa-bar-chart"></i> Agent AHT</h4>
		</header>
	</div>
	</div>
					...
					<div class="row">
						<div class="col-md-12">
							<div style="width:100%;padding:20px 40px;height:250px">
								<canvas id="o_ticket_daily_all"></canvas>
							</div>
						</div>
					</div>
				</div>
