...
<div class="wrap">
	<section class="app-content">
		...
		<div class="widget">
			...
			<h4 class="widget-title">EMAT Agent Hourly Report <span class="pull-right"><?php echo CurrMySqlDate(); ?></span></h4>
			</header>
		</div>
		</div>
				...
				<div class="widget">
					...
					<form id="form_new_user" method="GET" action="">
							...
							<div class="row">
								...
								<div class="col-md-4">
								<div class="form-group">
								<label for="start_date">Mail Box</label>
								<select class="form-control" name="ticket_email" required>
										<option value="">-- Select --</option>
									<?php foreach($category_list as $token){ ?>
										<option value="<?php echo $token['email_id']; ?>"><?php echo $token['email_name']; ?></option>
									<?php } ?>
								</select>
								</div>
								</div>
