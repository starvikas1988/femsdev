				...
				<div class="col-sm-9">
					<div class="all-bg">
							<div class="body-widget">
								<div class="row">
									<div class="col-md-4">
										<h2 class="small-white-title"><i class="fa fa-user"></i> <?php echo !empty($agentListData[$currentAgent]) ? $agentListData[$currentAgent]['fname'] ." " .$agentListData[$currentAgent]['lname'] : " Completed List"; ?></h2>
									</div>
									
									<div class="col-md-8">								
									<a class="btn btn-danger btn-sm btn-mini pull-right" href="<?php echo base_url()?>emat/ticket_completed/<?php echo bin2hex($email_id); ?>/all">
									...
									<table class="table table-bordered table-striped">
										<tbody>
										  <tr>
											...
											<td  style="width:<?php echo $_t4; ?>%;font-size:12px"><span class="green"><?php echo $agingTime; ?></span></td>
