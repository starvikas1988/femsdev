		...
		<div class="row">
			...
			<div class="col-sm-2">							
				<div class="left-side2">
					...
					?>
						...
						<a class="nav-link nav-link-ticket <?php echo $selected; ?>" href="<?php echo base_url() .'emat/ticket_assigned_completed/' .bin2hex($email_id)."/".$foundCat ."/" .$token['ticket_no'] .$extraAddUrlParamFound; ?>">
							<div class="all-main">									
			...
			<div class="col-sm-7">
				<div class="all-bg">
					...
					<div class="col-md-4">
					<div class="pull-right text-white" style="display:none">
					...
					<div class="tab-content">
						...
						<div id="job1" class="tab-pane active">
							...
							<div class="row">							  
							  ...
							  -->
							  <a style="display:none" href="<?php echo base_url('emat/ticket_pass_manual/'.$ticket_no); ?>" onclick="return confirm('Are you sure you want to pass this ticket to queue ?');" class="btn btn-danger pull-right"><i class="fa fa-repeat"></i> Pass</a>
							  </div>
							</div>
							  ...
							  <div class="col-md-6">
								 <label>To</label>
								  <input class="form-control" id="mailing_to" name="mailing_to" value="<?php echo $messageList[0]['ticket_email_from']; ?>" readonly>
							  </div>
							  ...
							  <div class="col-md-12"  style="display:none">
								  ...
								  <div class="row align-items-center">
									<div class="col-sm-2">
										<div class="body-widget">											
											<button type="submit" style="border-radius: 2px;" class="bg-green update-btn">
			...
			<div class="col-sm-3">
						...
						<div class="select-widget">
							<div class="form-group">
							  <label>Mail Box</label>
							   ...
							   <select class="form-control" name="ticket_email" disabled required>
									<option value="">-- Select --</option>
									<?php foreach($ticketMails as $token){ ?>
										<option value="<?php echo $token['id']; ?>" <?php echo $messageList[0]['ticket_email'] == $token['email_id'] ? "selected" : ""; ?>><?php echo $token['email_name']; ?></option>
									<?php } ?>
								</select>
							</div>
							<div class="form-group">
							  <label>Category</label>
							   ...
							   <select class="form-control" name="ticket_category" disabled required>
									<option value="">-- Select --</option>
								<?php foreach($catListTicket as $token){ ?>
							...
							<div class="form-group">
							  <label>Assigned User</label>
							   ...
							   <select class="form-control" name="ticket_user" disabled required>
									<option value="">-- Select --</option>
								<?php foreach($agentListTicket as $token){ ?>
				...
				<div class="right-side1 notesBlock">
					...
					<hr style="margin-top:15px;margin-bottom:5px" class="notesSectionShow" />
										...
										<div class="common-top">
											...
											<div class="col-md-3">
													<div class="form-group">
														...
														<input type="text" placeholder="Search reference no/Ticket ID" id="reference_no" name="reference_no" value="<?php  echo !empty($reference_no) ? $reference_no : ''; ?>" class="form-control">
													</div>
												</div>
												<div class="col-md-3">
													<div class="form-group">
...
<div class="modal fade" id="unholdCallModal" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="unholdCallModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<p class="text-danger"><b>Your Call is Put on HOLD <input type="hidden" name="timer_hold" id="timer_hold" value=""> <input type="hidden" name="timer_hold_status" id="timer_hold_status" value="H"></b></p>
