									...
									<table class="table table-bordered table-striped">
										<tbody>
										  <tr>
											...
											<td  style="width:<?php echo $_t4; ?>%;font-size:11px;padding-left:10px;"><span class="<?php echo $sla_class; ?> ticketInfoDiv" ticket="<?php echo $token['ticket_no']; ?>"><b><?php echo e_display_aging_time(e_aging_ticket($token['date_added'])); ?></b></span></td>
