...
<a class="btn btn-primary btn-sm" href="<?php echo base_url('activities/myteam2'); ?>"><i class="fa fa-arrow-left"></i> Go Back</a>
<?php } ?>
</h4>
</header>
...
<div class="widget">
<header class="widget-header">
<h4 class="widget-title">24-Hour Timeline Acivities</h4>
</header>
<div class="widget-body clearfix">
<div id="checkactivities"></div>
</div>
</div>
</div>
