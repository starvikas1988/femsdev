...
<hr class="widget-separator"/>
	...
	<form method="GET">
		...
		<?php if($searchingq != ""){ ?>
			<a href="<?php echo base_url('activities/myteam2'); ?>" class="btn btn-success">View All</a>
		<?php } ?>
		</div>
		</div>
  ...
  <table class="table table-bordered mb-0">
    ...
    <thead>
      <tr class="bg-primary text-white">
		...
		<th scope="col">Real Time Activities</th>
      </tr>
    </thead>
	...
	?>
      ...
      <tr>
        ...
        <a href="<?php echo base_url() ."activities/monitor2?uid=". $uidteam; ?>"><?php echo $token['fullname']; ?> <i class="fa fa-eye"></i></a><br/>
		...
		<div id="team<?php echo $uidteam; ?>" style="height: 100px;"></div>
