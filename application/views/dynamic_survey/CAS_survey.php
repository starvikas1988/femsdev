...
<form method="post" action="<?=base_url()?>dynamic_survey/jam_survey">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="white-box">
        <div class="title">
          <h5>Afin de répondre efficacement à vos besoins et mesurer votre satisfaction par rapport à l’animation estivale, nous avons mis en place cette enquête. Toutes les données recueillies restent confidentielles et seront traitées de manière anonyme. Nous vous serions reconnaissants de participer à cette enquête en remplissant ce questionnaire.</h5></div>
              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td >1.Le contenu de l’animation était-il à la hauteur de vos attentes ?</td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="1" name="54" id="48_flexRadioDefault_6" required> 
                        <label class="form-check-label" for="48_flexRadioDefault_6"> &nbsp; 1 </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="2" name="54" id="48_flexRadioDefault_5">
                        <label class="form-check-label" for="48_flexRadioDefault_5"> &nbsp; 2  </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="3" name="54" id="48_flexRadioDefault_4">
                        <label class="form-check-label" for="48_flexRadioDefault_4"> &nbsp; 3  </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="4" name="54" id="48_flexRadioDefault_3">
                        <label class="form-check-label" for="48_flexRadioDefault_3"> &nbsp; 4 </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="5" name="54" id="48_flexRadioDefault_2">
                        <label class="form-check-label" for="48_flexRadioDefault_2"> &nbsp; 5  </label>
                      </div>
                    </td>
                  </tr>
                  
                  <tr>
                    <td>2. L'animation vous a-t-elle procuré un moment de détente ?</td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="1" name="55" id="49_flexRadioDefault_6" required>
                        <label class="form-check-label" for="49_flexRadioDefault_6"> &nbsp; 1 </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="2" name="55" id="49_flexRadioDefault_5">
                        <label class="form-check-label" for="49_flexRadioDefault_5"> &nbsp; 2  </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="3" name="55" id="49_flexRadioDefault_4">
                        <label class="form-check-label" for="49_flexRadioDefault_4"> &nbsp; 3  </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="4" name="55" id="49_flexRadioDefault_3">
                        <label class="form-check-label" for="49_flexRadioDefault_3"> &nbsp; 4  </label>
                      </div>
                    </td>
                    <td>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" value="5" name="55" id="49_flexRadioDefault_2">
                        <label class="form-check-label" for="49_flexRadioDefault_2"> &nbsp; 5  </label>
                      </div>
                    </td>
                  </tr>
...
<div class="row">
    <div class="col-md-12">
      <div class="white-box">
        ...
        <div class="title">
          <h5>3. Sur une échelle de 1 à 10, quel était votre degré de satisfaction ? </h5></div>
        <table class="table table-striped table-bordered">
          <tbody>
            <tr>
  ...
  <div class="row">
    ...
    <div class="white-box">
        ...
        <div class="form-check term-end">
          <textarea name="57" required placeholder="Write here....."></textarea>
  ...
  <div class="row">
    <div class="col-md-12">
    <div class="white-box">
        <div class="title"><h4>5. Avez-vous des suggestions à déployer lors des animations futures ?</h4></div>
        <div class="form-check term-end">
          <textarea name="58" required placeholder="Write here....."></textarea>
