...
<form method="post" action="<?=base_url()?>dynamic_survey/jam_survey">
          ...
          <h5>Please complete this short survey to let us know how satisfied you are with your overall experience at our Company. All responses are recorded anonymously so feel free to provide honest feedback. Your responses will help us improve our services. </h5></div>
              ...
              <table class="table table-striped table-bordered new-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td >9. Do you feel as though your job responsibilities are clearly defined?</td>
                    <td>
                      <div class="form-check">
                  ...
                  <tr>
                    <td >10. Do you feel you are rewarded for your dedication and commitment towards the work?</td>
                    <td>
                      <div class="form-check">
                  ...
                  <tr>
                    <td >11. Does your manager praise you when you have done a good job?</td>
                    <td>
                      <div class="form-check">
                  ...
                  <tr>
                    <td >12. How happy are you at work?</td>
                    <td>
                      <div class="form-check">
  ...
  <div class="row">
    ...
    <div class="white-box">
        ...
        <div class="title"><h4>13. How happy are you at work? (Comments)</h4></div>
        <div class="form-check term-end">
          <textarea name="75" placeholder="Write here....." required></textarea>
        </div>

        <div class="title"><h4>14. If you resigned tomorrow, why would that be?</h4></div>
        <div class="form-check term-end">
          <!-- <input class="form-check-input" type="radio" value="1" name="67" required> -->
          <textarea name="67" placeholder="Write here....." required></textarea>
        </div>

        <div class="title"><h4>15. If something unusual comes up, do you know who to go for a solution?</h4></div>
        <div class="form-check term-end">
          <!-- <input class="form-check-input" type="radio" value="1" name="68" required> -->
          <textarea name="68" placeholder="Write here....." required></textarea>
        </div>

        <div class="title"><h4>16. Do you have any suggestions to improve company/employee relations?</h4></div>
        <div class="form-check term-end">
          <textarea name="76" placeholder="Write here....." required></textarea>
        </div>

        <div class="title"><h4>17. Do you have any comments, concerns or suggestions for your supervisor?</h4></div>
        <div class="form-check term-end">
          <textarea name="77" placeholder="Write here....." required></textarea>
        </div>
      </div>
    </div>
  </div>  
