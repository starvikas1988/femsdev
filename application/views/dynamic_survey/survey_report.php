	...
	<div class="widget">
		...
		<hr class="widget-separator">
		 <div class="widget-body">
			...
			<form class="" method='POST' action="<?php echo base_url(); ?>dynamic_survey/survey_report" style="margin:10px;">
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group" id="client_div">
							<label for="Client">Client</label><br/>
								<select class="form-control" style="width:100%; height:100px" id="client" name="client[]" multiple>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="form-group">
							...
							<select class="form-control" style="width:100%; height:100px" multiple id="process" name="process[]" >
								<option value="">Select</option>
								<option value="0">All</option>
								<?php 
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select class="form-control" style="width:100%; height:100px" multiple id="department" name="department[]">
								<option value="">Select</option>
								<?php 
					...
					<div class="col-md-4">
						<div class="form-group">
							<label for="Location">Location</label><sup style="color:red">*</sup><br>
						...
						<tbody>
							...
							foreach ($survey_list as $key => $value) { ?>
								<tr>
									...
									<td> <?php 
									if(get_user_office_id() == "CAS" || get_global_access() == '1') echo "--";
									else echo $value['fusion_id']; 
									?> </td>
									<td> <?php
										if(get_user_office_id() == "CAS" || get_global_access() == '1') echo "--";
										else echo $value['uname']; 									
									?></td>
