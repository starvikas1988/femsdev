								...
								<div class="row">
									...
									<div class="col-md-9">
										<div class="body-widget">
											<textarea type="text" class="form-control" id="" name="feedback<?php echo $i; ?>" placeholder="Feedback.." <?php echo $required; ?>></textarea>
										</div>
									</div>
									<?php }else{ ?>
									<div class="col-md-12">
										<div class="btn-widget">
											<div>
												...
												<label for="radio1<?php echo $i; ?>"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Strongly disagree</label>
											</div>
		
											<div>
												<input type="radio" <?php echo $name; ?> id="radio2<?php echo $i; ?>" class="radio" value="2"/>
												<label for="radio2<?php echo $i; ?>"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Disagree</label>
											</div>

											<div>	
												<input type="radio" <?php echo $name; ?> id="radio3<?php echo $i; ?>" class="radio" value="3"/>
												<label for="radio3<?php echo $i; ?>"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Neither agree nor disagree</label>
											</div>

											<div>	
												<input type="radio" <?php echo $name; ?> id="radio4<?php echo $i; ?>" class="radio" value="4"/>
												<label for="radio4<?php echo $i; ?>"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Agree</label>
											</div>

											<div>	
												<input type="radio" <?php echo $name; ?> id="radio5<?php echo $i; ?>" class="radio" value="5"/>
												<label for="radio5<?php echo $i; ?>"><i class="fa fa-dot-circle-o" aria-hidden="true"></i> Strongly agree</label>
											</div>
										</div>
									</div>
									<div class="col-md-12">
