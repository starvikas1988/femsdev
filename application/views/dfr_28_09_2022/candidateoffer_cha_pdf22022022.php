...
<div style="margin:5px;">	
	...
	<div id="body1" style='width:100%;'>
		...
		<span>2. Your monthly Gross salary will be <strong>Rs. <?php echo $can_dtl_row['gross_pay'];?>/- (Rupees  <?php echo getIndianCurrency($can_dtl_row['gross_pay']); ?></strong> <strong>Only)</strong>.</span><br>
