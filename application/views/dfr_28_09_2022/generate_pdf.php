	...
	<div>
		<table cellspacing="0" style="width:100%">
			<tr>
				...
				<td style="border: 1px solid #000; text-align: left; padding:5px 2px;  "><h6><?php echo strtoupper($candidate_details[0]['can_name']) ; ?></h6></td>
			...
			<tr>
				...
				<td style="border: 1px solid #000; text-align: left; padding:5px 2px;  "><h6><?php echo $candidate_details[0]['interviewer_name']; ?></h6></td>
				<td style="border: 1px solid #000; text-align: left; padding:5px 2px;  width:155px; "><h6><b>DATE & VENUE :</b></h6></td>
				<td style="border: 1px solid #000; text-align: left;"><h6><?php echo $candidate_details[0]['interview_date'].' '.$candidate_details[0]['pool_location']; ?></h6></td>
			</tr>
		</table>	
	</div>
