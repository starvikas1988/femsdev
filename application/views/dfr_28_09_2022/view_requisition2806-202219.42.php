...
<style>
    ...
    .filter-widget .btn-group, .btn-group-vertical {
        width:100%;
    }
        ...
        <div class="modal-content">
            ...
            <form class="frmAddCandidate" action="<?php echo base_url(); ?>dfr/add_candidate" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <!-- goutam added for new requirement by Sankha da -->
                    <?php if ($dfr_location == 'KOL') { ?>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Mother name: <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <input type="text" id="mother_name" name="mother_name" class="form-control" value="" placeholder="Enter your mother name" required>
                            </div>
                        </div>
                    </div>
                    <?php  } ?>
                    ...
                    <div class="row" >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                ?>
                                <input type="text" class="form-control" id="social_security_no" name="social_security_no" <?php echo $required.' '.$length; ?> onkeyup="checkDec(this);" onfocusout="checksecurity();">
    ...
    $(function () {
      $('#mother_name').keydown(function (e) {
          if (e.shiftKey || e.ctrlKey || e.altKey) {
              ...
              alert('only Alphabate and space allowed');
                  e.preventDefault();
              }
          }
      });
...
<script>
    $("#asset_requisition").change(function () {
        ...
        var r_id = $("#r_id").val();         
        $.post("<?php echo base_url(); ?>" + "dfr/getRequisitionAssetsData", {sel: assets, r_id: r_id}).done(function (response) {
            if (response != '') {
