	...
	<div id="body1" style='width:100%;'>
		...
		<?php } ?>
			...
			<span>Variable Pay:</span>
                        <span> &nbsp;Rs.<?php echo $variable_pay; ?></span><br>
		<?php } ?>
		<br><br>
		...
		<tr >
			...
			<?php if ($rank <= '3') { ?>
						<img height='80px' src="<?php APPPATH ?>main_img/fusion_stamp.png" alt="signature" />
					<?php } else if ($rank <= '6' && $rank >= '4') { ?>
						<img height='80px' src="<?php APPPATH ?>main_img/shivika_signature.png" alt="signature" />
					<?php } else { ?>
						<img height='80px' src="<?php APPPATH ?>main_img/sreejita_signature.png" alt="signature" />
					<?php } ?>
			<br/></td>
		...
		<tr>
			...
			<?php if ($rank <= '3') { ?>
						Oindrila Banerjee<br> General Manager
					<?php } else if ($rank <= '6' && $rank >= '4') { ?>
						Shivika<br> Manager
					<?php } else { ?>
						Sreejita Mitra<br>Team Leader
					<?php } ?>
			</td>
