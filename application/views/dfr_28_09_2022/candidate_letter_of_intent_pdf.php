				...
				<div style="width: 100%;overflow-x: hidden;padding: 0 10px 0 0;">
					<div style="width:100%;padding-left: 20px;text-align: justify;">
						...
						<div style="margin: 40px 0 10px 20px;">
							<p style="margin-bottom: 20px;"> This has reference to your application and interview with us; we are pleased to offer you an opportunity to attend our <strong style="font-weight: bold;">Specialized Training Program </strong>as per Company Scheme which is mandatory for the position of <strong style="font-weight: bold;">Customer Care Executive</strong>. The Training Start Date is <?php echo $training_start_date; ?>.</p>
							<p style="margin-bottom: 20px;">On successful completion and certification of Training for which the management is the sole judge, you will be absorbed as a<strong style="font-weight: bold;"> Customer Care Executive</strong> at <?php echo $brand_name; ?>, <span style="width: 80px;height: 1px;display: inline-block;"><?php echo get_location_by_abbr($location); ?></span>  (Location) and your monthly <?php echo $ctc_type; ?> will be Rs.<span style="width: 100px;height: 1px;display: inline-block;"><?php echo number_format($ctc_amount,2) ; ?></span> /- (Rupees <span style="width: 200px;height: 1px;display: inline-block;"><?php echo ucwords(convertNumberToWord($ctc_amount));?></span> Only) with effect from the date of your completion and certification of training </p>
