							...
							<!--<div class="col-sm-3">
								<div class="form-group">
									...
									<select id="multiselectwithsearch" name="Requisition" class="select-box" placeholder="Select Requisition" multiple>
										<?php foreach ($getrequisition as  $value) {
						...
						<!-- <div class="col-md-1">
							<div class="form-group">
								...
								<select class="form-control" name="date_select" id="date_select" >
									<option value="ALL" <?php if(isset($a)){echo $a;}?> >All</option>
									<option value="DATE" <?php if(isset($b)){echo $b;}?> >Date</option>
								</select>
							</div>
						</div> -->
						...
						<table id="default-datatable" data-plugin="DataTable" class="table skt-table" cellspacing="0" width="100%">
							<thead>
								<tr class='bg-info'>
									...
									if (!empty($get_candidate_details)) {
										if (array_search("CHA", $get_candidate_details[0])) {echo "<th>Site</th>"; $site_open = true;} 
									}
									?>
							...
							<tbody>
								...
								<tr>
									...
									<?php
									if ($site_open===true) {
										if ($cd['site_name'] != '') echo "<td>".$cd['site_name']."</td>";
										else echo "<td>NA</td>";
									}
									?>
									...
									<td><?php if(!file_exists(FCPATH."uploads/candidate_resume".$cd['attachment'])) {
											...
											<tbody>
												<?php 
													...
													if(array_key_exists($c_id, $dfr_interview_schedules)):
														//print_r($dfr_interview_schedules[$c_id]);
												...
												<tr>
													...
													<td><?php echo $row1->interview_type; ?></td>
													<td><?php echo $row1->assign_interviewer; ?></td>
													...
													<td class="text-center" width="100px">
														...
														//if(get_dept_folder()=="hr" || get_role_dir()=="admin" || get_role_dir()=="super" || get_global_access()==1){
																...
																if($sh_status=="P"){
																	...
																	echo '<a class="btn btn-primary btn-xs editInterview" r_id="'.$r_id.'" c_id="'.$c_id.'" sch_id="'.$sch_id.'" schType="'.$interview_type.'" schSite="'.$interview_site.'" schAssin="'.$assign_interviewer.'"    title="Edit Interview" style="font-size:12px"><i class="fa fa-pencil-square-o"></i></a>';
					...
					<div class="form-group">
						...
						<select class="form-control" id="pool_location" name="pool_location" required>
							...
							<?php foreach($location_data as $row): 
								...
								$sCss="";
										if($row['abbr']==$oValue) $sCss="selected";
