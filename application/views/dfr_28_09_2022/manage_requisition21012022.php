					...
					<div class="row">
						...
						<div class="col-md-8" style='float:right; padding-right:10px; margin-top:14px'>
							<div class="form-group" style='padding-right:10px; float:right'>
								<a href='?req_status=2' <span style="padding:8px 12px;" class="label label-warning">Cancel/Decline</span></a>	
							</div>
							<div class="form-group" style='padding-right:10px; float:right'>
								<a href='?req_status=1' <span style="padding:8px 12px;" class="label label-danger">Closed</span></a>	
							</div>
							<div class="form-group" style='padding-right:10px; float:right'>
								<a href='?req_status=3' <span style="padding:8px 12px;" class="label label-info">Pending</span></a>	
							</div>
							<div class="form-group" style='padding-right:10px; float:right'>
								<a href='?req_status=0' <span style="padding:8px 12px;" class="label label-success">Open</span></a>	
							</div>
						</div>
					</div>
								...
								?>								
									<div class="col-md-12" style="float:right">
										<div class="form-group" style='float:right; padding-right:10px;'>
											<a><span style="padding:8px 12px;" class="label label-primary addRequisition">Add Requisition</span></a>
										</div>
									</div>
