				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="file" name="photo" class="form-control" placeholder="" id="photofile" accept="image/*">
							</td>
					  	</tr>
					  	<tr>
					  		<td>
						  ...
						  <tr>
							...
							<td>
								<input type="file" name="pan" class="form-control" placeholder="" id="panfile" required="" accept="image/*">
