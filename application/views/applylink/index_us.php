									...
									<fieldset>
										<div class="form-repeat">
										  <div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
													 	<strong>Last Four Digits of Social Security No</strong>
													 </label>
													 <input type="text" maxlength="4" class="form-control required" placeholder="Last Four Digits of Social Security No" id="adhar" name="adhar">
												</div>
											</div>
										...
										<div class="row" style="display: none;">
											...
											<div class="form-group">
													  ...
													  <input type="text" name="guardian_name" class="form-control" placeholder="Guardian's Name" value="">
													</div>
												</div>

											<div class="col-sm-6">
												<div class="form-group" style="display: none;" value="">
												<label>
														<strong>Relation With Guardian</strong>
												</label>
												<select name="relation_guardian" class="form-control">
												<option value="">--Select--</option>
								...
								<option></option>
									...
									?>
									  ...
									  <div class="form-repeat">
										<div class="row">
											...
											<div class="col-sm-4" style="display: none;">
												<div class="form-group">
													 <label>
														<strong>TRN ID</strong>
													 </label>
													 <input type="text" class="form-control" placeholder="TRN ID" id="pan" name="pan" value="">
												</div>
											</div>
									  ...
									  <div class="form-repeat">
											...
											<div class="radio">
											  <label class="radio-inline">
												<input class="" type="radio" name="married" id="inlineRadio1" value=""> 
												Yes
											  </label>
											  <label class="radio-inline">
												<input class="" type="radio" name="married" id="inlineRadio2" value="">
												No
											  </label>
											</div>
										</div>
										...
										<div class="col-sm-4" style="display: none;">
											...
											<div class="form-repeat">
											<input type="text" class="form-control" name="home_town" id="home_town" placeholder="Home Town" value="">
										</div>
									</div>
										</div>
									...
									<fieldset>
									  <div class="form-repeat" style="display: none;">
										<div class="row" style="display: none;">
											<div class="col-sm-6" style="display: none;">
												<p>
													<strong>
												...
												<div class="radio">
													  <label class="radio-inline">
														<input class="" type="radio" name="conveyance" id="conveyance_yes" value="">
														Yes
													  </label>
													  <label class="radio-inline">
														<input class="" type="radio" name="conveyance" id="conveyance_no" value="">
														No
													  </label>
												</div>
											</div>
											<div class="col-sm-6" style="display: none;">
												<div class="form-group">
													 ...
													 <input type="text" class="form-control" name="d_licence" id="d_licence" placeholder="Driving Licence" value="">
												</div>
											</div>
										</div>
									  </div>
									  ...
									  <div class="form-repeat">
										<div class="row">
											<div class="col-sm-3">
												<p><strong>Own Conveyance</strong></p>
												<div class="radio">
													  <label class="radio-inline">
											...
											<div class="col-sm-5">
												<p><strong>If Other, Please Describe</strong></p>
												<div class="form-group">
									  ...
									  <div class="form-repeat">
										<div class="row">
											...
											<div class="col-sm-6">
												<p>	
													<strong>
														Have you appeared for interview before? If Yes, please specify when?
													</strong>
												</p>
												<div class="form-group">
											...
											<div class="col-sm-12">
												<div class="form-group">
													<div id='divHabilitSelectors' class="input-file-container">
														...
														<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Photocopy of Social Security No</label>
													</div>
...
<script>
	...
	$(".next").click(function(){
		...
		var next_step = true;
		if(document.getElementById('references').className == "active")
		{
		...
		var file2 = $("#adhar_file_upload").val();
			if(file2==""){
					...
					success	:	function(msg)
					{
						...
						if(res.stat == true)
						{
							...
							$.each(res.data,function(index,element)
							{
								...
								{
									list += '<option value="'+element.hr_name+'">'+element.hr_name + "("+element.office_id +")"+'</option>';
								}
								else
								{
