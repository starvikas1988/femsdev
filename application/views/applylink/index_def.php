...
<body>
	...
	<?php $user_office_id = substr($rq_id, 0,3); ?>
            ...
            <div class="card px-0 pb-0">                
                <div class="row">
                    <div class="col-md-12 mx-0">
											...
											<div class="col-sm-4">
												<div class="form-group">
													...
													elseif($user_office_id == "JAM"){ ?>
														<strong>Tax Registration Number ID</strong>
													<?php }
													 else { ?>
						...
						<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Your SSS</label>

						<?php } else { ?>
						<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Your Adhar</label>
						<?php } ?>
