									  ...
									  <div class="form-repeat">
										<div class="row">
											<div class="col-sm-4">
												<div class="form-group">
													<label>
														<strong>Mobile No </strong><span>(aadhar linked mobile number)</span> <span class="require">*</span>
													</label>
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
													 	<strong>Aadhar No <span class="require">*</span></strong>
													 </label>
													 <input type="text" class="form-control checkNumber required" placeholder="Aadhar No" id="adhar" name="adhar" onblur="checkAadhar()">
											...
											<div class="col-sm-12">
												<div class="form-group">
													<div id='divHabilitSelectors' class="input-file-container">
														...
														<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Your Aadhar <span class="require">*</span></label>
													</div>
