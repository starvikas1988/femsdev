                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" enctype="multipart/form-data">
										...
										<div class="row">
											...
											<div class="col-sm-3">
												<div class="form-group">
													 ...
													 <input type="text" class="form-control" placeholder="National ID" id="adhar" name="adhar">
												</div>
											</div>
											...
											<div class="col-sm-3">
												<div class="form-group">
													 <label>
													 	<strong>NIS(National Insurance Scheme ID)</strong>
													 </label>
													 <input type="text" class="form-control" placeholder="National Insurance Scheme ID" id="nis" name="nis">
												</div>
											</div>
											...
											<div class="col-sm-3">
												<div class="form-group">
													 ...
													 <input type="text" class="form-control" placeholder="TRN ID" id="pan" name="pan">
												</div>
											</div>
							...
							<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Photocopy of National ID</label>
								</div>
									  ...
									  <div class="form-repeat">
										...
										<div class="col-sm-4">
											...
											<div class="form-repeat">
											<input type="text" class="form-control" name="home_town" id="home_town" placeholder="Current Address">
										</div>
									</div>
										</div>
						...
						<label for="file_upload" class="input-file-trigger" id='labelFU' tabindex="0">Upload Your Resume</label>
								...
								<fieldset>
									...
									<tr>
										...
										<td>
											<input type="number" name="marks[]" class="form-control required" placeholder="Marks %" value="">
										</td>
										<td>
