...
<div style="margin:10px;">	
	...
	<div>
		<img src="<?php echo APPPATH; ?>/../assets/images/fusion-bpo.png" height="10%">
	</div>
	...
	<div>
			...
			<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
				...
				<?php if(isUSLocation($row['location'])!==true){ ?>
			...
			<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
				<tr>
				<?php if($row['location'] == 'JAM'){ ?>
					<td style="text-align:left;width:100px;"><b>National ID No.:</b></td>
				<?php } elseif (isIndiaLocation($row['location'])==true) {	?>
					<td style="text-align:left;width:100px;"><b>Adhaar No.:</b></td>
				<?php } elseif($row['location'] == 'ELS'){ ?>
						<td style="text-align:left; width:100px ;"><b>AFP No.:</b></td>
					<? } ?>

					<td style="text-align:left;"><?php echo $row['adhar']; ?></td>



				<?php if(isUSLocation($row['location'])!==true){ ?>
					<?php if($row['location'] == 'JAM'){ ?>
					<td style="text-align:left;width:100px;"><b>TRN ID No.:</b></td>
					<?php } elseif (isIndiaLocation($row['location'])==true) {	?>
						<td style="text-align:left; width:100px ;"><b>PAN No.:</b></td>
					<?php } elseif($row['location'] == 'ELS'){ ?>
						<td style="text-align:left; width:100px ;"><b>DUI/Tax No.:</b></td>
					<? } ?>
					<td style="text-align:left;"><?php echo $row['pan']; ?></td>

					<?php if (isIndiaLocation($row['location'])==true) { ?>
					<td style="text-align:left; width:100px ;"><b>Caste:</b></td>
					<td style="text-align:left;width:100px;"><?php echo $row['caste']; ?></td>
					<?php }
				} ?>
				</tr>
			</table>
			...
			<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
				<tr>
					<td style="text-align:left;width:100px;"><b>Guardian's Name:</b></td>
					<td style="text-align:left"><?php echo $row['guardian_name']; ?></td>
					<td style="text-align:left; width:100px ;"><b>Relation With Guardian:</b></td>
					<td style="text-align:left"><?php echo $row['relation_guardian']; ?></td>
				</tr>
			</table>
			<?php } ?>
			...
			<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
				...
				<tr>
					<td style="text-align:left"><b>Last Qualification:</b></td>
					<td style="text-align:left"><?php echo $row['last_qualification']; ?></td>
				</tr>
				<tr>
		...
		<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
			...
			<div style="padding-top:10px"><b>Last 3 Organization:</b></div>
			<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
				<tr style="border:1px solid black; background-color:#D1FAFA">
