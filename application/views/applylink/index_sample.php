                    ...
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" enctype="multipart/form-data">
											...
											<div class="col-sm-3">
												<div class="body-widget">
													<div class="form-group">
													  ...
													  <input type="text" name="first_name" class="form-control required" value='Sample' placeholder="First name" readonly>
													  <input type="hidden" name="rq_id" id="rq_id" class="form-control" value="">
													  <input type="hidden" name="r_id" id="r_id" class="form-control" value="">
													  <input type="hidden" name="cid" id="cid" class="form-control" value="">
													<input type="hidden" name="link_token" id="link_token" class="form-control" value='		' >
											...
											<div class="col-sm-3">
												<div class="body-widget">
													<div class="form-group">
													  ...
													  <input type="text" name="last_name" class="form-control required" value='Applicant' placeholder="Last name" readonly>
													</div>
												</div>
											</div>
											<div class="col-sm-3">
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													 ...
													 <input type="email" id="email" name="email" value='' class="form-control required" placeholder="Email">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
													 	<strong>Social Security No/Adhar No/SSS ID/AFP</strong>
													 </label>
													 <input type="text" class="form-control required" placeholder="SSN/Adhar/SSS/AFP" id="adhar" name="adhar">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
														<strong>Pan No/TIN Number/TRN ID/DUI</strong>
													 </label>
													 <input type="text" class="form-control" placeholder="TIN/TAX/Pan/DUI No" id="pan" name="pan">
												</div>
											</div>
							...
							<div id='divHabilitSelectors' class="input-file-container">
								...
								<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Your Adhar/SSS</label>
...
<script type="text/javascript">
	$('#file_upload').change(function () {
	    ...
	    if (fileExtension == "doc" || fileExtension == "docx" || fileExtension == "pdf") {
	    	...
	    	alert("File type not supported");
	        $('#file_upload').value = "";
	        $('#labelFU').text("Choose a pdf,doc or docx file please");
	        return false;
	    }
});
</script>
