                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" enctype="multipart/form-data">
									  ...
									  <div class="form-repeat">
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
													 	<strong>AFP No</strong>
													 </label>
													 <input type="text" class="form-control required" placeholder="AFP No" id="adhar" name="adhar">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
														<strong>DUI/Tax No</strong>
													 </label>
													 <input type="text" class="form-control" placeholder="DUI/Tax No" id="pan" name="pan">
												</div>
											</div>
							...
							<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload Photocopy of AFP No </label>
								</div>
