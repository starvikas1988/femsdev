                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" method="POST" enctype="multipart/form-data">
								  ...
								  <input type="text" class="form-control" name="comp_employee_dept" placeholder="Employee Dept" value="">
									  ...
									  <div class="form-repeat" id="ref_job_vacancy">
										...
										<div class="radio">
										  ...
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="applicant_ref" value="Applicant Referral Program">
											Applicant Referral Program
										  </label>
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="external_ref" value="External Referrer">
											External Referrer
										  </label>
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="headhunter" value="Headhunter">
											Headhunter
										  </label>
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="wom" value="Word of Mouth">
											Word of Mouth
										  </label>
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="sourcing_colat" value="Sourcing Collateral">
											Sourcing Collateral
										  </label>
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="lgu" value="Local Government Unit">
											Local Government Unit
										  </label>
										  <label class="radio-inline">
											<input class="" type="radio" name="referal" id="academe" value="Academe">
											Academe
										  </label>
										...
										<div class="row">
											...
											<div class="col-sm-4">
												<div class="form-group">
													 ...
													 <input type="text" class="form-control required" placeholder="SSS ID" id="adhar" name="adhar">
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="form-group">
													 <label>
														<strong>TIN /TAX No</strong>
													 </label>
													 <input type="text" class="form-control" placeholder="TIN /TAX No" id="pan" name="pan">
												</div>
											</div>
							...
							<label for="adhar_file_upload" class="input-file-trigger2" id='labelFU2' tabindex="0">Upload SSS Number (Photocopy of E1 or SSS ID)</label>
								</div>
...
<script>
		...
		<script>
			$(document).on('click','#job_source_portal,#job_source_consult,#news_paper,#call_hr,#applicant_ref,#external_ref,#headhunter,#wom,#sourcing_colat,#lgu,#academe',function()
			{
				var val = $(this).val();
					...
					success	:	function(msg)
					{
						...
						if(res.stat == true)
						{
							...
							$.each(res.data,function(index,element)
							{
								...
								{
									list += '<option value="'+element.wom+'">'+element.wom+'</option>';
								}
								else if(element.sourcing_colat)
								{
									list += '<option value="'+element.sourcing_colat+'">'+element.sourcing_colat+'</option>';
								}
