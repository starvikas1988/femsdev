			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_park_west'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success blains-effect" href="<?php echo base_url()?>Qa_park_west" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">Park West</div>
									<?php if(is_access_qa_module()==true){ ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_park_west/add_edit_park_west/0">Add Feedback</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_park_west/add_edit_park_west/<?php echo $cjid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit/Review</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
