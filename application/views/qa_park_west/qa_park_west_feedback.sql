...
-- --------------------------------------------------------
--
-- Table structure for table `qa_park_west_feedback`
--

CREATE TABLE `qa_park_west_feedback` (
  `id` int(11) NOT NULL,
  ...
  `identify_himself` varchar(10) DEFAULT NULL,
  `provide_quality_assurance` varchar(10) DEFAULT NULL,
  `state_my_quick_wallet` varchar(10) DEFAULT NULL,
  `speaking_right_party` varchar(10) DEFAULT NULL,
  `demographics_information` varchar(10) DEFAULT NULL,
  `disclosure_verbatim` varchar(10) DEFAULT NULL,
  `callback_permission` varchar(10) DEFAULT NULL,
  `balance_due` varchar(10) DEFAULT NULL,
  `resolve_account` varchar(10) DEFAULT NULL,
  `payment_account` varchar(10) DEFAULT NULL,
  `follow_up_call` varchar(10) DEFAULT NULL,
  `promise_pay` varchar(10) DEFAULT NULL,
  `elaborate_consiquences` varchar(10) DEFAULT NULL,
  `settelment_options` varchar(10) DEFAULT NULL,
  `urgency_for_payment` varchar(10) DEFAULT NULL,
  `negotiate_effectively` varchar(10) DEFAULT NULL,
  `misrepresent_their_identity` varchar(10) DEFAULT NULL,
  `imply_leagal_actions` varchar(10) DEFAULT NULL,
  `nature_of_communication` varchar(10) DEFAULT NULL,
  `contact_customer` varchar(10) DEFAULT NULL,
  `communicate_customer_work` varchar(10) DEFAULT NULL,
  `communicate_customer_learning` varchar(10) DEFAULT NULL,
  `phone_policy` varchar(10) DEFAULT NULL,
  `adhere_policy` varchar(10) DEFAULT NULL,
  `status_code` varchar(10) DEFAULT NULL,
  `abusive_acts` varchar(10) DEFAULT NULL,
  `false_credit_information` varchar(10) DEFAULT NULL,
  `take_appropriate_action` varchar(10) DEFAULT NULL,
  `pursue_leagal_action` varchar(10) DEFAULT NULL,
  `adhere_FDCPA` varchar(10) DEFAULT NULL,
  `violation_ECOA_policy` varchar(10) DEFAULT NULL,
  `adhere_state_restrictions` varchar(10) DEFAULT NULL,
  `authorized_user` varchar(10) DEFAULT NULL,
  `recap_call` varchar(10) DEFAULT NULL,
  `proper_payment_script` varchar(10) DEFAULT NULL,
  `permission_from_customer` varchar(10) DEFAULT NULL,
  `educate_customer` varchar(10) DEFAULT NULL,
  `consumer_callback` varchar(10) DEFAULT NULL,
  `active_listening` varchar(10) DEFAULT NULL,
  `positive_manner` varchar(10) DEFAULT NULL,
  `overcome_objections` varchar(10) DEFAULT NULL,
  `transfer_call` varchar(10) DEFAULT NULL,
  `summarize_call` varchar(10) DEFAULT NULL,
  `support_wallet` varchar(10) DEFAULT NULL,
  `follow_up` varchar(10) DEFAULT NULL,
  `close_call_professionally` varchar(10) DEFAULT NULL,
  `proper_action_code` varchar(10) DEFAULT NULL,
  `document_thoroughly` varchar(10) DEFAULT NULL,
  `document_callback` varchar(10) DEFAULT NULL,
  `remove_phone_no` varchar(10) DEFAULT NULL,
  `update_address_information` varchar(10) DEFAULT NULL,
  `change_status` varchar(10) DEFAULT NULL,
  `escalate_account` varchar(10) DEFAULT NULL,
...
ALTER TABLE `qa_park_west_feedback`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `qa_park_west_feedback`
--
ALTER TABLE `qa_park_west_feedback`
...
--
-- Indexes for table `qa_park_west_feedback`
--
