						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px; text-align:center!important; ">PARK WEST QA FORM</td>
										...
										if ($park_west_id == 0) {
											...
											if ($park_west_data['entry_by'] != '') {
												$auditorName = $park_west_data['auditor_name'];
											} else {
												$auditorName = $park_west_data['client_name'];
											}
											//$new = explode("-", $park_west_data['audit_date']);
											//$new1 = explode(" ", $new[2]);
											//print_r($new);
											$auditDate = mysql2mmddyy($park_west_data['audit_date']);
										 //    $at = array($new[1], $new1[0], $new[0]);
										 //    $n_date = implode("/", $at);
											// $auditDate = ($n_date)." ".$new1[1];
											$clDate_val = mysql2mmddyy($park_west_data['call_date']);
										}
										?>
										<tr>
										...
										<tr>
											...
											<td colspan="2">
													...
													<?php 
													if($park_west_data['tl_id']!=''){
														?>
														<option value="<?php echo $park_west_data['tl_id'] ?>"><?php echo $park_west_data['tl_name'] ?></option>
														<?php 
												...
												<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $park_west_data['tl_id'] ?>" required>
											</td>
										</tr>
										<tr>
											...
											<td><input type="text" class="form-control" name="data[customer_phone]" value="<?php echo $park_west_data['customer_phone'] ?>" onkeyup="checkDec(this);" required>
												<span id="start_phone" style="color:red"></span></td>

											<td>Customer Name:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[customer_name]" value="<?php echo $park_west_data['customer_name'] ?>" required>
											</td>
										</tr>
										
										<tr>
											<td>Call Duration:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2"><input type="text" class="form-control" onkeydown="return false;" id="call_duration" name="data[call_duration]" value="<?php echo $park_west_data['call_duration']?>" required></td>
										...
										<tr>
											...
											<td rowspan=8>10%</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF1" name="data[identify_himself]" required>
										...
										<tr>
											...
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF2" name="data[provide_quality_assurance]" required>
										...
										<tr>
											...
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point " id ="parkAF3" name="data[state_my_quick_wallet]" required>
										...
										<tr>
											...
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF4" name="data[speaking_right_party]" required>
										...
										<tr>
											...
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF5" name="data[demographics_information]" required>
										...
										<tr>
											...
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF6" name="data[disclosure_verbatim]" required>
										...
										<tr>
											...
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[callback_permission]" required>
										...
										<tr>
											<td colspan="2">State/Ask for balance due? (If required, also inform the breakdown of principal, finance fees & NSF Fees.)
											</td>
											<td>1.25</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[balance_due]" required>
										...
										<tr>
											...
											<td rowspan=4>24%</td>
											<td>
												<select class="form-control park_west_point" name="data[resolve_account]" required>
										...
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control park_west_point" name="data[payment_account]" required>
										...
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control park_west_point" name="data[follow_up_call]" required>
										...
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control park_west_point" name="data[promise_pay]" required>
										...
										<tr>
											...
											<td rowspan=4>10%</td>
											<td>
												<select class="form-control park_west_point" name="data[elaborate_consiquences]" required>
										...
										<tr>
											...
											<td>2.50</td>
											<td>
												<select class="form-control park_west_point" name="data[settelment_options]" required>
										...
										<tr>
											...
											<td>2.50</td>
											<td>
												<select class="form-control park_west_point" name="data[urgency_for_payment]" required>
										...
										<tr>
											...
											<td>2.50</td>
											<td>
												<select class="form-control park_west_point" name="data[negotiate_effectively]" required>
										...
										<tr>
											...
											<td rowspan=16>15%</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF7" name="data[misrepresent_their_identity]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF8" name="data[imply_leagal_actions]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF9" name="data[nature_of_communication]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF10"name="data[contact_customer]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF11" name="data[communicate_customer_work]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF12" name="data[communicate_customer_learning]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF13" name="data[phone_policy]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF14"  name="data[adhere_policy]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF15" name="data[status_code]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF16"  name="data[abusive_acts]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF17" name="data[false_credit_information]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF18" name="data[take_appropriate_action]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF19" name="data[pursue_leagal_action]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF20" name="data[adhere_FDCPA]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF21" name="data[violation_ECOA_policy]" required>
										...
										<tr>
											...
											<td>0.94</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF22"name="data[adhere_state_restrictions]" required>
										...
										<tr>
											...
											<td rowspan=6>10%</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[authorized_user]" required>
										...
										<tr>
											...
											<td>1.67</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[recap_call]" required>
										...
										<tr>
											...
											<td>1.67</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[proper_payment_script]" required>
										...
										<tr>
											...
											<td>1.67</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF24" name="data[permission_from_customer]" required>
										...
										<tr>
											...
											<td>1.67</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[educate_customer]" required>
										...
										<tr>
											...
											<td>1.67</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[consumer_callback]" required>
										...
										<tr>
											...
											<td rowspan=4>10%</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[active_listening]" required>
										...
										<tr>
											...
											<td>2.50</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[positive_manner]" required>
										...
										<tr>
											...
											<td>2.50</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[overcome_objections]" required>
										...
										<tr>
											...
											<td>2.50</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[transfer_call]" required>
										...
										<tr>
											...
											<td rowspan=4>6%</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[summarize_call]" required>
										...
										<tr>
											...
											<td>1.50</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[support_wallet]" required>
										...
										<tr>
											...
											<td>1.50</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[follow_up]" required>
										...
										<tr>
											...
											<td>1.50</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[close_call_professionally]" required>
										...
										<tr>
											...
											<td rowspan=8>15%</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[proper_action_code]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF25" name="data[proper_result_code]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF26" name="data[document_thoroughly]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[document_callback]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF27" name="data[remove_phone_no]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF28" name="data[update_address_information]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="parkAF29" name="data[change_status]" required>
										...
										<tr>
											...
											<td>1.88</td>
											<td>
												<select class="form-control park_west_point" id ="" name="data[escalate_account]" required>
													...
													<td colspan=6>
														...
														foreach ($attach_file as $mp) { ?>
															<audio controls='' style="background-color:#607F93">
																<source src="<?php echo base_url(); ?>qa_files/park_west/qa_audio_files/<?php echo $mp; ?>" type="audio/ogg">
																<source src="<?php echo base_url(); ?>qa_files/park_west/qa_audio_files/<?php echo $mp; ?>" type="audio/mpeg">
															</audio> </br>
														<?php } ?>
													</td>
											<?php } else {
										...
										<?php if ($park_west_id != 0) { ?>
											<tr>
												...
												<td colspan=6><?php echo $park_west_data['agnt_fd_acpt'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td>
												<td colspan=6><?php echo $park_west_data['agent_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td>
												<td colspan=6><?php echo $park_west_data['mgnt_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td>
												<td colspan=6><?php echo $park_west_data['client_rvw_note'] ?></td>
											</tr>
