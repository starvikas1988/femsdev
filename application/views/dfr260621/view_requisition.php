						...
						<div class="table-responive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tr>
									...
									<td><?php echo $row['off_location']; ?></td>
						...
						<tbody>
							...
							<tr>
								...
								<?php	
									...
									$params=$cd['requisition_id']."#".$cd['fname']."#".$cd['lname']."#".$cd['hiring_source']."#".$dob."#".$cd['email']."#".$cd['phone']."#".$cd['last_qualification']."#".$cd['skill_set']."#".$cd['total_work_exp']."#".$cd['country']."#".$cd['state']."#".$cd['city']."#".$cd['postcode']."#".$cd['address']."#".$cd['summary']."#".$cd['attachment']."#".$cd['gender']."#".$cd['ref_name']."#"."#".$cd['onboarding_type']."#".$cd['company'];
										...
										if($r_status=='A' && $c_status!='E'){ ////Approve Requisition & not Fusion Employee
											...
											echo '<a class="btn btn-success btn-xs candidateApproval" p_access="'.$pay_lock.'" r_id="'.$r_id.'" c_id="'.$c_id.'" req_id="'.$requisition_id.'"  c_status="'.$c_status.'" org_role="'.$cd['org_role'].'" gender="'.$cd['gender'].'" location_id="'.$cd['location'].'" title="Approval to Final Selection" style="font-size:12px"><i class="fa fa-check-square"></i></a>';
												...
												if(get_dept_folder()=="hr" || get_global_access()== 1 ){
													...
													echo '&nbsp;<a class="btn btn-success btn-xs viewOfferLetter" href="'.base_url().'dfr/candidate_offer_pdf/'.$c_id.'/Y" target="_blank"  c_id="'.$c_id.'" r_id="'.$r_id.'" title="Click to View Offer Letter " style="font-size:12px"><i class="fa fa-print"></i></a>';
      ...
      <div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> &nbsp; First Name</label>
						<input type="text" id="fname" name="fname" class="form-control" value="" placeholder="Enter First name" required>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> &nbsp; Last Name</label>
						<input type="text" id="lname" name="lname" class="form-control" value="" placeholder="Enter Last name" >
					</div>
				</div>
			</div>
			<div class="row">
			...
			<div class="row">
				<div class="col-md-5">
					<div class="form-group">
						<label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> &nbsp; Field of Interest:</label>
						<div style="display:inline-block">
			...
			<div class="row">
				<?php if($dfr_location == 'ELS' || $dfr_location == 'JAM') { } else{ ?>
					...
					<div class="form-group">
						...
						<input type="text" id="postcode" name="postcode" class="form-control" onkeypress="return isNumber(event)" value="" placeholder="Enter Postcode" required >
					</div>
				</div>
				<?php } ?>
				<div class="col-md-5">
	...
	<form class="frmEditCandidate" action="<?php echo base_url(); ?>dfr/edit_candidate" data-toggle="validator" method='POST' enctype="multipart/form-data">
      ...
      <div class="modal-body">
			...
			<!-- <div class="row"> -->
				...
				<div class="col-md-3 existing" id="existing_employee_edit" style="display: none;">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						...
						<?php
							//-- DISABLED MINLENGTH REQUIRED ON 25 MARCH 2021 ----//
							if(isIndiaLocation($dfr_location)==true ){
				...
				<div class="col-md-3">
					<div class="form-group">
						<?php
							...
							//-- DISABLED REQUIRED ON 25 MARCH 2021 ----//
						?>
			...
			<div class="row">				
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="bank_acc_no" placeholder="Account No" name="bank_acc_no" onkeydown="return ( event.ctrlKey || event.altKey 
