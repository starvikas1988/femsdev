							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>Fusion ID:</td>
										<td colspan="3"><input type="text" class="form-control" id="fusion_id" name="" value="<?php echo $sensio['fusion_id']; ?>" readonly></td>
										<td>L1 Supervisor:</td>
									...
									<tr>
										...
										<td>Call Duration:</td>
										<td colspan="3"><input type="text" class="form-control" id="call_duration" name="call_duration" value="<?php echo $sensio['call_duration']; ?>" required></td>
									</td>
									<tr>
										<td style="font-weight:bold">Possible Score:</td>
										<td colspan="2"><input type="text" readonly id="sensioPossibleScore" name="" class="form-control" style="font-weight:bold" ></td>
										<td style="font-weight:bold">Earned Score:</td>
										<td colspan="2"><input type="text" readonly id="sensioEarnedScore" name="" class="form-control" style="font-weight:bold" ></td>
										<td style="font-weight:bold">Overall Score:</td>
										<td colspan="2"><input type="text" readonly id="sensioOverallScore" name="overall_score" class="form-control" style="font-weight:bold" value="<?php echo $sensio['overall_score'] ?>"></td>
									</tr>
									...
									<tr style="background-color:#D2B4DE">
										<td>Percentage:</td><td colspan="2"><input type="text" readonly style="background-color:#D2B4DE; text-align:center" class="form-control" id="custSenScore" name="customer_score" value="<?php echo $sensio['customer_score'] ?>"></td>
										<td>Percentage:</td><td colspan="2"><input type="text" readonly style="background-color:#D2B4DE; text-align:center" class="form-control" id="busiSenScore" name="business_score" value="<?php echo $sensio['business_score'] ?>"></td>
										<td>Percentage:</td><td colspan="2"><input type="text" readonly style="background-color:#D2B4DE; text-align:center" class="form-control" id="complSenScore" name="compliance_score" value="<?php echo $sensio['compliance_score'] ?>"></td>
									</tr>


									<tr>
										<td>Call Summary:</td>
										<td colspan=3><textarea class="form-control" id="" name="call_summary"><?php echo $sensio['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan=3><textarea class="form-control" id="" name="feedback"><?php echo $sensio['feedback'] ?></textarea></td>
									</tr>
									<tr>
									...
									<?php if($sensio_id!=0){ ?>
										<tr><td colspan=3 style="font-size:16px; font-weight:bold">Agent Review:</td><td colspan=4><?php echo $sensio['agent_rvw_note'] ?></td></tr>
										<tr><td colspan=3 style="font-size:16px; font-weight:bold">Management Review:</td><td colspan=4><?php echo $sensio['mgnt_rvw_note'] ?></td></tr>
										<tr><td colspan=3 style="font-size:16px; font-weight:bold">Client Review:</td><td colspan=4><?php echo $sensio['client_rvw_note'] ?></td></tr>
