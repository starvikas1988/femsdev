					 	...
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr style="background-color:#D2B4DE"><td colspan=3>Customer Score</td><td colspan=2>Business Score</td><td colspan=2>Compliance Score</td></tr>
									<tr style="background-color:#D2B4DE">
										<td>Earned:</td><td id="custSenEarned" colspan="2"></td><td>Earned:</td><td id="busiSenEarned"></td><td>Earned:</td><td id="complSenEarned"></td>
									</tr>
									<tr style="background-color:#D2B4DE">
