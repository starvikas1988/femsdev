					...
					<div class="widget-body">
						<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF"><td colspan="8" id="theader" style="font-size:30px">SENSIO</td></tr>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control sensioVal customer" id="sensio_AF1" name="rude_behaviour" disabled>
										...
										<td colspan=2><input type="text" class="form-control" disabled name="cmt16" value="<?php echo $sensio['cmt16'] ?>" ></td>
										<td>Customer</td>
									</tr>
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control sensioVal customer" id="sensio_AF2" name="call_avoidance" disabled>
										...
										<td colspan=2><input type="text" class="form-control" disabled name="cmt17" value="<?php echo $sensio['cmt17'] ?>" ></td>
										<td>Customer</td>
									</tr>
									 	...
									 	<tr>
											...
											<td colspan="2">
												<select class="form-control" id="" name="agnt_fd_acpt">
													<option value="">--Select--</option>
													<option <?php echo $sensio['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $sensio['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
