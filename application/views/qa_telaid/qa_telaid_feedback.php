					...
					<div class="row">
						<div class="col-md-12">
							<header class="widget-header">
								...
								<div class="col-sm-12">
									<div class="form-group pull-right" > <a href="<?php echo base_url();?>Qa_philipines_raw/sample_telaidsaob_download" class="btn btn-success" title="Download Sample telaidsaob Excel" download="Sample telaidsaob Excel.xlsx" style="margin-right:5px;">Sample Excel</a>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_<?php echo $page ?>/process/add/<?php echo $stratEmailAuditTime; ?>/telaidsaob">Add Feedback</a>	
								</div>
								</div>
									<?php } ?>
