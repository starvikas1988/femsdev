							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="9" id="theader" style="font-size:30px">Mgnt TelAid TA Rvw<!-- <img src="<?php echo base_url(); ?>main_img/hra.png"> --></td>
									...
									<?php if($$dataDetails['entry_by']==get_user_id()){ ?>
										<tr>
											<td colspan=3>Upload Files</td>
											<td colspan=6><input type="file" multiple class="form-control1" id="attach_file" name="attach_file[]"></td>
										</tr>
									<?php }
									
									if($$dataDetails['attach_file']!=''){ 
									?>
									<tr>
											...
											<?php $attach_file = explode(",",$$dataDetails['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio controls='' style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_telaid/<?php echo $page; ?>/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_telaid/<?php echo $page; ?>/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									echo is_access_qa_module();
									echo "460";
									echo is_access_qa_operations_module();
									echo "462";

									if(is_access_qa_module()==true || is_access_qa_operations_module()==true){ 
									if(is_available_qa_feedback($$dataDetails['entry_date'],72) == true){ ?>
										<tr>
											<td colspan="9"><button class="btn btn-success waves-effect" type="submit" id='btnmgntSave' name='btnSave' value="SAVE" style="width:300px">SAVE</button> &nbsp; <a class="btn btn-warning" href="<?php echo base_url(); ?>Qa_telaid">Back</a></td>
										</tr>
									<?php } 
									} ?>
								</tbody>
