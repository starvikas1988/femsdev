...
<h4 class="widget-title">Process Wise Absenteeism & Summary of Agents (Local Time Wise) </h4>
</header>
<hr class="widget-separator"/>
<div class="widget-body clearfix">


<?php echo form_open('',array('method' => 'post','onsubmit'=> 'return false;','name'=> 'frmAttnSummary','id'=> 'frmAttnSummary')) ?>

<?php //echo form_open('',array('method' => 'post','name'=> 'frmAttnSummary','id'=> 'frmAttnSummary')) ?>
...
<div class="row">
	...
	<div class="col-md-2">
		...
		<input type="text" class="form-control" id="start_date" value='<?php echo $start_date; ?>' name="start_date" required>
		</div>
	</div>
	...
	<div class="col-md-2">
		...
		<input type="text" class="form-control" id="end_date" value='<?php echo $end_date; ?>' name="end_date" required>
		</div>
	</div>
	...
	<div class="col-md-3">
		<div class="form-group">
			...
			<select class="form-control" name="dept_id" id="fdepartment_id" >
				<?php
				if(get_global_access()==1 || get_dept_folder()=="mis" || get_dept_folder()=="hr" || get_dept_folder()=="wfm" ) echo "<option value='ALL'>ALL</option>";
				?>
...
<div class="col-md-3" id="site_div" <?php echo $sHide;?>>
	<div class="form-group">
...
<div class="row">
		...
		<input type="Submit" style='' class="btn btn-primary btn-md" id='exportSummReports' name='exportSummReports' value="Export As Excel">&nbsp&nbsp	
		<a  style='display:none;' href='' class="btn btn-success btn-md" id='downloadSummReports' name='downloadSummReports' value="">Download Excel File </a>
		
		<span style='padding:10px;display:none;' class="alert alert-info" id='ajax_msg_div'>
...
<div class="row" id='progress_bar_div' style='margin-top:4px; display:none;' >
