	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="mynavbar">
			...
			<div class="d-flex navbar-right">
				...
				<a href="<?php echo base_url() ?>home" class="hover_efect">
					<img src="<?php echo base_url(); ?>assets_home_v3/images/home_icon.svg" class="" alt="">
				</a>

				<?php if (get_login_type() != "client" && isDisableFemsChat() == false) { ?>
					<a href="<?php echo base_url() ?>femschat" target="_blank" class="hover_efect">
						<img src="<?php echo base_url(); ?>assets_home_v3/images/chat_message.svg" class="" alt="">
					</a>
				<?php } ?>
