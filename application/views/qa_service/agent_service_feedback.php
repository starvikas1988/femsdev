			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_'.$page.'/agent'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
								    <button class="btn btn-success waves-effect" a href="<?php echo base_url()?>Qa_<?php echo $page; ?>/agent" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php $adid=$row['id']; ?>
												<a class="btn btn-success agentFeedback" href="<?php echo base_url(); ?>qa_<?php echo $page; ?>/agentRvw/<?php echo $adid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">View/Review</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
