               ...
               <div class="card mb-4">
                         ...
                         <thead>
                                ...
                                foreach($cns_list as $key=>$rows){ ?>
                                    ...
                                    <td><?php echo $rows['cns_status'];?></td>
                                    <td>
                                    ...
                                    <?php }elseif($rows['cns_status']=='Pending'){ ?>
                                     ...
                                     <?php } */?>  
                                       <a class="btn btn-success btn-xs dropCandidateBtn" onclick="change_data('<?php echo $rows['cns_id'];?>');">View</a> 
                                       <?php if((get_global_access()=='1')||(get_email_id_off()==$rows['emails1'])){ ?>
                                        <a class="btn btn-success btn-xs dropCandidateBtn" href="<?php echo base_url();?>cns/cns_comment_histroy?cns=<?php echo $rows['cns_id'];?>">Approval</a> 
                                       <?php } ?>                                  
                                    </td>
                                    </tr>
                                 <?php 
...
<div class="modal fade" id="upload_doc_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmdoc" id="frmdoc" action="<?php echo base_url(); ?>'cns/upload_docs_file" data-toggle="validator" method='POST' enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" name="doc" id="doc" class="form-control" accept=".pdf,.png,.jpg,.jpeg" required="required">
                                <span style="color:red;">(Upload Max File Size is 300 KB)</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
