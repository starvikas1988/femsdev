...
<div class="wrap">
    <div class="widget">
        <div class="widget-body">
            ...
            <hr>
            <form name="frm" id="frm" method="Get" action="<?php echo base_url();?>cns/cns_report">
            ...
            <div class="widget-body">
                ...
                <table id="example" class="table table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <td><?php echo ($rows['approve_status']=='A')?'Approve':'Pending';?></td>
                        </tr>
                        <?php } ?>
                        </tbody>
                    </table>
