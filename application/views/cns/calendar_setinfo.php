...
<div class="row">
    <div class="col-md-12">
        <div class="slotFormGroup" >
            ...
            <form method="POST" action="<?php echo base_url('cns/calendar_availability_data_'.$cl_type); ?>">
                <input type="hidden" name="entry_type" id="entry_type" value="<?php echo $cl_type;?>">
                <input type="hidden" name="cns_id" id="cns_id" value="<?php echo $cns_id;?>">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="case"> Date </label>
                            <input type="date" class="form-control date_pic" autocomplete="off" value="<?php echo $cns_date; ?>" name="s_from_date" required <?php echo $cl_type=="edit" ? "" : ""; ?>> </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " autocomplete="off" value="<?php echo $emails; ?>" name="emails" required> </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="case">Notification Days </label>
                                <input type="number" class="form-control " autocomplete="off" value="<?php echo $notification_days; ?>" name="notification_days" required> </div>
                        </div>
                    </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control " autocomplete="off" value="<?php echo $emails1; ?>" name="emails1" required> </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="case">Supervisor's Notification Days </label>
                                    <input type="number" class="form-control " autocomplete="off" value="<?php echo $notification_days1; ?>" name="notification_days1" required> </div>
                            </div>
                        </div>
                            <div class="row">
                                <div class="col-md-6">
