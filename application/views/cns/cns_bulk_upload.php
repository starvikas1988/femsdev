...
<h4 class="widget-title">CNS  Upload
<a class="btn btn-primary btn-sm pull-right" target="_blank" href='<?php echo base_url('cns/download_sample_log'); ?>'><i class="fa fa-download"></i> Sample Format</a></h4>
</header>
<hr class="widget-separator"/>
<div class="widget-body clearfix">

<form method="POST" action="<?php echo base_url();?>/cns/bulk_uploads_record" enctype="multipart/form-data">
	...
	<table id="example" class="table table-striped skt-table" cellspacing="0" width="100%">
		<thead>
			<tr class='bg-info'>
				...
				<th>Supervisor Notication Date</th>
				<th>Comment</th>
				<th>Status</th>
			</tr>
		</thead>
