...
$(function(){
    ...
    $("label.btn").on('click',function () {
		...
		if(ans==true){
			...
			var CookTime = $.cookie('remtime');
			var display = document.querySelector('#exam_time');
			startTimer(CookTime,display);
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function(){
			...
			if(CookTime == 'undefined'){
				CookTime = '<?php echo $this->session->userdata('exam_rem_time'); ?>'; 
			}
...
<div class="">
	   <div id="loadbar" style="position:absolute;display:none;z-index:9000;margin-top:20%;margin-left:45%;">
		  <img src="<?php echo base_url();?>main_img/loading.gif">
	  </div>
</div>
