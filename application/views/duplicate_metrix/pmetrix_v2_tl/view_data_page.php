...
foreach($kpi_design as $key=>$kpi_design_value)
{
	...
	/* echo '<pre>';
	print_r($indv_user_raw_data_row);
	echo '</pre>'; */
?>
<div class="row">
			<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-5">
									<header class="widget-header">
										<h4 class="widget-title">Performance Metrix <?php echo $report_of; ?> <a onclick="exportF2(this)"><button class="btn btn-xs btn-info"><i class="fa fa-file-excel-o" aria-hidden="true"></i></button></a></h4>
									</header>
								</div>
								...
								<tbody>
									<?php
										...
										foreach($grade as $key=>$value)
										{
											...
											{
												echo '<td style="text-align:center;border: 1px solid black;" style="text-align:center;color:red;">'.$value->grade.'</td>';
											}
										}
										echo '</tr>';
									?>
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" width="100%" cellspacing="0">
								...
								<tbody>
									<?php
										...
										{
											echo '<tr style="background:orange;border:1px solid black;">';
