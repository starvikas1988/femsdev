				...
				foreach($row as $col_key=>$col)
				{
					...
					else
					{
						...
						else if($col['summ_type'] == 3)
						{
							...
							{
								$summary_array[$tl_fusion_id][$col['kpi_name']]['value'] = $summary_array[$tl_fusion_id][$col['kpi_name']]['value']/$avg_counter[$tl_fusion_id][$col['kpi_name']]['avg_count'];
								//$row_counter=1;
							}
						}
						$summary_array[$tl_fusion_id][$col['kpi_name']]['agent_view'] = $col['agent_view'];
