...
<head>
	...
	<style>
		.banner-widget-new .col-sm-3:nth-child(2) .banner-main {
			margin:0 0 0 -100px;
		}
		.banner-widget-new .col-sm-3:nth-child(3) .banner-main {
			margin:0 -100px 0 0;
		}
		
		.banner-widget-new .col-sm-3:nth-child(1) .first-one {
			position:relative;
			margin:0 0 -25px 0;
		}
		.banner-widget-new .col-sm-3:nth-child(1) .banner-main {
			margin:25px 0 0 0;
		}
...
<body>
  ...
  ?>  
                                        ...
                                        <li class="left-border">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="<?php echo base_url();?>profile" target="_blank">Profile</a></li>
                                                 <li><a href="<?php echo base_url();?>agent/changePasswd" target="_blank">Change<br>Password</a></li>
        ...
        <div class="sidebar">
            ...
            <div class="sidebar_inner" data-simplebar>
                ...
                <ul>
                    ...
                    <li id="more-veiw" hidden><a href="https://fems.fusionbposervices.com/femschat/userview/im"  target="_blank"> 
                    ...
                    <li id="more-veiw" hidden><a href="<?php echo base_url();?>mindfaq_analytics" target="_blank"> 
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="text-red-500">
                            ...
                            <div id="demo" class="carousel slide" data-ride="carousel">
                              ...
                              <div class="carousel-inner">
                                <div class="carousel-item active">
									<div class="banner-widget-new">
                                  <div class="row align-items-center">
                                        <div class="col-sm-3">
											<div class="banner-main">
                                            <div class="chart-content">
                                                <div class="body-widget text-center">
                                                    <h2 class="heading-title first-one">
                                                        My Average Day
                                                    </h2>
                                                    <div id="piechart" class="pie-new"></div>
                                                </div>
                                            </div>
											</div>
                                        </div>
                                        <div class="col-sm-3">   <div class="banner-main">           
                                            <div class="body-widget text-center">
                                ...
                                <div class="carousel-item">
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-sm-3">
											<div class="banner-main" style="margin:0;">
                                            <div class="body-widget text-center">
                                                <h2 class="heading-title">
                                                    Quality
                                                </h2>
                    ...
                    <div class="profiles_content">
                        <div class="profile_avatar">
                            <div class="profile_avatar_holder"> 
                                <img src="<?php echo (file_exists($prof_pic_url))?$prof_pic_url:base_url().'pimgs/blank.png';?>" style="margin:auto;display:block;" alt="">
                            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="lunch-left">
                                        <div class="lunch-main">
                                            ...
                                            <div class="body-widget">
                                                <label class="switch">
                                                  <input type="checkbox" name="lunchbreak" id="break_check_button_ld" <?php echo ($break_on_ld==true)?"checked='checked'":'';?>
                                        ...
                                        <div class="white-widget1 left-one">
                                            <div class="lunch-left">
                                                <div class="lunch-main">
                                                    ...
                                                    <div class="body-widget">
                                                        <label class="switch">
                                                          <input type="checkbox" name="otherbreak" id="break_check_button" <?php echo ($break_on==true)?'checked="checked"':'';?>>
                                                          <span class="slider-toggle round"></span>
                                                        </label>
                                                    </div>
                                                </div>
                ...
                <div class="uk-switcher" id="timeline-tab">
                    ...
                    <div class="md:flex md:space-x-6 lg:mx-16">
                        <div class="space-y-5 flex-shrink-0 md:w-7/12">
                           ...
                           <input type="hidden" name="end" id="end" value="5">
                           <input type="hidden" name="office_id" id="office_id" value="<?php echo $oValue;?>">
                           <div id="friend_data"></div>
                           ...
                           <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                               ...
                               <div class="flex justify-between items-center lg:p-4 p-2.5">
                                   <div class="flex flex-1 items-center space-x-4">
                                       ...
                                       <div class="flex-1 font-semibold capitalize">
                                           ...
                                           <div class="text-gray-700 flex items-center space-x-2 updated">  </span> <ion-icon name="people"></ion-icon></div>
                                           <div class="date">
                                            Date : <?php echo  date('d.m.Y',strtotime($pmatrex['updated_on']));?>
                                           </div>
                                       </div>
                                   </div>
                                 <div>
                                        ...
                                        <tbody>
                                         ...
                                         ?> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url();?>Pmetrix_v2" class="edit-link" target="_blank">
                               ...
                               <div class="p-4 space-y-3 like_div"> 
                                       ...
                                       <!--<a href="#" class="flex items-center space-x-2">-->
                                        <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $pmatrex['id'];?>');">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div>Like</div> &nbsp;<span class="total_like" id="total_like_<?php echo $pmatrex['id'];?>"><?php echo total_likes_data($pmatrex['id'],$prof_uid);?></span></a>
                                       <!--</a>-->
                               ...
                               <div class="flex justify-between items-center lg:p-4 p-2.5">
                                   <div class="flex flex-1 items-center space-x-4">
                                       ...
                                       <div class="flex-1 font-semibold capitalize">
                                           ...
                                           <div class="text-gray-700 flex items-center space-x-2 updated">  </span> <ion-icon name="people"></ion-icon></div>
                                           <div class="date">
                                            Date : <?php echo  date('d.m.Y',strtotime($qamatrex['post_date']));?>
                                           </div>
                                       </div>
                                   </div>
                               ...
                               <div class="w-full h-full">
                                <div class="table-widget1">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php foreach($qamatrex['content'] as $w=>$v):?> 
                                   ...
                                   <div class="flex space-x-4 lg:font-bold">
                                       <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $qmatrex['id'];?>');">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div>Like</div> &nbsp;<span class="total_like" id="total_like_<?php echo $qmatrex['id'];?>"><?php echo total_likes_data($qmatrex['id'],$prof_uid);?></span></a>
                                       </a>
                                   </div>
                               </div>
                                   ...
                                   <div class="flex space-x-4 lg:font-bold">
                                       <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $training_score['id'];?>');">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div>Like</div> &nbsp;<span class="total_like" id="total_like_<?php echo $training_score['id'];?>"><?php echo total_likes_data($training_score['id'],$prof_uid);?></span></a>
                                   ...
                                   <div class="flex space-x-4 lg:font-bold">
                                       <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $kat['id'];?>');">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div>Like</div> &nbsp;<span class="total_like" id="total_like_<?php echo $kat['id'];?>"><?php echo total_likes_data($kat['id'],$prof_uid);?></span></a>
                                   ...
                                   <div class="flex space-x-4 lg:font-bold">
                                       <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $qa['id'];?>');">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div>Like</div> &nbsp;<span class="total_like" id="total_like_<?php echo $qa['id'];?>"><?php echo total_likes_data($qa['id'],$prof_uid);?></span></a>
                                   </div>
                               </div>-->
                           ...
                           <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                               ...
                               <div class="p-4 space-y-3 like_div"> 
                                  <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $rows['id'];?>');" style="cursor: pointer;">
                                   <div class="flex space-x-4 lg:font-bold">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600 ">
                                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
                                                   <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                                            ...
                                            <div>Like</div> &nbsp;<span id="total_like_<?php echo $rows['id'];?>"><?php echo total_likes_data($rows['id'],$prof_uid);?></span></a>
                                   </div>
                               </div>
                           ...
                           ?>  
                           <?php 
                           if(sizeof($policy['content_text']['policy_list'])>0){ ?>
                           <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                               ...
                               <div class="p-4 space-y-3 like_div"> 
                                   ...
                                   <div class="flex space-x-4 lg:font-bold">
                                       <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $policy['id'];?>');">
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
                                                   <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z" />
                                               </svg>
                                           </div>
                                            <div>Like</div> &nbsp;<span id="total_like_<?php echo $policy['id'];?>"><?php echo total_likes_data($policy['id'],$prof_uid);?></span></a>
                                       </a>
                                   </div>
                               </div>
                           ...
                           <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                               ...
                               <div class="p-4 space-y-3 like_div"> 
                                  <a  onclick="add_like('<?php echo $prof_uid;?>','<?php echo $rws['id'];?>');" style="cursor: pointer;">
                                   <div class="flex space-x-4 lg:font-bold">
                                           ...
                                           <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            ...
                                            <div>Like</div> &nbsp;<span id="total_like_<?php echo $rws['id'];?>"><?php echo total_likes_data($rws['id'],$prof_uid);?></span></a>
                           ...
                           ?>
                           <?php /* ?><div class="card lg:mx-0 uk-animation-slide-bottom-small">
                                    ...
                                    <div class="late-widget">
                                        ...
                                        <div class="late-content">
                                            <div class="late-center">
                                                ...
                                                <div class="count-bg">
                                                    <?php echo sizeof($absent);?>  
                                                </div>
                                                <div class="leave-link">
                                                    <a href="<?php echo base_url();?>/leave/" target="_blank">
                                                        Apply for Leave
                                                    </a>
                                                </div>
                                            </div>
                           ...
                           <div id="load_more" class="flex justify-center mt-6">
                        ...
                        <div class="w-full space-y-6">
                            ...
                            <div class="body-widget text-center">
                                <img id="mypic" src="<?php echo (file_exists(prof_pic_url))?$prof_pic_url:base_url().'pimgs/blank.png';?>" class="circle-img2" alt="">
                        ...
                        <div class="bottom-widget">
                            <div class="row">
                                ...
                                <div class="col-md-4" title="<?php echo $rows['fullname'];?>">
                                    <div class="top-winner">
                                        <div class="body-widget text-center">
                                            <img id="mypic<?php echo ($k+1);?>" src="<?php echo (file_exists($rows['pic']))?$rows['pic']:base_url().'pimgs/blank.png';?>" class="circle-img2" alt="">
                                            <h2 class="heading-green">
                                                <i class="fa fa-trophy" aria-hidden="true"></i>
                                                <?php
                                                 $ids='firstpoint';
                                        ...
                                        <div class="winner-widget">
                                            <div class="count-bg">
                                                <?php if($k+1==1)echo '1st';?>
                                                <?php if($k+1==2)echo '2nd';?>
                                                <?php if($k+1==3)echo '3rd';?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="widget card p-3 border-t">
                                ...
                                <div class="grid grid-cols-3 gap-3 text-gray-600 font-semibold">
                                 <?php
                                    ...
                                    ?> 
                                    <span id="disf_<?php echo $i;?>" class="flist" style="display:<?php echo ($i<=9)?'':'none'?>">  
                                    <a onclick="display_friends_data('<?php echo $rws['id'];?>');">  
                                ...
                                ?>
                                  <div id="fell_<?php echo $i;?>" style="display: <?php echo($i>4)?'none':'';?>" class="flex items-center space-x-4 rounded-md -mx-2 p-2 hover:bg-gray-50 fellclass">
                                     <a href="#" class="w-12 h-12 flex-shrink-0 overflow-hidden rounded-full relative">
                                          <img src="<?php echo base_url();?><?php echo(file_exists($path))?$path:'assets/gamification/images/noimage.png';?>" class="absolute w-full h-full inset-0 " alt="">
                                      </a>
                                      <div class="flex-1">
                                  ...
                                  <input type="hidden" id="follow_list_on" name="follow_list_on" value="0">
                                  <div id="follow_content"></div>
                                 <?php 
                                    $i++;
                                    }
                                 ?>                         
                    ...
                    <div class="grid md:grid-cols-1 grid-cols-1  gap-x-2 gap-y-4 mt-6">  
                                         ...
                                         // echo "<pre>";print_r($performance);
                                                foreach($performance as $key=>$v2): if($key <10){

                                                    ?>
                                                     <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <td colspan="5" style="background: antiquewhite;"><?php echo date('d/m/Y',strtotime($v2['updated_on']));  ?></td>
                                            </tr>
                                          <tr>      
                                            <th colspan="2">D2D Battle</th>
                                            <th>Score</th>
                                        ...
                                        <tr>
                                                    <td colspan="4">
                                                        <div class="p-4 space-y-3 like_div"> 
                                                          <a onclick="add_like('<?php echo $prof_uid;?>','<?php echo $v2['id'];?>');" style="cursor: pointer;">
                                                           <div class="flex space-x-4 lg:font-bold">
                                                                   <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                                                       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
                                                                    ...
                                                                    <div>Like</div> &nbsp;<span id="total_like_<?php echo $v2['id'];?>"><?php echo total_likes_data($v2['id'],$prof_uid);?></span></a>
                                    ...
                                    <?php if(count($performance)> 11){ ?>
                                        <div id="pmatrex_content">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                                ...
                                <div class="grid md:grid-cols-1 grid-cols-1  gap-x-2 gap-y-4 mt-6">  
                                         ...
                                         <?php 
                                                ...
                                                foreach($quality as $key=>$v2): if($key < 10){
                                                    if(sizeof($v2['content_text'])!=0){
                                                    ?>
                                                     <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                    ...
                                    <?php if(count($quality)> 11){ ?>
                                        <div id="qmatrex_content">
                    ...
                    <div class="card md:p-6 p-2 max-w-3xl mx-auto">
                        ...
                        <div class="grid gap-4 mt-5">
                            ...
                            foreach ($training_score_history as $key => $value) { 
                                if(sizeof($value['content_text'])!=0){
                                ?>
                                <div class="flex flex-1 items-center space-x-4">
                                       <img src="<?php echo $prof_pic_url;?>" class="bg-gray-200 border border-white rounded-full w-10 h-10">
                                       <div class="flex-1 font-semibold capitalize">
                                            <div class="date">
                                            Date : <?php echo  date('d.m.Y',strtotime($value['updated_on']));?>
                                           </div>
                                       </div>
                                   </div>
                                <div class="card lg:mx-0 uk-animation-slide-bottom-small">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="palette">
                                          ...
                                          <div class="colorOuter2">
                                            <div class="great-color"></div>
                                          </div>
                                          <div class="colorOuter3">
                                            <div class="excellent-color"></div>
                                          </div>
                                          <div class="colorOuter4">
                                            <div class="fair-color"></div>
                                          </div>
                                          <div class="colorOuter5">
                                            <div class="poor-color"></div>
                                          </div>
                                          <div class="centerOverlay">
                                            <?php echo $value['content_text']['score'];?>%
                                          </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="circle-content">
                                            <div class="body-widget">
                                                <ul>
                                                    <li>
                                                        <span class="small-circle red-color big-circle"></span><strong>Poor 30%</strong>
                                                    </li>
                                                    <li>
                                                        <span class="small-circle fair-color"></span>Fair 50%
                                                    </li>
                                                    <li>
                                                        <span class="small-circle good-color"></span>Good 70%
                                                    </li>
                                                    <li>
                                                        <span class="small-circle great-color"></span>Great 85%
                                                    </li>
                                                    <li>
                                                    <span class="small-circle excellent-color"></span>Excellent 95%
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                           ...
                           <!---------------------code Start here------------------->
                            <div class="p-4 space-y-3 like_div"> 
                                <a onclick="add_like('<?php echo $prof_uid;?>','<?php echo $value['id'];?>');" style="cursor: pointer;">
                                <div class="flex space-x-4 lg:font-bold">
                                <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
                                                <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z">
                                ...
                                <div>Like</div> &nbsp;<span id="total_like_<?php echo $value['id'];?>"><?php echo total_likes_data($value['id'],$prof_uid);?></span>
                            </div>
                                </a>    
                                  </div>     
                           ...
                           <?php
                             ...
                             ?>
                            <div id="training_score_content"></div>
                        ...
                        <div class="grid md:grid-cols-1 grid-cols-1  gap-x-2 gap-y-4 mt-6">  
                            ...
                            <div class="p-3 border-b dark:border-gray-700">
                               ...
                               <div class="p-4 space-y-3 like_div"> 
                                ...
                                <div>Like</div> &nbsp;<span id="total_like_<?php echo $rows['id'];?>"><?php echo total_likes_data($rows['id'],$prof_uid);?></span>
                            </div>
                                </a>    
                                  </div>
                   ...
                   <!--  <div class="card md:p-6 p-2 max-w-3xl mx-auto">  
                    ...
                    <div class="news-main md:p-6 p-2 max-w-3xl mx-auto">  
                        ...
                        <div class="grid md:grid-cols-1 grid-cols-1 gap-x-2 gap-y-4 mt-6">  
                            ...
                            <div class="p-4 space-y-3 like_div"> 
                                <a onclick="add_like('<?php echo $prof_uid;?>','<?php echo $row1['id'];?>');" style="cursor: pointer;">
                                    <div class="flex space-x-4 lg:font-bold">
                                        <div class="p-2 rounded-full  text-black lg:bg-gray-100 dark:bg-gray-600">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" width="22" height="22" class="dark:text-gray-100">
                                                        <path d="M2 10.5a1.5 1.5 0 113 0v6a1.5 1.5 0 01-3 0v-6zM6 10.333v5.43a2 2 0 001.106 1.79l.05.025A4 4 0 008.943 18h5.416a2 2 0 001.962-1.608l1.2-6A2 2 0 0015.56 8H12V4a2 2 0 00-2-2 1 1 0 00-1 1v.667a4 4 0 01-.8 2.4L6.8 7.933a4 4 0 00-.8 2.4z">
                                        ...
                                        <div>Like</div> &nbsp;<span id="total_like_<?php echo $row1['id'];?>" class="total_like_<?php echo $row1['id'];?>"><?php echo total_likes_data($row1['id'],$prof_uid);?></span>
                                    </div>
                                </a>    
                            </div>
   ...
   <!-- <div class="start-chat">
    ...
    <!-- Modal -->
<div id="leadership" class="modal fade model-new model-new1" role="dialog">
  <div class="modal-dialog modal-lg">    
    <div class="modal-content">
	  <div class="modal-header">          
      ...
      <div class="modal-body">
		<div class="team-widget">
			<h4 class="modal-title">Executive Team</h4>
			<div class="divider"></div>
        <div class="row">
		   <div class="col-md-4">
			  <a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
				<div class="widget widget-person">
					<div class="widget-body clearfix" style="padding:1px;">
						<div class="pull-left">
							<img src="<?php echo base_url(); ?>pimgs/imgmt/pankaj.jpg" class="team-img" alt="">
						</div>
						<div class="profile-team">
							<h4 class="widget-title"><span class="counter">Pankaj Dhanuka</span></h4>
							<h5 class="team-sub">Co-Founder & Director</h5>
						</div>
					</div>
				</div>
			</a>
          ...
          <div class="col-md-4">
			<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
				<div class="widget widget-person">
					<div class="widget-body clearfix" style="padding:1px;">
						<div class="pull-left">
							<img src="<?php echo base_url(); ?>pimgs/imgmt/kishore.jpg" class="team-img" alt="">
						</div>
						<div class="profile-team">
							<h4 class="widget-title"><span class="counter">Kishore Saraogi</span></h4>
							<h5 class="team-sub">Co-Founder & Director</h5>
						</div>
					</div>
				</div>
		...
		<div class="col-md-4">
			<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
				<div class="widget widget-person">
					<div class="widget-body clearfix" style="padding:1px;">
						<div class="pull-left">
							<img src="<?php echo base_url(); ?>pimgs/imgmt/prashant.jpg" class="team-img" alt="">
						</div>
						<div class="profile-team">
							<h4 class="widget-title"><span class="counter">Prashant Khandelwal</span></h4>
							<h5 class="team-sub">Chief Finance Officer</h5>
						</div>
					</div>
				</div>
			</a>
		...
		<div class="col-md-4">
			<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
				<div class="widget widget-person">
					<div class="widget-body clearfix" style="padding:1px;">
						<div class="pull-left">
							<img src="<?php echo base_url(); ?>pimgs/imgmt/partho.jpg" class="team-img" alt="">
						</div>
						<div class="profile-team">
							<h4 class="widget-title"><span class="counter">Partho Choudhury</span></h4>
							<h5 class="team-sub">President - Ameridial Inc.</h5>
						</div>
					</div>
				</div>
			</a>
		...
		<div class="col-md-4">
			<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
				<div class="widget widget-person">
					<div class="widget-body clearfix" style="padding:1px;">
						<div class="pull-left">
							<img src="<?php echo base_url(); ?>pimgs/imgmt/matt.jpg" class="team-img" alt="">
						</div>
						<div class="profile-team">
							<h4 class="widget-title"><span class="counter">Matt McGeorge</span></h4>
							<h5 class="team-sub">Executive Vice President - Ameridial Inc.</h5>
						</div>
					</div>
				</div>
			</a>
		...
		<div class="col-md-4">
			<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
				<div class="widget widget-person">
					<div class="widget-body clearfix" style="padding:1px;">
						<div class="pull-left">
							<img src="<?php echo base_url(); ?>pimgs/imgmt/ritesh.jpg" class="team-img" alt="">
						</div>
						<div class="profile-team">
							<h4 class="widget-title"><span class="counter">Ritesh Chakraborty</span></h4>
							<h5 class="team-sub">Vice President - Operations</h5>
						</div>
					</div>
				</div>
			</a>
	 ...
	 <div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/eric.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Eric Pittman</span></h4>
						<h5 class="team-sub">President, Vital Solutions, Inc.</h5>
					</div>
				</div>
			</div>
		</a>
	...
	<div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/rajesh.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Rajesh Ramdas</span></h4>
						<h5 class="team-sub">Senior Vice President</h5>
					</div>
				</div>
			</div>
		</a>
	...
	<div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/lalita.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Lalita Sinha</span></h4>
						<h5 class="team-sub">Director - Human Resources</h5>
					</div>
				</div>
			</div>
		</a>
	...
	<div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/nagarajan.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Nagarajan Anandaraman</span></h4>
						<h5 class="team-sub">Country Manager - Philippines</h5>
					</div>
				</div>
			</div>
		</a>
	...
	<div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/ganesh.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Ganesh Marve</span></h4>
						<h5 class="team-sub">Vice President - Global Marketing</h5>
					</div>
				</div>
			</div>
		</a>
	...
	<div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/suresh.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Suresh Sampath</span></h4>
						<h5 class="team-sub">Director Quality Assurance and Business Excellence</h5>
					</div>
				</div>
			</div>
		</a>
	...
	<div class="col-md-4">
		<a href="http://www.fusionbposervices.com/management-team.html" class="link-area" target="_blank">
			<div class="widget widget-person">
				<div class="widget-body clearfix" style="padding:1px;">
					<div class="pull-left">
						<img src="<?php echo base_url(); ?>pimgs/imgmt/prasun.jpg" class="team-img" alt="">
					</div>
					<div class="profile-team">
						<h4 class="widget-title"><span class="counter">Prasun Das</span></h4>
						<h5 class="team-sub">Head - Workforce Management</h5>
					</div>
				</div>
			</div>
		</a>
		...
		<div class="second-widget">
			...
			<div class="row">
				<div class="col-md-4">
					<a href="http://www.fusionbposervices.com/executive-team.html" class="link-area" target="_blank">
						<div class="widget widget-person">
							<div class="widget-body clearfix" style="padding:1px;">
								<div class="pull-left">
									<img src="<?php echo base_url(); ?>pimgs/imgmt/rajan.jpg" class="team-img" alt="">
								</div>
								<div class="profile-team">
									<h4 class="widget-title"><span class="counter">Rajan Singh</span></h4>
									<h5 class="team-sub">CTO</h5>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4">
					<a href="http://www.fusionbposervices.com/executive-team.html" class="link-area" target="_blank">
						<div class="widget widget-person">
							<div class="widget-body clearfix" style="padding:1px;">
								<div class="pull-left">
									<img src="<?php echo base_url(); ?>pimgs/imgmt/neha.jpg" class="team-img" alt="">
								</div>
								<div class="profile-team">
									<h4 class="widget-title"><span class="counter">Neha Kallani</span></h4>
									<h5 class="team-sub">Finance Controller</h5>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4">
					<a href="http://www.fusionbposervices.com/executive-team.html" class="link-area" target="_blank">
						<div class="widget widget-person">
							<div class="widget-body clearfix" style="padding:1px;">
								<div class="pull-left">
									<img src="<?php echo base_url(); ?>pimgs/imgmt/rahul.jpg" class="team-img" alt="">
								</div>
								<div class="profile-team">
									<h4 class="widget-title"><span class="counter">Rahul Singh</span></h4>
									<h5 class="team-sub">Site Head - El Salvador</h5>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4">
					<a href="http://www.fusionbposervices.com/executive-team.html" class="link-area" target="_blank">
						<div class="widget widget-person">
							<div class="widget-body clearfix" style="padding:1px;">
								<div class="pull-left">
									<img src="<?php echo base_url(); ?>pimgs/imgmt/barbara.jpg" class="team-img" alt="">
								</div>
								<div class="profile-team">
									<h4 class="widget-title"><span class="counter">Barbara Atillo-Alovera</span></h4>
									<h5 class="team-sub">Director of Client Services - Philippines</h5>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4">
					<a href="http://www.fusionbposervices.com/executive-team.html" class="link-area" target="_blank">
						<div class="widget widget-person">
							<div class="widget-body clearfix" style="padding:1px;">
								<div class="pull-left">
									<img src="<?php echo base_url(); ?>pimgs/imgmt/topaz.jpg" class="team-img" alt="">
								</div>
								<div class="profile-team">
									<h4 class="widget-title"><span class="counter">Topaz Tolloti</span></h4>
									<h5 class="team-sub">Vice President - Client Services - Ameridial Inc.</h5>
								</div>
							</div>
						</div>
					</a>
				...
				<div class="col-md-4">
					<a href="http://www.fusionbposervices.com/executive-team.html" class="link-area" target="_blank">
						<div class="widget widget-person">
							<div class="widget-body clearfix" style="padding:1px;">
								<div class="pull-left">
									<img src="<?php echo base_url(); ?>pimgs/imgmt/terri.jpg" class="team-img" alt="">
								</div>
								<div class="profile-team">
									<h4 class="widget-title"><span class="counter">Terri Peterman</span></h4>
									<h5 class="team-sub">Vice President - Service Delivery - Ameridial Inc.</h5>
								</div>
							</div>
						</div>
					</a>
...
<!---------User Attendance-------->
<div id="attendance_model" class="modal model-new popup-big fade">
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <!-- Modal content-->
    <div class="modal-content">
		<div class="modal-header">
          <h4 class="modal-title">Your Attendance Report</h4>
          <a href="javascript:void(0);" class="close" data-dismiss="modal">&times;</a>
        </div>
				...
				<div class="col-md-12">
					<div class="widget">						
						<div class="widget-body">
							<div id='currAttendanceTable' class="table-responsive table-new">
							</div>
						</div>
					</div>
            </div>           
...
function drawChart() {
  ...
  ['', 'Monthly Schedule Adherance'],
  ['ontime', <?php echo $piedata['ontime'];?>],
  ['Late', <?php echo $piedata['latetime'];?>],
  ['Off', <?php echo $piedata['offtime'];?>],
  ['Leave', <?php echo $piedata['leavetime'];?>],
  ['Absent', <?php echo $piedata['absenttime'];?>],
...
<script>
 ...
 $("#attendance").click(function(){
    var rURL='<?php echo base_url(); ?>'+'GamifyProcess/getCurrentAttendance';
...
$(window).scroll(function(){
 if (scrollLoad && ($(document).height() - $(window).height())-$(window).scrollTop()<=20){
    start_count();
    pmatrex_histroy();
    qmatrex_histroy();
...
function start_count(){
    var rURL='<?php echo base_url(); ?>'+'gamify/fetch_follwers_data';
        var userid=$('#uid').val();
        var start=$('#start').val();
        var end=$('#end').val();
        //$('#sktPleaseWait').modal('show');
           $.ajax({
                   ...
                   success: function(tbDtata){
                    ...
                    if(tbDtata==0){
                        $('#load_more').html('No More Data Found');
                      //$('#sktPleaseWait').modal('hide'); 
...
$('.frmPolicyAccept').submit(function(){
            if($('#p_status').prop("checked") == true){
                ...
                swal("Alerta", "Please select the CheckBox.", "error");
