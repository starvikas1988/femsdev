...
<div class="tabs-widget">
	<ul class="nav nav-pills" role="tablist">
	  <li class="nav-item">
		<a data-toggle="tab" href="#main1" class="nav-link <?php if($current_view == 1){ echo "active"; } ?>">
			My Attendance
		</a>
	  </li>
	  <li class="nav-item">
		<a data-toggle="tab" href="#main2" class="nav-link <?php if($current_view == 2){ echo "active"; } ?>">
			Login Adherence
		</a>
	  </li>
	  <li class="nav-item">
		<a data-toggle="tab" href="#main3" class="nav-link <?php if($current_view == 3){ echo "active"; } ?>">
			Auto Logout Count
		</a>
	  </li>
	  <li class="nav-item">
		<a data-toggle="tab" href="#main4" class="nav-link <?php if($current_view == 4){ echo "active"; } ?>">
			Staffed Time
		</a>
	  </li>
	</ul>
