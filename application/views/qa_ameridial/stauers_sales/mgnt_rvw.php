							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="9" id="theader" style="font-size:30px">AMERIDIAL [Stauers sales Scorecard]
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control" value="<?php echo mysql2mmddyy($aspca_data['audit_date']); ?>" disabled></td>
										<td>Call Date:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="3"><input type="text" class="form-control" id="call_date" name="call_date" value="<?php echo mysql2mmddyy($aspca_data['call_date']); ?>" required></td>
									</tr>
									<tr>
										...
										<td colspan="2"><input type="text" readonly class="form-control" id="fusion_id" name="" value="<?php echo $aspca_data['fusion_id'] ?>"></td>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control" id="call_duration" name="call_duration" value="<?php echo $aspca_data['call_duration'] ?>" required></td>
										<td>File No.:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="3"><input type="text" class="form-control" id="file_no" name="file_no" value="<?php echo $aspca_data['file_no'] ?>" required></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td colspan="2"><input type="text" readonly id="conduent_possible_score" name="possible_score" class="form-control" style="font-weight:bold" value="<?php echo $aspca_data['possible_score'] ?>"></td>
										<td style="font-weight:bold; font-size:16px">Overall Score:</td>
										<td colspan="3"><input type="text" readonly id="conduent_overall_score" name="overall_score" class="form-control" style="font-weight:bold" value="<?php echo $aspca_data['overall_score'] ?>"></td>
									</tr>
								...
								<tr style="background-color:#D2B4DE"><td colspan=2>Customer Score</td><td colspan=4>Business Score</td><td colspan=4>Compliance Score</td></tr>
									...
									<tr>
										...
										<td>Feedback:</td>
										<td colspan="5"><textarea class="form-control" id="feedback" name="feedback"><?php echo $aspca_data['feedback'] ?></textarea></td>
									</tr>
									...
									<?php if($aspca_data['agent_rvw_date']==''){ ?>
										<tr>
											<td colspan="9" style="font-size:16px; font-weight:bold">Agent Review Not found</td>
										</tr>
									<?php }else{ ?>
										<tr>
									...
									if(is_available_qa_feedback($aspca_data['entry_date'],72) == true){ ?>
										<tr>
											<td colspan="9"><button class="btn btn-success waves-effect" type="submit" id='btnmgntSave' name='btnSave' value="SAVE" style="width:500px">SAVE</button></td>
										</tr>
									<?php } 
									} ?>
