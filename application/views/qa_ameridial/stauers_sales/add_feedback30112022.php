							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" class="form-control" onkeydown="return false;" id="call_date" name="call_date" required></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control" onkeydown="return false;" id="call_duration" name="call_duration" required></td>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control conduent_points business" id="" name="text1" required>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control conduent_points customer" id="" name="text19" required>
												<option value="">-Select-</option>
												<option acm_val=5 value="Yes">Yes</option>
												<option acm_val=5 value="No">No</option>
												<option acm_val=5 value="N/A">N/A</option>
								...
								<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control conduent_points business" id="hovBR1"  name="data[text19]" required>
								...
								<tr>
									<td class="eml" colspan=4 style="color:red">Rude Remarks</td>
										<td>1</td>
										<td>
											<select class="form-control conduent_points compliance_round" id="hovBR2" name="data[rude_remarks]" required>
												<option acm_val=1 value="Pass">Pass</option>
												<option acm_val=0 value="Fail">Fail</option>
												<option acm_val=1 value="N/A">N/A</option>
											</select>
										</td>
									<td colspan=2><input type="text" class="form-control" name="data[cmt19]"></td>
									<td>Compliance</td>
								</tr>
								<tr>
									...
									<td colspan=2><input type="text" class="form-control" name="data[cmt20]"></td>
									<td>Compliance</td>
								</tr>
									<tr>
										<td>Call Summary:</td>
