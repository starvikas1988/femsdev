							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>										
										...
										<td style="font-size:18px; font-weight:bold" colspan="2"><input type="text" readonly class="form-control"  name="data[overall_score]" value="<?php echo $$dataDetails['overall_score'] ?>" readonly></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class="form-control conduent_points"  name="data[rude_remarks]" required>
												<option acm_val=1 value="Pass" <?php echo $$dataDetails['rude_remarks']=="Pass"?"selected":""; ?> >Pass</option>
												<option acm_val=0 value="Fail" <?php echo $$dataDetails['rude_remarks']=="Fail"?"selected":""; ?> >Fail</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control conduent_points"  name="data[call_avoidance]" required>
												<option acm_val=1 value="Pass" <?php echo $$dataDetails['call_avoidance']=="Pass"?"selected":""; ?> >Pass</option>
												<option acm_val=0 value="Fail" <?php echo $$dataDetails['call_avoidance']=="Fail"?"selected":""; ?> >Fail</option>
											</select>
										</td>
