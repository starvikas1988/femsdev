								...
								<tbody>
									...
									<tr  style="height:25px; font-weight:bold">
										...
										<tr>
											...
											<td colspan="2"><input type="text" class="form-control" name="data[mtd_attendance]" value="<?php echo $auditData['mtd_attendance'] ?>"></td>

											<td colspan="2">Pause:</td>
											<td colspan="3"><input type="text" class="form-control" name="data[mtd_pause]" value="<?php echo $auditData['mtd_pause'] ?>"></td>
										</tr>

										<tr>
											<td colspan="1">ACW :</td>
											<td colspan="1"><input type="text" class="form-control" name="data[mtd_acw]" value="<?php echo $auditData['mtd_acw'] ?>"></td>

											<td colspan="2">Shrink:</td>
											<td colspan="2"><input type="text" class="form-control" name="data[mtd_shrink]" value="<?php echo $auditData['mtd_shrink'] ?>"></td>

											<td colspan="2">Before Ready %:</td>
											<td colspan="3"><input type="text" class="form-control" name="data[mtd_before_ready]" value="<?php echo $auditData['mtd_before_ready'] ?>"></td>
										...
										<tr>
											...
											<td colspan="2">Attendance:</td>
											<td colspan="2"><input type="text" class="form-control" name="data[wtd_attendance]" value="<?php echo $auditData['wtd_attendance'] ?>"></td>

											<td colspan="2">Pause:</td>
											<td colspan="3"><input type="text" class="form-control" name="data[wtd_pause]" value="<?php echo $auditData['wtd_pause'] ?>"></td>
										</tr>
												
										<tr>
											<td colspan="1">ACW:</td>
											<td colspan="1"><input type="text" class="form-control" name="data[wtd_acw]" value="<?php echo $auditData['wtd_acw'] ?>"></td>

											<td colspan="2">Shrink:</td>
											<td colspan="2"><input type="text" class="form-control" name="data[wtd_shrink]" value="<?php echo $auditData['wtd_shrink'] ?>"></td>

											<td colspan="2">Before Ready %:</td>
											<td colspan="3"><input type="text" class="form-control" name="data[wtd_before_ready]" value="<?php echo $auditData['wtd_before_ready'] ?>" ></td>
									...
									<tr  style="height:25px; font-weight:bold">
										...
										<tr  style="height:25px;">
											...
											<td colspan='6'>
												<textarea class="form-control" name="data[validation_comm1]" rows="5" cols="20"><?php echo $auditData['validation_comm1'] ?></textarea>
											</td>
										...
										<tr  style="height:25px;">
											...
											<td colspan='6'>
												<textarea class="form-control" name="data[validation_comm2]"><?php echo $auditData['validation_comm2'] ?></textarea>
											</td>
										</tr>
										<tr  style="height:25px;">
											...
											<td colspan='6'>
												<textarea class="form-control" name="data[validation_comm3]"><?php echo $auditData['validation_comm3'] ?></textarea>
											</td>
										</tr>
										<tr  style="height:25px;">
											...
											<td colspan='6'>
												<textarea class="form-control" name="data[validation_comm4]"><?php echo $auditData['validation_comm4'] ?></textarea>
											</td>
										</tr>
										...
										if($auditData['follow_up_active_listening']!=''){
											?>
											    ...
											    <tr class="">
															...
															<td colspan="2">
																<input type="text" class="form-control" id="call_date_time" name="call_date"  onkeydown="return false;" value="<?php echo $clDate_val; ?>">
															</td>
