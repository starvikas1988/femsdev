						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px; text-align:center!important; ">Conduent- Direct Express Agent FORM</td>
										...
										<tr>
											...
											<td colspan="2">
												<input type="text" class="form-control" id="tl_name_s"  value="<?php echo $tl_name; ?>" readonly>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="data[phone_no]" value="<?php echo $conduent_direct_express_data['phone_no'] ?>" onkeyup="checkDec(this);" disabled>
												<span id="start_phone" style="color:red"></span></td>

											<td>Ticket id/File no:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[ticket_id]" value="<?php echo $conduent_direct_express_data['ticket_id'] ?>" disabled>
											</td>
										</tr>
										...
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt1]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt1'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt2]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt2'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt3]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt3'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt4]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt4'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt5]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt5'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt6]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt6'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt7]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt7'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt8]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt8'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt9]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt9'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt10]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt10'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt11]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt11'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt12]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt12'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt13]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt13'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt14]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt14'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt15]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt15'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt16]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt16'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt17]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt17'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt18]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt18'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt19]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt19'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt20]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt20'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt21]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt21'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt22]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt22'] ?>"></td>
										</tr>
										<tr>
											...
											<td colspan=2><input type="text" disabled name="data[cmt23]" class="form-control" value="<?php echo $conduent_direct_express_data['cmt23'] ?>"></td>
										</tr>
										<tr>
											<td>Call Summary:</td>
											<td colspan=3><textarea class="form-control" disabled name="data[call_summary]"><?php echo $conduent_direct_express_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $conduent_direct_express_data['feedback'] ?></textarea></td>
										</tr>
										<?php if($conduent_direct_express_data['attach_file']!=''){ ?>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $conduent_direct_express_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $conduent_direct_express_data['client_rvw_note'] ?></td>
									</tr>

									<tr><td colspan="10" style="background-color:#C5C8C8"></td></tr>
									
									 <form id="form_agent_user" method="POST" action="">
										<input type="hidden" name="conduent_id" class="form-control" value="<?php echo $conduent_id; ?>">
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $conduent_direct_express_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $conduent_direct_express_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $conduent_direct_express_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($conduent_direct_express_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($conduent_direct_express_data['agent_rvw_note']==''){ ?>
