								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_ameridial/add_edit_conduent/<?php echo $fbid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit/Review Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
