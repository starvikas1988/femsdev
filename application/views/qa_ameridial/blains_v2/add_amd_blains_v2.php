							...
							<table class="table table-striped skt-table new-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td colspan="3">
										<!--<input type="text" class="form-control" id="phone_no" name="data[phone]" onkeyup="phone_noFunction(phone_no)"  autocomplete="off" class="form-control" maxlength="12"	pattern="[6789][0-9]{9}" value="<?php //echo $customer_contact_number;?>"  required>-->
										<input type="text" class="form-control" id="phone_no" name="data[phone]" onkeyup="phone_noFunction(phone_no)"  autocomplete="off" class="form-control" maxlength="12"  pattern="[123456789][0-9]{9}" value="<?php echo $customer_contact_number;?>"  required>
										
										</td>
									</tr>
									<tr><td colspan=11 style="text-align:right"><div id="msg-phone_no"></div></td></tr>
									<tr>
										...
										<td  >
											<select class="form-control" id="agent_id" name="data[agent_id]" required>
												...
												<option value="<?php echo $agent_id; ?>" selected><?php echo $agent_name; ?></option>
												<?php }?>
										...
										<td colspan="3"><input type="text" class="form-control" id="fusion_id" value="<?php echo $fusion_id;?>" disabled></td> 
										...
										<td  colspan="3">
											<select class="form-control" id="tl_id" name="data[tl_id]" required>
												<option value="">--Select--</option>
												<?php if(!empty($tl_id)){?>
												<option value="<?php echo $tl_id; ?>" selected><?php echo $tl_name; ?></option>
												<?php }?>
									...
									<tr>
										...
										<td colspan="3"><input type="text" class="form-control" onkeydown="return false;" id="call_date" name="call_date" value="<?php echo $clDate_val;?>" required></td>
										<td colspan="1">Call Duration:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="3"><input type="text" class="form-control" onkeydown="return false;" id="call_duration" name="data[call_duration]" value="<?php echo $call_duration;?>" required></td>
									</tr>
									<tr>
										...
										<td class="auType_epi" colspan="1">Auditor Type:<span style="font-size:24px;color:red">*</span></td>
									...
									<tr>
										...
										<td ><input type="text" class="form-control"  name="data[site]" value="<?php echo $campaign;?>" required></td>
									...
									<tr>
										<td colspan="1">Location:<span style="font-size:24px;color:red">*</span></td>
										<td colspan="3"><input type="text" class="form-control" id="office_id" name="data[side_location]" readonly></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control conduent_points customer" name="data[brand_name]" required>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control conduent_points customer"  name="data[least_once]" required>
												<option acm_val=5 value="Yes">Yes</option>
												<option acm_val=5 value="No">No</option>
												<option acm_val=5 value="N/A">N/A</option>
											</select>
									...
									<tr>
										...
										<td>6</td>
										<td>
											<select class="form-control conduent_points customer"  name="data[phone_number]" required>
									...
									<tr>
										...
										<td>6</td>
										<td>
											<select class="form-control conduent_points customer"  name="data[flagging_notating]" required>
												<option acm_val=6 value="Yes">Yes</option>
												<option acm_val=6 value="No">No</option>
												<option acm_val=6 value="N/A">N/A</option>
											</select>
								...
								<tr>
										...
										<td>6</td>
										<td>
											<select class="form-control conduent_points customer"  name="data[if_required]" required>
												<option acm_val=6 value="Yes">Yes</option>
												<option acm_val=6 value="No">No</option>
												<option acm_val=6 value="N/A">N/A</option>
											</select>
								...
								<tr>
										...
										<td>6</td>
										<td>
											<select class="form-control conduent_points customer"  name="data[blains_website]" required>
												<option acm_val=6 value="Yes">Yes</option>
												<option acm_val=6 value="No">No</option>
												<option acm_val=6 value="N/A">N/A</option>
											</select>
								...
								<tr>
										...
										<td>9</td>
										<td>
											<select class="form-control conduent_points business"  name="data[and_recgnition]" required>
												<option acm_val=9 value="Yes">Yes</option>
												<option acm_val=9 value="No">No</option>
												<option acm_val=9 value="N/A">N/A</option>
											</select>
										</td>
								...
								<tr>
										...
										<td>9</td>
										<td>
											<select class="form-control conduent_points business"  name="data[and_pacing]" required>
												<option acm_val=9 value="Yes">Yes</option>
												<option acm_val=9 value="No">No</option>
												<option acm_val=9 value="N/A">N/A</option>
											</select>
								...
								<tr>
										...
										<td>9</td>
										<td>
											<select class="form-control conduent_points business" name="data[with_customer]" required>
												<option acm_val=9 value="Yes">Yes</option>
												<option acm_val=9 value="No">No</option>
												<option acm_val=9 value="N/A">N/A</option>
											</select>
								...
								<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control conduent_points customer"  name="data[time_is_right]" required>
												<option acm_val=4 value="Yes">Yes</option>
												<option acm_val=4 value="No">No</option>
												<option acm_val=4 value="N/A">N/A</option>
											</select>
									...
									<!-- <td rowspan=2 class="eml1" style="color:red">Other (Any score here =ZERO fatal for call)</td> -->
										...
										<td>
											<select class="form-control conduent_points compliance_round" id="hovBR1"  name="data[rude_remarks]" required>
												<option acm_val=0 value="Pass">Pass</option>
								...
								<tr>
									<td class="eml" colspan=4 style="color:red">Did the agent dispose the call properly</td>
										<td>0</td>
										<td>
											<select class="form-control conduent_points business" id="agent_dispose" name="data[agent_dispose]" required>
												<option acm_val=0 value="Yes">Yes</option>
												<option acm_val=0 value="No">No</option>
												<option acm_val=0 value="N/A">N/A</option>
											</select>
										</td>
									<td colspan=2><input type="text" class="form-control" name="data[cmt18]"></td>
									<td>Business Critical</td>
								</tr>
								...
								<tr style="background-color:#D2B4DE"><td colspan=2>Customer Score</td><td colspan=4>Business Score</td><td colspan=4>Compliance Score</td></tr>
									...
									<tr>
										...
										<td colspan=8><input type="file" multiple class="form-control" data-file_types="audio/*,video/*" id="attach_file" name="attach_file[]"></td>
									</tr>
