	...
	<header class="aside-header">
		<div class="animated">
			<a href="<?php echo base_url()?>home" id="app-brand" class="app-brand">
				...
				<span id="brand-name" class="brand-icon foldable"><img src="<?php echo base_url() ?>assets_home_v3/brand_logo/fusion_logo.svg" border="0" alt="Fusion BPO"></span>
			</a>
		</div>
	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
						...
						<?php
							if(get_clients_allow_dfr_report() == 1 ){
						?>
								
						<li class="menu-item">
							<a href="<?php echo base_url('client_dfr/dashboard')?>" class="menu-link ">
						...
						<li class="menu-item">
							<a href="<?php echo base_url('client_dfr/requisition_report')?>" class="menu-link ">
								<span class="menu-icon"><i class="zmdi zmdi-accounts-outline zmdi-hc-lg"></i></span>
						...
						<?php
							if(get_clients_allow_dfr_interview() == 1 ){
						?>
				        <li class="menu-item">
