	...
	<div id='main_page_content'>
		...
		<!--========== Wrap class start -->
			...
			<div class="wrap">
				...
				<?php if($client_info['allow_dfr_interview'] == 1){ ?>
									...
									<tr>
										...
										<td>
											<?php	
												...
												echo '<a class="btn btn-success btn-xs" href="'.base_url().'client/view_candidate_details/'.$c_id.'" target="_blank"  c_id="'.$c_id.'" r_id="'.$r_id.'" title="Click to View Candidate Details" style="font-size:12px"><i class="fa fa-eye"></i></a>';
												echo "&nbsp &nbsp";
										
												if($c_status!='P'){
												
													echo '<a class="btn btn-xs" href="'.base_url().'client/view_candidate_interview/'.$c_id.'"  target="_blank"  c_id="'.$c_id.'" r_id="'.$r_id.'" title="Click to View Candidate Interview Report" style="font-size:12px; background-color:#EE8CE4;"><i class="fa fa-desktop"></i></a>';
															...
															//if(get_dept_folder()=="hr" || get_role_dir()=="admin" || get_role_dir()=="super" || get_global_access()==1){
																...
																if($sh_status=="P"){
																	...
																	//if($currDate >= $scheduled_on){
																		echo '<a class="btn btn-success btn-xs candidateAddInterview" title="Add Interview" r_id="'.$r_id.'" c_id="'.$c_id.'" sch_id="'.$sch_id.'" sh_status="'.$sh_status.'" sch_date="'.$sch_date.'" style="font-size:12px"><i class="fa fa-plus"></i></a>';
																	/* }else{
																	...
																	echo '<a class="btn btn-primary btn-xs editInterview" r_id="'.$r_id.'" c_id="'.$c_id.'" sch_id="'.$sch_id.'" params2="'.$params2.'" title="Edit Interview" style="font-size:12px"><i class="fa fa-pencil-square-o"></i></a>';
				...
				<div class="widget">					
					...
					<div class="widget-body clearfix">
						...
						<div class='apps_grid'>
							...
							<?php if(($client_info['allow_process_update'] == 1) || ($client_info['allow_qa_module'] == 1) || ($client_info['allow_ba_modile'] == 1)) { ?>
								...
								<?php
								if($client_info['allow_ba_modile'] == 1){ 
									...
									<div class="case-wrapper" title="Performance Metrics V2">
										<a  href="<?php echo $linkurl; ?>" >
											...
											<div class="case-label ellipsis"> 
												...
												<span class="case-label-text">Performance Metrics V2</span>
											</div>
										</a>
							...
							<?php if($client_info['allow_knowledge'] == 1) { ?>
