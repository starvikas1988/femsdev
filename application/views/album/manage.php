	...
	<section class="app-content">
		...
		<div class="col-md-12">
				<div class="widget">
					...
					<div class="row">
							<div class="col-md-9 ">
								<h4 class="widget-title"><?php echo $perfect_loaction; ?>'s Gallery</h4>
							</div>
						...
						<div class="col-md-1  float-right">
								<h4 class="widget-title">
									<div style="display: inline-block; text-align: center;">
										...
										<a href="<?php echo base_url();?>album"  title="Back to Album" class="btn btn-dark" width="100px"><i class='fa fa-mail-reply fa-lg' style="color:white"></i></a>
									</div>
								</h4>
							</div>
						</div>	
								...
								<?php foreach($albums as $display) :?>
										...
										<div class="col-md-3" style="padding-top:10px" title="<?php echo $display['album_name'] ?>"> 
											...
											<?php if($display['album_cover']!="") {  ?>
												<img alt="" src="<?php echo base_url().''.$display['album_cover'];?>" width="200px" height="200px"  class="picture img">
											<?php } else{ ?>				 
											...
											<?php }     ?>
												...
												<img alt="" src="<?php echo base_url();?>main_img/f1.png" width="200px" height="200px"  class="over-img"></a>
												<div class="alertol alert-success">
												<?php 
													
												$album_length = strlen($display['album_name']); 
													
													 if(strlen($album_length <= 20))
															echo $d = substr($display['album_name'],0,20);
													 else{
															echo $d = substr($display['album_name'],0,20)."...";
													 }
			...
			<div class="modal-body">
					<div class="row">
						<div class="col-md-12">
							...
							<input type="hidden" name="location" value="<?php echo $abbr_loaction; ?>" required?>
						</div>
