			...
			<div class="col-md-12">
				<div class="widget" style="border-radius: 3px;">
					<header class="widget-header">
						...
						<a href="<?php echo base_url('egaze/reports') ."?d=".$date_now."&office=".$office_now."&csv=yes"; ?>" class="btn btn-success btn-sm" style="padding: 1px 6px;margin-left:5px"><i class="fa fa-download"></i> Download Report</a>
						</h4>
					</header>
							...
							<table class="egazetable table m-0">
								<thead>
									<tr>
										...
										<th scope="col" style="text-align:center;" width="16%"> Unknown Apps %</th>
									</tr>
								</thead>
								<tbody>
								...
								<?php foreach($activities as $tokenm){ 
									...
									$totalproductive = $tokenm['productiveapps'];
									$totalunproductive = $tokenm['unproductiveapps'];
									$totalunknown = $tokenm['unknownapps'];
										...
										<th scope="row" style="padding: 10px 15px!important;">
											<div class="media">
												...
												<div class="media-body">
													<p class="mb-0">
													<a href="<?php echo base_url('egaze/individual?uid='.$tokenm['user_id']) ?>">
