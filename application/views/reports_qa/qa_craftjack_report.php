						  ...
						  <?php echo form_open('',array('method' => 'get')) ?>
							...
							<div class="col-md-3" style='margin-top:2px;'>
								<div class="form-group">
									...
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>reports_qa/qa_craftjack_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
