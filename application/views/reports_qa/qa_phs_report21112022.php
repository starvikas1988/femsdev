			...
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header">
								...
								<h4 class="widget-title">Premier Health Solution Report</h4>
							</header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('reports_qa/qa_phs_report'); ?>">
							...
							<div class="col-md-3"> 
								<div class="form-group">
									...
									<select class="form-control" name="campaign" required>
										...
										<option <?php echo $campaign=='phs'?"selected":""; ?> value="phs">PHS</option>
										<option <?php echo $campaign=='phs_chat'?"selected":""; ?> value="phs_chat">PHS Chat</option>
										<option <?php echo $campaign=='phs_email'?"selected":""; ?> value="phs_email">PHS Email</option>
										<option <?php echo $campaign=='phs_chat_v2'?"selected":""; ?> value="phs_chat_v2">PHS Chat Version 2</option>
										<option <?php echo $campaign=='phs_email_v2'?"selected":""; ?> value="phs_email_v2">PHS Email Version 2</option>
										<option <?php echo $campaign=='phs_voice_v2'?"selected":""; ?> value="phs_voice_v2">PHS Voice Version 2</option>
									</select>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-2" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>reports_qa/qa_phs_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
							<?php if($download_link!=""){ ?>
								<div style='float:right; margin-top:26px' class="col-md-6">
