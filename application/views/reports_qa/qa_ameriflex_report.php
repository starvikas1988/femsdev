			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('reports_qa/qa_ameriflex_report'); ?>">	
						...
						<div class="row">
							<div class="col-md-1">
								<div class="form-group" style='margin-top:10px'>
									<button class="btn btn-primary esal-effect" a href="<?php echo base_url()?>reports_qa/qa_ameriflex_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
