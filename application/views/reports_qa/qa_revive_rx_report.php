		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">Revive Rx</h4></header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_revive_rx/qa_revive_rx_report'); ?>">	
						...
						<div class="col-md-3">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" id="" name="campaign" required>
											...
											<option <?php echo $campaign=='revive_rx'?"selected":""; ?> value="revive_rx">Revive Rx</option>
											<option <?php echo $campaign=='revive_rx_new'?"selected":""; ?> value="revive_rx_new">Revive Rx New</option>
											<option <?php echo $campaign=='revive_rx_inbound'?"selected":""; ?> value="revive_rx_inbound">Revive Rx Inbound</option>
										</select>
								</div>
							</div> 
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary blains-effect" a href="<?php echo base_url()?>reports_qa/qa_revive_rx_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									foreach($qa_revive_rx_list as $row){ ?>
									<tr>
										<td><?php echo $i++; ?></td>
