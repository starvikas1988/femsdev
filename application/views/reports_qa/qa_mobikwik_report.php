		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">QA Mobikwik Report</h4></header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('reports_qa/qa_mobikwik_report'); ?>">	
						  <?php echo form_open('',array('method' => 'get')) ?>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>Select Mobikwik Report</label>
									<select class="form-control" name="campaign" required>
										<option value=''>Select</option>
										<option <?php echo $campaign=='mobikwik'?"selected":""; ?> value="mobikwik">Mobikwik</option>
										<option <?php echo $campaign=='mobikwikemail'?"selected":""; ?> value="mobikwikemail">Mobikwik [Email]</option>
									</select>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>reports_qa/qa_mobikwik_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									$desig = '';
									foreach($qa_mobikwik_list as $row){ ?>
										<?php 
