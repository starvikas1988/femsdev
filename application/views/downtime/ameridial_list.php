							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="form-control" name="search_office_id" id="search_office_id" >
											<?php
											...
											<?php foreach($location_list as $loc): ?>
												...
												$sCss="";
												if($loc['abbr']==$s_office_id) $sCss="selected";
						...
						<div class="table-responsive">
							<table style="margin-top: 10px;" id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tr>
									...
									<td>
									<?php if(!empty($token['approved_by_name'])){ ?>
									<span class='text-success'><b>Approved <br/>(<?php echo $token['approved_by_name']; ?>)</span>									
									<?php } else { ?>
									...
									<a title="Approve Now" href="<?php echo base_url()?>downtime/my_ameridial_list_approve/<?php echo $token['id']; ?>" onclick="return confirm('Do you want to approve this ticket ?')" class="btn btn-success btn-xs" style="font-size:12px"><i class="fa fa-check"></i></a>
									<?php } ?>
