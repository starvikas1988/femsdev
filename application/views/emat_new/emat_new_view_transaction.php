					 ...
					 <div class="row" >
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="crm_id" placeholder="" value="<?php echo $crm_details['trans_ticket_id']; ?>"  readonly>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										<label>Flight Id</label>
										<input type="text" class="form-control"  value="<?php echo $crm_details['trans_flight_id']; ?>"  readonly>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
										<label>Date of Flight</label>
										<input type="text" class="form-control" id="crm_id" placeholder="" value="<?php echo date('d M, Y', strtotime($crm_details['trans_flight_date'])); ?>"  readonly>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="crm_id" placeholder="" value="<?php echo $trns_details[0]['action_taken']; ?>"  readonly>
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label>Pending Items</label>
										<input type="text" class="form-control" id="crm_id" placeholder="" value="<?php echo $trns_details[0]['pending_items']; ?>"  readonly>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<label>Remarks</label>
										<input type="text" class="form-control" id="crm_id" placeholder="" value="<?php echo $crm_details['remarks']; ?>"  readonly>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
