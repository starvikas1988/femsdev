							...
							<div class="row" id="formInfoJurysInn" style="display:none">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<input type="date" class="form-control" id="flight_date" name="flight_date" value="<?php echo $flight_date; ?>" min="<?= date('Y-m-d') ?>" required>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="form-group">
										...
										<select class="form-control" name="outbond_call" autocomplete="off" placeholder="Dispostion List for Resolved" required>
