...
<body class="simple-page">
	...
	<div class="login-section">
		...
		<div class="main-box">
		    ...
		    <img src="<?php echo base_url(); ?>assets/home_bgimages/fusion-original-transparent.png?<?php echo time(); ?>" alt="fusion-logo">
		    	</div>
		  	...
		  	<div class="form-cont"> 
			    ...
			    <div class="form form-signin">
				    ...
				    <?php 
						echo form_open(base_url()."fakefusion/login");
					?>
					    ...
					    <div class="form-group">
						  ...
						  <input id="sign-in-username" type="text"  name="omuid" required <?php echo $isdisabled;?> />
