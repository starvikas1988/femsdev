			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('qa_gtn'); ?>">
							<div class="row">
								<div class="col-md-2">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url()?>qa_gtn" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">GTN Technical Staffing</div>
									<?php if(is_access_qa_module()==true || get_login_type()=="client"){ 
									$gtn_technical_id=0; ?>
									<div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_gtn/add_edit_gtn/<?php echo $gtn_technical_id ?>">Add Audit</a>
									</div>	
									<?php } ?>
								</h4>
							</header>
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php $mpid=$row['id']; ?>
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_gtn/add_edit_gtn/<?php echo $mpid ?>" style="margin-left:5px; font-size:10px;">Edit/Review Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
