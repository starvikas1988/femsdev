			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('qa_gtn/agent_gtn_technical_feedback'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url()?>qa_gtn/agent_gtn_technical_feedback" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
				...
				<div class="widget">
					...
					<div class="row">
						<div class="col-md-12">
							<header class="widget-header">
								<div class="col-md-6">
									<h4 class="widget-title">GTN Technical Staffing</h4>
								</div>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>qa_gtn/agent_gtn_technical_rvw/<?php echo $mpid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
