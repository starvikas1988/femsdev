							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>Disposition:</td>
										<td colspan="4">
										<select class="form-control" name="data[Disposition1]" required>
												<option value="<?php echo $pre_booking['Disposition1'] ?>"><?php echo $pre_booking['Disposition1'] ?></option>
												<option value="">-Select-</option>
												<option value="Dropped">Dropped</option>
												<option value="Dead Lead">Dead Lead</option>
												<option value="Interested _others">Interested _others</option>
												...
												<option value="Lead Skip">Lead Skip</option>
												<option value="Not Connected">Not Connected</option>
												<option value="Not interested in visit">Not interested in visit</option>
												
												<option value="Visit Confirmed">Visit Confirmed</option>
												<option value="Visit Not Confirmed">Visit Not Confirmed</option>
												<option value="New booking done">New booking done</option>
												<option value="Visit slot rescheduled">Visit slot rescheduled</option>
												<option value="Need_Free_HD_Eligible">Need_Free_HD_Eligible</option>
												<!-- <option value="Visit_Confirmed_HTD">Visit_Confirmed_HTD</option> -->
									...
									<tr>
										...
										<td colspan="4">
										<select class="form-control" id="audit_type" name="data[Sub_Disposition]" required>
