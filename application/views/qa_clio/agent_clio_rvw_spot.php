							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>Modality</td>
										<td>
									        <select style="color:black;" class="form-control" name="data[modality]" disabled>
												<option value="">-Select-</option>
										...
										<td>
									        <select style="color:black;" class="form-control" name="data[lob]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points compliance" name="data[Referring_Doctor]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points compliance" name="data[Eligibility]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points compliance" name="data[Prescription]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points compliance" name="data[Orders]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[Account_Notes]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[Appointment_Accuracy]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[Screening_Questions]" disabled>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" id="" name="data[diagnosis_report]" disabled>
												<option value="">-Select-</option>
