                        ...
                        <div class="row">	
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control oldDatePick" name="search_from" id="search_from" value="<?php echo date('m/d/Y', strtotime($search_from)); ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>To Date</label>
                                    <input type="text" class="form-control oldDatePick" name="search_to" id="search_to" value="<?php echo date('m/d/Y', strtotime($search_to)); ?>" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
