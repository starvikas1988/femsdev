  ...
  <table id="default-datatable" class="table table-bordered mb-0 table table-striped skt-table" data-plugin="DataTable">  
	...
	?>	
      <tr>
		...
		<a class="btn btn-primary  btn-sm reassignDataList" c_idd ="<?php echo $client_id; ?>" sid="<?php echo $token['id']; ?>"><i class="fa fa-users"></i>Re-assign Agent</a>
		</td>
      </tr>
	<?php } ?>	
    </tbody>
...
<div class="modal fade" id="editModal_record" tabindex="-1" role="dialog" aria-labelledby="editModal_record" aria-hidden="true">
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
	  ...
	  <form id="assign_data_form" method="POST" action="<?php echo duns_url('assign_data_agent_submission'); ?>" enctype="multipart/form-data">
...
<div class="modal fade" id="editModal_reassing_record" tabindex="-1" role="dialog" aria-labelledby="editModal_record" aria-hidden="true">
  <div class="modal-dialog  modal-lg">
    <div class="modal-content">
	  ...
	  <form id="reassign_data_form" method="POST" action="<?php echo duns_url('reassign_data_agent_submission'); ?>" enctype="multipart/form-data">
	  	<div class="modal-scroll">
      <div class="modal-body">	
