	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				...
				<?php if(get_role_dir() != "agent" || get_user_fusion_id() == "FKOL011922"){ ?>
				...
				<li class="menu-item">
					<a href="<?php echo duns_url('quality_control'); ?>" class="menu-link">
						<span class="menu-icon"><i class="fa fa-snowflake-o" aria-hidden="true"></i></span>
