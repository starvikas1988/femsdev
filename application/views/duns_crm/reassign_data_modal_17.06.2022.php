	...
	<!--<div class="col-sm-6">
		...
		<div class="col-sm-6">
			...
			<select class="form-control" id="reassignList" name="assigned_to" required>
				<?php echo duns_dropdown_assigned_to($duns_assigned_clients_list, 'id', 'name', '1'); ?>
			</select>
		   </div>
		</div>
	</div>
		...
		<div class="col-sm-12">
			<div class="table-responsive" style="height:300px;">			
				...
				<table id="default-datatable" data-plugin="DataTable" class="table skt-table" cellspacing="0" width="100%" style="margin-bottom:0px;">
					<thead>
						<tr class="bg-info">
							<th class="text-center"><input type="checkbox" id="selectAllChekcbox" name="selectAllChekcbox" class="selectAllChekcbox" value="1"></th>
	...
	<div class="row">
		...
		<div class="col-sm-6">
		    ...
		    <input type="number" class="form-control" name="assign_record" min="1" max="<?php echo $records_assigned; ?>" value="" required>
		   </div>
		</div>
	</div>
