            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <ul>
                  ...
                  <li><b>@corp.fusionbposervices.com</b></li>
                </ul>
              </div>
              <form method="post">
...
<script>
      ...
      $(document).on('focusout','#email_s',function()
      {
        ...
        var validRegex = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@(fusionbposervices.com|corp.fusionbposervices.com|vitalsolutions.net|xplore-tech.com|omindtech.com|travelomind.com)$/;   
        if (!(email.toLowerCase().match(validRegex))) {  
            alert("Invalid email address");
            $('#email_s').val('');
            return false;
