								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td colspan="2"><input type="text" class="form-control" id="fusion_id" disabled value="<?php echo $greenspace_data['fusion_id'] ?>" readonly></td>
										...
										<tr>
											...
											<td colspan="2">
												<input type="text" class="form-control" name="data[L1]" value="<?php echo $greenspace_data['L1'] ?>" disabled>
											</td>
											<td>L2 Analysis:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[L2]" value="<?php echo $greenspace_data['L2'] ?>" disabled>
											</td>
										</tr>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point business" name="data[opening]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt1]" class="form-control" value="<?php echo $greenspace_data['cmt1'] ?>"></td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point business" name="data[decision_maker]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt2]" class="form-control" value="<?php echo $greenspace_data['cmt2'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point business" name="data[discovery_questions]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt3]" class="form-control" value="<?php echo $greenspace_data['cmt3'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point business" name="data[education]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt4]" class="form-control" value="<?php echo $greenspace_data['cmt4'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point business" name="data[plan_tariff]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt5]" class="form-control" value="<?php echo $greenspace_data['cmt5'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point business" name="data[appointment_setting]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt6]" class="form-control" value="<?php echo $greenspace_data['cmt6'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point compliance" id ="greenspaceAF1" name="data[correct_information]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt7]" class="form-control" value="<?php echo $greenspace_data['cmt7'] ?>"></td>
										...
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point compliance" id ="greenspaceAF2" name="data[sales_authorization]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt8]" class="form-control" value="<?php echo $greenspace_data['cmt8'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Complaince</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[sound_energetic]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt9]" class="form-control" value="<?php echo $greenspace_data['cmt9'] ?>"></td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[communication]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt10]" class="form-control" value="<?php echo $greenspace_data['cmt10'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[rapport_building]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt11]" class="form-control" value="<?php echo $greenspace_data['cmt11'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[hold_verbiage]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt12]" class="form-control" value="<?php echo $greenspace_data['cmt12'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[sales_summary]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt13]" class="form-control" value="<?php echo $greenspace_data['cmt13'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[process_knowledge]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt14]" class="form-control" value="<?php echo $greenspace_data['cmt14'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[downtime_installation]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt15]" class="form-control" value="<?php echo $greenspace_data['cmt15'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_greenspace_point customer" name="data[closing]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt16]" class="form-control" value="<?php echo $greenspace_data['cmt16'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<tr>
											<td>Call Summary:</td>
											<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $greenspace_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $greenspace_data['feedback'] ?></textarea></td>
										</tr>

										<?php if($greenspace_data['attach_file']!=''){ ?>
											...
											<?php $attach_file = explode(",",$greenspace_data['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_att/greenspace/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_att/greenspace/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $greenspace_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $greenspace_data['client_rvw_note'] ?></td>
									</tr>
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $greenspace_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $greenspace_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $greenspace_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($greenspace_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($greenspace_data['agent_rvw_note']==''){ ?>
