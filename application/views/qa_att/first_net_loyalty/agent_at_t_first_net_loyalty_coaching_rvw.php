							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="12" id="theader" style="font-size:30px">AT&T 5 Step Coaching Agent Form 
									...
									<tr>
										...
										<td colspan='2'>
											<select class="form-control" style="text-align:center" id="process_client" name="data[process_id]" disabled>
												...
												<option value="<?php echo $auditData['process_id'] ?>" selected><?php echo $auditData['process_name'] ?></option>
									...
									<tr>
										...
										<td colspan='2'><input type="text" readonly class="form-control" id="fusion_id" name="data[employee_id]" disabled value="<?php echo $auditData['fusion_id'] ?>"></td>
									...
									<tr  style="height:25px; font-weight:bold">
										...
										<tr>
											<td colspan="1">QA:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[mtd_qa]" value="<?php echo $auditData['mtd_qa'] ?>"></td>

											<td colspan="2">Tcrift:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[mtd_tcrift]" value="<?php echo $auditData['mtd_tcrift'] ?>"></td>

											<td colspan="2">AHT:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[mtd_aht]" value="<?php echo $auditData['mtd_aht'] ?>"></td>
										</tr>

										<tr>
											<td colspan="1">Attendance :</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[mtd_attendance]" value="<?php echo $auditData['mtd_attendance'] ?>"></td>

											<td colspan="2">Saves:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[mtd_saves]" value="<?php echo $auditData['mtd_saves'] ?>"></td>

											<td colspan="2">Compliance:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[mtd_compliance]" value="<?php echo $auditData['mtd_compliance'] ?>"></td>
										...
										<tr>
											<td colspan="1">QA:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[wtd_qa]" value="<?php echo $auditData['wtd_qa'] ?>"></td>

											<td colspan="2">Tcrift:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[wtd_tcrift]" value="<?php echo $auditData['wtd_tcrift'] ?>"></td>

											<td colspan="2">AHT:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[wtd_aht]" value="<?php echo $auditData['wtd_aht'] ?>"></td>
										</tr>
												
										<tr>
											<td colspan="1">Attendance :</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[wtd_attendance]" value="<?php echo $auditData['wtd_attendance'] ?>"></td>

											<td colspan="2">Saves:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[wtd_saves]" value="<?php echo $auditData['wtd_saves'] ?>"></td>

											<td colspan="2">Compliance:</td>
											<td colspan="2"><input type="text" class="form-control" disabled name="data[wtd_compliance]" value="<?php echo $auditData['wtd_compliance'] ?>" ></td>
									...
									<tr  style="height:25px; font-weight:bold">
										...
										<tr>		
											<td colspan='12'>
												<textarea class="form-control" disabled name="data[area_of_strength]"><?php echo $auditData['area_of_strength'] ?></textarea>
											</td>
										</tr>
										...
										<tr colspan='12'>
											...
											<td colspan='6'>
												<textarea class="form-control" disabled name="data[improve_behavior]"><?php echo $auditData['improve_behavior'] ?></textarea>
											</td>
											</tr>
										<tr colspan='12'>
											...
											<td colspan='6'>
												<textarea class="form-control" disabled name="data[incorporate_behavior]"><?php echo $auditData['incorporate_behavior'] ?></textarea>
											</td>
											</tr>
										<tr colspan='12'>
											...
											<td colspan='6'>
												<textarea class="form-control" disabled name="data[fulfilling_behavior]"><?php echo $auditData['fulfilling_behavior'] ?></textarea>
											</td>
										...
										<tr  style="height:25px; font-weight:bold">
											...
											<td colspan='6'>
												<input type="text" class="form-control" disabled name="data[validation_comm1]" value="<?php echo $auditData['validation_comm1'] ?>">
											</td>
										...
										<tr  style="height:25px; font-weight:bold">
											...
											<td colspan='6'><input type="text" class="form-control" disabled name="data[validation_comm2]" value="<?php echo $auditData['validation_comm2'] ?>"></td>
										</tr>
										<tr  style="height:25px; font-weight:bold">
											...
											<td colspan='6'><input type="text" class="form-control" disabled name="data[validation_comm3]" value="<?php echo $auditData['validation_comm3'] ?>"></td>
										</tr>
										<tr  style="height:25px; font-weight:bold">
											...
											<td colspan='4'><input type="text" class="form-control" disabled name="data[validation_comm4]" value="<?php echo $auditData['validation_comm4'] ?>"></td>
										</tr>
										...
										<tr  style="height:25px; font-weight:bold">
											...
											<td colspan='6'><input type="text" class="form-control" disabled name="data[agent_commitents]" value="<?php echo $auditData['agent_commitents'] ?>"></td>
										...
										if($auditData['follow_up_active_listening']!=''){
											?>
											    ...
											    <tr class="">
															...
															<td colspan="2"><input type="text" class="form-control" id="follow_up_active_listening" disabled name="data[follow_up_active_listening]" value="<?php echo $auditData['follow_up_active_listening'] ?>"></td>

															<td colspan="2">When - Date & Time:</td>
															<td colspan="2">
																<input type="text" class="form-control" id="call_date_time" disabled name="call_date"  onkeydown="return false;" value="<?php echo mysqlDt2mmddyy($auditData['follow_up_date']); ?>">
															</td>

															<td colspan="2">How:</td>
															<td colspan="2"><input type="text" class="form-control" id="follow_up_how" disabled name="data[follow_up_how]" value="<?php echo $auditData['follow_up_how'] ?>"></td>
														</tr>
													 ...
													 <tr class="">
													 	<td colspan="4">What was the outcome after the follow up inspection? Did we hear the desired behaviors based on the actions/commitments provided by agent in the last coaching session on the phone?</td>
															<td colspan="8">
																<textarea class="form-control" id="follow_up_result" disabled name="data[follow_up_result]"><?php echo $auditData['follow_up_result'] ?></textarea>
															</td>
													 </tr>
													 <tr class="">
													  ...
													  <tr class=""  id='close_gap'>
													 	<td colspan="4">If failed, please also outline what are the next steps to close the gap?</td>
															<td colspan="8">
																<textarea class="form-control" disabled name="data[close_gap]"><?php echo $auditData['close_gap'] ?></textarea>
															</td>
													 </tr>
													 <tr class="">
															<td colspan=3>Employee Signature :</td>
...
<script src="<?php echo base_url() ?>application/views/qa_att/qa_coaching_js_v1.php"></script>
