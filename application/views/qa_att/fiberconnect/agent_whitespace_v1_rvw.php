								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td colspan="2"><input type="text" class="form-control" id="fusion_id" disabled value="<?php echo $whitespace_v1_data['fusion_id'] ?>" readonly></td>
										...
										<tr>
											...
											<td colspan="2">
												<input type="text" class="form-control" name="data[L1]" value="<?php echo $whitespace_v1_data['L1'] ?>" disabled>
											</td>
											<td>L2:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[L2]" value="<?php echo $whitespace_v1_data['L2'] ?>" disabled>
											</td>
										</tr>
										...
										<tr>
											...
											<td colspan=2>
												<input type="text" autocomplete="off" name="data[phone]" class="form-control" id="phone_no" value="<?php echo $whitespace_v1_data['phone']; ?>" disabled>
											</td>
										...
										<tr>
											...
											<td colspan="2">
												<input type="text" class="form-control" name="data[probable_cancel]" value="<?php echo $whitespace_v1_data['probable_cancel'] ?>" disabled>
											</td>
											<td>Cancel Reason:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[cancel_reason]" value="<?php echo $whitespace_v1_data['cancel_reason'] ?>" disabled>
											</td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF1" name="data[opening]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt1]" class="form-control" value="<?php echo $whitespace_v1_data['cmt1'] ?>"></td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point business" id="" name="data[greeting]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt2]" class="form-control" value="<?php echo $whitespace_v1_data['cmt2'] ?>"></td>
										...
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point business" id="" name="data[change_purpose]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt3]" class="form-control" value="<?php echo $whitespace_v1_data['cmt3'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF2" name="data[recorded_line]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt4]" class="form-control" value="<?php echo $whitespace_v1_data['cmt4'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[sound_energetic]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt5]" class="form-control" value="<?php echo $whitespace_v1_data['cmt5'] ?>"></td>
										...
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[communication]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt6]" class="form-control" value="<?php echo $whitespace_v1_data['cmt6'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[used_jargons]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt7]" class="form-control" value="<?php echo $whitespace_v1_data['cmt7'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[issue_with_pronunciation]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt8]" class="form-control" value="<?php echo $whitespace_v1_data['cmt8'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point business" id="" name="data[decision_maker]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt9]" class="form-control" value="<?php echo $whitespace_v1_data['cmt9'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>8</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point business" id="" name="data[features_benefits]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt10]" class="form-control" value="<?php echo $whitespace_v1_data['cmt10'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[rapport_building]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt11]" class="form-control" value="<?php echo $whitespace_v1_data['cmt11'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[hold_call]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt12]" class="form-control" value="<?php echo $whitespace_v1_data['cmt12'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[call_scenario]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt13]" class="form-control" value="<?php echo $whitespace_v1_data['cmt13'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>3</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[call_on_hold]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt14]" class="form-control" value="<?php echo $whitespace_v1_data['cmt14'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[hold_time_exceed_2_min]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt15]" class="form-control" value="<?php echo $whitespace_v1_data['cmt15'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>3</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[resume_call]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt16]" class="form-control" value="<?php echo $whitespace_v1_data['cmt16'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point business" id="" name="data[discovery_questions]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt17]" class="form-control" value="<?php echo $whitespace_v1_data['cmt17'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											<td>Plan & Tariff</td>
											...
											<td>7</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point business" id="" name="data[plan_tariff]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt18]" class="form-control" value="<?php echo $whitespace_v1_data['cmt18'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Business</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF3" name="data[appointment_setting]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt19]" class="form-control" value="<?php echo $whitespace_v1_data['cmt19'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[process_knowledge]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt20]" class="form-control" value="<?php echo $whitespace_v1_data['cmt20'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF4" name="data[correct_information]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt21]" class="form-control" value="<?php echo $whitespace_v1_data['cmt21'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF5" name="data[verified_address]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt22]" class="form-control" value="<?php echo $whitespace_v1_data['cmt22'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF6" name="data[probed_special_services]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt23]" class="form-control" value="<?php echo $whitespace_v1_data['cmt23'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF7" name="data[notified_internet]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt24]" class="form-control" value="<?php echo $whitespace_v1_data['cmt24'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>9</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF8" name="data[confirmed_business_installation]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt25]" class="form-control" value="<?php echo $whitespace_v1_data['cmt25'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[additional_assistance]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt26]" class="form-control" value="<?php echo $whitespace_v1_data['cmt26'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point compliance" id="whitespace_v1AF9" name="data[sales_authorization]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt27]" class="form-control" value="<?php echo $whitespace_v1_data['cmt27'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Compliance</td>
										</tr>
										<tr>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[further_assistance]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt28]" class="form-control" value="<?php echo $whitespace_v1_data['cmt28'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
										<tr>
											<td>Closing</td>
											...
											<td>5</td>
											<td>
												<select class="form-control fiber_connect_whitespace_v1_point customer" id="" name="data[closing]" disabled>
											...
											<td colspan=2><input type="text" disabled name="data[cmt29]" class="form-control" value="<?php echo $whitespace_v1_data['cmt29'] ?>"></td>
											<td style="font-weight:bold; background-color:#D7BDE2">Customer</td>
										</tr>
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<tr>
											<td>Call Summary:</td>
											<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $whitespace_v1_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $whitespace_v1_data['feedback'] ?></textarea></td>
										</tr>
										<?php if($whitespace_v1_data['attach_file']!=''){ ?>
											...
											<?php $attach_file = explode(",",$whitespace_v1_data['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_att/whitespace_v1/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_att/whitespace_v1/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $whitespace_v1_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $whitespace_v1_data['client_rvw_note'] ?></td>
									</tr>
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $whitespace_v1_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $whitespace_v1_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $whitespace_v1_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($whitespace_v1_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($whitespace_v1_data['agent_rvw_note']==''){ ?>
