					...
					<div class="widget-body">
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr>
										<td colspan="8" id="theader" style="font-size:40px">AT&T Audit Sheet</td>
									...
									<tr>
										...
										<td>Call Date:</td>
										<td colspan="2"><input type="text" class="form-control" id="call_date" name="call_date" value="<?php echo $clDate_val; ?>" disabled ></td>
									</tr>
									<tr>
										<td>Agent:</td>
										<td disabled>
										...
										<td>Employee ID:</td>
										<td><input type="text" readonly class="form-control" id="fusion_id" name="data[employee_id]" value="<?php echo $att['fusion_id'] ?>" disabled></td>
										<td>L1 Supervisor:</td>
										<td colspan="2">
									...
									<tr>
										<td>Type of Call:</td>
                                        <td>
                                        	<input type="text" class="form-control" value="<?php echo $att['call_type'] ?>" required disabled></td>

										</td>
										<!-- removed by sourav -->

										<!-- <td>Improvement Key:</td>
										<td><select class="form-control" name="data[improvement_key]" disabled>
										...
										<td><select class="form-control" name="data[previous_opportunity]" disabled>
									...
									<tr>
										<td>Phone Number:</td>
										<td><input type="number" class="form-control" id="phone_number" name="data[phone_number]" value="<?php echo $att['phone_number'] ?>" disabled></td>
										<td>Call Duration:</td>
										<td><input type="text" class="form-control" id="call_duration" name="data[call_duration]" value="<?php echo $att['call_duration'] ?>" disabled></td>
										<td>Call ID:</td>
										<td><input type="text" class="form-control" name="data[call_record_id]" value="<?php echo $att['call_record_id'] ?>" disabled></td>
									</tr>
									<tr>
										<td>ATTUID:</td>
										<td><input type="text" class="form-control" name="data[attuid]" value="<?php echo $att['attuid'] ?>" disabled></td>
										
										<!-- removed by sourav -->
										<!-- <td>Register Number:</td>
										<td><input type="text" class="form-control" name="data[register_no]" value="<?php echo $att['register_no'] ?>" disabled></td> -->
										<!-- removed by sourav -->
										...
										<td>
											...
											<select class="form-control" name="data[lob]" disabled>
												...
												<option <?php echo $att['lob']=='BMC'?"selected":""; ?> value="BMC">BMC</option>
									...
									<tr>
										...
										<td>
											<select class="form-control" name="data[first_call]" disabled>
										...
										<td>Fiber Offer:</td>
										<td><input type="text" class="form-control" name="data[fiber_offer]" value="<?php echo $att['fiber_offer'] ?>" disabled></td>
									</tr>
									<tr>
										<td>Audit Type:</td>
										<td>
										...
										<td>
											<select class="form-control" id="customer_audit_type" name="data[customer_audit_type]" disabled>
									...
									<tr>
										<td>Violation </td>
										<td>
											<select class="form-control" id="violation" name="data[violation]" disabled>
												<option value="" selected disabled>-Select-</option>
										...
										<td>
											<select class="form-control" id="violation_type" name="data[violation_type]" disabled>
												<option value="" selected disabled>-Select-</option>
									...
									<tr>
										...
										<td><input type="text" readonly id="attOverall" name="data[overall_score]" class="form-control" style="font-weight:bold" value="<?php echo $att['overall_score'] ?>"></td>
									</tr>
									...
									<tr>
										<td rowspan=3>Commitment</td>
										<td rowspan=3>Greet</td>
										<td colspan=2>Warmly welcome</td>
										<td>4</td>
										<td>
											<select class="form-control att_point" name="data[warmly_welcome]" disabled>
												<option att_val=4 <?php echo $att['warmly_welcome']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=4 <?php echo $att['warmly_welcome']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[call_flow_utilization]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control att_point" name="data[make_it_personal]" disabled>
									...
									<tr>
										<td rowspan=6>Analytical Thinking</td>
										<td rowspan=6>Understand</td>
										<td colspan=2>Acknowledge</td>
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[acknowledge]" disabled>
												<option att_val=5 <?php echo $att['acknowledge']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=5 <?php echo $att['acknowledge']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[empathy]" disabled>
												<option att_val=5 <?php echo $att['empathy']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=5 <?php echo $att['empathy']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[reassurance]" disabled>
												<option att_val=5 <?php echo $att['reassurance']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=5 <?php echo $att['reassurance']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control att_point" name="data[ownership]" disabled>
									...
									<tr>
										...
										<td>6</td>
										<td>
											<select class="form-control att_point" name="data[cpni]" disabled>
									...
									<tr>
										...
										<td>6</td>
										<td>
											<select class="form-control att_point" name="data[cbr]" disabled>
									...
									<tr>
										<td rowspan=6>Results Delivery</td>
										<td rowspan=4>Recommend</td>
										<td colspan=2>Resources Utilization</td>
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[resources_utilization]" disabled>
												<option att_val=5 <?php echo $att['resources_utilization']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=5 <?php echo $att['resources_utilization']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control att_point" name="data[professional_language]" disabled>
												<option att_val=4 <?php echo $att['professional_language']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=4 <?php echo $att['professional_language']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control att_point" name="data[hold_dead_air]" disabled>
												<option att_val=4 <?php echo $att['hold_dead_air']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=4 <?php echo $att['hold_dead_air']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>12</td>
										<td>
											<select class="form-control att_point" name="data[effective_sales_offer]" disabled>
									...
									<!--<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control att_point" name="data[sales_compliance]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[fully_resolved]" disabled>
												<option att_val=5 <?php echo $att['fully_resolved']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=5 <?php echo $att['fully_resolved']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[transfer_procedure]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[recap]" disabled>
									...
									<tr>
										<td colspan=2>Next call prevention</td>
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[next_call_prevention]" disabled>
												<option att_val=5 <?php echo $att['next_call_prevention']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=5 <?php echo $att['next_call_prevention']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
												<option att_val=0 <?php echo $att['next_call_prevention']=='N/A'?"selected":""; ?> value="N/A">N/A</option>
											</select>
										</td>
									</tr>
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control att_point" name="data[self_service_option]" disabled>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control att_point" name="data[additional_assistance]" disabled>
												<option att_val=4 <?php echo $att['additional_assistance']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=4 <?php echo $att['additional_assistance']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control att_point" name="data[sincerely_thanks]" disabled>
												<option att_val=4 <?php echo $att['sincerely_thanks']=='Effective'?"selected":""; ?> value="Effective">Effective</option>
												<option att_val=4 <?php echo $att['sincerely_thanks']=='Not effective'?"selected":""; ?> value="Not effective">Not effective</option>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF1" name="data[authentication]" disabled>	
									...
									<tr>
										<td colspan=2>CPNI</td>
										<td>
											<select class="form-control attCompliance" id="attCompAF2" name="data[cpni_compliance]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF3" name="data[disabled_disclosures]" disabled>
												<option <?php echo $att['disabled_disclosures']=='No'?"selected":""; ?> value="No">No</option>
												<option <?php echo $att['disabled_disclosures']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF4" name="data[credit_check]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF5" name="data[documentation]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF6" name="data[account_permission]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF7" name="data[verbal_consent]" disabled>
									...
									<tr>
										<td colspan=2>Sales compliance </td>
										<td>
											<select class="form-control attCompliance" id="attCompAF8" name="data[compliance_sales]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF9" name="data[communication_customers]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF10" name="data[derogatory_references]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF11" name="data[discourteous]" disabled>
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF12" name="data[social_engagements]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF13" name="data[blind_transferred]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF14" name="data[intentional_transferring]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF15" name="data[inaccurate_information]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF16" name="data[intentioanlly_ignoring_customer]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF17" name="data[camping]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF18" name="data[compliance_hold_dead_air]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF19" name="data[refused_escalate]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF20" name="data[transfer_in_scope]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF21" name="data[unauthorized_access]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF22" name="data[agent_seen_retaining_collecting]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF23" name="data[att_customer_records]" disabled>	
									...
									<tr>
										...
										<td>
											<select class="form-control attCompliance" id="attCompAF24" name="data[misrepresent_misleading]" disabled>	
									...
									<tr>
										<td>Call Summary:</td>
										<td colspan="2"><textarea class="form-control" id="" name="data[call_summary]" disabled><?php echo $att['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan="2"><textarea class="form-control" id="" name="data[feedback]" disabled><?php echo $att['feedback'] ?></textarea></td>
									</tr>
												...
												<?php $attach_file = explode(",",$att['attach_file']);
												 foreach($attach_file as $mp){ ?>
													<audio controls='' style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_ltfs/<?php echo $mp; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_ltfs/<?php echo $mp; ?>" type="audio/mpeg">
													</audio> </br>
												 <?php } ?>
											</td>
										<?php }else{
									...
									<?php } ?>
                                     <form id="form_agent_user" method="POST" action="">
										<input type="hidden" name="att_id" class="form-control" value="<?php echo $att_id; ?>">
										...
										<tr>
											...
											<td colspan="2">
												<select class="form-control" id="" name="agnt_fd_acpt" required>
													<option value="">--Select--</option>
													<option <?php echo $att['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $att['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan="2"  style="font-size:16px">Review</td>
											<td colspan="4"><textarea class="form-control" name="note" required><?php echo $att['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($att['entry_date'],72) == true){ ?>
											<tr>
												<?php if($att['agent_rvw_note']==''){ ?>
