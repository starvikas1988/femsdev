							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>0,10</td>
										<td>
											<select class="form-control scanVal" data-id="compliance"  name="data[hipaa_phi]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt1]"><?php echo $scan_data['cmt1'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>0,5,10</td>
										<td>
											<select class="form-control scanVal" data-id="compliance"  name="data[call_recording]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt2]"><?php echo $scan_data['cmt2'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>0,10</td>
										<td>
											<select class="form-control scanVal" data-id="compliance"  name="data[accurate_information]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt3]"><?php echo $scan_data['cmt3'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>0,5,10</td>
										<td>
											<select class="form-control scanVal" data-id="compliance"  name="data[telephonic_agreement]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt4]"><?php echo $scan_data['cmt4'] ?></textarea></td>
									</tr>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[greeting]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt5]"><?php echo $scan_data['cmt5'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[probing]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt6]"><?php echo $scan_data['cmt6'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[critical_thinking]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt7]"><?php echo $scan_data['cmt7'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[resolution]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt8]"><?php echo $scan_data['cmt8'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[additional_assistance]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt9]"><?php echo $scan_data['cmt9'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[closing]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt10]"><?php echo $scan_data['cmt10'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[proper_category]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt11]"><?php echo $scan_data['cmt11'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[documentation]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt12]"><?php echo $scan_data['cmt12'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="call_flow"  name="data[technology_resources]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt13]"><?php echo $scan_data['cmt13'] ?></textarea></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="member_centric"  name="data[active_listening]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt14]"><?php echo $scan_data['cmt14'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="member_centric"  name="data[courtesy_emphaty]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt15]"><?php echo $scan_data['cmt15'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="member_centric"  name="data[proffesional_language]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt16]"><?php echo $scan_data['cmt16'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="member_centric"  name="data[dead_air]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt17]"><?php echo $scan_data['cmt17'] ?></textarea></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="member_centric"  name="data[make_simple]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt18]"><?php echo $scan_data['cmt18'] ?></textarea></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control scanVal" data-id="book_business"  name="data[briefcase_management]" required>
										...
										<td colspan="2"> <textarea class="form-control" name="data[cmt19]"><?php echo $scan_data['cmt19'] ?></textarea></td>
									</tr>
									<tr>
										<td>Call Summary:</td>
										<td colspan=2><textarea class="form-control"  name="data[call_summary]"><?php echo $scan_data['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan=2><textarea class="form-control"  name="data[feedback]"><?php echo $scan_data['feedback'] ?></textarea></td>
									</tr>
									<tr>
												...
												<?php $attach_file = explode(",",$scan_data['attach_file']);
												 foreach($attach_file as $mp){ ?>
													<audio controls='' style="background-color:#607F93"> 
													  <source src="<?php echo base_url(); ?>qa_files/qa_scan/<?php echo $mp; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_scan/<?php echo $mp; ?>" type="audio/mpeg">
													</audio> </br>
												 <?php } ?>
											</td>
										<?php }else{
									...
									<?php if($scan_id!=0){ ?>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td><td colspan=4><?php echo $scan_data['agent_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td><td colspan=4><?php echo $scan_data['mgnt_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td><td colspan=4><?php echo $scan_data['client_rvw_note'] ?></td></tr>
