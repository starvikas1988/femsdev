...
if($content_template=="home/home.php" || $content_template=="home/homecha.php" || $content_template=="home/homealm.php" || $content_template=="homev2.php" ){
...
///-------- LEAVE ------------------////
if(in_array(get_user_office_id(), array("ALB","KOS")) && $content_template=="leave/index.php") include_once 'jscripts/apply_leave_alb_kos_js.php';
...
if($content_template=="super/dashboard.php" || 
	$content_template=="training/training.php" ||
