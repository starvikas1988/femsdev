...
<h4><i class="fa fa-user"></i> <?php echo $parentdetails['fullname']; ?> - <?php echo $parentdetails['rolename']; ?></h4><br/>
...
<table id="default-datatable" data-plugin="DataTable" class="table skt-table" width="100%" cellspacing="0">
	...
	<?php if($sl == "0"){ ?>
	<tr>
	<td colspan="8" style="font-size:14px;font-weight:600">-- No Team Found --</td>
	</tr>
	<?php } ?>
	</tbody>
</table>
