			...
			<div class="col-12">
				<div class="widget">
					...
					<div class="widget-body">
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_agent_coaching'); ?>">
							<div class="row">
								<div class="col-md-2">
									<div class="form-group">
										<label>From Date (mm/dd/yyyy)</label>
										<input type="text" id="from_date" name="from_date" value="<?php echo mysql2mmddyy($from_date); ?>" class="form-control" autocomplete="off" readonly>
									</div>
								</div>  
								<div class="col-md-2"> 
									<div class="form-group">
										<label>To Date (mm/dd/yyyy)</label>
										<input type="text" id="to_date" name="to_date" value="<?php echo mysql2mmddyy($to_date); ?>" class="form-control" autocomplete="off" readonly>
									</div> 
								</div>
								<div class="col-md-2">
									<div class="form-group">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url()?>Qa_agent_coaching" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						</form>
					</div>
							...
							<header class="widget-header">
								<h4 class="widget-title">
									...
									<div class="pull-right">
										<a class="btn btn-primary waves-effect" href="<?php echo base_url(); ?>Qa_agent_coaching/add_feedback" title="Add Evaluation">Add Feedback</a>
									</div>	
								<?php } ?>
								</h4>
							</header>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1; 
										foreach($qa_agent_coaching_data as $row){
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										...
										<td title="<?php echo $row['agent_feedback']; ?>"><?php 
										$msg=strlen($row['agent_feedback']);
										echo ($msg>40)?(substr($row['agent_feedback'],0,40)."..."):($row['agent_feedback']);
										 ?></td>
										<td>
											<?php $mpid=$row['id']; ?>
											
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_agent_coaching/mgnt_agent_coaching_rvw/<?php echo $mpid ?>" title="Edit Evaluation" style="margin-left:5px; font-size:10px;">Edit</a>
										</td>
									</tr>
									<?php } ?>
								</tbody>
