...
if($location == "CHA"){
	...
	$gmt_calamount =  round($gross_pay - $conveyance);
}
	...
	<section id="pdf-converter" class="pdf-converter">
		<div style="width:800px;margin:0 auto;max-width:100%;">
			...
			<p style="font-size:14px;font-family: 'Roboto', sans-serif;	padding:0 0 15px 0;margin:0;line-height:25px;">
				...
				based on your annual performance you have been promoted to the <?php echo $role['name']; ?>-Role effective Date <?php echo $individual_user['affected_from']; ?>. Your salary is revised to CTC Rs. <?php echo $ctc; ?> p.m. w.e.f. <?php echo $individual_user['affected_from']; ?><br>
