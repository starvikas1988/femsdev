<?php 
	...
	$singDtls = get_signature_details($office_id, $org_role, $rank, $brand, $individual_user['doj']);
		...
		<section id="pdf-converter" class="pdf-converter">
			<div style="width:800px;margin:0 auto;max-width:100%;">
				...
				<p style="font-size:14px;font-family: 'Roboto', sans-serif;	padding:0 0 15px 0;margin:0;line-height:25px;">
					...
					if($joining_bonus > 0) echo " Joining Bonus: Rs. ".number_format($joining_bonus)."(".getIndianCurrency($joining_bonus).")"; ?></span><br>
				<?php } ?>
