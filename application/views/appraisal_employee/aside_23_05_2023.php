	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
				<ul class="aside-menu aside-left-menu">
						...
						<?php 
						if(is_access_appraisal_module()==true ){
						?>
						
						<li class="menu-item">
							<a href="<?php echo base_url('appraisal_employee')?>" class="menu-link">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
								<span class="">Send Letter</span>
							</a>
						</li>

						<li class="menu-item">
							<a href="<?php echo base_url('appraisal_employee/appraised')?>" class="menu-link">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
								<span class="">Appraisals/Revision</span>
							</a>
						</li>
						...
						<li class="menu-item">
							<a href="<?php echo base_url('appraisal_employee/your_appraisal_letter')?>" class="menu-link">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
								<span class="">Your Letter</span>
							</a>
						</li>
