    ...
    <div class="white_widget padding_3">
      <div class="body_widget">
        <div class="row d_flex">
          <div class="col-sm-7">
            <h2 class="avail_title_heading">Master Entry for User Assets Declined Reason</h2>
          </div>
          <div class="col-sm-5">
        ...
        <div class="table_scroll_new leave_table common_table_widget">
          <table id="example" class="table table-bordered table-striped">
            ...
            <tbody>
              <?php
              $c = 1;
              foreach ($declied_list as $key => $value) {
              ?>
                <tr>
                  <td><?= $c ?></td>
                  <td><?= $value['name'] ?></td>
                  ...
                  <td class="edit_assets">
                    ...
                    <?php if ($value['is_active'] == 1) : ?>
                      <a href="<?= base_url() ?>dfr_it_assets/assets_user_assign_decline_mst/disable/<?= $value['id'] ?>" class="btn btn no_padding btn_left" title="Deactive" onclick="return confirm('Make sure, Are you Deactive it?');"><img src="<?php echo base_url(); ?>assets_home_v3/images/deactive_user.svg" alt=""></a>
                    <?php else : ?>
                      <a href="<?= base_url() ?>dfr_it_assets/assets_user_assign_decline_mst/enable/<?= $value['id'] ?>" class="btn btn no_padding btn_left" title="Active" onclick="return confirm('Make sure, Are you Active it?');"><img src="<?php echo base_url(); ?>assets_home_v3/images/active_user.svg" alt=""></a>
                    <?php endif; ?>
                  </td>
                </tr>
              <?php $c++;
  ...
  <div class="modal-dialog modal-sm small_modal_new">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Add Declines Reason</h4>
      </div>
      <form action="<?= base_url() ?>dfr_it_assets/assets_user_assign_decline_mst/add" method="post">
        <div class="modal-body">
          <div class="row">
            <div class="col-sm-12">
              <div class="form-group">
                <label>Enter Name <span class="red_bg">*</span></label>
                <input type="text" oninput="this.value = this.value.toUpperCase()" required name="add_declined" class="form-control" placeholder="Enter Name">
              </div>
            </div>
          </div>
        </div>
...
<div class="modal fade in" id="update_assets_add_assets" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg small_modal_new">
    <div class="modal-content">
      <form id="chnage_assets_add_assets_user_declined" action="" data-toggle="validator" method="POST" novalidate="true">
        <div class="modal-header">
          <button type="button" class="close close_new" data-dismiss="modal" aria-label="Close"></button>
          <h4 class="modal-title" id="myModalLabel">Change Name (<spna class="rename"></spna>)</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="assets_name" oninput="this.value = this.value.toUpperCase()" required name="add_declined" class="form-control" placeholder="Enter Name">
                </div>
              </div>
            </div>
          </div>
