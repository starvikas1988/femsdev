...
<style>
    ...
    .new-table table.dataTable thead>tr>th.sorting_asc,
            ...
            <div class="common_top">
                <div class="chart_area">
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="widget">
                                <div class="widget-body caption_main">
                            ...
                            <table id="datatablesSimple" class="table table-striped new-list">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th>Remarks</th>
                                        <th>Status</th>
                                        <th style="width: 120px;display: block;padding-top: 12px;border-bottom: 2px solid #4650dd;padding-bottom: 12px;">Action</th>
                                    </tr>
                                </tfoot>
                                <tbody>
                                    <?php foreach ($result_data as $key => $value) {
                                        ...
                                        if ($value['status'] == 2) {
                                            ...
                                            if ($value['is_user_acknowledge'] == 1) {
                                                ...
                                                $ack = '<span style="color:red">Pending</span>';
                                            }
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php if (it_assets_full_access() == true) { ?>
                                                    ...
                                                    <button title="Edit Stock Details" style="margin-top: 5px;" type="button" params="<?php echo $params2; ?>" class="btn btn-primary btn-sm edit_stock_entry"><i class="fa fa-pencil" aria-hidden="true"></i></button>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content" style="width: 900px;">
            <div class="modal-header bg-primary">
                ...
                <h4 class="modal_title">ENTER STOCK DETAILS</h4>
            </div>
...
<div class="modal fade" id="stock_details" role="dialog" tabindex="-1" role="dialog" aria-labelledby="addAprv" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal_title">VIEW ASSETS DETAILS</h4>
            </div>
    ...
    <div class="modal-dialog modal-md">
        <form id="update-stock-details-submit">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal_title">EDIT ASSETS DETAILS | <span id="stok_head"></span></h4>
                </div>
                <div class="modal-body">
                    <div class="row">
...
<div class="modal fade" id="stock_status_update" role="dialog" tabindex="-1" role="dialog" aria-labelledby="addAprv" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal_title">STATUS UPDATE || REFERENCE ID: <span id="stock_reference_id"></span> || SERIAL NUMBER: <span id="stock_serial_num"></span></h4>
            </div>
            <div class="modal-body">
                <div class="filter-widget">
    ...
    <div class="modal-dialog modal-md">
        <form method="post" id="assets_assignment_jitbit_submit">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal_title">USER ASSETS ASSIGNMENT - JITBIT TICKET | <span id="assets_details"></span></h4>
                </div>
                <div class="modal-body">
                    <div class="filter-widget">
                        <div class="modal-card">
    ...
    <div class="modal-dialog modal-md">
        <form method="post" id="assets_assignment_jitbit_submit_non_inv">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal_title"><span style="font-weight: bold;">NON INVENTORY</span> ASSETS ASSIGNMENT USING JITBIT TICKET ID</h4>
                </div>
                <div class="modal-body">
                    <div class="filter-widget">
                        <div class="modal-card">
...
<div class="modal fade" id="stock_un-assigned_release" role="dialog" tabindex="-1" role="dialog" aria-labelledby="addAprv" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal_title"> <span style="font-weight: bold;">UN-ASSIGN/RELEASE ASSETS</span> | REFERENCE ID: <span id="stock_reference_id"></span> | SERIAL NUMBER: <span id="stock_serial_num"></span></h4>
            </div>
            <div class="modal-body">
                <div class="filter-widget">
...
<div class="modal modal-new-dash fade" id="assets_agreement_doc_upload" role="dialog" tabindex="-1" role="dialog" aria-labelledby="addAprv" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal_title"> <span style="font-weight: bold;">USER ASSET DOCUMENT DETAILS</span> | REFERENCE ID: <span id="stock_reference_id"></span> | SERIAL NUMBER: <span id="stock_serial_num"></span></h4>
            </div>
            <div class="modal-body">
                <div class="filter-widget">
                    <div class="modal-card">
    ...
    <div class="modal-dialog modal-md">
        <form method="post" id="assets_assignment_jitbit_submit">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal_title">USER BGV STATUS | <span id="assets_details"></span></h4>
                </div>
                <div class="modal-body">
                    <div class="filter-widget">
    ...
    <div class="modal-dialog modal-md">
        <form id="stock_floor_assign">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal_title">ASSIGN ASSETS TO FLOOR - JITBIT TICKET | <span id="assets_details"></span></h4>
                </div>
                <input type="hidden" id="stock_id" name="stock_id" value="">
                <div class="modal-body">
                    <div class="filter-widget">
