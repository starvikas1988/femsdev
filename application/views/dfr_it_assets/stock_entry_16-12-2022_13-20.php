                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mb-1 search-select">
                                                    ...
                                                    <select class="selectpicker search_stock_id" name="location_search" data-show-subtext="true" data-live-search="true">
                    ...
                    <table id="datatablesSimple" class="table table-striped new-list">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $value['raised_by_name'] ?></td>
                            ...
                            <?php if(it_assets_full_access()==true || get_dept_folder() == "it"){ ?>
                                ...
                                <?php if ($value['status'] != 2) { ?>
                                    <button title="Status Update" style="margin-top: 5px;" type="button" params="<?php echo $params; ?>" class="btn btn-info btn-sm stock_status_update"><i class="fa fa-check-square" aria-hidden="true"></i></button>
                                <?php } ?>
                                ...
                                if ($value['status']==1 || $value['status']==5) { ?>
                                    ...
                                    <button title="Assigned Asset Using `JITBIT ID`" style="margin-top: 5px;" type="button" params="<?php echo $params; ?>" class="btn btn-warning btn-sm" id="assign_stock_using_jitbit"><i class="fa fa-chevron-circle-up" aria-hidden="true"></i></button>
                                <?php }  if($value['status']==2) { ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="mb-1">
                            <label for="exampleInputEmail1" class="form-label">SELECT PHYSICAL LOCATIONS</label>
...
<div class="modal fade" id="assign_stock_using_jitbit_model" role="dialog" tabindex="-1" role="dialog" aria-labelledby="addAprv" aria-hidden="true">
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal_title">ASSETS ASSIGNMENT USING JITBIT TICKET ID | <span id="assets_details"></span></h4> </div>
            <div class="modal-body">
                <div class="filter-widget">
                        <div class="modal-card">
                            <div class="row">
