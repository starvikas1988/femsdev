    ...
    <div class="white_widget padding_3">
      <div class="body_widget">
        <div class="row d_flex">
          <div class="col-sm-6">
            <h2 class="avail_title_heading">Storage Device List</h2>
          </div>
          <div class="col-sm-6">
            <div class="right_side">
              <button type="button" class="btn btn_padding filter_btn" data-toggle="modal" data-target="#myModal">Add Storage</button>
            </div>
          </div>
        </div>
                ...
                <tr>
                  ...
                  <td class="edit_assets">
                    ...
                    <?php if ($value['is_active'] == 1) : ?>
                      <a href="<?= base_url() ?>dfr_it_assets/add_storage/disable/<?= $value['id'] ?>" class="btn btn no_padding btn_left" title="Deactive" onclick="return confirm('Make sure, Are you Deactive it?');"><img src="<?php echo base_url(); ?>assets_home_v3/images/deactive_user.svg" alt=""></a>
                    <?php else : ?>
                      <a href="<?= base_url() ?>dfr_it_assets/add_storage/enable/<?= $value['id'] ?>" class="btn btn no_padding btn_left" title="Active" onclick="return confirm('Make sure, Are you Active it?');"><img src="<?php echo base_url(); ?>assets_home_v3/images/active_user.svg" alt=""></a>
                    <?php endif; ?>
                  </td>
                </tr>
              <?php $c++;
  ...
  <div class="modal-dialog modal-sm small_modal_new">
    <div class="modal-content">
      <div class="modal-header">
        <form action="<?= base_url() ?>dfr_it_assets/add_storage/add" method="post">
          <button type="button" class="close close_new" data-dismiss="modal"></button>
          <h4 class="modal-title">Add Srorage Device Size</h4>
      </div>
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <label>Enter Srorage Size <span class="red_bg">*</span></label>
              <input type="text" minlength="2" maxlength="10" required name="add_assets_storage" class="form-control" placeholder="Enter Size">
            </div>
          </div>
        </div>
      </div>
...
<div class="modal fade in" id="update_assets_add_assets" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg small_modal_new">
    <div class="modal-content">
      <form id="chnage_assets_add_assets_storage" action="" data-toggle="validator" method="POST" novalidate="true">
        <div class="modal-header">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" minlength="2" maxlength="10" id="assets_name" value="" required name="add_assets_storage" class="form-control" placeholder="Enter Size">
                </div>
              </div>
            </div>
          </div>
