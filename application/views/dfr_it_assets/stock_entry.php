        ...
        <div class="wrap">
            ...
            <div class="top_1">
                <div class="white_widget padding_3">
                    ...
                    <div class="body_widget">
                        <form id="assset_stock_search" method="post">
                            <div class="row">
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        <label for="exampleInputEmail1" class="form-label ">Start Date</label>
                                        <input type="date" id="search_from_date" class="form-control search_stock_id" value="<?php if(isset($filter_data["start_date"][0])) echo $filter_data["start_date"][0] ?>" name="start_date[]">
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        <label for="exampleInputEmail1" class="form-label ">End Date</label>
                                        <input type="date" id="search_end_date" class="form-control search_stock_id" value="<?php if(isset($filter_data["end_date"][0])) echo $filter_data["end_date"][0] ?>" name="end_date[]">
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        <label for="exampleInputEmail1" class="form-label ">Location<span style="color: red;">*</span> </label>
                                        <select class="search_stock_id multiselect_options" name="location_search[]" required multiple>
                                            <?php foreach ($location_list as $key => $value) {
                                                $sel = "";
                                                if(isset($filter_data["location_search"])){
                                                    if(in_array($value['abbr'], $filter_data["location_search"])) $sel = "selected";
                                                }
                                            ?>
                                ...
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        ...
                                        <select class="search_stock_id multiselect_options" name="assets_search[]" multiple>
                                            <?php foreach ($assets_list_chart as $key => $value) {
                                                $sel = "";
                                                if(isset($filter_data["assets_search"])){
                                                    if(in_array($value['id'], $filter_data["assets_search"])) $sel = "selected";
                                                }
                                            ?>
                                ...
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        ...
                                        <select class="search_stock_id multiselect_options" name="brand_search[]" multiple>
                                            <?php foreach ($brand_list as $key => $value) {
                                                $sel = "";
                                                if(isset($filter_data["brand_search"])){
                                                    if(in_array($value['id'], $filter_data["brand_search"])) $sel = "selected";
                                                }
                                            ?>
                                                <option value="<?php echo $value['id']; ?>" <?php echo $sel; ?>><?php echo $value['name'] ?></option>
                                            <?php } ?>
                                ...
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        ...
                                        <select class="multiselect_options search_stock_id" name="status_search[]" multiple>
                                            <option value="1" <?php if(isset($filter_data["status_search"])) { if(in_array("1", $filter_data["status_search"])) echo "selected"; } ?>>Un-Assigned/Released</option>
                                            <option value="2" <?php if(isset($filter_data["status_search"])) { if(in_array("2", $filter_data["status_search"])) echo "selected"; } ?>>Assigned</option>
                                            <option value="8" <?php if(isset($filter_data["status_search"])) { if(in_array("8", $filter_data["status_search"])) echo "selected"; } ?>>Live</option>
                                            <option value="3" <?php if(isset($filter_data["status_search"])) { if(in_array("3", $filter_data["status_search"])) echo "selected"; } ?>>Scrap</option>
                                            <option value="4" <?php if(isset($filter_data["status_search"])) { if(in_array("4", $filter_data["status_search"])) echo "selected"; } ?>>Defect</option>
                                            <option value="5" <?php if(isset($filter_data["status_search"])) { if(in_array("5", $filter_data["status_search"])) echo "selected"; } ?>>Return(Un-Assigned/Released)</option>
                                            <option value="6" <?php if(isset($filter_data["status_search"])) { if(in_array("6", $filter_data["status_search"])) echo "selected"; } ?>>Stock</option>
                                            <option value="9" <?php if(isset($filter_data["status_search"])) { if(in_array("9", $filter_data["status_search"])) echo "selected"; } ?>>In-Stock(Check Overall Stock)</option>
                                            <option value="7" <?php if(isset($filter_data["status_search"])) { if(in_array("7", $filter_data["status_search"])) echo "selected"; } ?>>Misplaced/Lost</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        ...
                                        <select class="multiselect_options search_stock_id" name="type_search[]" multiple>
                                            <option value="1" <?php if(isset($filter_data["type_search"])) { if(in_array("1", $filter_data["type_search"])) echo "selected"; } ?>>New</option>
                                            <option value="2" <?php if(isset($filter_data["type_search"])) { if(in_array("2", $filter_data["type_search"])) echo "selected"; } ?>>Existing</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        ...
                                        <select id="stock-serial-number-search" class="multiselect_options" name="serial_number[]" multiple>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-4 form-group">
                                    <div class="filter-widget search-select">
                                        ...
                                        <select id="stock-reference-id-search" class="multiselect_options" name="reference_id_search[]" multiple>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="search-select">
                                        ...
                                        <input type="text" name="assigned_user_search[]" class="form-control" value="<?php if(isset($filter_data["assigned_user_search"][0])) echo $filter_data["assigned_user_search"][0] ?>" placeholder="Enter MWP ID">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="mb-0">
                                        ...
                                        <button id="stock_dashboard_search" type="submit" class="btn btn_padding filter_btn_blue save_common_btn mt-3">Search</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            ?>
                <div class="top_1">
                    <div class="white_widget padding_3 new-table">
                        ...
                        <div class="common_table_widget report_hirarchy_new table_body">
                            <table id="datatablesSimple" class="table table-bordered table-striped new-list">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Brand</th>
                                        <th>Model Number</th>
                                        <th>Remaining Days of Warranty Expiry</th>
                                        <th>Remaining Days of Next Inspection Date</th>
                                        <th>Remarks</th>
                                        <th>Status</th>
                                        <th data-priority="1" class="table_width">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <td>
                                                ...
                                                <?php  
                                                    ...
                                                    if ((it_assets_full_access() == true || get_dept_folder() == "it") && $value['is_user_acknowledge'] == 1) {
                                                        ...
                                                        $btn_arr[] = '<button title="Upload Agreement Document" type="button" params="'.$params.'" class="btn btn-xs  assets_upload_doc_agreement"><img src="'.base_url().'assets_home_v3/images/upload_icon.svg" alt=""></button>';
                                                    }
                                                    ...
                                                    if (it_assets_access() == true) {
                                                        ...
                                                        $btn_arr[] = '<button title="View Stock Details" type="button" params="'.$params.'" class="btn btn-xs view_stock_details"><img src="'.base_url().'assets_home_v3/images/view.svg" alt=""></button>';
                                                    }
                                                    ...
                                                    if (it_assets_full_access() == true) {
                                                        if ($value['status'] != 2 && $value['status'] != 8) {
                                                            ...
                                                            if(count($btn_arr) >= 2) $btn_arr[] = '<li><a href="javascript:void(0);" params="'.$params_new.'" class="stock_status_update"><div class="action_img_width"><img src="'.base_url().'assets_home_v3/images/check.svg" alt=""></div>Status Update</a></li>';

                                                            else $btn_arr[] = '<button title="Status Update" type="button" params="'.$params_new.'" class="btn btn-xs stock_status_update"><img src="'.base_url().'assets_home_v3/images/check.svg" alt=""></button>';
                                                        }
                                                        ...
                                                        if ($value['status'] == 1 || $value['status'] == 5) {
                                                            ...
                                                            if(count($btn_arr) >= 2) $btn_arr[] = '<li><a href="javascript:void(0);" params="'.$params.'" id="assign_stock_using_jitbit"><div class="action_img_width"><img src="'.base_url().'assets_home_v3/images/assets_jitbit.svg" alt=""></div>Assign Using JITBIT ID</a></li>';

                                                            else $btn_arr[] = '<button title="Assign Asset to user Using `JITBIT ID`" type="button" params="'.$params.'" class="btn btn-xs" id="assign_stock_using_jitbit"><img src="'.base_url().'assets_home_v3/images/assets_jitbit.svg" alt=""></button>';
                                                        }
                                                        ...
                                                        if ($value['status'] == 2) {
                                                            ...
                                                            if(count($btn_arr) >= 2) $btn_arr[] = '<li><a href="javascript:void(0);" params="'.$params.'" class="un_assigned_user_assets"><div class="action_img_width"><img src="'.base_url().'assets_home_v3/images/cancel_big.svg" alt=""></div>Un-Assign/Release</a></li>';

                                                            else $btn_arr[] = '<button title="Un-Assign/Release" type="button" params="'.$params.'" class="btn btn-xs un_assigned_user_assets"><img src="'.base_url().'assets_home_v3/images/cancel_big.svg" alt=""></button>';

                                                            //button: User BGV status ----

                                                            if(count($btn_arr) >= 2) $btn_arr[] = '<li><a href="javascript:void(0);" params="'.$params.'" user_id="'.$value['assign_user_id'].'" class="user_bgv_reports_status"><div class="action_img_width"><img src="'.base_url().'assets_home_v3/images/background_check_action_menu.svg" alt=""></div>User BGV Status</a></li>';

                                                            else $btn_arr[] = '<button title="User BGV Status" type="button" params="'.$params.'" user_id="'.$value['assign_user_id'].'" class="btn btn-xs user_bgv_reports_status"><img src="'.base_url().'assets_home_v3/images/background_check_action_menu.svg" alt=""></button>';
                                                        }
                                                        ...
                                                        if ($value['status'] != 2) {
                                                            ...
                                                            if(count($btn_arr) >= 2) $btn_arr[] = '<li><a href="javascript:void(0);" params="'.$params_new.'" class="assign_assets_to_floor"><div class="action_img_width"><img src="'.base_url().'assets_home_v3/images/floor_action.svg" alt=""></div>Assign to the floor</a></li>';

                                                            else $btn_arr[] = '<button title="Assign to the floor" type="button" params="'.$params_new.'" class="btn btn-xs assign_assets_to_floor" id="assign_assets_to_floor"><img src="'. base_url().'assets_home_v3/images/floor_action.svg" alt=""></button>';
                                                        }

                                                        //button: Assets Assigned to the floor (Live status update) ----

                                                        if(count($btn_arr) >= 2) $btn_arr[] = '<li><a href="javascript:void(0);" params="'.$params2.'" class="edit_stock_entry"><div class="action_img_width"><img src="'.base_url().'assets_home_v3/images/edit_icon.svg" alt=""></div>Edit Stock Details</a></li>';

                                                        else $btn_arr[] = '<button title="Edit Stock Details" type="button" params="'.$params2.'" class="btn btn-xs edit_stock_entry"><img src="'.base_url().'assets_home_v3/images/edit_icon.svg" alt=""></button>';
                                                    }
                                                ...
                                                <div class="dropdown action_dropdown d_inline">
                                                    ...
                                                    <ul id="list_dropdown" class="dropdown-menu right_action_column">
                ...
                if (res.bgv_status == true) {
                    if (res.user_data[0].is_modify == '1') {
                        var modified_details_crc = `
                                    <td>
                                        <a href="<?= base_url() ?>uploads/bgv_doc/${res.user_data[0].crc_doc_old}" target="_blank">
                                            <img src="<?php echo base_url(); ?>assets_home_v3/images/view.svg" alt="">
                                        </a>
                                    </td>
                                    <td>${res.user_data[0].modify_by}</td>
                                    <td>${res.user_data[0].modified_date}</td>
                                </div> 
                    `;
                        var modified_details_ad = `
                                    <td>
                                        <a href="<?= base_url() ?>uploads/bgv_doc/${res.user_data[0].address_verification_doc_old}" target="_blank">
                                            <img src="<?php echo base_url(); ?>assets_home_v3/images/view.svg" alt="">
                                        </a>
                                    </td>
                                    <td>${res.user_data[0].modify_by} </td>
                                    <td>${res.user_data[0].modified_date} </label></td>
                    `;
                    } else {
                        var modified_details_crc = "<td></td><td></td><td></td>";
                        var modified_details_ad = "<td></td><td></td><td></td>";
                    }
                    var bgv_details_crc = `
                                    <td>
                                        <a href="<?= base_url() ?>uploads/bgv_doc/${res.user_data[0].crc_doc}" target="_blank">
                                            <img src="<?php echo base_url(); ?>assets_home_v3/images/view.svg" alt="">
                                        </a>
                                    </td>
                                    <td>${res.user_data[0].upload_by}</td>
                                    <td>${res.user_data[0].crc_date} </label></td>

                                    ${modified_details_crc}`

                     var bgv_details_address = `<td>
                                        <a href="<?= base_url() ?>uploads/bgv_doc/${res.user_data[0].address_verification_doc}" target="_blank">
                                            <img src="<?php echo base_url(); ?>assets_home_v3/images/view.svg" alt="">
                                        </a>
                                    </td>
                                    <td> ${res.user_data[0].upload_by}</td>
                                    <td>${res.user_data[0].address_verification_date}</td>
                                 ${modified_details_ad}
                `;
                    $("#user_bgv_status_model .report_hirarchy_new").css("display", "block");
                    $("#user_bgv_status_model #user_bgv_div").css("display", "none");
                    $("#user_bgv_status_model #user_bgv_div_crc").html('<tr>'+bgv_details_crc+'</tr>');
                    $("#user_bgv_status_model #user_bgv_div_address").html('<tr>'+bgv_details_address+'</tr>');

                } else {
                    $("#user_bgv_status_model .report_hirarchy_new").css("display", "none");
                    $("#user_bgv_status_model #user_bgv_div").css("display", "block");
