	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				<li class="menu-item">
					<a href="<?php echo base_url()?>am/dashboard/1" class="menu-link">
				...
				<?php if(is_access_manage_client()){ ?>
				<li class="menu-item has-submenu">
					<a href="" class="menu-link submenu-toggle">
						<span class="menu-icon"><i class="zmdi zmdi-view-dashboard zmdi-hc-lg"></i></span>
					...
					<ul class="submenu">
						<li>
							<a  href="<?php echo base_url()?>users/manage_client">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
								<span class="">Manage</span>
							</a>
						</li>
						...
						<li>
							<a href="<?php echo base_url()?>users/add_client">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
								<span class="">Add</span>
							</a>
						</li>
				...
				<li class="menu-item has-submenu">
					...
					<ul class="submenu">
						...
						<li><a  href="<?php //echo base_url()?>evaluation/evaluate_list">Evaluate</a></li>
					</ul>
				</li>
				-->
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>user_history/history" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-view-dashboard zmdi-hc-lg"></i></span>
						<span class="">Migrate/Rejoin User (History)</span>
					</a>
				</li> 
				-->
