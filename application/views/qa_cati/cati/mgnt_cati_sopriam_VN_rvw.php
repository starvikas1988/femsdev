							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="9" id="theader" style="font-size:30px">Mgnt Sopriam VN Rvw<!-- <img src="<?php echo base_url(); ?>main_img/hra.png"> --></td>
										...
										<td colspan="6">
											<?php $attach_file = explode(",",$$dataDetails['attach_file']);
											 foreach($attach_file as $af){ ?>
												...
												<!-- <audio controls='' style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/<?=$page_name ?>/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/<?=$page_name ?>/<?php echo $af; ?>" type="audio/mpeg">
												</audio>  -->
											</br>
											 <?php } ?>
										</td>
