							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="9" id="theader" style="font-size:30px">Agent <?= $table?> Rvw<!-- <img src="<?php echo base_url(); ?>main_img/hra.png"> --></td>
									...
									<tr>
										...
										<td colspan="2"><input type="text" class="form-control"  name="data[UCID]" value="<?php echo $$dataDetails['UCID'] ?>" disabled></td> -->
										<td colspan="1">Contact Date:<span style="font-size:24px;color:red">*</span></td>
										...
										<td colspan="1">Contact Duration:<span style="font-size:24px;color:red">*</span></td>
									...
									<tr style="height:45px">
										...
										?>
									<tr>
										<td rowspan=6 class="eml1">TECHNIQUES DE COMMUNICATION</td>
										<td class="eml" colspan=6><?php echo $scoreParametername[$parameter_column_name++] ?></td>
										<td>											
											<select class="form-control points_epi" name="data[<?=$columname[$score_column_name++]?>]" disabled>
												<?php
									...
									<tr>
										<td rowspan=6 class="eml1">QUALITÉ DE DISCOURS ET DE CONTACT</td>
										<td class="eml" colspan=6><?php echo $scoreParametername[$parameter_column_name++] ?></td>
										<td>
											<select class="form-control points_epi"  name="data[<?=$columname[$score_column_name++]?>]" disabled>
												<?php
								   ...
								   <tr>
								   		<td rowspan=3 class="eml1">Gestion des procèdures</td>
										<td class="eml" colspan=6><?php echo $scoreParametername[$parameter_column_name++] ?></td>
										<td>
											<select class="form-control points_epi" name="data[<?=$columname[$score_column_name++]?>]" disabled>
												<?php
											...
											<?php $attach_file = explode(",",$$dataDetails['attach_file']);
											 foreach($attach_file as $af){ ?>
											 	...
											 	<audio controls='' style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_cati/<?=$page ?>/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_cati/<?=$page ?>/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
