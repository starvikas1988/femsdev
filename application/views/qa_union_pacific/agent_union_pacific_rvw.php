							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF">
										<td colspan="6" id="theader">Union Pacific Agent Form  </td>
									...
									<tr>
										...
										<td>
											<select class="form-control" id="agent_id" name="data[agent_id]" disabled>
												<?php 
												if($union_pacific_data['agent_id']!=''){
													?>
									...
									<tr>
										...
										<td><input type="text" class="form-control"  name="data[call_link]" value="<?php echo $union_pacific_data['call_link']; ?>" disabled></td>
										<td>Account:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control"  onkeyup="checkDecConsumer(this);" name="data[account]" value="<?php echo $union_pacific_data['account']; ?>" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF1" name="data[identify_himself]" disabled>
										...
										<td><input type="text" name="data[comm1]" class="form-control" disabled value="<?php echo $union_pacific_data['comm1'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF2" name="data[provide_quality_assurance]" disabled>
										...
										<td><input type="text" name="data[comm2]" class="form-control" disabled value="<?php echo $union_pacific_data['comm2'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[get_callers_name]" disabled>
										...
										<td><input type="text" name="data[comm3]" class="form-control" disabled value="<?php echo $union_pacific_data['comm3'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF3" name="data[purpose_communication]" disabled>
										...
										<td><input type="text" name="data[comm4]" class="form-control" disabled value="<?php echo $union_pacific_data['comm4'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[callback_permission]" disabled>
										...
										<td><input type="text" name="data[comm5]" class="form-control" disabled value="<?php echo $union_pacific_data['comm5'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[balance_due]" disabled>
										...
										<td><input type="text" name="data[comm6]" class="form-control" disabled value="<?php echo $union_pacific_data['comm6'] ?>"></td>
									</tr>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[intention_resolve]" disabled>
										...
										<td><input type="text" name="data[comm7]" class="form-control" disabled value="<?php echo $union_pacific_data['comm7'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[complete_information]" disabled>
										...
										<td><input type="text" name="data[comm8]" class="form-control" disabled value="<?php echo $union_pacific_data['comm8'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[previous_conversations]" disabled>
										...
										<td><input type="text" name="data[comm9]" class="form-control" disabled value="<?php echo $union_pacific_data['comm9'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[promise_pay]" disabled>
										...
										<td><input type="text" name="data[comm10]" class="form-control" disabled value="<?php echo $union_pacific_data['comm10'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF4" name="data[misrepresent_identity]" disabled>
										...
										<td><input type="text" name="data[comm11]" class="form-control" disabled value="<?php echo $union_pacific_data['comm11'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF5" name="data[imply_leagal_actions]" disabled>
										...
										<td><input type="text" name="data[comm12]" class="form-control" disabled value="<?php echo $union_pacific_data['comm12'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF6" name="data[nature_of_communication]" disabled>
										...
										<td><input type="text" name="data[comm13]" class="form-control" disabled value="<?php echo $union_pacific_data['comm13'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF7" name="data[contact_consumer]" disabled>
										...
										<td><input type="text" name="data[comm14]" class="form-control" disabled value="<?php echo $union_pacific_data['comm14'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF8" name="data[communicate_consumer]" disabled>
										...
										<td><input type="text" name="data[comm15]" class="form-control" disabled value="<?php echo $union_pacific_data['comm15'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF9" name="data[status_code]" disabled>
										...
										<td><input type="text" name="data[comm16]" class="form-control" disabled value="<?php echo $union_pacific_data['comm16'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF10" name="data[abusive_acts]" disabled>
										...
										<td><input type="text" name="data[comm17]" class="form-control" disabled value="<?php echo $union_pacific_data['comm17'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF11" name="data[false_credit_information]" disabled>
										...
										<td><input type="text" name="data[comm18]" class="form-control" disabled value="<?php echo $union_pacific_data['comm18'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF12" name="data[take_appropriate_action]" disabled>
										...
										<td><input type="text" name="data[comm19]" class="form-control" disabled value="<?php echo $union_pacific_data['comm19'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF13" name="data[violation_ECOA_policy]" disabled>
										...
										<td><input type="text" name="data[comm20]" class="form-control" disabled value="<?php echo $union_pacific_data['comm20'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[active_listening]" disabled>
										...
										<td><input type="text" name="data[comm21]" class="form-control" disabled value="<?php echo $union_pacific_data['comm21'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[overcome_objections]" disabled>
										...
										<td><input type="text" name="data[comm22]" class="form-control" disabled value="<?php echo $union_pacific_data['comm22'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[building_rapport]" disabled>
										...
										<td><input type="text" name="data[comm23]" class="form-control" disabled value="<?php echo $union_pacific_data['comm23'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										<td colspan=2>Did the collector use system appropriately?
										Examples: Appropriate usage of system to provide accurate information / to provide a breakdown of balance (as disabled)</td>
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[use_system_appropriately]" disabled>
										...
										<td><input type="text" name="data[comm24]" class="form-control" disabled value="<?php echo $union_pacific_data['comm24'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[empathy_statement]" disabled>
										...
										<td><input type="text" name="data[comm25]" class="form-control" disabled value="<?php echo $union_pacific_data['comm25'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[hung_up_RP]" disabled>
										...
										<td><input type="text" name="data[comm26]" class="form-control" disabled value="<?php echo $union_pacific_data['comm26'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[dead_air]" disabled>
										...
										<td><input type="text" name="data[comm27]" class="form-control" disabled value="<?php echo $union_pacific_data['comm27'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[pleasant_tone]" disabled>
										...
										<td><input type="text" name="data[comm28]" class="form-control" disabled value="<?php echo $union_pacific_data['comm28'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[summarize_call]" disabled>
										...
										<td><input type="text" name="data[comm29]" class="form-control" disabled value="<?php echo $union_pacific_data['comm29'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[provided_UP]" disabled>
										...
										<td><input type="text" name="data[comm30]" class="form-control" disabled value="<?php echo $union_pacific_data['comm30'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[follow_up]" disabled>
										...
										<td><input type="text" name="data[comm31]" class="form-control" disabled value="<?php echo $union_pacific_data['comm31'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>2.5</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[proper_greeting]" disabled>
										...
										<td><input type="text" name="data[comm32]" class="form-control" disabled value="<?php echo $union_pacific_data['comm32'] ?>"></td>
									</tr>
									<tr>
									...
									<tr>
										...
										Examples: All the important information happened during the conversation; Payment Promise information; Update information if changing the phone number; Update information if change staus is disabled. </td>
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF14" name="data[context_conversation]" disabled>
										...
										<td><input type="text" name="data[comm33]" class="form-control" disabled value="<?php echo $union_pacific_data['comm33'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										...
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="union_pacificAF15" name="data[remove_phone_no]" disabled>
										...
										<td><input type="text" name="data[comm34]" class="form-control" disabled value="<?php echo $union_pacific_data['comm34'] ?>"></td>
									</tr>
									<tr>
										<td></td>
										<td colspan=2>Escalate the account to a supervisor for handling, if appropriate? / If disabled, for further account handling escalate it to Union Pacific / LOUP.</td>
										<td>4</td>
										<td>
											<select class="form-control union_pacific_point" id="" name="data[escalate_account]" disabled>
										...
										<td><input type="text" name="data[comm35]" class="form-control" disabled value="<?php echo $union_pacific_data['comm35'] ?>"></td>
									</tr>

									<tr>
										<td>Observations:</td>
										<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $union_pacific_data['call_summary'] ?></textarea></td>
										<td>Area of opportunity:</td>
										<td colspan=2><textarea class="form-control" disabled name="data[feedback]"><?php echo $union_pacific_data['feedback'] ?></textarea></td>
									</tr>
											...
											<?php $attach_file = explode(",",$union_pacific_data['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/qa_union_pacific/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_union_pacific/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $union_pacific_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $union_pacific_data['client_rvw_note'] ?></td>
									</tr>
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $union_pacific_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $union_pacific_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $union_pacific_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($union_pacific_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($union_pacific_data['agent_rvw_note']==''){ ?>
