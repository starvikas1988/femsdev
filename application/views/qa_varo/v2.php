							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<!-- <select class="form-control" id="tl_id" name="data[tl_id]" readonly>
												<option value="<?php //echo $varo_rp['tl_id'] ?>"><?php //echo $varo_rp['tl_name'] ?></option>
												<option value="">--Select--</option>
												<?php //foreach($tlname as $tl): ?>
													<option value="<?php //echo $tl['id']; ?>"><?php //echo $tl['fname']." ".$tl['lname']; ?></option>
												<?php //endforeach; ?>	
											</select> -->
											<input type="text" class="form-control" id="tl_name"  value="<?php echo $varo_rp['tl_name'] ?>" readonly>
									...
									<tr>
										...
										<td><input id="call_control_score" type="hidden" name="" disabled=""></td>
									</tr>
									...
									<tr>
										...
										<td><input id="closing_score" type="hidden" name="" disabled=""></td>
									</tr>
									<tr>
