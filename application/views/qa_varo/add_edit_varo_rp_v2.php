					...
					<div class="widget-body">
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr>
										<td colspan="6" id="theader" style="font-size:40px">Varo RP V2</td>
									...
									<?php
										if($varo_rp_id==0){
											...
											//$go_live_date = mysql2mmddyy($varo_rp['go_live_date']);
										}
									?>
									<tr>
									...
									<tr>
										...
										<td>
											...
											<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $varo_rp['tl_id'] ?>" required>
										</td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control" id="" name="data[qa_type]" value="<?php echo $varo_rp['qa_type'] ?>" required ></td>

										<td>Call ID:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[call_id]" value="<?php echo $varo_rp['call_id'] ?>" required ></td>

										<td>Area of Opportunity:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[area_of_opportunity]" value="<?php echo $varo_rp['area_of_opportunity'] ?>" required ></td>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal1" name="data[identify_himself]" required>
												<option varo_rp_val=2.23 <?php echo $varo_rp['identify_himself']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option varo_rp_val=2.23 <?php echo $varo_rp['identify_himself']=='NA'?"selected":""; ?> value="NA">NA</option>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal2" name="data[provide_the_quality]" required>
												<option varo_rp_val=2.23 <?php echo $varo_rp['provide_the_quality']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option varo_rp_val=2.23 <?php echo $varo_rp['provide_the_quality']=='NA'?"selected":""; ?> value="NA">NA</option>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal3" name="data[state_varo_bank]" required>
												<option varo_rp_val=2.23 <?php echo $varo_rp['state_varo_bank']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option varo_rp_val=2.23 <?php echo $varo_rp['state_varo_bank']=='NA'?"selected":""; ?> value="NA">NA</option>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal4" name="data[speaking_to_right_party]" required>
												<option varo_rp_val=2.23 <?php echo $varo_rp['speaking_to_right_party']=='Yes'?"selected":""; ?> value="Yes">Yes</option>
												<option varo_rp_val=2.23 <?php echo $varo_rp['speaking_to_right_party']=='NA'?"selected":""; ?> value="NA">NA</option>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal5" name="data[demographics_information]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal6" name="data[mini_miranda_disclosure]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" id="o_fatal7" name="data[client_name_and_purpose]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" name="data[callback_permission_policy]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point opening_point" name="data[ask_for_balance_due]" required>
									...
									<tr>
										...
										<td colspan=3>Intention to resolve the account? / Ask for a reason for delinquency? / Ask appropriate probing questions as when it is required.</td>
										
										<td>
											<select class="form-control varo_rp_point effort_point" id="cmthScriptAF6" name="data[reason_for_delinquency]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point effort_point" id="cmthScriptAF7" name="data[ask_for_the_payment]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point effort_point" id="cmthScriptAF8" name="data[help_customer_reset_password]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point effort_point" id="cmthScriptAF9" name="data[followed_the_previous_conversation]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point effort_point" id="cmthScriptAF9" name="data[promise_to_pay_the_account]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point effort_point" id="cmthScriptAF10" name="data[convince_the_customer_for_payment]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal1" name="data[misrepresent_their_identity]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal2" name="data[did_discuss_or_imply_legal_action]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal3" name="data[false_representation]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal4" name="data[contact_the_consumer_unusual_time]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal5" name="data[communicate_consumar_at_work]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal6" name="data[consumer_represented_an_attorney]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal7" name="data[adhereto_the_cell_policy]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal8" name="data[adhere_to_third_party_policy]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal9" name="data[enter_status_code]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal10" name="data[constitute_unfair_statement]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal11" name="data[threaten_to_communicate_false_credit_information]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal12" name="data[handel_consumer_dispute_correctly]" required>
									...
									<tr>
										<td colspan=3 style="color:red">Did not Make the required statement on time barred accounts, indicating that the consumer cannot be pursued with legal action?</td>
										
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal13" name="data[statement_on_time_barred_accounts]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal14" name="data[adhere_to_fdcpa]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal15" name="data[violation_of_vrs_ecoa_policy]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point compliance_point" id="complianceFatal16" name="data[adhere_to_the_state_restrictions]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point call_control_point" id="cmthScriptAF1" name="data[demonstrate_active_listening]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point call_control_point" id="cmthScriptAF5" name="data[anticipate_and_overcome_objections]" required>
									...
									<tr>
										...
										Examples: Appropriate usage of system to provide accurate information / to provide a breakdown of past due balance (as required).</td>
										
										<td>
											<select class="form-control varo_rp_point call_control_point" id="cmthScriptAF3" name="data[collector_use_system_appropriately]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point call_control_point" id="cmthScriptAF5" name="data[transfer_call_varo_support]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point soft_skill_point" id="cmthScriptAF1" name="data[collector_get_connected_with_consumer]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point soft_skill_point" id="cmthScriptAF5" name="data[apology_empathy_statement]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point soft_skill_point" id="cmthScriptAF3" name="data[collector_hang_up_rp]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point soft_skill_point" id="cmthScriptAF5" name="data[tone_pleasant_accommodating]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point closing_point" id="cmthScriptAF3" name="data[disrespectful_attitude]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point closing_point" id="cmthScriptAF1" name="data[summarize_the_call]" required>
									...
									<tr>
										<td colspan=3>Did the collector provided Varo Bank FAQ's on how to contact customer support voice/chat incase its required? (Voice: mobile wallet activation/dispute/login/Zelle, Chat: common account related questions) </td>
										
										<td>
											<select class="form-control varo_rp_point closing_point" id="cmthScriptAF4" name="data[provided_varo_bank_support]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point closing_point" id="cmthScriptAF4" name="data[set_appropriate_timelines]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point closing_point" id="cmthScriptAF5" name="data[professionally_close_the_call]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" id="doc_fatal2" name="data[collector_file_document]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" id="doc_fatal3" name="data[context_of_conversation]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" id="doc_fatal4" name="data[callback_permission_document]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" id="doc_fatal5" name="data[remove_any_incorrect_phone]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" id="doc_fatal6" name="data[update_address_information]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" id="doc_fatal8" name="data[change_the_status]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control varo_rp_point documentation_point" name="data[escalate_the_account_to_supervisor]" id="doc_fatal9" required>
												...
												<?php $attach_file = explode(",",$varo_rp['attach_file']);
												 foreach($attach_file as $mp){ ?>
													<audio controls='' style="background-color:#607F93"> 
													  <source src="<?php echo base_url(); ?>qa_files/qa_varo_rp/<?php echo $mp; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/qa_varo_rp/<?php echo $mp; ?>" type="audio/mpeg">
													</audio> </br>
												 <?php } ?>
											</td>
										<?php }else{
									...
									<?php if($varo_rp_id!=0){ ?>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Feedback Acceptance:</td><td colspan=4><?php echo $varo_rp['agnt_fd_acpt'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weightbold">Agent Review:</td><td colspan=4><?php echo $varo_rp['agent_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td><td colspan=4><?php echo $varo_rp['mgnt_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td><td colspan=4><?php echo $varo_rp['client_rvw_note'] ?></td></tr>
