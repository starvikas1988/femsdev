						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px; text-align:center!important; ">SEA WORLD CHAT AGENT FORM</td>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" name="data[call_id]" value="<?php echo $sea_world_chat_data['call_id'] ?>" disabled>
											</td>
										</tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control"  id="" name="data[ticket_id]" value="<?php echo $sea_world_chat_data['ticket_id']; ?>" disabled></td>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" id="" name="data[evaluation_link]" value="<?php echo $sea_world_chat_data['evaluation_link'] ?>" disabled>
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt1]" disabled>
											...
											<td>3</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[proper_greeting]" disabled>
											...
											<td><input type="text" name="data[remarks1]" class="form-control" disabled value="<?php echo $sea_world_chat_data['remarks1'] ?>"></td>
										</tr>
										<tr>
											<td>1b. Proper Closing</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt2]" disabled>
											...
											<td>3</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[proper_closing]" disabled>
											...
											<td><input type="text" name="data[remarks2]" class="form-control" disabled value="<?php echo $sea_world_chat_data['remarks2'] ?>"></td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt3]" disabled>
											...
											<td>9</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[proper_spelling]" disabled>
											...
											<td><input type="text" name="data[remarks3]" class="form-control" disabled value="<?php echo $sea_world_chat_data['remarks3'] ?>"></td>
										</tr>
										<tr>
											<td>2b. Ambassador used courteous &<br> professional words and phrases.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt4]" disabled>
											...
											<td>6</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[professional_words]" disabled>
											...
											<td><input type="text" disabled name="data[remarks4]" class="form-control" value="<?php echo $sea_world_chat_data['remarks4'] ?>"></td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt5]" disabled>
											...
											<td>6</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[adapted_approach]" disabled>
											...
											<td><input type="text" name="data[remarks5]" class="form-control" disabled value="<?php echo $sea_world_chat_data['remarks5'] ?>"></td>
										</tr>
										<tr>
											<td>2d. Active Listening.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt6]" disabled>
											...
											<td>7</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[active_listening]" disabled>
											...
											<td><input type="text" disabled name="data[remarks6]" class="form-control" value="<?php echo $sea_world_chat_data['remarks6'] ?>"></td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt7]" disabled>
											...
											<td>12</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[take_ownership]" disabled>
											...
											<td><input type="text" disabled name="data[remarks7]" class="form-control" value="<?php echo $sea_world_chat_data['remarks7'] ?>"></td>
										</tr>
										<tr>	
											<td>3.1.b. Agent follows all SOP/Policies<br> as stated in SharePoint or provided <br>by Leadership.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt8]" disabled>
											...
											<td>8</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[follows_all_SOP]" disabled>
											...
											<td><input type="text" disabled name="data[remarks8]" class="form-control" value="<?php echo $sea_world_chat_data['remarks8'] ?>"></td>
										</tr>
										<tr>	
											<td>3.1.c. Agent does not blame parks<br> or other departments for problem.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt9]" disabled>
											...
											<td>5</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[blame_parks]" disabled>
											...
											<td><input type="text" disabled name="data[remarks9]" class="form-control" value="<?php echo $sea_world_chat_data['remarks9'] ?>"></td>
										</tr>
										<tr>	
											<td>3.1.d. The agent asked pertinent<br> questions to accurately diagnose the<br> guest's need or problem.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt10]" disabled>
											...
											<td>7</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[pertinent_questions]" disabled>
											...
											<td><input type="text" disabled name="data[remarks10]" class="form-control" value="<?php echo $sea_world_chat_data['remarks10'] ?>"></td>
										</tr>
										<tr>	
											<td>3.1.e. Agent used appropropriate<br> resources to address the issue.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt11]" disabled>
											...
											<td>4</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[appropropriate_resources]" disabled>
											...
											<td><input type="text" disabled name="data[remarks11]" class="form-control" value="<?php echo $sea_world_chat_data['remarks11'] ?>"></td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt12]" disabled>
											...
											<td>8</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[accurate_information]" disabled>
											...
											<td><input type="text" disabled name="data[remarks12]" class="form-control" value="<?php echo $sea_world_chat_data['remarks12'] ?>"></td>
										</tr>
										<tr>		
											<td>3.2.b. Agent presents a sense of<br> urgency whenever applicable.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt13]" disabled>
											...
											<td>4</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[sense_urgency]" disabled>
											...
											<td><input type="text" disabled name="data[remarks13]" class="form-control" value="<?php echo $sea_world_chat_data['remarks13'] ?>">
											</td>
										</tr>
										<tr>
											...
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt14]" disabled>
											...
											<td>6</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[handles_chat_efficiently]" disabled>
											...
											<td><input type="text" disabled name="data[remarks14]" class="form-control" value="<?php echo $sea_world_chat_data['remarks14'] ?>">
											</td>
										</tr>
										<tr>				
											<td>3.3.b. Uses Proper Hold Procedures.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt15]" disabled>
											...
											<td>8</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[hold_procedures]" disabled>
											...
											<td><input type="text" disabled name="data[remarks15]" class="form-control" value="<?php echo $sea_world_chat_data['remarks15'] ?>">
											</td>
										</tr>
										<tr>				
											<td>3.3.c. Ambassador minimized or eliminated dead<br> time on Chat.</td>
											<td>
												<select class="form-control" id ="" style="width: 200px;" name="data[cmt16]" disabled>
											...
											<td>4</td>
											<td>
												<select class="form-control sea_world_chat_point" id ="" name="data[dead_time]" disabled>
											...
											<td><input type="text" name="data[remarks16]" class="form-control" disabled value="<?php echo $sea_world_chat_data['remarks16'] ?>">
											</td>
										</tr>
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control sea_world_chat_point" id ="seaworldChatAF1" name="data[qualifies_park]" disabled>
											...
											<td><input type="text" disabled name="data[remarks17]" class="form-control" value="<?php echo $sea_world_chat_data['remarks17'] ?>">
											</td>
										</tr>
										<tr>				
											...
											<td></td>
											<td>
												<select class="form-control sea_world_chat_point" id ="seaworldChatAF2" name="data[cancelation_policies]" disabled>
											...
											<td><input type="text" disabled name="data[remarks18]" class="form-control" value="<?php echo $sea_world_chat_data['remarks18'] ?>">
											</td>
										</tr>
										<tr>				
											...
											<td></td>
											<td>
												<select class="form-control sea_world_chat_point" id ="seaworldChatAF3" name="data[customer_focused]" disabled>
											...
											<td><input type="text" disabled name="data[remarks19]" class="form-control" value="<?php echo $sea_world_chat_data['remarks19'] ?>">
											</td>
										</tr>
										<tr>				
											...
											<td></td>
											<td>
												<select class="form-control sea_world_chat_point" id ="seaworldChatAF4" name="data[correct_disposition]" disabled>
											...
											<td><input type="text" disabled name="data[remarks20]" class="form-control" value="<?php echo $sea_world_chat_data['remarks20'] ?>">
											</td>
										</tr>
										<tr>				
											...
											<td></td>
											<td>
												<select class="form-control sea_world_chat_point" id ="seaworldChatAF5" name="data[PCI_policies]" disabled>
											...
											<td><input type="text" disabled name="data[remarks21]" class="form-control" value="<?php echo $sea_world_chat_data['remarks21'] ?>">
											</td>
										</tr>
										<tr>				
											...
											<td></td>
											<td>
												<select class="form-control sea_world_chat_point" id ="seaworldChatAF6" name="data[complete_notes]" disabled>
											...
											<td><input type="text" disabled name="data[remarks22]" class="form-control" value="<?php echo $sea_world_chat_data['remarks22'] ?>">
											</td>
										</tr>

										<tr>
											<td>Call Summary:</td>
											<td colspan=3><textarea class="form-control" disabled name="data[call_summary]"><?php echo $sea_world_chat_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $sea_world_chat_data['feedback'] ?></textarea></td>
										</tr>
										<?php if($sea_world_chat_data['attach_file']!=''){ ?>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $sea_world_chat_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $sea_world_chat_data['client_rvw_note'] ?></td>
									</tr>
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $sea_world_chat_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $sea_world_chat_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $sea_world_chat_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($sea_world_chat_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($sea_world_chat_data['agent_rvw_note']==''){ ?>
