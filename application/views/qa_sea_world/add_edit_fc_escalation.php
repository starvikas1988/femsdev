						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px; text-align:center!important; ">FC ESCALATION QA FORM</td>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" name="data[call_id]" value="<?php echo $fc_escalation_data['call_id'] ?>" required>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<select class="form-control" id="" name="data[reason_for_call]" required>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" id="" name="data[evaluation_link]" value="<?php echo $fc_escalation_data['evaluation_link'] ?>" required>
											</td>

											<td>Disposition:<span style="font-size:24px;color:red">*</span>
											</td>
											<td>
												<select class="form-control" id="" name="data[disposition]" required>
                                                    <option value="">-Select-</option>
										...
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[accurate_information]" required>
											...
											<td><input type="text" name="data[cmt1]" class="form-control" value="<?php echo $fc_escalation_data['cmt1'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[active_listening]" required>
											...
											<td><input type="text" name="data[cmt2]" class="form-control" value="<?php echo $fc_escalation_data['cmt2'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[verbatim_tone]" required>
											...
											<td><input type="text" name="data[cmt3]" class="form-control" value="<?php echo $fc_escalation_data['cmt3'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[finding_solution]" required>
											...
											<td><input type="text" name="data[cmt4]" class="form-control" value="<?php echo $fc_escalation_data['cmt4'] ?>"></td>
										</tr>
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[owns_call]" required>
											...
											<td><input type="text" name="data[cmt5]" class="form-control" value="<?php echo $fc_escalation_data['cmt5'] ?>"></td>
										</tr>
										<tr>
											<td>6 - Empathetic</td>
											<td>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[empathetic]" required>
											...
											<td><input type="text" name="data[cmt6]" class="form-control" value="<?php echo $fc_escalation_data['cmt6'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[efficiency_of_call]" required>
											...
											<td><input type="text" name="data[cmt7]" class="form-control" value="<?php echo $fc_escalation_data['cmt7'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_escalation_point" id ="" name="data[proper_opening_closing]" required>
											...
											<td><input type="text" name="data[cmt8]" class="form-control" value="<?php echo $fc_escalation_data['cmt8'] ?>"></td>
										</tr>
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control fc_escalation_point" id ="fc_fatal1" name="data[cancelation_policy]" required>
											...
											<td><input type="text" name="data[cmt9]" class="form-control" value="<?php echo $fc_escalation_data['cmt9'] ?>"></td>
										</tr>
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control fc_escalation_point" id ="fc_fatal2" name="data[leaves_notes]" required>
											...
											<td><input type="text" name="data[cmt10]" class="form-control" value="<?php echo $fc_escalation_data['cmt10'] ?>"></td>
										</tr>
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control fc_escalation_point" id ="fc_fatal3" name="data[qualifies_park]" required>
											...
											<td><input type="text" name="data[cmt11]" class="form-control" value="<?php echo $fc_escalation_data['cmt11'] ?>"></td>
										</tr>
										<tr>
											...
											<td></td>
											<td>
												<select class="form-control fc_escalation_point" id ="fc_fatal4" name="data[offensive_rude]" required>
											...
											<td><input type="text" name="data[cmt12]" class="form-control" value="<?php echo $fc_escalation_data['cmt12'] ?>"></td>
										</tr>

										<tr>
											<td>Call Summary:</td>
											<td colspan=3><textarea class="form-control" name="data[call_summary]"><?php echo $fc_escalation_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" name="data[feedback]"><?php echo $fc_escalation_data['feedback'] ?></textarea></td>
										</tr>
										<tr>
											...
											<?php if ($sea_world_id == 0) { ?>
												...
												<?php } else {
												if ($fc_escalation_data['attach_file'] != '') { ?>
													<td colspan=6>
														...
														foreach ($attach_file as $mp) { ?>
															<audio controls='' style="background-color:#607F93">
																<source src="<?php echo base_url(); ?>qa_files/sea_world/fc_escalation/<?php echo $mp; ?>" type="audio/ogg">
																<source src="<?php echo base_url(); ?>qa_files/sea_world/fc_escalation/<?php echo $mp; ?>" type="audio/mpeg">
															</audio> </br>
														<?php } ?>
													</td>
											<?php } else {
										...
										<?php if ($sea_world_id != 0) { ?>
											<tr>
												...
												<td colspan=6><?php echo $fc_escalation_data['agnt_fd_acpt'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td>
												<td colspan=6><?php echo $fc_escalation_data['agent_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td>
												<td colspan=6><?php echo $fc_escalation_data['mgnt_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td>
												<td colspan=6><?php echo $fc_escalation_data['client_rvw_note'] ?></td>
											</tr>
