								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										if ($sea_world_id == 0) {
											...
											//$new = explode("-", $sea_world_data['audit_date']);
											//$new1 = explode(" ", $new[2]);
											//print_r($new);
										...
										<tr>
											...
											<td><input type="text" class="form-control" id="fusion_id" required value="<?php echo $sea_world_data['fusion_id'] ?>" readonly></td>
											<td> L1 Supervisor:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" id="tl_name"  value="<?php echo $sea_world_data['tl_name'] ?>" readonly>
												<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $sea_world_data['tl_id'] ?>" required>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="2"><input type="text" class="form-control" onkeydown="return false;" id="call_duration" name="data[call_duration]" value="<?php echo $sea_world_data['call_duration']?>" required></td>
