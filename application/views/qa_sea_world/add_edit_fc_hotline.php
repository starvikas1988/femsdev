						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px; text-align:center!important; ">FC HOTLINE QA FORM</td>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" name="data[call_id]" value="<?php echo $fc_hotline_data['call_id'] ?>" required>
											</td>
										</tr>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" id="" name="data[evaluation_link]" value="<?php echo $fc_hotline_data['evaluation_link'] ?>" required>
											</td>
										...
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fc_hotline_point" id ="" name="data[accurate_information]" required>
											...
											<td><input type="text" name="data[cmt1]" class="form-control" value="<?php echo $fc_hotline_data['cmt1'] ?>"></td>
										</tr>
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fc_hotline_point" id ="" name="data[active_listening]" required>
											...
											<td><input type="text" name="data[cmt2]" class="form-control" value="<?php echo $fc_hotline_data['cmt2'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_hotline_point" id ="" name="data[verbatim_tone]" required>
											...
											<td><input type="text" name="data[cmt3]" class="form-control" value="<?php echo $fc_hotline_data['cmt3'] ?>"></td>
										</tr>
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fc_hotline_point" id ="" name="data[finding_solution]" required>
											...
											<td><input type="text" name="data[cmt4]" class="form-control" value="<?php echo $fc_hotline_data['cmt4'] ?>"></td>
										</tr>
										<tr>
											...
											<td>10</td>
											<td>
												<select class="form-control fc_hotline_point" id ="" name="data[issue_called_about]" required>
											...
											<td><input type="text" name="data[cmt5]" class="form-control" value="<?php echo $fc_hotline_data['cmt5'] ?>"></td>
										</tr>
										<tr>
											...
											<td>20</td>
											<td>
												<select class="form-control fc_hotline_point" id ="" name="data[efficiency_on_call]" required>
											...
											<td><input type="text" name="data[cmt6]" class="form-control" value="<?php echo $fc_hotline_data['cmt6'] ?>"></td>
										</tr>

										<tr>
											<td>Call Summary:</td>
											<td colspan=3><textarea class="form-control" name="data[call_summary]"><?php echo $fc_hotline_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" name="data[feedback]"><?php echo $fc_hotline_data['feedback'] ?></textarea></td>
										</tr>
										<tr>
											...
											<?php if ($fc_hotline_id == 0) { ?>
												...
												<?php } else {
												if ($fc_hotline_data['attach_file'] != '') { ?>
													<td colspan=6>
														...
														foreach ($attach_file as $mp) { ?>
															<audio controls='' style="background-color:#607F93">
																<source src="<?php echo base_url(); ?>qa_files/sea_world/fc_hotline/<?php echo $mp; ?>" type="audio/ogg">
																<source src="<?php echo base_url(); ?>qa_files/sea_world/fc_hotline/<?php echo $mp; ?>" type="audio/mpeg">
															</audio> </br>
														<?php } ?>
													</td>
											<?php } else {
										...
										<?php if ($fc_hotline_id != 0) { ?>
											<tr>
												...
												<td colspan=6><?php echo $fc_hotline_data['agnt_fd_acpt'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td>
												<td colspan=6><?php echo $fc_hotline_data['agent_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td>
												<td colspan=6><?php echo $fc_hotline_data['mgnt_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td>
												<td colspan=6><?php echo $fc_hotline_data['client_rvw_note'] ?></td>
											</tr>
