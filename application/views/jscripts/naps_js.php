...
<script type="text/javascript">
	...
	function check_apprentice_val(){
		str = $('#apprentice_registration_no').val();
		if(str.charAt(0)!= 'A'){
			alert('Apprentice no should start with A');
			$('#apprentice_registration_no').val('');
			$('#apprentice_registration_no').focus();
		}
	}
	function check_contract_val(){
		str = $('#contract_registration_no').val();
		if(str.charAt(0)!= 'C'){
			alert('Contract no should start with C');
			$('#contract_registration_no').val('');
			$('#contract_registration_no').focus();
		}
	}
	function check_apprentice_val1(){
		str = $('#apprentice_no').val();
		if(str.charAt(0)!= 'A'){
			alert('Apprentice no should start with A');
			$('#apprentice_no').val('');
			$('#apprentice_no').focus();
	...
	function send_contract_letter(id,user_id){
		var baseURL="<?php echo base_url();?>";
		$('#sktPleaseWait').modal('show');
			$.ajax({
					    type: 'GET',    
					    url:baseURL+'naps/send_contract_letter',
