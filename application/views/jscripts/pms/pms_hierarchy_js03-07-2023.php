    ...
    function open_sub(pms_id,user_id){
       ...
       $.ajax({
            ...
            success:function(res){
                ...
                ts+='</td><td>'+data['name']+'</td><td>'+data['mwp_id']+'</td><td>'+data['role_name']+'</td><td>'+data['dept_name']+'</td><td>'+data['pms_title']+'</td><td>'+data['pms_status']+'</td><td>'+data['start_date']+'</td><td><span class="badge bg-success">'+data['status']+'</span></td><td><div class="tooltip_fresh">';
                ...
                ts+='<span class="tooltiptext">View</span></div></td></tr><tr class="common_table_widget_expand"><td colspan="12" class="hiddenRow"><div class="accordian-body collapse table_under" id="demo'+data['pms_id']+'_'+data['user_id']+'"></div></td></tr></tbody>';
                });
                ts+='</table>';
...
if (id != '') {
    $.ajax({
        ...
        success: function (data) {
            ...
            // $("#pms_type").empty();
                // console.log(a);
            var htm = "<option>Select PMS Cycle</option>"; 
