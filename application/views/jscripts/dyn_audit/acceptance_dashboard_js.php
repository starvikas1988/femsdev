<?php
include "report_dashboard_js.php";
?>
...
<script type="text/javascript">
	...
	Highcharts.chart('lob-wise-chart', {
	    chart: {
	        type: 'column'
	    },
	    title: {
	        text: 'LOB Wise Acceptance Analytics'
	    },
	    subtitle: {
	        text: ''
	    },
	    xAxis: {
	        categories: <?php echo json_encode($lob_wise_graph_xAxis);?>,
	        crosshair: true
	    },
	    yAxis: {
	        title: {
	    ...
	    series: [{
	        name: 'Feedback Raised',
	        data: <?php echo json_encode($lob_wise_graph_feedback_raised);?>,

	    }, {
	        name: 'Feedback Accepted within 24 hour',
	        data: <?php echo json_encode($lob_wise_graph_feedback_accepted_less24hrs);?>,

	    }, {
	        name: 'Feedback Accepted Post 24 hrs',
	        data: <?php echo json_encode($lob_wise_graph_feedback_accepted_post24hrs);?>,

	    }, {
	        name: 'Feedback Not Accepted',
	        data: <?php echo json_encode($lob_wise_graph_feedback_not_accepted);?>,

	    },{
	        name: 'Rebuttal Raised',
	        data: <?php echo json_encode($lob_wise_graph_feedback_rebuttal);?>,
	...
	<?php } ?>
	Highcharts.chart('asheet-wise-chart', {
	    chart: {
	        type: 'column'
	    },
	    title: {
	        text: 'Audit Sheet Wise Acceptance Analytics'
	    },
	    subtitle: {
	        text: ''
	    },
	    xAxis: {
	        categories: <?php echo json_encode($a_sheet_wise_graph_xAxis);?>,
	        crosshair: true
	    },
	    yAxis: {
	        title: {
	    ...
	    series: [{
	        name: 'Feedback Raised',
	        data: <?php echo json_encode($a_sheet_wise_graph_feedback_raised);?>,

	    }, {
	        name: 'Feedback Accepted within 24 hour',
	        data: <?php echo json_encode($a_sheet_wise_graph_feedback_accepted_less24hrs);?>,

	    }, {
	        name: 'Feedback Accepted Post 24 hrs',
	        data: <?php echo json_encode($a_sheet_wise_graph_feedback_accepted_post24hrs);?>,

	    }, {
	        name: 'Feedback Not Accepted',
	        data: <?php echo json_encode($a_sheet_wise_graph_feedback_not_accepted);?>,

	    },{
	        name: 'Rebuttal Raised',
	        data: <?php echo json_encode($a_sheet_wise_graph_feedback_rebuttal);?>,
	...
	Highcharts.chart('qa-wise-chart', {
      ...
      $(document).on('click','.audit-deatils',function(){
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo base_url("Dyn_acceptance_dashboard/get_audit_details?");?>'+urlParams,
            data: { agentId: agentId },
            dataType: "json",
            beforeSend: function(){
               $("#audited-list").html(`<tr><td colspan="15" class="text-center text-bold" style="text-align: center !important;">Please Wait..</td></tr>`);
            },
                ...
                if (response.data.length != 0) {
                    for (const [key, value] of Object.entries(response.data)) {
                        ...
                        html += `<tr> 
                                      ...
                                      <td align="center">${value.campaign_name}</td>
                    ...
                    html = `<tr>
                              <td colspan="15" class="text-center text-bold" style="text-align: center !important;">No Data Available</td>
                            </tr>`;
                }
