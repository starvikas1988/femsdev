...
// // Display the popup for New Employee
// if (diffInDays < 15 && oldRegimeValue >= grossPay ) {
//     $("#it_declaration_popup").modal('show');
// }

// // Display the popup for old Employee
// if (oldRegimeValue >= grossPay  && financialYear && enableId && fromDateTime && toDateTime && isItDeclaration == 0) {
//     $("#it_declaration_popup").modal('show');
// }
 ...
 if (currentDate - dojDate < 15 * 24 * 60 * 60 * 1000 && grossPay > oldRegimeValue && isItDeclaration == 0) {
    $('#it_declaration_popup').modal('show');
  }
  ...
  if (currentDate - dojDate >= 15 * 24 * 60 * 60 * 1000 && fromDateTime <= currentDate && toDateTime >= currentDate && grossPay > oldRegimeValue && isItDeclaration == 0) {
    $('#it_declaration_popup').modal('show');
  }
