			...
			if(ans==true){
				...
				if(tbid != "" && tattrition != ""){
				  $.ajax({
				   ...
				   data: { bid : tbid, uid : tuid, trnattrition : tattrition, type : t_type },
				   success: function(msg){
...
///////////////////////////////////////////////////
  $('input[name="daterange"]').daterangepicker({
	...
	$(document).on('click','.selectAllCertifyUserCheckBox',function()
		{
		if($(this).is(':checked'))
		{
			$('[name="userCertifyCheckBox[]"]').prop('checked',true);
		}
		else
		{
			$('[name="userCertifyCheckBox[]"]').prop('checked',false);
		}
	});
