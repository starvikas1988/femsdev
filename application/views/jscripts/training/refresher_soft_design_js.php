...
////////////////////////////////////////////////////
	...
	$("#modelNestingResultUpload").on("shown.bs.modal", function () {
		...
		var uUrl=baseURL+'training/upload_refresher_soft_Result';
	...
	$(".btnNestingUpload").click(function(){
		...
		var certificateurl = baseURL+'training/refresher_soft_design/' +batch_id;
		$.ajax({
		   type: 'GET',    
		   url:baseURL+'training/getFormatDesign_refresher_soft',
		   data:'batchid=' + batch_id,
		   success: function(msg){
			 if(msg != 0)
			 {
				var uUrl=baseURL+'training/download_refresher_soft_Header' + '?pmdid=' + msg;
...
//================================== DESIGN JS ===================================================================//	
	...
	$(".editDesignButton").click(function(){
		...
		var URL=baseURL+'training/get_refresher_soft_DesignForm?mdid='+mdid;
...
<script>
	$(document).on('change','#foffice_id',function()
	{
		...
		$.ajax({
		   type: 'POST',    
		   url:"<?php echo base_url('training/get_clients_refresher_tni');?>",
