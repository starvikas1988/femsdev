...
////////////////////////////////////////////////////
	...
	$("#modelNestingResultUpload").on("shown.bs.modal", function () {
		...
		var uUrl=baseURL+'training/upload_refresher_tni_Result';
	...
	$(".btnNestingUpload").click(function(){
		...
		var certificateurl = baseURL+'training/refresher_tni_design/' +batch_id;
		$.ajax({
		   type: 'GET',    
		   url:baseURL+'training/getFormatDesign_refresher_tni',
		   data:'batchid=' + batch_id,
		   success: function(msg){
			 if(msg != 0)
			 {
				var uUrl=baseURL+'training/download_refresher_tni_Header' + '?pmdid=' + msg;
...
//================================== DESIGN JS ===================================================================//	
	...
	$(".editDesignButton").click(function(){
		...
		var URL=baseURL+'training/get_refresher_tni_DesignForm?mdid='+mdid;
