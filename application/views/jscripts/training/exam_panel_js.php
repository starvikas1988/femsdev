<script>
	...
	function timeBetweenDates(start,end) {
	  ...
	  if (difference <= 0) {
		...
		var request_url = "<?php echo base_url('training/submit_exam'); ?>";
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			if(res.stat == true)
			{
				window.location.href = "<?php echo base_url('training/agent'); ?>";
			}
			else
			{
...
<script>
	$(document).ready(function()
	{
		...
		var request_url = "<?php echo base_url('training/get_first_question'); ?>";
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			if(res.stat == true)
...
<script>
	$(document).on('click','#next',function()
	{
		...
		var request_url = "<?php echo base_url('training/submit_question'); ?>";
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			if(res.stat == true)
