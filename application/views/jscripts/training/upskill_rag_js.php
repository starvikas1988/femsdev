...
/// Nesting Result Add
	...
	$("#modelNestingResultUpload").on("shown.bs.modal", function () {
		...
		var uUrl=baseURL+'training/uploadUpskillRagResult';
	...
	$(".btnNestingUpload").click(function(){
		...
		var certificateurl = baseURL+'training/upskill_rag_design/' +batch_id;
		$.ajax({
		   type: 'GET',    
		   url:baseURL+'training/getFormatDesignUpskill_Rag',
		   data:'batchid=' + batch_id,
		   success: function(msg){
			 if(msg != 0)
			 {
				var uUrl=baseURL+'training/downloadTrainingUpskillRagHeader' + '?pmdid=' + msg;
...
//================================== DESIGN JS ===================================================================//	
	...
	$(".editDesignButton").click(function(){
		...
		var URL=baseURL+'training/getTrainingUpskillRagDesignForm?mdid='+mdid;
