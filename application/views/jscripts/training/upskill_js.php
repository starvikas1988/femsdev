...
////////////////////////////////////////////////////
	...
	$("#modelNestingResultUpload").on("shown.bs.modal", function () {
		...
		var uUrl=baseURL+'training/uploadUpskillResult';
	...
	$(".btnNestingUpload").click(function(){
		...
		var certificateurl = baseURL+'training/upskill_design/' +batch_id;
		$.ajax({
		   type: 'GET',    
		   url:baseURL+'training/getFormatDesignUpskill',
		   data:'batchid=' + batch_id,
		   success: function(msg){
			 if(msg != 0)
			 {
				var uUrl=baseURL+'training/downloadTrainingUpskillHeader' + '?pmdid=' + msg;
...
//================================== DESIGN JS ===================================================================//	
	...
	$(".editTrainingAuditDesignButton").click(function(){
		...
		var URL=baseURL+'training/get_upskill_DesignForm?mdid='+mdid;
...
/*---------------------- BUTTON ACTIONS -------------------------------------------------------------*/
	...
	$(".moveclasstraineeR").click(function(){
		...
		var rURL=baseURL+'training/fetchBatchUsers_upskill';
		var bURL=baseURL+'training/fetchBatchlist_upskill';
	...
	$(".newuserbatchR").click(function(){
		...
		var rURL=baseURL+'training/fetchBatchTraineeList_upskill';
		//var bURL=baseURL+'training/fetchBatchlist';
