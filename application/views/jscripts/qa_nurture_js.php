...
function do_pre_booking(){
		...
		$('.nurture_farms_point').each(function(index,element){
			var score_type = $(element).val();
			//alert(score_type);
            if(score_type =='Yes'){
				var weightage = parseFloat($(element).children("option:selected").attr('nurture_farms_val'));
		...
		//quality_earnedScore_percent     = (score).toFixed(2);
		quality_earnedScore_percent 	= (score);
		...
		if(!isNaN(quality_possibleScore_percent)){
          ...
          // For Fatal
		if($('.all_fatal1').val()=='No' || $('.all_fatal2').val()=='No' || $('.all_fatal3').val()=='No' || $('.all_fatal4').val()=='No' || $('.all_fatal5').val()=='No' || $('#outbound_fatal1').val()=='No' || $('#outbound_fatal2').val()=='No' || $('#outbound_fatal3').val()=='No' || $('#outbound_fatal4').val()=='No' || $('#outbound_fatal5').val()=='No' || $('#outbound_fatal6').val()=='No'){
 ...
 $(document).on('change','.nurture_farms_point',function(){
	do_pre_booking();
});
 do_pre_booking();
