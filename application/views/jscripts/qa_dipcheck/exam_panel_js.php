<script>
	...
	function timeBetweenDates(start,end) {
	  ...
	  if (difference <= 0) {
		...
		var request_url = "<?php echo base_url('qa_dipcheck/submit_exam'); ?>";
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			if(res.stat == true)
			{
				window.location.href = "<?php echo base_url('qa_dashboard'); ?>";
			}
			else
			{
				alert('Unable to Submit qa_dipcheck. Server Error!');
			}
...
<script>
	$(document).ready(function()
	{
		...
		var request_url = "<?php echo base_url('qa_dipcheck/get_first_question'); ?>";
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			if(res.stat == true)
...
<script>
	$(document).on('click','#next',function()
	{
		...
		var request_url = "<?php echo base_url('qa_dipcheck/submit_question'); ?>";
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			if(res.stat == true)
			{
				...
				var request_url = "<?php echo base_url('qa_dipcheck/get_question'); ?>";
				process_ajax(function(response)
				{
					var res = JSON.parse(response);
					if(res.stat == true)
