...
if(isBreak_Sd_on == 1){
	countdownTimer_onload = setInterval('timer_sd()', 1000);
}

if(isBreak_Cb_on == 1){
	countdownTimer_onload = setInterval('timer_cb()', 1000);
}

if(isBreak_Dl_on == 1 ){
	countdownTimer_onload = setInterval('timer_ld()', 1000);
}

if(isBreak_Other_on == 1){
	countdownTimer_onload = setInterval('timer()', 1000);
}
