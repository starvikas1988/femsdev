...
////////////////////////// ALL AD File///////////////////////////////
	...
	$(document).on('change','.pajamagram',function(){
		fb_calculation();
	});
...
$('.conduent_points').each(function(index,element){
	...
	var score_type = $(element).val();
		...
		if(!isNaN(quality_score_percent)){
			...
			quality_score_percent = (0).toFixed(2);
			$('#conduent_overall_score').val(quality_score_percent+'%');
		}
	...
	/////////////////
		if($('#HS_AF1').val()=='Fail' || $('#HS_AF2').val()=='Fail' || $('#HS_AF3').val()=='Fail'){
			...
			$('.heatsurge_Fatal').val(quality_score_percent+'%');
		}
	/////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	//////////////// Pajamagrams ///////////////
		var pajamScore=0;
		var pajamScoreable=0;
		var pajamTotal=0;
	
		$('.pajamagram').each(function(index,element){
			var score_type = $(element).val();
			if(score_type == 'Yes'){
				var pw1 = parseFloat($(element).children("option:selected").attr('ds_val'));
				pajamScore = pajamScore + pw1;
				pajamScoreable = pajamScoreable + pw1;
		...
		pajamTotal = ((pajamScore*100)/pajamScoreable).toFixed(2);

		$('#pajamEarned').val(pajamScore);
		$('#pajamPossible').val(pajamScoreable);
		if(!isNaN(pajamTotal)){
			$('#pajamOverall').val(pajamTotal+'%');
		}
		
		if($('#pajamAF1').val()=='Yes' || $('#pajamAF2').val()=='Yes' || $('#pajamAF3').val()=='Yes' || $('#pajamAF4').val()=='Yes' || $('#pajamAF5').val()=='Fail'|| $('#pajamAF6').val()=='Fail'|| $('#pajamAF7').val()=='Fail'|| $('#pajamAF8').val()=='Fail'|| $('#pajamAF9').val()=='Fail'){
			$('.pajamFatal').val(0);
		}else{
			$('.pajamFatal').val(pajamTotal+'%');
		}
	///////////////////////////////
    ...
    var customerScoreable = 0;
    var customerPercentage = 0;
    $('.customer_ds').each(function(index, element) {
        var sc1 = $(element).val();
        if (sc1 == 'Yes') {
            var w1 = parseInt($(element).children("option:selected").attr('ds_val'));
            customerScore = customerScore + w1;
            customerScoreable = customerScoreable + w1;
        }else if (sc1 == 'Pass') {
            var w1 = parseInt($(element).children("option:selected").attr('ds_val'));
    ...
    var businessScoreable = 0;
    var businessPercentage = 0;
    $('.business_ds').each(function(index, element) {
        var sc2 = $(element).val();
        if (sc2 == 'Yes') {
            var w2 = parseInt($(element).children("option:selected").attr('ds_val'));
            businessScore = businessScore + w2;
            businessScoreable = businessScoreable + w2;
        }else if (sc2 == 'Pass') {
            var w2 = parseInt($(element).children("option:selected").attr('ds_val'));
    ...
    var complianceScoreable = 0;
    var compliancePercentage = 0;
    $('.compliance_ds').each(function(index, element) {
        var sc3 = $(element).val();
        if (sc3 == 'Yes') {
            var w3 = parseInt($(element).children("option:selected").attr('ds_val'));
            complianceScore = complianceScore + w3;
            complianceScoreable = complianceScoreable + w3;
        }else if (sc3 == 'Pass') {
            var w3 = parseInt($(element).children("option:selected").attr('ds_val'));
...
<script>
	function amd_pilgrim_point_calc(){
		...
		var total_earned_score=0,total_possible_score=0;
			...
			quality_score_percent = ((total_earned_score*100)/total_possible_score).toFixed(2);
			if(!isNaN(quality_score_percent)){
		    ...
		    $('#pilgrim_overallScore').val(0.00+'%');
		  }else{
			$('#pilgrim_overallScore').val(quality_score_percent+'%');
		  }
		  //////////////// Customer/Business/Compliance //////////////////
				...
				$('.customer').each(function(index,element){
					...
					if(sc1 == 'Yes'){
						...
						customerScore1 = customerScore1 + w1;
						customerScoreable1 = customerScoreable1 + w1;
					}else if(sc1 == 'No'){
						var w1 = parseFloat($(element).children("option:selected").attr('amd_max'));
						customerScoreable1 = customerScoreable1 + w1;
					}else if(sc1 == 'N/A'){
						var w1 = parseFloat($(element).children("option:selected").attr('amd_val'));
						customerScore1 = customerScore1 + w1;
				...
				if(!isNaN(customerScore1)){
					$('#custlockEarned1').val(customerScore1);
				}

				if(!isNaN(customerScoreable1)){
					$('#custlockPossible1').val(customerScoreable1);
				}
				
				
				customerPercentage = ((customerScore1*100)/customerScoreable1).toFixed(2);
				if(!isNaN(customerPercentage)){
					$('#custlockScore').val(customerPercentage+'%');
				}
			////////////
				...
				$('.business').each(function(index,element){
					var sc2 = $(element).val();
					if(sc2 == 'Yes'){
						var w2 = parseFloat($(element).children("option:selected").attr('amd_val'));
						businessScore1 = businessScore1 + w2;
						businessScoreable1 = businessScoreable1 + w2;
					}else if(sc2 == 'No'){
				...
				//console.log(businessScore1);
				if(!isNaN(businessScore1)){
					
					$('#busilockEarned1').val(businessScore1);
				}
				//console.log(businessScoreable1);
				if(!isNaN(businessScoreable1)){

					$('#busilockPossible1').val(businessScoreable1);
				}
				// $('#busilockEarned').val(businessScore);
				// $('#busilockPossible').val(businessScoreable);
				businessPercentage = ((businessScore1*100)/businessScoreable1).toFixed(2);
				if(!isNaN(businessPercentage)){
					$('#busilockScore').val(businessPercentage+'%');
				}
			////////////
				...
				$('.compliancee').each(function(index,element){
					var sc3 = $(element).val();
					if(sc3 == 'Yes'){
						var w3 = parseFloat($(element).children("option:selected").attr('amd_val'));
						complianceScore1 = complianceScore1 + w3;
						complianceScoreable1 = complianceScoreable1 + w3;
					}else if(sc3 == 'No'){
						var w3 = parseFloat($(element).children("option:selected").attr('amd_max'));
						complianceScoreable1 = complianceScoreable1 + w3;
					}else if(sc3 == 'N/A'){
						var w3 = parseFloat($(element).children("option:selected").attr('amd_val'));
						complianceScore1 = complianceScore1 + w3;
				...
				if(!isNaN(complianceScore1)){
					$('#compllockEarned1').val(complianceScore1);
				}

				if(!isNaN(complianceScoreable1)){
					$('#compllockPossible1').val(complianceScoreable1);
				}
				// $('#compllockEarned').val(complianceScore);
				// $('#compllockPossible').val(complianceScoreable);
				compliancePercentage = ((complianceScore1*100)/complianceScoreable1).toFixed(2);
				if(!isNaN(compliancePercentage)){
					$('#compllockScore').val(compliancePercentage+'%');
				}
	}
