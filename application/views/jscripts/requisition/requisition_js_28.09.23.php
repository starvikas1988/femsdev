                    ...
                    $.each(dat_asset, function(r) {
                        string += '<div class="col-md-4">\
                                <div class="form-group">\
                                    <label>' + dat_asset[r].name + ' Count <span class="red_bg">*</span></label>\
...
<script>
    ...
    $(document).on("click", "#candidateFinalSelection", function() {
        ...
        } else if(isUSLocation(off_id) == true) { //add restriction for US location
            $('#xpoid').attr("required", "true");
        } else {
            $('#xpoid').removeAttr("required");
        }
...
<script>
    ...
    function get_stipend_data(ctc = '') {
        ...
        if ($("#is_loi").is(":checked")) {
            if (indLocation == true) {
                lblHtml = 'Training date (dd/mm/yyyy) <span class="red_bg">*</span>';
            } else {
                lblHtml = 'Training date (mm/dd/yyyy) <span class="red_bg">*</span>';
            }
            ...
            if (indLocation == true) {
                lblHtml = 'Date of Joining (dd/mm/yyyy) <span class="red_bg">*</span>';
            } else {
                lblHtml = 'Date of Joining (mm/dd/yyyy) <span class="red_bg">*</span>';
            }
    ...
    //Checking duplicate entry of paycomID for US location
