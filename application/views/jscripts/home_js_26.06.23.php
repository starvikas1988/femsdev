...
var it_declaration_is_skip_today = "<?php echo $it_declaration_is_skip_today; ?>";
...
// }
 ...
 if (currentDate - dojDate < 15 * 24 * 60 * 60 * 1000 && grossPay > oldRegimeValue && isItDeclaration == 0 && it_declaration_is_skip_today == 0) {
    $('#it_declaration_popup').modal('show');
  }
