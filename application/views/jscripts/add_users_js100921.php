...
$(document).ready(function(){
	...
	$("#client_id").change(function(){
		...
		// var selected=[];
		// var i=0;
		// $('#client_id :selected').each(function(){
...
//////////////USER CLIENT SECTION//////////////////
	...
	$(".resetPasswordClientSubmit").click(function(){
		...
		if(newp != "" && oldp != "" && cid != ""){
			if(newp == oldp){
				var URL='<?php echo base_url();?>user/resetClientPassword';
				$.ajax({
				   type: 'POST',    
				   url: URL,
	...
	$(".editUserClient").click(function(){
		...
		if(consult=='consultant'){
			...
			if(consult=="Caller"){
				$("#caller").hide();
				// $("#edaccount_num").prop('required',false);
				// $("#edaccount_name").prop('required',false);
				// $("#edbank_name").prop('required',false);
				// $("#edbank_add").prop('required',false);
			}else{
				$("#caller").show();
				// $("#edaccount_num").prop('required',true);
				// $("#edaccount_num").prop('disabled',false);
				// $("#edaccount_name").prop('required',true);
				// $("#edaccount_name").prop('disabled',true);
				// $("#edbank_name").prop('required',true);
				// $("#edbank_name").prop('disabled',true);
				// $("#edbank_add").prop('required',true);
				// $("#edbank_add").prop('disabled',true);
		...
		if(assignPrams[17] > 0){ $( ".frmeditUserClient #allow_naps" ).prop( 'checked', true ); }
		if(assignPrams[18] > 0){ $( ".frmeditUserClient #allow_consultant_report" ).prop( 'checked', true ); }
		if(assignPrams[19] > 0){ $( ".frmeditUserClient #allow_emat" ).prop( 'checked', true ); }
		if(assignPrams[20] > 0){ $( ".frmeditUserClient #allow_k2claims" ).prop( 'checked', true ); }
		if(assignPrams[21] > 0){ $( ".frmeditUserClient #allow_diy" ).prop( 'checked', true ); }
