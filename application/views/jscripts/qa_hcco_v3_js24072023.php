...
<script type="text/javascript">
	function hcco_v3_calc(){
				...
				$(".hcco_v3_point").each(function(index, element){
					if($(element).val()!=""){
						var earned_weightage = parseFloat($(element).children("option:selected").attr('hcco_v3_val'));
						earned_score += earned_weightage;
						var weightage = parseFloat($(element).children("[value='Pass']").attr('hcco_v3_val'));
...
<script type="text/javascript">
	$(document).on("change", ".hcco_v3_point", function(){
			hcco_v3_calc();
	});
	hcco_v3_calc();
...
//Edited By Samrat 30/9/21
	$(document).ready(function(){
		...
		<?php if($this->uri->segment(2)=="Qa_epgi" && $this->uri->segment(4)=="0"){?>
			//console.log("okk");
			//$("#hcco_v3_earned_score, #hcco_v3_possible_score").val("0");
		<?php }?>
	});
</script>
