...
function drawChartMonthPositive() {
	...
	var options = {
	  title: "Zovio Cases Positive - <?php echo date('F', strtotime($selected_year .'-'.$selected_month.'-01')) ." " . $selected_year; ?>",
	  'is3D':   false,
	  pieHole: 0.4,
	  tooltip: { text: 'value' },
	};
...
function drawChartMonthNegative() {
	...
	var options = {
	  title: "Zovio Cases Negative - <?php echo date('F', strtotime($selected_year .'-'.$selected_month.'-01')) ." " . $selected_year; ?>",
	  'is3D':   false,
	  pieHole: 0.4,
	  tooltip: { text: 'value' },
	};
...
function drawChartWeek_positive_<?php echo $weekSl; ?>() {
	...
	var options = {
	  title: "Zovio Positive Case - Week <?php echo $weekSl; ?> (<?php echo date('d M', strtotime($current_dataSet['weekly'][$i]['start'])) .' - ' .date('d M', strtotime($current_dataSet['weekly'][$i]['end'])); ?>)",
...
function drawChartWeek_negative_<?php echo $weekSl; ?>() {
	...
	var options = {
	  title: "Zovio Negative Case - Week <?php echo $weekSl; ?> (<?php echo date('d M', strtotime($current_dataSet['weekly'][$i]['start'])) .' - ' .date('d M', strtotime($current_dataSet['weekly'][$i]['end'])); ?>)",
