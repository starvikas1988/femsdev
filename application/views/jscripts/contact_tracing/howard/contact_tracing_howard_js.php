...
<script>
    ...
    $("#formfour #disposition").change(function(){
        ...
        $('#formfour #final_case_type').removeAttr('required'); 
        $('#formfour #date_of_birth').removeAttr('required'); 
        $('#formfour #user_address').removeAttr('required'); 
        $('#formfour #specify_symptoms').removeAttr('required'); 
        $('#formfour #name_of_facility').removeAttr('required');
        $('#formfour #last_date_school').removeAttr('required');
        $('#formfour #disposition_expose').css('display','none'); 
        if(disposition == 5){
            ...
            if(disposition == 1||disposition ==2||disposition == 3){
                ...
                $('#formfour #final_case_type').prop('required',true);
                $('#formfour #date_of_birth').prop('required',true);
                $('#formfour #user_address').prop('required',true);
                $('#formfour #specify_symptoms').prop('required',true);
                $('#formfour #name_of_facility').prop('required',true);
                $('#formfour #last_date_school').prop('required',true);
            }
        }
    });
