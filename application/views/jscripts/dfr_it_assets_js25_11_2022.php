	...
	process_ajax(function(response)
	{
		...
		if (res.stat == true) 
		{
			...
			$.each(res.datas,function(index,element)
			{
				...
				if (element.is_bgv_verify == 1) { button_access = '<button type="button" class="btn btn-primary btn-xs model_users_assets" dfr_id="'+dfr_id+'" user_id="'+element.user_id+'" user_name="'+element.can_name+' ('+element.fusion_id+')" ><i class="fas fa-edit"></i></button>'; }
