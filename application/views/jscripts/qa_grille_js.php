...
/////////////
	...
	// function myFunction(){
	// 		sel=document.getElementById('agent_id_ajax').value;
	// 		localStorage.setItem("item",sel);
	// 	}

	// $("#agent_id_ajax").on("change", myFunction);

	// function work(ar,url,sel=''){
	// 	if(localStorage.getItem("item")!=''){
	// 		sel=localStorage.getItem("item");
	// 	}
	// 	var optionSelect=`<option value="">-Select-</option>`;
	// 	console.log(url);
	// 	fetch("<?php echo base_url(); ?>qa_alteras/"+url).
	//         then((Response)=>{
	//             Response.json().then((result)=>{
	//                 for (rr of result) {
	//                 	if(rr.id==sel){
 // 					 		optionSelect+=`<option value=${rr.id} selected>${rr.name}</option>`;
 // 						}else{
 // 							optionSelect+=`<option value=${rr.id}>${rr.name}</option>`;
 // 						}
	// 				}
	//         	document.getElementById(ar).innerHTML=optionSelect;
	//         	localStorage.setItem("item",'');
	//             })
	//         });
	// }

	// function agentTlName(){

	// 	const array=['agent_id','agent_id_ajax'];
	// 	for(ar of array){
	// 	var myEle = document.getElementById(ar);
	// 	if(myEle){
	//     if(ar=="tl_id"){
	// 			work(ar,'tlName');
	//       }else{
	// 			work(ar,'agentNameJson');
	//       }
	//   	}
	// 	}
	// }
