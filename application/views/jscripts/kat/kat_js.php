		...
		$.ajax({
		   ...
		   success: function(response){
				...
				for (var i in json_obj){
					...
					if(json_obj[i].exam_status == 2 || json_obj[i].exam_status == 3){
						html += '<td><span class="text-success"><b>Started</b></span></td>';
					} else if(json_obj[i].exam_status == 1) {
						html += '<td><span class="text-success"><b>Completed</b></span></td>';
					} else {
