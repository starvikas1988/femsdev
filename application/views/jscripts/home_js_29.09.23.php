...
$(document).on('click', '#submit_frm', function(e) {
        e.preventDefault();
        if($('#acknowledge_regime').is(':checked')){
...
var itd_popup_id = "<?php echo $itd_popup_id; ?>";
var is_submit = "<?php echo ($GetEmployeeRecordItd['status']==2)?$GetEmployeeRecordItd['status']: 0; ?>";
if(is_submit=="0"){
	if((itd_popup_id== "1" || itd_popup_id =="2" )) $('#it_declaration_popup').modal('show');
	else if(itd_popup_id=="3") $('#itdmodelnotification').modal('show');
}
