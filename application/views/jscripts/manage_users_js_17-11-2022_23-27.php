...
///////////////////	
	...
	$("#terminatefrmUser").click(function(){
		...
		if( uid!="" && disp_id!="" && terms_date!="" && t_type!="" && sub_t_type!="" && (remarks!="" || resign_remarks!="") && (is_rehire != "") ){
...
$(document).on('change','.frmTerminateUser #t_type',function()
    {
		id = $('.frmTerminateUser #t_type').val();
		if(id=='11'){
			is_active='2';
		}else{
			is_active='1';
		...
		process_ajax(function(response)
		{
			...
			console.log(dts);
			$('.frmTerminateUser #sub_t_type').html(dts);
