...
<script>
<?php
if(empty($reportType)){ $reportType = 'monthly'; }
?>
...
$('#adh_select_month,#adh_select_year').change(function(){
	monthCheck = $('#adh_select_month').val();
	yearCheck = $('#adh_select_year').val();
	window.location.href = '<?php echo base_url("home"); ?>' + '?select_month=' + monthCheck + '&select_year=' + yearCheck; 
});
