<script>
	...
	////////////////////////Approved Section//////////////////////////	
		...
		$(".userApprovedResign").click(function(){
			...
			casOffice = '<option value="">-Select-</option><option value="8">8 Days</option><option value="15">15 Days</option><option value="30">30 Days</option><option value="60">60 Days</option><option value="90">90 Days</option>';
