			...
			if (res.data_stock != null) {
				...
				var html_content = `<div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-1">
                                        <label for="exampleInputEmail1" class="form-label">Enter Release Date: <span style="color: red;">*</span></label>
