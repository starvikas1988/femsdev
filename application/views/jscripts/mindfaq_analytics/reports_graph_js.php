...
<?php if($content_template == "mindfaq_analytics/reports_visitors.php"){ ?>
...
<?php } ?>
<?php if($content_template == "mindfaq_analytics/reports_questions.php"){ ?>
...
<?php if($content_template == "mindfaq_analytics/reports_users.php"){ ?>
<?php if($reportType == "monthly" || $reportType == "all"){ ?>
//============================= TOP USER QUESTIONS ============================================
<?php
	$lastday = cal_days_in_month(CAL_GREGORIAN, $selected_month, $selected_year);
...
<?php if($content_template == "mindfaq_analytics/reports_overview.php"){ ?>
...
function saveImage(graph = 'daily_visitor', urlLoc){
  ...
  $.ajax({
	  type: "POST",
	  url: "<?php echo base_url('mindfaq_analytics/saveImageOnServer'); ?>",
	  data: { 
		 filData: dataURL,
		 fileName: fileName
	  }
