	...
	process_ajax(function(response)
	{
		...
		if (res.stat == true) 
		{
			...
			$.each(res.datas,function(index,element)
			{
				...
				if (element.assets_approve==element.assets_provide || element.assets_approve==total_assets_provided) { status = '<span>Done</span>'; }
				...
				if (element.assets_provide=='0' && res.inv_assets_his[element.user_id]=='0') { status = '<span>Pending</span>'; }

				if (res.bgv[element.user_id] == true) { button_access = '<?php if(it_assets_full_access()==true){ ?><button type="button" title="Assign assets" class="btn btn-xs model_users_assets" dfr_id="'+dfr_id+'" user_id="'+element.user_id+'" user_name="'+element.can_name+' ('+element.fusion_id+')" ><img src="<?php echo base_url();?>assets_home_v3/images/assets_jitbit.svg" alt=""></button><?php } ?>'; }

				else { button_access = '<span>BGV Pending</span>'; } 
				...
				if (res.datas2[assets_id] != null || res.datas5[assets_id] != null) {
					...
					if(element.is_inv == 1) {
						...
						if (res.datas2[assets_id] != null) {
							section_1 = '<div class="col-sm-3"><p><span class="form-label">Status: <span>Provided </span></span><p></div>';
							section_3 = '<div class="col-sm-3"><p><span class="form-label">Serial Number: <span>'+res.datas2[assets_id][0].serial_number+'</span></span></p></div><div class="col-sm-3"></div> <div class="col-sm-3"> <p><span class="form-label">Reference ID: <span>'+res.datas2[assets_id][0].reference_id+' </span></span><p></div> <div class="col-sm-3"> <p><span class="form-label">Brand Name: <span>'+res.datas2[assets_id][0].brand_name+' </span></span><p></div> <div class="col-sm-3"> <p><span class="form-label">Configuration/Details: <span>'+res.datas2[assets_id][0].configuration+' </span></span><p></div>';
						}
						else { 
							section_1 = '<div class="col-sm-3"><p><span class="form-label">Status: <span>Provided </span></span><p></div>';
							section_3 = '<div class="col-sm-3"><p><span class="form-label">Serial Number: <span>'+res.datas5[assets_id][0].serial_number+'</span></span></p></div><div class="col-sm-3"></div> <div class="col-sm-3"> <p><span class="form-label">Reference ID: <span>'+res.datas5[assets_id][0].reference_id+' </span></span><p></div> <div class="col-sm-3"> <p><span class="form-label">Brand Name: <span>'+res.datas5[assets_id][0].brand_name+' </span></span><p></div> <div class="col-sm-3"> <p><span class="form-label">Configuration/Details: <span>'+res.datas5[assets_id][0].configuration+' </span></span><p></div>';
						}
					}
					else { 
						if (res.datas2[assets_id] != null && res.datas2[assets_id][0].comments != null) {
					...
					if(element.is_inv == 1) {
						if (res.datas3[assets_id] >= element.assets_required) {
							section_1 = '<div class="col-sm-6"><p><span class="form-label">Status: <span>Required Asset is '+element.assets_required+' (Assets filled up)</span></span><p></div>';
							section_2 = "";
							section_3 = "";			
						}
						else {
							if (res.datas4[assets_id] != null) {
								...
								section_1 = '<div class="col-sm-3"><p><span class="form-label">Status: <span>Not in Stock</span></span><p></div>';
								section_2 = "";
								section_3 = "";
							}
						}
...
if(add_total > 0) {
	...
	{
		html += `<div class="modal-card" id="section_add_stock-${i}"><div class="title_with_bg stk_padding form-group"><div class="row d_flex"><div class="col-sm-6"><h4>No. ${i}</h4></div><div class="col-sm-6"><div class="mb-1"><button class="btn remove-btn add-stock-remove" value="${i}"><img src="<?php echo base_url();?>assets_home_v3/images/delete_action.svg" alt=""></button></div></div></div></div><div class="row">

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Model Number: </label><input type="text" class="form-control" name="model_no[]" maxlength="150" placeholder="Enter Model Number"></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Serial Number: <span style="color: red;">*</span></label><input type="text" class="form-control" name="serial_no[]" id="add_stock_serial_number" required maxlength="150" placeholder="Enter Serial Number"></div></div>

			<div class="col-sm-4"><div class="mb-1"> <label for="exampleInputEmail1" class="form-label">Assets Details/Configuration:</label><input type="text" class="form-control" name="config[]" maxlength="150" placeholder="Enter Asset Details"></div></div>

			<div class="col-sm-4"> <div class="mb-1"><label for="exampleInputEmail1" class="form-label">PO Number: <span style="color: red;">*</span></label><input type="text" class="form-control" name="po_number[]" maxlength="150" placeholder="Enter PO Number" required> </div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Purchase Type: <span style="color: red;">*</span></label><select class="form-control" name="purchase_type[]" required><option value="" selected disable>Select an option</option> <option value="1">OpEx</option> <option value="2">CapEx</option> </select> </div> </div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Processor: </label><select class="form-control ast_department_add_stock" name="ast_department[]"></select></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Ram: </label><select class="form-control ram_add_stock" name="ram_ids[]"> </select></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Storage Device Type: </label><select class="form-control" name="purchase_dev_type[]"><option value="" selected disable>Select an option</option><option value="1">SSD</option> <option value="2">HDD</option></select></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Storage Device: </label><select class="form-control storage_device_add_stock" name="storage_device[]"> </select></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Own/Rental/Client: <span style="color: red;">*</span></label><select class="form-control" name="own_rental[]" required><option value="" selected disable>Select an option</option><option value="1">Own</option><option value="2">Rental</option><option value="3">Client</option></select></div></div>

			<div class="col-sm-4"><div class="mb-1"> <label for="exampleInputEmail1" class="form-label">Date Purchase : <span style="color: red;">*</span></label><input type="date" class="form-control" name="date_purcahse[]" required></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Vendor Name: <span style="color: red;">*</span></label> <select class="form-control vendor_name_add_stock" name="vendor_name[]" required></select></div> </div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Under Validity/Warranty: <span style="color: red;">*</span></label><select class="form-control under_validity_add_stock" name="under_validity[]" required><option value="" selected disable>Select an option</option> <option value="1">Yes</option> <option value="2">No</option> </select></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Valid till :</label><input type="date" class="form-control add_stock_valid_thru" name="under_validity_date[]"></div></div>

			<div class="col-sm-4"><div class="mb-1"> <label for="exampleInputEmail1" class="form-label">Select OS: </label><select class="form-control os_add_stock" name="os_ids[]"></select></div></div>

			<div class="col-sm-4"><div class="mb-1"> <label for="exampleInputEmail1" class="form-label">Conditions: </label> <input type="text" class="form-control" name="conditions[]" maxlength="150" placeholder="Enter Condition"></div></div>

			<div class="col-sm-4"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Physical Locations: </label><select class="form-control phy_location_add_stock" name="phy_location[]"></select></div></div>

			<div class="col-sm-4"> <div class="mb-1"><label for="exampleInputEmail1" class="form-label">Company Brand: </label><select class="form-control assest_company_brand_mst" name="campaign_name[]"></select></div></div>

			<div class="col-sm-4"> <div class="mb-1"><label for="exampleInputEmail1" class="form-label">Battery Qty: </label><input type="number" min="1" oninput="validity.valid||(value='');" class="form-control" placeholder="Enter Battery Qty" name="battery_qty[]" id="battery_qty"></div></div>   

 			<div class="col-sm-4"> <div class="mb-1"><label for="exampleInputEmail1" class="form-label">Last Inspection Date: </label><input type="date" class="form-control" name="last_inspection_date[]"></div></div>

		    <div class="col-sm-12"><div class="mb-1"><label for="exampleInputEmail1" class="form-label">Remarks:</label><input type="text" class="form-control" name="remarks[]" maxlength="200" placeholder="Enter Comment"></div></div></div></div>`;
	}
...
$(document).on('click','.edit_stock_entry',function(){
	...
	let office_abbr = arrPrams[23];
	let battery_qty = arrPrams[24];
	let inspection_date = arrPrams[25];
	...
	$("#edit-stock-details #update-stock-details-submit #battery_qty").val(battery_qty);
	$("#edit-stock-details #update-stock-details-submit #date_of_last_inspection").val(inspection_date);
	...
	process_ajax(function(response)
	{
		var res = JSON.parse(response);
		if (res.stat==true) {
			var options_vendor=options_brand=options_office_location=sel='';
            ...
            $.each(res.location_assets_edit,function(index,element) {
                if(office_abbr == element.abbr) { sel = "selected"; }
                else { sel = ""; }
                options_office_location += '<option value="'+element.abbr+'" '+sel+'>'+element.office_name+'</option>';
            });
			...
			$("#edit-stock-details #update-stock-details-submit #office_location").html(options_office_location);
		}
...
<script>
$(document).on('change','#assset_stock_search .search_stock_id',function(){
	...
	if($(this).attr('id')=='search_from_date') $("#search_end_date").val('');

	if($(this).attr('id')=='search_end_date') {
		let start_date = $("#search_from_date").val();
		...
		if(start_date!="") {
      		...
      		if(start_date > end_date) {
      			...
      			$("#stock_dashboard_search").prop("disabled", true);
      		}
      		else {
      			$("#stock_dashboard_search").prop("disabled", false);
      		}
		}
		else { 
			check_validation = false; alert("Please select From date!"); 
			$("#stock_dashboard_search").prop("disabled", true);
		}
	}
	...
	if (check_validation) {
		...
		process_ajax(function(response)
		{
			...
			$('#stock-reference-id-search').multiselect('rebuild');
			$('#stock-serial-number-search').multiselect('rebuild');
...
<?php if ($content_template=="dfr_it_assets/stock_entry.php") { ?>
...
<script>
	$(document).on('click','.view_stock_details',function()
    {
		...
		{
			var res = JSON.parse(response);
			var option_user = '<h4 style="margin-left: 7px;">Assets Assigned history: </h4>';
				...
				$.each(res.assigned_user,function(index,element)
				{
					if(element.return_date == null){
						...
						if (element.is_user_acknowledge==2) {
							stock_return_by = '<div class="col-sm-12"><h5><span style="font-weight: bold;">Return By: </span><span>(Assets Assignment Declined By User)</span></h5></div>';
						}
						else {
					...
					if (element.is_user_acknowledge == 1) { var user_ack = "<span>Done</span>"; }
					else if (element.is_user_acknowledge == 2) { var user_ack = "<span>Declined</span>"; }
					else { var user_ack = "<span>Pending</span>"; }
			...
			if(res.stock_details[0].last_inspection_date != null && res.stock_details[0].next_inspection_dur_days != null) {

				var originalDate = new Date(res.stock_details[0].last_inspection_date);

				var daysToAdd = parseInt(res.stock_details[0].next_inspection_dur_days, 10);

				originalDate.setDate(originalDate.getDate() + daysToAdd);

				console.log(originalDate);

				var next_inspection_date = originalDate.toISOString().slice(0, 10);	
			}
			else var next_inspection_date = "NA";
			...
			$('#stock_details .stock_details_result').html('<div class="col-sm-6"> <h5><span style="font-weight: bold;">Reference ID:</span> '+res.stock_details[0].reference_id+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Serial Number:</span> '+res.stock_details[0].serial_number+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Model Number:</span> '+assets_arr.check_null_val(res.stock_details[0].model_number)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Assets Details:</span> '+assets_arr.check_null_val(res.stock_details[0].configuration)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Brand Name:</span> '+res.stock_details[0].brand_name+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">PO Number:</span> '+assets_arr.check_null_val(res.stock_details[0].po_number)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Purchase Type:</span> '+purchase_type+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Processor:</span> '+assets_arr.check_null_val(res.stock_details[0].dpt_name)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Ram Size:</span> '+assets_arr.check_null_val(ram_size)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Storage Device Type:</span> '+assets_arr.check_null_val(storage_device_type)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Storage Device Size:</span> '+assets_arr.check_null_val(res.stock_details[0].strg_name)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Own/Rental/Client:</span> '+own_rental+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Date Purchase:</span> '+assets_arr.check_null_val(res.stock_details[0].data_purchase)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Vendor Name:</span> '+res.stock_details[0].vendor_name+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Under Validity:</span> '+under_validity+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Valid Till:</span> '+assets_arr.check_null_val(res.stock_details[0].valid_thru)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">OS Name:</span> '+assets_arr.check_null_val(res.stock_details[0].os_name)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Conditions:</span> '+assets_arr.check_null_val(res.stock_details[0].conditions)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Physical Location:</span> '+assets_arr.check_null_val(res.stock_details[0].phy_location)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Company Brand:</span> '+assets_arr.check_null_val(res.stock_details[0].company_brand_assets)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Remarks:</span> '+assets_arr.check_null_val(res.stock_details[0].reamrks)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Status Comments:</span> '+assets_arr.check_null_val(res.stock_details[0].comments_status)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Type:</span> '+assets_arr.check_null_val(type)+'</h5> </div> <div class="col-sm-6"> <h5><span style="font-weight: bold;">Raised By:</span> '+res.stock_details[0].raised_by_name+'</h5> </div><div class="col-sm-6"> <h5><span style="font-weight: bold;">Vendor Email:</span> '+assets_arr.check_null_val(res.stock_details[0].vendor_email)+'</h5> </div><div class="col-sm-6"> <h5><span style="font-weight: bold;">Vendor Contact No:</span> '+assets_arr.check_null_val(res.stock_details[0].vendor_phNo)+'</h5> </div><div class="col-sm-6"> <h5><span style="font-weight: bold;">Battery Qty:</span> '+assets_arr.check_null_val(res.stock_details[0].battery_qty)+'</h5> </div><div class="col-sm-6"> <h5><span style="font-weight: bold;">Last Inspection Date:</span> '+assets_arr.check_null_val(res.stock_details[0].last_inspection_date)+'</h5> </div><div class="col-sm-6"> <h5><span style="font-weight: bold;">Next Inspection Date:</span> '+assets_arr.check_null_val(next_inspection_date)+'</h5> </div>');
...
$(document).on('change','#myModal-assets-req-generate #client_id_hod',function()
{
	...
	var request_url = "<?php echo base_url('users/getProcessList'); ?>";
	process_ajax(function(response)
	{
		var res = JSON.parse(response);
		console.log(res);
		...
		if (res.stat == true) {
			...
			if (res.data_user[0].ack_doc!=null) {
				...
				var user_document_details = `<div class="modal-card new-tab"><div class="row">
                                <div class="col-md-4">
                                <div> <label  class=" font-look righT">View Document :</label> <span class="font-look lefT"><a href="<?=base_url()?>it_assets_import/ack_doc/${res.data_user[0].ack_doc}" target="_blank"><img src="<?php echo base_url();?>assets_home_v3/images/view.svg" alt=""></a></span></div>
                                </div>
                                 <div class="col-md-4">
                                <div> <label  class=" font-look righT">Upload By :</label> <span class="font-look lefT">${res.data_user[0].doc_upload_by}</span></div>
                                </div>

                                 <div class="col-md-4">
                                <div> <label  class=" font-look righT">Upload Date :</label> <span class="font-look lefT">${res.data_user[0].doc_upload_date}</span></div>
                                </div> 
                            </div>
                    </div>`
                         ...
                         <div class="row new-section">
                             <div class="col-sm-5">
                                    ...
                                    <input type="hidden" name="tab_id" value="${res.data_user[0].id}">
                                        <label for="exampleInputEmail1" class="form-label">Document Upload <span class="red_bg small_font">*(Only PDF File allowed, Max Size 5MB)</span></label>
                                 ...
                                 <div class="col-sm-2">
								  <label class="visiblity_hidden d_block">Upload</label>
                                   <button class="btn btn_padding filter_btn_blue" type="submit">Upload</button>
                                </div>
                        </div>
                    </div></form>`;
...
$(document).on('click','.assign_assets_to_floor',function()
{
	//$("#assign_stock_to_floor form")[0].reset();
	//$('.selectpicker').selectpicker('refresh');

	var params=$(this).attr("params");	
	var arrPrams = params.split("~#~");
	$("#assign_stock_to_floor #assets_details").text("Reference ID: "+arrPrams[0]+" | Serial Number: "+arrPrams[1]);
	var stock_id = arrPrams[3];
	$("#assign_stock_to_floor #stock_id").val(stock_id);
	var request_url = "<?php echo base_url('dfr_it_assets/check_stock_floor_assign'); ?>";
	var datas = {'stock_id': stock_id};
	process_ajax(function(response)
	{
		var res = JSON.parse(response);
		if (res.stat == true) {
			if (res.data_stock != null) {

				var client_name = process_name = dept_name = tr_details = ''; var c=1;
				$.each(res.data_stock,function(index,element)  
				{
					client_name = element.client_name!=null ? element.client_name : "All";
					dept_name = element.department_name!=null ? element.department_name : "All";
					process_name = element.process_name!=null ? element.process_name : "All";
					tr_details += '<tr><td>'+c+'</td><td>'+element.assets_name+'</td><td>'+element.assigned_by+'</td><td>'+element.assign_date+'</td><td>'+client_name+'</td><td>'+process_name+'</td><td>'+dept_name+'</td><td>'+element.comments+'</td></tr>';
					c++;
				});
				...
				var html_content = `<div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-1">
                                        <label class="form-label ">Select Status <span class="red_bg">*</span></label>
                                            <select style="cursor: pointer" autocomplete="off" class="form-control" name="status_id" id="status_id" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-1">
                                        <label for="exampleInputEmail1" class="form-label">Enter Release Date: <span class="red_bg">*</span></label>
				...
				$("#assign_stock_to_floor form").attr("id","assets_stock_floor_release");
				$("#assign_stock_to_floor #submit_assignment").text("Release");

			}
			else {
				var department_list = '<option value="">All</option>';
				$.each(res.department_list,function(index,element)
				{
					department_list += '<option value="'+element.id+'">'+element.shname+'</option>';
				});

				var clients_list = '<option value="">All</option>';
				$.each(res.client_list,function(index,element)
				{
					clients_list += '<option value="'+element.id+'">'+element.shname+'</option>';
				});


				///Assign
				var html_content = `<div class="row" id="assign_form">
                                <div class="col-sm-6">
                                    <div class="mb-1">
                    ...
                    || (event.keyCode==46) )" class="form-control" placeholder="Jitbit ID" name="jitbit_id" id="jitbit_id" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-1">
                                        ...
                                        <select style="cursor: pointer;" class="form-control" name="department_id">
                                            ${department_list}
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-1">
                                        ...
                                        <select style="cursor: pointer;" class="form-control" id="client_id_assets" name="client_id">
                                        	${clients_list}
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="mb-1">
                                        ...
                                        <select style="cursor: pointer;" class="form-control" id="process_id" name="process_id">
				...
				$("#assign_stock_to_floor form").attr("id","assets_stock_floor_assign");
				$("#assign_stock_to_floor #submit_assignment").text("Assign");
			}

			$("#model_content_assets").html(html_content);

		}
		else {
			alert(res.errmsg);
			$("#model_content_assets").html("<h4 style='color:red'>Something is wrong!</h4>");
		}
	},request_url, datas, 'text');

	$('#assign_stock_to_floor').modal('show');
	
});
$(document).on('change','#assign_stock_to_floor #client_id_assets',function() {
	var client_id=$(this).val();
	if (client_id=="") {
		$('#assign_stock_to_floor #process_id').html('<option value="">All</option>');
	}else {
		var request_url = "<?php echo base_url('dfr_it_assets/get_client_process_list'); ?>";
		var datas = {'client_id': client_id};
		process_ajax(function(response)
		{
			var res = JSON.parse(response);
			$('.select_refresh').selectpicker();
				if (res.data_stock != null) {

					var tr_detail = '<option value="">All</option>';
					$.each(res.data_stock,function(index,element)
					{
						tr_detail += '<option value="'+element.id+'">'+element.name+'</option>';
					});
					$('#assign_stock_to_floor #process_id').html(tr_detail);
				}
