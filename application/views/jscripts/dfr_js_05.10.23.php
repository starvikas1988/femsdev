...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#candidateFinalSelection").click(function () {
            ...
            } else if(isUSLocation(off_id) == true) {
                $('#xpoid').attr("required", "true");
            } else {
                $('#xpoid').removeAttr("required");
            }
        ...
        $(".finalSelection").click(function () {
            ...
            if(carrPrams[10] == 'ALB'){
                ...
                if (isUSLocation(carrPrams[10]) == true) {
                    $xpoid_title = 'Emp ID/XPO ID/Paycom ID <span class="red_bg">*</span>';
                    $(".frmfinalSelection #xpoid").attr("oninput", "checkpaycomID()");
                    $(".frmfinalSelection #xpoid").attr("onfocusout", "checkpaycomID()");
                    $(".frmfinalSelection #xpoid").attr("data-location", carrPrams[10]);
                }else{
