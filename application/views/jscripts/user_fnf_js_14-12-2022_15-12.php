	...
	$(".editfnfITLocalTeam").click(function(){
		...
		process_ajax(function(response)
		{
			...
			if (res.active_ast==true) {
				...
				$('#assets_maintanance_div #it_local_user_assets_details').html('<tr><td>No Active Assets Found!<td><tr>');
			...
			if (res.release_ast==true) {
				...
				$('#assets_maintanance_div #it_local_user_assets_details_returned').html('<tr><td>No Data Found!<td></tr>');
			}
		}
		else {
			alert(res.errmsg);
	...
	process_ajax(function(response)
	{
		...
		if (res.stat == true) {
			if (res.active_ast==true) {
				...
				$('#procurement_fnf_model #user_assets_details').html('<tr><td>No Active Assets Found!<td><tr>');
			...
			if (res.release_ast==true) {
				...
				$.each(res.datas_release,function(index,element)
				{
					...
					assets_details_release += '<tr><td>'+element.user_name+'</td><td>'+element.assets_name+'</td><td>'+element.serial_number+'</td><td>'+element.model_number+'</td><td>'+element.raised_date+'</td><td>'+it_local_return_date+'</td><td>'+fnf_it_doc+'</td><td>'+element.fnf_it_local_comment+'</td><td>'+element.return_date+'</td><td>'+fnf_doc+'</td><td>'+element.fnf_return_comment+'</td><td>'+element.return_by_name+'</td></tr>';
				});
				$('#procurement_fnf_model #user_assets_details_returned').html(assets_details_release);
			}
			else {
				$('#procurement_fnf_model #user_assets_details_returned').html('<tr><td>No Data Found!<td></tr>');
			}
		}
		else {
			alert(res.errmsg);
	...
	process_ajax(function(response)
	{
		...
		if (res.stat == true) {
			if (res.active_ast==true) {
				...
				$.each(res.datas_active,function(index,element)
				{
					...
					if(element.fnf_hr_status != '1'){
						assets_details += '<tr><td>'+element.user_name+'</td><td>'+element.assets_name+'</td><td>'+element.serial_number+'</td><td>'+element.model_number+'</td><td>'+element.raised_date+'</td><td>'+it_local_return_date+'</td><td>'+fnf_it_doc+'</td><td>'+element.fnf_it_local_comment+'</td><td>'+element.fnf_return_comment+'</td><td><input class="form-control" type="date" name="hr_acceptance_date[]" value="<?=date("Y-m-d")?>" required></td><td><input style="width: 18px;margin-left: 13px;" class="form-control" type="checkbox" name="is_hr_acceptance[]" value="'+element.id+'" required></td></tr>';
					}else{
						assets_details += '<tr><td>'+element.user_name+'</td><td>'+element.assets_name+'</td><td>'+element.serial_number+'</td><td>'+element.model_number+'</td><td>'+element.raised_date+'</td><td>'+it_local_return_date+'</td><td>'+fnf_it_doc+'</td><td>'+element.fnf_it_local_comment+'</td><td>'+element.fnf_hr+'</td><td>'+element.fnf_return_comment+'</td><td>Completed</td></tr>';
					}
				...
				$('#acceptance_fnf_model #user_assets_details').html('<tr><td>No Active Assets Found!<td><tr>');
			...
			if (res.release_ast==true) {
				...
				$('#acceptance_fnf_model #user_assets_details_returned').html('<tr><td>No Data Found!<td></tr>');
			}
		}
		else {
			alert(res.errmsg);
