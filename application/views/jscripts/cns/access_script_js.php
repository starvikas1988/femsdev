<script>
    $( "#add_button" ).click(function() {
       ...
       if(loc!=''){
            $.ajax({
                type:'POST',
                url:'<?php echo base_url();?>/cns/add_location_access',
    ...
    $( "#edit_button" ).click(function() {
       ...
       if(loc!=''){
            $.ajax({
                type:'POST',
                url:'<?php echo base_url();?>/cns/edit_location_access',
    ...
    function delete_cns_location(id,name){
        $('#id').val(id);
        $('#location').val(name);
        ids=id;
