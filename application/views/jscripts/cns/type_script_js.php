<script>
    $( "#add_button" ).click(function() {
       ...
       if(typ!=''){
            $.ajax({
                type:'GET',
                url:'<?php echo base_url();?>/cns/add_type',
                data:'type='+typ,
    ...
    $( "#edit_button" ).click(function() {
       ...
       if(typ!=''){
            $.ajax({
                type:'GET',
                url:'<?php echo base_url();?>/cns/edit_type',
    ...
    function get_cns_type_data(id,name){
        
        $('#edit_id').val(id);
        $('#edit_type').val(name);
    }
    function delete_cns_type(id,status){
        ids=id;
        var result = confirm('Do you want to perform this action?');
        if(result){
            $.ajax({
                type:'GET',
                url:'<?php echo base_url();?>/cns/delete_type',
