	...
	$('#break_check_button_sd').change(function(){
		if($(this).prop("checked")==true){
			...
			if(willDelete){
				...
				$.post("<?php echo base_url();?>user/break_on_system_downtime",function(data){
					//window.location.href = "<?php echo base_url().get_role_dir();?>/dashboard";
					window.location.href = "<?php echo base_url();?>home";
				});
				...
				$.post("<?php echo base_url();?>user/break_off_system_downtime",function(data){
					if(data==1){	
						$(this).prop("checked",false);
						//window.location.href = "<?php echo base_url().get_role_dir();?>/dashboard";
						window.location.href = "<?php echo base_url();?>home";
		...
		if($(this).prop("checked")==true){					
			...
			if(willDelete){
				...
				$.post("<?php echo base_url();?>user/break_on_coaching",function(data){
					//window.location.href = "<?php echo base_url().get_role_dir();?>/dashboard";
					window.location.href = "<?php echo base_url();?>home";
				});
				...
				$.post("<?php echo base_url();?>user/break_off_coaching",function(data){
					if(data==1){	
						$(this).prop("checked",false);
						//window.location.href = "<?php echo base_url().get_role_dir();?>/dashboard";
						window.location.href = "<?php echo base_url();?>home";
...
if(seconds_sd > 0){
	var countdownTimer_sd = setInterval('timer_sd()', 1000);
}

if(seconds_cb > 0){
	var countdownTimer_cb = setInterval('timer_cb()', 1000);
}
