...
$('.conduent_points').each(function(index,element){
	...
	var score_type = $(element).val();
		...
		if($('#condtAF1').val()=='No' || $('#condtAF2').val()=='No' || $('#condtAF3').val()=='No' || $('#condtAF4').val()=='No' || $('#condtAF5').val()=='NO' || $('#condtAF6').val()=='No' || $('#condtAF7').val()=='No' || $('#condtAF8').val()=='No' || $('#condtAFbtl2').val()=='Yes' || $('#condtAFbtl3').val()=='Yes'){
			$('.conduentFatal').val(0);
		}else{
			$('.conduentFatal').val(quality_score_percent+'%');
		}
	...
	////////////
		...
		$(document).ready(function(){
		$(document).on('change','.conduent_points',function(){ conduent_score(); });
		conduent_score();
...
//////////////////////////////////////////////////////////////////////////////////////
		...
		valNum=$(this).val();
		if(valNum == "Yes" || valNum == "Unacceptable"){
		score=0;
		return false;
		}
		});
