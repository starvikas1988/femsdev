    ...
    $("#from_date").datepicker({
        onSelect: function(selected){
            ...
            if (var_js[$("#form-leave_type").val()][0] == 13 && is_ind_loc == 1) {
                ...
                // $("#ptl_div_india #delivery_date").attr("required", "true");
                // $("#ptl_div_india #child_first_name").attr("required", "true");
                // $("#ptl_div_india #child_last_name").attr("required", "true");
            ...
            if (var_js[$("#form-leave_type").val()][0] == 11 && is_ind_loc == 1) {
                ...
                if (Math.round(ml_difference_In_Days) >= 80) {
...
function date_change_checks(){
    if($("#from_date").val()!="" && $("#to_date").val()!=""){  
        ...
        if((leave_type_id !='' && var_js[leave_type_id][3] != 0) || leave_type_id == 40){
            from_date = new Date($("#from_date").val());
            to_date = new Date($("#to_date").val());
