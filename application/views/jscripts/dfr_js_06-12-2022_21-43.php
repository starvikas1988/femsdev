...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#editRequisitionAssets").click(function() {
        ...
        $('.frmAddCandidate').submit(function() {
            ...
            if (error) {
                ...
                if (dt == 1) {
                    ...
                    alert("please fill up all mandatory fileds");
                }
            }
        ...
        $('[type="radio"][name="hiring_source"]').click(function() {
            if ($(this).is(":checked")) {
                $('#referal').removeAttr('required');
        ...
        $("#job_source_portal").click(function() {
            if ($(this).is(":checked")) {
        ...
        $("#job_source_consult").click(function() {
            if ($(this).is(":checked")) {
                $("#not_friend_referal").show();
                $("#ref_name").removeAttr("placeholder");
        ...
        $("#job_source_callHR").click(function() {
            if ($(this).is(":checked")) {
                $("#not_friend_referal").show();
        ...
        $("#job_source_newspaper").click(function() {
            if ($(this).is(":checked")) {
                $("#not_friend_referal").show();
        ...
        $("#job_source_walkin").click(function() {
            if ($(this).is(":checked")) {
                $("#not_friend_referal").hide();
                $('#ref_name').removeAttr('required');
            }
        });
        $("#ref_name1").on('change', function() {
...
<script>
    $('#qualification_type').change(function() {
        ...
        if (value != 'Others') {
            ...
            $('#qualification_type').parent().parent().addClass('col-md-4');
            $('#req_qualification_container').hide();
        } else {
            $('#req_qualification').val('');
            $('#req_qualification_container').show();
            $('#qualification_type').parent().parent().removeAttr('class');
            $('#qualification_type').parent().parent().addClass('col-md-2');
        }
    });
</script>
...
<script>
    $(document).ready(function() {
        ...
        $('#gross_amount, #pay_type, #skill_set_slab, #emp_type').on('keyup change', function() {
            //alert(11);
            ...
            if (isIndiaLocation(location_id) == true || location_id == "CHA") {
                ...
                if (pay_type == "1" || pay_type == "7" || pay_type == "8" || pay_type == "9") {
                    ...
                    if (gr_amt >= 1000) {
                        ...
                        if (gender == "" && location_id == "MUM") alert("Gender Field is blank");
						pt = get_ptax(gr_amt, location_id, gender);
						
						var gr_amt_esi = Math.round(gr_amt - conv_amt);
						esi_employers = get_esi_employer(gr_amt_esi, location_id, gr_amt);
						esi_employees = get_esi_employee(gr_amt_esi, location_id, gr_amt);
						...
						var ctc_year =  Math.round(gross_year + employers_contribution_year);
						
						var tk_home_year =  Math.round(gross_year - employees_deduction_year);
