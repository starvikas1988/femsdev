		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">QA Kenny-U-Pull Report</h4></header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_kenny_u_pull/qa_kenny_u_pull_report'); ?>">	
						  <?php echo form_open('',array('method' => 'get')) ?>
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>Qa_kenny_u_pull/qa_kenny_u_pull_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1;
									foreach($qa_kenny_u_pull_list as $row){ ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php 
											if($row['entry_by']!=''){
