							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<?php if($kenny_u_pull['entry_by']!=''){
										...
										<td colspan="3"><input type="text" class="form-control" value="<?php echo mysql2mmddyy($kenny_u_pull['audit_date']); ?>" disabled></td>
										<td style="width:150px">Call Date:</td>
										<td colspan="3"><input type="text" class="form-control" value="<?php echo mysql2mmddyy($kenny_u_pull['call_date']); ?>" disabled></td>
									</tr>
									<tr>
										<td>Agent:</td>
										<td>
									...
									<tr>
										...
										<td>case:</td>
										<td colspan="3"><input type="text" class="form-control" id="case" name="case" value="<?php echo $kenny_u_pull['case']; ?>" disabled>
										</td>
									</tr>
									<tr>
										<td>Audit Type:</td>
									...
									<tr>
										...
										<td ><input type="text" readonly id="kennyPossibleScore" name="" class="form-control" style="font-weight:bold" ></td>
										<td style="font-weight:bold">Earned Score:</td>
										<td colspan="3"><input type="text" readonly id="kennyEarnedScore" name="" class="form-control" style="font-weight:bold" ></td>
									...
									<tr>
										...
										<td colspan=2><input type="text" class="form-control" name="cmt11" value="<?php echo $kenny_u_pull['cmt12'] ?>" disabled></td>
										<td>Business</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control kennyVal customer" id="" name="adherence_process" disabled>
									...
									<tr style="background-color:#D2B4DE">
										<td>Percentage:</td><td colspan="2"><input type="text" class="form-control" value="<?php echo $kenny_u_pull['customer_score'] ?>" disabled></td>
										<td>Percentage:</td><td colspan="2"><input type="text" class="form-control" value="<?php echo $kenny_u_pull['business_score'] ?>" disabled></td>
										<td>Percentage:</td><td colspan="2"><input type="text" class="form-control" value="<?php echo $kenny_u_pull['compliance_score'] ?>" disabled></td>
									</tr>


									<tr>
										<td>Call Summary:</td>
										<td colspan=2><textarea class="form-control" id="" name="call_summary" disabled><?php echo $kenny_u_pull['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan=4><textarea class="form-control" id="" name="feedback" disabled><?php echo $kenny_u_pull['feedback'] ?></textarea></td>
									</tr>
									...
									<tr><td style="font-size:16px" colspan="2">Manager Review:</td> <td colspan=7 style="text-align:left"><?php echo $kenny_u_pull['mgnt_rvw_note'] ?></td></tr>
									<tr><td style="font-size:16px" colspan="2">Client Review:</td> <td colspan=7 style="text-align:left"><?php echo $kenny_u_pull['client_rvw_note'] ?></td></tr>
									...
									<form id="form_agent_user" method="POST" action="">
										...
										<tr>
											...
											<td colspan=7><textarea class="form-control" name="note" required><?php echo $kenny_u_pull['agent_rvw_note'] ?></textarea></td>
										</tr>
