					...
					<div class="row">
						<div class="col-md-9">
							<header class="widget-header">
								<h4 class="widget-title">Search Audit For Feedback</h4>
							</header>
				</div>
			</div>		
		</div>
			...
			<div class="col-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-9">
							<header class="widget-header">
								<h4 class="widget-title">Audit Feedback</h4>
							</header>
						</div>
						<hr class="widget-separator">
					</div>
					<div class="widget-body">
						<form id="form_agent_feedback" method="GET" action="<?php echo base_url('qa_audit_dyn/agent_audit_feedback/'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url()?>qa_audit_dyn/agent_audit_feedback" type="submit" id='btnViewAgent' name='btnView' value="View">View</button>
								</div>
							</div>
						</form>
					</div>
								...
								<tbody>
									<?php $i=1;
										...
										<tr>
											...
											<td><?php $pr_name = $row['process']!=''?getProcessName($row['process']):'NA';
											echo $pr_name ?></td>
											...
											<td>
												<?php $ob_id=$row['id']; ?>
												<?php $qa_defect_id=$row['qa_defect_id']; ?>
											
												<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_audit_dyn/agent_audit_rvw/<?php echo $ob_id; ?>/<?php echo $qa_defect_id; ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
