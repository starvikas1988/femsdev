		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">Myglamm CQ sheet</h4></header>
						</div>	
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('qa_myglam/qa_myglam_report'); ?>">	
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="form-group">
									<label>Select Audit Old/New</label>
									<select class="form-control" name="audit_table" required>
										<option value=''>Select</option>
										<option <?php echo $audit_table=='qa_myglam_feedback'?"selected":""; ?> value="qa_myglam_feedback">qa_myglam_old_feedback</option>
										<option <?php echo $audit_table=='qa_myglam_new_feedback'?"selected":""; ?> value="qa_myglam_new_feedback">qa_myglam_new_feedback</option>
									</select>
								</div>
							</div>
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>qa_myglam/qa_myglam_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
