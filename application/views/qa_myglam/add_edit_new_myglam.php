							...
							<table class="table  skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<select class="form-control safe_point " name="data[budget_preferance]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control safe_point" id="tvsAF1" name="data[Communication9]" required>
									...
									<tr>
										...
										<td>
											<select class="form-control safe_point"  name="data[Closing5]" required>
