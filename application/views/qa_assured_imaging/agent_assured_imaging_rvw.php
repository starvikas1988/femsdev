						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px; text-align:center!important; ">Assured Imaging AGENT FORM</td>
										...
										<tr>
											<td colspan=3>   Rescheduling: Follow the established procedure for rescheduling appointments, accommodating customer requests<br> while considering availability and minimizing disruption. Document any and all changes<br> made and why.</td>
										...
										<tr>
											<td colspan=3> Cancellations: Follow the established procedure for canceling appointments, updating the scheduling<br> system, and notifying the relevant parties. Document any and all changes<br> made and why. </td>
