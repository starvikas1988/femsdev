		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">Assured Imaging Report</h4></header>
						</div>
					...
					<div class="widget-body">
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_assured_imaging/qa_assured_imaging_report'); ?>">
							 ...
							 <div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" id="campaign" name="campaign" required>
										...
										<option <?php echo $campaign=='assured_imaging'?"selected":""; ?> value="assured_imaging">Assured Imaging</option>
										<option <?php echo $campaign=='assured_imaging_card'?"selected":""; ?> value="assured_imaging_card">Audit Card</option>
									</select>
								</div>
							</div> 
						...
						<div class="row">
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary blains-effect" a href="<?php echo base_url()?>Qa_assured_imaging/qa_assured_imaging_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									...
									foreach($qa_assured_imaging_list as $row){ ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php
											if($row['entry_by']!=''){
