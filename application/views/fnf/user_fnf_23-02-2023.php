...
<div class="wrap">
	<section class="app-content">
		...
		<div style='float:right; margin-top:5px;' class="col-md-12 new-btn-group">
				<?php if($status=="1") { ?>				
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<div class="input-group selectdatepick" style="cursor:pointer">
										...
										<input readonly type="text" class="form-control" value="<?php echo $date_from; ?>" name="date_from" id="date_from" placeholder="From Date" >
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="input-group selectdatepick" style="cursor:pointer">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
										<input readonly type="text" class="form-control" value="<?php echo $date_to; ?>" name="date_to" id="date_to" placeholder="To Date" >
									</div>
								</div>
								</div>
								...
								<div class="col-md-5">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="mwp_ids" id="mwp_ids" value="<?php echo $mwp_ids; ?>">
									</div>
								</div>
																	
								<div class="col-md-1" style="margin-top:20px">
									<div class="form-group">
										<button class="btn btn-success waves-effect fnf_search_btn" a href="<?php echo base_url()?>fnf" type="submit" id='btnView' name='btnView' value="View">View</button>
									</div>
								</div>
							</div>
	...
	<?php if(isAccessFNFHr()==true){ ?>	
			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">HR FNF Checklist 
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<thead>
									<tr class='bg-info'>
										...
										<th>HR Acceptance</th>
									<?php $off_arr = array('CEB','MAN'); if(in_array(get_user_office_id(), $off_arr)){?>
										<th>Process</th>									
										<th>Department</th> 
									<?php } ?>
										<th>FNF Status</th>
								...
								foreach($hr_checklist as $token){ 
									...
									if($token['it_local_status'] == 'C'){ $local_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Completed</span>"; }
									else $isOpenFNFBtn=false;
									
									// IT NETWORK
									$network_status = "<span class='text-danger font-weight-bold'><i class='fa fa-circle'></i> Pending</span>"; 
									if($token['it_network_status'] == 'C'){ $network_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Completed</span>"; }
									else $isOpenFNFBtn=false;
									
									// IT HELPDESK
									$helpdesk_status = "<span class='text-danger font-weight-bold'><i class='fa fa-circle'></i> Pending</span>"; 
									if($token['it_global_helpdesk_status'] == 'C'){ $helpdesk_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Completed</span>"; }
									else $isOpenFNFBtn=false;


									// Procurement Team
									if($token['stock_history'] != ''){
										$procurement_status = "<span class='text-danger font-weight-bold'><i class='fa fa-circle'></i> Pending</span>"; 
										if($token['it_procurement_status'] == '1'){ $procurement_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Completed</span>"; }
										else $isOpenFNFBtn=false;
									}else{
										$procurement_status = '-';
									}
									...
									// HR Acceptance
									if($token['stock_history'] != ''){
										$hr_acceptance_status = "<span class='text-danger font-weight-bold'><i class='fa fa-circle'></i> Pending</span>"; 
										if($token['hr_acceptance_status'] == '1'){ $hr_acceptance_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Completed</span>"; }
										else $isOpenFNFBtn=false;
									}else{
                                    ...
                                    if($token['it_local_status'] == 'C' && $token['it_network_status'] == 'C' && $token['it_global_helpdesk_status'] == 'C'){
									...
									$holdName = "Hold"; $classbtn7 = "primary";
									if($holdStatus == 1){ $holdName = "Unhold"; $classbtn7 = "danger"; }
																		
								?>
								<tr>
									<td><input type="checkbox" class="check" name="check_box[]" value="<?php echo $fnfid; ?>"></td>
									<td><?php echo $cn; ?></td>
									...
									<td><?=$procurement_status?></td>
									<td><?=$hr_acceptance_status?></td>
									<?php if(in_array(get_user_office_id(), $off_arr)){?>
									<td><?php echo $token['process_names']; ?></td>								
									<td><?php echo $token['dept_name']; ?></td>
									<?php } ?>
									...
									<?php if($holdStatus == 0){ ?>
										...
										<button title='FNF compilation' fnfid="<?php echo $fnfid; ?>" type='button' class='complete_FNF btn btn-danger btn-xs' style='font-size:10px'>Complete FNF</button>
																					
										<?php }else{ ?>
										<button title='Button will activate after FNF compilation' disabled fnfid="<?php echo $fnfid; ?>" type='button' class='complete_FNF btn btn-danger btn-xs' style='font-size:10px'>Complete FNF</button>
										<?php } ?>
									<?php } else { 
										echo '<span class="text-warning"><b>ON HOLD</b></span>&nbsp;&nbsp;';
									 }
									?>
										<?php if(isIndiaLocation(get_user_office_id())==true || $token['resign_id']!="" ){ 
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Local IT Team
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<?php 
								$cn = 0;
								foreach($local_list as $token){ 
										
									$cn++;

										$extrapar = $token['user_id'] ."#" .$token['resign_id'] ."#" .$token['id'] ."#" .$token['term_id'];

										$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; $btn_disabled = "";
										if($token['it_local_status'] == 'C'){ $ustatus = "<span class='text-success font-weight-bold'>Completed</span>"; $classbtn = "success"; $btn_disabled = "disabled"; }
										...
										$holdStatus = $token['is_hold'];
										$holdName = "Hold"; $classbtn7 = "primary";
										if($holdStatus == 1){ $holdName = "Unhold"; $classbtn7 = "warning"; }
								...
								?>
									<tr>
										...
										<td>
										<?php if($holdStatus == 0){ ?>
										<button title='Submit FNF' type='button' pstatus="<?=$token['it_local_status']?>" extrapar="<?php echo $extrapar; ?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs editfnfITLocalTeam' style='font-size:12px'>
										<i class='fa fa-check-square'></i></button>
										<?php } ?>

										<button <?=$btn_disabled?> title='<?php echo $holdName; ?> FNF' type='button' extrapar="<?php echo $extrapar; ?>" ftype="7" class='btn btn-<?php echo $classbtn7; ?> btn-xs editfnfHoldTeam' style='font-size:12px'><i class='fa fa-clock-o'></i> <?php echo $holdName; ?></button>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">IT Network Team
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($local_list as $token){ 
									...
									if($token['it_network_status'] == 'C'){ $ustatus = "<span class='text-success font-weight-bold'>Completed</span>"; $classbtn = "success"; }
								...
								<tr>
									...
									<td>
									<?php if($holdStatus == 0){ ?>
									<button title='Submit FNF' type='button' extrapar="<?php echo $extrapar; ?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs editfnfITNetworkTeam' style='font-size:12px'>
									<i class='fa fa-check-square'></i></button>	
									<?php } else { 
										echo '<span class="text-warning"><b>ON HOLD</b></span>';
									 }
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">IT Global Helpdesk
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($local_list as $token){ 
									...
									$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
									if($token['it_global_helpdesk_status'] == 'C'){ $ustatus = "<span class='text-success font-weight-bold'>Completed</span>"; $classbtn = "success"; }
								...
								<tr>
									...
									<td>
									<?php if($holdStatus == 0){ ?>
									<button title='Submit FNF' type='button' extrapar="<?php echo $extrapar; ?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs editfnfITGlobalHelpdeskTeam' style='font-size:12px'>
									<i class='fa fa-check-square'></i></button>		
									<?php } else { 
										echo '<span class="text-warning"><b>ON HOLD</b></span>';
									 }
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">IT Security Team
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($local_list as $token){ 
									...
									$ustatus5 = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn5 = "primary"; 
									if($token['it_security_status'] == 'C'){ 
										$ustatus5 = "<span class='text-success font-weight-bold'>Completed</span>"; $classbtn5 = "success"; 
									}

									$showCheckOutButton = 0;
									if($token['it_global_helpdesk_remarks'] != "" && $token['it_local_remarks'] != '' && $token['it_network_remarks'] != ''){
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Procurement Team
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<?php 
								$cn = 0;
								foreach($procurement_list as $token){
									...
									$cn++;
										...
										$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
										$itLocalaccstatus = "<span class='text-danger font-weight-bold'>Pending</span>";

										$hr_status = "<span class='text-danger font-weight-bold'>Pending</span>";

										if($token['it_procurement_status'] == '1'){ $ustatus = "<span class='text-success font-weight-bold'>Completed</span>"; $classbtn = "success"; }

										if($token['it_local_acceptance_status'] == '1' || $token['it_local_status'] == 'C'){ $itLocalaccstatus = "<span class='text-success font-weight-bold'>Completed</span>"; }

										if($token['hr_acceptance_status'] == '1'){ $hr_status = "<span class='text-success font-weight-bold'>Completed</span>"; }
								...
								?>
									<tr>
										...
										<td><?php echo $lwd_date; ?></td>
										<td><b><?php echo $ustatus; ?></b></td>
										<td><b><?php echo $itLocalaccstatus; ?></b></td>
										<td><b><?php echo $hr_status; ?></b></td>
										<?php if(in_array(get_user_office_id(), $off_arr)){?>
										<td><?php echo $token['process_names']; ?></td>								
										<td><?php echo $token['dept_name']; ?></td>
										<?php } ?>
										...
										<button title='Submit FNF' type='button' <?php if($token['it_local_acceptance_status'] == '1' || $token['it_local_status'] == 'C'){ echo '';} else { echo 'disabled';}?> pstatus= "<?=$token['it_procurement_status']?>" hrcomment= "<?=$token['hr_acceptance_comment']?>" extrapar="<?=$extrapar?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs procrument_fnf_save' style='font-size:12px'>
										<i class='fa fa-check-square'></i></button>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">HR Acceptance
						<a href="<?php echo base_url('fnf/fnf_asset_export_report_excel'); ?>?office=<?php echo $getOffice; ?>&type=2&excel=1" class="btn btn-primary btn-sm pull-right"> <i class="fa fa-download"></i> Download Excel</a></h4>
					</header>
					<hr class="widget-separator">
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($procurement_list as $token){ 
									...
									$cn++;
										...
										$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
										if($token['hr_acceptance_status'] == '1'){ $ustatus = "<span class='text-success font-weight-bold'>Completed</span>"; $classbtn = "success"; }
								...
								?>
									<tr>
										...
										<button title='Submit FNF' type='button' <?php if($token['it_local_acceptance_status'] == '1' || $token['it_local_status'] == 'C'){ echo '';} else { echo 'disabled';}?> pstatus= "<?=$token['hr_acceptance_status']?>" hrcomment= "<?=$token['hr_acceptance_comment']?>" extrapar="<?=$extrapar?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs acceptance_fnf_save' style='font-size:12px'>
										<i class='fa fa-check-square'></i></button>
...
<script>
	...
	$(document).ready(function(){
		...
		$(document).on('change','#date_from',function() {
			...
			if (search_from_date > search_to_date) { alert("From Date can't be grater than To Date"); $(".fnf_search_btn").prop("disabled",true); }
			else { $(".fnf_search_btn").prop("disabled",false); }
		...
		$(document).on('change','#date_to',function() {
			...
			search_from_date = new Date(search_from_date);
			search_to_date = new Date(search_to_date);
			if (search_from_date > search_to_date) { alert("To Date can't be less than From Date"); $(".fnf_search_btn").prop("disabled",true); }
			else { $(".fnf_search_btn").prop("disabled",false); }
