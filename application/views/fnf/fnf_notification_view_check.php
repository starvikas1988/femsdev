...
<section class="app-content">	
		...
		<h4 class="form-title m-b-xl text-center"><?php echo $showup; ?> FNF Notifications</h4>
		...
		<center>
		<table class="table table-primary" style="width:80%">
		<thead>
		<tr class="bg-primary">
		...
		<tbody>
		<?php foreach($fnf_list as $fToken){ 
		...
		<a href="<?php echo base_url('fnf/fnf_submission_info/fnf/'.$total); ?>" class="btn btn-success" style="width:220px;"><i class="fa fa-check-circle"></i> Go To FNF</a>
		</div>		
		<a href="<?php echo base_url('fnf/fnf_submission_info/skip/'.$total); ?>" class="btn btn-danger pull-right" style="display:inline;width:120px;float: right;"><i class="fa fa-arrow-right"></i> Skip Now</a>				
		</form>
