		...
		<div style='float:right; margin-top:5px;' class="col-md-12 new-btn-group">
				<?php if($status=="1") { ?>				
					<div class="form-group" style='float:right; padding-right:5px;'>
						<a href='?status=2' <span style="padding:12px;" class="label label-danger">View Upcoming</span></a>	
					</div>
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<div class="input-group selectdatepick" style="cursor:pointer">
										...
										<input  type="text" class="form-control" value="<?php echo $date_from; ?>" name="date_from" id="date_from" placeholder="From Date" >
									</div>
								</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="input-group selectdatepick" style="cursor:pointer">
										<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
										<input  type="text" class="form-control" value="<?php echo $date_to; ?>" name="date_to" id="date_to" placeholder="To Date" >
									</div>
								</div>
								</div>
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($hr_checklist as $token){ 
									...
									if($token['stock_history'] != ''){
										...
										if($token['it_procurement_status'] == '1'){ $procurement_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Complete</span>"; }
										else $isOpenFNFBtn=false;
									}else{
										$procurement_status = '-';
									}
									...
									if($token['stock_history'] != ''){
										...
										if($token['hr_acceptance_status'] == '1'){ $hr_acceptance_status = "<span class='text-success font-weight-bold'><i class='fa fa-circle'></i> Complete</span>"; }
										else $isOpenFNFBtn=false;
									}else{
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								?>
									<tr>
										...
										<button title='<?php echo $holdName; ?> FNF' type='button' extrapar="<?php echo $extrapar; ?>" ftype="7" class='btn btn-<?php echo $classbtn7; ?> btn-xs editfnfHoldTeam' style='font-size:12px'><i class='fa fa-clock-o'></i> <?php echo $holdName; ?></button>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($local_list as $token){ 
									...
									$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
									if($token['it_network_status'] == 'C'){ $ustatus = "<span class='text-success font-weight-bold'>Complete</span>"; $classbtn = "success"; }
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($local_list as $token){ 
									...
									$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
									if($token['it_global_helpdesk_status'] == 'C'){ $ustatus = "<span class='text-success font-weight-bold'>Complete</span>"; $classbtn = "success"; }
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($local_list as $token){ 
									...
									if($token['it_security_status'] == 'C'){ 
										$ustatus5 = "<span class='text-success font-weight-bold'>Complete</span>"; $classbtn5 = "success"; 
									}
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($procurement_list as $token){
									...
									$cn++;
										...
										if($token['it_procurement_status'] == '1'){ $ustatus = "<span class='text-success font-weight-bold'>Complete</span>"; $classbtn = "success"; }

										if($token['it_local_acceptance_status'] == '1'){ $itLocalaccstatus = "<span class='text-success font-weight-bold'>Complete</span>"; }
								...
								?>
									<tr>
										...
										<button title='Submit FNF' type='button' <?php if($token['it_local_acceptance_status'] != '1'){ echo 'disabled';}?> pstatus= "<?=$token['it_procurement_status']?>" extrapar="<?=$extrapar?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs procrument_fnf_save' style='font-size:12px'>
										<i class='fa fa-check-square'></i></button>
							...
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								foreach($procurement_list as $token){ 
									...
									$cn++;
										...
										$ustatus = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
										if($token['hr_acceptance_status'] == '1'){ $ustatus = "<span class='text-success font-weight-bold'>Complete</span>"; $classbtn = "success"; }

										$procurement_status = "<span class='text-danger font-weight-bold'>Pending</span>"; $classbtn = "danger"; 
										if($token['it_procurement_status'] == '1'){ $procurement_status = "<span class='text-success font-weight-bold'>Complete</span>"; }
								...
								?>
									<tr>
										...
										<td><?php echo $lwd_date; ?></td>
										<td><b><?php echo $ustatus; ?></b></td>
										<td><b><?php echo $procurement_status; ?></b></td>
										<?php if(in_array(get_user_office_id(), $off_arr)){?>
										<td><?php echo $token['process_names']; ?></td>								
										<td><?php echo $token['dept_name']; ?></td>
										<?php } ?>
										...
										<button title='Submit FNF' type='button' <?php if($token['it_procurement_status'] != '1'){ echo 'disabled';}?> pstatus= "<?=$token['hr_acceptance_status']?>" hrcomment= "<?=$token['hr_acceptance_comment']?>" extrapar="<?=$extrapar?>" ftype="1" class='btn btn-<?php echo $classbtn; ?> btn-xs acceptance_fnf_save' style='font-size:12px'>
										<i class='fa fa-check-square'></i></button>
