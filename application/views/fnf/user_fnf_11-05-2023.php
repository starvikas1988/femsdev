              ...
              <div class="col-md-3">
                <div class="btn_main">
                  <div class="btn_inline">
                    <div class="form-group">
                      <label></label>
                      <button type="button" class="view-btn view_pad fnf_type" onclick="get_list(this.value)" ;>View</button>
                    </div>
                  </div>
                  <div class="btn_inline"> <?php if ($status == "1") { ?>
                      <div class="form-group space-top">
                        <a href='?status=2' class="view-btn view_pad1">View Upcoming</a>
                      </div>

                    <?php } else { ?>
                      <div class="form-group space-top">
                        <a href='?status=1' class="view-btn view_pad1"> View Pending</a>
                      </div>
                    <?php } ?>
                  </div>
                </div>
        ...
        <div id="one" class="tab-pane fade in active">
          <div class="white-space">
            ...
            <div class="row new">
              ...
              <div class="col-md-4">
                <button type="submit" class="send_mails btn btn-primary btn-sm pull-right" title="Click on the checkbox to resend multiple Mails"> <i class="fa fa-envelop"></i> Re-Send Mails</button>&nbsp;&nbsp;&nbsp;&nbsp;
              </div>
              <div class="col-md-4">
                <button type="button" class="check_complete_fnf btn btn-primary btn-sm pull-right" title="Click to Complete All FNF"> <i class="fa fa-envelop"></i> Complete All FNF</button>&nbsp;&nbsp;&nbsp;&nbsp;
              </div>
          ...
          for (var i in alrt.hr_checklist) {
            ...
            if (val == 'hr_fnf') {
              ...
              if (alrt.hr_checklist[i].resign_id != "") {              
                <?php if(isAccessReleaseLetter(2) == true){ ?>
                    if (isOpenFNFBtn == true) {
                      ...
                      html += `	<a class="btn btn-success btn-xs" href="javascript:void(0);" disabled title="Click to View Release_letter " style="font-size:12px"><i class="fa fa-print"></i></a>`;
                    }

                    if (display_email == 'Show') { 
                      <?php if(isAccessReleaseLetter(1) == true){ ?>
                ...
                // if (isOpenFNFBtn == true) {
                //   <?php //if(isAccessReleaseLetter() == true){ ?>
                //     html += `	<a class="btn btn-success btn-xs" href="<?php echo base_url(); ?>fnf/send_release_letter/` + fnfid + `/D" target="_blank" title="Click to View Release_letter " style="font-size:12px"><i class="fa fa-print"></i></a>`;  
                //  <?php  //} ?>
                // } else {
                //   // isIndiaLocation from skt.common.js 
                //   if ((isIndiaLocation(alrt.hr_checklist[i].office_id) == false) || ((isIndiaLocation(alrt.hr_checklist[i].office_id) == true) && (alrt.hr_checklist[i].brand === '3' || alrt.hr_checklist[i].brand === '0'))) {
                //     // (not in india or out of india) or (location in india but brand omind or 0)
                //     html += `	<a class="btn btn-success btn-xs" href="<?php echo base_url(); ?>fnf/send_release_letter/` + fnfid + `/D" target="_blank" title="Click to View Release_letter " style="font-size:12px"><i class="fa fa-print"></i></a>`;
                //   } else {
                //     html += `	<a class="btn btn-success btn-xs" href="javascript:void(0);" disabled title="Click to View Release_letter " style="font-size:12px"><i class="fa fa-print"></i></a>`;
                //   }
            ...
            if (val == 'it_network') {
              ...
              if (holdStatus == 0) {
                html += `<td><button title='Submit FNF' type='button' extrapar="` + extrapar + `" ftype="1" class='btn btn-` + classbtn + ` btn-xs editfnfITNetworkTeam' style='font-size:12px'>
            ...
            if (val == 'it_global') {
              ...
              if (holdStatus == 0) {
                html += `<td><button title='Submit FNF' type='button' extrapar="` + extrapar + `" ftype="1" class='btn btn-` + classbtn + ` btn-xs editfnfITGlobalHelpdeskTeam' style='font-size:12px'>
                  <i class='fa fa-check-square'></i></button></td>`;
              } else {
                // echo '<span class="text-warning"><b>ON HOLD</b></span>';
                html += `<td><span class="text-warning"><b>ON HOLD</b></span></td>`;
