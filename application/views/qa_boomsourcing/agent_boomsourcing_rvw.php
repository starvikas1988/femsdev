								...
								<tbody>
									...
									<?php if($campaign=="boomsourcing"){ ?>
										...
										<tr>
											...
											<td>Zone/Center:</td>
											<td><input type="text" class="form-control" id="office_name" name="data[zone]" value="<?php echo $boomsourcing_data['zone'] ?>" disabled></td>	
										</tr>
										<tr>
											<td>Phone:</td>
											<td><input type="text" class="form-control" id="phone" name="data[phone]" onkeyup="checkDec(this);" value="<?php echo $boomsourcing_data['phone'] ?>" disabled></td>
											<td>Link:</td>
											<td><input type="text" class="form-control" id="link" name="data[link]" value="<?php echo $boomsourcing_data['link'] ?>" disabled></td>
											<td>Week No:</td>
											<td><input type="number" class="form-control"  name="data[week]" value="<?php echo $boomsourcing_data['week'] ?>" disabled></td>
										</tr>
										<tr>
											<td>Campaign:</td>
											<td><input type="text" class="form-control" name="data[campaign]" value="<?php echo $boomsourcing_data['campaign'] ?>" disabled></td>
											<td>Disposition:</td>
											<td><input type="text" class="form-control" name="data[disposition]" value="<?php echo $boomsourcing_data['disposition'] ?>" disabled></td>
											<td>Q Score:</td>
											<td>
												<select class="form-control" name="data[q_score]" disabled>
													<option value="">-Select-</option>
													<option <?php echo $boomsourcing_data['q_score']=='Q3'?"selected":""; ?> value="Q3">Q3</option>
													<option <?php echo $boomsourcing_data['q_score']=='Q2'?"selected":""; ?> value="Q2">Q2</option>
													<option <?php echo $boomsourcing_data['q_score']=='Q1'?"selected":""; ?> value="Q1">Q1</option>
													<option <?php echo $boomsourcing_data['q_score']=='Q0'?"selected":""; ?> value="Q0">Q0</option>
												</select>
											</td>
										...
										<tr>
											<td>Audit Type:</td>
											<td><select class="form-control" disabled><option><?php echo $boomsourcing_data['audit_type'] ?></option></select></td>
											<td>VOC:</td>
											<td><select class="form-control" disabled><option><?php echo $boomsourcing_data['voc'] ?></option></select></td>
										</tr>
										...
										<tr style="background-color:#A5DDBD">
											...
											<?php if($boomsourcing_data['attach_img_file']!=''){ ?>
												<td colspan="4">
