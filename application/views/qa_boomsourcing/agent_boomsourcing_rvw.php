								...
								<tbody>
									...
									<tr style="background-color:#F5B7B1">
										...
										<?php if($pnid==0){ ?>
											...
											<td colspan=2>
												<?php echo '<a class="btn btn-warning" style="font-size:15px" href="'.base_url().'Qa_boomsourcing/record_audio/'.$pnid.'" target="a_blank" style="margin-left:5px; font-size:10px;">Record Audio Here</a>';  ?>
											</td>
										<?php }else{ ?>
											<td colspan=2><input type="file" multiple class="form-control audioFile" id="attach_file" name="attach_file[]" disabled></td>
