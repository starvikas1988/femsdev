...
<div class="widget-body">
  <div class="row">
  <div class="col-md-6">
  <h4 style="padding-left:10px"><i class="fa fa-bar-chart"></i> Conact Tracing Follett Overview</h4>
  </div>
  <div class="col-md-6">
...
<div class="panel-body">    
	<div class="row">		
		...
		<a href="<?php echo base_url() ."contact_tracing_follett/case_list?start_date=".$from_date."&end_date=".$to_date; ?>">
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
         <a href="<?php echo base_url() ."contact_tracing_follett/case_list?case_status=P&start_date=".$from_date."&end_date=".$to_date; ?>">   
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
		<a href="<?php echo base_url() ."contact_tracing_follett/case_list?case_status=P"; ?>">
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Conact Tracing Follett Records</b></div>
  <div class="panel-body">	
	<div class="row">
