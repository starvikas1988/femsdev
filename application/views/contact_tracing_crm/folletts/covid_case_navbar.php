...
//$linkURL = "#";
$linkURL = base_url('contact_tracing_follett/form/'.$crmid.'/'.$eachsection);
if($urlSection == $eachsection){ $linkURL = base_url('contact_tracing_follett/form/'.$crmid.'/'.$eachsection); }
?>  
