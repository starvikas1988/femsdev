...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>contact_tracing_follett/submit_personal_information" method="POST" autocomplete="off">
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
	...
	<div class="row">	
	<div class="col-md-12">
		  <p class="chatquote"><b>AGENT:</b>  Hello, thank you for calling Follett, Baker and Taylor's Health and Healing Support Line, this is <u><?php echo get_username(); ?></u>.  Who do I have the pleasure of speaking with today?  (Thank customer after each request)</p> <br/>
	</div>
	<div class="col-md-12">
		  <p class="chatquote"><b>AGENT:</b>  May I please verify the spelling of both your first and last name?</p> <br/>
	</div>
	</div>
	...
	<div class="row">	
	<div class="col-md-12">
		  <p class="chatquote"><b>AGENT:</b>  Next may I please verify your phone number?  May I also verify the store phone number please, if you have that?</p> <br/>
	</div>
	</div>
	...
	<div class="col-md-6">
		<div class="form-group">
		  <label for="case">Store Phone :</label>
	...
	<div class="row">	
	<div class="col-md-6">
		  <p class="chatquote"><b>AGENT:</b>  May I please have the store location and/or store number?</p> <br/>
	</div>
	<div class="col-md-6">
		  <p class="chatquote"><b>(After response) AGENT:</b> May I also verify your Team Manager's Name please?</p> <br/>
	</div>
	</div>
	...
	<div class="col-md-6">		
		<div class="form-group">
		  ...
		  <textarea class="form-control" id="caller_store_location" placeholder="" name="caller_store_location" required><?php echo !empty($crmdetails['cid']) ? $crmdetails['caller_store_location'] : ''; ?></textarea>
		</div>
	</div>
	<div class="col-md-6">		
		<div class="form-group">
		  <label for="case">Team Member's Manager Name</label>
 ...
 <div class="panel panel-default">
  ...
  <div class="panel-body"> 
	...
	<a href="<?php echo base_url()."contact_tracing_follett/form/" .$crmdetails['crm_id'] ."/case/"; ?>" class="btn btn-primary pull-right"><i class="fa fa-angle-double-right"></i> Skip & Next</a>
	<?php } ?>
	</div>
