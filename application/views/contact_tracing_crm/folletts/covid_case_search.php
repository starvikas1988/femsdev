...
<header class="widget-header">
	<h4 class="widget-title">Follett Case Search</h4>
</header>
...
<?php if((!empty($totaldata)) && ($totaldata > 0)){ ?>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Follett Case Found</h4>
					</header>
						...
						<div class="table-responsive">
							<table style="margin-top: 10px;" id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tr>
									...
									<td>
									<a title='View Case' href="<?php echo base_url()."contact_tracing_follett/form/" .$token['crm_id']."/personal/"; ?>" class='btn btn-success btn-xs' style='font-size:12px'>
									...
									<a title='View Logs' target="_blank" href="<?php echo base_url()."contact_tracing_follett/check_logs/" .$token['crm_id']."/"; ?>" class='btn btn-primary btn-xs' style='font-size:12px'><i class='fa fa-calendar'></i></a>
									
									<a title='Download Case' target="_blank" href="<?php echo base_url()."contact_tracing_follett/generate_crm_report_pdf/" .$token['crm_id']."/download"; ?>" class='btn btn-primary btn-xs' style='font-size:12px'><i class='fa fa-download'></i></a>
  ...
  <div class="modal-dialog">
	...
	<!--<form action="<?php echo base_url(); ?>contact_tracing_crm/send_email" method="POST" autocomplete="off">-->
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title">Send Case Details - FOLLETT</h4>
      </div>
