                  ...
                  <div id="tracking">
                     <div class="text-center tracking-status-intransit">
                        <p class="tracking-status text-tight">
                           <b><?php echo $crmdetails['incident_id'] . " - " . $crmdetails['caller_fname'] . " " . $crmdetails['caller_lname']; ?></b>
                        ...
                        ?>
                           <div class="tracking-item">
                              ...
                              <div class="tracking-date">
                                 <?php echo date('M d, Y', strtotime($token['date_of_call'])); ?>
                                 <!-- <span><?php echo date('h:i A', strtotime($token['date_of_call'])); ?></span> -->
                              </div>

                              <div class="tracking-content">
                                 <?php echo "Updated " . strtoupper($token['cl_section']); ?> Section
                                 <span><?php echo $token['full_name']; ?> <?php if (!empty($token['cl_interval'])) {
                                                                              echo " | " . $token['cl_interval'];
                                                                           } ?></span>
                                 <font style="font-size:12px">Remarks : <?php echo $token['comments']; ?></font>
                              </div>
