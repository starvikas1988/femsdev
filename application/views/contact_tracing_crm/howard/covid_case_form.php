					...
					<form id="formone" method="POST" autocomplete="off">
						<div class="caller-widget">
							...
							<div class="row">	
								...
								<div class="col-md-6">
									<div class="form-group">
									<label>You are calling for<span style="color:red">*</span></label>
									<select name="calling_for" id="calling_for" required>
										<option value="">--Select Option--</option>
										<option value="1" <?php echo ($case_details['calling_for']=='1')  ? 'selected="selected"' : '' ?>>Student</option>
										<option value="2" <?php echo ($case_details['calling_for']=='2')  ? 'selected="selected"' : '' ?>>Staff</option>
									</select>
									</div>
								</div>			
							</div>
							...
							<div class="row">	
								<div class="col-md-6">
									<div class="form-group">
									<label><i class="fa fa-graduation-cap"></i> Student's or Staff's First Name</label>
								...
								<div class="col-md-6">
									<div class="form-group">
									<label>Student's or Staff's Last Name</label>
							...
							<div class="row">	
								...
								<div class="col-md-6">
									<div class="form-group">
									<label>Athletic Grade<span style="color:gray;font-size:13px"></span></label>
									<input type="text" name="athletic_grade" class="form-control" id="athletic_grade" value="<?php echo isset($case_details['athletic_grade']) ? $case_details['athletic_grade'] : ''; ?>">
									</div>
								</div>
							</div>
							<div class="row">	
			...
			<div class="caller-widget">
				...
				<form id="formtwo" method="POST" autocomplete="off">
					...
					<div class="row">	
						<div class="col-md-6">
							<div class="form-group">
								<label><span style="color:red">*</span> History of COVID in last 90 days</label>
								<?php 
								$val='';
								if(isset($case_details['covid_in_last_90_days'])){
									if(!empty($case_details['covid_in_last_90_days'])){
										$val = $case_details['covid_in_last_90_days'];
									}
								}
								?>

								<select name="covid_in_last_90_days" id="covid_in_last_90_days" required>
									<option value="">--select option--</option>
					...
					<div class="row">	
						<div class="col-md-6">
							<div class="form-group">
								<label><span style="color:red">*</span> Has Caller Been Diagnosed as Positive?</label>
								<?php 
								$val='';
								...
								<select name="diagnosed_as_positive" id="diagnosed_yes" required>
									<option value="">--select option--</option>
									<option value="1" <?php echo ($val==1)  ? 'selected="selected"' : '' ?>>Yes</option>
									<option value="2" <?php echo ($val==2)  ? 'selected="selected"' : '' ?>>No</option>
						...
						<?php
						$chk='style="diaplay:block"';
						if($val==1){
							$chk='style="diaplay:none"';
						}
						?>
						<div class="col-md-6" id="diagnosed_date" <?php echo $chk;?>>
							<div class="form-group">
							<label>Date Tested</label>
							<input type="date" class="form-control" name="diagnosed_date" id="mydiagnosed_date" value="<?php echo isset($case_details['diagnosed_date']) ? $case_details['diagnosed_date'] : ''; ?>">
							</div>
						</div>
					</div>
					<div class="row">	
						<div class="col-md-6">
							<div class="form-group">
								<label><span style="color:red">*</span> Test Type</label>
								<?php 
								$val='';
								if(isset($case_details['diagnosed_as_positive'])){
									if(!empty($case_details['diagnosed_as_positive'])){
								...
								<select name="test_type" id="test_type" required>
									<option value="">--select option--</option>
									<option value="1" <?php echo ($val==1)  ? 'selected="selected"' : '' ?>>RAPID TEST</option>
									<option value="2" <?php echo ($val==2)  ? 'selected="selected"' : '' ?>>OTHER</option>
									
								</select>
							</div>
						</div>
						<div class="col-md-6" id="display_test_type" style="diaplay:none">
							<div class="form-group">
							<span id="display_other_type" style="display: none;">	
							<label>Other Type</label>
							<textarea class="form-control" name="other_type" id="other_type"><?php echo isset($case_details['other_type']) ? $case_details['other_type'] : ''; ?></textarea>
							</span>
							<span id="display_rapid_test" style="display: none;">
								<label></label>
								<span style="background-color: #8080802b;">
								<br>
									<h5>Please test with your doctor and call Us back once you have done that.</h5>
								</span>
							</span>
							</div>
						</div>
					...
					<div class="row">	
						<div class="col-md-12">
							...
							<?php 
								...
								?>
							<label><span style="color:red">*</span> May I please ask for the details of where you entered and exited the building for cleaning protocol? (Add notes in documtentation for more than one entrance/exit)</label>						  
								<select name="entrance_and_exit" id="front_door" required>
									<option value="">--Select Option--</option>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<?php 
								...
								?>
							<label><span style="color:red">*</span> Did you have Close Contact with any other members of the staff or students?  What I mean by this is were you within 6 feet, for a period of 15 minutes or more over a 24 hour period of time?</label>					  
								<select name="any_close_contact" id="close_connect" required>
									<option value="">--Select Option--</option>
									<option value="1" <?php echo ($val==1)  ? 'selected="selected"' : '' ?>>Yes</option>
									<option value="2" <?php echo ($val==2)  ? 'selected="selected"' : '' ?>>No</option>
					...
					<?php 
					$doc_exist = 'display:none';
					if($val==1)$doc_exist = 'display:block';
					?>
					<div class="row" <?php echo "style='".$doc_exist."'"?> id="close_connect_ref">	
						<div class="col-md-6">
							<div class="form-group">
							<label>Search and Find Exisitng Students/Staffs</label>
								<input id="contact_close_ref" name="contact_close_ref" class="form-control"  />
							&nbsp;&nbsp;<a onclick="add_close_contact('<?php echo isset($case_details['incident_id']) ? $case_details['incident_id'] : $incident_id; ?>');" style="cursor: pointer;" class="btn btn-primary btn-xs">Add Close Contact</a>
							</div>
						</div>
					</div>
					<div class="row">	
						<div class="col-md-6">
							<div class="form-group">
								...
								?>
								<label><span style="color:red">*</span> Have You been fully vaccinated</label>
								<select name="fully_vaccinated" id="fully_vaccinated" required>
									<option value="">--select--</option>
									<option value="1" <?php echo ($val==1)  ? 'selected="selected"' : '' ?>>Yes</option>
									<option value="2" <?php echo ($val==2)  ? 'selected="selected"' : '' ?>>No</option>
									<option value="3" <?php echo ($val==3)  ? 'selected="selected"' : '' ?>>NA</option>
								</select>
							</div>
						</div>
						<?php 
					...
					<div class="row">	
						...
						<div class="col-md-6">
							<div class="form-group">
								<label>And what was the date you were last at the buliding please Or on The Bus ? or when you being exposed to the positive person ? </label>
								<input type="date" name="last_date_in_building" class="form-control" id="last_date_in_building"
			...
			<div class="caller-widget">
				...
				<form id="formfour" method="POST" autocomplete="off">		
					...
					<div class="row">
						<div class="col-sm-12"> -->
							<div class="form-group">
								<label><span style="color:red">*</span> Please Choose the Correct Letter Type Below:</label>
								<?php 
								$val='';
								...
								?>
								<select class="form-control" style="width:100%; height:100px" id="correct_letter" name="correct_letter" required="required">
									<option value="">--select option--</option>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group">
								<label><span style="color:red">*</span>Caller's Final Case Type:</label>
								<?php 
								$val='';
								...
								?>
								<select name="final_case_type" id="final_case_type" required>
					...
					<div class="row " id="extra_data_field" style="<?php echo $extraop;?>">
						<div class="col-sm-6">
							<div class="form-group">
								<label>Student Date Of Birth <span style="color:red">*</span></label>
								<input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="<?php echo isset($case_details['dob']) ? $case_details['dob'] : ''; ?>" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="textarea" class="form-control" id="user_address" name="user_address" value="<?php echo isset($case_details['user_address']) ? $case_details['user_address'] : ''; ?>" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Please Specify Symptoms <span style="color:red">*</span></label>
								<?php 
								$val='';
								...
								?>
								<textarea id="specify_symptoms" name="specify_symptoms" class="form-control" required><?php echo $case_details['specify_symtoms'];?></textarea>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Date Last at School/Childcare <span style="color:red">*</span></label>
								<input type="date" class="form-control" id="last_date_school" name="last_date_school" value="<?php echo isset($case_details['last_date_of_school']) ? $case_details['last_date_of_school'] : ''; ?>" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label><span style="color:red;">*</span> Name of Facility:</label>
								<select name="name_of_facility" id="name_of_facility" >
										<option value="">--Select Option--</option>
										<?php
										foreach ($school_list as $key => $value) {
											$selected = '';
											if(isset($case_details['name_of_facility'])){
												if($value['id'] == $case_details['name_of_facility'] && !empty($case_details['name_of_facility'])){
													$selected = 'selected';
												}
											}
											?>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<?php  $contact_person=$case_details['caller_fname']." ".$case_details['caller_lname'];?>
								<input type="text" class="form-control" id="contact_person" name="contact_person" value="<?php echo isset($case_details['facility_contact_person']) ? $case_details['facility_contact_person'] : $contact_person; ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Facility Contact Number:</label>
								<input type="text" class="form-control" pattern="^\d{9,10}$" onkeypress="return isNumber(event)"  name="facility_contact_no" id="facility_contact_no" value="<?php echo isset($case_details['facility_contact_no']) ? $case_details['facility_contact_no'] : ''; ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Facility Contact Email:</label>
								<input type="email" class="form-control" name="facility_contact_email" id="facility_contact_email" value="<?php echo isset($case_details['facility_contact_mail']) ? $case_details['facility_contact_mail'] : ''; ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
								<label>Facility Address:</label>
								<input type="textarea" class="form-control" name="facility_address" id="facility_address" value="<?php echo isset($case_details['facility_address']) ? $case_details['facility_address'] : ''; ?>">
							</div>
						</div>
					</div>
					<div class="row">
...
<div id="myEmailSendModal" class="largeModal modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form id="frm_close_contact">	
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Add Close Contact Details - HOWARD</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							<input type="hidden" class="form-control" id="cincident_id" placeholder="" value="" name="cincident_id" >
							<strong for="case">First Name <span style="color:red;">*</span></strong>
							<input type="text" class="form-control" id="frm_first_name" placeholder="" value="" name="frm_first_name" required>
					...
					<div class="col-md-6">
						<div class="form-group">
							<strong for="case">Last Name <span style="color:red;">*</span></strong>
							<input type="text" class="form-control" id="frm_last_name" placeholder="" value="" name="frm_last_name" required >
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<strong for="case">Date Of Birth</strong>
							<input type="date" class="form-control" id="cdob" placeholder="" value="" name="cdob" >
					...
					<div class="col-md-6">
						<div class="form-group">
							<strong for="case">Parent Name</strong>
							<input type="text" class="form-control" id="cparent_name" placeholder="" value="" name="cparent_name">
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<strong for="case">Phone No</strong>
							<input type="Number" class="form-control" id="cphone_no" placeholder="" value="" name="cphone_no" >
					...
					<div class="col-md-6">
						<div class="form-group">
							<strong for="case">Staff/Child</strong>
							<select name="cstaff_child" id="cstaff_child" class="form-control">
										<option value="">--Select Option--</option>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<strong for="case">Class Room</strong>
							<input type="text" class="form-control" id="cclass_room" placeholder="" value="" name="cclass_room" >
					...
					<div class="col-md-6">
						<div class="form-group">
							<strong for="case">Vaccine Status</strong>
							<select name="cvaccine_status" id="cvaccine_status" class="form-control">
										<option value="">--Select Option--</option>
										<option value="Fully Vaccinated">Fully Vaccinated</option>
										<option value="1st Dose Taken">1st Dose Taken</option> 
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<strong for="case">	Other Notes</strong>
							<input type="text" class="form-control" id="cOther_notes" placeholder="" value="" name="cOther_notes" >
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success Submission_mail" id="crmFormSubmission" name="crmFormSubmission" onclick="submit_close_contact();">Save</button>
...
<script src="http://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>
  ...
  <script>
  function search_ex(st) {
  	var baseURL="<?php echo base_url(); ?>";
  	var school_1 = $('#school').val();
  	var grades_1 = $('#grades').val();
  	var school_2 = $('#school2').val();
  	var grades_2 = $('#grades2').val();
    ...
    $.ajax({
            url: baseURL+'howard_training/exsisting_student',
            type: 'GET',
            data: 'school='+ school_1+'&grades='+grades_1+'&school2='+school_2+'&grades2='+grades_2,
            cache: false,
            contentType: false,
            processData: false,
 ...
 function add_close_contact(incident){
 	$('#cincident_id').val(incident);
 	$('#myEmailSendModal').modal('show');
 }
 function submit_close_contact(){
 	var baseURL="<?php echo base_url(); ?>";
 	let valid = true;
            $('#frm_close_contact [required]').each(function() {
            if ($(this).is(':invalid') || !$(this).val()) valid = false;
            })
            if(!valid) alert("please fill all required fields!");
            else{
 		 var formData = new FormData(document.getElementById("frm_close_contact"));
        $.ajax({
            url: baseURL+'howard_training/saveclosecontact',
            type: 'POST',
            data: formData,
            cache: false,
            contentType: false,
