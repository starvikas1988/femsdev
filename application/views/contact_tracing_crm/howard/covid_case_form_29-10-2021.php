						...
						<div class="caller-widget">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<input type="date" class="form-control"  placeholder=""value="<?php echo isset($case_details['date_of_call']) ? $case_details['date_of_call'] : $date_of_call; ?>"  readonly>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
									...
									<select name="schools" id="school" required>
										...
										foreach ($school_list as $key => $value) {
											...
											if(isset($case_details['schools'])){
												if($key == $case_details['schools'] && !empty($case_details['schools'])){
													$selected = 'selected';
												}
											}
											?>
									...
									<select name="schools2" id="school2">
										...
										foreach ($school_list as $key => $value) {
											...
											if(isset($case_details['school2'])){
												if($key == $case_details['school2'] && !empty($case_details['school2'])){
													$selected = 'selected';
													// $selected = $case_details['initial_case'];
												}
											}
					...
					<div class="row">	
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" value="" id="r_initial_case_type" readonly />
								<!-- <select id="r_initial_case_type" readonly>
									<option value="">--Select Case Type--</option>
						...
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Initial Case Type</label>
										<input type="text" class="form-control" value="" id="r2_initial_case_type" readonly />
										<!-- <select id="r2_initial_case_type" readonly>
											<option value="">--Select Case Type--</option>
											<option value="1">Confirmed Positive</option>
											<option value="2">Presumed Positive</option>
											<option value="3">Close Contact</option>
				...
				<form id="formfour" method="POST" autocomplete="off">		
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								<label>Initial Case Type</label>
								<input type="text" class="form-control" value="" id="r3_initial_case_type" readonly />
								<!-- <select id="r3_initial_case_type" readonly>
									<option value="">--Select Case Type--</option>
									<option value="1">Confirmed Positive</option>
									<option value="2">Presumed Positive</option>
									<option value="3">Close Contact</option>
					...
					<div class="row" style="display:none" id="disposition_expose">	
						<div class="col-md-6">
							...
							<textarea type="text" class="form-control" name="others_disposition" id="others_disposition"></textarea>
							</div>
						</div>
					</div>
					<!-- <div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<select name="final_case_type" id="final_case_type">
									...
									<option value="1">Quarantine Illness ( Close Contact )</option>
									<option value="2">Confirm Positive ( Isolation )</option>
									<option value="3">Getting Tested ( Will Callback with Results )</option>
									<option value="4">Not Testing - ( Quarantine )</option>
									<option value="5">Closed Case</option>
					...
					<div class="row" style="display:none" id="final_case_type_expose">	
						<div class="col-md-6">
							<div class="form-group">
							<label>Other Final Case Type</label>
							<textarea type="text" class="form-control" name="others_final_case_type" id="others_final_case_type"></textarea>
							</div>
						</div>
					</div>
					<div class="row">
