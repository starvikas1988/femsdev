					...
					<div class="row " id="extra_data_field" style="<?php echo $extraop;?>">
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="date" class="form-control" name="date_of_birth" value="<?php echo isset($case_details['dob']) ? $case_details['dob'] : ''; ?>" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="textarea" class="form-control" name="user_address" value="<?php echo isset($case_details['user_address']) ? $case_details['user_address'] : ''; ?>" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="date" class="form-control" name="last_date_school" value="<?php echo isset($case_details['last_date_of_school']) ? $case_details['last_date_of_school'] : ''; ?>" required>
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
