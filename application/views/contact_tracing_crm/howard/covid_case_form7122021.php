							...
							<div class="row">	
								...
								<div class="col-md-6">
									...
									<select name="calling_for" id="calling_for" required>
										...
										<option value="1" <?php echo ($case_details['title']=='1')  ? 'selected="selected"' : '' ?>>Student</option>
										<option value="2" <?php echo ($case_details['title']=='2')  ? 'selected="selected"' : '' ?>>Staff</option>
									</select>
									</div>
								</div>			
							</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title">Add Close Candidate Details - HOWARD</h4>
			</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<strong for="case">Frist Name</strong>
					...
					<div class="col-md-6">
						<div class="form-group">
							<strong for="case">Last Name</strong>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="date" class="form-control" id="cdob" placeholder="" value="" name="cdob" required >
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="cparent_name" placeholder="" value="" name="cparent_name" required>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="Number" class="form-control" id="cphone_no" placeholder="" value="" name="cphone_no" required >
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="cstaff_child" id="cstaff_child" class="form-control" required>
										<option value="">--Select Option--</option>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="cclass_room" placeholder="" value="" name="cclass_room" required >
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="cvaccine_status" id="cvaccine_status" class="form-control" required>
										<option value="">--Select Option--</option>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="cOther_notes" placeholder="" value="" name="cOther_notes" required >
