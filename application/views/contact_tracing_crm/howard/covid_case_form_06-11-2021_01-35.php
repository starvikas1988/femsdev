					...
					<div class="row fdose" style="<?php echo $isfirstdis;?>">	
						<div class="col-md-6">
							<div class="form-group">
								<?php 
								$val='';
								if(isset($case_details['first_dose'])){
									if(!empty($case_details['first_dose'])){
										$val = $case_details['first_dose'];
									}
								}
								?>
					...
					<div class="row " id="extra_data_field" style="<?php echo $extraop;?>">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<input type="numbers" class="form-control" pattern="^\d{9,10}$" onkeypress="return isNumber(event)"  name="facility_contact_no" value="<?php echo isset($case_details['facility_contact_no']) ? $case_details['facility_contact_no'] : ''; ?>">
							</div>
						</div>
						<div class="col-sm-6">
							<div class="form-group">
