				...
				<form id="formtwo" method="POST" autocomplete="off">
					...
					<div class="row" <?php echo "style='".$doc_exist."'"?> id="close_connect_ref">	
						<div class="col-md-6">
							...
							&nbsp;&nbsp;<a onclick="add_close_contact('<?php echo $incident_id;?>');" style="cursor: pointer;" class="btn btn-primary btn-xs">Add Close Contact</a>
							</div>
						</div>
					</div>
					<div class="row">	
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-success Submission_mail" id="crmFormSubmission" name="crmFormSubmission" onclick="submit_close_contact();">Send</button>
