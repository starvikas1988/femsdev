...
$type_of_case=array(
	...
	"2"=>"Proximate exposure to someone diagnosis with COVID-19",
	"3"=>"Second hand exposure to someone diagnosis with COVID-19",
	"4"=>"Caller illness",
						...
						<div class="col-md-12">
							<table id="recordsTable" style="width:100%;border:1px solid #68696b;border-collapse: collapse;">
								...
								<tr>
									...
									<th style="border: 1px solid #68696b;padding:2px 10px;text-align:left;font-size:11px;">
										<?php echo !empty($type_of_case[$crm_details['type_of_case']]) ? $type_of_case[$crm_details['type_of_case']] : "-"; ?></th>
								</tr>
								<tr>
					...
					<div class="row">
						<div class="col-md-12">
							<table id="recordsTable" style="width:100%;border:1px solid #68696b;border-collapse: collapse;">
								...
								<?php
								$caseResultType = $crm_details['type_of_case'];
