	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				...
				<?php //if(is_access_howard_modules() || get_login_type() == "client"){ ?>
				<!--<li class="menu-item">
					<a href="<?php echo base_url()?>howard_training/case_report" class="menu-link">
						<span class="menu-icon"><i class="fa fa-download"></i></span>
						<span class="">Master Report</span>
					</a>
				</li>
				<li class="menu-item">
					<a href="<?php echo base_url()?>howard_training/case_report1" class="menu-link">
						<span class="menu-icon"><i class="fa fa-download"></i></span>
						<span class="">Positive Case Report</span>
					</a>
				</li>-->
				<li class="menu-item">
					<a href="<?php echo base_url()?>howard_training/report" class="menu-link">
						<span class="menu-icon"><i class="fa fa-download"></i></span>
						<span class="">Health Dept - Overall Report</span>
					</a>
				</li>
				<li class="menu-item">
					<a href="<?php echo base_url()?>howard_training/health_report" class="menu-link">
						<span class="menu-icon"><i class="fa fa-download"></i></span>
						<span class="">Health Dept. - Individual Report</span>
					</a>
				</li>
				<!--<li class="menu-item">
					<a href="<?php echo base_url()?>howard_training/single_report" class="menu-link">
						<span class="menu-icon"><i class="fa fa-download"></i></span>
						<span class="">Single Report</span>
					</a>
				</li>-->
				<?php //} ?>
