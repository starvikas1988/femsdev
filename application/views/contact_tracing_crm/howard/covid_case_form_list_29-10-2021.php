				...
				<form method="GET" enctype="multipart/form-data" action="" autocomplete="off">
					<div class="caller-widget">
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" name="main_type">
										<option value="">ALL</option>
										<?php
										foreach ($type_of_case as $key => $val) {
											$selected = "";
											if ($key == $main_type) {
												$selected = "selected";
											}
							...
							<div class="col-md-4">
								<div class="form-group">
									<button name="reportSubmission" type="submit" style="margin-top:20px" class="submit-btn"><i class="fa fa-search"></i> Filter</button>
								</div>
							</div>
						</div>
					</div>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td><?php
													echo !empty($type_of_case[$token['type_of_case']]) ? $type_of_case[$token['type_of_case']] : "-";
													?>
												</td>
												<td>
													<?php
