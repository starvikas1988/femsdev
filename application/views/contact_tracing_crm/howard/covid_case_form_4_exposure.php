...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>contact_tracing_crm/submit_exposure" method="POST" autocomplete="off">
...
<div class="panel panel-default">
  ...
  <a href="<?php echo base_url()."contact_tracing_crm/form/" .$crmdetails['crm_id'] ."/condition/"; ?>" class="pull-right btn btn primary"><i class="fa fa-arrow-left"></i> Back to Condition</a>
  </div>
  <div class="panel-body">
	...
	<?php
	// SYMPTOM DATE
	$symptomDate = $crmdetails['s_date_isolating'];
 ...
 <div class="panel panel-default">
  ...
  <div class="panel-body"> 
	...
	<a href="<?php echo base_url()."contact_tracing_crm/form/" .$crmdetails['crm_id'] ."/final/"; ?>" class="btn btn-primary pull-right"><i class="fa fa-angle-double-right"></i> Skip & Next</a>
	<?php } ?>
