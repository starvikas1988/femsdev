...
<div class="widget-body">
  <div class="row">
  <div class="col-md-6">
  <h4 style="padding-left:10px"><i class="fa fa-bar-chart"></i> Conact Tracing Zovio Overview</h4>
  </div>
  <div class="col-md-6">
...
<div class="panel-body">    
	<div class="row">		
		...
		<a href="<?php echo base_url() ."contact_tracing_crm/case_list?start_date=".$from_date."&end_date=".$to_date; ?>">
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
         <a href="<?php echo base_url() ."contact_tracing_crm/case_list?case_status=P&start_date=".$from_date."&end_date=".$to_date; ?>">   
			<div class="mini-stat clearfix  bg-googleplus rounded">
                <span class="mini-stat-icon"><i class="fa fa-bar-chart fg-googleplus"></i></span>
                <div class="mini-stat-info">
                    <span><?php echo $caseStatus['today']['open']; ?></span>
                    Cases Open
                </div>
            </div>
		  </a>
		...
		<div class="col-md-3 col-sm-6 col-xs-12">
		<a href="<?php echo base_url() ."contact_tracing_crm/case_list?case_status=P"; ?>">
            <div class="mini-stat bg-facebook clearfix rounded">
                <span class="mini-stat-icon"><i class="fa fa-tasks fg-facebook"></i></span>
                <div class="mini-stat-info">
                    <span><?php echo $caseStatus['total']['open'] ."/" .$total_records; ?></span>
                    Total Open Cases
                </div>
            </div>
		</a>
        ...
        <!--<div class="col-md-3 col-sm-6 col-xs-12">
		<a href="<?php echo base_url() ."contact_tracing_crm/case_list"; ?>">
            <div class="mini-stat bg-facebook clearfix rounded">
                <span class="mini-stat-icon"><i class="fa fa-tasks fg-facebook"></i></span>
                <div class="mini-stat-info">
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Conact Tracing Zovio Records</b></div>
  <div class="panel-body">	
	<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
	<?php if($todays_records > 0){ ?>
		<div style="width:100%;height:420px; padding:50px 10px">
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Conact Tracing Zovio Location wise Cases</b></div>
  <div class="panel-body">	
	<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
	<?php if($todays_records > 0){ ?>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Conact Tracing Zovio Agent wise Cases</b></div>
  <div class="panel-body">	
	<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
	<?php if($todays_records > 0){ ?>
