...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>contact_tracing_crm/submit_case_information" method="POST" autocomplete="off">
...
<div class="panel panel-default">
  ...
  <a href="<?php echo base_url()."contact_tracing_crm/form/" .$crmdetails['crm_id'] ."/personal/"; ?>" class="pull-right btn btn primary"><i class="fa fa-arrow-left"></i> Back to Personal Details</a>
  </div>
  <div class="panel-body">
	...
	<div class="col-md-6">	
	<div class="form-group">
	  <label for="case">Has Caller Been Diagnosed as Positive?</label>
