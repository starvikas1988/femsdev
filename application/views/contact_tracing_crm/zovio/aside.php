	...
	<header class="aside-header">
		<div class="animated">
			<a href="<?php echo base_url()?>home" id="app-brand" class="app-brand">
				...
				<span id="brand-name" class="brand-icon foldable"><img style="width:100px;height:70px" src="<?php echo base_url() ?>assets/images/zovio_logo.jpg" border="0" alt="Fusion BPO"></span>
			</a>
		</div>
	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>contact_tracing_crm/overview" class="menu-link">
				...
				<li class="menu-item open">
					...
					<a href="" class="menu-link submenu-toggle">
						...
						<span class="menu-text foldable">Zovio</span>
					...
					<ul class="submenu" style="display:block">
						...
						<li>
							<a  href="<?php echo base_url()?>contact_tracing_crm/form">
						...
						<li>
							<a  href="<?php echo base_url()?>contact_tracing_crm/case_search">
								<span class="menu-icon"><i class="zmdi zmdi-assignment-check zmdi-hc-lg"></i></span>
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>contact_tracing_crm/case_report" class="menu-link">
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>contact_tracing_crm/case_mail_report" class="menu-link">
						<span class="menu-icon"><i class="fa fa-download"></i></span>
