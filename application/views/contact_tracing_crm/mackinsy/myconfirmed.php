        ...
        <div class="main-content-inner">			
            <div class="white-area">
				<div class="top-filter">
					<form id="frm" name="search_frm" method="Post"  action="<?php echo base_url();?>mck/myconfirmed">
					<div class="row">
							<div class="col-sm-3">
								<div class="mb-2">
						...
						foreach($case_list as $ky=>$rws){ 
						  ...
						  <tr>
							...
							<?php if(is_access_mckinsey_edit() || get_login_type()== "client"){ ?>
								<a href="<?php echo base_url() ?>mck/edit_case/<?php echo $rw['case_id'];?>" class="editable">
