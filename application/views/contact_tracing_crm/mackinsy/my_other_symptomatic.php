        ...
        <div class="main-content-inner">			
            <div class="white-area">
				<div class="top-filter">
					<form id="frm" name="search_frm" method="Post"  action="<?php echo base_url();?>mck/my_other_cases">
						<div class="row">
								<div class="col-sm-3">
									<div class="mb-2">
					...
					<table id="example" class="table table-striped">
						...
						foreach($case_list as $ky=>$rws){ 
						  ...
						  <tr>
							...
							<td><?php echo $rws['office'];?></td>
							<td><?php echo $rws['case_manager'];?></td>
							<td><?php echo $rws['contact_status'];?></td>
							<td>
							<?php if(is_access_mckinsey_edit() || get_login_type()== "client"){ ?>
								<a href="<?php echo base_url() ?>mck/edit_case/<?php echo $rws['case_id'];?>" class="editable">
									<i class="fa fa-pencil" aria-hidden="true"></i>
								</a>
								<?php } if(is_access_mckinsey_delete() || get_login_type()== "client"){ ?>	
								<a onclick="delete_case('<?php echo $rws['case_id'];?>');" class="editable">
