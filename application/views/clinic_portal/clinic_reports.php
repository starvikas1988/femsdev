		...
		<div class="col-12">
			...
			<div class="widget">
				...
				<div class="widget-body">
					...
					<form id="form_new_user" action="<?php echo base_url() ."clinic_portal/patient_report"; ?>" method="GET" action="" autocomplete="off">
					
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>From Date (mm/dd/yyyy)</label>
									<input type="date" id="search_from_date" name="start" value="<?php if(!empty($from_date)){ echo date('Y-m-01', strtotime($from_date)); } ?>" class="form-control" required>
								</div>
							</div>
							<div class="col-md-3"> 
								<div class="form-group">
							...
							<div class="col-md-3"> 
								<div class="form-group">
									...
									<select class="form-control" name="rtype">
										...
										<option value="pdf">PDF Archieve</option>
									</select>
								</div> 
							</div>
						</div>
