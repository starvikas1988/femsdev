...
<div class="panel-body">    
	...
	<?php }} ?>
		<div class="col-md-3 col-sm-6 col-xs-12 docDiv">
		<a style="cursor:pointer" href="<?php echo base_url('assets/total_rewards_points_cebu/COMPBEN_DOWNLOADABLE_FORMS.zip') ?>">
		...
		<?php if (get_user_fusion_id() == "FCEB000093") { ?>
			<div class="col-md-3 col-sm-6 col-xs-12 docDiv">
				<a style="cursor:pointer" href="<?php echo base_url('clinic_portal/push_file/Pamplet_PAGE1.docx') ?>">
					<div class="mini-stat bg-facebook clearfix rounded">
						<div class="mini-stat-info">
							<span><img style="width:80px;height:70px" src="<?php echo base_url() . "assets/images/doc.png"; ?>"></img></span>
							Pamphlet Page 1
						</div>
					</div>
				</a>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 docDiv">
				<a style="cursor:pointer" href="<?php echo base_url('clinic_portal/push_file/Pamplet_PAGE2.docx') ?>">
					<div class="mini-stat bg-facebook clearfix rounded">
						<div class="mini-stat-info">
							<span><img style="width:80px;height:70px" src="<?php echo base_url() . "assets/images/doc.png"; ?>"></img></span>
							Pamphlet Page 2
				...
				<div class="col-md-3 col-sm-6 col-xs-12 docDiv">
				<a style="cursor:pointer" href="<?php echo base_url('clinic_portal/push_file/FUSION_BPO_CertOfCoverage_2022.pdf') ?>">
					<div class="mini-stat bg-facebook clearfix rounded">
						<div class="mini-stat-info">
							<span><img style="width:80px;height:70px" src="<?php echo base_url() . "assets/images/pdf.png"; ?>"></img></span>
							Certificate Of Coverage-2022
						</div>
					</div>
				</a>
			</div>
				...
				<div class="col-md-3 col-sm-6 col-xs-12 docDiv">
				<a style="cursor:pointer" href="<?php echo base_url('assets/total_rewards_points_cebu/FINAL_DOCTORS_LIST_UPDATED.xls') ?>">
					<div class="mini-stat bg-facebook clearfix rounded">
						<div class="mini-stat-info">
							<span><img style="width:80px;height:70px" src="<?php echo base_url() . "assets/images/excel.png"; ?>"></img></span>
							Final Doctors List Updated
						</div>
					</div>
				</a>
			</div>
