                            ...
                            <table class="table table-striped skt-table" width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[opening_spiel]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=1 <?php echo $avon['opening_spiel'] == "Yes" ? "selected" : ""; ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?php echo $avon['opening_spiel'] == "No" ? "selected" : ""; ?> value="No">No</option>
                                                <option avon_val=0 <?php echo $avon['opening_spiel'] == "N/A" ? "selected" : ""; ?> value="N/A">N/A</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[disclaimer_spiel]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=5 <?= $avon["disclaimer_spiel"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?= $avon["disclaimer_spiel"] == "No" ? "selected" : "" ?> value="No">No</option>
                                                <option avon_val=0 <?= $avon["disclaimer_spiel"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[consent_if_applicable]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=5 <?= $avon["consent_if_applicable"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?= $avon["consent_if_applicable"] == "No" ? "selected" : "" ?> value="No">No</option>
                                                <option avon_val=0 <?= $avon["consent_if_applicable"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[enthusiasm]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=3 <?= $avon["enthusiasm"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[customer_service_polite_words]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=3 <?= $avon["customer_service_polite_words"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?= $avon["customer_service_polite_words"] == "No" ? "selected" : "" ?> value="No">No</option>
                                                <option avon_val=0 <?= $avon["customer_service_polite_words"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[customer_service_empathy]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=3 <?= $avon["customer_service_empathy"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?= $avon["customer_service_empathy"] == "No" ? "selected" : "" ?> value="No">No</option>
                                                <option avon_val=0 <?= $avon["customer_service_empathy"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[customer_service_assurance]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=0 <?= $avon["customer_service_assurance"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?= $avon["customer_service_assurance"] == "No" ? "selected" : "" ?> value="No">No</option>
                                                <option avon_val=0 <?= $avon["customer_service_assurance"] == "N/A" ? "selected" : "" ?> value="N/A">N/A</option>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[ghost_spiel]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=0 <?= $avon["ghost_spiel"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                                <option avon_val=0 <?= $avon["ghost_spiel"] == "No" ? "selected" : "" ?> value="No">No</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[bad_line_spiel]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=0 <?= $avon["bad_line_spiel"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[profanity_spiel]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=0 <?= $avon["profanity_spiel"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[others]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=0 <?= $avon["others"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[information_shared_incomplete]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=5 <?= $avon["information_shared_incomplete"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[information_shared_inaccurate]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=0 <?= $avon["infrmation_shared_inaccurate"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[ticket_email_handling_if_applicable]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=5 <?= $avon["ticket_email_handling_if_applicable"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control avon_point" name="data[closing_spiel]" required disabled>
                                                <option value="">-Select-</option>
                                                <option avon_val=1 <?= $avon["closing_spiel"] == "Yes" ? "selected" : "" ?> value="Yes">Yes</option>
