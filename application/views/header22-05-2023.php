    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="javascript:void(0)">
                <?php if (get_user_company_id() == 3) { ?>
                    <img src="<?php echo base_url() ?>assets_home_v3/images/logo.svg" class="logo" alt="">
                <?php } else { ?>
                    <img src="<?php echo base_url() ?>assets_home_v3/images/fusion_logo.svg" class="logo" alt="">
                <?php } ?>
            </a>
                     ...
                     <div class="dropdown">
                        <button type="button" class="btn btn-primary dropdown-toggle lang_btn transparent_background" data-bs-toggle="dropdown">
                            <img src="<?php echo base_url() 
                                        ?>assets_home_v3/images/language.svg" alt=""> English
                        </button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item flag_link eng" data-lang="en">English</a></li>
                            <li><a class="dropdown-item flag_link frn" data-lang="fr">French</a></li>
                        </ul>
