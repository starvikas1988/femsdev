						...
						<div class="widget-body">
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										<tr>
											<td colspan="8" id="theader" style="font-size:40px">Clever Care Quality Form</td>
										...
										<tr>
											...
											<td><input type="text" class="form-control" id="" name="data[record_id]" value="<?php echo $clever_care_data['record_id'] ?>" required></td>
										</tr>
										<tr>
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<tr>
											<td>Call Summary:</td>
											<td colspan=2><textarea class="form-control" name="data[call_summary]"><?php echo $clever_care_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
