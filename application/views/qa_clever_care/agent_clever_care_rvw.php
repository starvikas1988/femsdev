							...
							<div class="table-responsive">
								<table class="table table-striped skt-table" width="100%">
									...
									<tr style="font-weight:bold; background-color:#D7BDE2">
										...
										<?php if($clever_care_data['attach_file']!=''){ ?>
											...
											<?php $attach_file = explode(",",$clever_care_data['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/clever_care/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/clever_care/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									<form id="form_agent_user" method="POST" action="">
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $clever_care_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $clever_care_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
										...
										if(is_available_qa_feedback($clever_care_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($clever_care_data['agent_rvw_note']==''){ ?>
