	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			<ul class="aside-menu aside-left-menu">
				...
				<li class="menu-item">
					<a href="<?php echo base_url('course') ?>" class="menu-link activate">
						<span class="menu-icon"><i class="fa fa-dashboard"></i></span>
						<span class="">Dashboard</span>
					</a>
				</li>
				
				<?php if($this->uri->segment(2) == 'view_courses' &&  $gant_access == true ) { ?>
				<li class="menu-item">
					<a href="<?php echo base_url('examination?ctid='. $this->uri->segment(3) .'&cid='. $this->uri->segment(4)) ?>" class="menu-link activate">
						<span class="menu-icon"><i class="fa fa-dashboard"></i></span>
				...
				<?php if(($this->uri->segment(2) == '') && (get_role_dir()=="super" || get_role_dir()=="admin"  || get_role_dir()=="manager" ||  get_user_id() == '6462' || get_user_fusion_id() == 'FKOL002536' )) { ?>
				...
				<?php }elseif($this->uri->segment(2) == "view_subject_list" && $gant_access == true ){ ?>
							<!--<li class="menu-item">
								<a href="javascript:void(0);" class="menu-link " data-toggle="modal" data-target="#exampleModal">
									<span class="menu-icon"><i class="fa fa-dashboard"></i></span>
									<span class="">Add Course</span>
				...
				<?php }elseif($this->uri->segment(2) == "assign_users" && $gant_access == true ){ ?>
				...
				<?php }elseif($this->uri->segment(2) == "reporting" && $gant_access == true ){ ?>
							
							<?php foreach($course_list as $course) {?>
							<li class="menu-item">
								<a href="<?php echo base_url() .'course/reporting/'. $categ_id .'/'. $course['course_id']; ?>" class="menu-link ">
