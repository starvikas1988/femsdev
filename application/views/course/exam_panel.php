...
<div class="wrap">
	<section class="app-content">
		<div class="row">
			<div class="col-md-2">
			<input type="hidden" id="lt_exam_categories_id" value="<?php echo $categories_id; ?>">
			<input type="hidden" id="lt_exam_course_id"     value="<?php echo $course_id;     ?>">
			<input type="hidden" id="lt_course_title_id"     value="<?php echo $course_title; ?>"> 
...
<div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel" aria-hidden="true">
  <div class="modal-dialog small_modal_new" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn_padding filter_btn_blue save_common_btn" id="confirmSubmit">Submit</button>
      </div>
    </div>
  </div>
</div>
