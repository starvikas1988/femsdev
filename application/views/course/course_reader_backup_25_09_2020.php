											...
											<div class="wrap course_section" id="partition_<?php echo $title['title_id']; ?>" style="display:<?php echo $k == 0 ? 'block':'none'; ?>">
												...
												<div class="embed-responsive-16by9">
													<?php for($i=0;$i<count($file_name);$i++){ ?>	 
														...
														<?php }elseif(strtolower($file_extension) == 'jpeg' || strtolower($file_extension) == 'jpg'){ ?> 
													   ...
													   <?php }elseif(strtolower($file_extension) == 'pdf' ){ ?> 
															...
															<div id="pdf"  style="height:500px ">
																<img class="tag" src="">
																<object id="pdf_file_<?php echo $title['title_id']; ?>" data="<?php echo base_url();?>course_uploads/<?php echo $file_name[$i]; ?>#toolbar=0&scrollbar=0&navpanes=1" type="application/pdf" width="100%" height="100%"></object> 
															</div>
															&nbsp;
												...
												<div class="card-body ">
													...
													<?php foreach($course_title as $title){ ?> 
														...
														<div class="form-group border-bottom">
															...
															<label class="control control-solid control-solid-primary control--checkbox"   ><?php echo $i;?>. <?php echo $title['title']; ?>
																<input type="checkbox"    <?php echo $i == 1 ?'':''; ?> data-checkboxid="<?php echo $i ;?>"  name="checksel" value="<?php echo $title['title_id']; ?>" class="form-check-input check"  id="material<?php echo $i; ?>" data-id="<?php echo $title['title_id']; ?>"  class="check" data-label="<?php echo $title['title_id']; ?>">
															...
															<?php }else{ ?>	
															 <label class="control control-solid control-solid-primary control--checkbox"><?php echo $i;?>. <?php echo $title['title']; ?>
																<input type="checkbox"   <?php echo $is_checked; ?>  data-checkboxid="<?php echo $i ;?>"  name="checksel" value="<?php echo $title['title_id']; ?>" class="form-check-input check"  id="material<?php echo $i; ?>" data-id="<?php echo $title['title_id']; ?>"  class="check" data-label="<?php echo $title['title_id']; ?>">
																<span class="control__indicator "></span>
															</label>
															<?php } ?>
																...
																<?php if($title_exam[$key1]['title_id'] == $title['title_id']){ ?>
																	...
																	<?php if(!empty($exam_complete)){ ?>
																		<?php if(isset($exam_complete[$j])){ ?>
																			<button type="submit" title="<?php echo $exam_complete[$j]['exam_status'] == 0 ? 'Proceed to Exam':'Examination Completed' ?>" style="display:<?php echo $is_checked == 'checked'? 'block':'none'; ?>" id="view_<?php echo $title['title_id']; ?>" value="<?php echo $course_id; ?>" class="btn btn-success view_course">
