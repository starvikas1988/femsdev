					...
					<div class="widget-body">
						<div class="row">
							<div class="col-md-2 pull-right">
                                    ...
                                    <a class="btn btn-primary text-white form-control" href="<?php echo base_url(); ?>course/report_analytics/<?php echo $categ_id; ?>/<?php echo $course_id; ?>" style="display:<?php echo $cat == '' ? 'none' : 'block'; ?>">Analytics Report</a>
                                    <button type="button" style="display:none;" class="btn form-control success" onclick="unfreez_user_all();" id="unfreez_all">Un-Freeze</button>
							</div>
							<div class="col-md-12 ">
