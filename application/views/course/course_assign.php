	...
	<?php echo form_open('',array('method' => 'POST')) ?>
		...
		<div class="col-md-2">
			...
			<div class="form-group filter-widget">
				...
				<select class="form-control common_multiselect" name="office_id[]" id="foffice_id"  multiple  size="10">
		...
		<div class="col-md-3">
			...
			<div class="form-group filter-widget">
				...
				<?php if(get_role_dir()=="super" || get_role_dir()=="admin" ||  get_role_dir()=="manager" || get_role_dir()=="tl" || get_global_access()=='1'){ ?>
				<select class="form-control common_multiselect" name="dept_id[]" id="dept_id"  multiple  size="10">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-2">
						<label for="inputCourse">Upload Assignee :</label> 
					</div>
					<div class="col-sm-4">
