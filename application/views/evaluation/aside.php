	...
	<div class="aside-scroll">
		<div id="aside-scroll-inner" class="aside-scroll-inner">
			...
			<ul class="aside-menu aside-left-menu">
				...
				<li class="menu-item">
					<a href="<?php echo base_url()?>evaluation/evaluate_list" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-view-dashboard zmdi-hc-lg"></i></span>
						<span class="">Review/Evaluate</span>
					</a>
				</li><!-- .menu-item -->
				
				<?php } ?>
				
				<?php if(get_global_access()!='1' && get_role_dir()!="super" ){ ?>
				<li class="menu-item">
					
					<a href="<?php echo base_url()?>evaluation" class="menu-link">
						<span class="menu-icon"><i class="zmdi zmdi-view-dashboard zmdi-hc-lg"></i></span>
						<span class="">Submit Own</span>
					</a>
				</li>
				<?php } ?>
