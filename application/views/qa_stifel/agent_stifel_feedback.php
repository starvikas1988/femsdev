						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('qa_stifel/agent_stifel_feedback'); ?>">
							<div class="row">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url()?>qa_stifel/agent_stifel_feedback" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
