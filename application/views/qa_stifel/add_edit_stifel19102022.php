					...
					<div class="widget-body">
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr>
										<td colspan="6" id="theader" style="font-size:40px">Stifel Scorecard</td>
									...
									<tr>
										...
										<td>Fusion ID:</td>
										<td><input type="text" class="form-control" id="fusion_id" value="<?php echo $stifel['fusion_id'] ?>" readonly ></td>
										<td>L1 Supervisor:</td>
										<td>
									...
									<tr>
										<td>Call Duration:</td>
										<td><input type="text" class="form-control" id="call_duration" name="data[call_duration]" value="<?php echo $stifel['call_duration'] ?>" required></td>
										<td>Hold Duration:</td>
										<td><input type="text" class="form-control" id="hold_duration" name="data[hold_duration]" value="<?php echo $stifel['hold_duration'] ?>" required></td>
										<td>Verification Duration:</td>
										<td><input type="text" class="form-control" id="verification_duration" name="data[verification_duration]" value="<?php echo $stifel['verification_duration'] ?>" required></td>
									</tr>
									<tr>
										<td>Interaction ID:</td>
										<td><input type="text" class="form-control" name="data[interaction_id]" value="<?php echo $stifel['interaction_id'] ?>" required></td>
									</tr>
									<tr>
										<td>Audit Type:</td>
										<td>
									...
									<tr>
										...
										<td><input type="text" value="<?= $stifel['earned_score']?>" readonly id="jurys_inn_earned_score" name="data[earned_score]" class="form-control" style="font-weight:bold"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Possible Score:</td>
										<td><input type="text" value="<?= $stifel['possible_score']?>" readonly id="jurys_inn_possible_score" name="data[possible_score]" class="form-control" style="font-weight:bold"></td>
										<td style="font-weight:bold; font-size:16px; text-align:right">Overall Score:</td>
										<td><input type="text" readonly id="jurys_inn_overall_score" name="data[overall_score]" class="form-control stifel_fatal" style="font-weight:bold" value="<?php echo $stifel['overall_score'] ?>"></td>
									</tr>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points business" name="data[opening]" required>
												<option value="">-Select-</option>
									...
									<!-- <tr>
										...
										<td>
											<select class="form-control jurry_points business" name="data[recording_verbiage]" required>
												<option value="">-Select-</option>
										...
										<td colspan=2><input type="text" name="data[cmt2]" class="form-control" value="<?php echo $stifel['cmt2'] ?>"></td>
									</tr> -->
									<tr>
										<td colspan=2>Closing</td>
										<td>
											<select class="form-control jurry_points business" name="data[closing]" required>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[transfer]" required>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td colspan=2>Tone / Rate Of Speech / Fumbling</td>
										<td>
											<select class="form-control jurry_points customer" name="data[rate_of_speech]" required>
												<option value="">-Select-</option>
												<option ji_val=5 <?php echo $stifel['rate_of_speech'] == "Yes"?"selected":"";?> value="Yes">No</option>
												<option ji_val=5 <?php echo $stifel['rate_of_speech'] == "No"?"selected":"";?> value="No">Yes</option>
									...
									<tr>
										<td colspan=2>Interruption /Parallel Conversation</td>
										<td>
											<select class="form-control jurry_points customer" name="data[parallel_conversion]" required>
												<option value="">-Select-</option>
												<option ji_val=5 <?php echo $stifel['parallel_conversion'] == "Yes"?"selected":"";?> value="Yes">No</option>
												<option ji_val=5 <?php echo $stifel['parallel_conversion'] == "No"?"selected":"";?> value="No">Yes</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points compliance" id="stifel_AF1" name="data[issue_identification]" required>
												<option value="">-Select-</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[probing]" required>
												<option value="">-Select-</option>
										...
										<td colspan=2><input type="text" name="data[cmt12]" class="form-control" value="<?php echo $stifel['cmt12'] ?>"></td>
									</tr>
									<tr>
										<td colspan=2 style="color:red">False Commitment</td>
										<td>
											<select class="form-control jurry_points compliance" id="stifel_AF2" name="data[false_commitment]" required>
												<option value="">-Select-</option>
												<option ji_val=10 <?php echo $stifel['false_commitment'] == "Yes"?"selected":"";?> value="Yes">No</option>
												<option ji_val=10 <?php echo $stifel['false_commitment'] == "No"?"selected":"";?> value="No">Yes</option>
									...
									<tr>
										<td class="eml">ZTP</td>
										<td colspan=2 style="color:red">ZTP</td>
										<td>
											<select class="form-control jurry_points compliance" id="stifel_AF5" name="data[ztp]" required>
												<option value="">-Select-</option>
												<option ji_val=10 <?php echo $stifel['ztp'] == "Yes"?"selected":"";?> value="Yes">No</option>
												<option ji_val=10 <?php echo $stifel['ztp'] == "No"?"selected":"";?> value="No">Yes</option>
											</select> 
										</td>
									...
									<tr style="background-color:#D2B4DE">
										<td>Earned:</td><td id="custJiCisEarned1"></td><td>Earned:</td><td id="busiJiCisEarned1"></td><td>Earned:</td><td id="complJiCisEarned1"></td>
									</tr>
									<tr style="background-color:#D2B4DE">
									...
									<tr>
										<td>Call Summary:</td>
										<td colspan=2><textarea class="form-control" name="data[call_summary]"><?php echo $stifel['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan=2><textarea class="form-control" name="data[feedback]"><?php echo $stifel['feedback'] ?></textarea></td>
									</tr>
									<tr>
									...
									<?php if($stifel_id!=0){ ?>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Feedback Acceptance:</td><td colspan=4><?php echo $stifel['agnt_fd_acpt'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td><td colspan=4><?php echo $stifel['agent_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td><td colspan=4><?php echo $stifel['mgnt_rvw_note'] ?></td></tr>
										<tr><td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td><td colspan=4><?php echo $stifel['client_rvw_note'] ?></td></tr>
