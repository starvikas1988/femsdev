							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[rate_of_speech]" required>
												<option value="">-Select-</option>
												<option ji_val=10 <?php echo $stifel['rate_of_speech'] == "Yes"?"selected":"";?> value="Yes">No</option>
												<option ji_val=10 <?php echo $stifel['rate_of_speech'] == "No"?"selected":"";?> value="No">Yes</option>
									...
									<tr>
										...
										<td>
											<select class="form-control jurry_points customer" name="data[parallel_conversion]" required>
												<option value="">-Select-</option>
												<option ji_val=10 <?php echo $stifel['parallel_conversion'] == "Yes"?"selected":"";?> value="Yes">No</option>
												<option ji_val=10 <?php echo $stifel['parallel_conversion'] == "No"?"selected":"";?> value="No">Yes</option>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control jurry_points customer" id="stifel_AF5" name="data[ztp]" required>
												<option value="">-Select-</option>
