			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('qa_stifel/qa_stifel_report'); ?>">	
						...
						<div class="row">
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary waves-effect" a href="<?php echo base_url()?>qa_stifel/qa_stifel_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
