	...
	<div id="body1" style='width:100%;'>
		...
		<tr >
			...
			<?php } else if ($rank <= '6' && $rank >= '4') { ?>
				<img height='80px' src="<?php APPPATH ?>main_img/shivika_signature_windows.png" alt="signature" />
			<?php } else { ?>
				<img height='80px' src="<?php APPPATH ?>main_img/srijita_signature_windows.png" alt="signature" />
			<?php } ?>
