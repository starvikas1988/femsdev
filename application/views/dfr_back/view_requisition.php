                                                            ...
                                                            if ($r_status == 'A' && $c_status != 'E') {
                                                                ...
                                                                if ($c_status == 'P' || $c_status == 'IP') {
                                                                    ...
                                                                    if ($required_pos > $filled_pos) {
                                                                        ...
                                                                        // CHECK OFFICE ACCESS
                                                                        $pay_lock = 1;
                                                                        if (isDisablePayrollInfo($cd['location']) == false || get_user_fusion_id() == "FELS005708") {
                                                                            $pay_lock = 0;
                                                                        }
...
// echo $dfr_location;
                    ...
                    <div class="site_cspl" style="display: none">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Site <?php if($dfr_location == 'CHA'){ ?><i class="fa fa-asterisk" style="font-size:6px; color:red"></i><?php } ?></label>
                                    <select name="site" class="form-control site" <?php echo ($dfr_location == 'CHA')?'required="required"':'';?> >
