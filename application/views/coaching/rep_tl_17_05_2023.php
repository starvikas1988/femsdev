<style>
	...
	<div class="row">
		...
		<header class="widget-header">
			<h4 class="widget-title">Coaching Report</h4>
		</header>
	...
	<div class="row">
		...
		<div class="col-md-12">
				<div class="widget">
					...
					<header class="widget-header">
						<h4 class="widget-title"> TL/Trainer Wisw Coaching Report </h4>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped" cellspacing="0" width="100%">
								...
								<?php 
									...
									if($pcoach_id!=$coach_id){
										
										if($pcoach_id!="") echo "<tr class=''><td colspan='14' class='bg-sep'></td></tr>";
										$pcoach_id=$coach_id;
										$cnt=1;
									}
