			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" id="phone" name="phone" class="form-control" minlength=10 maxlength=12 value="" onkeypress="return isNumber(event)" placeholder="Enter Phone no" onkeyup="isNumber(this);" required>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label>Alternate Phone</label>
						<input type="text" id="" name="alter_phone" class="form-control" value="" minlength=10 maxlength=12 onkeypress="return isNumber(event)" placeholder="Enter Alternate Phone no">
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
      ...
      <div class="modal-body">
			...
			<?php }else{ ?>
				<div class="col-md-3" id="hir">
					<div class="form-group">
						<label>Hiring Source</label>
						<!-- <input type="text" id="hiring_source" name="hiring_source" class="form-control"> -->
						<select id="hiring_source" name="hiring_source" class="form-control" required>
							<option value="Existing Emplyee">Existing Emplyee</option>
							<option value="Job Portal">Job Portal</option>
							<option value="Consultancy">Consultancy</option>
