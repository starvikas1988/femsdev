								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<select class="form-control" name="department_id" >
											...
											<option value="0" <?php echo $o_department_id == 0 && $o_department_id != '' ? "selected" : ""; ?>>Support</option>
										</select>
									</div>
								</div>
			...
			<div class="col-md-12">
				<div class="widget">
					...
					<div class="widget-body">
						...
						<div class="row">
							<?php 									
								if( get_dept_folder()=="wfm" || get_global_access()== 1 || $is_role_dir=="admin" || $is_role_dir=="manager" || is_access_dfr_module()==true || is_approve_requisition()==true ){ 
							?>
									...
									<tr>
										...
										<td width="145px" style="text-align:left">
											<?php 											
												...
												$params=$row['location']."#".$row['dueDate']."#".$row['department_id']."#".$row['role_id']."#".$row['client_id']."#".$row['process_id']."#".$row['employee_status']."#".$row['req_qualification']."#".$row['req_exp_range']."#".$row['req_no_position']."#".$row['job_title']."#".$row['job_desc']."#".$row['req_skill']."#".$row['additional_info']."#".$row['req_type']."#".$row['proposed_date']."#".$row['company_brand'];
