...
<div style="margin:5px;">	
	...
	<div id="body1" style='width:100%;'>
		...
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>	
			<span>1. The commencement of your Training/Joining will be from <b> <u><?php echo $can_dtl_row['doj'];?></u></b> and can be subject to <u>Work from Home basis or Work from Office basis.</u></span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
			<span >2. Training Period would be of <b>15 to 20 days</b>.</span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>3. Training batch timings will be from <b>9 am to 6 pm</b> with breaks.</span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>4. Training timings can be changed based on the business requirement by your respective trainer.</span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>5. Please note that your joining CSPL is subject to meeting all the following conditions mentioned here under:</span>
		</p>
		...
		<span>6. Please note that the training or subsequent employment with the CSPL is subject to either <b>Work from Home</b> or <b>Work from Office</b> as per the requirements of the business, process or client.</span>
		</p>
		<span>7. Please note that training fees is payable if the training period is more than seven working days.</span><br>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>8. Please note that in the event of your not clearing training, you will not be paid training fee and any other costs</span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		...
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>10. <b>Force Majeure:</b> The obligations of CSPL with respect to this offer shall be suspended when the company is subject to Force Majeure, which can be termed as civil disturbance, riots, strikes, storm, tempest, acts of God, emergency etc., </span>
		</p>
		<div style="page-break-after: always"><span style="display: none;">&nbsp;</span></div>
		<br/><br/><br/><br/>
		
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>11. You will have to provide your bank account details to the company along with a "cancelled cheque"/"photocopy of passbook" or you are required to get your account opened during the training before certification. </span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>12. You need to provide scanned copy of following documents at email id - harpreet.singh@mail.competentsynergies.com within first 3 days of your joining in training. You will be allowed to appear for certification post completion of training only after submission of documents as mentioned below: </span>
		...
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 0px;'>
		<span>13. In case of any dispute/clarification, you may contact HR Department. </span>
		</p>
		<P style='text-align:justify; margin-top: 5px; margin-bottom: 5px;'>
		<span>14. It is clearly understood that you will carry out duties/responsibilities diligently, honestly and efficiently. The company reserves the right to terminate your On Job Training/services without notice if it comes to its knowledge that you have indulged in any act of negligence or dishonesty or any act detrimental to the interest of the company. This is without prejudice to the right of the company to claim damages from you. </span>
		</p>
				
		<span>15. Please note that the attached Stipend Annexure forms a part of this Letter of Intent. </span><br>

		<P style='text-align:center;font-size:15px'><strong>Stipend Annexure</P><br>
		
		<span>You will be paid Total Stipend of <strong>Rs. <?php echo $can_dtl_row['gross_pay'];?>/- (Rupees  <?php echo getIndianCurrency($can_dtl_row['gross_pay']); ?> Only) </strong> which is subject to your successful completion of training and client certification.</span><br>
