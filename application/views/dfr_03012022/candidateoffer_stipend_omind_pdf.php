<?php
	...
	$esi_employer = get_esi_employer($gross_pay, $location, $gross_pay);
	$esi_employee = get_esi_employee($gross_pay, $location, $gross_pay);
...
<div style="margin:5px;">	
	...
	<div id="body1" style='width:100%;'>
		...
		<tr >
			<td style="height:30px;">For OMIND TECHNOLOGIES SERVICES PVT. LTD.</td>
			<td style="height:30px;">I hereby accept the above offer<br/></td>
		</tr>
		<tr >
			<td style="height:80px;">
			<img height='50px' src="<?php APPPATH ?>main_img/omind_niladri_sig.jpg" alt="signature" />
			<br/></td>
			<td style="height:80px;">Signature:......................................................<br/><br/></td>
		</tr>
		<tr>
			<td style="height:30px;">
				Niladri Sarkar<br> Manager Technical Recruitment & HR
			</td>
