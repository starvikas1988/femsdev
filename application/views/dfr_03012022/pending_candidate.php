				...
				<div class="col-md-12">
					<div class="widget">
						<header class="widget-header">
							<h4 class="widget-title">Pending Candidate List</h4>
						</header>
											...
											<td width="290px">
												...
												if($c_id!=""){
													...
													if($c_status=='P' || $c_status=='IP'){
														...
														echo '<a class="btn btn-success btn-xs candidateApproval" r_id="'.$r_id.'" c_id="'.$c_id.'" c_status="'.$c_status.'" requisition_id="'.$requisition_id.'" title="Approval to Final Selection (Joining Date)" style="font-size:12px"><i class="fa fa-check-square"></i></a>';
