				...
				<div class="widget">
					<header class="widget-header">
						...
						<div style="float:right; margin-top:-35px; margin-right:20px">
							...
							<a class="btn btn-warning" href="<?php echo $url; ?>" title="" style='font-size:10px'>Back</a>
						</div>
					...
					if( is_access_dfr_module()==1 || get_dept_folder()=="hr" || $is_global_access==1){
						...
						if($required_pos > $filled_pos){
							...
							if(is_block_add_candidate_requisition($requisition_id)==false){
								...
								echo "<button title='' type='button' class='btn btn-primary sendBasicLink' offc_location='$offc_location' r_id='$r_id' requisition_id='$requisition_id' company_brand='$company_brand'  style='font-size:10px'>Send Link to Candidate </button>&nbsp;";
								
								echo "<button title='' type='button' class='btn btn-primary addCandidate' r_id='$r_id' requisition_id='$requisition_id' company_brand='$company_brand' style='font-size:10px'>Add Candidate</button>";
					...
					<table id="default-datatable" data-plugin="DataTable" class="table skt-table" cellspacing="0" width="100%">
						...
						<tbody>
							...
							<tr>
								...
								<td width="70px" <?=$bold;?> ><?php echo $cstatus; ?></td>
								...
								<?php	
									...
									$params=$cd['requisition_id']."#".$cd['fname']."#".$cd['lname']."#".$cd['hiring_source']."#".$dob."#".$cd['email']."#".$cd['phone']."#".$cd['last_qualification']."#".$cd['skill_set']."#".$cd['total_work_exp']."#".$cd['country']."#".$cd['state']."#".$cd['city']."#".$cd['postcode']."#".$cd['address']."#".$cd['summary']."#".$cd['attachment']."#".$cd['gender']."#".$cd['ref_name']."#"."#".$cd['onboarding_type']."#".$cd['company']."#".$cd['guardian_name']."#".$cd['relation_guardian'];
								...
								///////////
									if($c_id!=""){
										...
										if($r_status=='A' && $c_status!='E'){ ////Approve Requisition & not Fusion Employee
											...
											echo '<a class="btn btn-success btn-xs candidateApproval" p_access="'.$pay_lock.'" r_id="'.$r_id.'" c_id="'.$c_id.'" req_id="'.$requisition_id.'"  c_status="'.$c_status.'" org_role="'.$cd['org_role'].'" gender="'.$cd['gender'].'" location_id="'.$cd['location'].'" title="Approval to Final Selection" style="font-size:12px"><i class="fa fa-check-square"></i></a>';
													echo '&nbsp';
												...
												if(get_dept_folder()=="hr" || get_global_access()== 1 ){
													...
													if($cd['location']=='CHA'){
														if($cd['loi']==''){
															echo '<a class="btn btn-primary btn-xs " href="'.base_url().'dfr/download_loi?c_id='.$c_id.'&requisition_id='.$requisition_id.'&r_id='.$r_id.'" title="Click to Download LOI" style="font-size:12px;background-color:#FFFF00;"><i class="fa fa-download"></i></a>';
														...
														{
															echo '<a class="btn btn-primary btn-xs " href="'.base_url().'uploads/loifrom/'.$cd['loi'].'" title="Click to Download LOI" target="_blank" style="font-size:12px"><i class="fa fa-download"></i></a>';
														}	
										...
										if($c_status=='E'){
											...
											if(get_dept_folder()=="hr" || get_global_access()== 1 ){
												...
												if($gross_pay>0 ){
													...
													echo '<a class="btn btn-primary btn-xs " href="'.base_url().'dfr/resend_offer_letter?c_id='.$c_id.'&r_id='.$r_id.'" title="Click to Resend Offer Letter" style="font-size:12px"><i class="fa fa-envelope"></i></a>';
									...
									if(($c_status=='CS' && $r_status=='CL') || ($c_status!='E' && $c_status!='CS')){
										echo "&nbsp";
										...
										?>
											...
											<td class="text-center">
												<?php
													...
													if($r_status=='A'){ ////Approve Requisition
									...
									<table  class="table skt-table" cellspacing="0" width="100%" style="background-color:#FFF;margin-bottom:0px;">
										...
										<tbody>
											...
											<tr>
												...
												<?php if($dfr_location=='CHA'){?>
												<td><?php echo $row['10eng'] ?></td>
												<td><?php echo $row['10math'] ?></td>
												<td><?php echo $row['12eng'] ?></td>
												<td><?php echo $row['12math'] ?></td>
												<?php }?>	
												<?php if(is_access_dfr_module()==1){ 	////ACCESS PART ?>
												<td class="text-center">
													<?php
								...
								<td style="background-color:#EEE">
									<table  class="table skt-table" cellspacing="0" width="100%" style="background-color:#FFF;margin-bottom:0px;">
										...
										<tbody>
											...
											?>
											<?php
												$sh_status=$row1['sh_status'];  //echo $sh_status;
											...
											<tr>
												...
												if($r_status=='A' && $c_status!='E'){ ////Approve Requisition & Fusion Employee
														...
														//if(get_dept_folder()=="hr" || get_role_dir()=="admin" || get_role_dir()=="super" || get_global_access()==1){
																...
																if($sh_status=="P"){
																	...
																	/* }else{
																		...
																		echo "&nbsp &nbsp";
																	if($row1['interview_loc']=='Chandigarh'){
																		if($cd['interview_evalution_form']==''){
																			$urls=base_url().'dfr/interview_evalution_from?candid='.$c_id.'&r_id='.$r_id.'&sch_id='.$sch_id;
																			echo '<a href="'.$urls.'"class="btn btn-success btn-xs " title=" Interview Evaluation Form" r_id="'.$r_id.'" c_id="'.$c_id.'" sch_id="'.$sch_id.'" schType="'.$interview_type.'" schSite="'.$interview_site.'" schAssin="'.$assign_interviewer.'" sh_status="'.$sh_status.'" sch_date="'.$sch_date.'" style="font-size:12px;background-color:#31b0d5"><i class="fa fa-download"></i></a>';

																			echo "&nbsp &nbsp";

																			echo '<a class="btn btn-success btn-xs Interviewfromupload" title=" Interview Evaluation Form Uploas" r_id="'.$r_id.'" c_id="'.$c_id.'" sch_id="'.$sch_id.'" schType="'.$interview_type.'" schSite="'.$interview_site.'" schAssin="'.$assign_interviewer.'" sh_status="'.$sh_status.'" sch_date="'.$sch_date.'" style="font-size:12px;background-color:#f0ad4e;"><i class="fa fa-upload"></i></a>';
																		}
																	else
																		{
																			$urls=base_url()."/uploads/InterviewEvalutionForm/".$cd['interview_evalution_form'];
																			echo '<a href="'.$urls.'"class="btn btn-success btn-xs " target="_blank" title=" Interview Evaluation Form" style="font-size:12px"><i class="fa fa-download"></i></a>';
																		}
																	}
...
<div class="modal fade" id="addCandidateModel" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> &nbsp; First Name</label>
						<input type="text" id="fname" name="fname" class="form-control" value="" placeholder="Enter First name" onkeypress="return /[a-z]/i.test(event.key)" required>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<label><?php if($dfr_location!='CHA'){?><i class="fa fa-asterisk" style="font-size:6px; color:red"></i><?php } ?> &nbsp; Last Name</label>
			...
			<?php } ?>
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="email" id="email" name="email" class="form-control" value="" placeholder="Enter Email" onfocusout="checkemail();" required>
						<span id="email_status" style="color:red;font-size:10px;"></span>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
			...
			<div class="row">
				<div class="col-md-3">
					<div class="form-group">
						...
						<input type="text" id="phone" name="phone" class="form-control" minlength=10 maxlength=12 value="" onkeypress="return isNumber(event)" placeholder="Enter Phone no" onkeyup="isNumber(this);" onfocusout="checkphone()" required>
						<span id="phone_status" style="color:red;font-size:10px;"></span>
					</div>
				</div>
				<div class="col-md-3">
					<div class="form-group">
						<label>Alternate Phone</label>
						<input type="text" id="alter_phone" name="alter_phone" class="form-control" value="" minlength=10 maxlength=12 onkeypress="return isNumber(event)" placeholder="Enter Alternate Phone no" onfocusout="checkalterphone()">
			...
			<div class="row">
				<div class="col-md-5">
					<div class="form-group">
						...
						<div style="display:inline-block">
							<input class="form-check-input_r" type="radio" name="interest" id="interest_voice" value="Voice" <?php echo ($dfr_location!='CHA')?'required':'';?>>
							<label class="form-check-label" for="interest_voice">Voice</label>
						</div>
						<div style="display:inline-block">
							<input class="form-check-input_r" type="radio" name="interest" id="interest_back" value="Back Office" <?php echo ($dfr_location!='CHA')?'required':'';?>>
							<label class="form-check-label" for="interest_back">Back Office</label>
						</div>
						<div style="display:inline-block">
							<input class="form-check-input_r" type="radio" name="interest" id="interest_other" value="Other" <?php echo ($dfr_location!='CHA')?'required':'';?>>
			...
			<div class="row">
				<?php if($dfr_location == 'ELS' || $dfr_location == 'JAM') { } else{ ?>
					...
					<div class="form-group">
						...
						<?php } ?>
						&nbsp; Post Code</label>
						<input type="text" id="postcode" name="postcode" class="form-control" onkeypress="return isNumber(event)" value="" placeholder="Enter Postcode" <?php echo ($dfr_location!='CHA')?'required':'';?>>
					</div>
				</div>
				<?php } ?>
				<div class="col-md-5">
      ...
      <div class="modal-body">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label>Location</label>
						<input type="text" id="office_location_edit" name="location" class="form-control" value="" required readonly>
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
			...
			<div class="row" id="check_payroll">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" min="0" id="incentive_amt" name="incentive_amt" class="form-control" autocomplete="off" >
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<input type="number" min="0" id="joining_bonus" name="joining_bonus" class="form-control" autocomplete="off" >
					</div>
				</div>
...
<!--------------- From Upload -------------------->
<div class="modal fade" id="InterviewEvalutionFrom" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
...
<!--------------- Fro loi Upload -------------------->
<div class="modal fade" id="loi_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
