...
<div class="col-md-12">
<a href="<?php echo base_url('letter/confirmation_list/1'); ?>">
<div class="widget widgetRibbonLD" style="border-radius: 3px; cursor:pointer;">
	<div class="customRibbonCount bg-danger"><?php echo $confirmationCount; ?></div>
	<header class="widget-header">
		<div class="widget-title" style="color:darkblue; font-size:16px; text-align:center;">
		 Your Pending Confirmation<i class="fa fa-bar-graph"></i>
		</div>
	</header>
</div>
</a>
