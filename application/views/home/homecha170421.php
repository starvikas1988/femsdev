										...
										<div class="row">
											 ...
											 <div style="padding:6px;margin-bottom:1px;" class="alert alert-asset" role="alert">
												<div class="row">
													...
													<div style="display:inline; font-size:14px;" class="col">
														<strong>Do not refer to attendance module in FEMS. Attendance module is not applicable for US Region.</strong>
													</div>
												</div>
											</div>
						...
						<div class="row" style="margin-bottom:5px;" >
							...
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
									...
									<i class="fa fa-bar-chart"></i> Download EfficiencyX(1.0.1.3)</div>
								</header>
							</div>
							</a>
...
<div id="addReferrals" class="modal fade">
  <div class="modal-dialog">
	<div class="modal-content">      
			...
			<form class="frmAddReferrals" action="" onsubmit="return false;" data-toggle="validator" method='POST'>
						...
						<div class="widget stats-widget">
							...
							<div class="widget-body clearfix">
									 ...
									 <center>
										 ...
										 <b>Do not refer to attendance module in FEMS. Attendance module is not applicable for US Region.<b>
										</span>	
									</center>									
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div style="background: aliceblue;box-shadow: 0 1px 2px #ccc">
						Please note that CSPL will be capturing your system data, while you are logged into EfficiencyX  and FEMS during Official duty. This is to ensure compliance monitoring is in place for the business. Application will not store any customer sensitive information or key logs. please ensure you are logged into EfficiencyX when you are in shift and logout from FEMS while your shift is over.
					</div>
