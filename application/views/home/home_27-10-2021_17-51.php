...
<?php //if ( get_role_dir() !="super" && get_global_access()=='0') { ?>
		...
		<div class="row">
			...
			<?php
			if(get_user_office_id()=="CEB" OR get_user_office_id()=="MAN") { 
			?>
						...
						<?php if(isAccessMindfaqApps()==true){ ?>
							...
							<?php } ?>
								...
								<?php if(is_access_howard_modules()){ 
									//if(get_process_ids() == '581'){
									?>
								<div class="case-wrapper" title="Contact Tracing Howard">
									<a  href="<?php echo base_url()."Howard_training";?>" >
										<div class="app-icon" style="background-color: #fff;padding: 14px 8px;" title="Contact Tracing Howard">
											<!--<i class="fa fa-medkit" title="Contact Tracing Zovio" aria-hidden="true" style=""></i>-->
											<img style="width: 100px;height: 32px;" src="<?php echo base_url(); ?>assets/images/Howard_logo.png" border="0" alt="Howard CRM">
										</div> 
										<div class="case-label ellipsis"> 
											<span class="case-label-text">
												Howard CRM
