					...
					<div class="widget-body clearfix" style="padding: .8rem 0.6rem;">
						...
						<div class='apps_grid'>
								...
								<div class='outerBoxTitle'>Learn</div>
										...
										<!-- ======== Learn > 1 Training ============== -->
										<?php 
										if(get_dept_folder()=="training" || get_dept_folder()=="hr" || is_access_trainer_module()==true || isAgentInTraining() || isAvilTrainingExam() >0 || get_user_fusion_id() == 'FCHA000721' ){
											
											if(isAssignAsTrainer()>0 || get_user_fusion_id() == 'FCHA000721') $linkurl=base_url()."training/crt_batch";
