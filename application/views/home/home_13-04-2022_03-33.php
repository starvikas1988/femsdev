					...
					<div class="widget-body clearfix" style="padding: .8rem 0.6rem;">
						...
						<div class='apps_grid'>
								...
								<div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
									<div class='outerBoxTitle'>Human Resource</div>
										...
										<?php
											...
											if(get_role_dir()!="agent" || get_site_admin()=='1' || get_global_access()=='1' || get_dept_folder()=="hr" || get_dept_folder()=="Recruitment" || get_dept_folder()=="wfm"  || get_dept_folder()=="rta" || is_enable_my_team() == true){
												...
												else if(get_dept_folder()=="hr" || get_dept_folder()=="Recruitment") $team_url=base_url().'hr/dashboard';
									...
									if ((get_dept_folder() == "hr" || get_dept_folder() == "it" || get_global_access()=='1' || get_user_fusion_id() == "FKOL011103" || get_user_fusion_id() == "FKOL008602") && (isIndiaLocation(get_user_office_id()) == true)) {
										?>
								...
								<div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
									...
									<?php if(get_global_access()=='1' || get_site_admin()=='1' ||  get_dept_folder()=="hr" || get_role_dir()=="super" || get_role_dir()=="admin" || get_role_dir()=="manager" || get_role_dir()=="tl" || get_dept_folder()=="wfm" || get_dept_folder()=="rta" || is_access_breakmon() == true ){ ?>
