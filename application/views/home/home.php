...
<style>
  ...
  /*start take css from here for birthday popup*/
  .birthday-content {
	width:100%;
	padding:50px;
	font-family: 'Roboto', sans-serif;
  }
  .birthday-widget .modal-body {
	padding:0 15px;
  }
  .birthdy-img {
	height:450px;
  ...
  #mid {
	...
	#mid #cid {
	  background: url("<?php echo base_url(); ?>assets/images/masking.jpg") center center no-repeat;
	  background-size: 150%;
	  text-align: center;
	...
	/*end take css from here for birthday popup*/
  </style>
	...
	.modal-design .modal-body {
		padding:50px 0;
		background:url(<?php echo base_url(); ?>assets/images/pattern-bg.png) no-repeat;
		background-size:cover;
	}
	.modal-design .img-responsive {
		width:100%;
	}
	.popup-content {
		width:100%;
...
<?php 
		...
		if ($break_on_sd === false) $sdHide = 'style="display:none;"';
		else $sdDiasable = "disabled";		
	?>
	...
	<section class="app-content">
		...
		<div class="row">
			<div class="col-md-9">
					...
					<?php if($office_asset['fusion_id'] !="" && $asset_return['fusion_id'] == "") { ?>
...
<?php //if ( get_role_dir() !="super" && get_global_access()=='0') { ?>
				...
				<header class="widget-header">
					...
					<div class="widget-body row">
						...
						<div class="col-md-4">
							<div class="widget">
								<header class="widget-header">
									<h4 class="widget-title">System Downtime</h4>
								</header>
								<hr class="widget-separator">
								<div class="widget-body row">
									<div class="col-xs-12" align="center">
										<label class="switch  switch-flat">
											<?php if ($break_on_sd === true) : ?>
												<input class="switch-input" type="checkbox" id="break_check_button_sd" checked>
											<?php else : ?>
												<input class="switch-input" type="checkbox" id="break_check_button_sd" <?php echo $sdDiasable; ?>>
											<?php endif; ?>
									...
									<div class="col-xs-12" align="center">
										<h3 class="fz-xl fw-400 m-0" data-plugin="counterUp">
											<span id="countdown_sd" <?php echo $sdHide; ?>></span>
											<span id="countdown1_sd"><br /></span>
										</h3>
									</div>
								</div>
				...
				<div class="widget">					
					...
					<div class="widget-body clearfix" style="padding: .8rem 0.6rem;">
						...
						<div class='apps_grid'>
								...
								<div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
									<div class='outerBoxTitle'>Human Resource</div>
										...
										<?php
											...
											if(get_role_dir()!="agent" || get_site_admin()=='1' || get_global_access()=='1' || get_dept_folder()=="hr" || get_dept_folder()=="Recruitment" || get_dept_folder()=="wfm"  || get_dept_folder()=="rta" || is_enable_my_team() == true){
			
												if(get_global_access()=='1') $team_url = base_url()."super/dashboard";
												else if(get_dept_folder()=="hr" || get_dept_folder()=="Recruitment" || get_user_fusion_id() == 'FKOL011173') $team_url=base_url().'hr/dashboard';
										...
										<?php
										$linkurl = base_url() . "dfr_can_assets";

									if ((get_dept_folder() == "hr" || get_dept_folder() == "Recruitment" || get_dept_folder() == "it" || get_global_access()=='1' || get_user_fusion_id() == "FKOL011103" || get_user_fusion_id() == "FKOL008602") && (isIndiaLocation(get_user_office_id()) == true)) {
										?>

											<div class="case-wrapper <?php echo $ac_class; ?>" title="Delivary Fullfilment Ratio">
												<a href="<?php echo $linkurl; ?>">
													<div class="app-icon" style="background-color: #b3b300" title="Delivary Fullfilment Ratio">
								...
								<?php
								if(isIndiaLocation(get_user_office_id())==true  || isPhilLocation(get_user_office_id())==true){
								?>
								...
								<div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
									...
									<?php
										...
										if(in_array(get_user_office_id(), ["ALT", "JAM", "CEB","MAN", "CAS"]) || isIndiaLocation(get_user_office_id())==true || get_user_oth_office()=="JAM" || get_global_access()=='1')
									...
									<?php if(get_global_access()=='1' || get_site_admin()=='1' ||  get_dept_folder()=="hr" || get_dept_folder() == "Recruitment" || get_role_dir()=="super" || get_role_dir()=="admin" || get_role_dir()=="manager" || get_role_dir()=="tl" || get_dept_folder()=="wfm" || get_dept_folder()=="rta" || is_access_breakmon() == true ){ ?>
								...
								<?php if (news_access_permission() == 1) { ?>
                                        <div class="case-wrapper" title="News">
                                            <a href="<?php echo base_url() . "news/news_list"; ?>">
                                                <div class="app-icon" style="background-color: #605081;" title="news">
                                                    <i class="fa fa-newspaper-o" title="News" aria-hidden="true" style=""></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                    <span class="case-label-text">News</span>
                                                </div>
                                            </a>
                                        </div>
                                        <?php
									...
									<a  href="<?php echo base_url()."itdeclaration";?>" >
										...
										<div class="case-label ellipsis"> 
											...
											<span class="case-label-text" style="font-size: 8px;">IT Declaration</span>
                                                                ...
                                                                <!-- ======== Financials > 3 Mediclaim Card ============== -->
								<div class="case-wrapper" title="Mediclaim Card">
									<a href="<?php echo base_url() . "mediclaim"; ?>">
										<div class="app-icon" style="background-color: #3498db" title="Mediclaim Card">
											<i class="fa fa-heart" title="Mediclaim Card" style=""></i>
										</div>
										<div class="case-label ellipsis">
											<!-- <div class="circle module-count-list-project" data-doctype="Project" style=""> <span class="circle-text">1</span></div>  -->
											<span class="case-label-text">Mediclaim Card</span>
										</div>
									</a>
								</div>
						...
						<?php if(isAccessMindfaqApps()==true){ ?>
								...
								if(get_user_fusion_id()!="FKOL002881" && get_user_fusion_id()!="FJAM004129"){?>
									<div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
                                        ...
                                        <?php if(is_access_cci_modules()==true){ ?>
											<div class="case-wrapper" title="CCI Mind FAQ">
												<a href="<?php echo base_url() ."cci_new"; ?>">
													<div class="app-icon" style="background-color: #0F6FBF ;" title="Connect i-Care Mind FAQ">
														<i class="fa fa-comments-o" title="Pay Nearby Mind FAQ" aria-hidden="true" style=""></i>
													</div> 
													<div class="case-label ellipsis"> 
														<span class="case-label-text">
										...
										<?php if(is_access_phs_modules()==true){ ?>
											<div class="case-wrapper" title="Premier Health Solutions Mind FAQ">
												<a href="<?php echo base_url() ."mindfaq_phs"; ?>">
													<div class="app-icon" style="background-color: #114893 ;" title="Premier Health Solutions Mind FAQ">
														<i class="fa fa-comments-o" title="Premier Health Solutions Mind FAQ" aria-hidden="true" style=""></i>
													</div> 
													<div class="case-label ellipsis"> 
														<span class="case-label-text">
															PHS MindFAQ
							...
							<div class='AppsOuterBox ' style="padding: 5px 5px 8px 5px;">
								...
								<?php if(is_access_mckinsey_modules()){
									...
									?>
									<div class="case-wrapper" title="Mckinsey">
										<a  href="<?php echo base_url()."mck/";?>" >
											<div class="app-icon" style="background-color: #36c95f;padding: 14px 8px;" title="Mckinsey">
												<!--<i class="fa fa-medkit" title="Contact Tracing Zovio" aria-hidden="true" style=""></i>-->
												<img style="width: 100px;height: 32px;" src="<?php echo base_url(); ?>assets/mckinsey/images/mckinsey_icon.jpg" border="0" alt="MCkinsey">
											</div> 
											<div class="case-label ellipsis"> 
												<span class="case-label-text">
													Mckinsey
								...
								<div class="case-wrapper" title="CJ CRM">
									<a href="<?php echo base_url() . "emat_new/dashboard"; ?>">
										<div class="app-icon" style="background-color: #682fa7" title="CJ CRM">
											<i class="fa fa-envelope" title="CJ CRM" aria-hidden="true" style=""></i>
										</div>
										<div class="case-label ellipsis">
											<span class="case-label-text">
												CJ CRM
								...
								<div class="case-wrapper" title="Client CCI">
									<a href="<?php echo base_url() ."webpages/cci/index.html"; ?>" target="_blank">
										<div class="app-icon" style="background-color: #1b348f;" title="Client CCI">
											<img style="width:100px;height: 32px;" src="<?php echo base_url() ."webpages/cci/cci1.png"; ?>" border="0" alt="Queen's English CRM">
										</div> 
										<div class="case-label ellipsis"> 
											<span class="case-label-text">
												CCI Health
							...
							<div class='AppsOuterBox'>
								...
								$ac_class="";
								$linkurl=base_url()."mindfaq_analytics_skt";
								?>								
	...
	<!------    -->
		...
		<div class="col-md-3">  <!-- start of right side box -->
						...
						<?php 
							// && count($iplcontest)
							if(isIndiaLocation(get_user_office_id())==true >0)
							{
						?>
						...
						<div class="row" style="margin-bottom:1px;">
							<div class="col-md-12">
								...
								<a data-toggle="modal" data-target="#support-helpdesk" style="cursor:pointer;">

									<div class="widget" style="border-radius: 3px; background:#adf08f; cursor:pointer;">
										<img src="<?php echo base_url(); ?>assets/images/support-helpdesk1.jpg" />
									</div>
						...
						<div class="row" style="margin-bottom:1px;">
							<div class="col-md-12">
								...
								<a data-toggle="modal" data-target="#hr-employee-support" style="cursor:pointer;">

									<div class="widget" style="border-radius: 3px; background:#adf08f; cursor:pointer;">
										<img src="<?php echo base_url(); ?>assets/images/hr-employee-support1.jpg" />
									</div>
						...
						?>
							...
							<div class="row" style="margin-bottom:2px;">
								<div class="col-md-12">
									...
									<div class="widget" id='appPayrollCalendar' style="border-radius: 3px;background: aliceblue; cursor:pointer;">
										<header class="widget-header">
											<div class="widget-title" style="font-size:16px; text-align:center;"><i class="fa fa-list-alt" style="font-size:18px;color:red"></i> Payroll calendar <?php echo $currYear; ?></div>
										</header>
									</div>
						...
						<!-- -------------- ER Calendar Kolkata 2022 -------------- -->

						<?php if(in_array(get_user_office_id(),array("KOL"))){ ?>

						<div class="row" style="margin-bottom:2px;" >
							<div class="col-md-12">
							
							<a data-toggle="modal" data-target="#refERCalendar" style="cursor:pointer;">
							
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
									<div class="widget-title" style="font-size:16px; text-align:center;"><i class="fa fa-list-alt" style="font-size:18px;color:red"></i> ER calendar <?php echo $currYear; ?></div>
								</header>
							</div>
                        ...
                        <!-- -------------- LD Calendar Kolkata 2022 -------------- -->

						<?php /*?><?php if(in_array(get_user_office_id(),array("KOL"))){ ?><?php */?>

						<div class="row" style="margin-bottom:2px;" >
							<div class="col-md-12">
							
							<a data-toggle="modal" data-target="#refLDCalendar" style="cursor:pointer;">
							
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
									<div class="widget-title" style="font-size:16px; text-align:center;"><i class="fa fa-list-alt" style="font-size:18px;color:red"></i> L&D calendar <?php echo $currYear; ?></div>
								</header>
							</div>
						...
						<div class="row" style="margin-bottom:2px;" >
							...
							<a data-toggle="modal" data-target="#refLDCourses" style="cursor:pointer;">
							
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
									<div class="widget-title" style="font-size:16px; text-align:center;"><i class="fa fa-list-alt" style="font-size:18px;color:red"></i> L&D Mandatory Courses </div>
								</header>
							</div>
                        ...
                        <div class="row" style="margin-bottom:px;" >
							...
							<a href="<?php echo base_url(); ?>uploads/email_creation_deletion_pdf/email_id_creation_deletion.pdf" target="_blank" style="cursor:pointer;">
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
									<div class="widget-title" style="font-size:16px; text-align:center;" ><i class="fa fa-file-pdf-o" style="font-size:18px;color:red"></i> Email ID Creation & Deletion Procedure</div>
								</header>
							</div>
							</a>
						...
						<div class="row" style="margin-bottom:2px;" >
							...
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
									...
									<i class="fa fa-bar-chart"></i> Download EfficiencyX(1.0.1.6)</div>
								</header>
							</div>
							</a>
						...
						<div class="row" style="margin-bottom:2px;" >
							...
							<a href="<?php echo base_url(); ?>assets/helpdesk/Fusion_Global_IT-Helpdesk_Escalation_MatrixV1_4.pdf" target="_blank" style="cursor:pointer;">
							<div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
								<header class="widget-header">
	...
	<div class="modal-content">      
			...
			<form id="frmAddReferrals" class="frmAddReferrals" action="" onsubmit="return false;" data-toggle="validator" method='POST' enctype="multipart/form-data">
			  ...
			  <div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Referrals </h4>
			  </div>
			  <div class="modal-body">
...
<!-------------------------Payroll Calendar--------------------------->
<div id="payrollCalendarModel" class="modal fade">
	<div class="modal-dialog  modal-lg">
		<div class="modal-content" style="width: 915px;margin-left: -86px;">			
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<div class="widget">
							<hr class="widget-separator">
								<header class="widget-header">
									<h4 class="widget-title" style="font-size: 23px;">Payroll Calendar <?php echo $currYear; ?></h4>
								</header>
							<div class="widget-body">
								<div class="table-responsive" id="payrollCalendar">
...
<div id="refERCalendar" class="modal fade">
  <div class="modal-dialog" style = 'width:50%;'>
	<div class="modal-content">
		<div class="modal-body">
			<img style= 'width:100%;' src ="<?php echo base_url(); ?>assets/images/ER_Calendar_2022.jpg"/>
		</div>
	</div>
	</div>
</div>
...
<div id="refLDCalendar" class="modal fade">
  <div class="modal-dialog" style = 'width:50%;'>
	<div class="modal-content">
		<div class="modal-body">
			<img style= 'width:100%;' src ="<?php echo base_url(); ?>assets/images/LD_Calendar_2022.png"/>
		</div>
	</div>
	</div>
</div>
        
<div id="refLDCourses" class="modal fade">
  <div class="modal-dialog" style = 'width:50%;'>
	<div class="modal-content">
		<div class="modal-body">
			<img style= 'width:100%;' src ="<?php echo base_url(); ?>assets/images/LD_Courses.png"/>
		</div>
	</div>
	</div>
</div>
...
<!-------------------------Home Holi Popup------------------ --------->
<div id="homeImgModelHoli" class="modal fade">
  <div class="modal-dialog" style = 'width:55%;'>
    <!-- Modal content-->
	<div class="modal-content">
		<div class="modal-body">
			...
			<!--<div id="IndCarousel" class="carousel slide" data-ride="carousel">			  
			  ...
			  <div class="carousel-inner">
				...
				<?php
					...
					if(get_user_company_id() == "1" || get_user_company_id() == "2" || get_user_company_id() == NULL){
					
				?>
						<img style= 'width:100%;' src ="<?php echo base_url(); ?>assets/images/fusion_holi.jpg"/>
				
				<?php
						
					}
				
					else if(get_user_company_id() == "3"){
						
				?>
						
						<img style= 'width:100%;' src ="<?php echo base_url(); ?>assets/images/omind_holi.jpg"/>
  ...
  <div class="modal-dialog" style='width:790px;'>
	...
	<div class="modal-content">
		<div class="modal-body">
			...
			<source src="./assets/video/fusion_cspl.mp4" type="video/mp4">			
...
<!----------------- Desktop Security Start  ----------------------------->

<div id="femsSecurityDesktop" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:60%; margin-top:15px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_security_desktop'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/desktop_security.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_security_desktop" name="fems_ack_security_desktop" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- Desktop Security End ------------------------------------>

<!----------------- Attention Announcement Start  ----------------------------->

<div id="femsAttentionAnnouncement" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_attention_announcement'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/attention_announcement.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_attention_announcement" name="fems_ack_attention_announcement" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- Attention Announcement End ------------------------------------>

<!----------------- Clean Inbox Start  ----------------------------->

<div id="femsCleanInbox" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_clean_inbox'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/clean_inbox.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_clean_inbox" name="fems_ack_clean_inbox" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<div id="femsOmindReview" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_omind_review'); ?>" method='POST'>
		
			  <div class="modal-body">
				  <div class="row verticle-center">
					<div class="col-sm-7">
						<div class="popup-content">
							<img src="<?php echo base_url(); ?>assets/images/omind-logo.png" class="omind-logo" alt="">
							<h2 class="survey-title">
								Greetings from Mind Workplace,
							</h2>
							<p>
								As we continue to develop and popularize the Mind Workplace platform, we invite all Fusion employees to submit reviews on their experience with this workforce management system.
							</p>
							<p>
								Please visit www.g2.com and submit your review. You can also use the link below to view a step-by-step guide on how to submit your review on G2.
							</p>
							<div class="thanks-top-widget">
								<h3 class="thank-blue">
									Thank you for your support!
								</h3>
							</div>
							<a href="https://www.g2.com/products/omind-technologies-mind-workplace/reviews" target="_blank" class="add-review">
								Add Review
							</a>
							<a href="https://www.omindtech.com/pdf/G2_Login_and_Review_System.pdf" target="_blank" class="download-pdf">
								Download Tutorial
							</a>
						</div>
					</div>
					<div class="col-sm-5">
						<div class="body-widget">
							<img src="<?php echo base_url(); ?>assets/images/survey-right.png" class="img-right" alt="">
						</div>
					</div>
				  </div>
					    <div class="col-md-12" style="margin-top:10px;">
...
<!----------------- Infosec Awareness Program 2022 Start  ----------------------------->

<div id="femsInfosecAwareness" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_infosec_awareness22'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/infosec_awareness_program_2022.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_infosec_awareness" name="fems_ack_infosec_awareness" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- Infosec Awareness Program 2022 End ------------------------------------>
	
	


<!----------------- Password Change Program 2022 Start  ----------------------------->

<div id="femsChangePassword" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_change_password22'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/change_password_2022.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_change_password" name="fems_ack_change_password" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- Password Change Program 2022 End ------------------------------------>	
	
	
<!----------------- RNR January 2022 Start  ----------------------------->

<div id="femsRnrJanuary" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_rnrjan22'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/rnr_january_2022.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_rnr_january" name="fems_ack_rnr_january" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- RNR January 2022 End ------------------------------------>
	
	
	
	
<!----------------- Org Chart Phils 2022 Start  ----------------------------->

<div id="femsOrgChartPhils" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_orgchartphils22'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/org_chart_phils_2022.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_orgchart_phils" name="fems_ack_orgchart_phils" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- Org Chart Phils 2022 End ------------------------------------>
	
	
	
<!----------------- ZT Policy Chart 2022 Start  ----------------------------->

<div id="femsZTPolicy" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_ztpolicy22'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/ZT_Policy_Paynearby_Outbound_2022.jpg"; ?>">
						</div>
						
						<div class="col-md-12" style="margin-top:10px;">
							<div class="form-group">
								<input type="checkbox" id="fems_ack_ZT_policy" name="fems_ack_ZT_policy" value="1" required> &nbsp; &nbsp;<b>I acknowledge that I have read the above content</b>
							</div>	
						</div>
					</div>
			  </div>				
...
<!---------------------- ZT Policy Chart 2022 End ------------------------------------>
    

<!----------------- Physical Security 2022 Start  ----------------------------->

<div id="femsPhySecurity" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
  <div class="modal-dialog" style="width:50%; margin-top:10px;" >
	<div class="modal-content">      
		
			<form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_PhySecurity22'); ?>" method='POST'>
		
			  <div class="modal-body">					
					<div class="row">
						<div class="col-md-12">
							<img style="width:100%" src="<?php echo base_url() ."assets/images/Physical_Security_MWP_Banner.jpg"; ?>">
						</div>
...
<!----------------------Physical Security 2022 End ------------------------------------>
	


<!----------------- Birthday Wish Pop-Up Start  ----------------------------->
	
<?php
	
$curr_date = date('m-d',strtotime(GetLocalTime()));
	
$checkBday = "SELECT s.fname AS 'full_name' FROM signin s WHERE DATE_FORMAT(s.dob, '%m-%d') = '$curr_date' AND status=1 AND s.fusion_id = '".get_user_fusion_id()."'" ;
	
$result = $this->Common_model->get_query_result_array($checkBday) ;
...
<div class="modal fade birthday-widget" id="myBirthdayModal" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
		 <!--start take the html element for birthday popup-->
          <div class="row">
			<div class="col-sm-4">
				<div class="body-widget">
					<img src="<?php echo base_url(); ?>assets/images/omind-logo.jpg" alt="">
				</div>
			</div>
			<div class="col-sm-8">
				<div class="annoucement-right">
					<h2>Announcement</h2>
				</div>
			</div>
		  </div>
		  <!--end take the html element for birthday popup-->
        </div>
        <div class="modal-body">
			<!--start take the html element for birthday popup-->
			<div class="row">
				<div class="col-sm-3">
					<img src="<?php echo base_url(); ?>assets/images/birthday-left.jpg" class="birthdy-img" alt="">
				</div>
				<div class="col-sm-9">
					<div class="birthday-content text-center">
						<h2 class="name-title"><span>Dear</span> <b><?=$name; ?></b></h2>
						<div class="divider-widget">
							<img src="<?php echo base_url(); ?>assets/images/birthday-divider.jpg" class="img-responsive" alt="">
						</div>
						
						<div class="main" id="mid">
						 <h3 class="heading-black">Wishing you a very</h3>
						  <div id="cid">
							Happy Birthday
						  </div>
						  <p>
							We cherish the bond we share with you and we wish you a year full of health, prosperity, growth and success. May this year be filled with boundless joy and all your desires comes true.
						  </p>
						  <div class="wondar-top">
							<h3 class="wondar-title">
								Have a <span class="red-bg">w</span>
								<span class="yellow-bg">o</span>
								<span class="yellow-bg">n</span>
								<span class="light-bg">d</span>
								<span class="red-bg">e</span>
								<span class="yellow-bg">r</span>
								<span class="light-bg">f</span>
								<span class="red-bg">u</span>
								<span class="yellow-bg">l</span>
								<span class="day-bg">day !</span>
							</h3>
						  </div>
						</div>
					</div>
