...
if ($break_on_ld === false)
    $ldcdHide = 'style="display:none;"';
else
    $diasable = "disabled";

if ($break_on === false)
    $cdHide = 'style="display:none;"';
else
    $ldDiasable = "disabled";

if ($break_on_cb === false)
    $cbHide = 'style="display:none;"';
else
    $cbDiasable = "disabled";

if ($break_on_sd === false)
    $sdHide = 'style="display:none;"';
else
    $sdDiasable = "disabled";
?>
<div class="wrap">
...
//print_r($get_announcement_desc);
                ...
                <?php if (get_role_dir() == "agent" || get_role_dir() == "tl" || get_user_fusion_id() == "FKOL008610" || get_user_fusion_id() == "FKOL012410") { ?>

                    <?php //if ( get_global_access()=='0') { 
                    ?>
                        ...
                        <div class="widget-body clearfix" style="padding: .8rem 0.6rem;">
                            ...
                            <div class='apps_grid'>
                                ...
                                <div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
                                    ...
                                    if ((get_dept_folder() == "hr" || get_dept_folder() == "it" || get_user_fusion_id() == "FKOL011103" || get_user_fusion_id() == "FKOL008602") && (isIndiaLocation(get_user_office_id()) == true)) {
                                        ?>

                                        <div class="case-wrapper <?php echo $ac_class; ?>" title="DFR Assets Management">
                                            <a href="<?php echo $linkurl; ?>">
                                                <div class="app-icon" style="background-color: #b3b300" title="DFR Assets Management">
                                                    <i class="fa fa-desktop" title="DFR Assets Management" aria-hidden="true"></i>
                                ...
                                <div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
                                    ...
                                    else if (in_array(get_user_fusion_id(), ['FMON003955', 'FHIG000301', 'FHIG000314']))
                                        $linkurl = base_url() . "leave/";
                                    else
                                        $linkurl = base_url() . "uc/";
                                    ?>		
                                    ...
                                    <div class="case-wrapper <?php echo $ac_class; ?>" title="Leave">
                                        <?php
                                        if (get_user_office_id() == "KOL" || get_user_office_id() == "BLR" || get_user_office_id() == "HWH")
                                            echo "<a href='$linkurl' />";
                                        else
                                            echo "<a  href='$linkurl' />";
                                        ?>
                                ...
                                <?php
                                if (get_global_access() != '1' && get_dept_folder() != "hr" && get_role_dir() != "super" && get_dept_folder() == "accounts") {
                                    ?>

                                    <div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
                                        <div class='outerBoxTitle'>Gratuity</div>



                                        <div class="case-wrapper" title="Gratuity">
                                            <a href="<?php echo base_url() . "gratuity"; ?>">
                                                <div class="app-icon" style="background-color: #605081" title="Gratuity">
                                                    <i class="fa fa-money" title="Gratuity" style=""></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                        <!-- <div class="circle module-count-list-project" data-doctype="Project" style=""> <span class="circle-text">1</span></div>  -->
                                                    <span class="case-label-text" style="font-size: 8px;">Gratuity</span>
                                                </div>
                                            </a>
                                        </div>
...
//$linkurl=base_url()."pmetrix";
                                        ...
                                        <?php } ?>
                                            ...
                                            <div class="case-wrapper" title="CCI Mind FAQ">
                                                <a href="<?php echo base_url() . "cci_new"; ?>">
                                                    <div class="app-icon" style="background-color: #114893 ;" title="CCI Mind FAQ">
                                                        <i class="fa fa-comments-o" title="CCI Mind FAQ" aria-hidden="true" style=""></i>
                                                    </div> 
                                                    <div class="case-label ellipsis"> 
                                                        <span class="case-label-text">
                                                            CCI MindFAQ
                                ...
                                <?php if (get_user_fusion_id() != "FKOL002881" && get_user_fusion_id() != "FJAM004129") { ?>
                                    <div class='AppsOuterBox ' style="padding: 5px 5px 8px 5px;">
                                        <div class='outerBoxTitle'>Business App</div>
                                        <!-- Edited By Samrat 26/10/21
                                        Allowing Fusion ID FALB000144 access to Jury'sInn CRM-->
                                        <?php
                                        //var_dump(is_access_jurys_inn_crm_report());
                                        //echo "hello : <pre>"; print_r(is_crm_readonly_access_mindfaq());

                                        if (is_access_jurys_inn_crm_report() == true || is_crm_readonly_access_mindfaq() || get_user_fusion_id() == "FALB000144") {
                                            ?>
                                        ...
                                        <?php if (true) { ?>
                                            <div class="case-wrapper" title="Contact Tracing Howard">
                                                <a href="<?php echo base_url() . "howard_training"; ?>">
                                                    <div class="app-icon" style="background-color: white;padding: 14px 8px;" title="Contact Tracing Howard">
                                                            <!--<i class="fa fa-medkit" title="Contact Tracing Zovio" aria-hidden="true" style=""></i>-->
                                                        <img style="width: 100px;height: 32px;" src="<?php echo base_url(); ?>assets/images/Howard_logo.png" border="0" alt="Contact Tracing Howard">
                                                    </div>
                                                    <div class="case-label ellipsis">
                                                        <span class="case-label-text">
                                                            Howard CRM
                                        ...
                                        <!-- <div class="case-wrapper" title="EMAT CRM">
                                                        <a href="http://10.100.20.120/emat/home.html">
                                                                <div class="app-icon" style="background-color: #682fa7" title="EMAT CRM">
                                                                        <i class="fa fa-envelope" title="EMAT CRM" aria-hidden="true" style=""></i>
                                                                </div>
                                                                <div class="case-label ellipsis">
                                        ...
                                        <?php if (is_access_duns_crm()) { ?>
                                            <div class="case-wrapper" title="DUNS CRM">
                                                <a href="<?php echo base_url() . "duns_crm"; ?>">
                                                    <div class="app-icon" style="background-color: #804b95" title="DUNS CRM">
                                                        <i class="fa fa-pie-chart" title="DUNS CRM" aria-hidden="true" style=""></i>
                                                    </div>
                                                    <div class="case-label ellipsis">
                                                        <span class="case-label-text">
                                                            DUNS CRM
                                        ...
                                        <?php } ?>
                                        <div class="case-wrapper" title="DUNS CRM">
                                            <a href="http://10.100.20.120/it-assets/home.html">
                                                <div class="app-icon" style="background-color: #804b95" title="DUNS CRM">
                                                    <i class="fa fa-laptop" title="IT Assets" aria-hidden="true" style=""></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                    <span class="case-label-text">
                                                        IT Assets
                                        ...
                                        <div class="case-wrapper" title="ID Management">
                                            <a href="http://10.100.20.120/ID-management/my-dashboard.html">
                                                <div class="app-icon" style="background-color: #682fa7" title="EMAT CRM">
                                                    <i class="fa fa-user" title="ID Management" aria-hidden="true" style=""></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                    <span class="case-label-text">
                                                        ID Management
                                        ...
                                        <div class="case-wrapper" title="MWP 2.0">
                                            <a href="http://10.100.20.120/mwp-bootstrap5-html/home.html">
                                                <div class="app-icon" style="background-color: #682fa7" title="MWP 2.0">
                                                    <i class="fa fa-file" title="MWP 2.0" aria-hidden="true" style=""></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                    <span class="case-label-text">
                                                        MWP 2.0
                                        ...
                                        <div class="case-wrapper" title="Mckinsy">
                                            <a href="<?php echo base_url(); ?>/Mck">
                                                <div class="app-icon" style="background-color: #3b74bc;" title="Mckinsy">
                                                    <i class="fa fa-hotel" title="Mckinsy" aria-hidden="true" style=""></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                    <span class="case-label-text">
                                                        Mckinsy tracing
                                        ...
                                        <div class="case-wrapper" title="TelAid">
                                            <a href="https://10.100.10.153/femsdev/TelAid">
                                                <div class="app-icon" style="background-color: #bc923b;" title="TelAid">
                                                    <i class="fa fa-id-card-o" title="TelAid" aria-hidden="true"></i>
                                                </div>
                                                <div class="case-label ellipsis">
                                                    <span class="case-label-text">
                                                        TelAid
                                ...
                                <div class='AppsOuterBox'>
                                    ...
                                    <?php
                                    if (get_user_fusion_id() == "FALB000079") {
                                        $ac_class = "";
...
// LD PROGRAMS
                ...
                <div class="col-md-12">
                    ...
                    <a href="<?php echo base_url(); ?>ITDocvm" target="_blank" style="cursor:pointer;">
                        <div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
                            <header class="widget-header">
                                <div class="widget-title" style="font-size:16px; text-align:center;"><i class="fa fa-file-pdf-o" style="font-size:18px;color:red"></i> IT Security</div>
                            </header>
                        </div>
                    </a>
            ...
            <?php if (isIndiaLocation(get_user_office_id()) == true) { ?>
                ...
                ?>assets/images/ind_calender_January_2021.jpg" />
                                        </div>
                ...
                <div class="row" style="margin-bottom:2px;">
                    <div class="col-md-12">
                        ...
                        <a data-toggle="modal" data-target="#support-helpdesk" style="cursor:pointer;">
                            ...
                            <div class="widget" style="border-radius: 3px; background:#adf08f; cursor:pointer;">
                                <img src="<?php echo base_url(); ?>assets/images/support-helpdesk.png" />
                            </div>
                        ...
                        <div class="widget" style="border-radius: 3px;background: aliceblue; cursor:pointer;">
                            <header class="widget-header">
                                <div class="widget-title" style="font-size:17px; text-align:center;">
                                    <i class="fa fa-bar-chart"></i> Download EfficiencyX(1.0.1.4)
                                </div>
                            </header>
                        </div>
                    </a>
                                                    ...
                                                    <b>
                                                        ...
                                                        <div id="homeImgModelEsl" class="modal fade">
                                                            <div class="modal-dialog" style='width:45%;'>
                                                                ...
                                                                <div class="item ">
                                                                  <img src="<?php //echo base_url(); 
                                                        ?>assets/images/els_popup4.png" alt="">
                                                                </div>
                                                                <div class="item ">
                                                                  <img src="<?php //echo base_url(); 
                                                        ?>assets/images/els_popup5.png" alt="">
                                                                </div>
                                                                
                                                                <div class="item ">
                                                                  <img src="<?php //echo base_url(); 
                                                        ?>assets/images/els_referral_bonus.png" alt="">
                                                                </div>
                                
                                                                <div class="item">
                                                                  <img src="<?php //echo base_url(); 
                                                        ?>assets/images/els_popup1.png" alt="">
                                                                </div>
                                
                                                                <div class="item">
                                                                  <img src="<?php //echo base_url(); 
                                                        ?>assets/images/els_popup2.png" alt="">
                                                                </div>
                                                                
                                                                <div class="item">
                                                                  <img src="<?php //echo base_url(); 
                                                        ?>assets/images/els_popup3.png" alt="">
                                                                </div>
                                                                                -->
                                                          ...
                                                          <div class="modal-dialog" style = 'width:700px;'>
                                                                <div class="modal-content">
                                                                        <div class="modal-body">	
                                                                                ...
                                                                                <img style= 'width:700px;' src ="<?php //echo base_url(); 
                                                        ?>assets/images/ref_cebu1.jpg"/>
                                                                        </div>
                                                                </div>
                                                                </div>
                                                        </div>
                                                        ...
                                                        ?>assets/images/ceb_workathome.png"/>
                                                                </a>
                                                                        -->
                                                                ...
                                                                <div class="modal-content">
                                                                        <div class="modal-body">
                                                                                <a data-toggle="modal" data-target="#itAssessment" style="cursor:pointer">
                                                                                        <img style= 'width:100%;' src ="<?php //echo base_url(); 
                                                        ?>assets/images/it_assessment.jpg"/>
                                                                                </a>	
                                                                        </div>
                                                                </div>
                                                                </div>
                                                                                                            ...
                                                                                                            <div class="modal-dialog" style='width:60%;'>
                                                                                                                ...
                                                                                                                <div class="modal-content">
                                                                                                                    <div class="modal-body">
                                                                                                                        <a id="" style="cursor:pointer;">
                                                                                                                                <!-- <img style= 'width:100%;' src ="<?php //echo base_url(); 
                                                        ?>assets/images/covid_all_loc.jpg"/> -->
...
//$this->load->view('home/modals/survey_mood_pulse');
                                                                                                        ...
                                                                                                        <!----------------- Spam Announcement Start  vkp----------------------------->

                                                                                                        <div id="femsSpamAnnouncement" class="modal fade" data-backdrop="static" data-keyboard="false" style="z-index:99999999999!important">
                                                                                                            <div class="modal-dialog" style="width:50%; margin-top:10px;" >
                                                                                                                <div class="modal-content">      

                                                                                                                    <form class="femsESIAckForm"  action="<?php echo base_url('notification_home/acknowledge_spam_out_inbox'); ?>" method='POST'>

                                                                                                                        <div class="modal-body">					
                                                                                                                            <div class="row">
                                                                                                                                <div class="col-md-12">
                                                                                                                                    <img style="width:100%" src="<?php echo base_url() . "assets/images/spam_announcement.jpg"; ?>">
                                                                                                                                </div>
