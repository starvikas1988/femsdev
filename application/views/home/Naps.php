...
class Naps extends CI_Controller {
	...
	public function index()
	{
		...
		{	
			...
			// echo '<pre>'; print_r($fullAray); exit;
		...
		if ($zip->open(FCPATH . $zipfilename, ZipArchive::CREATE) === TRUE)
		{
			...
			foreach ($info_list as $token)
			{
				...
				if(!file_exists($fileName)){
					$fileName = $this->config->item('BaseRealPath').'/'.$f_id.'/'.$token['photo'];
				}
						
				if(file_exists($fileName) && $token['photo'] != ""){
...
// profileUploadPath
				...
				if(!file_exists($fileName)){
					$fileName = $this->config->item('BaseRealPath').'/'.$f_id.'/'.$token['attachment_adhar'];
				}	
				if(file_exists($fileName) && $token['attachment_adhar'] != ""){
					//$this->zip->read_file($fileName, $newFileName);
					$zip->addFile($fileName, $newFileName);
					$dataCounter++;
				}
				...
				if(!file_exists($fileName)){
					$fileName = $this->config->item('BaseRealPath').'/'.$f_id.'/'.$token['attachment_adhar_back'];
				}		
				if(file_exists($fileName) && $token['attachment_adhar_back'] != ""){
					//$this->zip->read_file($fileName, $newFileName);
					$zip->addFile($fileName, $newFileName);
					$dataCounter++;
				}
				...
				// FOR local
				// $uploadDir = $this->config->item('BaseRealPath').'/uploads/candidate_local_background/';
				// $fileName = $uploadDir.$token['attachment_local_background'];		
				// $newFileName = "local background/".$token['attachment_local_background'];
				// if(file_exists($fileName) && $token['attachment_local_background'] != ""){
				// 	//$this->zip->read_file($fileName, $newFileName);
				// 	$zip->addFile($fileName, $newFileName);
				// 	$dataCounter++;
				// }
				...
				// FOR resume
				// $uploadDir = $this->config->item('BaseRealPath').'/uploads/candidate_resume/';
				// $fileName = $uploadDir.$token['attachment'];		
				// $newFileName = "resume/".$token['attachment'];
				// if(file_exists($fileName) && $token['attachment'] != ""){
				// 	//$this->zip->read_file($fileName, $newFileName);
				// 	$zip->addFile($fileName, $newFileName);
				// 	$dataCounter++;
				// }
				...
				if(!file_exists($fileName)){
					$fileName = $this->config->item('BaseRealPath').'/'.$f_id.'/'.$token['education_doc'];
				}
				...
				// FOR dfr_bank
				// $uploadDir = $this->config->item('BaseRealPath').'/uploads/dfr_bank/';
				// $fileName = $uploadDir.$token['attachment_bank'];		
				// $newFileName = "bank/".$token['attachment_bank'];
				// if(file_exists($fileName) && $token['attachment_bank'] != ""){
				// 	//$this->zip->read_file($fileName, $newFileName);
				// 	$zip->addFile($fileName, $newFileName);
				// 	$dataCounter++;
				// }
				...
				if(!file_exists($fileName)){
					$fileName = $this->config->item('BaseRealPath').'/'.$f_id.'/'.$token['attachment_signature'];
				}

				if(file_exists($fileName) && $token['attachment_signature'] != ""){
					//$this->zip->read_file($fileName, $newFileName);
					$zip->addFile($fileName, $newFileName);
					$dataCounter++;
				}
				...
				// // FOR PAN
				// $uploadDir = $this->config->item('BaseRealPath').'/uploads/pan/';
				// $fileName = $uploadDir.$token['attachment_pan'];			
				// $newFileName = "pan/".$token['attachment_pan'];
				// if(file_exists($fileName) && $token['attachment_pan'] != ""){
				// 	//$this->zip->read_file($fileName, $newFileName);
				// 	$zip->addFile($fileName, $newFileName);
				// 	$dataCounter++;
				// }
				...
				// // FOR candidate_birth
				// $uploadDir = $this->config->item('BaseRealPath').'/uploads/candidate_birth/';
				// $fileName = $uploadDir.$token['attachment_birth_certificate'];			
				// $newFileName = "birth certificate/".$token['attachment_birth_certificate'];
				// if(file_exists($fileName) && $token['attachment_birth_certificate'] != ""){
				// 	//$this->zip->read_file($fileName, $newFileName);
				// 	$zip->addFile($fileName, $newFileName);
				// 	$dataCounter++;
				// }

				// // FOR candidate_insurence
				// $uploadDir = $this->config->item('BaseRealPath').'/uploads/candidate_insurence/';
				// $fileName = $uploadDir.$token['attachment_health_insurence'];			
				// $newFileName = "health insurence/".$token['attachment_health_insurence'];
				// if(file_exists($fileName) && $token['attachment_health_insurence'] != ""){
				// 	//$this->zip->read_file($fileName, $newFileName);
				// 	$zip->addFile($fileName, $newFileName);
				// 	$dataCounter++;
				// }	
