						...
						<div class='apps_grid'>
								...
								<div class='AppsOuterBox' style="padding: 5px 5px 8px 5px;">
									...
									<?php
										...
										if(get_user_office_id()=="ALT" || isIndiaLocation(get_user_office_id())==true || get_user_office_id()=="JAM" || get_user_oth_office()=="JAM"  || get_user_office_id()=="CEB" || get_user_office_id()=="MAN" )
	...
	<!------    -->
		...
		<div class="col-md-3">  <!-- start of right side box -->
						...
						<div class="row" style="margin-bottom:5px;" >
							...
							<a href="<?php echo base_url(); ?>assets/it_security/sodinokibi_ransomware _002.pdf" target="_blank" style="cursor:pointer;">
...
<?php }
	...
	if($is_added_vaccination==0 && isIndiaLocation(get_user_office_id())==true ){
?>
...
if($isUserEfficiencyxSurveyModel==0 ){
	
?>

<div id="homeUserEfficiencyXModel" class="modal fade model-new" data-backdrop="static"  role="dialog" aria-hidden="true" >
	...
	<div class="middle-widget">	
		...
		<div class="container">
			<div class="body-widget text-center wow fadeInLeft">
				<h2 class="heading-title2"><b>Please click on appropriate button</b></h2>
				<h1 class="heading-title1">Are you happy with the utility of EfficiencyX ?</h1>
			</div>
			<div class="button-widget">
				
				<input type="hidden" name="ques_desc" id='ques_desc' value="Are you happy with the utility of EfficiencyX?">

				<div class="row">
					<div class="col-sm-2">
						<div class="btn-bg wow fadeInLeft">
							<a href="#" ans='Strongly Disagree' class='YourAnswerX' > <span class="small-font">Strongly <br> Disagree</span></a>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="btn-bg wow fadeInRight">
							<a href="#" ans='Disagree' class='YourAnswerX'><span class="small-font">Disagree</span></a>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="btn-bg wow fadeInLeft">
							<a href="#" ans='Neutral' class='YourAnswerX' ><span class="small-font">Neutral</span></a>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="btn-bg wow fadeInRight">
							<a href="#" ans='Agree' class='YourAnswerX'><span class="small-font">Agree</span></a>
						</div>
					</div>
					<div class="col-sm-2">
						<div class="btn-bg wow fadeInLeft">
							<a href="#" ans='Strongly Agree' class='YourAnswerX' ><span class="small-font">Strongly <br> Agree</span></a>
						</div>
					</div>
				</div>
  ...
  <script type="text/javascript">
   ...
   //////////////////////////////
	...
	$(window).on('load', function() {
			$("#homeUserEfficiencyXModel").modal('show');
				
	});
		
	$(document).ready(function(){

	$(".YourAnswerX").click(function(){
		
		var ans=$(this).attr("ans");
		var ques_desc = $("input[name='ques_desc']").val();
				
		if(ans != ""){
		//var r = confirm("Your Mood on Today is "+txt+"\r\nAre You Sure About Your Mood?");
			var r =true;	
			if(r===true){
				var dUrl="<?php echo base_url();?>home/saveUserEfficiencyx";
				$('#sktPleaseWait').modal('show');
				$.ajax({
					type	:	'POST',
					url		:	dUrl,
					...
					success	:	function(msg){
						...
						$('#sktPleaseWait').modal('hide');
						$("#homeUserEfficiencyXModel").modal('hide');
					}
				});
			}
		}else{
