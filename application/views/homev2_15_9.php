				    ...
				    <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-uielement" role="button">
                                    ...
                                    <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl" aria-labelledby="topnav-uielement">
                                        <div class="ps-2 p-lg-0">
											...
											?>		
												<li class="menu-item"><a href="<?php echo $linkurl; ?>">Recruitment Assets</a></li>
											<?php } ?>    				
											...
											<?php
												$ac_class = "";
												if (in_array(get_user_office_id(), ["ALT", "JAM", "CEB", "MAN", "CAS"]) || isIndiaLocation(get_user_office_id()) == true || get_global_access() == '1' || get_user_fusion_id() == 'FHIG000314') 
											...
											<?php } ?>
												  ...
												  <li class="menu-item"><a href="<?php echo base_url(); ?>pmetrix_v2">Perfomance</a></li>
											...
											<?php if(isAccessMindfaqApps()==true){ ?>
												...
												<?php if(is_access_brightway_modules()==true){ ?>
													<li class="menu-item"><a href="<?php echo base_url() ."mindfaq_brightway"; ?>">Brightway MindFAQ</a></li>
												<?php } ?>
												...
												<?php if(is_access_awareness_modules()==true){ ?>
												  <li class="menu-item"><a href="<?php echo base_url() ."mindfaq_awareness"; ?>">Awareness MindFAQ</a></li>
												<?php } ?>
												
												<?php if(is_access_paynearby_modules()==true){ ?> 
												  <li class="menu-item"><a href="<?php echo base_url() ."mindfaq_paynearby"; ?>">Pay Nearby MindFAQ</a></li>
												 <?php } ?>
												<?php if(is_access_cci_modules()==true){ ?>
												  <li class="menu-item"><a href="<?php echo base_url() ."mindfaq_cci"; ?>">CCI MindFAQ</a></li>
												<?php } ?>
												...
												<?php if(is_access_att_modules()==true){ ?>
												  <li class="menu-item"><a href="<?php echo base_url() ."mindfaq_att"; ?>"> AT&T MindFAQ </a></li>
												<?php } ?>
											...
											<?php if( get_role_dir()!="agent" || isAccessReports()==true ){ ?>
													 ...
													 <li class="menu-item"><a href="<?php echo base_url()."reports_pm";?>" target="_blank" >Performance</a></li>
                                    ...
                                    <div class="ps-2 p-lg-0">
                                       ...
                                       <div class="mega-widget">
                                          <ul class="sub-menu topul">
                                             ...
                                             <?php
                                                $ac_class = "";
                                                if (in_array(get_user_office_id(), ["ALT", "JAM", "CEB", "MAN", "CAS"]) || isIndiaLocation(get_user_office_id()) == true || get_global_access() == '1')
												        ...
												        <div class="col-sm-2">
                                                            <div class="body-widget text-center">
                                                                <div class="apps-bg-icon">
                                                                    ...
                                                                    <h2 class="apps-title"> Recruitment Assets
                                                                    </h2>
                                                                    <a href="<?php echo $linkurl; ?>" class="explore-more">
                                                                        Explore
                                                                    </a>
                                                ...
                                                <div class="common-top">
													...
													<?php if(is_access_brightway_modules()==true){ ?>
														  ...
														  <div class="col-sm-2">
                                                             <div class="body-widget text-center">
                                                                 <div class="apps-bg-icon">
                                                                     <img src="<?php echo base_url() ?>assets_home_v2/images/brightway-mindFAQ.png" class="icons-img" alt="">
                                                                     <h2 class="apps-title"> Brightway MindFAQ
                                                                     </h2>
                                                                     <a href="<?php echo base_url() ."mindfaq_brightway"; ?>" class="explore-more">
                                                                         Explore
                                                                     </a>
                                                                 </div>
                                                             </div>
													...
													<?php if(is_access_awareness_modules()==true){ ?>
														 ...
														 <div class="col-sm-2">
                                                             <div class="body-widget text-center">
                                                                 <div class="apps-bg-icon">
                                                                     <img src="<?php echo base_url() ?>assets_home_v2/images/awareness-mindFAQ.png" class="icons-img" alt="">
                                                                     <h2 class="apps-title"> Awareness MindFAQ
                                                                     </h2>
                                                                     <a href="<?php echo base_url() ."mindfaq_awareness"; ?>" class="explore-more">
                                                                         Explore
                                                                     </a>
                                                                 </div>
                                                             </div>
													...
													<?php if(is_access_paynearby_modules()==true){ ?>
														 ...
														 <div class="col-sm-2">
                                                             <div class="body-widget text-center">
                                                                 <div class="apps-bg-icon">
                                                                     <img src="<?php echo base_url() ?>assets_home_v2/images/pay-nearby-mindFAQ.png" class="icons-img" alt="">
                                                                     <h2 class="apps-title"> Pay Nearby MindFAQ
                                                                     </h2>
                                                                     <a href="<?php echo base_url() ."mindfaq_paynearby"; ?>" class="explore-more">
                                                                         Explore
                                                                     </a>
                                                                 </div>
                                                             </div>
														 ...
														 <div class="col-sm-2">
                                                             <div class="body-widget text-center">
                                                                 <div class="apps-bg-icon">
                                                                     ...
                                                                     <a href="<?php echo base_url() ."mindfaq_cci"; ?>" class="explore-more">
                                                                         Explore
                                                                     </a>
                                                                 </div>
                                                             </div>
														...
														<div class="col-sm-2">
                                                             <div class="body-widget text-center">
                                                                 <div class="apps-bg-icon">
                                                                     ...
                                                                     <a href="<?php echo base_url() ."mindfaq_att"; ?>" class="explore-more">
                                                                         Explore
                                                                     </a>
                                                                 </div>
                                                             </div>
