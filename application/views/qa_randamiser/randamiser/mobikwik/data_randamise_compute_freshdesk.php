									...
									<div class="filter-widget compute-widget">
										...
										<div class="common-top">
											<div class="row">
												...
												<div class="col-sm-3">
														<div class="form-group">
															<label>Customer Disconnection Source</label>
															<select id="customer_disconnection_source" class="multiple-select" name="customer_disconnection_source[]" multiple="multiple">
																<?php foreach($customer_disconnection_source as $source){ ?>
																<option value="<?php echo $source['customer_disconnection_source']?>"><?php echo $source['customer_disconnection_source'];?></option>
																<?php }?>
															</select>
														</div>
												</div>
