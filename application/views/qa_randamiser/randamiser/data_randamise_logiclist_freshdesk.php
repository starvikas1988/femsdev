								...
								<table class="table table-bordered table-responsive table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url('Qa_randamiser/compute_logiclist_delete/'); ?>/<?php echo $list['id'];?>" class="edit-btn">
												...
												<a href="javascript:void(0);" bid="<?php echo $list['id']; ?>" data-toggle="modal" data-target="#computeDetailsModal" class="computeDetailsModal edit-btn" style=" margin-left:15px;">
