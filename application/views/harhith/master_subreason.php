...
<div class="card">
<div class="card-body">
	<h2 class="heading-title">Call Sub Reason List</h2>
	
	<form method="POST" autocomplete="off">
	<div class="row">
		<div class="col-sm-4">
			<div class="form-group">
			  <label>Call Sub Reason</label>
		...
		<div class="col-md-4">
			<div class="form-group">
			  ...
			  <select class="form-control" name="c_reason">												
	...
	<div class="common-top">
		...
		<div class="table-widget">
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
				<?php $cn=0; foreach($callsubreason_list as $token){ $cn++; ?>
				<tr>
					<td><?php echo $cn; ?></td>
					<td><?php echo $token['name']; ?></td>
					<td><?php echo $token['parent_name']; ?></td>
					...
					<td>
					<a class="btn btn-primary editMasterSubReason" sid="<?php echo $token['id']; ?>"><i class="fa fa-edit"></i></a>
					</td>		
				 </tr>
				<?php } ?>
  ...
  <form method="POST" autocomplete="off" enctype="multipart/form-data">
    <div class="modal-content">
      <div class="modal-header">        
        <h4 class="modal-title">Update Call Sub Reason</h4>
