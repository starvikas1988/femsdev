...
<div class="card">
<div class="card-body">
	<h2 class="heading-title">Call Reason List</h2>
	...
	<div class="common-top">
		...
		<div class="table-widget">
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
				<?php $cn=0; foreach($callreason_list as $token){ $cn++; ?>
				<tr>
					<td><?php echo $cn; ?></td>
					...
					<td>
					<a class="btn btn-primary editMasterReason" sid="<?php echo $token['id']; ?>"><i class="fa fa-edit"></i></a>
					</td>		
				 </tr>
				<?php } ?>
