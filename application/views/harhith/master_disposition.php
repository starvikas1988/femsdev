...
<div class="card">
<div class="card-body">
	<h2 class="heading-title">Disposition List</h2>
	...
	<div class="common-top">
		...
		<div class="table-widget">
			<table class="table table-bordered table-striped table-hover">
				...
				<tbody>
				<?php $cn=0; foreach($disposition_list as $token){ $cn++; ?>
				<tr>
					<td><?php echo $cn; ?></td>
					...
					<td>
					<a class="btn btn-primary editMasterDisposition" sid="<?php echo $token['id']; ?>"><i class="fa fa-edit"></i></a>
					</td>		
				 </tr>
				<?php } ?>
  ...
  <form method="POST" autocomplete="off" enctype="multipart/form-data">
    <div class="modal-content">
      <div class="modal-header">        
        <h4 class="modal-title">Update Disposition</h4>
