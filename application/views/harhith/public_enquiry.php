                ...
                <div class="col-md-12 grid-margin">
                    <div class="d-flex justify-content-between flex-wrap">
                        <div class="d-flex align-items-center dashboard-header flex-wrap mb-3 mb-sm-0">
                            <h5 class="mr-4 mb-0 font-weight-bold"><i class="fa fa-user-plus"></i> New Enquiry</h5>                           
                        </div>                        
                    </div>
                </div>
            </div>
			...
			<div class="common-top">
				...
				<form id="complaintEnquiryFrm" method="POST" autocomplete="off" enctype="multipart/form-data">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
											  <label>Date</label>
											  <input type="date" class="form-control" value="<?php echo date('Y-m-d', strtotime($current_date)); ?>" name="c_date" required readonly>
											</div>
										</div>
										<div class="col-md-6" style="display:none">
											<div class="form-group">
											  ...
											  <input type="hidden" class="form-control" value="1" name="c_ticket_uid" required readonly>
											</div>
											
										</div>
										<div class="col-md-6">
											<div class="form-group">
											  <label>Enquiry Type <span class="text-danger font-weight-bold">*</span></label>
							...
							<div class="card">
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-md-6" style="display:none">
											<div class="form-group">
											  <label>Kindly Call Back</label>
											  <input type="radio" class="" name="c_call_back" value="Yes" required>	 <span style="font-size:12px">Yes</span> &nbsp;&nbsp;		
											  <input type="radio" class="" name="c_call_back" value="No" required checked> <span style="font-size:12px">No</span>
											</div>											
										</div>
										...
										<div class="col-md-6" style="display:none">
											<div class="form-group">
											  ...
											  <select class="form-control" name="c_disposition_type" required>
												<?php echo hth_dropdown_3d_options($disposition_type,'id','name','5'); ?>	
											  </select>
											</div>											
										</div>
										...
										<div class="col-md-12">
											<div class="form-group">
											  <label>Please describe your issue/ concern <span class="text-danger font-weight-bold">*</span></label>
											  <textarea style="height: 250px!important;" class="form-control capitalCheckText" name="c_comments" required></textarea>
											</div>									
										</div>
					...
					<div class="col-sm-12">						
						<div class="body-widget text-center">
							<button type="button" class="submit-btn verify_captcha">Submit</button>
  ...
  <div class="modal-dialog modal-lg" style="width:60%">
    <div class="modal-content">
      ...
      <div class="modal-footer">	 
        <a href="<?php echo hth_url('complaints'); ?>" class="btn btn-secondary">Close</a>
      </div>
    </div>
  </div>
</div>
