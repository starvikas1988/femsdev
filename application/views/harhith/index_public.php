...
<body style="background: #ecf0fa;">

<div id="page-container">
	
   <?php $this->load->view('harhith/top_public'); ?>
   
    <div class="main-content page-content" style="margin-left:0px">
	...
	<?php if(!empty($show_footers) && $show_footers == "off"){ ?>
	<?php } else { ?>
    <footer>
