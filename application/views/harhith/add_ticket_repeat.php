						...
						<div class="row">
							<div class="col-sm-3">
								<div class="form-group">
								  ...
								  <input type="text" class="form-control numberCheckPhone" value="<?php echo $search_ticket; ?>"  name="search_ticket">
								</div>
							</div>
							<div class="col-sm-3">
								<div class="form-group">
									<button type="submit" style="margin-top: 30px;" class="search-btn">Search</button>
								</div>
							</div>
						</div>
					</form>
									...
									<table id="datatable-check" class="table table-striped table-bordered">
										...
										?>
										  <tr class="<?php echo $colorVal; ?>">
											...
											<div class="edit-btn">
												<a href="javascript:void(0);" tid="<?php echo $token_list['ticket_no']; ?>" class="commentTicket btn btn-danger text-white edit-link" data-toggle="tooltip" data-placement="top" title="Comment Ticket">
													<i class="fa fa-reply" aria-hidden="true"></i> Comment
												</a>
											</div>
											</td>
...
<div class="modal fade" id="commentTicketModal" tabindex="-1" role="dialog" aria-labelledby="commentTicketModal" aria-hidden="true">
  <div class="modal-dialog  modal-lg" style="width:100%">
  <form method="POST" action="<?php echo hth_url('comment_ticket'); ?>" autocomplete="off" enctype="multipart/form-data">
    <div class="modal-content">
      ...
      <div class="modal-body">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="form-group">
						<input type="text" class="form-control" name="ticket_no" value="" readonly required>
					</div>
				</div>
				<div class="col-sm-12">
					<div class="form-group">
			...
			<div class="row" style="display:none">
				...
				<div class="col-sm-12" id="previous_logs_comments_div">	
      ...
      <div class="modal-footer">
	     <button type="button" class="btn search-btn commentTicketModalSubmit" style="width:150px">Update</button>		 
