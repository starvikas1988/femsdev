		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title"> CQ Squad Stack  </h4></header>
					...
					<div class="widget-body">					
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('qa_cq_squad_stack/qa_stack_report'); ?>">	
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<select class="form-control" id="campaign" name="campaign" required>
										...
										<option <?php echo $campaign=='cq_squad_stack'?"selected":""; ?> value="cq_squad_stack">CQ Squad Stack</option>
										<option <?php echo $campaign=='squad_stack_feedback'?"selected":""; ?> value="squad_stack_feedback">Squad Stack</option>
									</select>
								</div>
							</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-3" style='margin-top:22px;margin-left: 10px;'>
								<div class="form-group">
									<button class="btn btn-primary blains-effect" a href="<?php echo base_url()?>qa_cq_squad_stack/qa_stack_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
