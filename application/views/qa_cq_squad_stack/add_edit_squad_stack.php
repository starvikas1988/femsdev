								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="text" class="form-control" id="" name="data[call_id]" value="<?php echo $squad_stack_data['call_id'] ?>" required>
											</td>
										</tr>
										<tr>
											...
											<td>
												<input type="text" class="form-control" name="data[bp_id]" value="<?php echo $squad_stack_data['bp_id'] ?>" required>
											</td>
										...
										<tr>
											...
											<td>4</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF1" name="data[correct_disposition]" required>
											...
											<td colspan=2><input type="text" name="data[cmt1]" class="form-control" value="<?php echo $squad_stack_data['cmt1'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>4</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[call_noise_free]" required>
											...
											<td colspan=2><input type="text" name="data[cmt2]" class="form-control" value="<?php echo $squad_stack_data['cmt2'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>4</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[rate_of_speech]" required>
											...
											<td colspan=2><input type="text" name="data[cmt3]" class="form-control" value="<?php echo $squad_stack_data['cmt3'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>4</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[build_rapport]" required>
											...
											<td colspan=2><input type="text" name="data[cmt4]" class="form-control" value="<?php echo $squad_stack_data['cmt4'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>4</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[additional_notes]" required>
											...
											<td colspan=2><input type="text" name="data[cmt5]" class="form-control" value="<?php echo $squad_stack_data['cmt5'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											...
											<td>6</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[mandatory_part_of_scripts]" required>
											...
											<td colspan=2><input type="text" name="data[cmt6]" class="form-control" value="<?php echo $squad_stack_data['cmt6'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>6</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[record_correct_answers]" required>
											...
											<td colspan=2><input type="text" name="data[cmt7]" class="form-control" value="<?php echo $squad_stack_data['cmt7'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>6</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF2" name="data[conduct_call_without_abusive]" required>
											...
											<td colspan=2><input type="text" name="data[cmt8]" class="form-control" value="<?php echo $squad_stack_data['cmt8'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>6</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF3" name="data[correct_brand_pronunciation]" required>
											...
											<td colspan=2><input type="text" name="data[cmt9]" class="form-control" value="<?php echo $squad_stack_data['cmt9'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>6</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF4" name="data[correct_information_by_SE]" required>
											...
											<td colspan=2><input type="text" name="data[cmt10]" class="form-control" value="<?php echo $squad_stack_data['cmt10'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>13</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[probe_lead]" required>
											...
											<td colspan=2><input type="text" name="data[cmt11]" class="form-control" value="<?php echo $squad_stack_data['cmt11'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
...
(Without Misselling/misleading)</td>
											<td>6</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF5" name="data[accurate_information]" required>
											...
											<td colspan=2><input type="text" name="data[cmt12]" class="form-control" value="<?php echo $squad_stack_data['cmt12'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>13</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[products_benefits]" required>
											...
											<td colspan=2><input type="text" name="data[cmt13]" class="form-control" value="<?php echo $squad_stack_data['cmt13'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>19</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF6" name="data[urgency_for_deal]" required>
											...
											<td colspan=2><input type="text" name="data[cmt14]" class="form-control" value="<?php echo $squad_stack_data['cmt14'] ?>"></td>
										</tr>
										<tr>
											<td style="color:red; font-weight:bold">Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>19</td>
											<td>
												<select class="form-control squad_stack_point" id ="squadstackAF7" name="data[handle_objections]" required>
											...
											<td colspan=2><input type="text" name="data[cmt15]" class="form-control" value="<?php echo $squad_stack_data['cmt15'] ?>"></td>
										</tr>
										<tr>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[use_jargons]" required>
											...
											<td colspan=2><input type="text" name="data[cmt16]" class="form-control" value="<?php echo $squad_stack_data['cmt16'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[active_listening]" required>
													<option squad_stack_val=1 squad_stack_max="1"<?php echo $squad_stack_data['use_jargons'] == "Pass" ? "selected" : ""; ?> value="Pass">Pass</option>
											...
											<td colspan=2><input type="text" name="data[cmt17]" class="form-control" value="<?php echo $squad_stack_data['cmt17'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[purpose_of_call]" required>
											...
											<td colspan=2><input type="text" name="data[cmt18]" class="form-control" value="<?php echo $squad_stack_data['cmt18'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[greet_lead]" required>
											...
											<td colspan=2><input type="text" name="data[cmt19]" class="form-control" value="<?php echo $squad_stack_data['cmt19'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[correct_language]" required>
											...
											<td colspan=2><input type="text" name="data[cmt20]" class="form-control" value="<?php echo $squad_stack_data['cmt20'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[dead_air]" required>
											...
											<td colspan=2><input type="text" name="data[cmt21]" class="form-control" value="<?php echo $squad_stack_data['cmt21'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[empathetic_towards_lead]" required>
											...
											<td colspan=2><input type="text" name="data[cmt22]" class="form-control" value="<?php echo $squad_stack_data['cmt22'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:green; font-weight:bold">Business</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[proper_closing]" required>
											...
											<td colspan=2><input type="text" name="data[cmt23]" class="form-control" value="<?php echo $squad_stack_data['cmt23'] ?>"></td>
										</tr>
										<tr>
											<td style="font-weight:bold">Not Critical</td>
											<td style="color:Navy; font-weight:bold">Customer</td>
											...
											<td>1</td>
											<td>
												<select class="form-control squad_stack_point" id ="" name="data[summarization]" required>
											...
											<td colspan=2><input type="text" name="data[cmt24]" class="form-control" value="<?php echo $squad_stack_data['cmt24'] ?>"></td>
										</tr>

										<tr>
											<td>Call Summary:</td>
											<td colspan=3><textarea class="form-control" name="data[call_summary]"><?php echo $squad_stack_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" name="data[feedback]"><?php echo $squad_stack_data['feedback'] ?></textarea></td>
										</tr>
										<tr>
											...
											<?php if ($squad_stack_id == 0) { ?>
												...
												<?php } else {
												if ($squad_stack_data['attach_file'] != '') { ?>
													<td colspan=6>
														...
														foreach ($attach_file as $mp) { ?>
															<audio controls='' style="background-color:#607F93">
																<source src="<?php echo base_url(); ?>qa_files/qa_stack/inbound/<?php echo $mp; ?>" type="audio/ogg">
																<source src="<?php echo base_url(); ?>qa_files/qa_stack/inbound/<?php echo $mp; ?>" type="audio/mpeg">
															</audio> </br>
														<?php } ?>
													</td>
											<?php } else {
										...
										<?php if ($squad_stack_id != 0) { ?>
											<tr>
												...
												<td colspan=6><?php echo $squad_stack_data['agnt_fd_acpt'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Agent Review:</td>
												<td colspan=6><?php echo $squad_stack_data['agent_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Management Review:</td>
												<td colspan=6><?php echo $squad_stack_data['mgnt_rvw_note'] ?></td>
											</tr>
											<tr>
												<td colspan=2 style="font-size:16px; font-weight:bold">Client Review:</td>
												<td colspan=6><?php echo $squad_stack_data['client_rvw_note'] ?></td>
											</tr>
