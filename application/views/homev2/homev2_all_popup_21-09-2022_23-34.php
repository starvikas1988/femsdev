    ...
    <div class="pop-content right-new">
		...
		<ul>
			...
			<?php } ?>
                ...
                <li>
					<a href="<?php echo base_url(); ?>uploads/jitbit_ticket_creation_SOP/Jitbit Ticket creation SOP - Version 2.0.pdf" target="_blank" >
						 <i class="fa fa-question-circle" aria-hidden="true"></i>
				...
				<li>
					<a href="<?php echo base_url(); ?>assets/helpdesk/Fusion_Technical_Helpdesk_Escalation_MatrixV1_2.pdf" target="_blank" >
						 <i class="fa fa-question-circle" aria-hidden="true"></i>
						 Fusion Technical Helpdesk Escalation
					</a>
				</li>
				<li>
					<a href="<?php echo base_url(); ?>assets/helpdesk/Global_Technical_Helpdesk_SLA_for_all_the_Mediums_V1_2.pdf" target="_blank" >
