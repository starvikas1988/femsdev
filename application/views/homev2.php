...
<html lang="en">
    <head>      
        ...
        <style>
            ...
            .pMs .widget-header{
                background: rgb(75,255,252);
                background: linear-gradient(90deg, rgba(75,255,252,1) 0%, rgba(44,114,213,1) 35%, rgba(44,125,213,1) 66%, rgba(75,255,252,1) 100%);
            }
            .new-image img  {
                position: absolute;
                width: 50px;
    ...
    <body>
                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                        ...
                        ?>
                         ...
                         <?php if (count($user_work_anniversary) > 0) { ?>

                            <div class="dropdown d-none d-sm-inline-block right-divider" style='padding-left:15px;'>
                                <a href="javascript:void(0);" class="slide-workanniversary">
                                    <img src="assets_home_v2/images/work.png" style="height: 36px;" title="Work Anniversary" alt="" class="birthday-img vert-move">
                                </a>
                            </div>
                            <?php } ?>
                        <!-- +++++++++++++++++++++++++++++++ end work anniversary work +++++++++++++++++++++++++++++ -->
                        ...
                        <!-- <div class="dropdown d-inline-block" style='padding-left:5px;' >
                            <button type="button" class="btn header-item bg-soft-light border-start border-end" id="page-header-user-dropdown"
                                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="" style="height: 36px;width: 36px;padding: 3px;" src="<?php echo base_url(); ?>assets/Language_icon.png" alt="">
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                                
                                <a class="dropdown-item" style="cursor:pointer;" class="flag_link eng" title="English" data-lang="en">                                 
                                    <img width='30px;' src="<?php echo base_url(); ?>assets/flag_img/english_us.png" alt="English">&nbsp;English
                                </a>
                                <div class="dropdown-divider"></div>                               
                                <a class="dropdown-item" style="cursor:pointer;" class="flag_link eng" title="French" data-lang="fr" >                                 
                                <img width='30px;' src="<?php echo base_url(); ?>assets/flag_img/french.jpg" alt="French">&nbsp;French
                                </a>
                            </div>
                        </div>
                        <div id="google_translate_element"></div> -->
                        ...
                        <div class="dropdown d-inline-block" style='padding-left:5px;' >
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
								...
								<?php if(get_def_homepage() == "homev2"){ ?>
								
								<a class="dropdown-item" href="<?php echo base_url(); ?>/home/set_def_home_page/homev3">
                                    <i class="fa fa-user font-size-16 align-middle me-1" aria-hidden="true"></i>
                                    New Home
                                </a>
							...
							<?php }else{ ?>
								...
								<a class="dropdown-item" href="<?php echo base_url(); ?>/home/set_def_home_page/homev2">
                                    <i class="fa fa-user font-size-16 align-middle me-1" aria-hidden="true"></i>
                                    Old Home
                                </a>
                                                    ...
                                                    <div class="dropdown-menu mega-dropdown-menu px-2 dropdown-mega-menu-xl" aria-labelledby="topnav-uielement">
                                                            ...
                                                            <div class="mega-widget">
                                                                <ul class="sub-menu topul">
                                                                    ...
                                                                    if (get_global_access() == '1' || get_dept_folder() == "hr" || it_assets_access() == true) {
                                                                        ...
                                                                        ?>
                                                                        <li class="menu-item"><a href="<?php echo $linkurl; ?>">Background Verification</a></li>
                                                                    <?php } ?>
                                                        ...
                                                        <!--                                                    <li class="menu-item"><a href="<?php echo base_url(); ?>uc">Movement</a></li> -->
                                                                    ...
                                                                    if (is_access_confirmation() == true) {
                                                                        if (get_role_dir() != "agent") {
                                                                            $brand_arr = array(12,1,2);
                                                                                if((!in_array(get_brand(), $brand_arr) && isIndiaLocation(get_user_office_id()) == true )){
                                                                            ?>          
                                                                    ...
                                                                    if (is_access_ar_module() == true) {
                                                                        ...
                                                                        <li class="menu-item"><a href="<?php echo base_url() . "attendance_reversal"; ?>"> Attendance Reversal </a></li>
                                                                    ...
                                                                    <?php if (isAccessMindfaqApps() == true) { ?>
                                                                        ...
                                                                        <?php if (is_access_jurys_inn_modules() == true) { ?>
                                                                            <li class="menu-item"><a href="<?php echo base_url() . "Mindfaq_leonardohotels"; ?>">Leonardo_Hotels MindFAQ</a></li>
                                                                        <?php } ?>
																		...
																		<?php if (is_access_achieve_modules() == true) { ?>
                                                                            <li class="menu-item"><a href="<?php echo base_url() . "mindfaq_achieve"; ?>"> Achieve MindFAQ </a></li>
                                                                        <?php } ?>
                                                                    ...
                                                                    <?php if (is_access_zendesk_crm() == true) { ?>
                                                                        ...
                                                                        <li class="menu-item"><a href="<?php echo base_url() . "zendesk_report/tickets_report_export"; ?>">Zendesk CRM</a></li>
                                                                    <?php } ?>
                                                                    ...
                                                                    <?php }else if (is_access_announcment() == 1){ ?>
																		...
																		<li class="menu-item"><a href="<?php echo base_url() . "master/fems_announcement"; ?>">Announcement</a></li>
                                                                    ...
                                                                    <?php }  if(is_department_restriction()==true || is_pms_permssion()==true){?>
                                                                    <li class="menu-item"><a href="<?= base_url() ?>pms_assignment">PMS</a></li>
                                                                    <?php } ?>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9">
                                ...
                                <?php
                                if ($assets_assignement_details['status'] == true) {
                                    $c = 1;
                                    ?>
                                    <div class="row">
                                        <div class="col-xl-12">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-widget">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                if ($assets_assignement_details['inv'] != false) {
                                                                    foreach ($assets_assignement_details['inv'] as $value) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td style="text-align: center;">
                                                                                <?php
                                                                                if ($value['is_user_acknowledge'] == null || $value['is_user_acknowledge'] == '') {
                                                                                    $subm_id = $value['tab_his_id'];
                                                                                    ?>
                                                                ...
                                                                <?php
                                                                if ($assets_assignement_details['non_inv'] != false) {
                                                            ...
                                                            <div class="body-widget justify-content-end">
                                                                <label class="switch">
                                                                    <?php if ($break_on_ld === true) : ?>
                                                                        <input id="break_check_button_ld" type="checkbox" typ='lunch' checked>
                                                                    <?php else : ?>
                                                            ...
                                                            <div class="body-widget justify-content-end">
                                                                <label class="switch">
                                                                    ...
                                                                    <?php if ($break_on_cb === true) : ?>
                                                                        <input id="break_check_button_cb" type="checkbox" typ='coaching' checked>
                                                                    <?php else : ?>
                                                            ...
                                                            <div class="body-widget justify-content-end">
                                                                <label class="switch">
                                                                    ...
                                                                    <?php if ($break_on === true) : ?>
                                                                        <input type="checkbox" id="break_check_button" typ='others' checked>
                                                                    <?php else : ?>
                                                            ...
                                                            <div class="body-widget justify-content-end">
                                                                <label class="switch">
                                                                    ...
                                                                    <?php if ($break_on_sd === true) : ?>
                                                                        <input type="checkbox" id="break_check_button_sd" typ='downtime' checked>
                                                                    <?php else : ?>
                                                                ...
                                                                <div class="common-top">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            <div class="body-widget text-center">
                                                                                <div class="apps-bg-icon">
                                                                                    <i class="fa fa-tachometer" style="font-size:40px;color:#627de4"></i>
                                                                                    <h2 class="apps-title"> PMS
                                                                                    </h2>
                                                                                    <a href="<?php echo base_url(); ?>pms_assignment" class="explore-more">
                                                                                        Explore
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="col-sm-2">
                                                                                    <div class="body-widget text-center">
                                                                                        <div class="apps-bg-icon">
                                                                                            ...
                                                                                            <h2 class="apps-title">Confirmations
                                                                                            </h2>
                                                                        ...
                                                                        if (is_access_ar_module() == true) {
                                                                            ...
                                                                            <div class="col-sm-2">
                                                                                <div class="body-widget text-center">
                                                                                    <div class="apps-bg-icon">
                                                                                        <img src="<?php echo base_url() ?>assets_home_v2/images/my-time.png" class="icons-img" alt="">
                                                                                        <h2 class="apps-title"> Attendance Reversal
                                                                                        </h2>
                                                                                        <a href="<?php echo base_url() . "attendance_reversal"; ?>" class="explore-more">
                                                                                            Explore
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                         ...
                         <div class="apps-bg-icon">
                             ...
                             <a href="<?php echo $linkurl; ?>" class="explore-more">
                                 Explore
                                                                        ...
                                                                        <?php if (get_user_fusion_id() == "FKOL000001" || get_user_fusion_id() == "FKOL001800" || get_user_fusion_id() == "FKOL012753" || get_user_fusion_id() == "FKOL011883") { ?>
                                                                            <div class="col-sm-2">
                                                                                <div class="body-widget text-center">
                                                                                    <div class="apps-bg-icon">
                                                                                        <img src="<?php echo base_url() ?>assets_home_v2/images/report.png" class="icons-img" alt="">
                                                                                ...
                                                                                <div class="col-sm-2">
                                                                                    <div class="body-widget text-center">
                                                                                        <div class="apps-bg-icon">
                                                                                            ...
                                                                                            <h2 class="apps-title">Leonardo_Hotels MindFAQ
                                                                                            </h2>
                                                                                            <a href="<?php echo base_url() . "mindfaq_leonardohotels"; ?>" class="explore-more">
                                                                                                Explore
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                         ...
                         <div class="body-widget text-center">
                             <div class="apps-bg-icon">
																			...
																			<?php if (is_access_achieve_modules() == true){ ?>
                                                                                ...
                                                                                <div class="col-sm-2">
                                                                                    <div class="body-widget text-center">
                                                                                        <div class="apps-bg-icon">
                                                                                            <img src="<?php echo base_url() ?>assets_home_v2/images/cci-mindFAQ.png" class="icons-img" alt="">
                                                                                            <h2 class="apps-title">Achieve MindFAQ
                                                                                            </h2>
                                                                                            <a href="<?php echo base_url() . "mindfaq_achieve"; ?>" class="explore-more">
                                                                                                Explore
                                                                                            </a>
                                                                                        </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="col-sm-2">
                                                                                <div class="body-widget text-center">
                                                                                    <div class="apps-bg-icon">
                                                                                        ...
                                                                                        <h2 class="apps-title">Zendesk CRM
                                                                                        </h2>
                                                                                        <a href="<?php echo base_url() . "zendesk_report/tickets_report_export"; ?>" class="explore-more">
                                                                                            Explore
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            <div class="body-widget text-center">
                                                                                <div class="apps-bg-icon">
                                                                                    <img src="<?php echo base_url() ?>assets_home_v2/images/shoutbox.png" class="icons-img" alt="">
                                                                                    <h2 class="apps-title"> Call Alert
                                                                                    </h2>
                                                                                    <a href="<?php echo base_url() . "call_alert"; ?>" class="explore-more">
                                                                                        Explore
                                                                                    </a>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <?php } ?>
                                                                        <?php if (get_global_access()=='1' || is_access_legal_crm()=='true'){ ?>
                                                                            <div class="col-sm-2">
                                                                                <div class="body-widget text-center">
                                                                                    <div class="apps-bg-icon">
                                                                                    <img src="https://mindwork.place/fusion/assets_home_v2/images/shoutbox.png" class="icons-img" alt="">
                                                                                        <h2 class="apps-title">
                                                                                            <span class="case-label-text">LEGAL CRM</span>
                                                                                        </h2>
                                                                                        <a href="<?php echo base_url() . "legal"; ?>" class="explore-more">
                                                                                            Explore
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <?php
                                                                        if (get_dept_folder() == "rta" && (get_role_dir() == "admin" || get_role_dir() == "manager" || get_role_dir() == "tl" )) {
                                                                            ?>


                                                                            <div class="col-sm-2">
                                                                                <div class="body-widget text-center new-icon">
                                                                                    <div class="apps-bg-icon">
                                                                                        <div class="icon-ms"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                                                                                        <?php
                                                                                        if ((get_rta_rejection_count()) != 0) {
                                                                                            echo '<span class="red-circle">' . get_rta_rejection_count() . '</span>';
                                                                                        }
                                                                                        ?>


                                                                                        <h2 class="apps-title">RTA
                                                                                        </h2>
                                                                                        <a href="<?php echo base_url() . "training/rejected_candidate_list_for_rta"; ?>" class="explore-more">
                                                                                            RTA Rejection
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <?php
                                                                        $admin_access_array = array('FKOL009993');
                                                                        $f_id = get_user_fusion_id();
                                                                        if (get_client_id_for_access() == true && get_dept_folder() == "operations" && (get_role_dir() == "admin" || get_role_dir() == "manager" || get_role_dir() == "tl" || in_array($f_id, $admin_access_array))) {
                                                                            ?>
                                                                            ?>
                                                                            ...
                                                                            <div class="col-sm-2">
                                                                                <div class="body-widget text-center new-icon">
                                                                                    <div class="apps-bg-icon">
                                                                                        <div class="icon-ms"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
                                                                                        <?php
                                                                                        if ((get_operation_rejection_count()) != 0) {
                                                                                            echo '<span class="red-circle">' . get_operation_rejection_count() . '</span>';
                                                                                        }
                                                                                        ?>


                                                                                        <h2 class="apps-title">Operation
                                                                                        </h2>
                                                                                        <a href="<?php echo base_url() . "training/selected_candidate"; ?>" class="explore-more">
                                                                                            Operaton Rejection
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <?php }else if (is_access_announcment() == 1){ ?>
																			...
																			<div class="col-sm-2">
                                                                                <div class="body-widget text-center">
                                                                                    <div class="apps-bg-icon">
                                                                                        <img src="<?php echo base_url() ?>assets_home_v2/images/master-entry.png" class="icons-img" alt="">
                                                                                        <h2 class="apps-title"> Announcement
                                                                                        </h2>
                                                                                        <a href="<?php echo base_url(); ?>master/fems_announcement" class="explore-more">
                                                                                            Explore
                                                                                        </a>
                                                                                    </div>
                                                                                </div>
                                ...
                                <div class="col-xl-3">
                                                        ...
                                                        <div id="carouselExampleCaptions" class="carousel slide text-center widget-carousel" data-bs-ride="carousel">
                                                            ...
                                                            <div class="carousel-indicators carousel-indicators-rounded">
                                                                ...
                                                                foreach ($get_announcement_desc as $announce) :
                                                                    $activeCss = "";
                                                                    if ($i == 0)
                                                                        $activeCss = ' class="active" aria-current="true" ';
                                                                    ?>
                                    ...
                                    <?php if ((get_user_office_id() == "CEB") || (get_user_office_id() == "MAN")) { ?>
                                        <?php if ($surveySubmissionPulse == 0) { ?>
                                                    ...
                                                    <div class="col-md-12">
                                                        <a href="<?php echo base_url(); ?>survey/employee_pulse">
                                                            <div class="widget widgetRibbonLD" style="border-radius: 3px; cursor:pointer;">
                                                                <div class="customRibbonCount bg-danger">1</div>
                                                                <header class="widget-header">
                                                                    <div class="widget-title" style="color:#fff; font-size:16px; text-align:center;">
                                                                        Pulse Survey<i class="fa fa-bar-graph"></i>
                                                                    </div>
                                                                </header>
                                                            </div>
                                                        </a>
                                        ...
                                        <?php if ($surveySubmissionAnonymous == 0) { ?>

                                            <div class="a-survey">
                                                <div class="row" style="margin-bottom:2px;">
                                                    <div class="col-md-12">
                                                        <a href="<?php echo base_url(); ?>employee_feedback/feedbackform_ceb_man">
                                                            <div class="widget widgetRibbonLD" style="border-radius: 3px; cursor:pointer;">
                                                                <div class="customRibbonCount bg-danger">1</div>
                                                                <header class="widget-header">
                                                                    <div class="widget-title" style="color:#fff; font-size:16px; text-align:center;">
                                                                        Anonymous Survey<i class="fa fa-bar-graph"></i>
                                                                    </div>
                                                                </header>
                                                            </div>
                                                        </a>
                                    ...
                                    <!--------------- Employee Satisfaction Survey (30-11-2022) start --------------------->
                                    <?php if (isIndiaLocation(get_user_office_id()) == true) { ?>

                                        <?php if ($surveySubmissionSatisfaction == 0) { ?>
                                            <div class="mt-2">
                                                <div class="row">
                                                    <div class="col-xl-12">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <a href="<?php echo base_url() . 'survey/employee_satisfaction'; ?>">
                                                                    <div class="widget widgetRibbonLD" style="border-radius: 3px; cursor:pointer;">
                                                                        <div class="customRibbonCount bg-danger">1</div>
                                                                        <header class="widget-header">
                                                                            <div class="widget-title" style="color:darkblue; font-size:16px; text-align:center;">
                                                                                Employee Satisfaction Survey <i class="fa fa-bar-graph"></i>
                                                                            </div>
                                                                        </header>
                                                                    </div>
                                                                </a>
                                    ...
                                    <?php } ?>
                                    <!--------------- Employee Satisfaction Survey (30-11-2022) end --------------------->
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="card">                  
                                                    <div class="card-body">
                                                        ...
                                                        <?php if ($pms_row_count['cnt'] > 0) { ?>
                                                            <div class="pMs"> 
                                                                <div class="row" style="margin-bottom:2px;">
                                                                    <div class="col-md-12">
                                                                        <a href="<?php echo base_url(); ?>pms_assignment/">
                                                                            <div class="widget widgetRibbonLD" style="border-radius: 3px; cursor:pointer;">
                                                                                <div class="new-image bg-danger-na"><img src="<?php echo base_url(); ?>assets_home_v2/images/new.gif"></div>
                                                                                <header class="widget-header">
                                                                                    <div class="widget-title" style="color:#fff; font-size:16px; text-align:center;">
                                                                                        Your Performance Sheet<i class="fa fa-bar-graph"></i>
                                                                                    </div>
                                                                                </header>
                                                                            </div>
                                                                        </a>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $(".workanniversary").hide();
                $(".slide-workanniversary").click(function () {
                    $(".workanniversary").animate({
                        width: "toggle"
                    });
                });
                $(".close-btn").click(function () {
