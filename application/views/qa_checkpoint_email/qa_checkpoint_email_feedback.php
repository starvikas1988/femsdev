			...
			<div class="col-12">
				...
				<div class="widget">
					...
					<div class="widget-body">
						...
						<form id="form_new_user" method="GET" action="<?php echo base_url('Qa_checkpoint_email'); ?>">
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-1" style="margin-top:20px">
									<button class="btn btn-success waves-effect" a href="<?php echo base_url()?>Qa_checkpoint_email" type="submit" id='btnView' name='btnView' value="View">View</button>
								</div>
							</div>
						...
						<div class="col-md-12">
							<header class="widget-header">
								<h4 class="widget-title">
									<div class="pull-left">Check Point</div>
									<?php if(is_access_qa_module()==true){ ?>
									<!-- <div class="pull-right">
										<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_checkpoint_email/add_checkpoint_email_feedback">Add Feedback</a>
									</div> -->
								...
								<div class="col-sm-8">
									<div class="form-group">
										...
										<?php $stratAuditTimes=date('Y-m-d H:i:s'); ?>
											<?= form_open( base_url('Qa_checkpoint_email/import_chekpoint_email_excel_data'),array('method'=>'post','enctype'=>'multipart/form-data'));?>
								...
								<div class="col-sm-12">
									<div class="form-group pull-right" > <a href="<?php echo base_url();?>Qa_checkpoint_email/sample_chekpoint_email_download" class="btn btn-success" title="Download Sample chekpoint_email Excel" download="Sample chekpoint_email Excel.xlsx" style="margin-right:5px;">Sample Excel</a>
									<a class="btn btn-primary" href="<?php echo base_url(); ?>Qa_checkpoint_email/add_checkpoint_email_feedback">Add Audit</a>
								</div>
								</div>	
									<?php } ?>
								</h4>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									<?php $i=1; 
										foreach($qa_checkpoint_email_data as $row):
									?>
									<tr>
										<td><?php echo $i++; ?></td>
										...
										<td>
											...
											<a class="btn btn-success" href="<?php echo base_url(); ?>Qa_checkpoint_email/mgnt_checkpoint_email_feedback_rvw/<?php echo $paid ?>" title="Click to Review" style="margin-left:5px; font-size:10px;">Edit Feedback</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
