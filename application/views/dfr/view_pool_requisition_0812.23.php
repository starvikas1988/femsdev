    ...
    ?>	
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group margin_all filter-widget">
                                        ...
                                        <input type="number" id="ophone" name="ophone" class="form-control" min="0" placeholder="Enter phone no /alternative phone no" value="<?php echo $ophone; ?>" onKeyPress="if(this.value.length==10) return false;" onkeydown="return event.keyCode !== 69">
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" onKeyPress="if(this.value.length=='10') return false;" id="add_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onfocusout="checkonlyphone('add')" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" onKeyPress="if(this.value.length=='10') return false;" id="alter_phone" name="alter_phone" class="form-control checkNumber" value="" placeholder="Enter Alternate Phone no" onfocusout="checkonlyphone('alter')">
                        ...
                        <div class="col-md-3" style="display:none;" id="adhar_no_div">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control number-only-no-minus-also" minlength="12" onKeyPress="if(this.value.length=='12') return false;" maxlength="12" id="social_security_no_for_candidate" name="social_security_no" onfocusout="checksecurity_for_candidate();">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" id="total_experience" style="display:none">
                            <div class="form-group">
                                ...
                                <input type="text" id="total_work_exp" name="total_work_exp" class="form-control" value="0" placeholder="Enter Total Work Exp." onkeyup="checkDec(this);" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="6" id="postcode" name="postcode" class="form-control checkNumber" value="" placeholder="Enter Postcode" onkeypress="return ValidNumeric()">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="edit_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onfocusout="checkonlyphone('edit')" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Total Work Exp. (In Year) <span class="red_bg">*</span></label>
                                <input type="text" id="total_work_exp" name="total_work_exp" class="form-control" value="0" onkeyup="checkDec(this);" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control due_date-cal" type="text" name="from_date" id="fromdate" value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control due_date-cal" type="text" name="to_date" id="todate" value="" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="scheduled_on" name="scheduled_on" class="form-control due_date-cal" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                                ...
                                <select class="form-control" id="pool_location" name="pool_location" required>
                                    ...
                                    foreach ($location_data as $row) :
                                        ...
                                        if ($row['abbr'] == $oValue)
                                            $sCss = "selected";
                                    ?>
                                        <option value="<?php echo $row['abbr']; ?>" <?php echo $sCss; ?>><?php echo $row['location']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="first_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter phone" onKeyPress="if(this.value.length=='10') return false;" onfocusout="checkonlyphone('first')">
