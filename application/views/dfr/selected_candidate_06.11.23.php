	...
	<section class="app-content">
		...
		<div class="common-top">
			<div class="row">
				<div class="col-sm-12">
					<div class="white_widget padding_3">
						<div class="table-responsive table_widget common_table_widget report_hirarchy">
