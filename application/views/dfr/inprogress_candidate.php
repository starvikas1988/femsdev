			...
			<div class="col-md-12">
				<div class="white_widget padding_3">
					<div class="avail_widget_br">
						<h2 class="avail_title_heading">In-Progress Candidate Lists</h2>
					</div>
								...
								<tbody>
									...
									?>
										<tr class="smart_search_tr">
											...
											<?php if (is_access_dfr_module() == 1) {	////ACCESS PART 
											?>
												<td class="leave_columns_fixed action_column_right table_width2">
													...
													if ($c_id != "") {
														echo '<a class="btn btn-xs d_inline viewCandidate" href="' . base_url() . 'dfr/view_candidate_details/' . $c_id . '" target="_blank"  c_id="' . $c_id . '" r_id="' . $r_id . '" title="Click to View Candidate Details"><img src="' . base_url() . 'assets_home_v3/images/view.svg" alt=""></a>';
														if ($cd['requisition_status'] != 'CL') {
															...
															if ($req_no_position > $filled_no_position) {
																if ($c_status != 'R' && $c_status != 'CS') {
																	if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
																		echo '<a class="btn btn-xs d_inline editCandidate" c_id="' . $c_id . '" r_id="' . $r_id . '" params="' . $params . '" title="Click to Edit Candidate"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
																	}
																}
															} else {
													...
													<div class="dropdown action_dropdown d_inline">
														...
														<ul class="dropdown-menu right_action_column" id="list_dropdown">
															<?php if ($c_id != "") {
																if ($cd['requisition_status'] != 'CL') {
																	if ($req_no_position > $filled_no_position) {
																		if ($c_status != 'R' && $c_status != 'CS') {
																			if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
																				if ($c_status != 'E') {
																					echo '<li><a class="btn btn-xs addExperience" title="Add Candidate Experience"  r_id="' . $r_id . '"  c_id="' . $c_id . '"><img src="' . base_url() . 'assets_home_v3/images/add.svg" alt=""> Add Candidate Experience</a></li>';
																					echo '<li><a class="btn btn-xs addQualification" title="Add Candidate Qualification"  r_id="' . $r_id . '"  c_id="' . $c_id . '"><img src="' . base_url() . 'assets_home_v3/images/qualification.svg" alt=""> Add Candidate Qualification</a></li>';
																				}
																			}
																		}
																		...
																		if ($c_status == 'P' || $c_status == 'IP') {
																			if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
																				echo '<li><a class="btn btn-xs scheduleCandidate" title="Schedule Interview"  r_id="' . $r_id . '"  c_id="' . $c_id . '" hiring_department="' . $department_id . '" interview_site="' . $interview_site . '" ><img src="' . base_url() . 'assets_home_v3/images/calendar_black.svg" alt=""> Schedule Interview</a></li>';
																				if ($c_status != 'P') {
																			...
																			if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "manager" || $is_role_dir == "super" || $is_global_access == 1) {
																				echo '<li><a class="btn  btn-xs candidateApproval" r_id="' . $r_id . '" c_id="' . $c_id . '" c_status="' . $c_status . '" requisition_id="' . $requisition_id . '" title="Approval to Final Selection" ><img src="' . base_url() . 'assets_home_v3/images/add.svg" alt=""> Approval to Final Selection</a></li>';
																				echo '<li><a class="btn  btn-xs candidateDecline" r_id="' . $r_id . '"  c_id="' . $c_id . '" c_status="' . $c_status . '" title="Decline Approval" ><img src="' . base_url() . 'assets_home_v3/images/cancel.svg" alt=""> Decline Approval</a></li>';
																			}
																		} else if ($c_status == 'CS' || $c_status == 'E') {
																			if (get_dept_folder() == "hr" || $is_role_dir == "super" || $is_global_access == 1) {
																				if ($c_status != 'E') {
																					echo '<li><a class="btn btn-primary btn-xs finalSelection" r_id="' . $r_id . '" c_id="' . $c_id . '" cparams="' . $cparams . '" title="" ><img src="' . base_url() . 'assets_home_v3/images/add_employee.svg" alt=""> Add as Employee</a></li>';
																				} else {
																...
																echo '<li><a class="btn btn-xs rejectCandidateTransfer" r_id="' . $r_id . '" c_id="' . $c_id . '" c_status="' . $c_status . '" title="Transfer Candidate" ><img src="' . base_url() . 'assets_home_v3/images/transfer.svg" alt=""> Transfer Candidate</a></li>';
															}
															?>
														</ul>
													</div>
													<!--end action dropdown menu-->
																...
																if ($c_status == 'P' || $c_status == 'IP') {
																	...
																	if (get_dept_folder() == "hr" || $is_role_dir == "super" || $is_global_access == 1) {
																		if ($c_status != 'E') {
																			...
																			echo "<span class='action_msg'>Employee</span>";
																		}
																	}
																} else {
																	echo '<span class="action_msg">Rejected</span>';
																}
															} else {
																echo "<span class='action_msg'>Filled Position</span>";
															}
														}
													}
													?>
											...
											<td colspan="100">
												<table class="table">
																						...
																						if ($c_status != 'R' && $c_status != 'CS') {
																							...
																							if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
																								...
																								if ($req_no_position > $filled_no_position) {
																									...
																									echo '<a class="btn btn-xs editCandidateExp" c_exp_id="' . $c_exp_id . '" r_id="' . $r_id . '" c_id="' . $c_id . '"  params="' . $params . '" title="Click to Edit Candidate Experience" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
																								}
																							}
																						}
																					}
													...
													<tr>
														...
														<td>
															<table class="table table-bordered table-striped skt-table" cellspacing="0" width="100%" style="background-color:#FFF;margin-bottom:0px;">
																<thead>
																	<tr class="">
																		<th>SL.No</th>
																		<th>Examination</th>
																...
																<tbody>
																	...
																	?>
																				...
																				<td>
																					...
																					if ($c_status != 'R' && $c_status != 'CS') {
																						...
																						if ($sh_status == "P") {
																							...
																							echo '<a class="btn  btn-xs candidateAddInterview" title="Add Interview" r_id="' . $r_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" schType="' . $interview_type . '" schSite="' . $interview_site . '" schAssin="' . $assign_interviewer . '" sh_status="' . $sh_status . '" sch_date="' . $sch_date . '"><img src="' . base_url() . 'assets_home_v3/images/add.svg" alt=""></a>';
																							/* }else{
																		echo '<a class="btn btn-success btn-xs" disabled="true" title="Button will be active on '.$sch_date.' " style="font-size:12px"><i class="fa fa-plus"></i></a>';
																							...
																							echo '<a class="btn btn-xs cancelSchedule" r_id="' . $r_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" params1="' . $params1 . '" title="Cancel Interview Schedule" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/cancel.svg" alt=""></a>';
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" id="dob1" name="dob" class="form-control due_date-cal" value="" required>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label>Phone</label>
								<input type="text" id="phone" name="phone" class="form-control" value="" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<input type="text" id="total_work_exp" name="total_work_exp" class="form-control" value="" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))" required>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="from_date_inp" name="from_date" class="form-control due_date-cal datepicker" required readonly>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>To Date</label>
								<input type="text" id="to_date_inp" name="to_date" class="form-control due_date-cal datepicker" required readonly>
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="work_exp" name="work_exp" class="form-control" onkeydown="return ( event.ctrlKey || event.altKey
                                                || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))"
 required>
							</div>
						</div>
					</div>
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label>From Date</label>
								<input type="text" id="fromdate" name="from_date" class="form-control due_date-cal" readonly required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>To Date</label>
								<input type="text" id="todate" name="to_date" class="form-control due_date-cal" readonly required>
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="passing_year" name="passing_year" class="form-control" onkeydown="return ( event.ctrlKey || event.altKey
                                                || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))"
 required>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="grade_cgpa" name="grade_cgpa" class="form-control" onkeydown="return ( event.ctrlKey || event.altKey
                                                || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))"
 required>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="scheduled_on1" name="scheduled_on" class="form-control due_date-cal" readonly required >
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="scheduled_date" name="interview_date" class="form-control due_date-cal" readonly required>
							</div>
						</div>
					</div>
...
<script>
	...
	$(document).ready(function() {
        ...
        $('#from_date_inp').on('change', function() {
            validateDates();
        });
        $('#to_date_inp').on('change', function() {
            validateDates();
        });
        function validateDates() {
            var startDate = new Date($('#from_date_inp').val());
            var endDate = new Date($('#to_date_inp').val());
            if (startDate && endDate && endDate < startDate) {
                alert("End date cannot be a previous date of start date.");
                $('#to_date_inp').val('');
            }
            var today = new Date().toISOString().split('T')[0];
            $('#to_date_inp').attr('min', today);
        }
    });
</script>
