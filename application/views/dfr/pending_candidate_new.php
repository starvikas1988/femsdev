...
<div class="wrap">
	<section class="app-content">
		...
		<div class="row">
						...
						<?php echo form_open('',array('method' => 'get','id' => 'dynamic_search_form')) ?>
							...
							<div class="filter-widget">								
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="form-group">
											<button type="button" name="search" id="search" value="Search" class="submit-btn">
			...
			<input type="hidden" name="data_url" id="data_url" value="<?php echo base_url('dfr_new/getPendingCandidateAjaxResponse'); ?>">
...
<div class="modal fade" id="declineFinalSelectModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"></div>
...
$(function() {  
 $('#multiselect').multiselect();
	...
	// 		},
	// 		'url': '<?php echo base_url('dfr_new/getPendingCandidateAjaxResponse');?>',
	// 		'data': function(data) {
	// 			// Read values
	// 			var from_date 		= $('#from_date').val();
	// 			var to_date 		= $('#to_date').val();
	// 			var brand 			= $('#select-brand').val();
	// 			var office_loc 		= $('#fdoffice_ids').val();				
	// 			var select_department 	= $('#select-department').val();				
	// 			var select_client 	= $('#fclient_id').val();
	// 			var select_process 	= $('#fprocess_id').val();
