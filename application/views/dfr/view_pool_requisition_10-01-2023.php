                ...
                <div class="widget">
                    ...
                    <div class="row" style="float:right; margin-top:-40px; margin-right:20px">
                        ...
                        if (is_access_dfr_module() == 1) {  ////ACCESS PART
                            echo "<button title='' type='button' class='btn btn-primary blue-bg sendBasicLink' r_id='pool' requisition_id='pool' style='font-size:10px'>Send Link to Candidate </button>&nbsp;";

                            echo "<button title='' type='button' class='btn btn-primary green-bg addCandidate' r_id='' requisition_id='' style='font-size:10px'>Add Candidate</button>";
                        }
                        ?>
...
?>
    ...
    echo $b;
                            ...
                            <div class="col-md-2" id="start_date">
                                <div class="form-group">
                                    <label>Start Date</label>
                                    <input class="form-control" type="text" name="start_date" id="from_date"
                            ...
                            <div class="col-md-2" id="end_date">
                                <div class="form-group">
                                    <label>End Date</label>
                                    <input class="form-control" type="text" name="end_date"  id="to_date"
...
foreach ($get_candidate_details as $cd):
    ...
    ?>
                                        <tr>
                                            ...
                                            <!--<td><?php echo ""; //echo $cd['rehire']=='Y' ? 'Yes':''; ?></td>-->
                                            <!--<td><?php echo ""; //echo $cd['rehire']=='Y' ? $cd['comments']:''; ?></td>-->
                                            <td><?php
                                                                                    ...
                                                                                    <td class="text-center" width="100px">
                                                                                        ...
                                                                                        if ($c_status != 'R' && $c_status != 'CS') {
                                                                                            ...
                                                                                            if ($sh_status == "P") {
                                                                                                ...
                                                                                                echo '<a class="btn btn-success btn-xs candidateAddInterview" title="Add Interview" r_id="' . $r_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" schType="' . $interview_type . '" schSite="' . $interview_site . '" schAssin="' . $assign_interviewer . '" sh_status="' . $sh_status . '"  style="font-size:12px"><i class="fa fa-plus"></i></a>';
                                                                                                /* }else{
                                                                                                ...
                                                                                                echo '<a class="btn btn-danger btn-xs cancelSchedule" r_id="' . $r_id . '" schedule_id="' . $row1->dis_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" params1="' . $params1 . '" title="Cancel Interview Schedule" style="font-size:12px"><i class="fa fa-close"></i></a>';
            ...
            <form class="frmAddCandidate" action="<?php echo base_url(); ?>dfr/add_pool_candidate" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">  
                                <label>Location <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
...
<?php endforeach; ?>
                    ...
                    <div class="row" id="relationid" style="display: none;">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>
                                    <strong>Relation With Guardian <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></strong>
                                </label>
...
<?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date of Birth <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
...
?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="add_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onfocusout="checkonlyphone('add')" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="alter_phone" name="alter_phone" class="form-control checkNumber" value="" placeholder="Enter Alternate Phone no" onfocusout="checkonlyphone('alter')">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Field of Interest: <i class="fa fa-asterisk" id="field_of_interest" style="font-size:6px; color:red"></i></label><br/>
                                <div style="display:inline-block">
...
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Address <i class="fa fa-asterisk" id="address_req" style="font-size:6px; color:red"></i></label>
...
<?php } ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Upload Resume (doc,docx,pdf)</span>
                                </div>
                        ...
                        <div class="site_cspl" style="display: none">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Site <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onfocusout="checkonlyphone('edit')" required>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="from_date" id="fromdate"
                                       value="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="to_date"  id="todate"
                                       value="" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="first_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter phone" onfocusout="checkonlyphone('first')">
