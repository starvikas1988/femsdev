...
?>
	...
	<div id="body1" style='width:100%;'>
		...
		<p>Consequently, your contract signing will be on (<?php echo date( "F d, Y", strtotime($can_dtl_row['doj'])); ?>) at our Head Office at 153 Orange Street, Kingston. </p>
		
		<p>We would like a response to the job offer no later than (<?php echo date( "F d, Y", strtotime($can_dtl_row['doj'])); ?>) and in the meantime please feel free to contact the undersigned at email jamhr@fusionbposervices.com if you have any queries relating to this employment.</p>
		...
		<!--<p>Fusion BPO Services Jamaica would like welcome you to the Company as a (<?php echo $can_dtl_row['position_name'];?>). The salary being offered is (<?php echo ucwords(strtolower(numberTowords($can_dtl_row['gross_pay']))); ?> Dollars ($<?php echo $can_dtl_row['gross_pay'] ?>)) per month.  
		   You are to report for training and onboarding on( <?php echo date( "F d, Y", strtotime($can_dtl_row['doj'])); ?>) at our Head Office located at 153 Orange Street, Kingston.</p>
		<br/>
		...
		<img height='80px' src="<?php APPPATH ?>main_img/new_signature_JAM.png" alt="signature" />
		<br/>
		<br/>

		<strong>Jeanie Vazquez<br/>		
		Senior Director - Human Resource</strong></p>
