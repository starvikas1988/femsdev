                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                // echo $dfr_location;
                                ?>
                                <input type="number" id="first_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter phone" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'first')" required>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                ?>
                                <input type="number" id="add_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'add')" required>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                ?>
                                <input type="number" id="alter_phone" name="alter_phone" class="form-control checkNumber" value="" placeholder="Enter Alternate Phone no" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'alter')">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                // echo $dfr_location;
                                ?>
                                <input type="number" id="edit_phone" name="phone" class="form-control checkNumber" placeholder="Enter Phone" value="" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'edit')" required>
