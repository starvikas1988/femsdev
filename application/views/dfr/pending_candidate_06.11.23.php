								...
								<tbody>
									...
									?>
										<tr>
											...
											?>
												<td width="125px">
													...
													if ($c_id != "") {
														echo '<a class="btn btn_left action_btn_hover1 btn-xs d_inline viewCandidate" href="' . base_url() . 'dfr/view_candidate_details/' . $c_id . '" target="_blank"  c_id="' . $c_id . '" r_id="' . $r_id . '" title="Click to View Candidate Details"><img src="' . base_url() . 'assets_home_v3/images/view.svg" alt=""></a>';
														if ($cd['requisition_status'] != 'CL') {
															if ($req_no_position > $filled_no_position) {
																if ($c_status != 'R' && $c_status != 'CS') {
																	if(get_dept_folder()=="hr" || $is_role_dir=="admin" || $is_role_dir=="super" || $is_global_access==1){
																		echo '<a class="btn d_inline btn_left action_btn_hover1 btn-xs editCandidate" c_id="' . $c_id . '" r_id="' . $r_id . '" params="' . $params . '" title="Click to Edit Candidate"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';																	
																	}	
										...
										<tr id="<?php echo $c_id; ?>" class="collapse">
											<td colspan="100" style="background-color:#f8f8f8">
																					...
																					if ($c_exp_id != "") {
																						if ($c_status != 'R' && $c_status != 'CS') {
																							...
																							if ($req_no_position > $filled_no_position) {
																								...
																								echo '<a class="btn btn_left btn-xs editCandidateExp" c_exp_id="' . $c_exp_id . '" r_id="' . $r_id . '" c_id="' . $c_id . '"  params="' . $params . '" title="Click to Edit Candidate Experience" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
																							}
																					...
																					if ($c_qual_id != "") {
																						if ($c_status != 'R' && $c_status != 'CS') {
																							...
																							if ($req_no_position > $filled_no_position) {
																								...
																								echo '<a class="btn btn_left btn-xs editCandidateQual" c_qual_id="' . $c_qual_id . '" r_id="' . $r_id . '" c_id="' . $c_id . '"  params="' . $params . '" title="Click to Edit Candidate Qualification" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
																							}
																	...
																	?>
																		...
																		<tr>
																			...
																			echo '<a class="btn btn-success btn-xs" disabled="true" title="Button will be active on '.$sch_date.' " style="font-size:12px"><i class="fa fa-plus"></i></a>';
																							...
																							echo '<a class="btn btn_left btn-xs editInterview" r_id="' . $r_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" schType="' . $interview_type . '" schSite="' . $interview_site . '" schAssin="' . $assign_interviewer . '"  params2="' . $params2 . '" interview_date="' . $interview_date . '" title="Edit Interview" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
																						}
