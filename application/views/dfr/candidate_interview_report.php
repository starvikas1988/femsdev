						...
						<div class="col-md-12">
							<div class="widget">
								...
								<div class="widget-body">
									...
									<div class="row">  
										<div class="col-md-6">
											<h6><b>INTERVIEWER'S NAME :</b> 

												<?php /* ?><?=isset($candidate_details[0]['interviewer_name'])?$candidate_details[0]['interviewer_name']:''?><?php */ ?>

												<?php 
												$interviewer_name = array();
												foreach($candidate_interview_details as $row){ 
													if($row['interviewer'] != ''){
														array_push($interviewer_name, $row['interviewer']);
													}
													
												} ?>

												<?php if(!empty($interviewer_name)){ echo implode(',', $interviewer_name);}?>
