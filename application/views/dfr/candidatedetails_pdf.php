...
<div style="margin:5px;">	
	...
	<div>
		<img src="<?php echo APPPATH; ?>/../assets_home_v3/brand_logo/fusion_logo.jpg" height="10%">
	</div>
	...
	<div>
			...
			<table cellspacing="0" cellpadding="5" style="width:100%; border:1px solid black">
				...
				<?php if($row['location']=='KOL'){ ?>	
				<tr>
					<td style="text-align:left"><b>Mother Name:</b></td>
					<td style="text-align:left"><?php echo $row['mother_name']; ?></td>
				</tr>
				<?php  } ?>
