                ...
                <div class="col-md-12">
                    <div class="white_widget padding_3 dfr_table_widget">
                        <div class="widget-body no_padding gapping_less">
                            ...
                            ?>
                            <div id="bg_table" class="common_table_widget new_table_chan table_export new_fixed_widget1 manage_columns">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="req_no_position" name="req_no_position" class="form-control" value="" placeholder="Enter Req. no of Position..." required oninput="validateNumber(this)">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="4" id="req_exp_range" name="req_exp_range" class="form-control" value="" placeholder="Enter Req. Exp. Range..." required oninput="validateNumber(this)">
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script>
    ...
    table.buttons().container()
        ...
        table.on( 'draw', function () {
            $(".d_inline").each(function() {
            if($(this).find("li").length==0){
                $(this).removeClass('d_inline').addClass('hidden');
            }
        })
});    
</script>
