							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group margin_all">
										...
										<button class="btn btn_padding filter_btn save_common_btn waves-effect" a href="<?php echo base_url() ?>dfr/master_mis_download" type="submit" id='btnView' name='btnView' value="View">Export to Excel</button>
									</div>
								</div>
							</div>
