                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" id="incentive_amt" name="incentive_amt" onkeypress="return /[0-9]/i.test(event.key)" class="form-control" autocomplete="off" value='0'>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" id="joining_bonus" name="joining_bonus" onkeypress="return /[0-9]/i.test(event.key)" class="form-control" autocomplete="off" value='0'>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 indlocation">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" step="0.01" id="variable_pay" onkeypress="return /[0-9]/i.test(event.key)" name="variable_pay" class="form-control" autocomplete="off" value='0'>
                                </div>
                            </div>
