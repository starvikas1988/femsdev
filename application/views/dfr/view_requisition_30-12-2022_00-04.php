            ...
            <form class="frmEditRequisition" action="<?php echo base_url(); ?>dfr/edit_requisition" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body filter-widget">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Requisition Type <span  style="color:red"> *</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Required no of Position <span  style="color:red"> *</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Is Asset Required?<span  style="color:red"> *</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Required Experience Range <span  style="color:red"> *</span></label>
