                    ...
                    <div class="row" style="<?php echo $disCss; ?>">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="onboarding_typ" name="onboarding_typ" required class="form-control" "<?php echo $reqCss; ?>" >
                                    <option value="">-- Select type --</option>
                                    <option value="Regular">Regular</option>
                                    <option value="NAPS">NAPS</option>
									<option value="NATS">NATS</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="company" name="company" required class="form-control" "<?php echo $reqCss; ?>">
                ...
                <div class="modal-body">
                    ...
                    <div id="check_payroll">
                        <div class="row">
                            ...
                            <div class="col-md-6" id='csplBonus' style="">
                                <div class="form-group">
