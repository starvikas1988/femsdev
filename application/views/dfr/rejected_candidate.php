			...
			<div class="col-md-12">
				<div class="white_widget padding_3">
					<div class="avail_widget_br">
						<h2 class="avail_title_heading">Rejected Candidate List</h2>
					</div>
													...
													<div class="dropdown action_dropdown d_inline">
														...
														<ul class="dropdown-menu right_action_column" id="list_dropdown">
															<?php 
																if ($c_id != "") {
																	if ($c_status != 'P') {
																		echo '<li><a class="btn btn-xs candidateInterviewReport" href="' . base_url() . 'dfr/view_candidate_interview/' . $c_id . '"  target="_blank"  c_id="' . $c_id . '" r_id="' . $r_id . '" title="Candidate Interview Report"><img src="' . base_url() . 'assets_home_v3/images/report_black.svg" alt="">Candidate Interview Report</a></li>';
																	}
																}
															?>
														</ul>
