...
$approved_on = date_format(date_create($can_dtl_row['approved_on']), 'd/m/Y');
...
if($emp_type=="" || $emp_type=="0") $emp_type=$can_dtl_row['emp_status'];
if($emp_type==0) $emp_type=3;
...
<div style="margin:5px;">
	...
	<div id="body1" style='width:100%;'>
		...
		$slno=1;
			...
			if($emp_type==6){
		?>	
			<span><?php echo $slno++ ?>. This offer/apprenticeship will be valid for <?php echo $can_dtl_row['contract_dur_days'] ?> days, or it may get extended. </span><br>
		<?php } ?>
		
		<span><?php echo $slno++ ?>. You will be designated as <b><?php echo $can_dtl_row['position_name']; ?></b> , <b><?php echo $can_dtl_row['department_name']; ?></b> (Designation & Department).</span><br>
		<span><?php echo $slno++ ?>. Your monthly Gross salary will be <strong>Rs. <?php echo $can_dtl_row['gross_pay']; ?>/- ( <?php echo getIndianCurrency($can_dtl_row['gross_pay']); ?></strong> <strong>)</strong>.</span><br>
		...
		<?php } ?>
		<span><?php echo $slno++ ?>. You will be based at one of our location at <?php echo $can_dtl_row['location_name']; ?></span><br>
		<span><?php echo $slno++ ?>. Your date of joining will be on or before <?php echo date('d/m/Y', strtotime($can_dtl_row['doj'])); ?></span><br>
		<span><?php echo $slno++ ?>. Your employment would be subject to a positive Reference Check. </span><br>
		<span><?php echo $slno++ ?>. Your appointment letter along with employment terms & conditions will be issued to you at the time of your joining. </span><br>
		<span><?php echo $slno++ ?>. Please bring the below listed documents/details on your day of joining. </span><br>
		...
		<table cellpadding='2' cellspacing="0" border='1' align='center' style='font-size:12px; text-align:center; width:99%;'>
			...
			<tr>
				<td style="text-align:left;">Employer PF *</td>
				<td><?php echo $pf_employer; ?></td>
				<td><?php echo ($pf_employer * 12); ?></td>
			</tr>
			<tr>
				<td style="text-align:left;">Employer ESI *</td>
		...
		<span style='font-size:10px'><?php echo get_lwf_note("CHA");?> </span><br>
