            ...
            <div class="col-md-12">
                <div class="widget">
                    <header class="widget-header">
                        <h4 class="widget-title">View Requisition <?php //echo $filled_pos;
                                                                    ?>
                            ...
                            ?>
                                ...
                                <div class="row">
                                    <?php if ($r_status == 'P') { ?>
                                        ...
                                        <div class="col-md-6">
                                            <button title='' type='button' class='btn btn-primary approvalWfm' r_id='<?php echo $r_id; ?>' deptid='<?php echo $deptid; ?>' raisedby='<?php echo $row['raised_by']; ?>' style='font-size:10px'>Approve Requisition</button>
                                    ...
                                    <?php
                                        ...
                                        <div class="col-md-6">
                                            <button title="Edit Assets Count" type="button" class="btn btn-success editAssetsCount" r_id='<?php echo $r_id; ?>' params="<?php echo $params; ?>" requisition_id='<?php echo $requisition_id; ?>' style='font-size:10px'>Edit Assets Count</button>
                                        </div>
                                    <?php
                                    } ?>
...
//                                                                        }
                                                                ...
                                                                if ($c_status == 'E') {
                                                                    ...
                                                                    echo '<a class="btn btn-success small-icon btn-xs employee_assets_dfr" target="_blank" c_id="' . $c_id . '" title="Empolyee Assets" style="font-size:12px"><i class="fa fa-window-restore" aria-hidden="true"></i></a>';
            ...
            <form class="frmEditRequisition" action="<?php echo base_url(); ?>dfr/edit_requisition" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body filter-widget">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Requisition Type</label>
                    ...
                    <div class="row">
                        ...
                        <?php if (get_dept_folder() == 'wfm') { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Due Date</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Company Brand</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Position</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Required no of Position</label>
                                <input type="number" class="form-control" id="req_no_position" name="req_no_position" value="" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Required Skill</label>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Is Asset Required?</label>
                        ...
                        <div class="col-md-4 asset_required" style="display:none;">
                            <div class="form-group btn-mul">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Asset Requirements</label><br>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Work Type</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Qualification</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Required Experience Range</label>
...
<div class="modal fade modal-design" id="editRequisitionAssetsCountModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="frmSendBasicLink" action="<?php echo base_url(); ?>dfr/send_basic_link" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="link_fname" name="fname" class="form-control" value="" placeholder="Enter First name" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                // echo $dfr_location;
                                ?>
                                <input type="number" id="first_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter phone" onKeyPress="if(this.value.length=='<?=$phone_length?>') return false;" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'first')" required>
                    ...
                    <div class="row" style="<?php echo $disCss; ?>">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Onboarding Type</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Company </label>
            ...
            <form class="frmAddCandidate" action="<?php echo base_url(); ?>dfr/add_candidate" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <?php if ($dfr_location == 'CHA') { ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>
                                        <strong><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Guardian's Name(Father/Mother/Husband)</strong>
                                    </label>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>
                                        ...
                                        <strong><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Relation With Guardian</strong> 
                                    </label>
                    ...
                    <div class="row" id="non_existing_employee">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1"><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> How you come to know about the vacancy: </label>
                    ...
                    <div class="row">
                        <?php if (isUSLocation($dfr_location) != true) { ?>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <?php
                                    if (isIndiaLocation($dfr_location) == true) {
                                        echo '<label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Date of Birth (dd/mm/yyyy)</label>';
                                    } else {
                                        echo '<label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Date of Birth (mm/dd/yyyy)</label>';
                                    }
                                    ?>
                                    ...
                                    <input type="text" id="dob" name="dob" class="form-control dobdatepicker" value="" placeholder="Enter DOB" readonly autocomplete="off" required>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Gender</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                ?>
                                <input type="number" id="add_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onKeyPress="if(this.value.length=='<?=$phone_length?>') return false;" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'add')" required >
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                ?>
                                <input type="number" id="alter_phone" name="alter_phone" class="form-control checkNumber" value="" placeholder="Enter Alternate Phone no" onKeyPress="if(this.value.length=='<?=$phone_length?>') return false;" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'alter')">
                        ...
                        ?>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control number-only-no-minus-also" minlength="12" maxlength="12" onKeyPress="if(this.value.length=='12') return false;" id="social_security_no_for_candidate" name="social_security_no" onfocusout="checksecurity_for_candidate();">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-bottom:4px;">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Experience Level: </label><br />
                                <div style="display:inline-block">
                        ...
                        ?>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="postcode" name="postcode" class="form-control checkNumber" value="" placeholder="Enter Postcode" <?php echo ($dfr_location != 'CHA') ? 'required' : ''; ?> onblur="checkPostCode(<?php echo $post_code_length; ?>)">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Upload Resume</span>
                                </div>
                                <div class="custom-file">

                                    <input type="file" name="attachment" class="custom-file-input" id="inputGroupFile01" onchange="Filevalidation()" aria-describedby="inputGroupFileAddon01" required="required">
                ...
                <div class="modal-body">
                    ...
                    <?php if (get_user_fusion_id() == 'FKOL000003') { ?>
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Hiring Source</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Source Details</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                // echo $dfr_location;
                                ?>
                                <input type="number" id="edit_phone" name="phone" class="form-control checkNumber" placeholder="Enter Phone" value="" onKeyPress="if(this.value.length=='<?=$phone_length?>') return false;" maxlength="<?=$phone_length?>" onfocusout="checkphone(<?php echo $phone_length; ?>,'edit')" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Skill Set</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Country</label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Post Code</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Address</label>
            ...
            <form class="frmaddScheduleCandidate" action="<?php echo base_url(); ?>dfr/candidate_schedule" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Schedule Date/Time</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Interview Type</label>
                                <select class="form-control" id="interview_type" name="interview_type" required name="interview_type">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Interviewer</label>
                                <select class="form-control" required id="assign_interviewer" name="assign_interviewer" style="width:100%" >
                                    <option value="">--Select--</option>
            ...
            <form class="frmApprovalFinalSelect" id="candidateSelectionForm" action="<?php echo base_url(); ?>dfr/candidate_final_approval" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Approval Comment</label>
                    ...
                    <div class="row" id="stop_payroll" style="display:none1;">
                    ...
                    <div id="check_payroll">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Pay Type</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Currency</label>
							...
							<div class="col-md-3">
                                <div class="form-group">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Employment type</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" id="grossid">
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Monthly Total Earning (Gross Pay)</label>
            ...
            <form class="frmfinalSelection" action="<?php echo base_url(); ?>dfr/candidate_select_employee" onsubmit="return finalselection()" method='POST'>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label><?php if ($dfr_location == 'ALB') { echo 'Eleco ID <i class="fa fa-asterisk" style="font-size:6px; color:red"></i>'; } else { echo 'Emp ID/XPO ID';} ?></label>
                                <input type="text" id="xpoid" name="xpoid" class="form-control" <?php if ($dfr_location == 'ALB') {?> required oninput="onlyNumberAllow(this)" <?php } ?>>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Father's/Husband's Name</label>
                                <?php
                                if (isIndiaLocation($dfr_location) == true) {
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Relation</label>
                                <?php
                                if (isIndiaLocation($dfr_location) == true) {
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Nationality</label>
                        ...
                        <div class="col-md-2" id="caste_main">
                            <div class="form-group">
                                <label for="caste"><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Caste : </label>
                    ...
                    <div class="row" id="check_payroll">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="client"><i class="fa fa-asterisk" style="font-size:6px; color:red"></i> Select Payroll Type</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    if ($dfr_location == 'ELS') {
                                        ...
                                        echo "<label for='pan_no'><i class='fa fa-asterisk' style='font-size:6px; color:red'></i> TAX/PAN Number</label>";
                                    }
                                    ?>
        ...
        <div class="modal-content">
            ...
            <form class="frmBGVCandidate" action="<?php echo base_url(); ?>bgv/insertBGV" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="type" name="type" class="form-control" value="view_requisition" required>
                    ...
                    <div class="row" id="bgvdat">
                            ...
                            <div class="form-group">                                
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label>CRC Document <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label> <span id="crc_doc_view"></span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
                                    <label>Address Verification Document <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label> <span id="address_verification_doc_view"></span>
...
<!--------------- DFR Assests-------------------->
<!--<div class="modal fade modal-design employee_assets_model_dfr" id="employee_assets_model" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content" >
...
<!--<table class="table table-striped table-responsive">
        <thead>
                <tr>
                        <th>Email ID Required</th>
                        <th>Domain ID Required</th>
                        <th>Assets</th>
                        <th>Mouse Required</th>
                        <th>Keyboard Required</th>
                        <th>Keyboard Required</th>
                        <th>Headset Required</th>
                </tr>
        </thead>
        <tbody>
                <tr>
                        <td>Yes</td>
                        <td>Domain ID Required</td>
...
<!--<div class="row section_employee_assets_form" style="display: none;">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            <select class="form-control" name="email_id" id="email_id" required>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="client">Assets <span style="color: red">*</span></label>
            <select class="form-control" name="assests" id="assests" required>
                <option value="" selected>--Select Option--</option>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="client">Mouse <span style="color: red">*</span></label>
            <select class="form-control" name="mouse" id="mouse" required>
                <option value="" selected>--Select Option--</option>
                <option value='1'>Yes</option>
                <option value='0'>No</option>
            </select>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="client">Keyboard <span style="color: red">*</span></label>
            <select class="form-control" name="Keyboard" id="Keyboard" required>
                <option value="" selected>--Select Option--</option>
                <option value='1'>Yes</option>
                <option value='0'>No</option>
            </select>
    ...
    <div class="col-md-4">
        <div class="form-group">
            <label for="client">Headset <span style="color: red">*</span></label>
            <select class="form-control" name="headset" id="headset" required>
                <option value="" selected>--Select Option--</option>
                <option value='1'>Yes</option>
                <option value='0'>No</option>
            </select>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="section_employee_assets_form_submit" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body">
                    <div class="row dfr_assets_assigned">
            ...
            if (response != '') {
                ...
                $.each(dat_asset, function(r) {
                    ...
                    string += '<div class="col-md-4">\
                                <div class="form-group">\
                                    <label><i class="fa fa-asterisk" style="font-size:6px; color:red"></i>' + dat_asset[r].name + ' Count</label>\
...
<script>
// $(document).ready(function() {
//     if ($('#req_no_position').val() == '') {
//     $('#req_no_position').css('border-color', 'red');
// }
// else {
//     $('#req_no_position').css('border-color', '');
// }
// });
...
if ($('#due_date1').val() == '') {
    $('#due_date1').css('border-color', 'red');
}
else {
    $('#due_date1').css('border-color', '');
}

if ($('#company_brand').val() == '') {
    $('#company_brand').css('border-color', 'red');
}
else {
    $('#company_brand').css('border-color', '');
}
...
if ($('#req_skill').val() == '') {
    $('#req_skill').css('border-color', 'red');
}
else {
    $('#req_skill').css('border-color', '');
}

if ($('#is_asset').val() == '') {
    $('#is_asset').css('border-color', 'red');
}
else {
    $('#is_asset').css('border-color', '');
}
...
if ($('#req_qualification').val() == '') {
    $('#req_qualification').css('border-color', 'red');
}
else {
    $('#req_qualification').css('border-color', '');
}

if ($('#req_exp_range').val() == '') {
    $('#req_exp_range').css('border-color', 'red');
}
else {
    $('#req_exp_range').css('border-color', '');
}
  });
