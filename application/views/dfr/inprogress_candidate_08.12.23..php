					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" id="from_date" name="from_date" class="form-control due_date-cal datepicker" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>To Date</label>
								<input type="text" id="to_date" name="to_date" class="form-control due_date-cal datepicker" required>
							</div>
						</div>
					</div>
					<div class="row">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label>From Date</label>
								<input type="text" id="fromdate" name="from_date" class="form-control due_date-cal" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label>To Date</label>
								<input type="text" id="todate" name="to_date" class="form-control due_date-cal" required>
							</div>
						</div>
					</div>
					<div class="row">
