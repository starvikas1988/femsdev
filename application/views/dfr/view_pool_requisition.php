<div class="wrap" onmousemove="styleNone()">
                    ...
                    <div class="row d_flex">
                        <div class="col-sm-6">
                            <div class="avail_widget_br">
                                <h2 class="avail_title_heading">Candidate List of Pool</h2>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="right_side">
                                ...
                                if (is_access_dfr_module() == 1) {  ////ACCESS PART
                                    echo "<button title='' type='button' class='btn btn_padding filter_btn blue-bg btn_left sendBasicLink' r_id='pool' requisition_id='pool'>Send Link to Candidate </button>";

                                    echo "<button title='' type='button' class='btn btn_padding filter_btn green-bg btn_left addCandidate' r_id='' requisition_id=''>Add Candidate</button>";
                                }
                                ?>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control due_date-cal" id="from_date" name="from_date" value="<?php echo $from_date; ?>" autocomplete="off">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <!--	<input type="date" class="form-control" id="">-->
                                        <input type="text" readonly class="form-control due_date-cal" id="to_date" name="to_date" value="<?php echo $to_date; ?>" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group filter-widget">
                                        <label>Location</label>
                                        <select id="multiselectwithsearch" class="select-location " name="office_loc[]" multiple="multiple">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group filter-widget">
                                        <label>Site</label>
                                        <select id="multiselectwithsearch" class="form-control site_search" name="site">
                                            <option value="">--Select--</option>

                                            <?php /* foreach($get_site_location as $site): ?>
  <?php
  $sts="";
  if(in_array($site['office_abbr'],$oValue)) $sts="selected";
  ?>

  <option value="<?php echo $site['office_abbr']; ?>" <?php echo $sts;?>><?php echo $site['name']; ?></option>
  ...
  <?php endforeach; */ ?>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group margin_all filter-widget">
                                        ...
                                        <select id="brand" name="brand[]" class="select-box" autocomplete="off" placeholder="--Select--" multiple="multiple">
                                            <?php
...
<?php endforeach; ?>	
    ...
    ?>	
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group margin_all filter-widget">
                                        <label>Phone No / Alternative Phone No</label>
                                        <input type="text" id="ophone" name="ophone" class="form-control" min="0" placeholder="Enter phone no /alternative phone no" value="<?php echo $ophone; ?>" onKeyPress="if(this.value.length==10) return false;" onfocusout="checkonlyphone('add')" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                                    </div>
                                    <span id="ophone_status" style="color:red;font-size:10px;"></span>
                                </div>

                                <div class="col-sm-3">
                                    <div class="form-group margin_all filter-widget">
                                        <label>Email</label>
                                        <input type="email" id="oemail" name="oemail" class="form-control" placeholder="Enter email" value="<?php echo $oemail; ?>">
                                    </div>
                                </div>
                        ...
                        <div class="row" style="display:none;">
                            ...
                            <?php
                            if (get_global_access() == 1 || get_role_dir() == "super")
...
<?php endforeach; ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="candidate_status" id="pcandidate_status" disabled>
                                        <option value='PIP' <?php if (isset($a)) {
                                                                echo $a;
                                                            } ?>>Pending & In-Progress</option>
                                        <option value="SLCS" <?php if (isset($b)) {
                                                                    echo $b;
                                                                } ?>>Shortlisted & Selected</option>
                                        <option value="RD" <?php if (isset($c)) {
                                                                echo $c;
                                                            } ?>>Rejected & Dropped</option>
                                    </select>
                                </div>
                            </div>
                            <!-- <div class="col-md-1">
...
?>
                                            ...
                                            <select class="form-control" name="date_select" id="date_select" >
                                                    <option value="ALL" <?php if (isset($a)) {
                                                                            echo $a;
                                                                        } ?> >All</option>
                                                    <option value="DATE" <?php if (isset($b)) {
                                                                                echo $b;
                                                                            } ?> >Date</option>
                                            </select>
                                    </div>
                            ...
                            <div class="col-md-2" id="start_date">
                                <div class="form-group">
                                    <label>Start Date</label>
                                    <input class="form-control due_date-cal" type="text" name="start_date" id="from_date" value="<?php echo isset($start_date) ? $start_date : '' ?>">
                                </div>
                            </div>
                            <div class="col-md-2" id="end_date">
                                <div class="form-group">
                                    <label>End Date</label>
                                    <input class="form-control due_date-cal" type="text" name="end_date" id="to_date" value="<?php echo isset($end_date) ? $end_date : '' ?>">
                                </div>
                            </div>
            ...
            <div class="row">
                            ...
                            <table id="default-datatable" data-plugin="DataTable" class="table table-bordered table-striped skt-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Location</th>
                                        <?php
                                        if (!empty($get_candidate_details)) {
                                            if (array_search("CHA", $get_candidate_details[0])) {
                                                echo "<th>Site</th>";
                                                $site_open = true;
                                            }
                                        }
                                        ...
                                        ?>
                                            <th class="leave_columns_fixed">Action</th>
                                        <?php } ?>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    // echo '<pre>',print_r($get_candidate_details,1),'</pre>';
                                    // var_dump($get_candidate_details);
                                    $k = 1;
                                    $m = 1;
                                    ...
                                    ?>
                                        <tr class="smart_search_tr">
                                            ...
                                            <?php
                                            if ($site_open === true) {
                                                if (isset($cd['site_name'])) {
                                                    if ($cd['site_name'] != '')
                                                        echo "<td>" . $cd['site_name'] . "</td>";
                                                    else
                                                        echo "<td>NA</td>";
                                                } else {
                                                    echo "<td>NA</td>";
                                            ...
                                            <!--<td><?php echo ""; //echo $cd['rehire']=='Y' ? 'Yes':''; 
                                                    ?></td>-->
                                            <!--<td><?php echo ""; //echo $cd['rehire']=='Y' ? $cd['comments']:''; 
                                                    ?></td>-->
                                            <td><?php
                                                if (!file_exists(FCPATH . "uploads/candidate_resume" . $cd['attachment'])) {
                                                    echo '<a href="' . base_url() . "uploads/candidate_resume/" . $cd['attachment'] . '" target="_blank">View Resume</a>';
                                                } else {
                                                    echo "No Resume Uploaded";
                                                }
                                                ?></td>

                                            <!--<td><a href="<?php echo base_url(); ?>uploads/candidate_resume/<?php echo $cd['attachment']; ?>" target="_blank">View Resume</a></td>-->
                                                        ...
                                                        if ($c_status == 'P' || $c_status == 'IP') {
                                                            ...
                                                            if (get_dept_folder() == "hr" || $is_role_dir == "super" || $is_global_access == 1) {
                                                                if ($c_status != 'E') {
                                                                    ...
                                                                    echo "<br><span class='action_msg'>Emplyoee</span>";
                                                                }
                                                            }
                                                        } else {
                                                            echo '<br><span class="action_msg">Rejected</span>';
                                                        }
                                                    }
                                                }
                                                ?>
                                            ...
                                            <?php if (is_access_dfr_module() == 1) {  ////ACCESS PART 
                                            ?>
                                                <td class="leave_columns_fixed action_column_right table_width1">
                                                    <?php
                                                    //$sch_id=$cd['sch_id'];
                                                    ...
                                                    $false22 = 22;
                                                    $params = "#" . $cd['fname'] . "#" . $cd['lname'] . "#" . $cd['hiring_source'] . "#" . $cd['d_o_b'] . "#" . $cd['email'] . "#" . $cd['phone'] . "#" . $cd['last_qualification'] . "#" . $cd['skill_set'] . "#" . $cd['total_work_exp'] . "#" . $cd['country'] . "#" . $cd['state'] . "#" . $cd['city'] . "#" . $cd['postcode'] . "#" . $cd['address'] . "#" . $cd['summary'] . "#" . $cd['attachment'] . "#" . $cd['gender'] . "#" . $cd['ref_name'] . "#" . $interview_site . "#" . $cd['onboarding_type'] . "#" . $cd['company'] . "#" . $false22 . "#" . $cd['pool_location'] . "#" . $site;
                                                    // var_dump($params);
                                                    ...
                                                    if ($c_id != "") {
                                                        echo '<a class="btn btn-xs viewCandidate" href="' . base_url() . 'dfr/view_candidate_details/' . $c_id . '" target="_blank"  c_id="' . $c_id . '" r_id="' . $r_id . '" title="Click to View Candidate Details" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/view.svg" alt=""></a>';
                                                        if ($c_status != 'R' && $c_status != 'CS') {

                                                            if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
                                                                echo '<a class="btn btn-xs editCandidate" c_id="' . $c_id . '" r_id="' . $r_id . '" params="' . $params . '" title="Click to Edit Candidate" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
                                                            }
                                                        }
                                                    }
                                                    ?>
                                                        ...
                                                        <ul class="dropdown-menu right_action_column" id="list_dropdown">
                                                            ...
                                                            if ($c_id != "") {
                                                                if ($c_status != 'R' && $c_status != 'CS') {
                                                                    ...
                                                                    if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
                                                                        if ($c_status != 'E') {
                                                                            echo '<li><a class="btn btn-xs addExperience" title="Add Candidate Experience"  r_id="' . $r_id . '"  c_id="' . $c_id . '"  style="font-size:12px" ><img src="' . base_url() . 'assets_home_v3/images/add.svg" alt=""> Add Candidate Experience</a></li>';
                                                                            echo '<li><a class="btn btn-xs addQualification" title="Add Candidate Qualification"  r_id="' . $r_id . '"  c_id="' . $c_id . '" style="font-size:12px" ><img src="' . base_url() . 'assets_home_v3/images/qualification.svg" alt=""> Add Candidate Qualification</a></li>';
                                                                        }
                                                                    }
                                                                }
                                                                ...
                                                                if ($c_status == 'P' || $c_status == 'IP') {
                                                                    if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
                                                                        ...
                                                                        echo '<li><a class="btn btn-xs scheduleCandidate" title="Schedule Interview"  r_id="' . $r_id . '"  c_id="' . $c_id . '" interview_site="' . $interview_site . '" ><img src="' . base_url() . 'assets_home_v3/images/calendar_black.svg" alt=""> Schedule Interview</a></li>';

                                                                        if ($c_status != 'P') {
                                                                            if (candidate_total_schedule($c_id) > 0 && candidate_has_pending_sch($c_id) == "0") {
                                                                                echo '<li><a class="btn btn-xs candidateSelectInterview"  title="Candidate Final Status"  r_id="' . $r_id . '"  c_id="' . $c_id . '"  ><img src="' . base_url() . 'assets_home_v3/images/candidate_final_status.svg" alt=""> Candidate Final Status</a></li>';
                                                                            } else {
                                                                                if (candidate_has_pending_sch($c_id) == "0") {
                                                                                    echo '<li><a class="btn btn-xs candidateNotSelectInterview" r_id="' . $r_id . '"  c_id="' . $c_id . '" title="Reject Candidate" ><img src="' . base_url() . 'assets_home_v3/images/cancel.svg" alt=""> Reject Candidate</a></li>';
                                                                                }
                                                                            }
                                                                        }
                                                                    }
                                                                    ...
                                                                    //echo '<li><span class="label label-danger" style="font-size:12px"><b>Rejected</b></span></li>';
                                                                ...
                                                                if ($c_status != 'P') {
                                                                    ...
                                                                    echo '<li><a class="btn btn-xs candidateInterviewReport" href="' . base_url() . 'dfr/view_candidate_interview_pool/' . $c_id . '"  target="_blank"  c_id="' . $c_id . '" r_id="' . $r_id . '" title="Click to View Candidate Interview Report" ><img src="' . base_url() . 'assets_home_v3/images/report_black.svg" alt=""> Candidate Interview Report</a></li>';
                                                                }

                                                                if ($c_status != 'E') {
                                                                    echo '<li><a class="btn btn-xs selectedCandidateTransfer" r_id="' . $r_id . '" c_id="' . $c_id . '" c_status="' . $c_status . '" title="Transfer Candidate" ><img src="' . base_url() . 'assets_home_v3/images/transfer.svg" alt=""> Transfer Candidate</a></li>';
                                                                }
                                                            }
                                                        ...
                                                        <td>
                                                            <table class="table table-bordered table-striped skt-table" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    if (array_key_exists($c_id, $dfr_experience_details)) :
                                                                        //print_r($dfr_experience_details[$c_id]);
                                                                        foreach ($dfr_experience_details[$c_id] as $row) :
                                                                            /* print_r($row);
              echo $row->company_name; */
                                                                                        ...
                                                                                        if ($c_exp_id != "") {
                                                                                            if ($c_status != 'R' && $c_status != 'CS') {
                                                                                                ...
                                                                                                if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
                                                                                                    ...
                                                                                                    echo '<a class="btn btn-xs editCandidateExp" c_exp_id="' . $c_exp_id . '" r_id="' . $r_id . '" c_id="' . $c_id . '"  params="' . $params . '" title="Click to Edit Candidate Experience"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                        ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <table class="table table-bordered table-striped skt-table" cellspacing="0">
                                                                <thead>
                                                                    <tr>
                                                                        <th>SL. No.</th>
                                                                        <th>Examination</th>
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $q = 1;
                                                                    if (array_key_exists($c_id, $dfr_qualification_details)) :
                                                                        //print_r($dfr_qualification_details[$c_id]);
                                                                        foreach ($dfr_qualification_details[$c_id] as $row) :
                                                                    ?>
                                                                            <tr>
                                                                                <td><?php echo $q++; ?></td>
                                                                                        ...
                                                                                        if ($c_qual_id != "") {
                                                                                            if ($c_status != 'R' && $c_status != 'CS') {
                                                                                                ...
                                                                                                if (get_dept_folder() == "hr" || $is_role_dir == "admin" || $is_role_dir == "super" || $is_global_access == 1) {
                                                                                                    ...
                                                                                                    echo '<a class="btn btn-xs editCandidateQual" c_qual_id="' . $c_qual_id . '" r_id="' . $r_id . '" c_id="' . $c_id . '"  params="' . $params . '" title="Click to Edit Candidate Qualification" style="font-size:12px"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
                                                                                                }
                                                                                            }
                                                                                        }
                                                                                        ?>
                                                        ...
                                                        <td>
                                                            <table class="table table-bordered table-striped skt-table" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $q = 1;
                                                                    if (array_key_exists($c_id, $dfr_interview_schedules)) :
                                                                        //                                                                        print_r($dfr_interview_schedules);
                                                                        foreach ($dfr_interview_schedules[$c_id] as $row1) :
                                                                            //                                                                        echo "<pre>";print_r($row1);
                                                                    ?>
                                                                            <?php
                                                                            $sh_status = $row1->sh_status;
                                                                            $cancel_reason = $row1->remarks;

                                                                            if ($sh_status == 'P')
                                                                                $schstatus = "Pending";
                                                                            else if ($sh_status == 'N')
                                                                                $schstatus = "Not Cleared";
                                                                            else if ($sh_status == 'C')
                                                                                $schstatus = "Cleared";
                                                                            else
                                                                                $schstatus = "Cancel";
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo $row1->interview_site; ?></td>
                                                                                <td><?php echo $row1->interview_type_name; ?></td>
                                                                                <td><?php echo $row1->assign_intv_name; ?></td>
                                                                                <td><?php echo $sh_status; ?></td>
                                                                                <td><?php echo $row1->intv_name; ?></td>
                                                                                ...
                                                                                ?>
                                                                                    <td>
                                                                                        ...
                                                                                        $params1 = $row1->interview_type . "#" . $row1->interview_site . "#" . $row1->sh_status . "#" . $row1->remarks;
                                                                                        ...
                                                                                        if ($c_status != 'R' && $c_status != 'CS') {
                                                                                            ...
                                                                                            if ($sh_status == "P") {
                                                                                                ...
                                                                                                echo '<a class="btn btn-xs candidateAddInterview" title="Add Interview" r_id="' . $r_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" schType="' . $interview_type . '" schSite="' . $interview_site . '" schAssin="' . $assign_interviewer . '" sh_status="' . $sh_status . '"><img src="' . base_url() . 'assets_home_v3/images/add.svg" alt=""></a>';
                                                                                                /* }else{
                                                                                                ...
                                                                                                echo '<a class="btn btn-xs cancelSchedule" r_id="' . $r_id . '" schedule_id="' . $row1->dis_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" params1="' . $params1 . '" title="Cancel Interview Schedule"><img src="' . base_url() . 'assets_home_v3/images/cancel.svg" alt=""></a>';
                                                                                            } else if ($sh_status == "C" || $sh_status == "N") {
                                                                                                echo '<a class="btn btn-xs editInterview" r_id="' . $r_id . '" c_id="' . $c_id . '" sch_id="' . $sch_id . '" schType="' . $interview_type . '" schSite="' . $interview_site . '" schAssin="' . $assign_interviewer . '"  params2="' . $params2 . '" interview_date="' . $interview_date . '"    title="Edit Interview"><img src="' . base_url() . 'assets_home_v3/images/edit_icon.svg" alt=""></a>';
        ...
        <div class="modal-content">
            ...
            <form class="frmEditRequisition" action="<?php echo base_url(); ?>dfr/edit_requisition" data-toggle="validator" method='POST'>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id='editRequisition' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmApprovalWfm" action="<?php echo base_url(); ?>dfr/approved_requisition" data-toggle="validator" method='POST'>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <input type="submit" name="submit" id='wfmApproval' class="btn btn_padding filter_btn_blue save_common_btn" value="Save">
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmDeclineWfm" action="<?php echo base_url(); ?>dfr/decline_requisition" data-toggle="validator" method='POST'>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='wfmDecline' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
...
<div class="modal fade" id="addCandidateModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal_common modal-lg">
        <div class="modal-content">
            <form class="frmAddCandidate" action="<?php echo base_url(); ?>dfr/add_pool_candidate" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control loc_pol" id="location" name="location" required>
                                    <option value="">--Select--</option>
                                    <?php foreach ($location_data as $row) : ?>
                    ...
                    <div class="row" id="relationid" style="display: none;">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>
                                    <strong>Guardian's Name(Father/Mother/Husband) <span class="red_bg">*</span></strong>
                                </label>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>
                                    <strong>Relation With Guardian <span class="red_bg">*</span></strong>
                                </label>
                    ...
                    <div class="row" id="non_existing_employee">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="exampleInputEmail1">How you come to know about the vacancy: <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                    ...
                    <div class="row" id="existing_employee">
                        <div class="col-md-4">
                            <div class="form-group">
                                <select class="select-box existing_employee " id="ref_name1" name="ref_name">
                                    <option value="">--Select--</option>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date of Birth <span class="red_bg">*</span></label>
                                <!-- <input type="text" id="dob" name="dob" class="form-control dobdatepicker" value="" placeholder="Enter DOB" autocomplete="off" required> -->
                                <input type="text" id="dob" name="dob" class="form-control due_date-cal dobdatepicker" value="" placeholder="Enter DOB" autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Email ID <span class="red_bg">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Last Qualification <span class="red_bg">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                // }
                                ?>
                                <!-- <input type="number" id="phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" required> -->
                                <input type="text" onKeyPress="if(this.value.length=='10') return false;" id="add_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onfocusout="checkonlyphone('add')" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" onKeyPress="if(this.value.length=='10') return false;" id="alter_phone" name="alter_phone" class="form-control checkNumber" value="" placeholder="Enter Alternate Phone no" onfocusout="checkonlyphone('alter')" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                                <span id="alter_phone_status" style="color:red;font-size:10px;"></span>
                            </div>
                        </div>

                        <div class="col-md-3" style="display:none;" id="adhar_no_div">
                            <div class="form-group">
                                <label>SSN/Aadhaar No</label>
                                <input type="text" class="form-control number-only-no-minus-also" minlength="12" onKeyPress="if(this.value.length=='12') return false;" maxlength="12" id="social_security_no_for_candidate" name="social_security_no" onfocusout="checksecurity_for_candidate();" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                    ...
                    <div class="row">
                        <div class="col-md-6" style="margin-bottom:4px;">
                            <div class="form-group">
                                <label>Experience Level: <span class="red_bg">*</span></label><br />
                                <div style="display:inline-block">
                        ...
                        <div class="col-md-6" id="total_experience" style="display:none">
                            <div class="form-group">
                                <label>Total Work Exp.(In Year) <span class="red_bg">*</span></label>
                                <input type="text" id="total_work_exp" name="total_work_exp" class="form-control" value="0" placeholder="Enter Total Work Exp." onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Field of Interest: <span id="field_of_interest" class="red_bg">*</span></label><br />
                                <div style="display:inline-block">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <!-- <label>Country <i class="fa fa-asterisk" id="country_req" style="font-size:6px; color:red"></i></label>
                                    <input type="text" id="country" name="country" class="form-control" value="" placeholder="Enter Country name" required> -->
                                <label>Country <span class="red_bg">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>State <span class="red_bg">*</span></label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>City <span class="red_bg">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="6" id="postcode" name="postcode" class="form-control checkNumber" value="" placeholder="Enter Postcode" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                            </div>
                        </div>

                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Address <span id="address_req" class="red_bg">*</span></label>
                                <textarea class="form-control" id="address" name="address" placeholder="Enter Address details" style="min-height: 34px;" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Summary</label>
                                <textarea class="form-control" id="summary" name="summary" style="min-height: 34px;" placeholder="Enter Summary details"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Onboarding Type <span id="address_req" class="red_bg">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend form-group">
                                    <span class="input-group-text">Upload Resume (doc,docx,pdf) <span class="red_bg">*</span></span>
                                </div>
                                <div class="custom-file file_upload_style">
                                    <input type="file" name="attachment" class="form-control custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" required>
                                </div>
                            </div>
                        ...
                        <div class="site_cspl" style="display: none">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Site <span class="red_bg">*</span></label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='addCandidateDetails' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
    ...
    <div class="modal-dialog modal_common modal-lg">
        <div class="modal-content">
            ...
            <form class="frmEditCandidate" action="<?php echo base_url(); ?>dfr/edit_candidate" data-toggle="validator" method='POST' enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date of Birth <span class="red_bg">*</span></label>
                                <input type="text" id="dob1" name="dob" class="form-control due_date-cal dobdatepicker" value="" required>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Last Name</label>
                                <input type="text" id="lname" name="lname" class="form-control" value="" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)">
                            </div>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" <?= $readOnly; ?> id="hiring_source" name="hiring_source" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Source Details</label>
                                <input type="text" <?= $readOnly; ?> id="ref_name" name="ref_name" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter Phone no" onfocusout="checkonlyphone('edit')" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Skill Set</label>
                                <input type="text" id="skill_set" name="skill_set" class="form-control" value="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Total Work Exp. (In Year) <span class="red_bg">*</span></label>
                                <input type="text" id="total_work_exp" name="total_work_exp" class="form-control" value="0" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Address <span class="red_bg">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="file_upload_style form-group">
                        ...
                        <div class="site_cspl" style="display: none">
                            ...
                            <span style="display:none" id="additional"></span>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='edit_candidate' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
            ...
            <form class="frmaddCandidateExp" action="<?php echo base_url(); ?>dfr/add_candidate_exp" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Company Name <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Designation <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>From Date <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <!--<input type="text" id="from_date" name="from_date" class="form-control" required>-->
                                <input class="form-control due_date-cal" type="text" name="from_date" id="fromdate" value="" onkeydown="return false" pattern=".*\S+.*" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>To Date <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <!--<input type="text" id="to_date" name="to_date" class="form-control" required>-->
                                <input class="form-control due_date-cal" type="text" name="to_date" id="todate" value="" onkeydown="return false" pattern=".*\S+.*" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Contact <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <input type="text" maxlength="10" minlength="9" id="contact" name="contact" class="form-control" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Work Experience (In Year) <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <input type="text" id="work_exp" name="work_exp" class="form-control" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Job Description <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <textarea class="form-control" id="job_desc" name="job_desc" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Company Address <i class="fa fa-asterisk" style="font-size:6px; color:red"></i></label>
                                <textarea class="form-control" id="address" name="address" required></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='addCandidateExperience' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmEditCandidateExp" action="<?php echo base_url(); ?>dfr/edit_candidate_exp" data-toggle="validator" method='POST'>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="fromdate" name="from_date" class="form-control" required readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>To Date</label>
                                <input type="date" id="todate" name="to_date" class="form-control" required readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Contact</label>
                                <input type="text" id="contact" name="contact" class="form-control" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='editCandidateExperience' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmaddCandidateQual" action="<?php echo base_url(); ?>dfr/add_candidate_qual" data-toggle="validator" method='POST'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="passing_year" name="passing_year" class="form-control" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="grade_cgpa" name="grade_cgpa" class="form-control" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='addCandidateQualification' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmeditCandidateQual" action="<?php echo base_url(); ?>dfr/edit_candidate_qual" data-toggle="validator" method='POST'>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='editCandidateQualification' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
            ...
            <form class="frmaddScheduleCandidate" action="<?php echo base_url(); ?>dfr/candidate_schedule" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Schedule Date/Time <span class="red_bg">*</span></label>
                                <input type="text" id="scheduled_on" name="scheduled_on" class="form-control due_date-cal" autocomplete="off" required readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
?>	
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Interview Type <span class="red_bg">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Interviewer <span class="red_bg">*</span></label>
...
?>-->
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='addCandidateSchedule' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="scheduled_on1" name="scheduled_on" class="form-control due_date-cal" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
?>	
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='edCandidateSchedule' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="scheduled_date" name="interview_date" class="form-control due_date-cal" required readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="interview_remarks" name="interview_remarks" required></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Interview Date</label>
                                <input type="text" readonly id="interview_date" name="" class="form-control" readonly required>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="frmCandidateSelectInterview" action="<?php echo base_url(); ?>dfr/candidate_final_interviewStatus" data-toggle="validator" method='POST'>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <button type="submit" id='selectInterviewCandidate' class="btn btn_padding filter_btn_blue save_common_btn">Save</button>
                </div>
            ...
            <form class="frmApprovalFinalSelect" action="<?php echo base_url(); ?>dfr/candidate_final_approval" data-toggle="validator" method='POST'>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Date of Joining <span class="red_bg">*</span></label>
                                <input type="text" id="doj" name="doj" class="form-control" autocomplete="off" required readonly>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn_padding filter_btn save_common_btn" data-dismiss="modal">Close</button>
                    <input type="submit" name="submit" id='finalApproval' class="btn btn_padding filter_btn_blue save_common_btn" value="Save">
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="d_o_j" name="doj" class="form-control" required readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="d_o_b" name="dob" class="form-control" required readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" id="phone" placeholder="Phone No" name="phone" required onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="phone_emar">Phone No (Emergency)</label>
                                <input type="text"  class="form-control" id="phone_emar" placeholder="Phone No" name="phone_emar" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="req_id" name="req_id">
                                    ...
                                    <?php foreach ($getrequisition as $row) { ?>
                                        ...
                                        //if(in_array($row['id'],))
                                        ?>
                                        <option value="<?php echo $row['id']; ?>"><?php echo $row['requisition_id']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                                ...
                                <select class="form-control" id="pool_location" name="pool_location" required>
                                    ...
                                    foreach ($location_data as $row) :
                                        ...
                                        if ($row['abbr'] == $oValue)
                                            $sCss = "selected";
                                    ?>
                                        <option value="<?php echo $row['abbr']; ?>" <?php echo $sCss; ?>><?php echo $row['location']; ?>(<?php echo $row['office_name']; ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>First Name <span class="red_bg">*</span> </label>
                                <input type="text" id="link_fname" name="fname" class="form-control" value="" placeholder="Enter First name" required onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Last Name</label>
                                <input type="text" id="link_lname" name="lname" class="form-control" value="" placeholder="Enter Last name" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode == 32)">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="first_phone" name="phone" class="form-control checkNumber" value="" placeholder="Enter phone" onKeyPress="if(this.value.length=='10') return false;" onkeydown="return ( event.ctrlKey || event.altKey  || (47<event.keyCode && event.keyCode<58 && event.shiftKey==false)  || (event.keyCode==8) || (event.keyCode==9))">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="onboarding_typ" name="onboarding_typ" class="form-control" required>
                                    <option value="">-- Select type --</option>
                                    <option value="Regular">Regular</option>
                                    <option value="NAPS">NAPS</option>
                                    <option value="NATS">NATS</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="company" name="company" class="form-control">
                                    ...
                                    ?>
                                        <option value="<?php echo $value['id']; ?>" <?php echo $sCss ?>><?php echo $value['name']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (localStorage.getItem('vall') == "DATE") {
            $('#start_date').show();
            $('#end_date').show();
        }
        ...
        $('#date_select').on('change', function() {
            ...
            $(".ui-datepicker-inline").css("display", "none");
            if (a == 'DATE') {
                localStorage.setItem('vall', a);
                $('#start_date').show();
                $('#end_date').show();
            } else {
                localStorage.setItem('vall', "");
                $('#start_date').hide();
                $('#end_date').hide();
            }
        });
    });
    $('.loc_pol').on('change', function() {
        if (this.value == 'KOL') {
            $("#adhar_no_div").show();
        } else {
            $("#adhar_no_div").hide();
