...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>contact_tracing/submit_aftercase" method="POST" autocomplete="off">
...
<div class="panel panel-default">
  ...
  <a href="<?php echo base_url()."contact_tracing/form/" .$crmdetails['crm_id'] ."/risk/"; ?>" class="pull-right btn btn primary"><i class="fa fa-arrow-left"></i> Back to Risk</a>
  </div>
  <div class="panel-body">
...
<div class="panel panel-default">
  ...
  <div class="panel-body"> 
	...
	<a href="<?php echo base_url()."contact_tracing/form/" .$crmdetails['crm_id'] ."/investigation/"; ?>" class="btn btn-primary pull-right">Skip & Next</a>
	<?php } ?>
