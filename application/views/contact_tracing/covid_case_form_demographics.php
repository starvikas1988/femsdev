...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <form action="<?php echo base_url(); ?>contact_tracing/submit_demographics" method="POST" autocomplete="off">
...
<div class="panel panel-default">
  ...
  <a href="<?php echo base_url()."contact_tracing/form/" .$crmdetails['crm_id'] ."/administrative/"; ?>" class="pull-right btn btn primary"><i class="fa fa-arrow-left"></i> Back to Administrative LHJ</a>
  </div>
  <div class="panel-body">
 ...
 <div class="panel panel-default">
  <div class="panel-body"> 
	...
	<a href="<?php echo base_url()."contact_tracing/form/" .$crmdetails['crm_id'] ."/clinical/"; ?>" class="btn btn-primary pull-right">Skip & Next</a>
	<?php } ?>
