				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="file" name="photo" class="form-control" placeholder="" id="photofile" required accept=".pdf,image/*">
							</td>
					  	</tr>
					  	<tr>
					  		<td>
							...
							<td>
								<input type="file" name="adhar" class="form-control" placeholder="" id="adharfile" required accept=".pdf,image/*">
							</td>
						  ...
						  <tr>
							...
							<td>
								<input type="file" name="pan" class="form-control" placeholder="" id="panfile" required="" accept=".pdf,image/*">
						  ...
						  <tr>
							...
							<td>
								<input type="file" name="brth" class="form-control" placeholder="" id="brthfile" accept=".pdf,image/*">
							</td>
					</tr>
					<tr>
							<td>
							...
							<td>
								<input type="file" name="health" class="form-control" placeholder="" id="healthfile" accept=".pdf,image/*" required="">
							</td>
					</tr>
					<tr>
							<td>
							...
							<td>
								<input type="file" name="nbi" class="form-control" placeholder="" id="nbifile" accept=".pdf,image/*">
							</td>
					</tr>
				  ...
				  <table class="table table-bordered">
							  ...
							  <?php foreach ($get_edu as $key => $value): ?>
							  	...
							  	<td class="file_uploader_education" data-id="1">
									...
									<input type="file" name="edu[]" accept=".doc,.docx,.pdf,image/*" id="edufile">
								</td>
						</tr>
							  <?php endforeach ?>
							  ...
							  <?php foreach ($get_exp as $key => $value): ?>
							  		<tr>
									  	...
									  	<td class="file_uploader" data-id="1">
											...
											<input type="file" name="exp[]" accept=".doc,.docx,.pdf,image/*"  id="expfile">
											</div>
										</td>
									</tr>
							  <?php endforeach ?>
...
$('#brthfile').change(function () {
    	var uploadpath = $('#brthfile').val();
	    var fileExtension = uploadpath.substring(uploadpath.lastIndexOf(".") + 1, uploadpath.length);
		fileExtension = fileExtension.toLowerCase();
	    if (fileExtension == "pdf" || fileExtension == "jpg" || fileExtension == "jpeg" || fileExtension == "png") {
...
$('#nbifile').change(function () {
    	var uploadpath = $('#nbifile').val();
	    var fileExtension = uploadpath.substring(uploadpath.lastIndexOf(".") + 1, uploadpath.length);
		fileExtension = fileExtension.toLowerCase();
	    if (fileExtension == "pdf" || fileExtension == "jpg" || fileExtension == "jpeg" || fileExtension == "png") {
