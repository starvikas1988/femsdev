...
<div class="container">
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['photo'] ?>" name="photo" class="form-control" placeholder="" id="photofile"  accept=".pdf,image/*" required>
							</td>
					  	</tr>
					  	<tr>
					  		<td>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_adhar'] ?>" name="adhar" class="form-control" placeholder="" id="adharfile" required="required" accept=".pdf,image/*">
							</td>
					  	...
					  	<tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_adhar_back'] ?>" name="adhar_back" class="form-control" placeholder="" id="adharfileback" required="required" accept=".pdf,image/*">
							</td>
						  ...
						  <tr>
							...
							<td>
								<input type="file" value="<?= $get_person[0]['attachment_pan'] ?>" name="pan" class="form-control" placeholder="" id="panfile" accept=".pdf,image/*" required>
							</td>
						  </tr>
						  ...
						  <tr>
						  	<td align="text-center">
								...
								<div style="margin:auto;display:block">
						  		<select class="form-control required" id="last_qualification" name="last_qualification" required style="padding:4px;margin: auto;
    display: block;" >
    ...
    display: block;padding:4px;" type="text" value="" name="passing_year" onkeypress="return isNumber(event)" class="form-control" placeholder="Passing Year" id="passing_year"  required>
						  	</td>
						  	<td>
								Marks/Grade/CGPA/Result: 
						  		<input style="margin: auto;
    display: block;padding:4px;" type="text" value="" name="percentage" onkeypress="return isNumber(event)" class="form-control" placeholder="Marks/Grade/CGPA/Result" id="percentage"  required>
						  	</td>
						  </tr>	
						  <tr>
							<td>
