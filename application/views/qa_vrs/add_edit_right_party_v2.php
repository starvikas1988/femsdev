					 	...
					 	<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										<td style="font-weight:bold">Client:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[c_name]" value="<?php echo $right_party_v2_data['c_name'] ?>" required></td>
									...
									<tr>
										...
										<td colspan=2>
											<select class="form-control" id="acpt_option" name="data[acpt_option]" required>
												<?php
									...
									<tr>
										...
										<td><input type="text" class="form-control" id="vsi_account" name="data[vsi_account]" value="<?php echo $right_party_v2_data['vsi_account']; ?>" required></td>
										...
										<td><input type="text" class="form-control" id="" name="data[call_id]" value="<?php echo $right_party_v2_data['call_id']; ?>" required></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>0.94</td>
										<td>
											<select class="form-control compliance_score" id="c_fatal1" name="data[misrepresentidentity]" required>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control pscript_score" id="" name="data[confirmauthoriseduser]" required>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control pscript_score" id="" name="data[update_consumer_on_payment]" required>
									...
									<tr>
										...
										<td>2.5</td>
										<td>
											<select class="form-control callcontrol_score" id="" name="data[anticipateovercomeobjection]" required>
									...
									<tr>
										...
										<td>2.5</td>
										<td>
											<select class="form-control callcontrol_score" id="" name="data[collector_connect_customer]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control closing_score" id="" name="data[summarizethecall]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control closing_score" id="" name="data[provideVRScallbacknumber]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control closing_score" id="" name="data[setappropiatetimeline]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control closing_score" id="" name="data[closecallprofessionally]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control document_score" id="d_fatal1" name="data[useproperresultcode]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control document_score" id="d_fatal2" name="data[contextoftheconversation]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control document_score" id="d_fatal3" name="data[removeanyphonenumber]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control document_score" id="d_fatal4" name="data[updateaddressinformation]" required>
									...
									<tr>
										...
										<td>1.25</td>
										<td>
											<select class="form-control document_score" id="d_fatal5" name="data[changestateofAccount]" required>
									...
									<tr>
										...
										<td colspan=4><textarea class="form-control" name="data[call_summary]"><?php echo $right_party_v2_data['call_summary'] ?></textarea></td>
									</tr>
									<tr>
										<td colspan=2>Feedback:</td>
										<td colspan=4><textarea class="form-control" name="data[feedback]"><?php echo $right_party_v2_data['feedback'] ?></textarea></td>
									</tr>
