								...
								<table class="table table-striped skt-table" width="100%">
									<tbody>
										...
										<tr>
											...
											<td colspan="2">
												<input type="text" class="form-control" name="data[skill]" value="<?php echo $travel_pro_data['skill'] ?>" disabled>
											</td>
											<td>PO:<span style="font-size:24px;color:red">*</span></td>
											<td><input type="text" class="form-control" name="data[po]" value="<?php echo $travel_pro_data['po'] ?>" disabled>
											</td>

											<td>Call ID:<span style="font-size:24px;color:red">*</span></td>
											<td colspan="2">
												<input type="text" class="form-control" name="data[call_id]" value="<?php echo $travel_pro_data['call_id'] ?>" disabled>
											</td>
										</tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" id="" name="data[record_id]" value="<?php echo $travel_pro_data['record_id'] ?>" disabled></td>
										...
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[call_opening]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt1]" class="form-control" value="<?php echo $travel_pro_data['cmt1'] ?>"></td>
										</tr>
										...
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[verification_process]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt2]" class="form-control" value="<?php echo $travel_pro_data['cmt2'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent verify the customer's information?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[customers_information]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt3]" class="form-control" value="<?php echo $travel_pro_data['cmt3'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent verify the product(s) type?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[products_type]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt4]" class="form-control" value="<?php echo $travel_pro_data['cmt4'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent verify the call back number?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[call_back_number]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt5]" class="form-control" value="<?php echo $travel_pro_data['cmt5'] ?>"></td>
										</tr>
										<tr>
											...
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[active_listening]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt6]" class="form-control" value="<?php echo $travel_pro_data['cmt6'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent display proficient knowledge of applicable products, services/discounts?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[proficient_knowledge]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt7]" class="form-control" value="<?php echo $travel_pro_data['cmt7'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent ask appropriate probing questions?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[probing_questions]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt8]" class="form-control" value="<?php echo $travel_pro_data['cmt8'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent follow policy and procedures?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[follow_policy]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt9]" class="form-control" value="<?php echo $travel_pro_data['cmt9'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent miss any steps in the policy or procedure?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[miss_steps_in_policy]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt10]" class="form-control" value="<?php echo $travel_pro_data['cmt10'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent display a sense of urgency/avoid dead air?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[avoid_dead_air]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt11]" class="form-control" value="<?php echo $travel_pro_data['cmt11'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent setup the proper hold expectations?</td>
											<td>6</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[hold_expectations]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt12]" class="form-control" value="<?php echo $travel_pro_data['cmt12'] ?>"></td>
										</tr>
										<tr>
											<td colspan=3>Did the agent provide a One Call /Email/Chat Resolution?</td>
											<td>7</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[one_resolution]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt13]" class="form-control" value="<?php echo $travel_pro_data['cmt13'] ?>"></td>
										</tr>
										<tr>
											...
											<td>7</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[interact_professional_manner]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt14]" class="form-control" value="<?php echo $travel_pro_data['cmt14'] ?>"></td>
										</tr>
										<tr>
											...
											<td>7</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[appropriate_closing]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt15]" class="form-control" value="<?php echo $travel_pro_data['cmt15'] ?>"></td>
										</tr>
										<tr>
											...
											<td>7</td>
											<td>
												<select class="form-control travel_pro_point" id ="" name="data[compliance_expectations]" disabled>
													<option value="">Select</option>
											...
											<td colspan=2><input type="text" disabled name="data[cmt16]" class="form-control" value="<?php echo $travel_pro_data['cmt16'] ?>"></td>
										</tr>
										<tr>
											<td>Call Summary:</td>
											<td colspan=3><textarea class="form-control" disabled name="data[call_summary]"><?php echo $travel_pro_data['call_summary'] ?></textarea></td>
											<td>Feedback:</td>
											<td colspan=4><textarea class="form-control" disabled name="data[feedback]"><?php echo $travel_pro_data['feedback'] ?></textarea></td>
										</tr>
										<?php if($travel_pro_data['attach_file']!=''){ ?>
											...
											<?php $attach_file = explode(",",$travel_pro_data['attach_file']);
											 foreach($attach_file as $af){ ?>
												<audio oncontextmenu="return false;" controls controlslist="nodownload" style="background-color:#607F93">
													  <source src="<?php echo base_url(); ?>qa_files/travel_pro/<?php echo $af; ?>" type="audio/ogg">
													  <source src="<?php echo base_url(); ?>qa_files/travel_pro/<?php echo $af; ?>" type="audio/mpeg">
												</audio> </br>
											 <?php } ?>
										</td>
									</tr>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $travel_pro_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $travel_pro_data['client_rvw_note'] ?></td>
									</tr>

									<tr><td colspan="10" style="background-color:#C5C8C8"></td></tr>
									
									 <form id="form_agent_user" method="POST" action="">
										<input type="hidden" name="travel_pro_id" class="form-control" value="<?php echo $travel_pro_id; ?>">
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $travel_pro_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $travel_pro_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $travel_pro_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($travel_pro_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($travel_pro_data['agent_rvw_note']==''){ ?>
