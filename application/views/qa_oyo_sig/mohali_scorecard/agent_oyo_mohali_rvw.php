							...
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									...
									<tr>
										...
										<td style="width:250px"><input type="text" class="form-control" value="<?php echo mysql2mmddyy($oyo_sig_mohali['audit_date']); ?>"disabled></td>
										<td>Call Date:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="date" class="form-control" id="call_date2" name="data[call_date]" value="<?php echo $oyo_sig_mohali['call_date'] ?>" disabled></td>
									</tr>
									<tr>
										...
										<td>
											<input type="text" class="form-control" id="tl_names"  value="<?php echo $oyo_sig_mohali['tl_name'] ?>" readonly>
												<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $oyo_sig_mohali['tl_id'] ?>" disabled>
										</td>
										<td>Czentrix ID:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[czentrix_id]" value="<?php echo $oyo_sig_mohali['czentrix_id']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Call Duration:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="call_duration" name="data[call_duration]" value="<?php echo $oyo_sig_mohali['call_duration']; ?>" disabled></td>
										<td>Phone Number:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[phone]" onkeyup="check_numberDec(this);" value="<?php echo $oyo_sig_mohali['phone']; ?>" disabled><span id="start_phone" style="color:red"></span></td>
										<td>Campaign:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[campaign]" value="<?php echo $oyo_sig_mohali['campaign']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Call Type:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[call_type]" value="<?php echo $oyo_sig_mohali['call_type']; ?>" disabled></td>
										<td>Process<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[process_name]" value="<?php echo $oyo_sig_mohali['process_name']; ?>" disabled></td>
										<td>Booking ID:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[call_id]" value="<?php echo $oyo_sig_mohali['call_id']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Report UID:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[conf_id]" value="<?php echo $oyo_sig_mohali['conf_id']; ?>" disabled></td>
										<td>Batch No:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[batch_no]" value="<?php echo $oyo_sig_mohali['batch_no']; ?>" disabled></td>
										<td>Czentrix Disposition:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="" name="data[czentrix_disposition]" value="<?php echo $oyo_sig_mohali['czentrix_disposition']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Ticket Id:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" id="phone" name="data[ticket_id]" onkeyup="checkDec(this);" value="<?php echo $oyo_sig_mohali['ticket_id'] ?>" disabled></td>
										<td>Agent Disposition:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" name="data[agent_disposition]" value="<?php echo $oyo_sig_mohali['agent_disposition'] ?>" disabled></td>
										<td>QA Disposition:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" name="data[qa_disposition]" value="<?php echo $oyo_sig_mohali['qa_disposition'] ?>" disabled></td>
									</tr>
									<tr>
									...
									<tr style="background-color:#A9CCE3; font-weight:bold"><td>Parameter</td><td colspan=2>Sub-Parameter</td><td>Sub-Parameter Wise Score</td><td>Validation (Y/N/NA)</td><td colspan=3>Remark</td></tr>
									   <tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point " id="call_opening_5sec_mohali" name="data[call_opening_5sec]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="probing_done_mohali" name="data[probing_done]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="issue_identified_mohali" name="data[issue_identified]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="apology_empathy_mohali" name="data[apology_empathy]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="voice_intonation_mohali" name="data[voice_intonation]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_mohali_point" id="active_listening_mohali" name="data[active_listening]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="confidence_and_enthusiasm_mohali" name="data[confidence_enthusiasm]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_mohali_point" id="politeness_professionalism_mohali" name="data[politeness]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="grammar_sentence_mohali" name="data[sentence_construction]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="acknowledgement_guest_mohali" name="data[acknowledgement]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_mohali_point" id="agent_adhere_hold_mohali" name="data[adhere_hold_protocol]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="agent_adhere_dead_mohali" name="data[dead_air_protocol]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_mohali_point" id="legitimate_hold_mohali" name="data[legitimate_hold]" disabled>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control sig_mohali_point" id="resolution_provided_mohali" name="data[correct_information]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="correct_refund_mohali" name="data[correct_refund]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="follow_up_with_mohali" name="data[proper_followup]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="closure_procedure_mohali" name="data[gnc_closure]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_mohali_point" id="back_as_promised_mohali" name="data[ownership]" disabled>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control sig_mohali_point" id="send_correct_resolution_mohali" name="data[correct_email]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_mohali_point" id="complete_and_correct_mohali" name="data[correct_notes]" disabled>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control sig_mohali_point" id="accurate_tagging_off_mohali" name="data[accurate_tagging]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="disposed_accurately_mohali" name="data[call_disposed]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="ticket_status_mohali" name="data[correct_ticket_status]" disabled>
									  ...
									  <tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="pitched_need_help_mohali" name="data[piched_need_help]" disabled>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control sig_mohali_point" id="further_assistance_mohali" name="data[further_assistance]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_mohali_point" id="survey_effectively_mohali" name="data[Gsat_survey_pitched]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_mohali_point" id="survey_avoidance_mohali" name="data[Gsat_survey_avoidance]" disabled>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control sig_mohali_point" id="closing_done_with_mohali" name="data[closing_done_branding]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_mohali_point sig_mohali_fatal" id="back_ground_noise_mohali" name="data[back_ground_noise]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_mohali_point sig_mohali_fatal" id="zero_tolerance_mohali" name="data[zero_tolerance]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_mohali_point sig_mohali_fatal" id="warning_letter_mohali" name="data[warning_letter]" disabled>
									...
									<?php if($oyo_sig_mohali['attach_file']!=''){ ?>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $oyo_sig_mohali['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $oyo_sig_mohali['client_rvw_note'] ?></td>
									</tr>

									<tr><td colspan="10" style="background-color:#C5C8C8"></td></tr>
									
									 <form id="form_agent_user" method="POST" action="">
										<input type="hidden" name="sig_id" class="form-control" value="<?php echo $sig_id; ?>">
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $oyo_sig_mohali['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $oyo_sig_mohali['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $oyo_sig_mohali['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($oyo_sig_mohali['entry_date'],72) == true){ ?>
											<tr>
												<?php if($oyo_sig_mohali['agent_rvw_note']==''){ ?>
