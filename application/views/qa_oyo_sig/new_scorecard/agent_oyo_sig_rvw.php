					...
					<div class="widget-body">
						<div class="table-responsive">
							<table class="table table-striped skt-table" width="100%">
								<tbody>
									<tr style="background-color:#AEB6BF"><td colspan="6" id="theader" style="font-size:30px"><img src="<?php echo base_url(); ?>main_img/oyo.png">&nbsp SIG</td></td></tr>
									...
									<tr>
										...
										<td><input type="text" class="form-control" value="<?php echo $oyo_sig['auditor_name']; ?>" disabled></td>
										<td>Date of Audit:</td>
										<td style="width:250px"><input type="text" class="form-control" value="<?php echo mysql2mmddyy($oyo_sig['audit_date']); ?>" disabled></td>
										<td>Call Date:</td>
										<td><input type="text" class="form-control" id="call_date" name="call_date" value="<?php echo mysqlDt2mmddyy($oyo_sig['call_date']); ?>" disabled></td>
									</tr>
									<tr>
										<td>Agent:</td>
										<td>
											<select class="form-control" id="" name="agent_id" disabled>
												<option value="<?php echo $oyo_sig['agent_id'] ?>"><?php echo $oyo_sig['fname']." ".$oyo_sig['lname'] ?></option>
										...
										<td>Czentrix ID:</td>
										<td><input type="text" class="form-control" id="" name="czentrix_id" value="<?php echo $oyo_sig['czentrix_id']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Call Duration:</td>
										<td><input type="text" class="form-control" id="call_duration" name="call_duration" value="<?php echo $oyo_sig['call_duration']; ?>" disabled></td>
										<td>Phone Number:</td>
										<td><input type="text" class="form-control" id="" name="phone" onkeyup="checkDec(this);" value="<?php echo $oyo_sig['phone']; ?>" disabled></td>
										<td>Campaign:</td>
										<td><input type="text" class="form-control" id="" name="campaign" value="<?php echo $oyo_sig['campaign']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Call Type:</td>
										<td><input type="text" class="form-control" id="" name="call_type" value="<?php echo $oyo_sig['call_type']; ?>" disabled></td>
										<td>Disconnection Source:</td>
										<td><input type="text" class="form-control" id="" name="disconnection_source" value="<?php echo $oyo_sig['disconnection_source']; ?>" disabled></td>
										<td>Call ID:</td>
										<td><input type="text" class="form-control" id="" name="call_id" value="<?php echo $oyo_sig['call_id']; ?>" disabled></td>
									</tr>
									<tr>
										<td>CONF Unique ID:</td>
										<td><input type="text" class="form-control" id="" name="conf_id" value="<?php echo $oyo_sig['conf_id']; ?>" disabled></td>
										<td>Monitor File Name:</td>
										<td><input type="text" class="form-control" id="" name="monitor_file_name" value="<?php echo $oyo_sig['monitor_file_name']; ?>" disabled></td>
										<td>Czentrix Disposition:</td>
										<td><input type="text" class="form-control" id="" name="czentrix_disposition" value="<?php echo $oyo_sig['czentrix_disposition']; ?>" disabled></td>
									</tr>
									<tr>
										<td>Property Code:</td>
										<td><input type="text" class="form-control" name="data[property_code]" value="<?php echo $oyo_sig['property_code'] ?>" disabled></td>
										<td>Agent Disposition:</td>
										<td><input type="text" class="form-control" name="data[agent_disposition]" value="<?php echo $oyo_sig['agent_disposition'] ?>" disabled></td>
										<td>QA Disposition:</td>
										<td><input type="text" class="form-control" name="data[qa_disposition]" value="<?php echo $oyo_sig['qa_disposition'] ?>" disabled></td>
									</tr>
									<tr>
										<td>Audit Type:</td>
										<td>
									...
									<tr>
										...
										<td><input type="text" readonly id="sigScore" name="overall_score" class="form-control sigAutofail" style="font-weight:bold"></td>
									</tr>
									<tr style="background-color:#A9CCE3; font-weight:bold"><td>Parameter</td><td colspan=2>Sub-Parameter</td><td>Sub-Parameter Wise Score</td><td>Validation (Y/N/NA)</td><td colspan=3>Remark</td></tr>
									   <tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point " id="call_opening_5sec" name="data[call_opening_5sec]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="probing_done" name="data[probing_done]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="issue_identified" name="data[issue_identified]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="apology_empathy" name="data[apology_empathy]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="voice_intonation" name="data[voice_intonation]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_point" id="active_listening" name="data[active_listening]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="confidence_and_enthusiasm" name="data[confidence_enthusiasm]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_point" id="politeness_professionalism" name="data[politeness]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="grammar_sentence" name="data[sentence_construction]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="acknowledgement_guest" name="data[acknowledgement]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_point" id="agent_adhere_hold" name="data[adhere_hold_protocol]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="agent_adhere_dead" name="data[dead_air_protocol]" disabled>
									...
									<tr>
										<td colspan=2>4.3 Legitimate Hold used (Hold not disabled still used)</td>
										<td>5</td>
										<td>
											<select class="form-control sig_point" id="legitimate_hold" name="data[legitimate_hold]" disabled>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control sig_point" id="resolution_provided" name="data[correct_information]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="correct_refund" name="data[correct_refund]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="follow_up_with" name="data[proper_followup]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="closure_procedure" name="data[gnc_closure]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_point" id="back_as_promised" name="data[ownership]" disabled>
									...
									<tr>
										...
										<td>4</td>
										<td>
											<select class="form-control sig_point" id="send_correct_resolution" name="data[correct_email]" disabled>
									...
									<tr>
										...
										<td>5</td>
										<td>
											<select class="form-control sig_point" id="complete_and_correct" name="data[correct_notes]" disabled>
									...
									<tr>
										...
										<td>10</td>
										<td>
											<select class="form-control sig_point" id="accurate_tagging_off" name="data[accurate_tagging]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="disposed_accurately" name="data[call_disposed]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="ticket_status" name="data[correct_ticket_status]" disabled>
									  ...
									  <tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="pitched_need_help" name="data[piched_need_help]" disabled>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control sig_point" id="further_assistance" name="data[further_assistance]" disabled>
									...
									<tr>
										...
										<td>2</td>
										<td>
											<select class="form-control sig_point" id="survey_effectively" name="data[Gsat_survey_pitched]" disabled>
									...
									<tr>
										...
										<td>3</td>
										<td>
											<select class="form-control sig_point" id="survey_avoidance" name="data[Gsat_survey_avoidance]" disabled>
									...
									<tr>
										...
										<td>1</td>
										<td>
											<select class="form-control sig_point" id="closing_done_with" name="data[closing_done_branding]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control" id="back_ground_noise" name="data[back_ground_noise]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="handled_ethically" name="data[handled_ethically]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point " id="maintained_profanity" name="data[maintained_profanity]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="sounded_sarcastic" name="data[sounded_sarcastic]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="false_commitment" name="data[false_commitment]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="force_close_ticket" name="data[force_close_ticket]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="escalation_ticket" name="data[escalation_ticket]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="duplicate_tickets" name="data[duplicate_tickets]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="escalation_matrix" name="data[escalation_matrix]" disabled>
									...
									<tr>
										...
										<td></td>
										<td>
											<select class="form-control sig_point" id="misuse_hold_protocol" name="data[misuse_hold_protocol]" disabled>
									...
									<tr>
										<td>Call Summary:</td>
										<td colspan=2><textarea class="form-control" id="" name="call_summary" disabled><?php echo $oyo_sig['call_summary'] ?></textarea></td>
										<td>Feedback:</td>
										<td colspan=2><textarea class="form-control" id="" name="feedback" disabled><?php echo $oyo_sig['feedback'] ?></textarea></td>
									</tr>
									<tr oncontextmenu="return false;">
										<td colspan="2">Upload Files</td>
										<?php if($oyo_sig['attach_file']!=''){ ?>
											<td colspan="4">
									...
									<tr><td style="font-size:16px">Manager Review:</td> <td colspan="5" style="text-align:left"><?php echo $oyo_sig['mgnt_rvw_note'] ?></td></tr>
									<tr><td style="font-size:16px">Client Review:</td> <td colspan="5" style="text-align:left"><?php echo $oyo_sig['client_rvw_note'] ?></td></tr>
									
									<tr><td colspan="6" style="background-color:#C5C8C8"></td></tr>
									
									 <form id="form_agent_user" method="POST" action="">
										<tr>
											<td colspan="2"  style="font-size:16px">Review
												<input type="hidden" name="pnid" class="form-control" value="<?php echo $pnid; ?>">
											</td>
											<td colspan="4"><textarea class="form-control" name="note" required><?php echo $oyo_sig['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($oyo_sig['entry_date'],72) == true){ ?>
											<tr>
												<?php if($oyo_sig['agent_rvw_note']==''){ ?>
