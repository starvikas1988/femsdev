		...
		<div class="row">
			<div class="col-md-12">
				<div class="widget">
					<div class="row">
						<div class="col-md-10">
							<header class="widget-header"><h4 class="widget-title">Lunajoy Report</h4></header>
						</div>
					...
					<div class="widget-body">
						<div class="row">
						  <form id="form_new_user" method="GET" action="<?php echo base_url('Qa_lunajoy/qa_lunajoy_report'); ?>">
						...
						<div class="row">
							...
							<div class="col-md-1" style='margin-top:22px;'>
								<div class="form-group">
									<button class="btn btn-primary blains-effect" a href="<?php echo base_url()?>Qa_lunajoy/qa_lunajoy_report" type="submit" id='show' name='show' value="Show">SHOW</button>
								</div>
							</div>
						...
						<div class="table-responsive">
							<table id="default-datatable" data-plugin="DataTable" class="table table-striped skt-table" cellspacing="0" width="100%">
								...
								<tbody>
									...
									foreach($qa_lunajoy_list as $row){ ?>
									<tr>
										<td><?php echo $i++; ?></td>
										<td><?php
											if($row['entry_by']!=''){
