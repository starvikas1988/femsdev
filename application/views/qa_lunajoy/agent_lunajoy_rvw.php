					...
					<div class="widget-body">
					 	<div class="table-responsive">
							<table class="table  skt-table" width="100%">
								<tbody>
									<tr>
										<td colspan="6" id="theader" style="font-size:40px;text-align: center;background-color: #1948E0  ; color:white;"> Lunajoy Agent Audit Form</td>
									...
									<tr>
										...
										<td>
											...
											<input type="hidden" class="form-control" id="tl_id" name="data[tl_id]" value="<?php echo $lunajoy_data['tl_id'] ?>" disabled>
										</td>
									</tr>
									<tr>
										<td>Order/Ticket Id:<span style="font-size:24px;color:red">*</span></td>
										<td><input type="text" class="form-control" name="data[ticket_id]" value="<?php echo $lunajoy_data['ticket_id'] ?>" disabled ></td>
										...
										<td><input type="text" class="form-control" name="data[interaction_id]" id="" value="<?php echo $lunajoy_data['interaction_id'] ?>"   disabled> </td>
									</tr>
									...
									<tr>
										...
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[listening_to_patient]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt1]" value="<?php echo $lunajoy_data['cmt1'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Courteous, thoughtful, and making sure patient has a positive experience.</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[positive_experience]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt2]" value="<?php echo $lunajoy_data['cmt2'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Answering each question the patient asks.</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[answering_question]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt3]" value="<?php echo $lunajoy_data['cmt3'] ?>"></td>
									</tr>
									<tr>
										...
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[supporting_patient]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt4]" value="<?php echo $lunajoy_data['cmt4'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Used all the required tools e.g. Grammarly to ensure the quality of the text/email content.</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[grammarly_tools]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt5]" value="<?php echo $lunajoy_data['cmt5'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Used "Engaged" in GHL.</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[engaged_ghl]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt6]" value="<?php echo $lunajoy_data['cmt6'] ?>"></td>
									</tr>
									<tr>
										<td rowspan="6" style="background-color:#F6DDCC; text-align:center;">Action - 15%</td>
										<td colspan="2">Was the correct tag used?</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[correct_tag]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt7]" value="<?php echo $lunajoy_data['cmt7'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Did you notate the patients chart? (if needed)</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[patients_chart]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt8]" value="<?php echo $lunajoy_data['cmt8'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Did you complete the action? (example, delete or move the appointment)</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[complete_action]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt9]" value="<?php echo $lunajoy_data['cmt9'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Was the patient moved to the correct pipeline?</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[correct_pipeline]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt10]" value="<?php echo $lunajoy_data['cmt10'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Was the clinician informed of a cancelation for appts withing 24 hours?</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[cancelation_for_appts]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt11]" value="<?php echo $lunajoy_data['cmt11'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Did you tag engaged by?</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[tag_engaged]" disabled>
												<option value="">-Select-</option>
										...
										<td>2.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt12]" value="<?php echo $lunajoy_data['cmt12'] ?>"></td>
									</tr>
									<tr>
										...
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[support_customers]" disabled>
												<option value="">-Select-</option>
										...
										<td>7.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt13]" value="<?php echo $lunajoy_data['cmt13'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Responding to customer requests on time as well as resolving customer issues in a timely fashion.</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[resolving_customer_issues]" disabled>
												<option value="">-Select-</option>
										...
										<td>7.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt14]" value="<?php echo $lunajoy_data['cmt14'] ?>"></td>
									</tr>
									<tr>
										...
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[correct_information]" disabled>
												<option value="">-Select-</option>
										...
										<td>30</td>
										<td><input type="text" class="form-control" disabled name="data[cmt15]" value="<?php echo $lunajoy_data['cmt15'] ?>"></td>
									</tr>
									<tr>
										...
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[resolved_by_front_desk]" disabled>
												<option value="">-Select-</option>
										...
										<td>12.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt16]" value="<?php echo $lunajoy_data['cmt16'] ?>"></td>
									</tr>
									<tr>
										<td colspan="2">Used and followed the proper workflow, channel, tools to achieve FCR.</td>
										<td>
											<select  class="form-control lunajoy_point" id="" name="data[proper_workflow]" disabled>
												<option value="">-Select-</option>
										...
										<td>12.5</td>
										<td><input type="text" class="form-control" disabled name="data[cmt17]" value="<?php echo $lunajoy_data['cmt17'] ?>"></td>
									</tr>
									<tr>
										<td style="background-color:#5058e6;color: white;">Call Summary:</td>
										<td colspan=2><textarea class="form-control" disabled name="data[call_summary]"><?php echo $lunajoy_data['call_summary'] ?></textarea></td>
										<td style="background-color:#5058e6;color: white;">Feedback:</td>
										<td colspan=2><textarea class="form-control" disabled name="data[feedback]"><?php echo $lunajoy_data['feedback'] ?></textarea></td>
									</tr>
									<?php if($lunajoy_data['attach_file']!=''){ ?>
									...
									<tr>
										...
										<td colspan="8" style="text-align:left"><?php echo $lunajoy_data['mgnt_rvw_note'] ?></td>
									</tr>
									<tr>
										<td style="font-size:12px">Client Review:</td>
										<td colspan="8" style="text-align:left"><?php echo $lunajoy_data['client_rvw_note'] ?></td>
									</tr>

									<tr><td colspan="10" style="background-color:#C5C8C8"></td></tr>
									
									 <form id="form_agent_user" method="POST" action="">
										<input type="hidden" name="lunajoy_id" class="form-control" value="<?php echo $lunajoy_id; ?>">
										...
										<tr>
											...
											<td colspan=6>
												<select class="form-control" id="" name="agnt_fd_acpt" required="">
													<option value="">--Select--</option>
													<option <?php echo $lunajoy_data['agnt_fd_acpt']=='Acceptance'?"selected":""; ?> value="Acceptance">Acceptance</option>	
													<option <?php echo $lunajoy_data['agnt_fd_acpt']=='Not Acceptance'?"selected":""; ?> value="Not Acceptance">Not Acceptance</option>	
												</select>
											</td>
										</tr>
										<tr>
											<td colspan=2 style="font-size:16px">Your Review<span style="font-size:24px;color:red">*</span></td>
											<td colspan=6><textarea class="form-control" name="note" required><?php echo $lunajoy_data['agent_rvw_note'] ?></textarea></td>
										</tr>
										
										<?php if(is_access_qa_agent_module()==true){
										if(is_available_qa_feedback($lunajoy_data['entry_date'],72) == true){ ?>
											<tr>
												<?php if($lunajoy_data['agent_rvw_note']==''){ ?>
