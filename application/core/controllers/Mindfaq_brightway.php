...
class Mindfaq_brightway extends CI_Controller {
	...
	public function index(){
		if(check_logged_in()){
			...
			if(is_access_brightway_modules()==false) redirect(base_url()."home","refresh");
			...
			$this->load->view("mindfaq/brightway.php",$data);
