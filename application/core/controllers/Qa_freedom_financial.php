<?php 
 ...
 class Qa_freedom_financial extends CI_Controller{
	...
	public function serviceName(){
		return "freedom_financial";
	}

	public function scoreCard(){
    	return $arrayName = array('YES','NO','N/A','PASS','FAIL');
    }
	...
	public function index(){
		if(check_logged_in())
		{
			...
			$qSql="SELECT id, concat(fname, ' ', lname) as name, assigned_to, fusion_id FROM `signin` where role_id in (select id from role where folder ='agent') and dept_id=6 and is_assign_client (id,209) and is_assign_process (id,428) and status=1  order by name";
