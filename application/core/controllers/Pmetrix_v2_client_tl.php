...
class Pmetrix_v2_client_tl extends CI_Controller {
...
WHERE pm_design_kpi_v2.kpi_name="Sup_FEMS_ID" AND pm_design_v2.office_id="'.$form_data['office_id'].'" AND pm_design_v2.process_id="'.$form_data['process_id'].'" AND signin.id="'.$form_data['others_team'].'" GROUP BY user_id';
		}
		else
		{
	...
	public function prepare_tl_row()
	{
		...
		if($form_data['process_id'] == 30)
		{
			if(isset($form_data['tl_id']))
			{
				echo $this->load->view('pmetrix_v2_tl/view_data_page_manager_tl_vrs',$data,true);
			}
			else
			{
	...
	{
		/* echo 'SELECT tl.fusion_id as tl_fusion_id,tl.fname as tl_fname,tl.lname as tl_lname,signin.fusion_id, pm_design_kpi_v2.kpi_name,pm_data_v2.kpi_value,pm_data_v2.start_date,pm_design_kpi_v2.weightage,pm_design_kpi_v2.summ_formula,signin.fname as agent_fname,signin.lname as agent_lname
