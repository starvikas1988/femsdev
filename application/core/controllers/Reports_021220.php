...
////////////////////Master Database (19.07.2019)//////////////////////
	...
	public function generate_master_database_details_xls($rr)
	{
           ...
           $header = array("Fusion ID", "XPOID", "First Name", "Last Name", "Full Name", "Client", "Process", "Batch Code", "Designation", "Organization Role", "Location", "Department", "DOJ", "Rejoining Date", "Joining Month", "DOB", "Age", "Boss Name", "Official Email ID", "Personal Email ID", "Father's Name", "Gender", "Highest Qualification", "Present Address", "Permanent Address", "Pincode", "Mobile Number", "Blood Group", "Marital Status", "PAN Number", "UAN Number", "Aadhar Number", "Existing Bank A/C Number", "Existing ESI Number", "Bank IFSC CODE", "Hiring Source", "Hiring Sub Source", "Tenurity", "Experience", "Status", "Phase", "Term Date", "Term Type", "Caste", "Payroll Type", "Resign Status", "Released Date","Furlough Date","Furlough Expiry Date","Furlough Revoke Date","Bench Date","Suspended Date", "certify_address","work_home","office_assets","specifications");
