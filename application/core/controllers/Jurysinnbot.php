...
class Jurysinnbot extends CI_Controller {
	...
	public function index(){
		if(check_logged_in()){
			...
			if(is_access_jurys_inn_modules()==false) redirect(base_url()."home","refresh");
			...
			$data["content_template"] = "jurry_inn_chatbot/chatbot.php";
