...
class Admin extends CI_Controller {
    ...
    public function index()
    {
		...
		if(check_logged_in())
        {
			...
			if(get_role_dir()!="admin") redirect(base_url().get_role_dir()."/dashboard","refresh");
			$data["aside_template"] = get_aside_template();
			$data["content_template"] = "admin/dashboard.php";
