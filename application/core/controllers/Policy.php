...
class Policy extends CI_Controller {
    ...
    private $aside = "policy/aside.php";
			...
			$data['policy_list'] =array();
				...
				//{
					...
					if($current_user==20399 || $current_user == 20400){
						$data['policy_list'] = $policyArray =array();
					}
				...
				$data["content_template"] = "policy/manage.php";
