<?php 
 ...
 class Qa_nordnet extends CI_Controller{
	...
	public function catFieldVal(){
		return array("Are you satisfied with the courtesy of your advisor","How do you judge the clarity of the explanations answers given","What grade would you give to the last interlocutor you had in ");
	}

	public function subcatFieldVal(){
		return array("How is the vocabulary of the agent? ","Attitude on the call","Hold Time on call","Quality of the response","Quality of the historization","Relevance Of the Answer","Tool Usage","Welcome of the call","Summarizing the resolution","Conclusion of the call");
	}

	public function scoreCard(){
		return array("Meets Expectation","Below Ecpectation","N/A");
	}
	...
	public function index(){
		if(check_logged_in())
		{
			...
			$qSql="SELECT id, concat(fname, ' ', lname) as name, assigned_to, fusion_id FROM `signin` where role_id in (select id from role where folder ='agent') and dept_id=6 and  is_assign_client (id,178) and is_assign_process (id,371)  and status=1  order by name";
