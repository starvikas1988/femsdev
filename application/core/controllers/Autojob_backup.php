...
class Autojob extends CI_Controller {
	...
	//////////////////////////////////////////////////////////			
		...
		public function auto_release_term()
		{
			...
			foreach($get_users_to_term as $token_user)
			{
				...
				$evt_date          = CurrMySqlDate();
				$event_master_id   = 7;
				$log               = "Employee Exit - Auto Term # ". get_logs();
	...
	/////////////////////////////////////////////////////////////////////
		...
		//*********************************************************************************************************************************
		// implement the option of auto removal from FEMS if a person does not join or login within 7 days after the ID is getting created 
		//*********************************************************************************************************************************
 
		
		public function remove_unattended_candidate(){
