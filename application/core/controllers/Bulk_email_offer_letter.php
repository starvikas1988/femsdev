...
class Bulk_email_offer_letter extends CI_Controller {
    ...
    public function index()
    {
        ...
        if(check_logged_in())
        {
			...
			$data["content_template"] = "utils/email_offer_letter.php";
					...
					if($fids!="" )
					{
						...
						foreach ($fidArray as $fusion_id) {
							...
							if($uid!=""){
								...
								$this->Email_model->resend_email_offer_letter($current_user,$uid,$c_name,$email_id_per,$offer_letter);
	...
	public function candidate_offer_pdf($user_id,$isLHead='Y',$isSave='N'){ 
			...
			$html=$this->load->view('utils/candidae_offer_letter_pdf.php', $data, true);
