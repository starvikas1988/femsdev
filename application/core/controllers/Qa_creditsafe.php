<?php 
 ...
 class Qa_creditsafe extends CI_Controller{
	...
	public function index(){
		if(check_logged_in())
		{
			...
			$qSql="SELECT id, concat(fname, ' ', lname) as name, assigned_to, fusion_id FROM `signin` where role_id in (select id from role where folder ='agent') and dept_id=6 and  is_assign_client (id,173) and is_assign_process (id,365) and status=1  order by name";
