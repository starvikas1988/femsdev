...
//////////////////////////////////////////////////////////////////////////////	
	...
	public function send_basic_link()
	{
		if(check_logged_in())
		{
			...
			if($fname!="" && $email !=""){
				...
				$is_send=$this->email_basic_link($office_id,$requisition_id,$fname,$lname,$eto,$linkURL);
				
				if($rowid!==FALSE){ 					
						redirect("dfr/view_requisition/$rid");
				}else{
	...
	private function email_basic_link($office_id,$requisition_id, $fname,$lname, $eto, $linkURL){
	...
	public function resend_basic_link()
	{
		if(check_logged_in())
		{
			...
			if($r_id!="" && $c_id !=""){
				...
				$qSql="select * from dfr_candidate_details where r_id='$r_id' and id='$c_id'";
