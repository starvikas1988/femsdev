		...
		if(check_logged_in())
		{
			...
			if($this->input->post('agent_id')){
				...
				$field_array=array(
					...
					"guest_number" => $this->input->post('guest_number'),
					"chat_link" => $this->input->post('chat_link'),
					"escalation_ticket" => $this->input->post('escalation_ticket'),
					"haptik_id" => $this->input->post('haptik_id'),
					"audit_type" => $this->input->post('audit_type'),
					"auditor_type" => $this->input->post('auditor_type'),
					"voc" => $this->input->post('voc'),
					...
					"procedure_followed" => $this->input->post('procedure_followed'),
					"unnecessary_time_taken" => $this->input->post('unnecessary_time_taken'),
					"correct_booking" => $this->input->post('correct_booking'),
					"correct_information" => $this->input->post('correct_information'),
					"correct_refund" => $this->input->post('correct_refund'),
					"proper_followup" => $this->input->post('proper_followup'),
					"duplicate_ticket_merging" => $this->input->post('duplicate_ticket_merging'),
					"case_library_adherence" => $this->input->post('case_library_adherence'),
					"complete_notes" => $this->input->post('complete_notes'),
					"tagging_issue_category" => $this->input->post('tagging_issue_category'),
					"incorrect_cancelation" => $this->input->post('incorrect_cancelation'),
					"cottect_ticket_status" => $this->input->post('cottect_ticket_status'),
					"verify_account_before_cancel" => $this->input->post('verify_account_before_cancel'),
					...
					"infraction_incorrect_email" => $this->input->post('infraction_incorrect_email'),
					"infraction_followup" => $this->input->post('infraction_followup'),
					"infraction_spell_check" => $this->input->post('infraction_spell_check'),
					"infraction_resolution_provide" => $this->input->post('infraction_resolution_provide'),
					"infraction_sentence_structure" => $this->input->post('infraction_sentence_structure'),
					"infraction_procedure_not_follow" => $this->input->post('infraction_procedure_not_follow'),
					"infraction_issue_identify" => $this->input->post('infraction_issue_identify'),
					"infraction_incorrect_information" => $this->input->post('infraction_incorrect_information'),
					"infraction_ownership_failure" => $this->input->post('infraction_ownership_failure'),
					"infraction_share_communication" => $this->input->post('infraction_share_communication'),
					"infraction_process_deviation" => $this->input->post('infraction_process_deviation'),
					"infraction_incorrect_booking" => $this->input->post('infraction_incorrect_booking'),
					"advisor_ZTP" => $this->input->post('advisor_ZTP'),
					"cmt1" => $this->input->post('cmt1'),
					"cmt2" => $this->input->post('cmt2'),
					"cmt3" => $this->input->post('cmt3'),
					...
					"dd_val28" => $this->input->post('dd_val28'),
					"dd_val29" => $this->input->post('dd_val29'),
					"dd_val30" => $this->input->post('dd_val30'),
					"dd_val31" => $this->input->post('dd_val31'),
					"dd_val32" => $this->input->post('dd_val32'),
					"dd_val33" => $this->input->post('dd_val33'),
					"dd_val34" => $this->input->post('dd_val34'),
					"dd_val35" => $this->input->post('dd_val35'),
					"dd_val36" => $this->input->post('dd_val36'),
					"dd_val37" => $this->input->post('dd_val37'),
					"dd_val38" => $this->input->post('dd_val38'),
					"dd_val39" => $this->input->post('dd_val39'),
					"dd_val40" => $this->input->post('dd_val40'),
					"dd_val41" => $this->input->post('dd_val41'),
					"dd_val42" => $this->input->post('dd_val42'),
					"call_summary" => $this->input->post('call_summary'),
					"feedback" => $this->input->post('feedback')
				);
