...
class Mindfaq_affinity extends CI_Controller {
	...
	public function index(){
		if(check_logged_in()){
			...
			if(is_access_affinity_modules()==false) redirect(base_url()."home","refresh");
			...
			$this->load->view("mindfaq/affinity.php",$data);
