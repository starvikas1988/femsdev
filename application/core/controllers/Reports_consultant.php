...
class Reports_consultant extends CI_Controller {
	...
	public function photograph()
	{
		if(check_logged_in()){
			...
			$data["show_table"] = false;
			$data["aside_template"] = "reports_consultant/aside.php";
			$data["content_template"] = "reports_consultant/photo_upload_report.php";
	...
	public function generate_profile_photo_download_archieve($reportArray, $csvfile='', $office ='', $zipfile = '')
	{
		...
		if(check_logged_in()){
			...
			$data["show_table"] = false;
			$data["aside_template"] = "reports_consultant/aside.php";
			$data["content_template"] = "reports_consultant/new_document_upload_report.php";
...
////////////////////Master Database (19.07.2019)//////////////////////
	...
	public function fems_master_database(){
		if(check_logged_in()){
			...
			$data["aside_template"] = "reports_consultant/aside.php";
			$data["content_template"] = "reports_consultant/fems_master_database.php";
...
////////////////// Profile Document Upload ///////////////////////////
	...
	public function document_upload(){
		if(check_logged_in()){
			...
			$data["show_table"] = false;
			$data["aside_template"] = "reports_consultant/aside.php";
			$data["content_template"] = "reports_consultant/document_upload_report.php";
...
/*================================ LEAVE REPORTS ===============================================================================*/
	...
	public function generate_leave_report_xls($search_Office_ID="", $search_department_id="", $search_fusion_id="", $search_leave_type, $extraSearch)
	{
		...
		$reports_sql = "SELECT s.fusion_id, CONCAT(s.fname,' ', s.lname) as fullname, s.office_id, r.name as designation, get_process_names(s.id) as process_name, ls.leaves_present 
		from signin as s 
