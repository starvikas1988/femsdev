...
/* XW Zar Arabic fonts */
	...
	"xbzar" => array(
		...
		"certificatefont" => array(
			'R' => "lucidahandwritingitalic.ttf",
			//'R' => "edwardianscriptitc.ttf",
			//'R' => "vivaldi.ttf",
		...
		"naumanextrabold" => array(
			'R' => "naumanextrabold.ttf",
		...
		"guesssanswooregular" => array(
			'R' => "guesssanswooregular.ttf",
			
		),
		"retrokiacapsregular" => array(
			'R' => "retrokiacapsregular.ttf",
